...
En este artículo se presentan procedimientos recomendados para [crear un archivo de solución de administración](monitoring-solutions-solution-file.md) en Azure.  Esta información se actualizará a medida que se detecten procedimientos recomendados adicionales.
...
- Configure la solución para que [contenga](monitoring-solutions-solution-file.md#solution-resource) la vista de manera que se quite si la solución se quita.
...
* Recorra el proceso básico de [diseño y creación de una solución de administración](monitoring-solutions-creating.md).
* Aprenda a [crear un archivo de solución](monitoring-solutions-solution-file.md).
