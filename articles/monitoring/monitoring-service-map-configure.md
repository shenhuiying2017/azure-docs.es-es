...
En este artículo se describen los detalles sobre cómo configurar agentes de incorporación y de Mapa de servicio. Para información acerca de cómo usar Service Map, consulte [Uso de la solución Service Map en Azure]( monitoring-service-map.md).
...
- Obtenga información sobre cómo [usar Service Map]( monitoring-service-map.md) una vez implementado y configurado.
