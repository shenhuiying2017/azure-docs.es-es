...
![Notificaciones de estado](media/monitoring-service-map/status-badges.png)
...
![Grupo de equipos](media/monitoring-service-map/machine-group.png)
...
![Crear grupo](media/monitoring-service-map/machine-groups-create.png)
...
![Pestaña Grupos](media/monitoring-service-map/machine-groups-tab.png)

Luego seleccione el nombre del grupo para ver la asignación de ese grupo de equipos.
![Grupo de equipos](media/monitoring-service-map/machine-group.png) Los equipos que pertenecen al grupo tienen un contorno blanco en la asignación.

Al expandir el grupo se muestran los equipos que componen el grupo de equipos.

![Equipos del grupo de equipos](media/monitoring-service-map/machine-groups-machines.png)
...
![Filtrar grupo](media/monitoring-service-map/machine-groups-filter.png)
...
![Todos los procesos del grupo de equipos](media/monitoring-service-map/machine-groups-all.png)
...
![Procesos filtrados del grupo de equipos](media/monitoring-service-map/machine-groups-filtered.png)
...
![Quitar equipo del grupo](media/monitoring-service-map/machine-groups-remove.png)
...
![Menú Grupo de equipos](media/monitoring-service-map/machine-groups-menu.png)
...
| ![Servidor de aplicaciones](media/monitoring-service-map/role-application-server.png) | Servidor de aplicaciones |
| ![Servidor de bases de datos](media/monitoring-service-map/role-database.png) | Servidor de bases de datos |
...
![Iconos de rol](media/monitoring-service-map/role-icons.png)
...
![Conexiones con errores](media/monitoring-service-map/failed-connections.png)
...
![Propiedades del grupo de clientes](media/monitoring-service-map/client-group-properties.png)
...
![Grupos de puertos de servidor](media/monitoring-service-map/server-port-groups.png)
...
![Conexiones con errores](media/monitoring-service-map/context-menu.png)
...
![Panel de resumen del equipo](media/monitoring-service-map/machine-summary.png)
...
![Panel Propiedades de la máquina](media/monitoring-service-map/machine-properties.png)
...
![Panel Propiedades del proceso](media/monitoring-service-map/process-properties.png)
...
![Panel de eventos de registro del equipo](media/monitoring-service-map/log-events.png)
...
![Panel de departamento de servicios del equipo](media/monitoring-service-map/service-desk.png)
...
![Panel de seguimiento de cambios del equipo](media/monitoring-service-map/change-tracking.png)
...
![Panel Rendimiento de la máquina](media/monitoring-service-map/machine-performance.png)
...
Consulte la [sección de solución de problemas del documento de configuración de Service Map]( monitoring-service-map-configure.md#troubleshooting).
