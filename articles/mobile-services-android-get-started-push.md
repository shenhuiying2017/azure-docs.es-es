...
<div class="dev-center-tutorial-selector sublanding">
    <a href="/es-es/develop/mobile/tutorials/get-started-with-push-dotnet" title="C# para Tienda Windows">C# para Tienda Windows</a>
    <a href="/es-es/develop/mobile/tutorials/get-started-with-push-js" title="JavaScript para Tienda Windows">JavaScript para Tienda Windows</a>
...
<div class="dev-center-tutorial-subselector"><a href="/es-es/documentation/articles/mobile-services-dotnet-backend-android-get-started-push/" title="Back-end de .NET">Back-end de .NET</a> | <a href="/es-es/documentation/articles/mobile-services-android-get-started-push/"  title="Back-end de JavaScript" class="current">Back-end de JavaScript</a></div>
...
-   [Configuración de Servicios móviles][Configuración de Servicios móviles]
-   [Incorporación de notificaciones de inserción a la aplicación][Incorporación de notificaciones de inserción a la aplicación]
-   [Actualización de scripts para enviar notificaciones de inserción][Actualización de scripts para enviar notificaciones de inserción]
-   [Inserción de datos para recibir notificaciones][Inserción de datos para recibir notificaciones]

Este tutorial requiere lo siguiente:

-   [SDK de Android para Servicios móviles][SDK de Android para Servicios móviles]
...
## <span id="add-push"></span></a>Incorporación de notificaciones de inserción a la aplicación
...
5.  Agregue los siguientes permisos nuevos después del elemento `uses-permission`:
...
<p>Cuando su servicio m&oacute;vil tenga habilitado el esquema din&aacute;mico, una columna <strong>handle</strong> se agregar&aacute; autom&aacute;ticamente a la tabla <strong>TodoItem</strong> cuando se inserte un elemento nuevo que contenga esta propiedad.</p>
</div>

8.  Descargue y descomprima el [SDK de Android para Servicios móviles (en inglés)][SDK de Android para Servicios móviles], abra la carpeta **notificaciones**, copie el archivo **notifications-1.0.1.jar** en la carpeta *libs* del proyecto Eclipse y actualice la carpeta *libs*.
...
10. Agregue la siguiente variable privada a la clase, donde *`<PROJECT_NUMBER>`* es el número de proyecto que Google asigna a su aplicación en el procedimiento anterior:
...
13. En el Explorador de paquetes, haga clic con el botón secundario en el paquete (bajo el nodo `src`), haga clic en **Nuevo** y después en **Clase**.
...
## <span id="update-scripts"></span></a>Actualización del script de inserción registrado en el Portal de administración
...
3.  Reemplace la función de inserción por el siguiente código y, a continuación, haga clic en **Save**:
    ...
    Esto registra un nuevo script de inserción, que usa el [gcm (objeto)][gcm (objeto)] para enviar una notificación de inserción (el texto insertado) al dispositivo indicado en la solicitud de inserción.

## <span id="test"></span></a>Pruebas de notificaciones de inserción en su aplicación

<div class="dev-callout"><b>Nota:</b>
    <p>Cuando ejecute esta aplicaci&oacute;n en el emulador, aseg&uacute;rese de utilizar un dispositivo virtual Android (AVD) compatible con las API de Google.</p>
</div>
...
5.  En la aplicación, escriba un texto significativo, como *Una nueva tarea de Servicios móviles* y, a continuación, haga clic en el botón **Agregar**.
