...
- Todas las instancias de los roles se deben estar ejecutando para poder realizar el intercambio. Puede comprobar el estado de las instancias en el Portal de Azure clásico o mediante el [comando Get-AzureRole de Windows PowerShell](/powershell/module/azure/get-azurerole?view=azuresmps-3.7.0).
