...
* Creación de una cuenta de almacenamiento de Azure
  ...
  > [!NOTE]
  > Anote también el Id. de la suscripción de Azure, ya que lo necesitará más adelante. Lo puede encontrar en el portal clásico haciendo clic en **Configuración** > **Suscripciones**.
  > 
  > 
