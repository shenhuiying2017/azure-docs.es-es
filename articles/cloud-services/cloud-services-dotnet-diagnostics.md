---
title: Cómo usar Diagnósticos de Azure (.NET) con Servicios en la nube | Microsoft Docs
...
### Requisitos previos
En este artículo se supone que tiene una suscripción a Azure y usa Visual Studio 2013 con el SDK de Azure. Si no tiene una suscripción de Azure, puede registrarse para obtener una [prueba gratuita][prueba gratuita]. Asegúrese de [instalar y configurar Azure PowerShell versión 0.8.7 o posterior][instalar y configurar Azure PowerShell versión 0.8.7 o posterior].
