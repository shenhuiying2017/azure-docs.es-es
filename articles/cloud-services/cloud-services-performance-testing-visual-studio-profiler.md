<properties 
	...
	headerexpose="" 
	pageTitle="Generación del perfil de un servicio en la nube en modo local en el emulador de proceso" 
	metakeywords="" 
	footerexpose="" 
	description="Aprenda a probar el rendimiento de un servicio en la nube en el emulador de proceso de Azure local con el generador de perfiles de Visual Studio." 
	umbraconavihide="0" 
	disquscomments="1" 
	authors="kempb" 
	manager="douge" 
...
Cuando publica un servicio en la nube en Azure, puede hacer que Visual Studio recopile datos de
generación de perfiles y luego los analice de manera local, tal como se describe en [Generación de perfiles de una aplicación de Azure][1].
También puede usar diagnósticas para realizar el seguimiento de una variedad de
contadores de rendimiento, tal como se describe en [Uso de contadores de rendimiento en Azure][2].
