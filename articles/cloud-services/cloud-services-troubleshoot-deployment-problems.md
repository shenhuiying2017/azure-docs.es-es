...
Al implementar un paquete de aplicación del servicio en la nube en Azure, puede obtener información sobre la implementación en el panel **Propiedades** del Portal de Azure clásico. Puede usar los detalles de este panel para ayudarle a solucionar problemas con el servicio en la nube y proporcionar esta información al soporte técnico de Azure al abrir una nueva solicitud de soporte técnico.
...
1. En el Portal de Azure clásico, haga clic en la implementación del servicio en la nube.
2. En el panel **Propiedades** del Portal de Azure clásico, compruebe los puertos de las instancias de rol (en puntos de conexión de entrada).
...
1. En el Portal de Azure clásico, haga clic en la implementación del servicio en la nube.
2. En el panel **Propiedades** del Portal de Azure clásico, revise la información y determine si la recuperación del servicio se produjo durante el reinicio de los nodos.
...
1. En el Portal de Azure clásico, haga clic en la implementación del servicio en la nube.
2. En el panel **Propiedades** del Portal de Azure clásico, busque el valor de **Estado**. Si es **Listo**, compruebe **Última operación** para ver si hubo recientemente alguna que pudo impedir el intercambio de VIP.
...
1. En el Portal de Azure clásico, haga clic en la instancia de rol.
2. En el panel **Propiedades** del Portal de Azure clásico, tenga en cuenta las condiciones siguientes para resolver el problema:
