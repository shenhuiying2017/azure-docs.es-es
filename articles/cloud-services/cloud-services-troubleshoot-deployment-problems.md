...
Vea más [artículos de solución de problemas](https://docs.microsoft.com/en-us/azure/cloud-services/cloud-services-allocation-failures) para servicios en la nube.
