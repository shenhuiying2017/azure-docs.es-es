...
1. Escriba el siguiente comando para abrir el archivo index.jade:
   ...
   Jade es el motor de vistas predeterminado que utilizan las aplicaciones Express. Para obtener más información acerca del motor de vistas Jade, consulte [http://jade-lang.com][http://jade-lang.com].
