...
3. Para servicios en la nube, elija el vínculo **Configurar publicación con Visual Studio Online**. Para aplicaciones web, elija el vínculo **Configurar implementación desde control de código fuente**.<br/> ![][10]
