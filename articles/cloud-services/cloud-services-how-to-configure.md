...
3. Para los roles de servicio (agrupados por rol), puede actualizar la siguiente configuración:
    ...
    >**Configuración**<br/> Modifique los valores de los ajustes de la configuración diversa que se especifican en los elementos *ConfigurationSettings* del archivo de configuración del servicio (.cscfg).
...
[Establecer una conexión a Escritorio remoto para un rol de Azure]: https://msdn.microsoft.com/library/azure/hh124107.aspx

[Uso de Escritorio remoto con los roles de Azure]: https://msdn.microsoft.com/library/azure/gg443832.aspx
