---
title: "Configuración de un servicio en la nube (Portal clásico) | Microsoft Docs"
...
1. En el [Portal de Azure clásico](http://manage.windowsazure.com/), haga clic en **Cloud Services**, en el nombre del servicio en la nube y, a continuación, en **Configurar**.
