...
1. Para publicar un servicio, simplemente pase el parámetro **-Slot** al cmdlet **Publish-AzureServiceProject**.
   ...
   ```
2. Inicie sesión en el [Portal de Azure clásico] y seleccione **Cloud Services**. Una vez que se crea el servicio en la nube y que el estado de la columna **Ensayo** se actualiza a **En ejecución**, haga clic en el nombre del servicio.
...
1. Inicie sesión en el [Portal de Azure clásico], haga clic en **Cloud Services** y, a continuación, seleccione el nombre del servicio.
...
[Implementación de una actualización de servicio en producción intercambiando las VIP en Azure]: cloud-services-how-to-manage-portal.md#how-to-swap-deployments-to-promote-a-staged-deployment-to-production
