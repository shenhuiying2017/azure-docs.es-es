...
Se recomienda comenzar por ver el vídeo siguiente, donde Ryan CrawCour y Scott Hanselman presentan Base de datos de documentos de Azure y probar nuestra [Área de consultas](http://www.documentdb.com/sql/demo), donde puede probar Base de datos de documentos y ejecutar consultas SQL en nuestro conjunto de datos.
...
-	**Almacenamiento y rendimiento escalables y elásticos:** permite ampliar o reducir fácilmente Base de datos de documentos según las necesidades de la aplicación. El ajuste de escalado se realiza a través de unidades específicas de rendimiento y almacenamiento SSD. Base de datos de documentos se puede escalar de forma elástica con un rendimiento predecible adquiriendo más unidades de capacidad a medida que crezca la aplicación. 

-	**Abrir por diseño:** comience rápidamente con las habilidades y herramientas existentes. La programación con Base de datos de documentos es simple, accesible y no requiere adoptar nuevas herramientas ni adherirse a las extensiones personalizadas en JSON o JavaScript. Puede tener acceso a toda la funcionalidad de base de datos, incluidos CRUD, consulta y procesamiento de JavaScript a través de una interfaz HTTP de RESTful simple. Base de datos de documentos adopta estándares, idiomas y formatos existentes al mismo tiempo que ofrece capacidades de bases de datos de alto valor para ellos.
...
##<a name="data-management"></a>Recursos de Base de datos de documentos de Azure
...
##<a name="develop"></a>Desarrollo frente a Base de datos de documentos de Azure
...
-	[Modelo de recursos y conceptos de Base de datos de documentos](documentdb-resources.md)
-	[Interacción con recursos de Base de datos de documentos](documentdb-interactions-with-resources.md)
-	[Creación de una cuenta de base de datos de la Base de datos de documentos](documentdb-create-account.md)
-	[Introducción al SDK de .NET de Base de datos de documentos](documentdb-get-started.md)
