<properties urlDisplayName="Upload an Oracle Linux VHD" pageTitle="Creaci&oacute;n y carga de un VHD de Oracle Linux en Azure" metaKeywords="Azure VHD, uploading Linux VHD, Oracle Linux" description="Aprenda a crear y cargar un disco duro virtual de Azure (VHD) que contiene el sistema operativo Oracle Linux." metaCanonical="" services="virtual-machines" documentationCenter="" title="Creaci&oacute;n y carga de un disco duro virtual que contiene un sistema operativo Oracle Linux" authors="kathydav" solutions="" manager="timlt" editor="tysonn" />
...
-   [Preparación de una máquina virtual Oracle Linux 6.4+ para Azure][Preparación de una máquina virtual Oracle Linux 6.4+ para Azure]
-   [Preparación de una máquina virtual Oracle Linux 7.0+ para Azure][Preparación de una máquina virtual Oracle Linux 7.0+ para Azure]
