<properties
	...
	description="Implemente fácilmente un único servidor WordPress con Ubuntu con una plantilla de administrador de recursos y el Portal de Azure, Azure PowerShell o la CLI de Azure."
