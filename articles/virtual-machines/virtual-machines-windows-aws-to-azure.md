...
Antes de iniciar este proceso, asegúrese de revisar [Plan for the migration to Managed Disks](virtual-machines-windows-on-prem-to-azure.md#plan-for-the-migration-to-managed-disks) (Planificación de la migración a Managed Disks).
...
Si todavía no tiene la versión de PowerShell instalada, consulte [Cómo instalar y configurar Azure PowerShell](/powershell/azureps-cmdlets-docs).
