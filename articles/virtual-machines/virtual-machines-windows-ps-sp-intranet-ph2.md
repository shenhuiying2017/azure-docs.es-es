...
Debe completar esta fase antes de pasar a la [fase 3](virtual-machines-windows-ps-sp-intranet-ph3.md). Consulte [Implementación de SharePoint con grupos de disponibilidad AlwaysOn de SQL Server en Azure](virtual-machines-windows-sp-intranet-overview.md) para ver todas las fases.
...
Para obtener una lista completa de los tamaños de máquina virtual, consulte [Tamaños de máquinas virtuales](virtual-machines-linux-sizes.md).
...
Recuerde que definió las tablas V, S, ST y A en [Fase 1: Configuración de Azure](virtual-machines-windows-ps-sp-intranet-ph1.md).
...
- Para continuar con la configuración de esta carga de trabajo, vaya a la [Fase 3](virtual-machines-windows-ps-sp-intranet-ph3.md).
