...
> [AZURE.SELECTOR]
- [Portal clásico](virtual-machines-windows-classic-portal-sql.md)
- [PowerShell](virtual-machines-windows-classic-ps-sql-create.md)
- [Portal de Azure Resource Manager](virtual-machines-windows-portal-sql-server-provision.md)
...
1. En el Portal de Azure, haga clic en **+Nuevo**. En el portal se abrirá la hoja **Nuevo**. Las plantillas de máquina virtual de SQL Server están en el grupo **Proceso** de Marketplace.

1. En la hoja **Nuevo**, haga clic en **Proceso**.
1. Para ver todos los tipos de recursos en la hoja **Proceso**, haga clic en **Ver todos**. <br/> ![Hoja de proceso de Azure](./media/virtual-machines-windows-portal-sql-server-provision/azure-compute-blade.png) <br/>
1. En **Servidores de bases de datos**, haga clic en **SQL Server** para ver todas las plantillas disponibles para SQL Server. Es posible que deba desplazarse hacia abajo para encontrar **Servidores de bases de datos**.
...
* Un **nombre** único para la máquina virtual.
...
En la hoja **Crear máquina virtual**, en **Tamaño**, elija un tamaño de máquina virtual. El Portal de Azure mostrará los tamaños recomendados. Para obtener más información sobre los tamaños de las máquinas virtuales, consulte [Sizes for virtual machines](virtual-machines-linux-sizes.md) (Tamaños de máquinas virtuales). Los tamaños se basan en la plantilla seleccionada. El tamaño calcula el costo mensual para ejecutar la máquina virtual. Seleccione un tamaño de máquina virtual para el servidor. Para consultar algunas consideraciones sobre los tamaños de las máquinas virtuales de SQL Server, consulte [Performance best practices for SQL Server in Azure Virtual Machines](virtual-machines-windows-classic-sql-perf.md) (Prácticas recomendadas para mejorar el rendimiento para SQL Server en máquinas virtuales de Azure).
...
- En **Cuenta de almacenamiento**, puede aceptar el nombre suministrado automáticamente para la cuenta de almacenamiento o puede hacer clic en **Cuenta de almacenamiento** para elegir una cuenta existente y configurar el tipo de cuenta de almacenamiento. De forma predeterminada, Azure crea una nueva cuenta de almacenamiento con redundancia local.
...
>[AZURE.NOTE]Por seguridad, restrinja el puerto de origen mediante el grupo de seguridad de red. Para obtener más información, consulte [¿Qué es un grupo de seguridad de red?](../virtual-network/virtual-networks-nsg.md)
...
El **puerto** predeterminado es el 1433. Puede especificar un número de puerto diferente. Para obtener más información, consulte [Connect to a SQL Server Virtual Machine (Resource Manager) | Microsoft Azure](virtual-machines-windows-sql-connect.md) (Conexión a una máquina virtual de SQL Server (Resource Manager) | Microsoft Azure).
...
De forma predeterminada, Azure optimiza el almacenamiento de 5000 IOPS, 200 MB y 1 TB de espacio de almacenamiento. Puede cambiar estos valores de almacenamiento según la carga de trabajo. En **Optimización del almacenamiento**, seleccione una de las siguientes opciones:
...
>[AZURE.NOTE] Los límites de la configuración de almacenamiento dependen del tamaño de la máquina virtual. Para obtener más información, consulte [Sizes for virtual machines](virtual-machines-linux-sizes.md) (Tamaños de máquinas virtuales).
...
Para obtener más información, consulte [Aplicación de revisión automatizada para SQL Server en máquinas virtuales de Azure](virtual-machines-windows-classic-ps-sql-patch.md).

### Copias de seguridad
Habilite las copias de seguridad automáticas para todas las bases de datos en **Copia de seguridad automatizada de SQL**. Cuando habilita esta opción puede configurar lo siguiente:
...
Revise el resumen y haga clic en **Aceptar** para crear recursos de SQL Server, el grupo de recursos y los recursos especificados para esta máquina virtual. Puede supervisar la implementación desde el portal de Azure. En el botón **Notificaciones**, situado en la parte superior de la pantalla, se muestra el estado básico de la implementación.
...
1.	En la parte superior de la hoja de la máquina virtual, haga clic en **Conectar**. El explorador descargará un archivo .rdp para la máquina virtual. Abra el archivo .rdp
...
Si usa el portal para aprovisionar una imagen de máquina virtual de SQL Server con Resource Manager, estos pasos se llevaron a cabo de forma automática al seleccionar **Público** como opción de conectividad de SQL y habilitar la autenticación de SQL Server. Sin embargo, hay algunos pasos restantes necesarios para tener acceso a la instancia de SQL Server a través de Internet.

>[AZURE.NOTE] Si no seleccionó la opción Público durante el aprovisionamiento, son necesarios pasos adicionales para tener acceso a la instancia de SQL Server a través de Internet. Para obtener más información, consulte [Connect to a SQL Server Virtual Machine (Resource Manager) | Microsoft Azure](virtual-machines-windows-sql-connect.md) (Conexión a una máquina virtual de SQL Server (Resource Manager) | Microsoft Azure).
