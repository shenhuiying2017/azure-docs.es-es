...
5.	En la página **Agregar un extremo a una máquina virtual**, elija el tipo de extremo.
	...
	- Si está creando un nuevo extremo que no forma parte de un conjunto con equilibrio de carga o es el primer extremo en un nuevo conjunto con equilibrio de carga, elija **Agregar un extremo independiente** y haga clic en la flecha izquierda.
...
El nuevo extremo se mostrará en la página **Extremos**.
...
5.	En la barra de tareas, haga clic en **administrar ACL** para abrir el cuadro de diálogo **Especificar detalles de ACL**.
