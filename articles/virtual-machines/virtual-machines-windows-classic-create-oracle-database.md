...
En el ejemplo siguiente se muestra cómo crear una base de datos Oracle en una máquina virtual de Windows Server que ha creado anteriormente y donde ha instalado Oracle Database 12c. Hay dos pasos. En primer lugar, conecte la máquina virtual y luego cree la base de datos Oracle dentro de ella. El ejemplo mostrado es la versión de la Base de datos de Oracle 12c, pero los pasos son prácticamente idénticos para la versión 11g.
...
> [AZURE.NOTE] (Puede determinar el valor de *<<unique\_domain\_name>>* dentro del [Portal de Azure clásico](https://portal.azure.com/) haciendo clic en **Máquinas virtuales** y, luego, seleccionando la máquina virtual que está usando para ejecutar la base de datos de Oracle).
