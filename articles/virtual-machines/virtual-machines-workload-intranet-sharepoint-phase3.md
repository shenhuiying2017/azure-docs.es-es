...
En esta fase de la implementación de una granja de servidores de SharePoint 2013 de solo de intranet con grupos de disponibilidad AlwaysOn de SQL Server en servicios de infraestructura de Azure, configure los dos equipos de SQL Server y el equipo de nodo de la mayoría de clúster y, a continuación, combínelos en un clúster de Windows Server.
