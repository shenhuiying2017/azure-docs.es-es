...
| --- | --- |
| SSHKEYDATA |Datos de clave SSH utilizados para proteger el acceso a la máquina virtual. Para obtener información sobre cómo crear un par de claves SSH, consulte [Creación de claves SSH para máquinas virtuales Linux en Azure](virtual-machines-linux-mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json). |
...
[Paso 1: arquitectura de aplicaciones con plantillas de Azure Resource Manager](virtual-machines-linux-dotnet-core-2-architecture.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
