...
| --- | --- |
| SSHKEYDATA |Datos de clave SSH utilizados para proteger el acceso a la máquina virtual. Para obtener información sobre cómo crear un par de claves SSH, consulte [Creación de claves SSH para máquinas virtuales Linux en Azure](virtual-machines-linux-mac-create-ssh-keys.md). |
