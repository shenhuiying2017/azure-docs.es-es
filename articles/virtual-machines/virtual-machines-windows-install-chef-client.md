...
- Use el Portal de administración de Azure para instalar el cliente Chef cuando cree una máquina virtual que ejecute Windows Server 2012 o Windows Server 2012 R2. Para obtener instrucciones, consulte el [Portal de Microsoft Azure](https://docs.chef.io/azure_portal.html).
