...
### <a name="to-add-a-reference-to-microsoft.reportviewer.common"></a>Para agregar una referencia a Microsoft.ReportViewer.Common
...
### <a name="to-make-the-assemblies-locally-accessible-by-your-asp.net-application"></a>Para hacer que los ensamblados estén localmente disponibles para su aplicación ASP.NET
...
## <a name="publish-the-asp.net-web-application-to-azure"></a>Publicar la aplicación web ASP.NET en Azure
