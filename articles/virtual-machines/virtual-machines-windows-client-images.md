...
# <a name="using-windows-client-in-azure-for-dev/test-scenarios"></a>Uso del cliente Windows en Azure para escenarios de desarrollo y pruebas
...
Ahora puede implementar las máquinas virtuales con [PowerShell](virtual-machines-windows-ps-create.md), [plantillas de Resource Manager](virtual-machines-windows-ps-template.md) o [Visual Studio](../vs-azure-tools-resource-groups-deployment-projects-create-deploy.md).
