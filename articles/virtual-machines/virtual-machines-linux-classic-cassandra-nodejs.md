<properties 
	pageTitle="Ejecución de Cassandra con Linux en Azure | Microsoft Azure" 
...
[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)] Obtenga información acerca de cómo [realizar estos pasos con el modelo de Resource Manager](https://azure.microsoft.com/documentation/templates/datastax-on-ubuntu/).
...
![Implementación de una sola región](./media/virtual-machines-linux-classic-cassandra-nodejs/cassandra-linux1.png)
...
Use el comando “sudo waagent –deprovision+user” para quitar la información específica de la instancia de máquina virtual. Consulte [Captura de una máquina virtual de Linux para usar como plantilla](virtual-machines-linux-classic-capture-image.md). Encontrará más detalles en el proceso de captura de imagen.
