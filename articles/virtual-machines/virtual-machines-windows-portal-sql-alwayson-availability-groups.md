...
1.  En los resultados de la búsqueda, busque **Clúster AlwaysOn de SQL Server**.
...
1.  En la hoja de **ad-primary-dc** click **Conectar**. El explorador le preguntará si desea abrir o guardar el objeto de conexión remota. Haga clic en **Abrir**.
...
1.  **Escritorio remoto** puede advertirle de que el equipo remoto no se pudo autenticar debido a problemas con su certificado de seguridad. Le mostrará el nombre del certificado de seguridad. Si ha seguido el tutorial, el nombre será **ad-primary-dc.contoso.com**. Haga clic en **Sí**.
...
1.  En **Equipo**, escriba el nombre de uno de los servidores SQL Server. Escriba **sqlserver-0**en este tutorial.
