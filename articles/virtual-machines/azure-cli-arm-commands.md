...
> [!NOTE]
> Este artículo muestra los comandos de modo de Resource Manager en la CLI de Azure, que suele llamar Azure CLI 1.0. Para trabajar en el modelo de Resource Manager, también puede probar la [CLI de Azure 2.0](/cli/azure/install-az-cli2), nuestra CLI multiplataforma de última generación.
...
## <a name="azure-ad-commands-to-display-active-directory-objects"></a>Azure AD: comandos para mostrar los objetos de Active Directory
...
## <a name="azure-hdinsight-commands-to-manage-your-hdinsight-clusters"></a>hdinsight de azure: comandos para administrar sus cuentas de HDInsight
...
## <a name="azure-insights-commands-related-to-monitoring-insights-events-alert-rules-autoscale-settings-metrics"></a>azure insights: comandos relacionados con la supervisión con Insights (eventos, reglas de alerta, configuración de escalado automático, métricas)
...
Un intervalo de grupo de direcciones de back-end es el modo en que un equilibrador de carga sabe a qué recursos enrutar el tráfico de red entrante desde su punto de conexión mediante Azure Resource Manager. Una vez que se crea y denomina el intervalo de grupo de direcciones de back-end (vea el comando "azure network lb address-pool creat"), tendrá que agregar los puntos de conexión ahora definidos por un recurso denominado "network interfaces".

Para configurar el intervalo de direcciones de backend, necesitará al menos una "network interface" (vea la línea de comandos de "azure network lb nic" para más detalles).

En el ejemplo siguiente se usó una interfaz de red "nic1" creada anteriormente para crear el intervalo de grupo de direcciones de backend.
...
## <a name="azure-role-commands-to-manage-your-azure-roles"></a>azure role: comandos para administrar roles de Azure
...
## <a name="azure-storage-commands-to-manage-your-storage-objects"></a>azure storage: comandos para administrar los objetos de Almacenamiento
...
## <a name="azure-tag-commands-to-manage-your-resource-manager-tag"></a>azure tag: comandos para administrar etiquetas del administrador de recursos
