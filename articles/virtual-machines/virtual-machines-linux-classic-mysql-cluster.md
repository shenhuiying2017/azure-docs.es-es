...
---
# <a name="using-load-balanced-sets-to-clusterize-mysql-on-linux"></a>Uso de conjuntos de carga equilibrada para crear clústeres en MySQL en Linux
[!INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)]

Para obtener una plantilla de Resource Manager para implementar un clúster de MySQL, consulte [aquí](https://azure.microsoft.com/documentation/templates/mysql-replication/).
...
## <a name="setting-up-the-cluster"></a>Configuración del clúster
...
### <a name="setting-up-drbd"></a>Configuración de DRBD
...
### <a name="creating-the-mysql-load-balanced-set"></a>Creación del conjunto de carga equilibrada de MySQL
...
### <a name="testing-the-load-balanced-set"></a>Prueba del conjunto de carga equilibrada
...
## <a name="setting-up-corosync"></a>Configuración de Corosync
...
## <a name="setting-up-pacemaker"></a>Configuración de Pacemaker
