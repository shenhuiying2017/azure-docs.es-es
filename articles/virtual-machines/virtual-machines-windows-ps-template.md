...
### Paso 5: Creación de recursos con la plantilla y los parámetros
...
2. Implemente la plantilla.
    ...
    >[AZURE.NOTE] También puede implementar las plantillas y los parámetros desde una cuenta de Almacenamiento de Azure. Para más información, consulte [Usar Azure PowerShell con Almacenamiento de Azure](../storage-powershell-guide-full.md).
