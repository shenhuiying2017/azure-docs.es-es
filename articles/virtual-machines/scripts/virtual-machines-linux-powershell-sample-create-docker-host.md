...
Este script de ejemplo crea una máquina virtual y, a continuación, usa la extensión de máquina virtual de Azure Docker para configurar un host de Docker. Después, la extensión de máquina virtual de Docker crea un contenedor que ejecuta NGINX. Por último, el script configura un grupo de seguridad de red de Azure para todo el tráfico entrante en el puerto 80. Una vez que el script se ha ejecutado correctamente, el servidor web NGINX es accesible mediante el FQDN de la máquina virtual de Azure. 
