...
[!code-powershell[main](../../../powershell_scripts/virtual-machine/create-vm-from-snapshot/create-vm-from-snapshot.ps1 "Creación de máquinas virtuales a partir de una instantánea")]
