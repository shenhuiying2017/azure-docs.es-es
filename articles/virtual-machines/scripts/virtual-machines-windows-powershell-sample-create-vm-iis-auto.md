---
title: "Uso de New-AzVM para crear una máquina virtual IIS en Azure | Microsoft Docs"
description: "Ejemplo de script de Azure PowerShell: creación de una máquina virtual que ejecuta IIS con New-AzVM."
...
---
# <a name="create-an-iis-vm-using-the-new-azvm-powershell-cmdlet-preview"></a>Creación de una máquina virtual IIS con el cmdlet New-AzVM de PowerShell (versión preliminar)
