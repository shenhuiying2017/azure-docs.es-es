...
Para obtener información sobre cómo usar la extensión de scripts personalizada con plantillas, vea la documentación [aquí](virtual-machines-extensions-customscript -with template.md).
