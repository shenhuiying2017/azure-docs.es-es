...
## <a id='Docker and Linux Containers'></a>Contenedores Docker y Linux
...
## <a id='Virtual Machine Extensions for Linux and Windows'></a>Extensiones de máquina virtual para Linux y Windows
