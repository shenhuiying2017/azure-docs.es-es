<properties 
	pageTitle="Preparación de una máquina virtual Oracle Linux para Azure" 
	description="Lleve a cabo la configuración de una máquina virtual de Oracle con Linux en Microsoft Azure." 
