<properties
	pageTitle="Migrar una base de datos local a SQL Server en una máquina virtual de Azure"
...
Existen varios métodos para migrar una base de datos de usuario de SQL Server local a SQL Server en una máquina virtual de Azure. En este se tratarán brevemente diversos métodos, se recomendará el mejor método para diversos escenarios y se incluirá un tutorial que le guiará a través del uso del Asistente para implementación de una base de datos de SQL Server en una máquina virtual de Microsoft Azure.
...
> [AZURE.NOTE]Si tiene una implementación AlwaysOn local, también puede usar el [Asistente para agregar réplica de Azure](https://msdn.microsoft.com/library/dn463980.aspx) para crear una réplica en Azure y, a continuación, usar la conmutación por error como un método de migración.
...
- Configure la máquina virtual de Azure y la instancia de SQL Server para habilitar la conectividad desde otro equipo, para lo que debe seguir los pasos de la sección Finalizar los pasos de configuración para conectarse a la máquina virtual con SQL Server Management Studio en otro equipo de [Aprovisionamiento de una máquina virtual de SQL Server en Azure](../virtual-machines-provision-sql-server/#SSMS). Si la migración se realiza con el asistente, solo se admitirán las imágenes de SQL Server 2014 y SQL Server 2016 de la galería.
