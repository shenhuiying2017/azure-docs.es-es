...
- **Tamaño de unidad de asignación de NTFS**: al aplicar formato al disco de datos, se recomienda usar un tamaño de unidad de asignación de 64 KB para los archivos de datos y de registro, además de TempDB.
