...
![Aplicación de revisión automática de SQL en el Portal de Azure](./media/virtual-machines-windows-classic-ps-sql-patch/IC778484.jpg)
...
![Configuración de Aplicación de revisión automatizada en el Portal de Azure](./media/virtual-machines-windows-classic-ps-sql-patch/IC792132.jpg)
...
Una característica relacionada de las máquinas virtuales de SQL Server es la [Copia de seguridad automatizada para SQL Server en Máquinas virtuales de Azure](virtual-machines-windows-classic-ps-sql-backup.md).
