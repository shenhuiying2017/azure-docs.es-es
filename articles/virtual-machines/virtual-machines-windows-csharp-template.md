...
- Crear un grupo de recursos mediante [Azure PowerShell](../resource-group-template-deploy.md), [CLI de Azure](../resource-group-template-deploy-cli.md) o [Azure Portal](../resource-group-template-deploy-portal.md).
