---
title: "SAP NetWeaver en máquinas virtuales (VM) Windows: guía de implementación | Microsoft Docs"
description: "SAP NetWeaver en máquinas virtuales (VM) Windows: guía de implementación"
...
---
# <a name="sap-netweaver-on-windows-virtual-machines-vms--deployment-guide"></a>SAP NetWeaver en máquinas virtuales (VM) Windows: guía de implementación
...
* [SAP NetWeaver en máquinas virtuales (VM) Windows: guía de implementación (este documento)][deployment-guide]
...
3. Settings
   ...
   4. Grupo de seguridad de red: consulte [¿Qué es un grupo de seguridad de red?][virtual-networks-nsg] para más detalles.
...
### <a name="a-name31d9ecd6-b136-4c73-b61e-da4a29bbc9ccajoin-vm-into-on-premises-domain-windows-only"></a><a name="31d9ecd6-b136-4c73-b61e-da4a29bbc9cc"></a>Unión de una VM a un dominio local (solo Windows)
