...
Después de agregar el disco, debe prepararlo para poder usarlo. Para obtener más información, consulte [Inicio de un nuevo disco de datos](linux/classic/attach-disk.md#initialize-a-new-data-disk-in-linux).
