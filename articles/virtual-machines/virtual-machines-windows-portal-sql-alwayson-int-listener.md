---
title: Creación de un agente de escucha para un grupo de disponibilidad AlwaysOn de SQL Server en máquinas virtuales de Azure
...
2. Compruebe la conexión con la utilidad **sqlcmd**. Por ejemplo, el siguiente script establece una conexión **sqlcmd** con la réplica principal a través del agente de escucha utilizando la autenticación de Windows:
