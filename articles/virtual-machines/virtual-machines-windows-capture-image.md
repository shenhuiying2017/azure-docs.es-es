...
Para administrar la nueva máquina virtual con Azure PowerShell, lea [Administración de máquinas virtuales con Azure Resource Manager y PowerShell](virtual-machines-windows-ps-manage.md).
