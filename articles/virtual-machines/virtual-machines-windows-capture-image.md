---
title: Crear una imagen de máquina virtual desde una máquina virtual de Azure | Microsoft Docs
...
En esta sección se muestra cómo generalizar la máquina virtual de Windows para que se pueda usar como una imagen. Cree una copia de seguridad de la VM antes de ejecutar Sysprep.

> [!WARNING]
> No puede iniciar sesión en la máquina virtual a través de RDP una vez que se ha generalizado, dado que el proceso elimina todas las cuentas de usuario. Los cambios son irreversibles.
> 
> 
...
> [!NOTE]
> La máquina virtual debe estar en la misma cuenta de almacenamiento que el VHD original.
> 
> 
