...
El servicio de metadatos de instancia tiene versiones. Las versiones son obligatorias y la versión actual es `2017-04-02`.
...
platformUpdateDomain |  El [dominio de actualización](virtual-machines-windows-manage-availability.md) en que se ejecuta la máquina virtual.
platformFaultDomain | El [dominio de error](virtual-machines-windows-manage-availability.md) en que se ejecuta la máquina virtual.
...
- Obtenga más información sobre la API [scheduledevents](virtual-machines-scheduled-events.md) **en Versión preliminar pública** proporcionada por el servicio de metadatos de la instancia.
