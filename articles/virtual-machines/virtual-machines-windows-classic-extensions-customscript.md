...
Vínculo:[AZURE.INCLUDE [learn-about-deployment-models](../../includes/learn-about-deployment-models-classic-include.md)] [Resource Manager model](virtual-machines-extensions-customscript.md).
...
Vea la documentación [aquí](virtual-machines-extensions-customscript.md) para obtener información sobre el uso de la extensión de scripts personalizados con plantillas del Administrador de recursos de Azure.
