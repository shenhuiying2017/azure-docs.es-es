<properties
   ...
   description="Obtenga información acerca de cómo crear una implementación de varias máquinas virtuales con la CLI de Azure y el modelo de implementación clásica."
