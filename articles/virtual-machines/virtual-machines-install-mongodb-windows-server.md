...
> [AZURE.NOTE]Al crear la máquina virtual, puede agregar un extremo para MongoDB y configurarlo como se indica a continuación: asígnele el nombre **Mongo**, utilice el protocolo **TCP** y establezca los puertos públicos y privados en **27017**.
...
Para obtener instrucciones sobre la inicialización del disco, consulte "Procedimiento: un nuevo disco de datos en Windows Server" en [Acoplamiento de un disco de datos a una máquina virtual de Windows](storage-windows-attach-disk.md).
...
##Resumen
En este tutorial se ha facilitado información acerca de cómo crear una máquina virtual con Windows Server, conectarse a ella de forma remota y acoplar un disco de datos. También se ha descrito cómo instalar y configurar MongoDB en la máquina virtual con Windows. Ahora es posible acceder a MongoDB en la máquina virtual Windows. Para ello, es preciso seguir los temas avanzados de la [documentación de MongoDB][MongoDocs].
