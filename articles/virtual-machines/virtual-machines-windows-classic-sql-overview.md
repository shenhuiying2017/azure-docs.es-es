...
Para determinar la mejor configuración de la máquina virtual para la imagen de SQL Server, revise [Prácticas recomendadas para mejorar el rendimiento de SQL Server en máquinas virtuales de Azure](virtual-machines-windows-classic-sql-perf.md). Para cargas de trabajo de producción, **DS3** y **DS2** son los tamaños de máquina virtual mínimos recomendados para las ediciones SQL Server Enterprise y Standard, respectivamente.

Además de revisar las prácticas recomendadas para mejorar el rendimiento, otras tareas iniciales incluyen lo siguiente:

- [Revisar los procedimientos recomendados para mejorar la seguridad de SQL Server en máquinas virtuales de Azure](virtual-machines-windows-classic-sql-security.md)
- [Configurar la conectividad.](virtual-machines-windows-sql-connect.md)

### Migración de los datos

Una vez puesta en marcha la máquina virtual de SQL Server, podrá migrar bases de datos existentes al equipo. Existen varias técnicas, pero el asistente para implementación en SQL Server Management Studio funciona bien en la mayoría de los escenarios. Para obtener una explicación de los escenarios y un tutorial del asistente, consulte [Migración de una base de datos a SQL Server en una máquina virtual de Azure](virtual-machines-windows-classic-migrate-sql.md).
...
- [Configuración de los grupos de disponibilidad AlwaysOn en Azure (GUI)](virtual-machines-windows-classic-portal-sql-availability.md)
...
- [Ampliación de los grupos de disponibilidad AlwaysOn locales a Azure](virtual-machines-windows-classic-sql-onprem-availability.md)

Para otras consideraciones sobre alta disponibilidad, consulte [Alta disponibilidad y recuperación ante desastres para SQL Server en Máquinas virtuales de Azure](virtual-machines-windows-classic-sql-dr.md).
...
|Discos|El tamaño seleccionado limita el número de discos de datos que se puede configurar. Consulte [Tamaños de máquina virtual de Azure](virtual-machines-linux-sizes.md).|
...
|Grupos de disponibilidad AlwaysOn|Disponible en SQL Server 2012 o versiones posteriores. Requiere [Configuración adicional](virtual-machines-windows-classic-sql-dr.md).
...
- [Aprovisionamiento de una máquina virtual de SQL Server en Azure (Administrador de recursos)](virtual-machines-windows-portal-sql-server-provision.md)
...
- [Alta disponibilidad y recuperación ante desastres para SQL Server en máquinas virtuales de Azure](virtual-machines-windows-classic-sql-dr.md)
