---
title: "Montaje de Azure File Storage en máquinas virtuales Linux con SMB y la CLI de Azure 1.0 | Microsoft Docs"
...
# <a name="mount-azure-file-storage-on-linux-vms-using-smb-using-the-azure-cli-10"></a>Montaje de Azure File Storage en máquinas virtuales Linux con SMB y la CLI de Azure 1.0
...
- [CLI de Azure 2.0 (versión preliminar)](virtual-machines-linux-mount-azure-file-storage-on-linux-using-smb-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json): la CLI de última generación para el modelo de implementación de Resource Manager
