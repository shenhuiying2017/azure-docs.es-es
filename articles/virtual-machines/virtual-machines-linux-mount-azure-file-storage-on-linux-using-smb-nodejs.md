...
* [Archivos de clave pública y privada Secure Shell (SSH)](virtual-machines-linux-mac-create-ssh-keys.md)
...
- [CLI de Azure 2.0](virtual-machines-linux-mount-azure-file-storage-on-linux-using-smb-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json): la CLI de última generación para el modelo de implementación de Resource Manager


## <a name="quick-commands"></a>Comandos rápidos
Para realizar la tarea rápidamente, siga los pasos descritos en esta sección. Para más información y contexto, comience en la sección ["Tutorial detallado"](virtual-machines-linux-mount-azure-file-storage-on-linux-using-smb.md#detailed-walkthrough).
...
- [Cifrado de discos en una VM Linux mediante la CLI de Azure](virtual-machines-linux-encrypt-disks.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
