...
2. En el menú Concentrador, haga clic en **Nuevo** > **Proceso** > **Servidor de Ubuntu 14.04 LTS**.
	...
	![elegir una imagen de VM](media/virtual-machines-linux-portal-create/chooseubuntuvm.png)

	> [AZURE.TIP] Para encontrar otras imágenes, haga clic en **Marketplace** y luego busque o filtre los elementos disponibles.

3. En la parte inferior de la página **Servidor de Ubuntu 14.04 LTS**, seleccione **Usar la pila del Administrador de recursos** para crear la máquina virtual en el Administrador de recursos de Azure. Tenga en cuenta que para la mayoría de las cargas de trabajo nueva, se recomienda la pila del Administrador de recursos. Para más información, vea [Proveedores de procesos, redes y almacenamiento de Azure en el Administrador de recursos de Azure](virtual-machines-windows-compare-deployment-models.md).

4. Luego haga clic en ![botón Crear](media/virtual-machines-linux-portal-create/createbutton.png).

	![cambiar a la pila de procesos de administrador de recursos](media/virtual-machines-linux-portal-create/changetoresourcestack.png)
...
![resumen de la creación correcta](media/virtual-machines-linux-portal-create/successresultwithip.png)
...
> [AZURE.NOTE] También puede configurar un nombre de dominio completo (FQDN) para la máquina virtual en el portal. Lea más información sobre la [creación de FQDN en el portal](virtual-machines-linux-portal-create-fqdn.md).
...
- [Uso de las herramientas de línea de comandos de Azure para Mac y Linux](azure-cli-arm-commands.md)

- [Implementación de una aplicación LAMP con la extensión CustomScript para Linux](virtual-machines-linux-classic-lamp-script.md)

- [Extensión de máquina virtual Docker para Linux en Azure](virtual-machines-linux-dockerextension.md)
