...
3. En la página **Elegir una imagen**, haga clic en **SQL SERVER**. A continuación, seleccione una imagen de SQL Server. Haga clic en la flecha siguiente de la parte inferior derecha de la página.
	...
	![Elegir una imagen](./media/virtual-machines-windows-classic-portal-sql/choose-sql-vm.png)

Para obtener la información más actualizada sobre las imágenes compatibles de SQL Server en Azure, consulte el tema [Introducción a SQL Server en máquinas virtuales de Azure](virtual-machines-windows-classic-sql-overview.md).
...
4. En la primera página de **Configuración de máquina virtual**, facilite la siguiente información:
	...
	![Configuración de MV](./media/virtual-machines-windows-classic-portal-sql/4VM-Config.png)

	>[AZURE.NOTE] El tamaño de la máquina virtual se especifica durante el aprovisionamiento:
 	>
	> - Para las cargas de trabajo de producción, se recomienda usar Almacenamiento premium con los siguientes tamaños mínimos recomendados: **DS3** para la edición SQL Server Enterprise y **DS2** para la edición SQL Server Standard. Para obtener más información, consulte [Prácticas recomendadas de rendimiento para SQL Server en máquinas virtuales de Azure](virtual-machines-windows-classic-sql-perf.md).
	> - El tamaño seleccionado limita el número de discos de datos que se puede configurar. Para obtener la información más actualizada sobre los tamaños disponibles de máquina virtual y la cantidad de discos de datos que puede adjuntar a una máquina virtual, consulte [Tamaños de máquina virtual para Azure](virtual-machines-linux-sizes.md).
...
2. Haga clic en el botón **Abrir**.
	...
	![Haga clic en el botón Abrir](./media/virtual-machines-windows-classic-portal-sql/click-open-to-connect.png)

3. En el cuadro de diálogo **Windows Security**, haga clic en **Usar otra cuenta**.

	![Hacer clic en Usar otra cuenta](./media/virtual-machines-windows-classic-portal-sql/credentials.png)
...
Los pasos siguientes muestran cómo conectarse a la instancia de SQL Server a través de Internet mediante SQL Server Management Studio (SSMS). Sin embargo, se aplican los mismos pasos para hacer que la máquina virtual de SQL Server sea accesible para sus aplicaciones, tanto locales como en el modelo de implementación clásica de Azure. Si la máquina virtual se implementa en el modelo de Resource Manager, consulte [Conexión a una máquina virtual de SQL Server en Azure (Resource Manager)](virtual-machines-windows-sql-connect.md).
...
- [Conexión a una máquina virtual de SQL Server en Azure](virtual-machines-windows-classic-sql-connect.md)

- [Procedimientos recomendados para SQL Server en Máquinas virtuales de Azure](virtual-machines-windows-classic-sql-perf.md)

- [Consideraciones de seguridad para SQL Server en Máquinas virtuales de Azure](virtual-machines-windows-classic-sql-security.md)
...
- [Copias de seguridad y restauración para SQL Server en Máquinas virtuales de Azure](virtual-machines-windows-classic-sql-br.md)
