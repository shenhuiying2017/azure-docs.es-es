...
> [!NOTE]
> Ya debe tener una VM de Microsoft Azure que ejecuta Linux. Para crear y configurar una VM Linux, consulte el [tutorial de máquinas virtuales Linux de Azure](virtual-machines-linux-classic-createportal.md).
> 
> 
...
Si no sabe cómo configurar el extremo en su VM, consulte la [guía](virtual-machines-linux-classic-setup-endpoints.md).
