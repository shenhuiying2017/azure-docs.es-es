<properties
	...
	description="Explica la característica Copia de seguridad automatizada para SQL Server que se ejecuta en máquinas virtuales de Azure mediante el modelo de implementación clásica."
...
Una característica relacionada de las máquinas virtuales de SQL Server es la [Aplicación de revisiones automatizada para SQL Server en Máquinas virtuales de Azure](virtual-machines-windows-classic-sql-automated-patching.md).
