...
> * [Clásico](virtual-machines-linux-classic-restart-resize-error-troubleshooting.md)
...
En el Portal de Azure, haga clic en **Examinar** > **Máquinas virtuales** > *su máquina virtual de Linux* > **Configuración** > **Registros de auditoría**.
...
## Pasos siguientes
Si surgen problemas al crear una nueva máquina virtual Linux en Azure, consulte [Solución de problemas de la implementación de Resource Manager con la creación de una nueva máquina virtual de Linux en Azure](virtual-machines-linux-troubleshoot-deployment-new-vm.md).
