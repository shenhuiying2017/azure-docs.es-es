...
> [!IMPORTANT]
> Después de realizar el procedimiento siguiente, hay un blob único que permanece en el contenedor de VHD predeterminado. El nombre del archivo es "VMName.xxxxxxx.status". Este archivo se crea en Azure solo cuando se ha instalado [extensiones de VM](windows/classic/agents-and-extensions.md) en la máquina virtual. No elimine este objeto de estado de mantenimiento restante. En futuros trabajos se abordará este problema.
