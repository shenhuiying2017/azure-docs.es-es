...
Los individuos pueden elegir también basar sus soluciones en imágenes personalizadas que crean desde cero en Azure o cargar sus imágenes personalizadas de sus entornos locales.

## <a name="support-for-jd-edwards"></a>Compatibilidad con JD Edwards
De acuerdo con la nota de compatibilidad de Oracle con el [id. de documento 2178595.1](https://support.oracle.com/epmos/faces/DocumentDisplay?_afrLoop=573435677515785&id=2178595.1&_afrWindowMode=0&_adf.ctrl-state=o852dw7d_4), las versiones de JD Edwards EnterpriseOne 9.2 y superiores se admiten en **cualquier oferta de nube pública** que satisfaga sus `Minimum Technical Requirements` (MTR) específicos.  Deberá crear imágenes personalizadas que cumplan sus especificaciones de MTR para la compatibilidad con el sistema operativo y la aplicación de software. 
...
A pesar de tener una solución de alta disponibilidad y recuperación ante desastres diseñada en Azure, deberá asegurarse de contar con una estrategia de copia de seguridad para restaurar la base de datos.  En el tutorial [Backup and recover an Oracle Database](oracle-backup-recovery.md) (Copia de seguridad y recuperación de una instancia de Oracle Database) se describe el procedimiento básico para establecer una copia de seguridad coherente.
...
Ahora tiene una visión general de las soluciones actuales de Oracle en Microsoft Azure. El siguiente paso es ir e implementar su primera instancia de Oracle Database en Azure.
