...
- Más información sobre [disponibilidad de SAP HANA dentro de una región de Azure](https://docs.microsoft.com/en-us/azure/virtual-machines/workloads/sap/sap-hana-availability-one-region).
- Más información sobre [disponibilidad de SAP HANA entre regiones de Azure](https://docs.microsoft.com/en-us/azure/virtual-machines/workloads/sap/sap-hana-availability-across-regions). 
