...
---
# <a name="sap-netweaver-on-azure-virtual-machines--dbms-deployment-guide"></a>SAP NetWeaver en Azure Virtual Machines: guía de implementación de DBMS
...
* Herramientas de terceros para obtener una explicación más completa de Backup y SAP en Azure, consulte [la Guía de copia de seguridad de SAP](sap-hana-backup-guide.md) para más información.
