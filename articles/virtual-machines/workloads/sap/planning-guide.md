...
> ![Linux][Logo_Linux] Linux
>
> [Captura de una máquina virtual Linux para usarla como plantilla de Resource Manager][/linux/capture-image.md#step-2-create-vm-image]
>
>
...
* Utilice *Sysprep* en Windows o *waagent -deprovision* en Linux para generalizar la máquina virtual (vea [Referencia técnica de Sysprep](https://technet.microsoft.com/library/cc766049.aspx) para Windows o [Captura de una máquina virtual Linux para usarla como plantilla de Resource Manager][/linux/capture-image.md#step-2-create-vm-image] para Linux).
* Inicie sesión en su suscripción con *Login-AzureRmAccount*
* Establezca la suscripción de su contexto con *Set-AzureRmContext* y el parámetro SubscriptionId o SubscriptionName (consulte <https://msdn.microsoft.com/library/mt619263.aspx>).
* Cargue el disco duro virtual con *Add-AzureRmVhd* en una cuenta de Azure Storage (consulte, <https://msdn.microsoft.com/library/mt603554.aspx>).
