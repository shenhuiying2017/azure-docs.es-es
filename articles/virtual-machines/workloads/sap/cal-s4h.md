...
![Captura de pantalla de la ventana Soluciones de SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic-1b.jpg)
...
![Captura de pantalla de la ventana Cuentas de SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic-2.jpg)
...
![Captura de pantalla de la ventana Cuentas de SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic3b.jpg)
...
![Captura de pantalla del Portal de Azure clásico](./media/cal-s4h/s4h-pic4b.jpg)
...
![Captura de pantalla de la pestaña Certificados de administración del Portal de Azure clásico](./media/cal-s4h/s4h-pic5.jpg)

Aparece un cuadro de diálogo para seleccionar el archivo de certificado descargado.

![Captura de pantalla del cuadro de diálogo Cargar un certificado de administración](./media/cal-s4h/s4h-pic8.jpg)
...
![Captura de pantalla de la ventana Cuentas de SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic9.jpg)
...
![Captura de pantalla de la ventana Soluciones de SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic10.jpg)
...
![Captura de pantalla de la ventana Instancias de SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic11.jpg)
...
![Captura de pantalla de la ventana Instancias de SAP Cloud Appliance Library](./media/cal-s4h/s4h-pic12.jpg)
...
![Captura de pantalla que muestra tres máquinas virtuales en el Portal de Azure clásico](./media/cal-s4h/s4h-pic13.jpg)
...
![Captura de pantalla del cuadro de diálogo Conectar con instancia](./media/cal-s4h/s4h-pic14b.jpg)
...
![Captura de pantalla de la GUI de SAP configuradas previamente](./media/cal-s4h/s4h-pic15.jpg)
