...
* Cree una unidad de disco duro de .VHD que contenga informes y luego cargue y conecte la unidad.
  ...
  3. Cargue el archivo VHD en Azure mediante el cmdlet Add-AzureVHD [Crear y cargar un VHD de Windows Server a Azure](virtual-machines-windows-classic-createupload-vhd.md).
