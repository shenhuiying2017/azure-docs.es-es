...
También puede usar una plantilla del Administrador de recursos de Azure. Consulte [SharePoint](virtual-machines-linux-app-frameworks.md).
...
También puede usar una plantilla del Administrador de recursos de Azure. Consulte [Implementación de una granja de nueve servidores de SharePoint](virtual-machines-windows-app-frameworks.md#deploy-a-nine-server-sharepoint-farm).
