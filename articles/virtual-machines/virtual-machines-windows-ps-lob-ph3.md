...
Recuerde que definió la tabla M en [Fase 2](virtual-machines-windows-ps-lob-ph2.md) y las tablas V, S, ST y A en [Fase 1](virtual-machines-windows-ps-lob-ph1.md).
...
9.	En **Nombre de inicio de sesión**, escriba *dominio*\\sqladmin (donde *dominio* es el nombre del dominio en el que se creó la cuenta sqladmin en [Fase 2](virtual-machines-windows-ps-lob-ph2.md)). 
...
1.	Inicie sesión en la máquina virtual principal de SQL Server con la cuenta sqladmin que creó en [Fase 2](virtual-machines-windows-ps-lob-ph2.md).
