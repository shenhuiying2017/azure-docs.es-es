...
Actualmente, solo se admite la clave RSA SSH. Una clave SSH de varias líneas tiene que empezar con "---- BEGIN SSH2 PUBLIC KEY ----" y terminar con "---- END SSH2 PUBLIC KEY ----".
...
* Si desea incorporar su propio FreeBSD a Azure, consulte [Creación y carga de un VHD de FreeBSD en Azure](../virtual-machines-linux-classic-freebsd-create-upload-vhd.md?toc=%2fazure%2fvirtual-machines%2flinux%2fclassic%2ftoc.json).
