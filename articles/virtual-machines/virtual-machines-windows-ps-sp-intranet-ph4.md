...
Debe completar esta fase antes de pasar a la [fase 5](virtual-machines-windows-ps-sp-intranet-ph5.md). Consulte [Implementación de SharePoint con grupos de disponibilidad AlwaysOn de SQL Server en Azure](virtual-machines-windows-sp-intranet-overview.md) para ver todas las fases.
...
Después del reinicio, use el procedimiento [Inicio de sesión en una máquina virtual con una conexión a Escritorio remoto](virtual-machines-windows-ps-sp-intranet-ph2.md#logon) cuatro veces, una vez para cada servidor de SharePoint, para iniciar sesión con las credenciales de cuenta [Domain]\\sp\_farm\_db. Ha creado estas credenciales en [Fase 2: configuración de controladores de dominio](virtual-machines-windows-ps-sp-intranet-ph2.md).

Use el procedimiento [Para probar la conectividad](virtual-machines-windows-ps-sp-intranet-ph2.md#testconn) cuatro veces, uno para cada servidor de SharePoint, para probar la conectividad en las ubicaciones de la red de la organización.
...
5.	En la página **Especificar las opciones de la base de datos de configuración**:
 ...
 - En **Nombre de usuario**, escriba [dominio]** \\sp\_farm\_db** (creado en [Fase 2: Configuración de controladores de dominio](virtual-machines-windows-ps-sp-intranet-ph2.md)). Recuerde que la cuenta de sp\_farm\_db tiene privilegios de sysadmin en el servidor de la base de datos.
