...
Ahora, cree una máquina virtual con [az vm create](/cli/azure/vm#az_vm_create) y especifique el archivo de script bash con `--custom-data simple_bash.sh` como se indica a continuación:
