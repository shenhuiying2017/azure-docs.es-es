...
Para trabajar a través de un ejemplo en el cual se usa una extensión de máquina virtual en una implementación completa de la aplicación, consulte [Automatización de implementaciones de aplicaciones en Azure Virtual Machines](../windows/dotnet-core-1-landing.md).
...
Para obtener más información, consulte [Creación de plantillas de Azure Resource Manager con extensiones de máquina virtual Linux](../windows/extensions-authoring-templates.md).
