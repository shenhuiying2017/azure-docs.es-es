...
* También necesitará [instalar la CLI de Azure](../../../cli-install-nodejs.md) y [conectarse a su suscripción](/cli/azure/authenticate-azure-cli) para usar recursos de Azure asociados a su cuenta.
