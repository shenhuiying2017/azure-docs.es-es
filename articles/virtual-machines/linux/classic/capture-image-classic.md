...
9. La nueva imagen ahora está disponible en la lista de imágenes que pueden usarse para configurar nuevas VM. Puede visualizarla mediante el comando:
   ...
   En [Azure Portal](http://portal.azure.com), la nueva imagen aparece en las **imágenes de máquina virtual (clásicas)** que pertenece a los servicios de **Proceso**. Para tener acceso a **Imágenes de la VM (clásico)**, puede hacer clic en **Todos los servicios** en la parte superior de la lista de servicios de Azure y, a continuación, busque los servicios de **Proceso**.   
...
**Consulte también:**[Guía de usuario del Agente de Linux de Azure](../../extensions/agent-linux.md).
