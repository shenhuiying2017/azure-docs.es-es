...
![Sitio NGINX predeterminado](./media/tutorial-manage-vm/nginx.png)  
...
Este tutorial crea una sola máquina virtual con los recursos individuales de Azure. El siguiente tutorial parte de estos conceptos para crear una aplicación de alta disponibilidad, carga equilibrada y resistente a los eventos de mantenimiento. Continúe con el siguiente tutorial: [Build a load balanced, highly available application on Linux virtual machines in Azure](tutorial-load-balance-nodejs.md) (Creación de una aplicación con equilibrio de carga y de alta disponibilidad en máquinas virtuales Linux en Azure).

Ejemplos: [Scripts de ejemplo de CLI de Azure](../windows/cli-samples.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
