...
---
# <a name="how-to-create-a-linux-vm-using-an-azure-resource-manager-template"></a>Creación de una máquina virtual Linux mediante una plantilla de Azure Resource Manager
