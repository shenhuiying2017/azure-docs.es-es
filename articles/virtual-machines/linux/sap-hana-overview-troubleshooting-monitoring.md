...
![En SAP HANA Studio, vaya a Consola de administración: Alertas: Mostrar: Todas las alertas.](./media/sap-hana-overview-troubleshooting-monitoring/image1-show-alerts.png)
...
![Restablecer el umbral al valor predeterminado o a un valor más razonable](./media/sap-hana-overview-troubleshooting-monitoring/image2-cpu-utilization.png)
...
![Uso de CPU mostrado en la pantalla de información general](./media/sap-hana-overview-troubleshooting-monitoring/image3-cpu-usage.png)

El gráfico Carga podría mostrar un uso de CPU elevado o un uso de elevado en el pasado:

![El gráfico Carga podría mostrar un uso de CPU elevado o un uso de elevado en el pasado](./media/sap-hana-overview-troubleshooting-monitoring/image4-load-graph.png)
...
![En la pestaña Volúmenes de SAP HANA Studio, puede ver los volúmenes conectados y los utilizados por cada servicio](./media/sap-hana-overview-troubleshooting-monitoring/image5-volumes-tab-a.png)
...
![Para los volúmenes conectados, en la parte inferior de la pantalla puede ver los detalles de los volúmenes, como los archivos y las estadísticas de E/S](./media/sap-hana-overview-troubleshooting-monitoring/image6-volumes-tab-b.png)
...
![En SAP HANA Studio, en la pestaña System Information (Información del sistema), haga clic en la columna Name (Nombre) y seleccione Import SQL Statements (Instrucciones SQL de importación)](./media/sap-hana-overview-troubleshooting-monitoring/image7-import-statements-a.png)
...
![La instrucción SQL completa se abre, lo que permite cambiar y, después, ejecutar los parámetros de entrada (sección de modificación)](./media/sap-hana-overview-troubleshooting-monitoring/image8-import-statements-b.png)
...
![Otro ejemplo es hacer clic en las instrucciones en Replication: Overview (Replicación: Información general). Seleccione Execute (Ejecutar) en el menú contextual](./media/sap-hana-overview-troubleshooting-monitoring/image9-import-statements-c.png)

Esto genera información que ayuda a solucionar el problema:

![Esto generará información que ayudará a solucionar el problema](./media/sap-hana-overview-troubleshooting-monitoring/image10-import-statements-d.png)
...
![HANA\_Configuration\_MiniChecks\_Rev102.01+1 para comprobaciones general de SAP HANA](./media/sap-hana-overview-troubleshooting-monitoring/image11-configuration-minichecks.png)

**HANA\_Services\_Overview** para información general sobre los servicios de SAP HANA que se están ejecutando.

![HANA\_Services\_Overview para información general sobre los servicios de SAP HANA que se están ejecutando](./media/sap-hana-overview-troubleshooting-monitoring/image12-services-overview.png)

**HANA\_Services\_Statistics**para información sobre los servicio de SAP HANA (CPU, memoria, etc.).

![HANA\_Services\_Statistics para información sobre los servicio de SAP HANA ](./media/sap-hana-overview-troubleshooting-monitoring/image13-services-statistics.png)

**HANA\_Configuration\_Overview\_Rev110+** para información general sobre la instancia de SAP HANA.

![HANA\_Configuration\_Overview\_Rev110+ para información general sobre la instancia de SAP HANA](./media/sap-hana-overview-troubleshooting-monitoring/image14-configuration-overview.png)

**HANA\_Configuration\_Parameters\_Rev70+** para comprobar los parámetros de SAP HANA.

![HANA\_Configuration\_Parameters\_Rev70+ para comprobar los parámetros de SAP HANA](./media/sap-hana-overview-troubleshooting-monitoring/image15-configuration-parameters.png)
