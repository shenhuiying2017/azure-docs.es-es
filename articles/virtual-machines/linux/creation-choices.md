...
Los ejemplos siguientes usan la CLI de Azure 2.0. Para más información acerca de los distintos comandos que se muestran, lea cada uno de los artículos. También puede encontrar ejemplos de las opciones de creación de Linux mediante la [CLI de Azure 1.0](creation-choices-nodejs.md).

* [Creación de una máquina virtual Linux desde cero con la CLI de Azure 2.0](quick-create-cli.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json)
