---
title: "Implementación de un clúster Deis de 3 nodos | Microsoft Docs"
...
* Un identificador profesional o educativo para usar grupos de recursos de Azure. Si tiene una cuenta personal e inicia sesión con un identificador de Microsoft, deberá [crear un identificador profesional a partir del suyo personal](../windows/create-aad-work-id.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
* Dependiendo de su sistema operativo de cliente, bien [Azure PowerShell](/powershell/azureps-cmdlets-docs) bien la [CLI de Azure para Mac, Linux y Windows](../../cli-install-nodejs.md).
...
9. Modifique el parámetro **publicDomainName**. Esto pasará a formar parte del nombre DNS asociado con la IP pública del equilibrador de carga. El FQDN final tendrá el formato de *[valor de este parámetro]*.*[región]*.cloudapp.azure.com. Por ejemplo, si especifica el nombre como deishbai32 y el grupo de recursos se implementa en la región Oeste de EE. UU., el FQDN final del equilibrador de carga final será deishbai32.westus.cloudapp.azure.com.
...
11. Una vez que se ha aprovisionado el grupo de recursos, puede ver todos los recursos del grupo en el Portal de Azure clásico. Como se muestra en la siguiente captura de pantalla, el grupo de recursos contiene una red virtual con tres máquinas virtuales que se han unido al mismo conjunto de disponibilidad. El grupo también contiene un equilibrador de carga, que tiene una dirección IP pública asociada.
    ...
    ![Grupo de recursos aprovisionado en el Portal de Azure clásico](./media/deis-cluster/resource-group.png)
...
![Reglas NAT en el equilibrador de carga](./media/deis-cluster/nat-rules.png)

> [!NOTE]
> La plantilla solo admite actualmente clústeres de 3 nodos. Esto es debido a una limitación en la definición de la regla NAT de la plantilla del Administrador de recursos de Azure, que no admite la sintaxis del bucle.
> 
> 

## <a name="install-and-start-the-deis-platform"></a>Instalar e iniciar la plataforma Deis
