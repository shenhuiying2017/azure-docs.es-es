...
- [CLI de Azure 2.0 ](nsg-quickstart.md): CLI de última generación para el modelo de implementación de administración de recursos


## <a name="quick-commands"></a>Comandos rápidos
Para crear un grupo de seguridad de red y las reglas, tendrá que tener [la CLI de Azure 1.0](../../cli-install-nodejs.md) instalada y usar el modo de Resource Manager:
...
Cree el grupo de seguridad de red y escriba sus propios nombres y su propia ubicación según sea adecuado. En el ejemplo siguiente se crea un grupo de seguridad de red denominado *myNetworkSecurityGroup* en la ubicación *eastus*:
...
Los grupos de seguridad de red y las reglas de ACL también se pueden definir como parte de las plantillas de Azure Resource Manager. Más información sobre la [creación de grupos de seguridad de red con plantillas](../../virtual-network/template-samples.md).
