...
En primer lugar, cree un grupo de recursos con [az group create](/cli/azure/group#az_group_create). En el siguiente ejemplo se crea un grupo de recursos llamado *myResourceGroupAnsible* en la ubicación *eastus*:
...
Cree la máquina virtual con [az vm create](/cli/azure/vm#az_vm_create). En el ejemplo siguiente se crea una máquina virtual llamada *myVMAnsible*:
