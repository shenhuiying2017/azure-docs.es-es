...
Para controlar el acceso a la cuenta de almacenamiento, obtenga la clave de almacenamiento mediante el comando [az storage account key list](/cli/azure/storage/account/key#list), como se indica a continuación:
