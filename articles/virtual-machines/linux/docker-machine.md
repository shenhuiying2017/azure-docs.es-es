...
En primer lugar, obtenga el identificador de suscripción de Azure con el comando [az account show](/cli/azure/account#az_account_show) de la manera siguiente:
