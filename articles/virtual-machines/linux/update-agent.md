...
> [!NOTE]
> Si va a realizar esta tarea desde un equipo con Windows, utilice PuTTY para SSH en la máquina con Linux. Para más información, consulte [Inicio de sesión en una máquina virtual Linux](mac-create-ssh-keys.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
> 
> 
