...
Instale la versión más reciente de la [CLI de Azure 2.0](/cli/azure/install-az-cli2) e inicie sesión en su cuenta de Azure con [az login](/cli/azure/reference-index#az_login).
