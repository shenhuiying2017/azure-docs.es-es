...
También puede llevar a cabo estos pasos con la [CLI de Azure 1.0](deploy-linux-vm-into-existing-vnet-using-cli-nodejs.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
...
Creee la máquina virtual con [az vm create](/cli/azure/vm#create). Para más información sobre las marcas que se deben usar con la CLI de Azure 2.0 para implementar una máquina virtual completa, consulte [Creación de un entorno de Linux completo mediante la versión preliminar de la CLI de Azure 2.0](create-cli-complete.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
