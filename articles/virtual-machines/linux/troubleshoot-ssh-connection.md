...
---
<a id="troubleshoot-ssh-connections-to-an-azure-linux-vm-that-fails-errors-out-or-is-refused" class="xliff"></a>

# Solución de problemas de conexiones SSH a una máquina virtual Linux de Azure que producen error o se rechazan.
...
<a id="quick-troubleshooting-steps" class="xliff"></a>
...
<a id="available-methods-to-troubleshoot-ssh-connection-issues" class="xliff"></a>
...
![Restablecer la configuración o las credenciales de SSH en el portal de Azure](./media/troubleshoot-ssh-connection/reset-credentials-using-portal.png)

<a id="reset-the-ssh-configuration" class="xliff"></a>
...
<a id="reset-ssh-credentials-for-a-user" class="xliff"></a>
...
<a id="use-the-azure-cli-20" class="xliff"></a>
...
### Restablecimiento de las credenciales de SSH de un usuario
En el ejemplo siguiente se usa [az vm access set-linux-user](/cli/azure/vm/access#set-linux-user) para restablecer las credenciales de `myUsername` en el valor especificado en `myPassword`, en la máquina virtual llamada `myVM` en `myResourceGroup`. Use sus propios valores, como se indica a continuación:
...
<a id="use-the-vmaccess-extension" class="xliff"></a>
...
<a id="use-the-azure-cli-10" class="xliff"></a>

## Uso de la CLI de Azure 1.0
...
<a id="reset-ssh-configuration" class="xliff"></a>
...
<a id="restart-a-vm" class="xliff"></a>
...
![Reiniciar una máquina virtual en el portal de Azure](./media/troubleshoot-ssh-connection/restart-vm-using-portal.png)
...
<a id="redeploy-a-vm" class="xliff"></a>
...
![Nueva implementación de una máquina virtual en el portal de Azure](./media/troubleshoot-ssh-connection/redeploy-vm-using-portal.png)
...
<a id="vms-created-by-using-the-classic-deployment-model" class="xliff"></a>
