...
1. De forma predeterminada, la nueva máquina virtual no tiene un nombre de dominio completo (FQDN). Puede crear uno siguiendo las instrucciones que encontrará [aquí](virtual-machines-linux-portal-create-fqdn.md). Este paso es opcional para completar el tutorial.
