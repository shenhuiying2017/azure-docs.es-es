---
title: "Mensajes de error de máquina virtual de Azure"
description: 
...
---
# <a name="azure-virtual-machine-error-messages"></a>Mensajes de error de máquina virtual de Azure
En este artículo se describen los códigos de error y mensajes comunes que aparecen al administrar una máquina virtual (VM) de Azure.  

>[!NOTE]
>Deje comentarios en esta página para proporcionar información sobre los mensajes de error o a través del [foro de comentarios acerca de Azure](https://feedback.azure.com/forums/216843-virtual-machines) con la etiqueta #azerrormessage.
>
>

## <a name="error-response-format"></a>Formato de respuestas de error 
La máquina virtual de Azure utiliza el siguiente formato JSON para las respuestas de error.
```json
{
  "status": "status code",
  "error": {
...
Una respuesta de error siempre incluye un código de estado, un objeto de error (todos los objetos de error siempre contiene un código de error) y un mensaje. Si la implementación de la máquina virtual se crea mediante una plantilla, el objeto de error también tiene una sección de detalles, que contiene un nivel interno de códigos de error y un mensaje. Normalmente, el nivel más interno del mensaje es el error raíz. 


## <a name="common-virtual-machine-management-error"></a>Error común de administración de máquinas virtuales

En esta sección se enumeran los mensajes de error comunes para administrar una máquina virtual
