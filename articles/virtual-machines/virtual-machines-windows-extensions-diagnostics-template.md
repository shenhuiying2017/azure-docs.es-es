...
> [AZURE.IMPORTANT] Estas métricas dirigen los gráficos de supervisión y alertas en el Portal de Azure.  El nodo **Métricas** con *resourceID* y **MetricAggregation** deben incluirse en la configuración de diagnóstico para la máquina virtual si quiere ver los datos de supervisión de la máquina virtual en Azure Portal. 
