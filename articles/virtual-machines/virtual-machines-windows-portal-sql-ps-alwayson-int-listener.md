...
---
# <a name="configure-one-or-more-always-on-availability-group-listeners---resource-manger"></a>Configuración de uno o varios agentes de escucha de grupo de disponibilidad AlwaysOn: Resource Manager
...
> **Importante** La compatibilidad de varios agentes de escucha para grupos de disponibilidad Always On en máquinas virtuales de Azure es una característica en versión preliminar y está sujeta a los términos de la versión preliminar incluidos en el contrato de licencia (por ejemplo, el Contrato Enterprise, el Contrato de Microsoft Azure o el contrato Microsoft Online Subscription), así como a otros [Términos de uso complementarios de las versiones preliminares de Microsoft Azure](http://azure.microsoft.com/support/legal/preview-supplemental-terms/) aplicables. 
> 
> 
...
> [!NOTE]
> Si ha creado el grupo de disponibilidad con la [plantilla de Microsoft](virtual-machines-windows-portal-sql-alwayson-availability-groups.md) , no es necesario completar este paso. 
> 
> 
...
## <a name="example-script:-add-an-ip-address-to-an-existing-load-balancer-with-powershell"></a>Script de ejemplo: Agregar una dirección IP a un equilibrador de carga existente con PowerShell
...
## <a name="1.-create-the-availability-group-listener-on-the-failover-cluster"></a>1. Creación del agente de escucha del grupo de disponibilidad en el clúster de conmutación por error
...
* En el panel **Roles**, haga clic en el nombre del grupo de disponibilidad y después seleccione **Agregar recurso** > **Punto de acceso cliente**.
* En la casilla **Nombre**, cree un nombre para este nuevo agente de escucha, después haga clic en **Siguiente** dos veces y haga clic en **Finalizar**. No pongas el agente de escucha o el recurso en línea en este momento.
...
* En **IP Address** click **Dirección IP estática** and set the static Dirección IP to the same address that you used when you set the load balancer Dirección IP on the Azure portal. 
...
## <a name="2.-bring-the-listener-online"></a>2. Conexión del agente de escucha
...
* Desplázate atrás al Administrador de clústeres de conmutación por error. Amplia las **Funciones** y después resalta tu grupo de disponibilidad. En la pestaña de **Recursos**, haga clic con el botón derecho en el nombre del agente de escucha y haga clic en **Propiedades**.
...
* Una vez que el agente de escucha está en línea, en la pestaña de **Recursos**, haga clic con el botón derecho en el grupo de disponibilidad y haga clic en **Propiedades**.
...
* En el cuadro **Puerto**, especifique el número de puerto del agente de escucha del grupo de disponibilidad mediante el valor $EndpointPort que ha establecido antes (1433 era el valor predeterminado) y haga clic en **Aceptar**.
