<properties
   pageTitle="Uso de SAP en máquinas virtuales (VM) de Windows | Microsoft Azure"
   description="Más información sobre cómo usar SAP en máquinas virtuales (VM) Windows en Microsoft Azure"
