...
Azure almacena la imagen en **Images** (Imágenes), junto con las demás que haya cargado. Para obtener más información sobre las imágenes, consulte [Acerca de las imágenes de máquina virtual en Azure][].

## Antes de empezar

En estos pasos se supone que ya ha creado un máquina virtual de Azure con el modelo de implementación clásica y que ha configurado el sistema operativo, lo que incluye adjuntar cualquier disco de datos. Si tiene que crear una máquina virtual, lea [Creación de una máquina virtual Linux personalizada][].
...
4. Escriba **Salir** para cerrar el cliente SSH.
	...
	>[AZURE.NOTE] En los demás pasos se supone que ya ha [instalado la CLI de Azure](../xplat-cli-install.md) en el equipo cliente. Todos los pasos siguientes también pueden realizarse en el [Portal de Azure clásico][].
