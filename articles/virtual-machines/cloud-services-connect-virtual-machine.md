...
1.	Cree la red virtual en el [Portal de Azure](http://manage.windowsazure.com). Para obtener más información, consulte [Creación de una red virtual (clásica) usando el portal de Azure](../virtual-network/virtual-networks-create-vnet-classic-portal.md).
