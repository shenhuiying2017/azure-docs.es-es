...
Para una lista completa de los tamaños de máquina virtual, vea [Tamaños de máquinas virtuales](virtual-machines-linux-sizes.md).
...
Recuerde que definió las tablas V, S, ST y A en [Fase 1: Configuración de Azure](virtual-machines-windows-ps-lob-ph1.md).
