...
- **Azure PowerShell versión 1.0 o superior**: si todavía no la ha instalado, consulte [Cómo instalar y configurar Azure PowerShell](../powershell-install-configure.md).
