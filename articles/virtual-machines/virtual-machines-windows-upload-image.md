...
2. Agregue el VHD generalizado de Azure a la cuenta de almacenamiento mediante [AzureRmVhd agregar](https://msdn.microsoft.com/library/mt603554.aspx):
	...
	Si la ejecución de `Add-AzureRmVhd` es correcta, tendrá este aspecto:
...
Use el siguiente script de PowerShell de ejemplo para configurar una red virtual y la NIC para la nueva máquina virtual. Use valores para las variables representadas con el signo **$** según resulte apropiado para su aplicación.
...
En el siguiente script de PowerShell se muestra cómo establecer las configuraciones de máquina virtual y usar la imagen de VM cargada como origen para la nueva instalación. </br>
...
Debería ver la VM recién creada en el [Portal de Azure](https://portal.azure.com), en **Examinar** > **Máquinas virtuales**, o bien usando los siguientes comandos de PowerShell:
...
Para administrar la nueva máquina virtual con Azure PowerShell, lea [Manage virtual machines using Azure Resource Manager and PowerShell](virtual-machines-windows-ps-manage.md) (Administración de máquinas virtuales con Azure Resource Manager y PowerShell).
