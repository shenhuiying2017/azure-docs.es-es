...
Abra el explorador y escriba la dirección URL **http://<nombre DNS de su servidor tomcat>/manager/html**. Por ejemplo, en este artículo, la dirección URL es http://tomcatexample.cloudapp.net/manager/html.
