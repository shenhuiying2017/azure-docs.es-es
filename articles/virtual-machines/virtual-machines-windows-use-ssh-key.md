...
1. Las claves **ssh-rsa** son necesarias para cualquier implementación que use el [portal de vista previa](https://portal.azure.com), independientemente del modelo de implementación.
