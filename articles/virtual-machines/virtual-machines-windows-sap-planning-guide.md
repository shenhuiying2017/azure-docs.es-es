...
# <a name="sap-netweaver-on-windows-virtual-machines-vms-planning-and-implementation-guide"></a>SAP NetWeaver en máquinas virtuales (VM) Windows: guía de planeamiento e implementación
...
* [SAP NetWeaver en máquinas virtuales (VM) de Windows: guía de planeación e implementación (este documento)][planning-guide]
...
* [SAP NetWeaver en máquinas virtuales (VM) de Windows: guía de implementación de alta disponibilidad][ha-guide]
...
Puede encontrar más información sobre cómo crear imágenes de Virtual Machines en [este artículo (Windows)][virtual-machines-windows-capture-image] o en [este artículo (Linux)][virtual-machines-linux-capture-image].
...
* Use _sysprep_ en Windows o _waagent -deprovision_ en Linux para generalizar la máquina virtual (consulte [Captura de una máquina virtual Windows en el modelo de implementación de Resource Manager][virtual-machines-windows-capture-image-prepare-the-vm-for-image-capture] o [Captura de una máquina virtual Linux para usarla como plantilla de Resource Manager][virtual-machines-linux-capture-image-capture]
* Inicie sesión en su suscripción con _Login-AzureRmAccount_
* Establezca la suscripción de su contexto con _Set-AzureRmContext_ y el parámetro SubscriptionId o SubscriptionName (consulte <https://msdn.microsoft.com/library/mt619263.aspx>).
* Cargue el disco duro virtual con _Add-AzureRmVhd_ en una cuenta de Azure Storage (consulte, <https://msdn.microsoft.com/library/mt603554.aspx>).
...
* Use _sysprep_ en Windows o _waagent -deprovision_ en Linux para generalizar la máquina virtual (consulte [Captura de una máquina virtual Windows en el modelo de implementación de Resource Manager][virtual-machines-windows-capture-image-prepare-the-vm-for-image-capture] o [Captura de una máquina virtual Linux para usarla como plantilla de Resource Manager][virtual-machines-linux-capture-image-capture] para Linux
* Cambie al modo de Azure Resource Manager con _azure config mode arm_
* Inicie sesión en su suscripción con _azure login_
* Seleccione su suscripción con _azure account set`<subscription name or id`>_.
* Cargue el VHD con _azure storage blob upload_ (consulte [Uso de la CLI de Azure CLI con Azure Storage][storage-azure-cli].
...
Para más sugerencias e información, específicamente para las máquinas virtuales de DBMS, consulte la [Guía de implementación de DBMS][dbms-guide].
...
> ![ Windows][Logo_Windows] Windows
>
> [Conexión de un disco de datos en Azure Portal][virtual-machines-windows-attach-disk-portal]
>
