...
- [Fase 1: Configuración de Azure](virtual-machines-windows-ps-sp-intranet-ph1.md). Cree una cuenta de almacenamiento, conjuntos de disponibilidad y una red entre locales.
- [Fase 2: Configuración de los controladores de dominio](virtual-machines-windows-ps-sp-intranet-ph2.md). Cree y configure los controladores de dominio de los Servicios de dominio de Active Directory (AD DS) de réplica.
- [Fase 3: Configuración de la infraestructura de SQL Server](virtual-machines-windows-ps-sp-intranet-ph3.md). Cree y configure las máquinas virtuales de SQL Server, prepárelas para su uso con SharePoint y cree el clúster.
- [Fase 4: Configuración de los servidores de SharePoint](virtual-machines-windows-ps-sp-intranet-ph4.md). Cree y configure las cuatro máquinas virtuales de SharePoint.
- [Fase 5: Creación del grupo de disponibilidad y adición de las bases de datos de SharePoint](virtual-machines-windows-ps-sp-intranet-ph5.md). Prepare las bases de datos y cree un grupo de disponibilidad AlwaysOn de SQL Server.
