...
- [Tamaño](virtual-machines-windows-sizes.md)
- [Nombre](virtual-machines-linux-infrastructure-naming-guidelines.md) y credenciales
- [Configuración del sistema operativo](virtual-machines-windows-cli-ps-findimage.md) y disco
...
Aunque las [extensiones](virtual-machines-windows-extensions-features.md) son un recurso independiente, están estrechamente relacionadas con las máquinas virtuales. Las extensiones pueden agregar como un recurso secundario de la máquina virtual o como uno independiente. El ejemplo muestra la [extensión de diagnóstico](virtual-machines-windows-extensions-diagnostics-template.md) que se agrega a las máquinas virtuales:
...
Existen muchas extensiones que se pueden instalar en una máquina virtual, pero la más útil es probablemente la de [script personalizado](virtual-machines-windows-extensions-customscript.md). En el ejemplo, un script de PowerShell denominado "start.ps1" se ejecuta en cada máquina virtual cuando se inicia por primera vez:
...
![Obtención de la información de implementación](./media/virtual-machines-windows-template-description/virtual-machines-deployment-info.png)
