...
3. En la lista desplegable en Microsoft Azure, elija **Máquina virtual** y luego haga clic en el botón **Aceptar**.
...
6. En la lista **Imagen**, elija la imagen en la que desee basar la máquina virtual. Puede elegir cualquiera de las imágenes de máquinas virtuales de Azure o su propia imagen que haya cargado en Azure.
...
Si desea personalizar los scripts publicados que creó, consulte información más detallada en [Uso de scripts de Windows PowerShell para publicar en entornos de prueba y desarrollo](http://msdn.microsoft.com/library/dn642480.aspx).
