...
>[AZURE.IMPORTANT] Cuando se usa Oracle Database 12c, hay un nuevo usuario, **SYSDG**, que puede usar para administrar la protección de datos de Oracle. Para obtener más información, consulte los [cambios en la versión de Oracle Database 12ce](http://docs.oracle.com/database/121/UNXAR/release_changes.htm#UNXAR404).
