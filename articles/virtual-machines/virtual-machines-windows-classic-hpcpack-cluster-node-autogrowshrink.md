...
>[AZURE.TIP] A partir de HPC Pack 2012 R2 Update 2, HPC Pack incluye un servicio integrado para aumentar y reducir los nodos de ráfaga de Azure automáticamente o los nodos de ejecución de la máquina virtual de Azure. Configure el servicio con una configuración en el [script de implementación de IaaS de HPC Pack](virtual-machines-windows-classic-hpcpack-cluster-powershell-script.md) o establezca manualmente la propiedad **AutoGrowShrink** del clúster. Consulte [Novedades en Microsoft HPC Pack 2012 R2 Update 2](https://technet.microsoft.com/library/mt269417.aspx).
