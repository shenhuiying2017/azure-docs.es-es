...
También puede obtener más detalles sobre la [carga del disco duro virtual en un proceso de Azure](upload-image.md#upload-the-vhd-to-your-storage-account).
