...
> [!NOTE]
> Dado que el Portal de Azure clásico no admite actualmente un ILB, no muestra el ILB ni los puntos de conexión. No obstante, si el equilibrador de carga se está ejecutando en el portal clásico, `Get-AzureEndpoint` devuelve una dirección IP interna. De lo contrario, devuelve null.
> 
> 
