...
## [Aprovisionamiento de una máquina virtual con Azure PowerShell](../classic/ps-sql-create.md)
## [Conexión a una máquina virtual](../classic/sql-connect.md)
...
### [Configuración de grupos de disponibilidad Always On mediante el portal clásico](../classic/portal-sql-alwayson-availability-groups.md)
### [Configuración de grupos de disponibilidad Always On con PowerShell](../classic/ps-sql-alwayson-availability-groups.md)
### [Configuración un agente de escucha interno para un grupo de disponibilidad](../classic/ps-sql-int-listener.md)
### [Configuración un agente de escucha externo para un grupo de disponibilidad](../classic/ps-sql-ext-listener.md)
### [Ampliación de los grupos de disponibilidad locales a Azure](../classic/sql-onprem-availability.md)
## Manage
### [Uso de la Extensión Agente de IaaS de SQL Server](../classic/sql-server-agent-extension.md)
### [Aplicación de revisiones automatizada](../classic/sql-automated-patching.md)
### [Configuración de la integración de Azure Key Vault](../classic/ps-sql-keyvault.md)
### [Uso de Premium Storage](../classic/sql-server-premium-storage.md)
...
### [Copia de seguridad automatizada](../classic/sql-automated-backup.md)
...
### [Inteligencia empresarial de SQL Server en máquinas virtuales de Azure](../classic/ps-sql-bi.md)
### [Uso de ReportViewer en un sitio web hospedado en Azure](../classic/sql-server-reportviewer.md)
### [Uso de PowerShell para crear una máquina virtual de Azure con un servidor de informes](../classic/ps-sql-report.md)
