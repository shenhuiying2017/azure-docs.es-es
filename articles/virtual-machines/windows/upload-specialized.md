...
Si tiene previsto usar el VHD especializado como está para crear una nueva VM, asegúrese de completar los pasos siguientes. 
  * Si va a usar Managed Disks, revise [Plan for the migration to Managed Disks](on-prem-to-azure.md#plan-for-the-migration-to-managed-disks) (Planeación de la migración a Managed Disks).
