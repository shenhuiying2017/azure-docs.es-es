---
title: Copia de seguridad automatizada v2 para Azure Virtual Machines con SQL Server 2016 | Microsoft Docs
description: "Se explica la característica Copia de seguridad automatizada para SQL Server 2016 en máquinas virtuales que se ejecutan en Azure. Este artículo trata exactamente sobre las máquinas virtuales que usan Resource Manager."
...
Para utilizar Copia de seguridad automatizada v2, revise los siguientes requisitos previos:
...
> [!IMPORTANT]
> Copia de seguridad automatizada v2 funciona con SQL Server 2016. Si usa SQL Server 2014, puede usar Copia de seguridad automatizada v1 para hacer copias de seguridad de las bases de datos. Para obtener más información, vea [Copia de seguridad automatizada para SQL Server 2014 en Azure Virtual Machines](virtual-machines-windows-sql-automated-backup.md).
...
En la siguiente tabla se describen las opciones que pueden configurarse para Copia de seguridad automatizada v2. Los pasos de configuración reales varían si usa el Portal de Azure o comandos de Windows PowerShell de Azure.
...
El lunes, se habilita la copia de seguridad automatizada v2 con las siguientes opciones:
...
Cuando esto ocurre, la copia de seguridad automatizada comienza la copia de seguridad de las demás bases de datos al día siguiente, es decir, el miércoles a la 1:00 durante una hora. Si no se realiza la copia de seguridad de todas las bases de datos a esa hora, vuelve a intentarlo al día siguiente a la misma hora. Se aplica este mismo comportamiento hasta que se realiza correctamente la copia de seguridad de todas las bases de datos.
...
En este escenario se muestra que la copia de seguridad automatizada solo funciona durante el período de tiempo especificado y que la copia de seguridad de cada base de datos se realiza una vez a la semana. También se muestra que las copias de seguridad se pueden extender varios días en caso de que no sea posible completar todas las copias de seguridad en un solo día.
...
![Configuración de Copia de seguridad automatizada de SQL en el Portal de Azure](./media/virtual-machines-windows-sql-automated-backup-v2/automated-backup-blade.png)
...
> [!NOTE]
> Copia de seguridad automatizada no permite almacenar las copias de seguridad en almacenamiento premium, pero pueden realizar copias de seguridad de discos de VM que usan Premium Storage.
...
Copia de seguridad automatizada v2 configura Copia de seguridad administrada en máquinas virtuales de Azure. Por lo tanto, es importante [revisar la documentación de la Copia de seguridad administrada](https://msdn.microsoft.com/library/dn449496.aspx) para comprender el comportamiento y las implicaciones.
