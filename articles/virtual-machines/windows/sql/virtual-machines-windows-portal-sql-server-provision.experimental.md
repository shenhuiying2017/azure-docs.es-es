...
> [!NOTE]
> Puede agregar más restricciones de las comunicaciones de red en la máquina virtual de SQL Server. Puede agregar más restricciones mediante la edición del grupo de seguridad de red una vez creada la máquina virtual. Para más información, consulte [¿Qué es un grupo de seguridad de red?](../../../virtual-network/virtual-networks-nsg.md)
> 
> 
...
Puede habilitar [SQL Server R Services](https://msdn.microsoft.com/library/mt604845.aspx). SQL Server R Services le permite utilizar análisis avanzado con SQL Server 2016. Haga clic en **Habilitar** on the **SQL Server Settings** .
