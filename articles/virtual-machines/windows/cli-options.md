...
|Task | Instrucciones |
|---|---|
| Habilitación de WSL | [Instalación de la documentación de WSL](https://msdn.microsoft.com/commandline/wsl/install_guide) |
...
Para usar la CLI de Azure en Windows, instale el paquete siguiendo estas instrucciones, [Instalación de la CLI en Windows](https://docs.microsoft.com/cli/azure/install-az-cli2#windows).
...
[Ejemplos de la CLI para Azure Web Apps](../../app-service/app-service-cli-samples.md)
