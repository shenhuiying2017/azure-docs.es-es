...
Para obtener información detallada sobre el equilibrador de carga de red de Azure, consulte [Equilibrio de carga para servicios de infraestructura de Azure](load-balance.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
