---
title: "Documentación sobre las máquinas virtuales Windows de Azure: tutoriales y referencia de API | Microsoft Docs"
description: "Aprenda a crear máquinas virtuales Windows. La documentación le ayuda a planear, implementar y administrar un entorno informático de máquina virtual en la nube."
...
<div class="introHolder">
    <div class="intro">
Aprenda a crear máquinas virtuales Windows. Tutoriales, referencias de API y otra documentación le ayudan a planear, implementar y administrar un entorno informático de máquina virtual en la nube.
    </div>
    <div class="calloutHolder">
        <div class="callout">
            <a href="https://azure.microsoft.com/community/training/courses/managing-infrastructure-microsoft-azure-getting-started/">
                <img src="media/index/pluralsight.svg" />Vídeo gratuito de aprendizaje de PluralSight: administración de la infraestructura con Microsoft Azure </a>
        </div>
    </div>
</div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Información acerca de máquinas virtual Windows</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introducción a máquinas virtuales Windows con Azure Portal</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introducción a máquinas virtuales Windows con PowerShell</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introducción a máquinas virtuales Windows con una plantilla de Resource Manager</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/compute">Referencia de API de REST de Compute</a></p>
                    </div>
                </div>
            </div>
        </div>
