...
Sí. Para obtener instrucciones, consulte [Carga de una imagen de VM de Windows en Microsoft Azure para implementaciones del Administrador de recursos ](upload-image.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json)
...
Sí. Para más información, consulte, [Creación de una copia de una máquina virtual Windows en el modelo de implementación de Resource Manager](vhd-copy.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json).
...
Sí. Para crear rápidamente una máquina virtual Linux de prueba, consulte [Creación de una máquina virtual de Linux en Azure mediante el Portal](../linux/quick-create-portal.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
