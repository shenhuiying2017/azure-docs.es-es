...
Puede administrar los servidores de estas granjas a través de conexiones de Escritorio remoto. Para obtener más información, vea [Conexión a la máquina virtual e inicio de sesión](quick-create-portal.md#connect-to-virtual-machine).
