---
title: "Seguridad de máquina virtual Windows con Azure Security Center | Microsoft Docs"
...
1. En el panel de Azure Security Center, haga clic en **Security Policy** (Directiva de seguridad) y seleccione su suscripción. 
2. En **Data collection** (Recopilación de datos), seleccione *Activado*.
...
4. Haga clic en **Guardar** en la hoja **Security Policy** (Directiva de seguridad). 
...
1. En el panel de Azure Security Center, haga clic en **Security Policy** (Directiva de seguridad) y luego seleccione su suscripción. 
2. Haga clic en **Prevention policy** (Directiva de prevención).
...
5. Haga clic en **Guardar** en la hoja **Security Policy** (Directiva de seguridad). 
...
A medida que se recopilan datos, se agrega el estado de recursos de cada máquina virtual y de los recursos de Azure relacionados y esta información se presenta en un gráfico fácil de leer. Para ver el estado de los recursos, vuelva al panel de Azure Security Center. En **Resource security health** (Estado de seguridad de recurso), haga clic en **Compute**. Por último, en la hoja **Compute**, haga clic en **Máquinas virtuales**. Esta vista proporciona un resumen del estado de configuración de todas las máquinas virtuales.
