---
title: Preguntas más frecuentes sobre SQL Server en Máquinas virtuales de Azure | Microsoft Docs
...
7. **¿Se deben pagar los costos de SQL de una máquina virtual si solo se usará para el modo de espera/conmutación por error?**
