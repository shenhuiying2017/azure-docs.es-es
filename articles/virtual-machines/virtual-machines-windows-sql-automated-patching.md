...
Puede usar el [Portal de Azure](http://go.microsoft.com/fwlink/?LinkID=525040&clcid=0x409) para configurar la opción Aplicación de revisión automatizada cuando cree una nueva máquina virtual de SQL Server en el modelo de implementación de Resource Manager.
...
![Aplicación de revisión automática de SQL en el Portal de Azure](./media/virtual-machines-windows-sql-automated-patching/azure-sql-arm-patching.png)
...
Para las máquinas virtuales de SQL Server actuales, debe usar PowerShell para configurar las opciones de Aplicación de revisión automatizada.
...
Para obtener información acerca de otras tareas de automatización disponibles, consulte [Extensión Agente de IaaS de SQL Server](virtual-machines-windows-sql-server-agent-extension.md).
