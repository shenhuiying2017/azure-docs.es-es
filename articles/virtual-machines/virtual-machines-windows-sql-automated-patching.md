---
title: Aplicación de revisión automatizada para máquinas virtuales SQL Server (Resource Manager) | Microsoft Docs
...
modelo de implementación clásica. Para ver la versión clásica de este artículo, consulte [Aplicación de revisiones automatizadas para SQL Server en máquinas virtuales de Azure implementación clásica](virtual-machines-windows-classic-sql-automated-patching.md).
