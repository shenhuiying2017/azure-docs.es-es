...
3.	Para configurar el conector de SugarCRM, proporcione los detalles del plan de hospedaje, el grupo de recursos y seleccione el nombre de la aplicación de API.

4. Configure el conector de SugarCRM y haga clic en Crear. A continuación se proporciona la configuración del paquete que es necesario proporcionar para crear el conector:
	...
	<table>
	  ...
	  <tr>
	    ...
	    <td>Sí</td>
	    <td>Especifique la dirección URL de la instancia de SugarCRM Ex: https://abcde1234.sugarcrm.com</td>
	  </tr>
	  <tr>
	    <td>Id. de cliente</td>
	    <td>Sí</td>
...
5.	Expanda 'Aplicaciones de API en este grupo de recursos' en la Galería para ver todas las aplicaciones de API disponibles. Seleccione 'SugarCRM' en la galería y el 'Conector de Salesforce' se agregará al flujo.

	![][3]

6.	Seleccione la acción 'Crear cuenta'; se mostrarán los parámetros de entrada.

	![][4]

12.	Proporcione un nombre como 'Cuenta de Microsoft' y haga clic en ✓. 
...
14.	Seleccione 'Actualizar cuenta' de la lista de acciones; se mostrarán los parámetros de entrada de la acción 'Actualizar cuenta'.
...
19. Puede comprobar que se crea una nueva cuenta llamada 'Cuenta de Microsoft' en su cuenta de SugarCRM y la misma cuenta también se actualiza con la información de dirección de facturación.
