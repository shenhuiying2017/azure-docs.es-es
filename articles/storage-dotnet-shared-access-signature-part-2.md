...
-   Si desea instalar el paquete de NuGet, instale en primer lugar la [extensión Administrador de paquetes NuGet para Visual Studio][extensión Administrador de paquetes NuGet para Visual Studio] (en inglés). En Visual Studio, seleccione **Proyecto | Manage NuGet Packages**, busque en línea **Almacenamiento de Azure** y siga las instrucciones de instalación.
...
[Firmas de acceso compartido, parte 1: Descripción del modelo de firmas de acceso compartido][parte 1]
...
[Introducción a las firmas de acceso compartido de tabla y cola][Introducción a las firmas de acceso compartido de tabla y cola]

  [parte 1]: ../storage-dotnet-shared-access-signature-part-1/
  [paquete de NuGet]: http://nuget.org/packages/WindowsAzure.Storage/ "paquete de NuGet"
  [SDK de Azure para .NET]: http://www.windowsazure.com/es-es/downloads/
  [extensión Administrador de paquetes NuGet para Visual Studio]: http://visualstudiogallery.msdn.microsoft.com/27077b70-9dad-4c64-adcf-c7cf6bc9970c
