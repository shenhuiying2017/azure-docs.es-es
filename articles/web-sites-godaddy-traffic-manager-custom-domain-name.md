...
[Sitios web](/es-es/documentation/articles/web-sites-godaddy-custom-domain-name/ "Sitios web") | [Sitio web utilizando el Administrador de tráfico](/es-es/documentation/articles/web-sites-godaddy-traffic-manager-custom-domain-name/ "Sitio web utilizando el Administrador de tráfico")
