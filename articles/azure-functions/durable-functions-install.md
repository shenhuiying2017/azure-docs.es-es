...
* Siga las instrucciones que aparecen en "Instalación de Azure Functions Core Tools" en [Codificación y comprobación de las funciones de Azure Functions en un entorno local](https://docs.microsoft.com/en-us/azure/azure-functions/functions-run-local).
