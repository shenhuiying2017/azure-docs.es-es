...
* **QueueTrigger** : responder a mensajes conforme llegan a una cola de Almacenamiento de Azure. Para obtener un ejemplo, vea [Crear una función desencadenada por Azure Queue Storage](functions-create-storage-queue-triggered-function.md).
