---
title: Creación de un enlace web o una función de API de Azure| Microsoft Docs
...
1. Copie los valores de **Function URL** (URL de función) y **GitHub Secret** (Secreto de GitHub). Los necesitará al crear el webhook en GitHub.
