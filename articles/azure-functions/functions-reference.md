---
title: Referencia para desarrolladores de Funciones de Azure | Microsoft Docs
...
[!INCLUDE [proceso dinámico](../../includes/functions-bindings.md)]

## Problemas de informes
[!INCLUDE [Problemas de informes](../../includes/functions-reporting-issues.md)]
