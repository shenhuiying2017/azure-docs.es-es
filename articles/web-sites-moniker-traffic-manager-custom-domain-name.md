<properties title="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with Moniker" pageTitle="Configuración de un nombre de dominio de Moniker para un sitio web de Azure con el Administrador de tráfico" metaKeywords="Microsoft Azure, Sitios web de Microsoft Azure, Moniker, Administrador de tráfico" description="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with Moniker" services="web-sites" documentationCenter="" authors="larryfr,jroth" manager="wpickett" />
