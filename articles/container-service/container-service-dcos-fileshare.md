...
Necesita un clúster de ACS con DC/OS para completar los pasos de este tutorial. Si es necesario, este [script de ejemplo](./scripts/container-service-cli-deploy-dcos.md) puede crear uno.
