...
1. Paso opcional: si quiere ejecutar el servidor de Tomcat integrado en el puerto 80 en lugar del puerto 8080 predeterminado (por ejemplo, si va a probar el proyecto de Spring Boot localmente), puede configurar el puerto con los pasos siguientes:
   ...
   c. Modifique la configuración de **servidor:** de modo que el servidor se ejecute en el puerto 80, por ejemplo:
   ```
   server:
      port: 80
   ```
...
1. Cuando aparezca la hoja **Crear Registro de contenedor**, escriba su **Nombre del Registro** y **Grupo de recursos**, elija **Habilitar** para el **Usuario administrador** y haga clic en **Crear**.
...
>
> Si esto ocurre, es posible que deba iniciar sesión en Azure desde la línea de comandos Docker, por ejemplo:
>
...
1. Cuando aparezca la hoja **Web App on Linux** (Aplicación web en Linux), especifique la información siguiente:
