---
title: "Administración de contenedores de Azure Container Service a través de la interfaz de usuario web | Microsoft Docs"
...
---
# <a name="container-management-through-the-web-ui"></a>Administración de contenedores a través de la interfaz de usuario web
...
Acceda a http://localhost/ con un túnel de Secure Shell (SSH) establecido. Con ello, se cargará la interfaz de usuario web de DC/OS y aparecerá información acerca del clúster, como los recursos usados, los agentes activos y los servicios en ejecución.
...
Al volver a la interfaz de usuario web de DC/OS (http://localhost/), verá que hay una tarea en ejecución (en este caso, un contenedor con formato Docker) en el clúster de DC/OS.
