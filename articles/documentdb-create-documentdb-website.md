<properties 
	pageTitle="Implementación de Base de datos de documentos y un sitio web de Azure mediante una plantilla del Administrador de recursos de Azure | Azure" 
...
En este tutorial se muestra cómo usar una plantilla del Administrador de recursos de Azure para implementar e integrar [Base de datos de documentos de Microsoft Azure](http://azure.microsoft.com/services/documentdb/), un [sitio web de Azure](http://azure.microsoft.com/services/websites/) y una aplicación web de ejemplo.
...
2. Descargue el [ejemplo Creación de una cuenta de Base de datos de documentos y un sitio web](https://portalcontent.blob.core.windows.net/samples/CreateDocDBWebSite.zip) en una carpeta local (por ejemplo, C:\DocumentDBTemplates) y extraiga los archivos.  En este ejemplo se implementará una cuenta de Base de datos de documentos y un sitio web de Azure, y se modificará la configuración del sitio web para exponer fácilmente la información de conexión de Base de datos de documentos, pero no se incluye una aplicación web.  
...
> [AZURE.TIP] La plantilla no valida que el nombre del sitio web y el nombre de la cuenta de Base de datos de documentos especificados a continuación sean a) válidos y b) estén disponibles.  Es muy recomendable que compruebe la disponibilidad de los nombres que planea suministrar antes de ejecutar el script de implementación de PowerShell.

1. Abra Microsoft Azure PowerShell y vaya a la carpeta en la que ha descargado y extraído el [ejemplo Creación de una cuenta de Base de datos de documentos y un sitio web, e implementación de una aplicación de demostración](https://portalcontent.blob.core.windows.net/samples/CreateDocDBWebsiteTodo.zip) (por ejemplo, C:\DocumentDBTemplates\CreateDocDBWebsiteTodo).
...
5. Antes de examinar nuestra aplicación de ejemplo, es necesario comprender qué hace la implementación de la plantilla:
	...
	- Se ha creado una cuenta de Base de datos de documentos de Azure.

	- Un paquete de implementación web se ha implementado en el sitio web de Azure

	- La configuración del sitio web de Azure se ha modificado de forma que el extremo de Base de datos de documentos de Azure y la clave maestra principal se han expuesto como configuración de la aplicación.
...
9.  Observe que el mapa de recursos del modo Resumen muestra todos nuestros recursos relacionados (cuenta de Base de datos de documentos, Sitio web, Supervisión).

	![Screenshot of the Summary lens](./media/documentdb-create-documentdb-website/image4.png)
10.  Haga clic en su cuenta de Base de datos de documentos e inicie el Explorador de consultas (cerca de la parte inferior de la hoja de la cuenta).
...
1. Abra Microsoft Azure PowerShell y vaya a la carpeta en la que descargó y extrajo el [ejemplo Creación de una cuenta de Base de datos de documentos y un sitio web](https://portalcontent.blob.core.windows.net/samples/CreateDocDBWebSite.zip) (por ejemplo, C:\DocumentDBTemplates\CreateDocDBWebsite).
...
5. Antes de abrir el portal de Azure, debemos comprender qué hace la implementación de esta plantilla:
	...
	- 	La configuración del sitio web de Azure se ha modificado de forma que el extremo de Base de datos de documentos de Azure, la clave maestra primaria y la clave maestra secundaria se expusieron como configuración de la aplicación.
...
8. En la hoja Sitio web, haga clic en **Toda la configuración**, luego en **Configuración de la aplicación** y observe que existen valores de configuración de aplicación para el extremo de Base de datos de documentos y para cada una de las claves maestras de Base de datos de documentos.

	![Screenshot of the Website, Settings, and Site settings blades](./media/documentdb-create-documentdb-website/image7.png)
9. No dude en seguir explorando el portal de Azure o siga uno de nuestros [ejemplos](http://go.microsoft.com/fwlink/?LinkID=402386) de Base de datos de documentos para crear su propia aplicación de Base de datos de documentos.
