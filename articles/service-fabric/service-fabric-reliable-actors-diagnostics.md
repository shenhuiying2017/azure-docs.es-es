...
|Bit|Descripción|
|---|---|
|0x1|Conjunto de eventos importantes que resumen la operación del tiempo de ejecución de los actores de Fabric|
|0x2|Conjunto de eventos que describen las llamadas de método de actor. Para obtener más información, consulte el [tema de introducción sobre actores](service-fabric-reliable-actors-introduction.md#actors).|
...
|---|---|
|Actor de Service Fabric|Contadores específicos de los actores de Service Fabric. Por ejemplo, el tiempo empleado en guardar el estado del actor.|
...
#### Categoría `Service Fabric Actor`
...
#### Categoría `Service Fabric Actor Method`
