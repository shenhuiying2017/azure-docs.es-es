...
Ahora, necesitamos actualizar el archivo *ApplicationManifest.xml* (que se encuentra en el **VisualObjects** debajo de la solución **VisualObjects**) para usar la versión 2.0 del proyecto **VisualObjects.ActorService** y actualizar también la versión de la aplicación de 1.0.0.0 a 2.0.0.0. Ahora, las líneas correspondientes del archivo *ApplicationManifest.xml* debe tener el siguiente aspecto:
