...
> [!NOTE]
> Service Fabric no debe implementarse en un controlador de dominio. Asegúrese de que ClusterConfig.json no incluye la dirección IP del controlador de dominio al usar grupos de máquinas o gMSA.
> 
> 
