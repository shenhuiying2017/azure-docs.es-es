...
Puede ejecutar cualquier tipo de aplicación, como node.js, Java o aplicaciones nativas, en Azure Service Fabric. Service Fabric hace referencia a estos tipos de aplicaciones como aplicaciones ejecutables invitadas.
...
## <a name="packaging-an-existing-executable"></a>Empaquetado de un ejecutable existente
...
> [!NOTE]
> La forma más sencilla de empaquetar un ejecutable de Windows existente en un servicio es mediante Visual Studio.
> 
> 
...
## <a name="manually-packaging-and-deploying-an-existing-executable"></a>Empaquetado e implementación manuales de un archivo ejecutable existente
...
### <a name="add-the-application's-code-and-configuration-files"></a>Agregar archivos de código y la configuración de la aplicación
...
#### <a name="updating-the-servicetypes"></a>Actualización de ServiceTypes
```xml
<ServiceTypes>
  <StatelessServiceType ServiceTypeName="NodeApp" UseImplicitHost="true" />
</ServiceTypes>
...
#### <a name="updating-the-codepackage"></a>Actualización de CodePackage
...
#### <a name="optional:-updating-the-setupentrypoint"></a>Opcional: Actualización de SetupEntrypoint
```xml
<SetupEntryPoint>
   <ExeHost>
       <Program>scripts\launchConfig.cmd</Program>
...
#### <a name="updating-the-entrypoint"></a>Actualización de Entrypoint
```xml
<EntryPoint>
  <ExeHost>
    <Program>node.exe</Program>
...
#### <a name="updating-the-endpoints-and-registering-with-naming-service-for-communication"></a>Actualización de puntos de conexión y registro mediante el servicio de nombres para la comunicación
```xml
<Endpoints>
   <Endpoint Name="NodeAppTypeEndpoint" Protocol="http" Port="3000" Type="Input" />
</Endpoints>
