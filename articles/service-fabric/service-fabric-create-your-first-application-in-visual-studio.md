...
5. En el cuadro de diálogo siguiente puede crear cualquier tipo de aplicación de Service Fabric. Para esta guía de inicio rápido, elija **.Net Core 2.0** > **Servicio con estado**.
