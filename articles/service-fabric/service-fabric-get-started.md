...
>[AZURE.NOTE] Windows 7 solo incluye de forma predeterminada Windows PowerShell 2.0. Para usar los cmdlets de PowerShell para Service Fabric, deberá instalar PowerShell 3.0 o una versión superior. Puede [descargar Windows PowerShell 5.0][powershell5-download] desde el Centro de descarga de Microsoft.
...
- [Instalar el tiempo de ejecución, el SDK y las herramientas de Service Fabric para Visual Studio 2015 Update 2][full-bundle-vs2015]
...
[full-bundle-vs2015]: http://www.microsoft.com/web/handlers/webpi.ashx?command=getinstallerredirect&appid=MicrosoftAzure-ServiceFabric-VS2015-2_1 "Vínculo de WebPI de VS 2015"
[full-bundle-dev15]: http://www.microsoft.com/web/handlers/webpi.ashx?command=getinstallerredirect&appid=MicrosoftAzure-ServiceFabric-Dev15-2_1 "Vínculo de WebPI de Dev15"
[core-sdk]: http://www.microsoft.com/web/handlers/webpi.ashx?command=getinstallerredirect&appid=ServiceFabricSDK_2_1 "Vínculo de WebPI de SDK de núcleo"
