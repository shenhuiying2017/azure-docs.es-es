...
# Información sobre cómo la serialización afecta a la actualización de la aplicación
...
### Contrato de datos es el serializador predeterminado.
...
2. Durante la actualización gradual, el clúster puede contener una mezcla de las versiones anteriores y nuevas de su código. Como las réplicas se pueden incluir en distintos dominios de actualización y las réplicas envían datos entre sí, tanto la versión nueva como la anterior de los datos se pueden encontrar en la versión nueva o la anterior del serializador.
