...
**Estado de servicio** hace referencia a los datos que el servicio necesita para poder funcionar. Incluye las variables y las estructuras de datos que el servicio lee y escribe para realizar el trabajo.

Por ejemplo, piense en un servicio de calculadora. Este servicio toma dos números y devuelve su suma. Se trata de un servicio puramente sin estado que no tiene datos asociados.
...
El estado también se puede colocar con el código que manipula este código. Los servicios con estado de Service Fabric se pueden crear con este modelo. Service Fabric ofrece la infraestructura para garantizar que este estado es de alta disponibilidad y tolerante a errores en caso de un error.

## <a name="next-steps"></a>Pasos siguientes
Para información sobre los conceptos de Service Fabric, vea los siguientes artículos:
