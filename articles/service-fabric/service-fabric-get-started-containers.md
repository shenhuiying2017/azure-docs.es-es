...
Puede configurar el comportamiento de la instrucción **HEALTHCHECK** para cada contenedor especificando las opciones de **HealthConfig** como parte de **ContainerHostPolicies** en ApplicationManifest.
