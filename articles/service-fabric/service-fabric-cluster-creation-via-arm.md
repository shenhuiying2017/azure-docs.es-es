...
### Cree un almacén de claves en el nuevo grupo de recursos
...
## Uso de un almacén de claves existente
...
## Introducción de certificados al almacén de claves
...
#### Carga de un certificado existente
...
#### Creación de un certificado autofirmado para cargarlo en el almacén de claves
...
##### Recurso de conjunto de escalado de máquinas virtuales:
```json
{
  "apiVersion": "2016-03-30",
  "type": "Microsoft.Compute/virtualMachineScaleSets",
...
### Inserción de la configuración de Azure AD
...
## Solución de problemas de configuración de Azure Active Directory para la autenticación de cliente
...
### Error de conexión con PowerShell: "Las credenciales especificadas no son válidas"
<a id="problem" class="xliff"></a>
