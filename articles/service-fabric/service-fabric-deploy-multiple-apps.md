---
title: Implementación de una aplicación de Node.js con MongoDB | Microsoft Docs
...
> [!NOTE]
> Con Visual Studio, puede publicar la aplicación de forma local mediante la depuración (F5) o mediante el asistente para publicación.
> 
> 
