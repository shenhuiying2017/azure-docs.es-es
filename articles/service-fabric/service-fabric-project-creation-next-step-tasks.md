...
La aplicación de Service Fabric se ha creado. En este artículo se describe la preparación del proyecto y algunos posibles pasos siguientes.
...
### Reliable Actors
Cuando se agregan nuevos Reliable Actors, Visual Studio agrega dos proyectos a la solución: un proyecto de actor y un proyecto de interfaz.
...
Service Fabric proporciona integración con ASP.NET 5 para la creación de puntos de entrada basados en web en la aplicación. Consulte [Adición de un front-end web a la aplicación][add-web-frontend] para saber cómo crear una interfaz de REST basada en WebAPI de ASP.NET.
