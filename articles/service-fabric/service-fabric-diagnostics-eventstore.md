...
>[!NOTE]
>A partir de Service Fabric versión 6.2. las API de EventStore son una versión preliminar solo de los clústeres de Windows que se ejecutan en Azure. Se está trabajando para portar esta funcionalidad a Linux, así como nuestros clústeres independientes.
