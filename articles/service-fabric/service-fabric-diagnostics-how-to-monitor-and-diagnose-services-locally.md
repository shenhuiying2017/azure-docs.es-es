...
## <a name="the-benefits-of-event-tracing-for-windows"></a>Ventajas del Seguimiento de eventos para Windows
...
* [Recopilación de registros directamente desde el proceso del servicio](service-fabric-diagnostic-collect-logs-without-an-agent.md)
