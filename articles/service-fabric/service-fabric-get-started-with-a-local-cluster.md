...
El SDK de Service Fabric incluye un completo entorno de desarrollo local y permite empezar a trabajar rápidamente con aplicaciones de implementación y administración en un clúster local. En este artículo, se crea un clúster local, se implementa en él una aplicación existente y, a continuación, se actualiza dicha aplicación a una nueva versión, y todo ello desde Windows PowerShell.
