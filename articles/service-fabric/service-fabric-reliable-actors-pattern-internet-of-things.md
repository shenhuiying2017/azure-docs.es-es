...
<properties
   ...
   description="Reliable Actors de Service Fabric es el bloque de creación clave en un sistema que combina un front-end del sistema de mensajería que admite varios transportes como HTTPS, MQTT o AMQP."
