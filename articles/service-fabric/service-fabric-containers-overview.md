---
title: Información general de Service Fabric y los contenedores | Microsoft Docs
...
1. **Contenedores invitados**: similar al [escenario de archivo ejecutable invitado](service-fabric-deploy-existing-app.md) en el que puede implementar las aplicaciones existentes en un contenedor. Por ejemplo nodejs, javascript o cualquier código (EXE).
