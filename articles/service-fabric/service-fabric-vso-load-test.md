...
El siguiente diagrama ilustra la aplicación de Service Fabric que va a probar.
...
1. Expanda el nodo **Visual C#** y elija **Prueba** > **Proyecto de prueba de carga y rendimiento web**. Asigne un nombre al proyecto y, a continuación, elija el botón **Aceptar**.

    ![][1]

    Debería ver un nuevo proyecto de prueba de carga y rendimiento web.
...
1. Elija el icono **Agregar grabación** para iniciar una sesión de grabación en el explorador.

    ![][3]

    ![][4]

1. Vaya a la aplicación de Service Fabric. El panel de grabación debe mostrar las solicitudes web.

    ![][5]

1. Realice una secuencia de acciones que se espera que los usuarios realicen. Estas acciones se usan como patrón para generar la carga.

1. Cuando haya terminado, elija el botón **Detener** para parar la grabación.
...
1. Guarde el proyecto y, a continuación, elija el comando **Ejecutar prueba** para ejecutar la prueba de rendimiento web localmente y asegurarse de que todo funciona correctamente.

    ![][7]

### Parametrización de la prueba de rendimiento web

La prueba de rendimiento web se puede parametrizar convirtiéndola en una prueba de rendimiento web codificada y, a continuación, editando el código. Como alternativa, puede enlazar la prueba de rendimiento web con una lista de datos para que la prueba se itere a través de los datos. Consulte [Generación y ejecución de una prueba de rendimiento web codificada](https://msdn.microsoft.com/library/ms182552.aspx) para obtener información detallada sobre cómo convertir la prueba de rendimiento web en una prueba codificada, e [Incorporación de un origen de datos a una prueba de rendimiento web](https://msdn.microsoft.com/library/ms243142.aspx) para informarse sobre cómo enlazar datos a una prueba de rendimiento web.
...
1. En la sección **Patrón de carga**, elija si desea una carga de usuarios constante o una carga por pasos, que comienza con unos pocos usuarios y los va aumentando a medida que pasa el tiempo.

    Si tiene una buena estimación de la cantidad de carga de usuario y desea ver cómo rinde el sistema actual, elija **Carga constante**. Si su objetivo es saber si el rendimiento es constante con distintas cantidades de carga, elija **Carga por pasos**.
...
1. Elija el vínculo **Descargar informe** cerca de la parte superior de la página. Una vez que se descarga el informe, elija el botón **Ver informe**.

    En la pestaña **Gráfico**, puede ver los gráficos de varios contadores de rendimiento. En la pestaña **Resumen**, aparecen los resultados generales de la prueba . En la pestaña **Tablas** aparece el número total de pruebas de carga superadas y no superadas.

1. Elija el número de vínculos en las columnas **Prueba** > **Con error** y **Errores** > **Recuento** para ver los detalles del error.
...
Consulte [Análisis de los resultados de una prueba de carga en la vista de gráficos del analizador de prueba de carga](https://www.visualstudio.com/load-testing.aspx) para obtener más información acerca de cómo ver los resultados de las pruebas de carga.
