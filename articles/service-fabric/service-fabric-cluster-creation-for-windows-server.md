<properties
   ...
   description="Aprenda a crear un clúster de Service Fabric de Azure en cualquier máquina (física o virtual) que ejecute Windows Server, ya sea local o en la nube."
...
- Paquete redistribuible de Visual C++ 2012 (VC ++ 11.0)
