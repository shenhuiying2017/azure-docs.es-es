...
El estado se puede recuperar mediante una operación *Get`KeyNotFoundException` estándar que inicia * si no existe ninguna entrada para la clave especificada: 
