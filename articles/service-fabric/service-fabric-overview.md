...
Service Fabric impulsa muchos servicios de Microsoft en la actualidad, como Base de datos SQL de Azure, DocumentDB de Azure, Cortana, Power BI, Microsoft Intune, Centros de eventos de Azure, muchos servicios principales de Azure y Skype Empresarial, por nombrar algunos.
...
- Desarrollar aplicaciones que compuestas de microservicios, archivos ejecutables y otros marcos de aplicación que elija, como ASP.NET, Node.js, etc.
