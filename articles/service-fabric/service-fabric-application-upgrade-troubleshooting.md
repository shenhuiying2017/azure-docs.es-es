...
Service Fabric convierte todos los porcentajes en números reales de entidades (por ejemplo, réplicas, particiones y servicios) para la evaluación de estado y siempre se redondea a las entidades completas. Por ejemplo, si el valor de *MaxPercentUnhealthyReplicasPerPartition* máximo es 21 % y hay cinco réplicas, Service Fabric permite entonces hasta dos réplicas con estado incorrecto (es decir, `Math.Ceiling (5*0.21)'). Por lo tanto, las directivas de mantenimiento deben establecerse como corresponda.
