<properties umbracoNaviHide="0" pageTitle="Conceptos de cuenta de almacenamiento | Azure" metaKeywords="Azure storage, storage service, service, storage account, account, create storage account, create account" description="Información acerca de los conceptos de cuenta de almacenamiento." urlDisplayName="How to: storage accounts" headerExpose="" footerExpose="" disqusComments="1" title="Storage Account Concepts" services="storage" authors="tamram" manager="adinah" />
