<properties 
	pageTitle="Conceptos de cuenta de almacenamiento | Azure" 
	description="Información acerca de los conceptos de cuenta de almacenamiento." 
	headerExpose="" 
	footerExpose="" 
	services="storage" 
	authors="tamram" 
...
Su cuenta de almacenamiento de Azure es una cuenta única y segura a través de la cual puede tener acceso a los servicios de almacenamiento de Azure - los servicios de blobs, colas, tablas y archivos. Los datos se encuentran protegidos en el nivel de la cuenta de almacenamiento y, de manera predeterminada, solo están a disposición del propietario: usted. 
...
3. En **Dirección URL**, escriba un nombre para la cuenta de almacenamiento. Consulte [Extremos de cuenta de almacenamiento](#account-endpoints) más adelante para obtener información detallada sobre la forma en que se utilizará este nombre para dirigir objetos almacenados en el Almacenamiento de Azure.
...
También puede configurar un nombre de dominio personalizado para usar con la cuenta de almacenamiento. Consulte [Configuración de un nombre de dominio personalizado para datos blob en una cuenta de almacenamiento](http://azure.microsoft.com/es-es/documentation/articles/storage-custom-domain-name/) para obtener más información.
