...
description: Aprenda a usar Azure Databricks con Event Hubs para ingerir datos transmitidos desde Twitter y leer los datos en tiempo real.
...
En este tutorial, conectará un sistema de ingesta de datos con Azure Databricks para transmitir datos en tiempo real a un clúster de Apache Spark. El sistema de ingesta de datos en tiempo real se configura con Azure Event Hubs y, a continuación, se conecta con Azure Databricks para procesar los mensajes entrantes. Para acceder a un flujo de datos en tiempo real, utilice las API de Twitter para la ingesta de tweets en Event Hubs. Una vez que tiene los datos en Azure Databricks, puede ejecutar trabajos analíticos para analizar con mayor profundidad los datos. En este tutorial, se extraen los tweets que contienen el término "Azure".

La siguiente captura de pantalla muestra el flujo de la aplicación:
...
Para recibir un flujo de tweets en tiempo real, puede crear una aplicación en Twitter. Siga las instrucciones para crear una aplicación de Twitter y anote los valores que necesita para finalizar este tutorial.
...
Presione **MAYÚS + ENTRAR** para ejecutar el cuaderno. Verá una salida similar al siguiente fragmento. Cada evento de la salida es un tweet en tiempo real que contiene el término "Azure" y que se ingiere en Event Hubs. 
...
Eso es todo. Con Azure Databricks, ha transmitido correctamente datos en tiempo real a Azure Event Hubs. A continuación, ha consumido los datos de la transmisión mediante el conector de Event Hubs para Apache Spark.
...
>[Análisis de opiniones sobre los datos transmitidos con Azure Databricks](databricks-stream-from-eventhubs.md)
