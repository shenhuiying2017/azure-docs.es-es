...
description: "Azure Databricks es una plataforma de análisis de datos basada en Apache Spark."
...
* Visualice los datos en unos clics y use herramientas conocidas como Matplotlib, ggoplot o d3.
