...
##<a name="websitemetrics"></a>Procedimientos: Incorporación de métricas de aplicaciones web

1. En el [Portal de Azure](http://go.microsoft.com/fwlink/?LinkId=529715), en las páginas de administración de la aplicación web, haga clic en la pestaña **Supervisar** para mostrar la mostrar la página de administración **Supervisar**. De manera predeterminada, el gráfico de la pantalla **Supervisar** muestra las mismas métricas que el gráfico de la página **Panel**. 

2. Si desea ver métricas adicionales para el sitio web, haga clic en **Agregar métricas** en la parte inferior de la página para mostrar el cuadro de diálogo **Elegir métricas**. 
...
### Procedimientos: Visualización de las cuotas de uso para aplicaciones web configuradas para el modo Compartido ###
...
##<a name="resourceusage"></a> Eliminación superar las cuotas
...
##<a name="howtoconfigdiagnostics"></a>Procedimientos: Configuración de registros de diagnóstico y descarga para una aplicación web

Los diagnósticos se habilitan en la página de administración **Configurar** de la aplicación web. Existen dos tipos de diagnóstico: **diagnósticos de la aplicación** y **diagnósticos del sitio**.
...
> [AZURE.IMPORTANT] El registro y el seguimiento suponen exigencias importantes en una aplicación web. Recomendamos desactivar el registro y el seguimiento una vez que haya reproducido los problemas que se están solucionando.
...
- **Mostrar vínculos a información legal, etc.**: Proporciona información resumida adicional acerca del error y también puede incluir vínculos a otros recursos, como artículos de Microsoft Knowledge Base.
...
##<a name="webendpointstatus"></a> Eliminación Supervisión del estado de extremo web
...
11.	En **tipo de servicio**, seleccione **Aplicación web**, a continuación. seleccione la aplicación para la que configuró anteriormente la supervisión de extremos. Haga clic en **Next**.
...
- [Mantener activos Sitios web de Azure y supervisar extremos - con Stefan Schackow](/documentation/videos/azure-web-sites-endpoint-monitoring-and-staying-up/) (en inglés).
