...
- Las características de vista previa están en fase de prueba y podrían cambiar o incluso cancelarse antes de alcanzar la disponibilidad general. Las características de versión preliminar están siempre disponibles en la [versión preliminar de la API de REST](search-api-2015-02-28-preview.md) y a veces en el [SDK de .NET](http://go.microsoft.com/fwlink/?LinkId=528216). La documentación de la característica siempre explicará cómo obtener acceso a la característica en cuestión.
