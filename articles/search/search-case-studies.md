...
description: Casos prácticos e historias de clientes acerca de Azure Search, un servicio de búsqueda hospedado en la nube en Microsoft Azure.
author: HeidiSteen
manager: cgronlun
tags: azure-portal
services: search
...
ms.locfileid: "31790277"
---
# <a name="whos-using-azure-search-case-studies-and-customer-stories"></a>Quién usa Azure Search: casos prácticos y testimonios de clientes
Obtenga información sobre cómo las siguientes organizaciones desarrollaron sus negocios mediante la integración de la experiencia enriquecida de Azure Search en sus aplicaciones en línea.
