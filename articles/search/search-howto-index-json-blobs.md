...
> [!IMPORTANT]
> Cuando se utiliza el modo de análisis de `json` o `jsonArray`, Búsqueda de Azure da por hecho que todos los blobs en el origen de datos serán JSON. Si necesita admitir una mezcla de blobs JSON y que no son JSON en el mismo origen de datos, háganoslo saber en [nuestro sitio UserVoice](https://feedback.azure.com/forums/263029-azure-search).
> 
> 
