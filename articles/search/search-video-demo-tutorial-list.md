...
- [**AzSearchAutoScaleWeb**](https://github.com/liamca/AzureSearchDemos/tree/master/AzSearchAutoScaleWeb) es un código de ejemplo que muestra cómo escalar automáticamente un servicio de Búsqueda de Azure.
