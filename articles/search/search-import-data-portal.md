...
description: "Utilice el Asistente para la importación de datos de Azure Search en Azure Portal para rastrear datos de Azure desde DocumentDB NoSQL, Blob Storage, Table Storage, SQL Database y SQL Server en máquinas virtuales de Azure."
services: search
documentationcenter: 
author: HeidiSteen
manager: jhubbard
...
* [Indexación de DocumentDB](search-howto-index-documentdb.md)
