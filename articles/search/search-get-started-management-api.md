...
[Flujo de trabajo de desarrollo de Azure Search]: search-workflow.md
[Creación de la primera solución de Azure Search]: search-create-first-solution.md
[Crear una aplicación de búsqueda geoespacial usando Azure Search]: search-create-geospatial.md
