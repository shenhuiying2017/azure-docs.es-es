---
title: "Caso práctico para desarrolladores de Azure Search: Cómo crea WhatToPedia.com un portal infomedia en Microsoft Azure | Microsoft Docs"
...
---
# <a name="azure-search-developer-case-study"></a>Caso práctico para desarrolladores de Búsqueda de Azure
## <a name="how-whattopediacomhttpwhattopediacom-built-an-infomedia-portal-on-microsoft-azure"></a>¿Cómo crea [WhatToPedia.com](http://whattopedia.com/) un portal infomedia en Microsoft Azure
...
## <a name="how-we-did-it"></a>¿Cómo lo hicimos?
...
### <a name="how-we-use-microsoft-azure"></a>Cómo se usa Microsoft Azure
...
2. Realice una llamada a la API del servicio Azure Search para subir distribuidores de uno en uno (vea: http://msdn.microsoft.com/library/azure/dn798930.aspx).
...
1. Realice una llamada al servicio Azure Search para obtener todos los documentos de la búsqueda (vea: http://msdn.microsoft.com/library/azure/dn798927.aspx).
2. Extraiga lo siguiente de la respuesta de servicio de búsqueda (con json.net http://james.newtonking.com/json):
   * Results
   * Facetas
...
## <a name="what-we-learned"></a>¿Qué hemos aprendido?
...
### <a name="webjobs-for-scheduling-tasks"></a>WebJobs para tareas de programación
...
### <a name="azure-blob-storage-explorer-for-updating-images"></a>Explorador de almacenamiento BLOB de Azure para actualizar imágenes
...
## <a name="a-few-final-words"></a>Observaciones finales
...
## <a name="appendix-search-indexer-webjob"></a>Apéndice: WebJob de indexador de búsqueda
...
[Subtítulo 4]: #subheading-4
[Subtítulo 5]: #subheading-5
...
<!--Link references-->
[Vínculo 1 a otro tema de documentación de azure.microsoft.com]: ../virtual-machines-windows-hero-tutorial.md
[Vínculo 2 a otro tema de documentación de azure.microsoft.com]: ../web-sites-custom-domain-name.md
[Vínculo 3 a otro tema de documentación de azure.microsoft.com]: ../storage-whatis-account.md
