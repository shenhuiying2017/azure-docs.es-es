...
> [AZURE.NOTE] Si utiliza una operación PUT para actualizar el servicio, debe usar el mismo cuerpo de solicitud empleado en una solicitud de [creación de servicio](#CreateService).
