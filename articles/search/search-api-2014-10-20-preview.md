<properties pageTitle="API de REST del Servicio Búsqueda de Azure versión 2014-10-20-Preview" description="API de REST del Servicio Búsqueda de Azure versión 2014-10-20-Preview" services="search" solutions="" documentationCenter="" authors="HeidiSteen" manager="mblythe" editor="" />
