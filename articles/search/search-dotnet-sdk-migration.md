...
> [AZURE.NOTE] Si utiliza la versión 0.13-preview o anterior, primero debe actualizar a la versión 1.1 y después a la 2.0-preview. Consulte [Apéndice: pasos para actualizar a la versión 1.1](#UpgradeStepsV1) para obtener instrucciones.
...
> [AZURE.NOTE] Esta sección se aplica únicamente a los usuarios de la versión de SDK de .NET para Búsqueda de Azure 0.13-preview y anteriores.
