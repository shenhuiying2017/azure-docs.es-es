...
---
# <a name="upgrading-to-the-azure-search-net-sdk-version-20-preview"></a>Actualización a la versión 2.0-preview del SDK de .NET para Búsqueda de Azure
...
## <a name="whats-new-in-version-20-preview"></a>Novedades de la versión 2.0-preview
...
## <a name="breaking-changes-in-version-20-preview"></a>Cambios importantes en la versión 2.0-preview
...
Agradecemos sus comentarios sobre el SDK. Si tiene algún problema, no dude en pedirnos ayuda en el [foro de MSDN sobre Búsqueda de Azure](https://social.msdn.microsoft.com/Forums/azure/en-US/home?forum=azuresearch). Si encuentra un error, puede enviarlo al [repositorio de GitHub del SDK de .NET para Azure](https://github.com/Azure/azure-sdk-for-net/issues). Asegúrese de que prefija el título del problema con "SDK de búsqueda: ".
