<properties 
	pageTitle="Operaciones de indexador (API de REST del servicio de Búsqueda de Azure: 2014-10-20-Preview)" 
	description="Operaciones de indexador (API de REST del servicio de Búsqueda de Azure: 2014-10-20-Preview)" 
	services="search" 
	documentationCenter="" 
	authors="HeidiSteen" 
	manager="mblythe" />
