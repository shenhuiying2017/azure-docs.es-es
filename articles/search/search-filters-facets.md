...
+ Edm.DateTimeOffset
+ Edm.Boolean
+ Edm.Collections (consulte [cómo clasificar en facetas tipos de datos complejos](#facet-complex-fields) más adelante).
...
+ [Filters in Azure Search](search-filters.md) (Filtros en Azure Search)
