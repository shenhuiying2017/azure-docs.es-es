...
El SDK para .NET es compatible con la versión `2015-02-28` de la API de REST de Búsqueda de Azure, documentada en [MSDN](https://msdn.microsoft.com/library/azure/dn798935.aspx). Esta versión ahora es compatible con la sintaxis de consulta Lucene y los analizadores de idioma de Microsoft. Las nuevas características que *no* forman parte de esta versión, como la compatibilidad con el parámetro de búsqueda `moreLikeThis`, se encuentran en [versión preliminar](search-api-2015-02-28-preview.md) y no están disponibles todavía en el SDK. Puede consultar [Control de versiones del servicio de búsqueda](https://msdn.microsoft.com/library/azure/dn864560.aspx) para ver las actualizaciones de estado de cada característica.
