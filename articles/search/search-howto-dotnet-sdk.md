...
Si ya utiliza una versión anterior del SDK de .NET para Búsqueda de Azure y desea actualizar a la nueva versión preliminar 1.0, en [este artículo](search-dotnet-sdk-migration.md) se explica cómo.
