<properties
   pageTitle="Cómo usar Búsqueda de Azure desde una aplicación .NET | Microsoft Azure | Servicio de búsqueda hospedado en la nube"
...
El SDK de Búsqueda de Azure para .NET es compatible con aplicaciones orientadas a .NET Framework 4.0 o superior y con aplicaciones de la Tienda Windows destinadas a Windows 8.1 y Windows Phone 8.1. No se admite Silverlight.
...
#### Cómo gestiona los documentos el SDK para .NET ####
