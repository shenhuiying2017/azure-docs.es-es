...
Si ya está utilizando una versión anterior del SDK de .NET de Búsqueda de Azure y desea actualizar a la nueva versión de vista previa 1.0.1, [este artículo](search-dotnet-sdk-migration.md) explica cómo.
