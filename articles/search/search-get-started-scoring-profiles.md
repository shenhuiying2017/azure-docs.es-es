---
title: Uso de los perfiles de puntuación en la Búsqueda de Azure | Microsoft Docs
...
[!INCLUDE [Para completar este tutorial, deberá tener una cuenta de Azure:](../../includes/free-trial-note.md)]
