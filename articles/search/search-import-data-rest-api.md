...
Los requisitos previos para realizar la importación incluyen tener un índice existente preparado para recibir los datos.

Cuando se usa la API de REST, la ingesta de datos se basa en una solicitud PUT o POST HTTP. Los fragmentos de código pertenecen al [ejemplo de perfiles de puntuación](search-get-started-scoring-profiles.md).
