---
title: "Uso de módulos de Terraform para crear una infraestructura de VM Linux con equilibrio de carga en Azure"
description: "Aprenda a usar módulos de Terraform para crear un clúster de máquinas virtuales Linux con un equilibrador de carga en Azure"
...
---
# <a name="create-a-vm-cluster-with-terraform-using-custom-hcl"></a>Creación de un clúster de VM con Terraform mediante HCL personalizado
...
> * Aplicar la configuración para crear el clúster
...
![Plan de Terraform](media/terraformPlanVmsWithModules.png)


## <a name="create-the-virtual-machines-with-apply"></a>Crear las máquinas virtuales con apply

Ejecute `terraform apply` para aprovisionar el clúster de VM en Azure.
...
- Crear un [conjunto de escalado de máquinas virtuales con Terraform]()