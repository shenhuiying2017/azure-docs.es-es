<properties title="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with DomainDiscover - TierraNet" pageTitle="Configuración de un nombre de dominio de DomainDiscover para un sitio web de Azure mediante el Administrador de tráfico" metaKeywords="Microsoft Azure, Sitios web Microsoft Azure, DomainDiscover, TierraNet, Administrador de tráfico" description="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with DomainDiscover - TierraNet" services="web-sites" documentationCenter="" authors="larryfr,jroth" manager="wpickett" />
