...
[Sitios web](/es-es/documentation/articles/web-sites-directnic-custom-domain-name/ "Sitios web") | [Sitio web utilizando el Administrador de tráfico](/es-es/documentation/articles/web-sites-directnic-traffic-manager-custom-domain-name/ "Sitio web utilizando el Administrador de tráfico")
