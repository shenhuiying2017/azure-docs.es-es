<properties 
	pageTitle="Configuración de un nombre de dominio de Directnic para un sitio Web de Azure" 
	description="Obtenga información acerca de cómo configurar un sitio web de Azure para usar un nombre de dominio registrado con Directnic" 
	services="web-sites" 
	documentationCenter="" 
	authors="blackmist" 
	manager="wpickett" 
...
4. Agregue registros DNS; para ello, rellene los campos **Type** (Tipo), **Name** (Nombre) y **Data** (Datos). Cuando haya terminado, haga clic en el botón **Add Record** (Agregar registro).   
    ...
    * Cuando agregue un registro D, debe establecer el campo **Name** (Nombre) en **@** (esto representa el nombre del dominio raíz, como **contoso.com**) o el subdominio que desea usar (por ejemplo, **www**). Debe configurar el campo **Data** (Datos) con la dirección IP del sitio web de Azure.
		...
		> 
		> * Un valor de **Name** de **www** con un valor de **Data** de **&lt;nombredesusitioweb&gt;.azurewebsites.net**.
		> 
		> O bien
		> 
		> *Un valor de **Name** de **awverify.www** con un valor de **Data** de **awverify.&lt;nombredesusitioweb&gt;.azurewebsites.net**.
		> 
