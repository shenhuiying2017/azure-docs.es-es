---
title: ¿Qué hago si se deshabilita mi suscripción de Azure? | Microsoft Docs
...
> [!NOTE]
> Si está usando una suscripción de evaluación gratuita, quitar el límite de gasto convertirá la suscripción a pago por uso al final de la evaluación gratuita.
> 
> 
...
> [!NOTE]
> Este método actualmente solo se aplica a las suscripciones de pago por uso. Para otros tipos de suscripción, deberá [ponerse en contacto con el equipo de soporte técnico](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade).
> 
> 
