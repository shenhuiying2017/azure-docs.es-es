...
### <a name="a-namestep2astep-2-change-the-directory-associated-with-the-azure-subscription"></a><a name="Step2"></a>Paso 2: cambio del directorio asociado a la suscripción de Azure.
