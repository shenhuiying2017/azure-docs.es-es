...
1. Inicie sesión en [Azure Portal](https://portal.azure.com/). Seleccione **Ayuda y soporte técnico** > **Nueva solicitud de soporte técnico**.
...
3. En la hoja **Problema**, seleccione **Pagar mediante factura** en el cuadro **Tipo de problema**.
