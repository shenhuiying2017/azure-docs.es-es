...
### <a name="can-notifications-be-sent-to-a-different-email-address-other-than-the-account-administrator-email-address-associated-with-my-account"></a>¿Se pueden enviar notificaciones a una dirección de correo electrónico diferente de la del administrador de la cuenta asociada a mi cuenta?
