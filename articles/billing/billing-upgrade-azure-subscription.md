...
1. Inicie sesión en el [Portal de cuentas de Azure](https://account.windowsazure.com/subscriptions).
1. En la sección de estado de la suscripción, seleccione la pancarta **Actualizar ahora**.
...
La actualización no cuesta dinero, y solo se le cobra por los servicios que utiliza. Después de confirmar la actualización, sigue manteniendo el crédito de evaluación hasta el final del período de evaluación.