...
Si la tarjeta de débito o crédito se rechaza o no se acepta al suscribirse a Azure, puede que tenga que hacer frente a alguno de los siguientes problemas:

* **El proveedor de la tarjetas de crédito o débito no se acepta en su país.** Cuando elige una tarjeta, solo ve las opciones que son válidas en el país que selecciona. Póngase en contacto con su banco o emisor de tarjeta para confirmar que la tarjeta de crédito tiene habilitada las transacciones internacionales. Consulte los países y las monedas que se admiten en la página de [preguntas frecuentes de compras de Azure](https://azure.microsoft.com/pricing/faq/).
...
* **La tarjeta está inactiva o bloqueada.** Póngase en contacto con el banco para asegurarse de que la tarjeta está activa.
* **Es posible que haya otros problemas de registro** Compruebe cómo [solucionar problemas de registro de Azure](billing-troubleshoot-azure-sign-up-issues.md).

Después de actualizar su información de pago, intente suscribirse de nuevo.

## <a name="representing-a-business-that-doesnt-want-to-pay-by-card-set-up-invoicing"></a>¿Representa a una empresa que no quiere pagar con tarjeta? Configurar la facturación
