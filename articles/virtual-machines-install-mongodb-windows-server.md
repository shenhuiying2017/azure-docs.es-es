...
Para obtener instrucciones acerca de cómo conseguir esta información, consulte la sección "Inicializar un disco de datos nuevo en Windows Server" en [Acoplamiento de un disco de datos a una máquina virtual de Windows](http://azure.microsoft.com/documentation/articles/storage-windows-attach-disk/).
