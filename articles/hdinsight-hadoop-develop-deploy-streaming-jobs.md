...
3.  Escriba o seleccione los valores siguientes:
 ...
 <tr data-morhtml="true"><td data-morhtml="true">Campo</td><td data-morhtml="true">Valor</td></tr>
 <tr data-morhtml="true"><td data-morhtml="true">Plantilla</td><td data-morhtml="true">Visual C#/Windows/Aplicaci&oacute;n de consola</td></tr>
 <tr data-morhtml="true"><td data-morhtml="true">Nombre</td><td data-morhtml="true">WordCountMapper</td></tr>
 <tr data-morhtml="true"><td data-morhtml="true">Ubicaci&oacute;n</td><td data-morhtml="true">C:\Tutorials</td></tr>
 <tr data-morhtml="true"><td data-morhtml="true">Nombre de la soluci&oacute;n</td><td data-morhtml="true">WordCount</td></tr>
 </table>
...
2.  Escriba o seleccione los valores siguientes:
 ...
 <tr data-morhtml="true"><td data-morhtml="true">Campo</td><td data-morhtml="true">Valor</td></tr>
 <tr data-morhtml="true"><td data-morhtml="true">Plantilla</td><td data-morhtml="true">Visual C#/Windows/Aplicaci&oacute;n de consola</td></tr>
 <tr data-morhtml="true"><td data-morhtml="true">Nombre</td><td data-morhtml="true">WordCountReducer</td></tr>
 <tr data-morhtml="true"><td data-morhtml="true">Ubicaci&oacute;n</td><td data-morhtml="true">C:\Tutorials\WordCount</td></tr>
 </table>
...
<tr data-morhtml="true"><td data-morhtml="true">\WordCount</td><td data-morhtml="true">La carpeta ra&iacute;z para el proyecto del recuento de palabras. </td></tr>
...
2.  Copie y pegue el código siguiente:
         ...
         $location = "East US"     ### debe coincidir con la ubicación de la cuenta de almacenamiento de datos
         $clusterNodes = 1
         ...
         # Las variables de trabajo de MapReduce de streaming
         $mrMapper = "WordCountMapper.exe"
         $mrReducer = "WordCountReducer.exe"
         ...
         #=============================
         # Crear una definición de trabajo de MapReduce de streaming
         ...
         #=============================
         # Ejecutar un trabajo de MapReduce de streaming
