...
En las instrucciones de este tema se asume que tiene instalado [PHP](http://www.php.net/manual/en/install.php).
...
Si desea obtener información acerca del uso de las bibliotecas de clientes PHP para Azure, consulte [How to Use the Blob Service](http://go.microsoft.com/fwlink/?LinkId=252714), [How to Use the Table Service](http://go.microsoft.com/fwlink/?LinkId=252715) y [How to Use the Queue Service](http://go.microsoft.com/fwlink/?LinkId=252716).

### Instalación mediante el compositor

1.  Obtenga información sobre la instalación de Git en [Install Git](http://git-scm.com/book/en/Getting-Started-Installing-Git).
...
1.  [Instale PEAR](http://pear.php.net/manual/en/installation.getting.php) (información en inglés).
...
1.  Descargue un archivo .zip que contenga las bibliotecas desde [GitHub](http://go.microsoft.com/fwlink/?LinkId=252719). También puede bifurcar el repositorio y clonarlo en su máquina local. La última opción requiere una cuenta GitHub y tener Git instalado localmente.

    > [WACOM.NOTE]
    > Las bibliotecas de clientes PHP para Azure tienen una dependencia en los paquetes PEAR [HTTP\_Request2](http://pear.php.net/package/HTTP_Request2), [Mail\_mime](http://pear.php.net/package/Mail_mime) y [Mail\_mimeDecode](http://pear.php.net/package/Mail_mimeDecode). La forma recomendada de resolver estas dependencias es instalar esos paquetes con el [administrador de paquetes PEAR](http://pear.php.net/manual/en/installation.php) (en inglés).
...
La manera recomendada de instalar Azure PowerShell y los emuladores de Azure es utilizar el [instalador de plataforma web de Microsoft](http://go.microsoft.com/fwlink/?LinkId=253447). Observe que también puede elegir instalar otros componentes de desarrollo, como PHP, SQL Server, los controladores de Microsoft para SQL Server para PHP y WebMatrix.

Para obtener más información acerca del uso Azure PowerShell, consulte [Uso de Azure PowerShell](http://go.microsoft.com/fwlink/?LinkId=252718).
...
-   **Mac**: Descargue el Instalador de SDK de Azure aquí: <http://go.microsoft.com/fwlink/?LinkId=252249>. Abra el archivo .pkg descargado y complete los pasos de instalación a medida que se le solicita.
...
Para obtener información sobre el uso de las herramientas de línea de comandos de Azure para Mac y Linux, consulte [Uso de las herramientas de línea de comandos para Mac y Linux](http://go.microsoft.com/fwlink/?LinkId=252717).
