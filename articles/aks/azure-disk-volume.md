...
Las aplicaciones que usan contenedores a menudo necesitan acceder a un volumen de datos externo y conservar datos en él. Los discos de Azure se pueden usar como este almacén de datos externos. En este artículo se describe el uso de un disco de Azure como un volumen de Kubernetes en un clúster de Azure Container Service (AKS).
