...
Seleccione **Crear un recurso** > **Contenedores** > **Azure Container Service - AKS (versión preliminar)**.
...
Especificación de la suscripción (si aún no lo ha hecho)
