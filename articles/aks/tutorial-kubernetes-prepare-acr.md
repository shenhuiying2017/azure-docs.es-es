...
Cree una instancia de Azure Container Registry con el comando [az acr create][az-acr-create]. El nombre de una instancia de Container Registry **debe ser único**.
