<properties pageTitle="Acoplamiento de un disco a una máquina virtual que ejecuta Linux en Azure" description="Aprenda como acoplar un disco de datos a una máquina virtual de Azure y a inicializarla para que esté lista para utilizarse." services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor="tysonn"/>
