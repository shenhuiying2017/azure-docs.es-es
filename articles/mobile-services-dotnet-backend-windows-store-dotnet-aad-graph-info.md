...
+ [Incorporación de autenticación a la aplicación]<br/>Agrega un requisito de inicio de sesión a la aplicación de ejemplo TodoList.
...
[Obtención del usuario]: http://msdn.microsoft.com/es-es/library/azure/dn151678.aspx
