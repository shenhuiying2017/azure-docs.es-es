<properties title="Configure Active Directory for Azure RemoteApp" pageTitle="Configurar Active Directory para RemoteApp de Azure" description="Aprenda a configurar Active Directory para trabajar con Azure RemoteApp" metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo"  />
...
¿Todavía no ha agregado los servicios de dominio de Active Directory a su entorno de Windows Server 2012 R2? Consulte [estas instrucciones](http://technet.microsoft.com/es-es/library/cc731053(v=WS.10).aspx) para obtener información sobre cómo realizar esta operación.
...
2.	Expanda el nombre de dominio y, a continuación, haga clic en **Usuarios**.
3.	Haga clic con el botón secundario en **Administrador** y, a continuación, haga clic en **Propiedades**.
...
5.	Si no ve ningún sufijo que coincida con el nombre de dominio que desea utilizar para la recopilación de RemoteApp, haga lo siguiente:
	...
	2.	Haga clic con el botón secundario en **Dominios y confianzas de Active Directory** y, a continuación, haga clic en **Propiedades**.
	3.	Revise la lista de sufijos.
	4.	Escriba el FQDN del nombre de dominio en el cuadro y haga clic en **Agregar**. A continuación, haga clic en **Aceptar**. Ejemplo: contoso.com. 
...
Para obtener más información, consulte [Agregar sufijos de nombre principal de usuario](http://technet.microsoft.com/library/cc772007.aspx).
...
1. Inicie los equipos y usuarios de Active Directory.
2.	Haga clic con el botón secundario en **Usuarios** y, a continuación, haga clic en **Nuevo > Usuario**.
3.	Escriba un nombre de usuario y una contraseña para la cuenta de servicio de RemoteApp.

	**Nota:** necesitará esta información de cuenta al crear la recopilación de RemoteApp.
...
3.
	...
	Para ello, busque la cuenta de servicio que creó. Haga clic con el botón secundario en la cuenta y, a continuación, haga clic en **Mover**. Seleccione la nueva unidad organizativa y, a continuación, haga clic en **Aceptar**.


1. Conceda a la cuenta de servicio de RemoteApp la autoridad para agregar y eliminar equipos a esta 
UNIDAD ORGANIZATIVA:
	...
	2. Haga clic con el botón secundario en la unidad organizativa del servicio de RemoteApp y, a continuación, haga clic en **Propiedades**.
	3. En la pestaña **Seguridad**, haga clic en **Agregar**. Seleccione el objeto de usuario de la cuenta de servicio de RemoteApp y, a continuación, haga clic en **Aceptar**.
	4. Haga clic en **Avanzada**.
	5. En la pestaña **Permisos**, seleccione la cuenta de servicio de RemoteApp y, a continuación, haga clic en **Editar**.
	6. Seleccione **Este objeto y todos los descendientes** en el camp **Se aplica a**.
	7. En el campo **Permisos**, seleccione la opción **Permitir** situada junto a Crear objetos de equipo y Eliminar objetos de equipo y, a continuación, haga clic en **Aceptar**. 
...
- [Agregar su dominio](http://technet.microsoft.com/es-es/library/hh969247.aspx): utilice esta información para agregar un dominio que coincida con el sufijo UPN del dominio de su dominio de Active Directory local.
- [Integración de directorios](http://technet.microsoft.com/es-es/library/jj573653.aspx): utilice esta información para elegir una opción de integración de directorios como, por ejemplo, [DirSync con sincronización de contraseña](http://technet.microsoft.com/es-es/library/dn441214.aspx) o [DirSync con federación](http://technet.microsoft.com/es-es/library/dn441213.aspx).

También puede configurar la [Autenticación multifactor (MFA)](http://technet.microsoft.com/es-es/library/dn249466.aspx).
