...
-   El **cmdlet Add-AzureVHD**, que forma parte del módulo PowerShell de Azure. Para descargar el módulo, consulte la página de [descargas de Azure](/es-es/develop/downloads/). Para obtener más información, consulte [Add-AzureVhd](http://msdn.microsoft.com/library/windowsazure/dn495173.aspx).
