<properties title="How to scale a website" pageTitle="Escalación de un sitio web" description="Learn how to scale your hosting plan in Azure." authors="stepsic" manager="kamrani" />
