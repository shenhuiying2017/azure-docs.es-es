...
También observará que tiene un grupo de recursos predeterminada generado automáticamente en cada región que ya tiene sitios web. El nombre del grupo de recursos generado para sitios web es *Default-Web-<NOMBRE DE UBICACIÓN>* donde el nombre de ubicación representa una región de Azure (por ejemplo *Default-Web-WestUS*). En cada grupo de recursos encontrará todos los sitios existentes para la región del grupo. Cada sitio creado en el pasado y que se cree en el futuro en el portal de Azure completo o en el portal de vista previa de Azure, estará disponible en ambos portales. 
</br>
