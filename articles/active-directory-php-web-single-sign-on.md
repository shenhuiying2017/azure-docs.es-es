...
8.  En el Administrador de IIS, expanda la carpeta **Sites** en el menú de la izquierda, haga clic con el botón secundario en **Default Web Site** y, a continuación, haga clic en **Add Application...**.
...
3.  En el archivo **federation.ini**, escriba la siguiente información y suministre los valores con la información que guardó en el paso 2 cuando creó la entidad de servicio:
         ...
         <div class="dev-callout"><strong>Nota</strong><p>Los valores <b>audienceuris</b> y <b>realm</b> deben ir precedidos por "spn:".</p></div>
...
8.  En el menú **Run**, haga clic en **Run**. Se le redirigirá automáticamente a la página del proveedor de identidades de Office 365, donde puede iniciar sesión con sus credenciales de inquilino de directorio. Por ejemplo, *juan.perez@fabrikam.onmicrosoft.com*.
