...
Las versiones 3D de los [proyectos de arquitectura de Microsoft](http://aka.ms/azblueprints) se crearon inicialmente en una herramienta que no es de Microsoft, en una nueva plantilla de Visio 2013 comercializada el 5 de agosto de 2015 como parte de un [curso de certificación de arquitectura de Microsoft distribuido en EDX.ORG](#microsoft-architecture-certification-course).
...
##Conjuntos de símbolos e iconos 
