<properties 
	pageTitle="Arquitectura de aplicaciones en Microsoft Azure | Microsoft Azure" 
...
Microsoft ha creado un curso de arquitectura compatible con el examen de certificación de Microsoft 70-534. Está [disponible gratis en EDX.ORG](https://www.edx.org/course/architecting-microsoft-azure-solutions-microsoft-dev205x). Usa la [plantilla de Visio de proyectos 3D](#3d-blueprint-visio-template).
...
Anteriormente, Microsoft publicó un conjunto de proyectos con arquitecturas de ejemplo. Dicho conjunto se ha reemplazado por las arquitecturas de soluciones mencionadas antes, y el vínculo de los proyectos se ha redirigido para que señale a ellas. Si necesita acceso a los materiales de proyectos anteriores por alguna razón, envíe un correo electrónico [CnESymbols@microsoft.com](mailto:CnESymbols@microsoft.com) con su solicitud.

Los diagramas de los proyectos y las arquitecturas de soluciones usan partes del [Conjunto de símbolos empresariales y de nube](#Drawing-symbol-and-icon-sets).
...
Los símbolos de CnE están en los formatos Visio, SVG y PNG. En el conjunto se incluyen instrucciones sobre cómo usar fácilmente los símbolos en PowerPoint.
