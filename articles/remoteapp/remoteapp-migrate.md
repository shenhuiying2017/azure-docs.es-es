...
<properties
    pageTitle="Migración de datos de usuario desde Azure RemoteApp | Microsoft Azure"
...
## Uso de copiar y pegar en el Explorador de archivos
...
## Copia de archivos en OneDrive para la Empresa
...
## Copia de archivos mediante la redirección de unidades
