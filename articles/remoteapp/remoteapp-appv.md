...
| | Montado | Más rápido; la aplicación ya está presente en la máquina virtual. | Inflar: ocupa el espacio de la imagen (límite de 127 GB) |
...
| | Disco (en caché) | Ejecución rápida La aplicación no depende de la disponibilidad del origen del contenido. | Inflar: ocupa el espacio de la imagen (límite de 127 GB) |
