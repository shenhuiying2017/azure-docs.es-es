...
> [AZURE.NOTE] Si quiere agregar la aplicación desde el menú **Inicio**, debe haber *agregado esa aplicación al menú **Inicio** en la imagen de plantilla.* De lo contrario, RemoteApp solo verá lo que *está* en el menú **Inicio** y usted se confundirá.
