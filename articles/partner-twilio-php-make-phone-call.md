...
1. Adquiera una cuenta de Twilio y un token de autenticación. Para comenzar a usar Twilio, puede considerar los precios en [http://www.twilio.com/pricing][twilio_pricing]. Puede registrarse en [https://www.twilio.com/try-twilio][try_twilio] para obtener una cuenta de prueba. Para obtener información acerca de la API proporcionada por Twilio, consulte [http://www.twilio.com/api][twilio_api].
...
Además de realizar la llamada, **makecall.php** muestra algunos metadatos de llamada (en la captura de pantalla siguiente se muestra un ejemplo). Para obtener más información acerca de los metadatos de llamada, consulte [https://www.twilio.com/docs/api/rest/call#instance-properties][twilio_call_properties].
...
* [Crear un sitio web PHP-MySQL de Azure e implementarlo usando Git][website-git]
* [Crear un sitio web PHP-MySQL de Azure e implementarlo usando FTP][website-ftp]
* [Crear e implementar un sitio web PHP-MySQL de Azure usando WebMatrix][website-webmatrix]
...
* En lugar de usar un formulario web, puede usar blobs de almacenamiento de Azure o una base de datos SQL para almacenar los números de teléfono y el texto de llamada. Para obtener información sobre el uso de blobs de almacenamiento de Azure en PHP, consulte [Usar el almacenamiento de Azure con aplicaciones PHP][howto_blob_storage_php]. Para obtener información sobre el uso de bases de datos SQL en PHP, consulte [Usar las bases de datos SQL con aplicaciones PHP][howto_sql_azure_php].
