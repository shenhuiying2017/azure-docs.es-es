...
-   Un clúster de HDInsight de Azure. Para obtener instrucciones, consulte [Introducción a HDInsight de Azure][] o [Aprovisionamiento de clústeres de HDInsight][].
...
-   [Importación de datos desde una base de datos SQL de Azure en el almacenamiento de blobs usando Sqoop][]
...
-   [Uso de Pig con HDInsight][]
  ...
  [Biblioteca de cliente de almacenamiento de Azure para .NET]: /en-us/develop/net/how-to-guides/blob-storage/
