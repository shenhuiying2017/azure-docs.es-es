...
Para obtener más información, consulte [la página NuGet RedisSessionStateProvider](http://www.nuget.org/packages/Microsoft.Web.RedisSessionStateProvider/ ) y [Configuración de los clientes de caché](cache-dotnet-how-to-use-azure-redis-cache.md#NuGet).
...
* Para obtener una guía del cambio del portal antiguo al nuevo, consulte: [Referencia para navegar por el portal de vista previa](http://go.microsoft.com/fwlink/?LinkId=529715)
  ...
  *Por [Rick Anderson](https://twitter.com/RickAndMSFT)*
  ...
  [instala la versión más reciente]: http://www.windowsazure.com/downloads/?sdk=net  
  [Información general del estado de sesión de ASP.NET]: http://msdn.microsoft.com/library/ms178581.aspx
