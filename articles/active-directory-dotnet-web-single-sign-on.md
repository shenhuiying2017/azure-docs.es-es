...
Este tutorial le ha mostrado cómo crear y configurar una aplicación de un solo inquilino que utiliza las capacidades de inicio de sesión único de Azure Active Directory. Lea el siguiente tutorial para saber cómo crear aplicaciones multiinquilino para Azure Active Directory: [Desarrollo de aplicaciones multiinquilino en la nube con Azure Active Directory](http://g.microsoftonline.com/0AX00en/121).
