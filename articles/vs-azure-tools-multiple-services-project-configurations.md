...
En la página **Almacenamiento en caché**, puede configurar los servicios de almacenamiento en caché de Azure que se encuentran en vista previa. Para obtener más información, consulte [Procedimiento: Configurar caché en rol de Azure](https://msdn.microsoft.com/library/azure/jj131263.aspx).
...
Establezca la propiedad **Número de instancia**s en el número de instancias que el servicio debe ejecutar para este rol

Establezca la propiedad **Tamaño de VM** en **Extra pequeño**, **Pequeño**, **Mediano**, **Grande** o **Extra grande**. Para obtener más información, consulte [Configurar los tamaños de los Servicios en la nube](https://msdn.microsoft.com/library/azure/ee814754.aspx).
...
La página de propiedades **Certificados** agrega información sobre los certificados a la configuración del servicio. Tenga en cuenta que sus certificados no se incluyen con el servicio, sino que debe cargarlos en Azure a través del [Portal de administración de la plataforma Azure](http://go.microsoft.com/fwlink/?LinkID=213885).
