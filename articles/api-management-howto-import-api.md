...
> Para obtener información sobre la creación manual de una API y la incorporación de operaciones, consulte [Creación de API][] y [Incorporación de operaciones a una API][].
