<properties title="How to use end user analytics in Azure" pageTitle="Uso de análisis de usuario final" description="End user analytics for Microsoft Azure websites." authors="awills" manager="kamrani" />
