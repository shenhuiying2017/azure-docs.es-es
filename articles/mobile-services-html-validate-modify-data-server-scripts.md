<properties urlDisplayName="Validate Data - HTML5" pageTitle="Uso de scripts de servidor para validar y modificar datos (HTML 5) | Centro de desarrollo móvil" metaKeywords="" description="Learn how to validate and modify data sent using server scripts from your HTML app." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Validate and modify data in Mobile Services by using server scripts" authors="glenga" solutions="" manager="dwrede" editor="" />
