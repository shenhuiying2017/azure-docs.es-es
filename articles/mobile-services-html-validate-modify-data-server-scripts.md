<properties 
	pageTitle="Uso de scripts de servidor para validar y modificar datos (HTML 5) | Centro de desarrollo móvil" 
	description="Obtenga información acerca de cómo validar y modificar los datos enviados mediante scripts de servidor desde su aplicación HTML." 
