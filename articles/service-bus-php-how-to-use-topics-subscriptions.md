<properties urlDisplayName="Service Bus Topics" pageTitle="Uso de los temas del bus de servicio (PHP) - Azure" metaKeywords="" description="Obtenga información acerca de cómo usar los temas del Bus de servicio con PHP en Azure." metaCanonical="" services="service-bus" documentationCenter="PHP" title="How to Use Service Bus Topics/Subscriptions" authors="sethm" solutions="" manager="timlt" editor="" />
