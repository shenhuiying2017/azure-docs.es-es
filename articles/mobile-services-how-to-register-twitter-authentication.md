<properties pageTitle="Registro para autenticación de Twitter - Servicios móviles" description="Obtenga información acerca de cómo usar la autenticación de Twitter con su aplicación de Servicios móviles de Azure." services="mobile-services" documentationCenter="" authors="ggailey777" manager="dwrede" editor=""/>
...
2. Escriba los valores de **Name** (Nombre), **Description** (Descripción) y **Website** (Sitio web) de su aplicación, luego escriba la dirección URL de su servicio móvil anexada a la ruta de acceso _/login/twitter_ en **Callback URL** (URL de devolución de llamada).

	>[AZURE.NOTE]Para un servicio móvil de back-end de .NET publicado en Azure con Visual Studio, la dirección URL de redireccionamiento es la dirección URL del servicio móvil con la ruta de acceso _signin-twitter_ anexada como un servicio .NET, por ejemplo <code>https://todolist.azure-mobile.net/signin-twitter</code>.
