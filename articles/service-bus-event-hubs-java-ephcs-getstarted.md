...
En este tutorial, obtendrá información sobre cómo introducir mensajes en un Centro de eventos mediante una aplicación de consola en Java y recuperarlos en paralelo con la biblioteca [Host del procesador de eventos] de C#.
...
2.	Ejecute el proyecto **Remitente**, presione **Entrar** en la ventana de la consola y vea los eventos que aparecen en la ventana del receptor.
