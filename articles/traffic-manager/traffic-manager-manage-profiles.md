...
Puede crear rápidamente un perfil del Administrador de tráfico con **Creación rápida** en el Portal de administración. Creación rápida permite crear perfiles con valores de configuración básicos. Sin embargo, no puede usar Creación rápida para valores como, por ejemplo, el conjunto de extremos (servicios en la nube y sitios web), el orden de conmutación por error para el método de equilibrio de carga de conmutación por error o la configuración de supervisión. Después de crear el perfil, puede configurar estas opciones en el Portal de administración. Consulte [Tareas de configuración del Administrador de tráfico](https://msdn.microsoft.com/library/azure/hh744830.aspx) para obtener una lista de procedimientos de configuración.

### Para crear un nuevo perfil del Administrador de tráfico

1. **Implemente los servicios en la nube y sitios web en el entorno de producción.** Para obtener más información sobre servicios en la nube, consulte [Servicios en la nube](http://go.microsoft.com/fwlink/p/?LinkId=314074). Para obtener información sobre servicios en la nube, consulte [Prácticas recomendadas](https://msdn.microsoft.com/library/azure/5229dd1c-5a91-4869-8522-bed8597d9cf5#bkmk_TrafficManagerBestPracticesProfile). Para obtener más información sobre sitios web, consulte [Sitios web](http://go.microsoft.com/fwlink/p/?LinkId=393327).

2. **Inicie sesión en el Portal de administración.** Para crear un nuevo perfil del Administrador de tráfico, haga clic en **Nuevo** en la esquina inferior izquierda del portal, haga clic en **Servicios de red**, en **Administrador de tráfico** y en **Creación rápida** para empezar a configurar el perfil.
3. **Configure el prefijo de DNS.** Asigne al perfil del Administrador de tráfico un nombre de prefijo de DNS único. Solo puede especificar el prefijo para un nombre de dominio del Administrador de tráfico.
4. **Seleccione la suscripción.** Seleccione la suscripción adecuada de Azure. Cada perfil está asociado a una única suscripción. Si únicamente tiene una sola suscripción, esta opción no aparece.
...
6. **Haga clic en "Crear" para crear el nuevo perfil**. Cuando haya finalizado la configuración del perfil, puede buscar el perfil en el panel Administrador de tráfico del Portal de administración.
7. **Configure los extremos, la supervisión y opciones adicionales en el Portal de administración.** Dado que con Creación rápida solo se pueden configurar opciones básicas, es necesario configurar opciones adicionales como, por ejemplo, la lista de extremos y el orden de conmutación por error, para completar la configuración que se desee. Consulte [Tareas de configuración del Administrador de tráfico](https://msdn.microsoft.com/library/azure/hh744830.aspx) para obtener una lista de procedimiento que le ayuden a completar la configuración.
...
3. En la página Registros de operaciones puede usar los filtros para ver el historial de cambios del perfil del Administrador de tráfico. Después de seleccionar las opciones de filtrado, haga clic en la marca de verificación para ver los resultados.
   - Para ver los cambios de todos los perfiles, seleccione la suscripción y un intervalo de tiempo, y elija **Administrador de tráfico** en la lista desplegable **Tipo**.
