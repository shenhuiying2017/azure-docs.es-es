...
2. En **Perfil de Traffic Manager**, en la sección **Configuración**, haga clic en **Puntos de conexión**.
...
4. Realice los pasos siguientes:
    ...
    4. En **Recurso de destino**, haga clic en **Elegir un servicio de aplicaciones** para mostrar la lista de Web Apps en la misma suscripción. En **Recursos**, elija el servicio de aplicación que quiere agregar como el primer punto de conexión.
...
6.  Cuando termine de agregar ambos puntos de conexión, aparecerán en **Perfil de Traffic Manager** junto con el estado de supervisión como **En línea**.
...
Si ya no los necesita, elimine el grupo de recursos y el perfil de Traffic Manager que creó. Para ello, seleccione el grupo de recursos en **Perfil de Traffic Manager** y haga clic en **Eliminar**.
