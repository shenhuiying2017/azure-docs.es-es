...
[][]<http://www.windowsazure.com/es-es/develop/python/tutorials/web-sites-with-django></a>.
...
En este tutorial se asume que existe una suscripción a Azure y que ya se tiene acceso al Portal de administración de Azure. Para obtener instrucciones detalladas acerca de cómo crear un sitio web, consulte [][1]<http://www.windowsazure.com/es-es/manage/services/web-sites/how-to-create-websites></a>.
