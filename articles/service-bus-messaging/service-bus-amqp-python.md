...
| byte | int | - |
| sbyte | int | - |
| char | char | Clase de Proton-Python |
| short | int | - |
| ushort | int | - |
| int | int | - |
| uint | int | - |
| long | int | - |
| ulong | long | Clase de Proton-Python |
| float | float | - |
| double | float | - |
| decimal | String | Actualmente, decimal no es compatible con Proton. |
| bool | bool | - |
| Guid | uuid | Clase de Proton-Python |
| string | string | - |
| DateTime | timestamp | Clase de Proton-Python |
| DateTimeOffset | DescribedType | DateTimeOffset.UtcTicks asignado a AMQP type:<type name=”datetime-offset” class=restricted source=”long”> <descriptor name=”com.microsoft:datetime-offset” /></type> |
| TimeSpan | DescribedType | Timespan.Ticks asignado a AMQP type:<type name=”timespan” class=restricted source=”long”> <descriptor name=”com.microsoft:timespan” /></type> |
| Uri | DescribedType | Uri.AbsoluteUri asignado a AMQP type:<type name=”uri” class=restricted source=”string”> <descriptor name=”com.microsoft:uri” /></type> |
