<properties 
	pageTitle="Uso de temas de Service Bus con PHP | Microsoft Azure" 
...
La mejor forma de recibir mensajes de una suscripción es usar un método **ServiceBusRestProxy->receiveSubscriptionMessage**. Los mensajes recibidos pueden funcionar en dos modos distintos: **ReceiveAndDelete** (predeterminado) y **PeekLock**.
...
Ahora que ya conoce los aspectos básicos de las colas de Service Bus, consulte [Colas, temas y suscripciones][], donde encontrará más información.
