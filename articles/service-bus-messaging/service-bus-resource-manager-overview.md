---
title: "Creación de recursos de Service Bus con las plantillas de Azure Resource Manager | Microsoft Docs"
...
Instale Azure PowerShell siguiendo las instrucciones de [Cómo instalar y configurar Azure PowerShell](/powershell/azureps-cmdlets-docs).
...
Para más información, vea el tema [Archivo de parámetros](../azure-resource-manager/resource-group-template-deploy.md#parameter-precedence).
...
* [Implementación de recursos con las plantillas de Azure Resource Manager][Deploy resources with Azure Resource Manager templates]
