<properties 
	pageTitle="Uso de temas de Service Bus con Node.js | Microsoft Azure" 
...
# Uso de temas y suscripciones de Service Bus
...
> [AZURE.NOTE] Las suscripciones son permanentes y seguirán existiendo hasta que se eliminen, o se elimine el tema al que están asociadas. Si una aplicación contiene lógica para crear una suscripción, en primer lugar debe comprobar si esta ya existe, para lo que se utiliza el método **getSubscription**.
