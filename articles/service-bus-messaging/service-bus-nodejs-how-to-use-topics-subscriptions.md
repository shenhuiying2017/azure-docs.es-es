...
Cree una aplicación Node.js vacía. Para obtener instrucciones sobre cómo crear una aplicación Node.js, vea [Creación e implementación de una aplicación Node.js en un sitio web de Azure], [Servicio en la nube Node.js][] (con Windows PowerShell) o Sitio web con WebMatrix.
...
Para ver un ejemplo de configuración de las variables de entorno en el [Portal de Azure clásico][] para un sitio web de Azure, consulte [Aplicación web Node.js con Storage][].
...
Los temas y las suscripciones son permanentes, por lo que deben eliminarse explícitamente a través del [Portal de Azure clásico][] o mediante programación.
