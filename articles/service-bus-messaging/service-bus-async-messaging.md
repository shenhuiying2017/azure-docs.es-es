---
title: Mensajería asincrónica del bus de servicio | Microsoft Docs
...
En estos casos, la aplicación cliente genera una excepción [System.TimeoutException][System.TimeoutException] o [MessagingException][MessagingException]. El Bus de servicio contiene una mitigación para este problema en forma de lógica de reintento de cliente automatizado. Si se agotó el período de reintento y no se entregó el mensaje, puede probar con otras funciones, como los [espacios de nombres emparejados][espacios de nombres emparejados]. Estos espacios de nombres tienen otros riesgos que se describen en este artículo.
...
### <a name="the-messagingfactory.pairnamespaceasync-api"></a>La API de MessagingFactory.PairNamespaceAsync
...
Para usar el código, cree una instancia principal de [MessagingFactory][MessagingFactory], una instancia secundaria de [MessagingFactory][MessagingFactory] y una instancia secundaria de [NamespaceManager][NamespaceManager] y una instancia de [SendAvailabilityPairedNamespaceOptions][SendAvailabilityPairedNamespaceOptions]. La llamada puede ser tan simple como la siguiente:
