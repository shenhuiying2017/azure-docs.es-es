...
Las **colas y los temas con particiones**, también conocidos como *entidades con particiones*, ofrecen una mayor disponibilidad, confiabilidad y rendimiento que las colas y los temas sin particiones convencionales. Para más información sobre las entidades con particiones, consulte [Entidades de mensajería con particiones](service-bus-partitioning.md).
