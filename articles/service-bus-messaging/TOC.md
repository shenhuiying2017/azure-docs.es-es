...
## [Generación de firmas de acceso compartido](service-bus-sas-overview.md)
...
### [Guía del desarrollador de AMQP]
...
### [Uso de AMQP con API de .NET](service-bus-dotnet-advanced-message-queuing.md)
