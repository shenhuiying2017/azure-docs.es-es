...
##### <a name="bytesmessage"></a>BytesMessage
El código siguiente muestra cómo crear un objeto [BrokeredMessage][BrokeredMessage] en .NET que recibe un cliente JMS como **BytesMessage**.
...
##### <a name="streammessage"></a>StreamMessage
El código siguiente muestra cómo crear un objeto [BrokeredMessage][BrokeredMessage] en .NET que recibe un cliente JMS como **StreamMessage**.
...
En las API de .NET de Service Bus, las propiedades de la aplicación de mensajes se realizan en la colección **Properties** de [BrokeredMessage][BrokeredMessage]. El código siguiente muestra cómo se leen las propiedades de la aplicación de un mensaje recibido desde un cliente de JMS.
