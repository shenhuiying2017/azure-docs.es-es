---
title: "Información general sobre AMQP de Service Bus con Java | Microsoft Docs"
...
Para más información sobre cómo obtener y usar estas bibliotecas con Service Bus, consulte la [Guía para desarrolladores sobre AMQP de Service Bus][Guía para desarrolladores sobre AMQP de Service Bus]. Consulte la sección [Pasos siguientes](service-bus-java-amqp-overview.md#next-steps) para obtener vínculos a más información.
...
* [Guía para desarrolladores sobre AMQP de Service Bus][Guía para desarrolladores sobre AMQP de Service Bus]
...
[Guía para desarrolladores sobre AMQP de Service Bus]: service-bus-amqp-dotnet.md
