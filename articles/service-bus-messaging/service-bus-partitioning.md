<properties 
    pageTitle="Temas y colas con particiones | Microsoft Azure"
...
Para más información sobre los aspectos internos de Service Bus, consulte el tema [Arquitectura de Service Bus][].
...
Puede crear colas y temas de Service Bus en tamaños de 1, 2, 3, 4 o 5 GB (el valor predeterminado es 1 GB). Con las particiones habilitadas, el Bus de servicio crea 16 particiones por cada GB que especifique. Por lo tanto, si crea una cola con un tamaño de 5 GB, con 16 particiones, el tamaño de cola máximo se convierte en (5 \* 16) = 80 GB. Puede ver el tamaño máximo de la cola o tema con particiones examinando su entrada en [Azure Portal][].
...
También puede crear una cola o tema con particiones en Visual Studio o en [Azure Portal][]. Al crear una nueva cola o tema en el portal, en la hoja **Configuración general** de la cola o en la ventana **Configuración** del tema, establezca la opción **Habilitar particiones** en **true**. En Visual Studio, haga clic en la casilla **Habilitar particiones** en el cuadro de diálogo **Nueva cola** o **Nuevo tema**.
...
Consulte la explicación en [Compatibilidad de AMQP 1.0 con los temas y las colas con particiones de Service Bus][] para más información sobre las entidades de mensajería con particiones. 
