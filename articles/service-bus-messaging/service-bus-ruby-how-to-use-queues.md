...
-   Comunicación entre aplicaciones locales y aplicaciones hospedadas en Azure en una [solución híbrida](service-bus-dotnet-hybrid-app-using-service-bus-relay.md).
...
> [AZURE.NOTE] También puede encontrar esta clave si [Azure Portal](https://portal.azure.com/) y consulta la información sobre conexión relacionada con el espacio de nombres de Service Bus.
