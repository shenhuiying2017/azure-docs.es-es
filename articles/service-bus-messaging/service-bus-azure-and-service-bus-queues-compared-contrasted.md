...
Microsoft Azure admite dos tipos de mecanismos de cola: **colas de Storage** y **colas de Service Bus**.
...
* Los nombres de colas de Storage pueden tener de 3 a 63 caracteres de longitud que pueden incluir letras minúsculas, números y guiones. Para obtener más información, vea [Nomenclatura de colas y metadatos](https://msdn.microsoft.com/library/azure/dd179349.aspx).
