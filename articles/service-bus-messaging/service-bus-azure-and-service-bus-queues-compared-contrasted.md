...
> [!NOTE]
> Todos los costes están sujetos a cambios. Esta tabla refleja los precios actuales y no incluye ninguna oferta promocional que pueda haber disponible actualmente. Para obtener información actualizada sobre los precios de Azure, vea la página [Precios de Azure](https://azure.microsoft.com/pricing/). Para obtener más información sobre los precios de Service Bus, vea [Precios de Bus de servicio](https://azure.microsoft.com/pricing/details/service-bus/).
> 
> 
