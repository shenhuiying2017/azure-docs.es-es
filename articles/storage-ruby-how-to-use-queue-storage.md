<properties urlDisplayName="Queue Service" pageTitle="Uso del servicio de cola (Ruby) | Microsoft Azure" metaKeywords="Azure Queue Service get messages Ruby" description="Learn how to use the Azure Queue service to create and delete queues, and insert, get, and delete messages. Samples written in Ruby." metaCanonical="" services="storage" documentationCenter="Ruby" title="How to Use the Queue Storage Service from Ruby" authors="guayan" solutions="" manager="wpickett" editor="" />
...
para obtener la información necesaria para conectarse a la cuenta de almacenamiento de Azure. Si estas variables de entorno no están configuradas, 
debe especificar la información de la cuenta antes de usar **Azure::QueueService** con el siguiente código:

	Azure.config.storage_account_name = "<su cuenta de almacenamiento de azure>"
	Azure.config.storage_account_name = "<su clave de acceso de almacenamiento de Azure>"
...
## <a id="how-to-create-a-queue"></a>Eliminación de una cola
...
## <a id="how-to-insert-a-message-into-a-queue"></a>Eliminación de un mensaje en una cola
...
## <a id="how-to-peek-at-the-next-message"></a>Eliminación de siguiente mensaje
...
## <a id="how-to-dequeue-the-next-message"></a>Eliminación de siguiente mensaje de la cola
...
## <a id="how-to-change-the-contents-of-a-queued-message"></a>Eliminación de contenido de un mensaje en cola
...
## <a id="how-to-additional-options-for-dequeuing-messages"></a>Eliminación de quitar mensajes de la cola
...
## <a id="how-to-get-the-queue-length"></a>Eliminación de la longitud de la cola
...
## <a id="how-to-delete-a-queue"></a>Eliminación de una cola
