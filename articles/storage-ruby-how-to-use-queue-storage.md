<properties urlDisplayName="Queue Service" pageTitle="Uso del servicio de cola (Ruby) | Microsoft Azure" metaKeywords="Azure Queue Service get messages Ruby" description="Aprenda a utilizar el servicio Cola de Azure para crear y eliminar colas e insertar, obtener y eliminar mensajes. Los ejemplos están escritos en Ruby." metaCanonical="" services="storage" documentationCenter="Ruby" title="How to Use the Queue Storage Service from Ruby" authors="tomfitz" solutions="" manager="wpickett" editor="" />
