...
1. En el Explorador de soluciones, haga clic con el botón derecho en la solución **device-simulations** y seleccione **Establecer proyectos de inicio**. Elija **Proyecto de inicio único** y seleccione **WebService**. A continuación, haga clic en **Aceptar**.
...
1. En el Explorador de soluciones, haga clic con el botón derecho en **WebService**, elija **Depurar** y, a continuación, **Iniciar nueva instancia**.
...
![Vista de la lista de simulaciones disponibles](./media/iot-accelerators-remote-monitoring-test/devicesmodellist.png)

Puede ver la telemetría desde el dispositivo simulado:

![Vista de la telemetría de bombilla](./media/iot-accelerators-remote-monitoring-test/devicestelemetry.png)

Puede llamar a los métodos **SwitchOn** y **SwitchOff** en el dispositivo:

![Llamada a los métodos de bombilla](./media/iot-accelerators-remote-monitoring-test/devicesmethods.png)
...
![Incorporación del refrigerador actualizado](./media/iot-accelerators-remote-monitoring-test/devicesupdatedchiller.png)
