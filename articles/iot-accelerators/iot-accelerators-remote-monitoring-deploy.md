...
En este tutorial se muestra cómo aprovisionar el acelerador de la solución de supervisión remota. Puede implementar la solución desde azureiotsuite.com. También puede implementar la solución con la CLI. Para información sobre esta opción, consulte el artículo sobre la [implementación del acelerador de una solución desde la línea de comandos](iot-accelerators-remote-monitoring-deploy-cli.md).
...
1. Haga clic en **Intentar ahora** en el icono **Supervisión remota**.
    ...
    ![Elegir una supervisión remota](./media/iot-accelerators-remote-monitoring-deploy/remotemonitoring.png)
...
Ahora que ha implementado la solución de supervisión remota, el paso siguiente es [explorar las funcionalidades del panel de soluciones](iot-accelerators-remote-monitoring-explore.md).
