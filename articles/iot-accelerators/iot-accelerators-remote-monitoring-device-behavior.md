...
La sección [Simulation](iot-accelerators-remote-monitoring-device-schema.md#simulation) del esquema de modelo de dispositivo define el estado interno de un dispositivo simulado:
...
La sección [CloudToDeviceMethods](iot-accelerators-remote-monitoring-device-schema.md#cloudtodevicemethods) del esquema de modelo de dispositivo define los métodos a los que responde un dispositivo simulado.
...
El artículo sobre la [creación de un dispositivo simulado](iot-accelerators-remote-monitoring-test.md) muestra cómo se ejecuta el servicio de simulación del dispositivo de forma local. La ejecución local del servicio facilita la depuración de los dispositivos simulados antes de implementarlos en la nube.
