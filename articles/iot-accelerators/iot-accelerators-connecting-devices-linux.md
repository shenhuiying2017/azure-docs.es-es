...
---
# <a name="connect-your-device-to-the-remote-monitoring-solution-accelerator-linux"></a>Conectar el dispositivo al acelerador de la solución de supervisión remota (Linux)
