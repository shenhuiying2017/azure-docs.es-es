...
1.  Inicie sesión en el [portal de Microsoft Azure](http://manage.windowsazure.com) en línea.
2.  Haga clic en **Nuevo**, en **Servicios de datos** y luego en **Análisis de transmisiones** y **Creación rápida**.
...
3.  Especifique la configuración que desee para el trabajo de Análisis de transmisiones.
	- En el cuadro **Nombre del trabajo**, escriba un nombre para identificar el trabajo de Análisis de transmisiones. Cuando se valida el **Nombre del trabajo**, aparece una marca de verificación verde en el cuadro Nombre de trabajo. El **Nombre del trabajo** solo puede contener caracteres alfanuméricos y el carácter "-", y debe tener entre 3 y 63 caracteres.
	- Use **Región** para especificar la ubicación geográfica en la que desea ejecutar el trabajo.
	- En **Cuenta de almacenamiento de supervisión regional**, seleccione o cree una cuenta de almacenamiento. Esta cuenta de almacenamiento se usa para almacenar datos de supervisión para todos los trabajos de Análisis de transmisiones que se ejecutan dentro de esta región.
