<properties 
	...
	description="Creación de trabajos de Análisis de transmisiones | segmento de ruta de aprendizaje."
	documentationCenter=""
...
1.  Inicie sesión en el [Portal de Microsoft Azure clásico](http://manage.windowsazure.com) en línea o en el Portal de Azure.
2.  En el Portal de Azure clásico: haga clic en **Nuevo**, en **Servicios de datos** y luego en **Análisis de transmisiones** y **Creación rápida**.

    ![Asistente para la creación rápida](./media/stream-analytics-create-a-job/1-stream-analytics-create-a-job.png)

    En el Portal de Azure: haga clic en Nuevo, en Datos y análisis y luego en Análisis de transmisiones de Azure.

    ![Crear trabajo en el Portal de Azure clásico](./media/stream-analytics-create-a-job/4-stream-analytics-create-a-job.png)
...
3.  Especifique la configuración que desee para el trabajo de Análisis de transmisiones.
	...
	- Use **Región** en el Portal de Azure clásico o **Ubicación** en el Portal de Azure para especificar la ubicación geográfica en la que desea ejecutar el trabajo.
	- Si usa el Portal de Azure clásico, seleccione o cree una cuenta de almacenamiento para usarla como **Cuenta de almacenamiento de supervisión regional**. Esta cuenta de almacenamiento se usa para almacenar datos de supervisión para todos los trabajos de Análisis de transmisiones que se ejecutan dentro de esta región.
...
4.  Cuando se configuren las nuevas opciones del trabajo de Análisis de transmisiones, haga clic en **Crear trabajo de Análisis de transmisiones**. La creación del trabajo del Análisis de transmisiones puede tardar unos minutos. Para comprobar el estado, puede supervisar el progreso en el centro de notificaciones.
    ...
    ![Portal de Azure - Crear trabajo](./media/stream-analytics-create-a-job/5-stream-analytics-create-a-job.png)
...
5.  Se mostrará el nuevo trabajo con el estado **Creado**. Tenga en cuenta que el botón **Iniciar** está deshabilitado. Debe configurar la entrada, la salida y la consulta del trabajo para poder iniciar el trabajo.
    ...
    ![Estado del trabajo en el Portal de Azure](./media/stream-analytics-create-a-job/6-stream-analytics-create-a-job.png)
