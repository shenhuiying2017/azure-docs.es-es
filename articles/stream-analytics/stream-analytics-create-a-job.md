---
title: Creación de un trabajo de procesamiento de análisis de datos para Análisis de transmisiones | Microsoft Docs
...
1. Inicie sesión en el [Portal de Microsoft Azure clásico](http://manage.windowsazure.com) en línea o en el [Portal de Azure](https://portal.azure.com/).
2. En el portal: **haga clic en Nuevo**; después, haga clic en **Servicios de datos** o **Análisis de datos** (dependerá del portal). Luego, haga clic en **Análisis de transmisiones de Microsoft Azure** o **Análisis de transmisiones** y, a continuación, en **Creación rápida**.
...
3. Especifique la configuración que desee para el trabajo de Análisis de transmisiones.
   ...
   * Use **Región** o **Ubicación** en el Portal de Azure para especificar la ubicación geográfica en la que desea ejecutar el trabajo.
