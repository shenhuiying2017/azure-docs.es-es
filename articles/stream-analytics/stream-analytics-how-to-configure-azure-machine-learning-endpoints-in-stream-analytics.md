...
---
<a id="machine-learning-integration-in-stream-analytics" class="xliff"></a>
...
<a id="overview-azure-machine-learning-terminology" class="xliff"></a>
...
<a id="machine-learning-resources-needed-for-stream-analytics-jobs" class="xliff"></a>

## Recursos de Machine Learning necesarios para trabajos de Stream Analytics
...
<a id="configure-a-stream-analytics-and-machine-learning-udf-via-rest-api" class="xliff"></a>
...
<a id="creating-a-udf-with-basic-properties" class="xliff"></a>
...
<a id="call-retrievedefaultdefinition-endpoint-for-default-udf" class="xliff"></a>
...
<a id="patch-udf-with-the-response" class="xliff"></a>
...
<a id="implement-stream-analytics-transformation-to-call-the-udf" class="xliff"></a>
