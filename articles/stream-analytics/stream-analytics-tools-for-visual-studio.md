---
title: Uso de herramientas de Azure Stream Analytics para Visual Studio
description: En este artículo se describe cómo comenzar a usar las herramientas de Azure Stream Analytics para Visual Studio.
