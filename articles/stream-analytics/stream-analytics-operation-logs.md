...
## Búsqueda de registros de operaciones en el Portal de Azure clásico
...
En el Portal de Azure clásico, haga clic en el botón **Detalles** situado en la parte inferior de la ventana para ver más detalles sobre un evento seleccionado.
...
En el Portal de Azure clásico, haga clic en el icono Buscar y escriba “error”. Esto genera todos los registros con errores.
