...
---
<a id="introduction-to-stream-analytics-window-functions" class="xliff"></a>
...
<a id="tumbling-window" class="xliff"></a>
...
<a id="hopping-window" class="xliff"></a>
...
<a id="sliding-window" class="xliff"></a>
...
<a id="getting-help-with-window-functions" class="xliff"></a>
