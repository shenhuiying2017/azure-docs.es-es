---
title: Escritura de consultas en Análisis de transmisiones | Microsoft Docs
...
> [!NOTE]
> Actualmente no se admiten pruebas de consultas en el explorador en el Portal de Azure.
> 
> 
...
3. Vaya hasta un archivo de prueba. Hay varios archivos de ejemplo disponibles en [github](datos de https://github.com/Azure/azure-stream-analytics/tree/master/Sample.md) y también puede recuperar datos de ejemplo de sus propias entradas de flujo de datos a través de la función de datos de ejemplo de la pestaña de entradas.
