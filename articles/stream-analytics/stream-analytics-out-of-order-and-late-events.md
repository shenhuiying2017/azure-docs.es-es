...
---
<a id="azure-stream-analytics-event-order-handling" class="xliff"></a>

# Control del orden de los eventos de Azure Stream Analytics
...
<a id="lateness-tolerance" class="xliff"></a>

## Tolerancia a la tardanza
...
<a id="reduce-the-number-of-out-of-order-events" class="xliff"></a>

## Reducción del número de eventos desordenados
