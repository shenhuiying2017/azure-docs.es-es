<properties
    pageTitle="Análisis de transmisiones: detección de fraudes en tiempo real | Microsoft Azure"
...
2.  Agregue lo siguiente al editor de código:
    ...
    > [AZURE.IMPORTANT] Asegúrese de que el nombre del origen de entrada coincida con el nombre de la entrada que especificó anteriormente.
