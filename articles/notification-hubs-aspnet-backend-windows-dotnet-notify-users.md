...
Antes de empezar este tutorial, debe reservar un nombre de aplicación y después crear un Centro de notificaciones de Azure y conectarlo a esa aplicación. Siga los pasos de [Introducción a los Centros de notificaciones (Tienda Windows)][Introducción a los Centros de notificaciones (Tienda Windows)], especialmente las secciones [Registro de la aplicación para la Tienda Windows][Registro de la aplicación para la Tienda Windows] y [Configuración de su Centro de notificaciones][Configuración de su Centro de notificaciones]. En concreto, asegúrese de que ha especificado los valores de **SID del paquete** y **Secreto del cliente** en el portal, en la pestaña **Configurar** correspondiente a su centro de notificaciones. Este procedimiento de configuración se describe en la sección [Configuración de su Centro de notificaciones][Configuración de su Centro de notificaciones]. Este es un paso importante: si las credenciales del portal no coinciden con las especificadas para el nombre de la aplicación que elija, la notificación de inserción no tendrá lugar.
...
5.  Siga los pasos del asistente para iniciar sesión y asociar la aplicación con la Tienda.
    ...
    > [AZURE.NOTE] Asegúrese de anotar el nombre de la aplicación que elija durante este procedimiento. Debe configurar el centro de notificaciones en el portal usando las credenciales que obtenga desde el [Centro de desarrollo de Windows][Centro de desarrollo de Windows] para este nombre de aplicación reservado específico. Este procedimiento de configuración se describe en [Configuración de su Centro de notificaciones][Configuración de su Centro de notificaciones]. Este es un paso importante: si las credenciales del portal no coinciden con las especificadas para el nombre de la aplicación que elija, la notificación de inserción no tendrá lugar.
