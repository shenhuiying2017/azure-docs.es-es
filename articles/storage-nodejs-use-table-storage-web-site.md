...
> [AZURE.NOTE] Para obtener más información, consulte [Instalación y configuración de la interfaz de línea de comandos entre plataformas de Azure](xplat-cli.md);
