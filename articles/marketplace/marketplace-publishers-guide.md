...
La elección de un escaparate empieza por identificar la audiencia de destino de su oferta. Azure Marketplace está orientado a las necesidades de los desarrolladores y profesionales de TI. AppSource está orientado a las necesidades de los usuarios empresariales. Si la solución va destinada a ambas audiencias, solo es necesario publicarla una vez para anunciarla en ambos escaparates.
...
### <a name="prerequisites-for-all-marketplace-publishing-options"></a>Requisitos previos para todas las opciones de publicación de Marketplace
...
### <a name="certify-your-azure-ad-integration-for-the-marketplace-single-tenant-applications"></a>Certificar la integración de Azure AD en Marketplace: aplicaciones de un único inquilino
...
#### <a name="sign-in-to-the-cloud-partner-portal"></a>Inicie sesión en Cloud Partner Portal.
...
Para más información sobre seguridad y directrices adicionales para la cuenta de desarrollador, consulte [Abrir una cuenta de desarrollador](https://docs.microsoft.com/en-us/windows/uwp/publish/opening-a-developer-account).
