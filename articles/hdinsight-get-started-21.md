...
> [WACOM.NOTE] En este tutorial se trata el uso de los clústeres de Hadoop 1,2 en HDInsight. Para otras versiones admitidas, haga clic en el selector en la parte superior de la página. Para obtener información de la versión, consulte [Novedades en las versiones de clústeres proporcionadas por HDInsight][]
