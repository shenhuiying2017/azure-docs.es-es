<properties urlDisplayName="Service Bus AMQP Overview" pageTitle="Información general sobre AMQP para el Bus de servicio (Java) - Azure " metaKeywords="" description="Learn about using the Advanced Message Queuing Protocol (AMQP) 1.0 in Azure." metaCanonical="http://www.windowsazure.com/es-es/develop/net/how-to-guides/service-bus-amqp-overview/" services="service-bus" documentationCenter="Java" title="" authors="sethm" solutions="" manager="timlt" editor="" />
