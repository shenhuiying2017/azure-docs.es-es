<properties title="How to create a PHP website in Azure Websites" pageTitle="Creación de un sitio web PHP en Sitios web Azure" metaKeywords="PHP Azure Web Sites" description="Aprenda a crear un sitio web PHP en sitios web de Azure" documentationCenter="PHP" services="Web Sites" editor="mollybos" manager="wpickett" authors="tomfitz" />
...
> [WACOM.NOTE]
> Si desea empezar a trabajar con sitios web de Azure antes de contratar una cuenta, vaya a <a href="https://trywebsites.azurewebsites.net/?language=php">https://trywebsites.azurewebsites.net,</a>donde puede crear inmediatamente un sitio de inicio ASP.NET en sitios web de Azure de forma gratuita. No se requiere ninguna tarjeta de crédito, sin compromisos.
...
1. Descargue e importe su archivo de configuración de publicación siguiendo las siguientes instrucciones: [Descarga e importación de configuración de publicación](/ es-es/develop/php/how-to-guides/command-line-tools/#Account).
...
1. Descargue e importe su archivo de configuración de publicación siguiendo las siguientes instrucciones: [Cómo: Importar configuración de publicación](/es-es/develop/php/how-to-guides/powershell-cmdlets/#ImportPubSettings).
...
Para obtener información sobre opciones adicionales, consulte [Creación y administración de Crear y administrar un sitio web de Azure](/es-es/develop/php/how-to-guides/powershell-cmdlets/#WebSite).
