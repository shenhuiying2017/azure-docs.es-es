...
Compile y ejecute su servicio en la nube localmente con la configuración de solución establecida en **Liberar**. Esto asegura que todos los archivos y carpetas se crean para ejecutar la aplicación localmente y asegura que se inicien todos los emuladores.
...
Paso 3: Vista de informes de rendimiento
----------------------------------------
