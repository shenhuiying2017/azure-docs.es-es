---
title: Procedimiento para migrar y publicar una aplicación web en un servicio en la nube de Azure desde Visual Studio | Microsoft Docs
...
> [!NOTE]
> En este tema se explica la implementación en servicios en la nube pero no en sitios web. Para obtener más información sobre la implementación en sitios web, vea [Implementación de una aplicación web en el Servicio de aplicaciones de Azure](app-service-web/web-sites-deploy.md).
> 
> 
