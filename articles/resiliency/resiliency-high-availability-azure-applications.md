...
> [!NOTE]
> En el diagrama anterior, SQL Server está instalado y ejecutándose en las máquinas virtuales. Esto difiere de la explicación anterior sobre Base de datos SQL de Azure, que proporciona una base de datos como servicio administrado.
> 
> 
...
2. Intentar la operación que podría producir un error transitorio.
3. Si se produce un error transitorio, invocar la directiva de reintento.
4. Si se produce un error en todos los reintentos, detectar una excepción final.
