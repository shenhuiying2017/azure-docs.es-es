...
2.  La aplicación cliente almacena este identificador en el backend de la aplicación para usarlo más adelante. En el caso de WNS, el back-end normalmente es un servicio en la nube. En el caso de Apple, el sistema se llama proveedor.
