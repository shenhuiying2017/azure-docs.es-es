<properties 
	pageTitle="Qué es el SDK de Trabajos web de Azure" 
	description="Una introducción al SDK de Trabajos web de Azure. Se explica qué es el SDK, se describen escenarios habituales en los que resulta útil y se proporcionan códigos de ejemplo." 
