...
Al crear una máquina virtual en el Portal de administración de Azure, se crean automáticamente extremos de escritorio remoto, acceso remoto a Windows PowerShell y shell seguro (SSH). Puede configurar extremos adicionales al crear la máquina virtual o posteriormente, según sea necesario. 
...
8.	Para puertos personalizados, en **Puerto público**, escriba el número de puerto para el tráfico entrante desde Internet. En **Puerto privado**, escriba el número de puerto en el que escucha la máquina virtual. Estos números de puerto pueden ser distintos. Asegúrese de que se ha configurado el firewall en la máquina virtual para permitir el tráfico correspondiente al protocolo (en el paso 7) y el puerto privado.
...
5.	En la barra de tareas, haga clic en **Administrar ACL**. Aparecerá el cuadro de diálogo **Especifique los detalles de ACL**.
...
[Equilibrio de carga de máquinas virtuales](http://www.windowsazure.com/manage/windows/common-tasks/how-to-load-balance-virtual-machines/)

[Información sobre las listas de control de acceso de red](http://go.microsoft.com/fwlink/p/?linkid=303816&clcid=0x409)
