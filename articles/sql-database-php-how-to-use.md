...
* Descarga e instalación de SQL Server Express: [http://www.microsoft.com/download/details.aspx?id=29062][install-sql-express]
...
##<a id="CreateServer"></a>Codificación una Base de datos SQL
...
##<a id="ConnectionInfo"></a>Codificación información de conexión de la Base de datos SQL
