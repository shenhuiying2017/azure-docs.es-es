...
El panel de WebJobs en el Portal de administración de Azure proporciona capacidades de administración eficaces que ofrecen un control completo sobre la ejecución de WebJobs, incluida la capacidad para invocar funciones individuales dentro de WebJobs. El panel también muestra los tiempos de ejecución de las funciones y el resultado del registro. 

## Tabla de contenido

* [Introducción a WebJobs](#getstarted)
* [Implementación de WebJobs](#deploy)
* [Prueba y depuración de WebJobs](#debug)
* [Recursos adicionales de WebJobs](#additional)
* [Recursos adicionales de SDK de WebJobs](#additionalsdk)
* [Aplicaciones de WebJobs de ejemplo](#samples)
* [Blogs](#blogs) 
* [Ayuda de WebJobs](#gethelp)

##<a name="getstarted"></a>Introducción a WebJobs
...
* [Escalado de su aplicación web con Sitios web Azure](http://msdn.microsoft.com/magazine/dn786914.aspx)
* Vídeos
