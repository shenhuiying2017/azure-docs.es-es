...
En la tabla siguiente se enumeran los datos de consumo de energía para los distintos modelos del dispositivo StorSimple.
 
| Condiciones | 240 V CA | 110 V CA |
| ---------- | -------- | -------- |
| Ventiladores lentos, unidades inactivas | 1,45 A 0,31 kW | 3,19 A 0,34 kW |
| Ventiladores lentos, unidades accediendo | 1,54 A 0,33 kW | 3,27 A 0,36 kW |
| Ventiladores rápidos,unidades inactivas, dos fuentes de alimentación activas | 2,14 A 0,49 kW | 4,99 A 0,54 kW |
| Ventiladores rápidos, unidades inactivas, una fuente de alimentación activa y una inactiva | 2,05 A 0,48 kW | 4,58 A 0,5 kW |
| Ventiladores rápidos, unidades accediendo, dos fuentes de alimentación activas | 2,26 A 0,51 kW | 4,95 A 0,54 kW |
| Ventiladores rápidos, unidades accediendo, una fuente de alimentación activa y una inactiva | 2,14 A 0,49 kW | 4,81 A 0,53 kW |
...
En el caso de las interfaces de red 10 GbE, DATA 2 y DATA 3, encontrará la lista de módulos y cables de red admitidos en este vínculo: [http://www.mellanox.com/page/cables?mtag=cable\_overview](http://www.mellanox.com/page/cables?mtag=cable_overview)
