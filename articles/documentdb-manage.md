...
La siguiente tabla proporciona una lista de varias operaciones de base de datos y las unidades de solicitud disponibles por CU. La tabla le ayuda a planificar cómo una operación de base de datos dada consume la capacidad de proceso aprovisionada asociada con una CU. Asumimos que el tamaño del documento es de 1 KB que consta de 10 valores de propiedad únicos con el nivel de coherencia predeterminado establecido en "Sesión" y la Base de datos de documentos indexa automáticamente todos los documentos.
