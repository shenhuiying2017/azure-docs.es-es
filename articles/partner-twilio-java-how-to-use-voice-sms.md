<properties urlDisplayName="Twilio Voice/SMS Service" pageTitle="Uso de Twilio para voz y SMS (Java) - Azure" metaKeywords="Twilio, Twilio API, phone calls, SMS message, TwiML responses, Azure Twilio Java" description="Aprenda a realizar una llamada telefónica y a enviar un mensaje SMS con la API de Twilio API en Azure. Los ejemplos de código están escritos en Java." metaCanonical="" services="" videoId="" scriptId="" documentationCenter="Java" title="How to Use Twilio for Voice and SMS Capabilities in Java" authors="MicrosoftHelp@twilio.com; robmcm" solutions="" manager="twilio" editor="mollybos" />
...
* [Cómo servicios Twilio adicionales](#AdditionalServices)
...
Si desea obtener más información acerca de los parámetros que se transmitieron al método **SmsFactory.create**, consulte [http://www.twilio.com/docs/api/rest/sending-sms][twilio_rest_sending_sms].
