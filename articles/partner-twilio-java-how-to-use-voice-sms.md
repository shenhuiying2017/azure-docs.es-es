<properties urlDisplayName="Twilio Voice/SMS Service" pageTitle="Uso de Twilio para voz y SMS (Java) - Azure" metaKeywords="Twilio, API de Twilio, llamadas de teléfono, mensaje SMS, respuestas de TwiML, Azure Twilio Java" description="Aprenda a realizar una llamada telefónica y a enviar un mensaje SMS con el servicio de la API de Twilio en Azure. Ejemplos de código escritos en Java." metaCanonical="" services="" videoId="" scriptId="" documentationCenter="Java" title="How to Use Twilio for Voice and SMS Capabilities in Java" authors="MicrosoftHelp@twilio.com; robmcm" solutions="" manager="twilio" editor="mollybos" />
