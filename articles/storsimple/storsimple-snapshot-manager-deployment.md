---
title: Implementación de Administrador de instantáneas StorSimple | Microsoft Docs
...
> [!IMPORTANT]
> Antes de comenzar, revise la [lista de comprobación de la configuración de implementación](storsimple-deployment-walkthrough.md#deployment-configuration-checklist)
...
6. Cuando aparece el mensaje **La instalación se realizó correctamente**, haga clic en **Cerrar**. Debería ver el icono de Administrador de instantáneas StorSimple en su escritorio.
