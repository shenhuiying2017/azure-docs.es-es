<properties 
   pageTitle="Configurar el proxy web para el dispositivo"
   description="Aprenda a configurar el proxy web para el dispositivo StorSimple con Windows PowerShell para StorSimple"
   services="storsimple"
   documentationCenter=""
   authors="alkohli"
   manager="carolz"
...
# Configurar el proxy web para el dispositivo
...
1. A continuación, habilite los valores de proxy web configurados a través de los cmdlets de Windows PowerShell para StorSimple.
...
- Ver la configuración de proxy web en el Portal de administración
...
## Configurar el proxy web mediante el asistente de instalación
...
#### Para configurar el proxy web mediante el asistente de configuración
...
1. Si utiliza la autenticación, proporcione un **nombre de usuario de Proxy Web** y una **contraseña de Proxy Web**. También deberá confirmar la contraseña.
...
Asimismo, se habilitará el proxy web. Puede omitir el paso [Habilitar proxy web](#Enable-web-proxy) y ver los valores del proxy web directamente en el Portal de administración.
...
> [AZURE.NOTE]**Este paso no será necesario si utiliza el asistente de configuración para configurar el proxy web. El proxy web se habilita automáticamente de manera predeterminada después de una sesión del asistente de configuración.**
...
## Ver la configuración de proxy web en el Portal de administración
La valores de proxy web se configuran mediante la interfaz de Windows PowerShell y no pueden modificarse desde el Portal de administración. Sin embargo, puede ver los valores configurados en el Portal de administración. Lleve a cabo los siguientes pasos para ver el proxy web:

#### Para ver la configuración de proxy web:
1. Vaya a **Servicio de administrador de StorSimple > Dispositivos**. Seleccione y haga clic en un dispositivo, y luego vaya a **Configurar**.
...
> - Los errores relacionados con la configuración de proxy web no se muestran en el Portal de administración del servicio de Administrador de StorSimple. Si hay un problema con el proxy web una vez completada la configuración, el estado del dispositivo cambiará a**Sin conexión** en el Portal de administración.
