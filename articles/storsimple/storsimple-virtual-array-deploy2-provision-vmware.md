---
title: "Implementación de Microsoft Azure StorSimple Virtual Array: aprovisionamiento en VMware | Microsoft Docs"
...
* Ha revisado los requisitos de red para implementar un dispositivo virtual StorSimple y ha configurado la red del centro de datos según los requisitos. Para más información, consulte [Requisitos del sistema de la matriz virtual de StorSimple](storsimple-virtual-array-system-requirements.md).
