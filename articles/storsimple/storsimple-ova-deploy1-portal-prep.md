...
Si necesita crear una cuenta de almacenamiento de Azure en una región distinta, consulte [Crear una cuenta de almacenamiento](../storage/storage-create-storage-account.md#create-a-storage-account) para instrucciones detalladas.
