# [Documentación de StorSimple](index.md)
...
##### [Nueva autenticación](storsimple-virtual-array-aad-registration-key.md)
...
## Notas de la versión
### [Update 1: actual](storsimple-virtual-array-update-1-release-notes.md)
...
#### [Nueva autenticación de servicio](storsimple-8000-aad-registration-key.md)
...
##### [Clonación de un volumen](storsimple-8000-clone-volume-u2.md)
##### [Conexión a su dispositivo de forma remota](storsimple-8000-remote-connect.md)
...
###### [Conmutación por error a dispositivo físico](storsimple-8000-device-failover-physical-device.md)
###### [Conmutación por error al dispositivo de nube](storsimple-8000-device-failover-cloud-appliance.md)
...
### Migrar
#### [Suscripciones y cuentas de almacenamiento](storsimple-8000-migrate-classic-azure-portal.md)
#### [Desde dispositivos de la serie 5000 o 7000](storsimple-8000-migrate-from-5000-7000.md)
...
## [Opciones de soporte técnico de StorSimple](storsimple-8000-support-options.md)
