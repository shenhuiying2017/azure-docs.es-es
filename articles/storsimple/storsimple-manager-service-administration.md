...
## <a name="connect-to-storsimple-manager-service"></a>Conectarse al servicio de Administrador de StorSimple
...
* **Administrador de StorSimple** lleva a las páginas de nivel de servicio de la IU aplicables a todos los dispositivos dentro de un servicio.
* **Dispositivos** lleva a las páginas de la IU de nivel de dispositivo aplicables a un dispositivo específico.
* **Contenedores de volúmenes** lleva a la página de volúmenes que muestra todos los volúmenes asociados con un dispositivo.
