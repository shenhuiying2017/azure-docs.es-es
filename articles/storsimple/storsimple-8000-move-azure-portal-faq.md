...
No. Una vez que migra el servicio StorSimple Manager a Azure Portal, no puede crear un servicio nuevo en el portal clásico. Además, tampoco puede administrar el dispositivo mediante el portal clásico. Para más información, vaya a [Mover un servicio a Azure Portal](storsimple-8000-manage-service.md#move-a-service-to-azure-portal).
...
No. No puede elegir las instancias de StorSimple Manager que desea migrar a Azure Portal. Se migran todas las instancias de StorSimple Manager de su suscripción.
...
No. El nombre del servicio no se puede cambiar una vez que el servicio se crea en Azure Portal. El mismo comportamiento ocurre con otras entidades, como dispositivos, volúmenes, contenedores de volúmenes y directivas de copia de seguridad.
...
No. La migración no debería generar errores ni alertas. Siga las recomendaciones de la alerta para resolverla.
...
No. Los dispositivos de la serie StorSimple 5000/7000 no son compatibles con Azure Portal.
...
No. No se admite la migración del servicio Administrador de dispositivos de StorSimple de una suscripción a otra. Puede llevar a cabo un proceso manual que consta de los pasos siguientes:
...
No. Las cuentas de almacenamiento clásico se pueden administrar completamente desde Azure Portal. Cuando migra el dispositivo StorSimple a Azure Portal, la cuenta de almacenamiento sigue funcionando como antes.
...
No. No puede migrar una instancia de Administrador de dispositivos de StorSimple creada con un grupo de recursos a otro grupo de recursos.
...
No. Con la migración del servicio al nuevo Azure Portal, no debería haber ningún impacto en los cmdlets de Windows PowerShell para StorSimple asociados con el dispositivo de StorSimple local (que tampoco se ve afectado con la migración). Puede seguir usando estos cmdlets para crear un paquete de soporte sin ningún problema, incluso en Azure Portal. Esta migración solo afecta los cmdlets de PowerShell del modelo de implementación clásica de Azure.

## <a name="moving-storsimple-data-manager-service"></a>Migración del servicio StorSimple Data Manager

### <a name="i-am-using-storsimple-data-manager-service-how-should-i-proceed-with-this-move"></a>Uso el servicio StorSimple Data Manager. ¿Cómo debo seguir con esta migración?

Si usa el servicio StorSimple Data Manager, debe migrar primero las instancias de Administrador de dispositivos de StorSimple a Azure. Una vez que se complete la migración, cree nuevas instancias de StorSimple Data Manager en Azure Portal. Las instancias de StorSimple Data Manager que se crearon antes de la migración no funcionan.

Para más información sobre la migración del servicio Administrador de dispositivos de StorSimple, vaya a [Mover un servicio a Azure Portal](storsimple-8000-manage-service.md#move-a-service-to-azure-portal). Para más información sobre la creación de StorSimple Data Manager, vaya al artículo sobre la [creación de un servicio de StorSimple Data Manager](storsimple-data-manager-ui.md).
...
No. La migración de un servicio a Azure Portal no afecta a StorSimple Snapshot Manager. El dispositivo y StorSimple Snapshot Manager seguirán funcionando como antes.
...
No. No se puede cambiar el nombre de los dispositivos, volúmenes, contenedores de volúmenes ni directivas de copia de seguridad en Azure Portal.

## <a name="next-steps"></a>Pasos siguientes

Obtenga información paso a paso sobre la [migración del servicio Administrador de dispositivos de StorSimple a Azure Portal](storsimple-8000-manage-service.md#move-a-service-to-azure-portal).
