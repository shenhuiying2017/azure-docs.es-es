...
---
# <a name="deploy-the-storsimple-manager-service-for-storsimple-virtual-array"></a>Implementación del servicio StorSimple Manager en una matriz virtual de StorSimple
