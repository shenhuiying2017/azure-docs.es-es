---
title: "Desactivación y eliminación de una matriz virtual de StorSimple | Microsoft Docs"
...
---
# <a name="deactivate-and-delete-a-storsimple-virtual-array-via-storsimple-manager"></a>Desactivación y eliminación de una matriz virtual de StorSimple mediante StorSimple Manager
...
2. Haga clic en **Desactivar**en la parte inferior de la página.
   
    ![Clic en Desactivar](./media/storsimple-ova-deactivate-and-delete-device/deactivate2m.png)
3. Aparecerá un mensaje de confirmación. Haga clic en **Sí** para continuar. 
...
4. Tras la desactivación, se actualizará la lista de dispositivos. 
...
4. Es posible que el servicio tarde unos minutos en eliminarse. 
