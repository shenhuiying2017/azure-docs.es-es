...
| Tamaño máximo de un volumen anclado localmente en dispositivos físicos | 8 TB para 8100 <br></br> 20 TB para 8600 | 8100 y 8600 son dispositivos físicos. |
...
|Velocidad de procesamiento de instantáneas en la nube| 15 minutos/TB. | <ul><li>Tiempo mínimo para que la instantánea en la nube esté lista para cargarla, por TB de datos del volumen asociado en la copia de seguridad. </li><li> El tiempo total de la instantánea en la nube se calcula mediante la suma de este tiempo al tiempo de carga de la instantánea, que se ve afectado por el ancho de banda de Internet en la nube.
