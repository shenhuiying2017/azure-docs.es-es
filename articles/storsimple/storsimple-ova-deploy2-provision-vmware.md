...
# Implementar una matriz virtual de StorSimple: Aprovisionar una matriz virtual en VMware (versión preliminar)

![](./media/storsimple-ova-deploy2-provision-vmware/vmware4.png)

## Información general 
Este tutorial de aprovisionamiento se aplica a las matices virtuales de StorSimple (también conocido como dispositivo virtual StorSimple local o dispositivo virtual StorSimple) 1.1.1.0 (versión preliminar pública) únicamente. En este tutorial se describe cómo aprovisionar y conectarse una matriz virtual de StorSimple en un sistema host que ejecuta VMware ESXi 5.5 y versiones posteriores.
...
-   Ha completado todos los pasos de la sección [Preparar el portal para la matriz virtual de StorSimple](storsimple-ova-deploy1-portal-prep.md).

-   Ha descargado la imagen del dispositivo virtual para VMware desde el Portal de Azure. Para obtener más información, consulte [Paso 3: Descargar la imagen del dispositivo virtual](storsimple-ova-deploy1-portal-prep.md#step-3-download-the-virtual-device-image).
...
1.  En primer lugar, cargue el VMDK al servidor ESXi. Desplácese hasta la pestaña **Configuración** en el panel derecho. Bajo **Hardware**, seleccione **Almacenamiento**.

	![](./media/storsimple-ova-deploy2-provision-vmware/image3.png)

1.  En el panel derecho, bajo **Almacenes de datos**, seleccione el almacén de datos donde desea cargar el VMDK. El almacén de datos debe tener espacio suficiente para los discos de datos y el sistema operativo.

	![](./media/storsimple-ova-deploy2-provision-vmware/image4.png)

1.  Haga clic con el botón secundario y seleccione **Explorar almacén de datos**.

	![](./media/storsimple-ova-deploy2-provision-vmware/image5.png)

1.  Aparecerá una ventana **Explorador del almacén de datos**.
...
1.  La nueva carpeta aparecerá en el panel izquierdo del **Explorador del almacén de datos**.
...
1.  En la página **Versión de la máquina virtual**, seleccione **Versión de la máquina virtual: 8**. Tenga en cuenta que esta es la única opción admitida para esta versión.
...
1.  En la página **Seleccionar disco existente**, en **Ruta de acceso de archivo de disco**, haga clic en **Examinar**. Se abrirá un cuadro de diálogo **Examinar almacenes de datos**. Desplácese hasta la ubicación en la que cargó el VMDK. Seleccione el archivo y haga clic en **Aceptar**. Haga clic en **Siguiente**.
