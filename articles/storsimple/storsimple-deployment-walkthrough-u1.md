...
> - Para obtener instrucciones de instalación y configuración de MPIO e iSCSI en el host Linux, vaya a [Configurar MPIO para su host Linux StorSimple](storsimple-configure-mpio-linux.md)
