<properties urlDisplayName="Use SSH" pageTitle="Uso de SSH para conectarse a máquinas virtuales de Linux en Azure" metaKeywords="Azure SSH keys Linux, Linux vm SSH" description="Aprenda a generar y utilizar claves SSH con una máquina virtual de Linux en Azure." metaCanonical="" services="virtual-machines" documentationCenter="" title="How to Use SSH with Linux on Azure" authors="szarkos" solutions="" manager="timlt" editor="" />
...
3.	Opcionalmente, puede copiar "myPrivateKey.key" a "~/.ssh/id_rsa" para que su cliente OpenSSH pueda recuperarla automáticamente sin usar la opción "-i".
