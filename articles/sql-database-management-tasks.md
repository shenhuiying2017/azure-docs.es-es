...
## <span id="addlogins"></span></a>Direccionamiento del inicios de sesión y usuarios a Base de datos SQL en Azure
...
<div style="width:auto; height:auto; overflow:auto"><pre>
    -- ejec&uacute;telo en master, ejecute cada l&iacute;nea por separado
    -- utilice este inicio de sesi&oacute;n para administrar otros inicios de sesi&oacute;n en este servidor
    ...
    -- utilice este inicio de sesi&oacute;n para crear o copiar una base de datos
...
<div style="width:auto; height:auto; overflow:auto"><pre>
    -- ejec&uacute;telo en una base de datos normal, ejecute cada l&iacute;nea por separado
    -- utilice este inicio de sesi&oacute;n para leer operaciones
    ...
    -- utilice este inicio de sesi&oacute;n para escribir operaciones
