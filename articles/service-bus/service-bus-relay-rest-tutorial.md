<properties
   pageTitle="Tutorial de REST de Bus de servicio | Microsoft Azure"
...
En este tutorial se describe cómo compilar una sencilla aplicación host de Bus de servicio que expone una interfaz basada en REST. REST permite a un cliente web, como un explorador web, tener acceso a la API del Bus de servicio a través de solicitudes HTTP.
...
6. Después del elemento `<services>`, cree un elemento `<behaviors>` con el contenido siguiente, reemplazando "SAS\_KEY" por la clave de *firma de acceso compartido* (SAS) que ha obtenido en el portal de Azure en el paso 1.
