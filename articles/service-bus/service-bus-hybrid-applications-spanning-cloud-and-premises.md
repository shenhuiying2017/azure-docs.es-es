...
- [Mensajería retransmitida y asíncrona](http://msdn.microsoft.com/library/azure/hh367519.aspx)

## Compilación

- [Crear una aplicación híbrida en la nube/local .NET mediante Retransmisión de bus de servicio](cloud-services-dotnet-hybrid-app-using-service-bus-relay.md)
...
- [Cómo integrar un sitio web de Azure con una aplicación LOB mediante la retransmisión de bus de servicio](http://code.msdn.microsoft.com/windowsazure/How-to-integrate-a-Windows-f1fedff8) 
...
- [P+F de precios de Bus de servicio](http://msdn.microsoft.com/library/azure/Hh667438.aspx)
