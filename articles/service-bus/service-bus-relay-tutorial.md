...
1. Repita los pasos anteriores para agregar una referencia al espacio de nombres [Microsoft.ServiceBus](https://msdn.microsoft.com/library/microsoft.servicebus.aspx) y Microsoft.ServiceBus.dll del proyecto.
