<properties
    pageTitle="Creación de un espacio de nombres de Bus de servicio con un grupo de consumidores y Centro de eventos | Microsoft Azure"
    description="Creación de un espacio de nombres de Bus de servicio con un grupo de consumidores y Centro de eventos con una plantilla de ARM"
...
# Creación de un espacio de nombres de Bus de servicio con un grupo de consumidores y Centro de eventos con una plantilla de ARM

Este artículo muestra cómo utilizar una plantilla de Azure Resource Manager (ARM) que crea un espacio de nombres de Bus de servicio con un grupo de consumidores y Centro de eventos. Aprenderá a definir los recursos que se implementan y los parámetros que se especifican cuando se ejecuta la implementación. Puede usar esta plantilla para sus propias implementaciones o personalizarla para satisfacer sus necesidades.

Para obtener más información sobre la creación de plantillas, consulte [Creación de plantillas de Azure Resource Manager][].

Para ver la plantilla completa, consulte la [Plantilla de grupo de consumidores y Centro de eventos de Bus de servicio][] en GitHub.
...
>-    [Creación de un espacio de nombres de bus de servicio](service-bus-arm-namespace.md)
>
...
Centros de eventos es un servicio de procesamiento de eventos que se usa para ofrecer la entrada de telemetría y eventos en Azure a escala masiva, con una latencia baja y una alta confiabilidad.

Obtenga más información acerca de los [Centros de eventos de Azure](../event-hubs/event-hubs-what-is-event-hubs.md).

Para ejecutar automáticamente la implementación, haga clic en el botón siguiente:

[![Implementación en Azure](./media/service-bus-arm-namespace-event-hub/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F201-servicebus-create-eventhub-and-consumergroup%2Fazuredeploy.json)
...
- [Administración de recursos de Centros de eventos con el Explorador de Bus de servicio](https://code.msdn.microsoft.com/Service-Bus-Explorer-f2abca5a)
  ...
  [Plantilla de grupo de consumidores y Centro de eventos de Bus de servicio]: https://github.com/Azure/azure-quickstart-templates/blob/master/201-servicebus-create-eventhub-and-consumerGroup/
