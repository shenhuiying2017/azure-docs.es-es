---
title: Bus de servicio de Azure | Microsoft Docs
...
Como ocurre con las colas, los suscriptores a un tema pueden leer los mensajes con **ReceiveAndDelete** o **PeekLock**. Sin embargo, a diferencia de las colas, varias suscripciones pueden recibir un mensaje individual enviado a un tema. Este enfoque, que se denomina normalmente *publicar y suscribir* (o *pub/sus*), es útil cuando hay varias aplicaciones interesadas en los mismos mensajes. Si se define el filtro adecuado, cada suscriptor puede pulsar solo la parte de la secuencia de mensaje que necesita ver.
