...
**create\_queue** también admite opciones adicionales, que le permiten reemplazar la configuración predeterminada de las colas, como el período de vida (TTL) de los mensajes o el tamaño máximo de las colas. En el siguiente ejemplo se establece el tamaño máximo de las colas en 5 GB y el valor de TTL en 1 minuto:
