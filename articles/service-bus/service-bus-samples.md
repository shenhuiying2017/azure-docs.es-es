---
title: Información general sobre los ejemplos del Bus de servicio | Microsoft Docs
...
3. En la lista, haga clic en el nombre del espacio de nombres del servicio.
4. Haga clic en **Información de conexión**. En el cuadro de diálogo **acceso a la información de conexión**, copie la cadena de conexión en el Portapapeles.
