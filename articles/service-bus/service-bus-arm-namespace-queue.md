<properties
    pageTitle="Creación de un espacio de nombres de Bus de servicio con cola | Microsoft Azure"
    description="Creación de una cola y un espacio de nombres de Bus de servicio con una plantilla de ARM"
...
# Creación de una cola y un espacio de nombres de Bus de servicio con una plantilla de ARM

Este artículo muestra cómo utilizar una plantilla de Azure Resource Manager (ARM) que crea una cola y un espacio de nombres de Bus de servicio. Aprenderá a definir los recursos que se implementan y los parámetros que se especifican cuando se ejecuta la implementación. Puede usar esta plantilla para sus propias implementaciones o personalizarla para satisfacer sus necesidades.
...
[![Implementación en Azure](./media/service-bus-arm-namespace-queue/deploybutton.png)](https://portal.azure.com/#create/Microsoft.Template/uri/https%3A%2F%2Fraw.githubusercontent.com%2FAzure%2Fazure-quickstart-templates%2Fmaster%2F201-servicebus-create-queue%2Fazuredeploy.json)
