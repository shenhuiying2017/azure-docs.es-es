<properties
	pageTitle="Administración de RemoteApp de Azure mediante Automatización de Azure"
...
Reduzca la sobrecarga operativa y libere al personal de TI y DevOps para que se concentre en el trabajo que proporciona valor al negocio trasladando las tareas de administración en la nube para que se ejecuten automáticamente mediante Automatización de Azure.
