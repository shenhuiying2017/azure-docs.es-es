...
- Híbrido: incluye una red virtual para acceso local y se crea mediante la opción **Crear con VPN** del Portal de administración.
...
1. En el [Portal de administración de Windows Azure](http://manage.windowsazure.com), vaya a la página RemoteApp.
...
Después de crear la colección RemoteApp, vaya a la página **Inicio rápido** de RemoteApp para continuar con los pasos de configuración.
...
## **Paso 4: Configurar el acceso del usuario** ##
