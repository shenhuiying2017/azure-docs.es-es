<properties 
	...
	description="Obtenga información acerca de cómo usar Servicios móviles en tiempo de ejecución de .Net de Azure y centros de notificaciones para enviar notificaciones de inserción a su aplicación JavaScript de la Tienda Windows." 
