...
-   **Desarrolladores** - Los desarrolladores son los clientes que crean aplicaciones usando sus API. A los desarrolladores se les concede acceso al [portal para desarrolladores][Portal para desarrolladores] y crean aplicaciones que llaman a las operaciones de una API.
...
Puede personalizar el aspecto y apariencia del portal para desarrolladores agregando contenido personalizado, personalizando estilos e incorporando su toque diferenciador.
  ...
  [Agregación de operaciones a una API]: ../api-management-howto-add-operations
  ...
  [Creación de desarrolladores e invitación a los mismos]: ../api-management-howto-create-or-invite-developers
  [Asociación de grupos a desarrolladores]: ../api-management-howto-create-groups/#associate-group-developer
  [Referencia de directivas]: ../api-management-policy-reference
  [Directivas de Administración de API]: ../api-management-howto-policies
  [Creación y definición de configuraciones de productos avanzadas]: ../api-management-howto-product-with-rules
