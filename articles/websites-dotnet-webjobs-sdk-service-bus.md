...
**Nota:** si va a crear la cola de mensajes en una aplicación que no use el SDK de WebJobs, asegúrese de establecer [BrokeredMessage.ContentType](http://msdn.microsoft.com/es-es/library/microsoft.servicebus.messaging.brokeredmessage.contenttype.aspx) a "text/plain".
