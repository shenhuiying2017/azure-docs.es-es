<properties
	pageTitle="Configuración de webhooks en alertas de registro de actividad de Azure | Microsoft Azure"
...
>[AZURE.NOTE] Esta característica está actualmente en versión preliminar, por lo que el rendimiento y la calidad son variables.

Puede configurar una alerta de registro de actividad mediante los [cmdlets de Azure PowerShell](./insights-powershell-samples.md#create-alert-rules), la [CLI multiplataforma](./insights-cli-samples.md#work-with-alerts) o la [API de REST Insights](https://msdn.microsoft.com/library/azure/dn933805.aspx).
...
## Pasos siguientes
- [Aprenda más sobre el registro de actividad](./monitoring-overview-activity-logs.md)
