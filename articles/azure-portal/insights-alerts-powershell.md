<properties
	pageTitle="Uso de PowerShell para crear alertas de los servicios de Azure | Microsoft Azure"
...
7. Para crear una alerta que se desencadena según una condición específica en el registro de actividades, use comandos con el siguiente formato:
...
8. Observe las reglas individuales para comprobar que las alertas se crearon correctamente.
...
9. Elimine las alertas. Estos comandos eliminan las reglas que se crearon anteriormente en este artículo.
