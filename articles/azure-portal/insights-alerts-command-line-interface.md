---
title: Uso de la interfaz de la línea de comandos (CLI) multiplataforma para crear alertas de los servicios de Azure | Microsoft Docs
...
1. Cumpla los requisitos previos e inicie sesión en Azure. Consulte [Ejemplos de CLI de Azure Insights](../monitoring-and-diagnostics/insights-cli-samples.md). En pocas palabras, instale la CLI y ejecute estos comandos. Con estos comandos, puede iniciar sesión, ver la suscripción que usa y prepararse para ejecutar comandos de Insights.
