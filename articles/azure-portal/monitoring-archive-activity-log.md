...
## Archivo del registro de actividades a través de PowerShell
```
...
| categoría |Categoría de la acción, p. ej. Escritura, Lectura, Acción. |
| resultType |El tipo de resultado, p. ej. Satisfactorio, Error, Inicio |
...
* [Transmitir el registro de actividades a Centros de eventos](../monitoring-and-diagnostics/monitoring-stream-activity-logs-event-hubs.md)
* [Obtener más información acerca del registro de actividades](../monitoring-and-diagnostics/monitoring-overview-activity-logs.md)
