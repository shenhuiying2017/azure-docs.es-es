---
title: Transmisión de registros de diagnóstico de Azure a Centros de eventos | Microsoft Docs
...
---
# Transmisión de registros de diagnóstico de Azure a Centros de eventos
Los **[registros de diagnóstico de Azure](../monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md)** se pueden transmitir casi en tiempo real a cualquier aplicación mediante la opción "Exportar a Centro de eventos" integrada en el Portal o habilitando el identificador de regla del Bus de servicio en una configuración de diagnóstico por medio de los cmdlets de Azure PowerShell o la CLI de Azure.

## Qué se puede hacer con registros de diagnóstico y Centros de eventos
...
Para habilitar el streaming mediante [cmdlets de Azure PowerShell](../monitoring-and-diagnostics/insights-powershell-samples.md), puede utilizar el cmdlet `Set-AzureRmDiagnosticSetting` con estos parámetros:
...
Para habilitar el streaming mediante la [CLI de Azure](../monitoring-and-diagnostics/insights-cli-samples.md), puede utilizar el comando `insights diagnostic set` del modo siguiente:
...
Puede ver una lista de todos los proveedores de recursos que admiten el streaming al Centro de eventos [aquí](../monitoring-and-diagnostics/monitoring-overview-of-diagnostic-logs.md).
