...
### Acceso a todas las métricas en un solo lugar
1. Abra Azure Portal.
...
## Acceso a métricas a través de la API de REST
...
* La [API de REST para definiciones de métricas de Azure Monitor](https://msdn.microsoft.com/library/mt743621.aspx) para acceder a la lista de métricas disponibles para un servicio.
* La [API de REST de métricas de Azure Monitor](https://msdn.microsoft.com/library/mt743622.aspx) para acceder a los datos de métricas reales.
...
Para ver un tutorial más detallado mediante las API de REST de Monitor de Azure, vea el [Tutorial sobre la API de REST de Azure Monitor](../monitoring-and-diagnostics/monitoring-rest-api-walkthrough.md).

## Opciones de exportación de métricas
...
Puede configurar esto a través de plantillas de Resource Manager, [PowerShell](../monitoring-and-diagnostics/insights-powershell-samples.md), [CLI](../monitoring-and-diagnostics/insights-cli-samples.md) o [API de REST](https://msdn.microsoft.com/library/dn931943.aspx).

## Realización de acciones en función de las métricas
...
Puede ver una lista detallada de todos los servicios admitidos y sus métricas en [Métricas de Azure Monitor: métricas admitidas por tipo de recurso](../monitoring-and-diagnostics/monitoring-supported-metrics.md).

## Pasos siguientes
Consulte los vínculos de este artículo. Además:

* Obtenga información sobre [métricas comunes de escalado automático de Azure Insights](../monitoring-and-diagnostics/insights-autoscale-common-metrics.md).
* Vea la información sobre cómo [crear reglas de alertas](../monitoring-and-diagnostics/insights-alerts-portal.md).
