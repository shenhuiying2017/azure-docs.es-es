---
title: Transmisión del registro de actividad de Azure a centros de eventos | Microsoft Docs
...
[El esquema para el registro de actividad está disponible aquí](../monitoring-and-diagnostics/monitoring-overview-activity-logs.md). Cada evento está en una matriz de blobs JSON denominados "registros".

## Pasos siguientes
* [Archive the Activity Log to a storage account](../monitoring-and-diagnostics/monitoring-archive-activity-log.md) (Archivado del registro de actividad en una cuenta de almacenamiento)
* [Lea la información general sobre el registro de actividad de Azure](../monitoring-and-diagnostics/monitoring-overview-activity-logs.md)
* [Configure una alerta basada en un evento del registro de actividad](../monitoring-and-diagnostics/insights-auditlog-to-webhook-email.md)
