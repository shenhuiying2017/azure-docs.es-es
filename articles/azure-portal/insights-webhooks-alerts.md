<properties
	pageTitle="Configuración de webhooks en alertas de métrica de Azure | Microsoft Azure"
...
>[AZURE.NOTE] Solo se puede establecer el campo de propiedades mediante la [API de REST Insights](https://msdn.microsoft.com/library/azure/dn933805.aspx).
