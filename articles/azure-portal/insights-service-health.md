---
title: Seguimiento del estado del servicio con Azure Insights | Microsoft Docs
...
1. Haga clic en **Examinar** y seleccione **Registros de auditoría**. ![Centro de exploración](./media/insights-service-health/Insights_Browse.png)
2. Se abrirá una hoja en la que se muestran todos los eventos que han influido en cualquiera de sus suscripciones durante los últimos 7 días. Las entradas del estado del servicio aparecerán en esta lista, pero puede que sea difícil encontrarlas, ya que la lista puede ser grande.
3. Haga clic en el comando **Filtro**.
4. Seleccione **Categoría de eventos** y elija **Estado del servicio**: ![Todos los eventos](./media/insights-service-health/Insights_Filter.png)
5. Haga clic en **Actualizado**.
6. Verá todos los eventos del estado del servicio que han afectado a la suscripción: ![Grupos de recursos](./media/insights-service-health/Insights_HealthEvent.png)
7. Desde ahí puede ir a la hoja de detalles para ver las particularidades del evento.
