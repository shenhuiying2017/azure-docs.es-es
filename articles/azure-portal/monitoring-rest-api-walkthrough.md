...
**Identificador URI de la solicitud**: https://management.azure.com/subscriptions/*{subscription-id}*/resourceGroups/*{resource-group-name}*/providers/*{resource-provider-namespace}*/*{resource-type}*/*{resource-name}*/providers/microsoft.insights/metrics?$filter=*{filter}*&api-version=*{apiVersion}*
...
3. Escriba *armclient GET [identificador\_del\_recurso]/providers/microsoft.insights/metricdefinitions?api-version=2016-03-01*.
4. Escriba *armclient GET [identificador\_del\_recurso]/providers/microsoft.insights/metrics?api-version=2016-06-01*.
...
* **IoT Hub**: /subscriptions/*{identificador-suscripción}*/resourceGroups/*{nombre-grupo-recursos}*/providers/Microsoft.Devices/IotHubs/*{nombre-iot-hub}*
* **Elastic SQL Pool**: /subscriptions/*{identificador-suscripción}*/resourceGroups/*{nombre-grupo-recursos}*/providers/Microsoft.Sql/servers/*{db-grupo}*/elasticpools/*{nombre-grupo-sql}*
* **SQL Database (v12)**: /subscriptions/*{identificador-suscripción}*/resourceGroups/*{nombre-grupo-recursos}*/providers/Microsoft.Sql/servers/*{nombre-servidor}*/databases/*{nombre-base datos}*.
* **Service Bus**: /subscriptions/*{identificador-suscripción}*/resourceGroups/*{nombre-grupo-recursos}*/providers/Microsoft.ServiceBus/*{espacio-de-nombres}*/*{nombre-servicebus}*.
* **VM Scale Sets**: /subscriptions/*{identificador-suscripción}*/resourceGroups/*{nombre-grupo-recursos}*/providers/Microsoft.Compute/virtualMachineScaleSets/*{nombre-vm}*.
* **Virtual Machines**: /subscriptions/*{identificador-suscripción}*/resourceGroups/*{nombre-grupo-recursos}*/providers/Microsoft.Compute/virtualMachines/*{nombre-vm}*.
* **Event Hubs**: /subscriptions/*{identificador-suscripción}*/resourceGroups/*{nombre-grupo-recursos}*/providers/Microsoft.EventHub/namespaces/*{espacio de nombres-centro de eventos}*.
...
## Pasos siguientes
* Revise la [información general de supervisión](../monitoring-and-diagnostics/monitoring-overview.md).
* Vea las [métricas compatibles con Azure Monitor](../monitoring-and-diagnostics/monitoring-supported-metrics.md).
