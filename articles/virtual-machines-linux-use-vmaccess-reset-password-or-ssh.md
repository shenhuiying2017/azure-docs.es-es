<properties pageTitle="Cómo usar VMAccess para las máquinas virtuales de Linux" description="Cómo usar la extensión VMAccess para Linux para restablecer las contraseñas, claves SSH y configuraciones de SSH" services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
...
[Características y extensiones de máquina virtual de Azure]: http://msdn.microsoft.com/es-es/library/azure/dn606311.aspx
[Conectarse a una máquina virtual de Azure con RDP o SSH]: http://msdn.microsoft.com/es-es/library/azure/dn535788.aspx
