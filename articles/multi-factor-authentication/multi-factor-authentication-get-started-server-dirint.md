...
> [!WARNING]
> Una vez quitado un registro de elemento de sincronización, no se puede recuperar. Tendrá que volver a agregar el registro del elemento de sincronización si lo eliminó por error.
> 
> 
...
## <a name="multifactor-auth-servers"></a>Servidores Multi-Factor Authentication
