...
---
# <a name="getting-started-with-the-azure-multifactor-authentication-server"></a>Introducción a Servidor Azure Multi-Factor Authentication
...
## <a name="download-the-azure-multifactor-authentication-server"></a>Descarga de Servidor Azure Multi-Factor Authentication
...
### <a name="to-download-the-azure-multifactor-authentication-server-from-the-azure-portal"></a>Para descargar Servidor Azure Multi-Factor Authentication del Portal de Azure.
- - -
...
5. De este modo se abrirá una nueva página.  Haga clic en **Descargas.**
   ![Descarga](./media/multi-factor-authentication-sdk/download.png)
...
### <a name="to-download-the-azure-multifactor-authentication-server-via-the-service-settings"></a>Descarga del Servidor de Azure Multi-Factor Authentication mediante la configuración del servicio
1. Inicie sesión en el Portal de Azure como administrador.
2. En la parte izquierda, seleccione Active Directory.
...
## <a name="install-and-configure-the-azure-multifactor-authentication-server"></a>Instalación y configuración del Servidor Azure Multi-Factor Authentication
...
### <a name="azure-multifactor-authentication-server-firewall-requirements"></a>Requisitos de firewall del Servidor Azure Multi-Factor Authentication
- - -
...
### <a name="to-install-and-configure-the-azure-multifactor-authentication-server"></a>Para instalar y configurar el Servidor Azure Multi-Factor Authentication
- - -
...
### <a name="to-import-users-from-active-directory"></a>Para importar usuarios desde Active Directory
- - -
...
### <a name="configuring-email-and-email-templates"></a>Configuración del correo electrónico y las plantillas de correo electrónico
...
## <a name="how-the-azure-multifactor-authentication-server-handles-user-data"></a>¿Cómo controla el Servidor Azure Multi-Factor Authentication los datos de usuario?
...
## <a name="advanced-azure-multifactor-authentication-server-configurations"></a>Configuraciones de servidor de Azure Multi-Factor Authentication avanzadas
