...
[No lo sé](#changing-your-settings-with-the-myapps-portal)|Esto significa que debe iniciar sesión en [http://myapps.microsoft.com](http://myapps.microsoft.com) y cambiar ahí la configuración.
...
![Configuración](./media/multi-factor-authentication-end-user-manage-myapps/proofup.png)
...
3. En el cuadro desplegable, seleccione Comprobación de seguridad adicional. ![Configuración](./media/multi-factor-authentication-end-user-manage/azure1.png)
4. Esto le llevará a la página que le permitirá cambiar la configuración. ![Configuración](./media/multi-factor-authentication-end-user-manage-azure/proofup.png)
