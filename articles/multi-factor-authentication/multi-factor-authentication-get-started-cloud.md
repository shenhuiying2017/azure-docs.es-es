---
title: Introducción a Microsoft Azure Multi-Factor Authentication en la nube
...
* [Crear un Proveedor de Multi-Factor Authentication](multi-factor-authentication-get-started-auth-provider.md) y asignarlo a su directorio o [asignar licencias a sus usuarios](multi-factor-authentication-get-started-assign-licenses.md).
