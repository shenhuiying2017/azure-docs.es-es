...
# Configuración de conexiones VPN S2S activo-activo con Azure VPN Gateway utilizando Azure Resource Manager y PowerShell
...
En este paso, creará la conexión de TestVNet1 a Site5\_1 con "EnableBGP" establecido como $True..
...
Cree la conexión de TestVNet1 a Site5\_2 con "EnableBGP" establecido como $True
...
### Configuración de una puerta de enlace de activo-en espera a puerta de enlace activo-activo

#### 1\. Parámetros de la puerta de enlace
...
### Configuración de una puerta de enlace de activo-activo a puerta de enlace activo-en espera
