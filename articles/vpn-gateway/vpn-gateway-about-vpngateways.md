...
[AZURE.INCLUDE [vpn-gateway-gwsku-include](../../includes/vpn-gateway-gwsku-include.md)] Las VPN basadas en directivas solo se pueden crear para puertas de enlace mediante la SKU básica.
Para más información acerca de las SKU de puerta de enlace, consulte [SKU de puerta de enlace](vpn-gateway-about-vpn-gateway-settings.md#gwsku).
