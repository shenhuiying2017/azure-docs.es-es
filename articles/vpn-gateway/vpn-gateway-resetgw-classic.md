...
## <a name="reset-a-vpn-gateway-using-the-resource-management-deployment-model"></a>Restablecimiento de una instancia de VPN Gateway usando el modelo de implementación de Resource Manager
...
## <a name="reset-a-vpn-gateway-using-the-classic-deployment-model"></a>Restablecimiento de una instancia de VPN Gateway usando el modelo de implementación clásico
