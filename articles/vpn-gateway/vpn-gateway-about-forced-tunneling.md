<properties 
	...
	description="Si tiene una red virtual con una puerta de enlace VPN entre entornos, puede redirigir o «forzar» todo el tráfico enlazado a Internet de nuevo a la ubicación local. Este artículo se aplica a puertas de enlace de VPN creadas mediante el modelo de implementación clásica "
