<properties 
   pageTitle="Conectar una red virtual a varios sitios con VPN Gateway y PowerShell | Microsoft Azure"
...
![diagrama multisitio](./media/vpn-gateway-multi-site/multisite.png "multi-site")
...
- Deberá instalar la versión más reciente de los cmdlets de Azure PowerShell. Consulte [Cómo instalar y configurar Azure PowerShell](../powershell-install-configure.md) para más información sobre cómo instalar los cmdlets de PowerShell.
...
### <a name="if-you-don't-have-a-site-to-site-virtual-network:"></a>Si no dispone de una red virtual de sitio a sitio:
...
## <a name="<a-name="export"></a>2.-export-the-network-configuration-file"></a><a name="export"></a>2. Exportar el archivo de configuración de red 
