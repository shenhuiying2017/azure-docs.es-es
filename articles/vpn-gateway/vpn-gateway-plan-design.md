...
### <a name="<a-name="gwrequire"></a>gateway-requirements-by-vpn-type-and-sku"></a><a name="gwrequire"></a>Requisitos de puerta de enlace por tipo de VPN y SKU
...
Las secciones siguientes analizan los aspectos básicos de la puerta de enlace de VPN. Además, considere las [limitaciones de servicios de red](../articles/azure-subscription-service-limits.md#networking-limits).
