---
title: "Creación de certificados autofirmados para conexiones entre entornos de red virtual de punto a sitio mediante MakeCert | Microsoft Docs"
...
Para conexiones P2S, el método preferido para los certificados es usar la solución de certificados de empresa, lo que garantiza que los certificados de cliente se emiten con el formato de valor de nombre común 'name@yourdomain.com',, en lugar de con el formato "nombre de dominio NetBIOS\nombre de usuario".
...
2. Después de la instalación, la utilidad makecert.exe se encuentra en esta ruta de acceso: C:\Archivos de programa (x86)\Windows Kits\10\bin\<arquitectura>. 
...
1. Para obtener un archivo .cer del certificado, abra **certmgr.msc**. Haga clic con el botón derecho en el certificado raíz autofirmado, luego en **Todas las tareas** y, por último, en **Exportar**. Se abre el **Asistente para exportar certificados**.
...
1. Todos los certificados se almacenan en su almacén de certificados, en Usuario actual\Personal\Certificados, de su equipo. Puede generar tantos certificados de cliente como sean necesarios según este procedimiento.
