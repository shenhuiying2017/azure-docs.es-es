...
### <a name="generate"></a>Paso 2: Generación del certificado de cliente
...
## <a name="clientcertificate"></a>Parte 6: Instalación del certificado de cliente
