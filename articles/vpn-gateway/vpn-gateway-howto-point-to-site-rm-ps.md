---
title: Configuración de una conexión de puerta de enlace de VPN de punto a sitio a una red virtual mediante el modelo de implementación de Resource Manager | Microsoft Docs
...
## <a name="<a-name="declare"></a>part-1---log-in-and-set-variables"></a><a name="declare"></a>Parte 1: Inicio de sesión y establecimiento de variables
...
## <a name="part-2---configure-a-vnet"></a>Parte 2: Configuración de una red virtual
...
## <a name="part-3---add-trusted-certificates"></a>Parte 3: Incorporación de certificados de confianza
...
## <a name="part-4---create-the-vpn-gateway"></a>Parte 4: Creación de la puerta de enlace de VPN
...
## <a name="part-5---download-the-vpn-client-configuration-package"></a>Parte 5: Descarga del paquete de configuración de cliente de VPN
...
## <a name="<a-name="cc"></a>part-6---generate-the-client-certificate"></a><a name="cc"></a>Parte 6: Generación de un certificado de cliente
...
## <a name="part-7---install-the-client-certificate"></a>Parte 7: Instalación del certificado de cliente
...
## <a name="part-8---connect-to-azure"></a>Parte 8: Conexión a Azure
...
## <a name="part-9---verify-your-connection"></a>Parte 9: Comprobación de la conexión
...
## <a name="to-add-or-remove-a-trusted-root-certificate"></a>Procedimiento para agregar o quitar un certificado raíz
...
## <a name="to-manage-the-list-of-revoked-client-certificates"></a>Administración de la lista de certificados de cliente revocados
