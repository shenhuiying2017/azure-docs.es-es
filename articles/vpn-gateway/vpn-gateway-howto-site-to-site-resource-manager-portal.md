...
# Creación de una red virtual del administrador de recursos con una conexión VPN de sitio a sitio mediante el Portal de Azure
...
Este artículo le guiará a través de la creación de una red virtual y una conexión VPN de sitio a sitio en una red local mediante el modelo de implementación de Azure Resource Manager y el Portal de Azure.
...
En los pasos siguientes, creará una red virtual, agregará una subred de puerta de enlace, una puerta de enlace, un sitio local y una conexión. Además, también necesitará configurar el dispositivo VPN.

Al usar estos pasos como un ejercicio, puede utilizar los siguientes valores:
...
Si está creando una nueva red virtual como un ejercicio, puede hacer referencia a estos [valores](#values) al crear la red virtual.
