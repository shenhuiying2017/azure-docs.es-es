---
title: 'Documentación sobre Azure VPN Gateway: tutoriales y referencia de API | Microsoft Docs'
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Más información acerca de VPN Gateway</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Biblioteca de vídeos de VPN Gateway</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Comenzar a planear con VPN Gateway</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Comenzar a crear una conexión de sitio a sitio mediante Azure Portal</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Comenzar a crear una conexión de punto a sitio mediante Azure Portal</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Comenzar a crear una conexión de red virtual a red virtual mediante Azure Portal</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/powershell/module/azure/#networking">PowerShell (clásico)</a></p> 
                        <p><a href="/cli/azure/network/vnet-gateway">CLI de Azure</a></p> 
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="https://msdn.microsoft.com/library/jj154113">REST (clásico)</a></p>
                    </div>
                </div>
            </div>
        </div>
