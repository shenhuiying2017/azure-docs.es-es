...
4. Creación de las configuraciones de subred para TestVNet1
	...
	El siguiente ejemplo usa las variables que estableció anteriormente. En este ejemplo, la subred de la puerta de enlace está usando un /27. Aunque se puede crear una subred de puerta de enlace con un prefijo tan reducido como /29, no se recomienda hacerlo. Se recomienda utilizar prefijos algo más grandes, como /27 o /26. Ello le permitirá aprovechar las configuraciones existentes o futuras que puedan requerir una subred de puerta de enlace más grande.
