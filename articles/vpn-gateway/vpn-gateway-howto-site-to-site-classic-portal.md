...
3. Cerca de la parte inferior de la página Red virtual, en la lista desplegable **Seleccionar un modelo de implementación**, seleccione **Clásico** y, a continuación, haga clic en **Crear**.
