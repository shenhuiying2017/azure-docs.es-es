<properties 
   pageTitle="Configuración de credenciales de autenticación con nombre"
	description="Configuración de credenciales de autenticación con nombre"
...
Se requieren dos datos para la autenticación en Azure:
...
- Cuando publique un servicio en la nube de Azure desde el asistente **Publicar aplicación de Azure**, seleccione **<Manage>** en la lista **Elija su suscripción**, elija la pestaña **Certificados** y después haga clic en el botón **Nuevo** o **Editar**.
...
1. Para cargar el certificado en el Portal de administración, seleccione el vínculo **Azure Portal**

    Se abre el Portal de administración.

1. Elija el vínculo **Portal de Azure**.

    Se abre el [Portal de administración](http://go.microsoft.com/fwlink/?LinkID=213885).

1. Inicie sesión en el Portal de administración con la cuenta Microsoft y después elija el botón **Servicios en la nube**.

1. Elija el servicio en la nube que le interese. Se abre la página para ese servicio.
