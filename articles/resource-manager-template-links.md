---
title: Plantilla del Administrador de recursos para la vinculación de recursos | Microsoft Docs
...
| Nombre | Valor |
| --- | --- |
| targetId |Cadena<br />Obligatorio<br />**{resource id}****<br /><br />Identificador del recurso de destino al que se vinculará. |
