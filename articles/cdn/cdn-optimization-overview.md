...
Cuando realice la entrega de contenido a una audiencia global de gran tamaño, es fundamental garantizar la entrega optimizada del contenido. Azure Content Delivery Network (CDN) puede optimizar la experiencia de entrega según el tipo de contenido que tenga. El contenido puede ser un sitio web, una transmisión en directo, un vídeo o un archivo grande para su descarga. Cuando cree un punto de conexión de CDN, especifique un escenario en la opción **Optimizado para**. Su elección determina qué optimización se aplica al contenido que se va a entregar desde el punto de conexión de la red CDN.
...
**Azure CDN Estándar de Microsoft** admite las siguientes optimizaciones:
...
**Azure CDN Estándar de Verizon** y **Azure CDN Premium de Verizon** admiten las siguientes optimizaciones:
...
**Azure CDN Estándar de Akamai** admite las siguientes optimizaciones:
...
Para crear un nuevo punto de conexión, seleccione el tipo de optimización que mejor coincida con el escenario y el tipo de contenido que quiere que el punto de conexión entregue. **Entrega web general** es la selección predeterminada. Para los puntos de conexión existentes de **Azure Content Delivery Network de Akamai**, puede actualizar la opción de optimización en cualquier momento. Este cambio no interrumpe la entrega desde Azure CDN. 

1. Dentro de un perfil **Azure CDN Estándar de Akamai**, seleccione un punto de conexión.
...
> [!NOTE]
> Si usa **Azure CDN Estándar de Akamai**, es posible que quiera usar esta optimización cuando el tamaño medio de los archivos sea inferior a 10 MB. Si el tamaño promedio de los archivos es superior a 10 MB, seleccione **Descarga de archivos grandes** en la lista desplegable **Optimizado para**.
...
Para **Azure CDN Estándar de Microsoft**, **Azure CDN Estándar de Verizon** y **Azure CDN Premium de Verizon**, use el tipo de optimización de entrega web general para entregar streaming de contenido multimedia de vídeo bajo demanda.
...
Con **Azure CDN Estándar de Akamai**, se optimizan las descargas de archivos de gran tamaño de contenido de más de 10 MB. Si el tamaño medio de los archivos es menor que 10 MB, use la entrega web general. Si los tamaños promedios de los archivos son constantemente superiores a 10 MB, es posible que sea más eficaz crear un punto de conexión independiente para los archivos grandes. Por ejemplo, las actualizaciones de firmware o software normalmente son archivos grandes. Para entregar archivos de más de 1,8 GB, se requiere la optimización de descarga de archivos grandes.

Para **Azure CDN Estándar de Microsoft**, **Azure CDN Estándar de Verizon** y **Azure CDN Premium de Verizon**, use el tipo de optimización de entrega web general para entregar contenido de descarga de archivos de gran tamaño. No hay ninguna limitación en el tamaño de la descarga de archivos.
...
### <a name="dynamic-site-acceleration"></a>Aceleración de sitios dinámicos
 ...
 La aceleración de sitios dinámicos está disponible para los perfiles **Azure CDN Estándar de Akamai**, **Azure CDN Estándar de Verizon** y **Azure CDN Premium de Verizon**. El uso de esta optimización implica el pago de una cuota adicional; para más información, consulte [Precios de Content Delivery Network](https://azure.microsoft.com/pricing/details/cdn/).
