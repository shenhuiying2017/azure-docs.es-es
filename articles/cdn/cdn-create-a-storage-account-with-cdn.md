...
4. Deje los valores predeterminados para **Modelo de implementación**, **Tipo de cuenta**, **Rendimiento** y **Replicación**.
5. Seleccione la **Suscripción** con la que se usará la cuenta de almacenamiento.
6. Seleccione o cree un grupo de recursos. Para más información sobre los grupos de recursos, consulte [Información general del Administrador de recursos de Azure](../resource-group-overview.md#resource-groups).
...
> [!TIP]
> Si ya tiene un perfil de red CDN que quiere utilizar para este tutorial, continúe con el [Paso 3](#step-3-create-a-new-cdn-endpoint).
> 
> 
