<properties
	 pageTitle="Asignación del contenido de la red de entrega de contenido (CDN) de Azure a un dominio personalizado | Microsoft Azure"
...
> [AZURE.NOTE] Debe crear un registro CNAME con su registrador de dominio y asignar su dominio al extremo de red CDN. Los registros CNAME asignan subdominios específicos, como `www.contoso.com` o `cdn.contoso.com`. No es posible asignar un registro CNAME a un dominio raíz, como `contoso.com`.
>    
