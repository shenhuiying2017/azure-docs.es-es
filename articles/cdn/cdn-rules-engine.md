---
title: "Invalidación del comportamiento HTTP predeterminado mediante el motor de reglas de Content Delivery Network (CDN) de Azure | Microsoft Docs"
...
---
# <a name="override-default-http-behavior-using-the-azure-content-delivery-network-cdn-rules-engine"></a>Invalidación del comportamiento HTTP predeterminado mediante el motor de reglas de Content Delivery Network (CDN) de Azure
