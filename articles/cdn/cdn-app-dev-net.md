---
title: Introducción a la biblioteca de red CDN de Azure para .NET | Microsoft Docs
...
> [!NOTE]
> El ejemplo anterior asigna al punto de conexión un origen denominado "*Contoso*" con el nombre de host `www.contoso.com`. Debe cambiarlo para que señale al nombre de host de su propio origen.
> 
> 
