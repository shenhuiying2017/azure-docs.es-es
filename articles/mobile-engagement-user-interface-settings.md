<properties 
   ...
   description="Información general de la interfaz de usuario para la sección de configuración de Azure Mobile Engagement" 
...
Las opciones del menú Configuración disponibles para una aplicación varían, dependiendo de la plataforma de la aplicación y de los permisos que se le hayan concedido para la aplicación. Entre los ajustes se incluyen los siguientes: Detalles, Proyectos, Inserción nativa, Velocidad de inserción, SDK, Seguimiento, Información de la aplicación, Presión comercial y Permisos. Solamente la opción del menú Información de la aplicación de la sección de configuración de la interfaz de usuario contiene elementos que se pueden administrar con la función "Etiqueta" de la API del dispositivo. El "Glosario" de "Conceptos" incluye definiciones de términos y abreviaturas, como las siguientes: APNS, GCM, IDFA, API, SDK, clave de API, clave de SDK, identificador de aplicación (ID de aplicación), ID de tienda, Plan de etiquetas, ID de usuario, ID de dispositivo, delegado de la aplicación, seguimiento de la pila y vinculación en profundidad.

**Consulte también:** 

- [Documentación de API: API de dispositivos][Link 4][Conceptos - Glosario][Link 6], [Guía de solución de problemas - Servicio][Link 2]
 
  ![settings1][46]

## Detalles:
Permite cambiar el nombre y la descripción de la aplicación 
Presenta el propietario de la aplicación y los permisos del rol. 
Configuración de análisis: Permite ver o cambiar el día en que empieza la semana y el tiempo de retención en días
...
## Inserción nativa:
Permite registrar un nuevo certificado o la eliminación de un certificado existente para usar con la inserción nativa. 
Inserción nativa permite a Azure Mobile Engagement insertar en su aplicación en cualquier momento, aunque no se esté ejecutando. 
...
- [Documentación de la API: API de cobertura] [Link 4],[Documentación de la API: API de inserción] [Link 4], [Documentación de la interfaz de usuario - Alcance - Nueva campaña de inserción][Link 17]
...
Para habilitar la inserción nativa mediante el servicio de notificación de Windows, debe proporcionar las credenciales de la aplicación. 
Necesitará el identificador de seguridad del paquete (SID) y la clave secreta.
 
![settings5][50]
 
**Inserción nativa de Android con GCM o ADM**

**Mensajería en la nube de Google para Android (GCM)**

Para habilitar la inserción nativa mediante GCM, deberá seguir las instrucciones disponibles en http://developer.android.com/guide/google/gcm/gs.html. 
A continuación, debe pegar una clave de API simple de servidor configurada sin restricciones de IP. 
Requiere la integración con el SDK de Android v1.12.0 +.
...
Para habilitar la inserción nativa con ADM, debe proporcionar <credenciales OAuth> compuestas de un identificador de cliente y el secreto del cliente (requiere la integración con el SDK de Android v2.1.0+).
...
-    Use un servicio de atribución de terceros (actualmente Azure Mobile Engagement admite [el seguimiento de aplicaciones móviles]( http://www.mobileapptracking.com/) y es posible que [Trademob](http://www.trademob.com/) también sea compatible en un futuro próximo).
...
- [Documentación de la interfaz de usuario - Cobertura - Nueva campaña de inserción][Link 17] 
...
- [Documentación de la interfaz de usuario - Cobertura - Insertar contenido][Link 17]
...
- [Documentación de la interfaz de usuario - Cobertura - Nueva campaña de inserción][Link 17], [Documentación de IU - Segmentos][Link 18]
