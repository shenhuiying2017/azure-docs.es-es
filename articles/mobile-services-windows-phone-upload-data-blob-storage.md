...
+ Complete el tutorial [Incorporación de servicios móviles a una aplicación existente](/es-es/documentation/articles/mobile-services-windows-phone-get-started-data/)  
...
2. En el panel izquierdo, seleccione la categoría **En línea**, seleccione **Incluir versión preliminar**, busque **MicrosoftAzure.Storage-Preview**, haga clic en **Instalar** en el paquete del **Almacenamiento de Azure** y acepte el contrato de licencia. 
