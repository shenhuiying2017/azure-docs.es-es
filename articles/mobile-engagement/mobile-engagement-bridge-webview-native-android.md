...
7. Tenga en cuenta los siguientes aspectos sobre el archivo HTML anterior:
...
8. Ejecute la aplicación y verá lo siguiente. Ahora, proporcione un nombre para un evento de prueba similar al siguiente y haga clic en el botón **Send** (Enviar) que se encuentra debajo. 
   
    ![][1]
9. Ahora, si va a la pestaña **Monitor** (Supervisar) de la aplicación y busca **Events -> Details** (Eventos -> Detalles), verá que este evento se muestra con app-info estática que se envía. 
