...
8. Este es el aspecto que presentaría el conjunto de cmdlets de PowerShell. 
    ...
    ![][3]
9. En el Portal de administración de Azure, compruebe que se haya creado una nueva aplicación de AD con el nombre que proporcionara al script llamado **principalName** en **Mostrar > Aplicaciones que tiene mi compañía**.
