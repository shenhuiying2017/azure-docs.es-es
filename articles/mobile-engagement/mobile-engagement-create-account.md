<properties
	pageTitle="Creación de una cuenta de Azure Mobile Engagement y comienzo de la administración de las aplicaciones | Microsoft Azure"
	description="Describe cómo crear una cuenta de Mobile Engagement en Azure y comenzar a administrar las aplicaciones con el portal de Mobile Engagement."
...
# Creación de una cuenta de Azure Mobile Engagement y comienzo de la administración de las aplicaciones

En este artículo se indica cómo usar el método **Creación rápida** para crear una cuenta de **Azure Mobile Engagement**. También se muestra cómo navegar hasta el portal de **Mobile Engagement** para comenzar a supervisar y administrar las aplicaciones.
