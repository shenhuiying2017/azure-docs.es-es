...
> [!NOTE]
> El período de tiempo se basa en la fecha de la configuración de dispositivo de los usuarios, por lo que un usuario cuyo teléfono tiene la fecha establecida incorrectamente podría aparecer en el período de tiempo incorrecto.
...
## <a name="accessing-the-retention-overview"></a>Acceso a la información general de retención
![Analytics3][12]
