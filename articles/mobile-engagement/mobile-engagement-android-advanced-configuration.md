...
Varias opciones requieren permisos específicos, las cuales se enumeran aquí para su referencia, así como las integradas en las características en cuestión. Agregue estos permisos al archivo AndroidManifest.xml del proyecto inmediatamente antes o después de la etiqueta `<application>`.
