...
3. Rellene el **Nombre del producto**, **Nombre de la organización** y **Identificador de organización**. Asegúrese de que ha seleccionado **Swift** en el lenguaje.
...
7. Edite el archivo de encabezado puente para exponer el código AzME Objective-C en el código Swift, agregue las importaciones siguientes:
...
6. Edite el archivo de encabezado puente para exponer encabezados AzME Objective-C Reach, agregue las importaciones siguientes:
