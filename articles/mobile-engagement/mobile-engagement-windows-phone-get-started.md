...
##<a id="setup-azme"></a>Configurar Mobile Engagement para su aplicación Windows Phone Silverlight
...
2. En el menú emergente, seleccione **Aplicaciones de la Tienda** -> **Aplicaciones de Windows Phone** -> **Aplicación vacía (Windows Phone Silverlight)**. Rellene la aplicación `Name` y `Solution name`, y luego haga clic en **Aceptar**.
...
Para comenzar a enviar datos y asegurarse de que los usuarios estén activos, debe enviar al menos una pantalla (Actividad) al back-end de Mobile Engagement. Para ello, se crearán subclases de `MainPage` con `EngagementPage` que ofrece el SDK de Mobile Engagement.

1. Agregue la instrucción `using`:

       mediante Microsoft.Azure.Engagement;

2. Para ello, reemplace la superclase de **MainPage**, que es anterior a **PhoneApplicationPage**, con **EngagementPage**, como se muestra a continuación:
...
3. Configure el primer campo de la campaña mediante los pasos siguientes: ![][36]
	...
	2. Como **Tiempo de entrega**, seleccione *Cualquier momento* para permitir que la aplicación reciba una notificación, independientemente de si se ha iniciado o no.
...
<!-- URLs. -->
[SDK de Windows Phone para Mobile Engagement]: http://go.microsoft.com/?linkid=9874664[Mobile documentación de SDK de Windows Phone para Engagement]: ../mobile-engagement-windows-phone-integrate-engagement/
