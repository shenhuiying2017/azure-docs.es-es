<properties 
	pageTitle="Uso del almacenamiento de tablas (Python) | Microsoft Azure" 
	description="Aprenda a utilizar el servicio Tabla de Azure de Python para crear y eliminar una tabla e insertar, eliminar y consultar la tabla." 
	services="storage" 
...
Esta guía le indicará cómo actuar en situaciones habituales usando el servicio de almacenamiento de tablas de Azure. Los ejemplos están escritos usando la API Python. Entre los escenarios descritos se incluyen la **creación y eliminación de una tabla, la inserción y la consulta de entidades en una tabla**. Para obtener más información acerca de las tablas, consulte la sección [Pasos siguientes][].
...
[¿Qué es el servicio Tabla?][]   
 ...
 [Adición de una entidad][]   
 [Adición de Cambio de un grupo de entidades][]   
 [Adición de una entidad][]   
 [Adición de un conjunto de entidades][]   
 [Adición de un subconjunto de propiedades de las entidades][]   
 [Adición de una entidad][]   
 [Adición de de una tabla][]   
 [Pasos siguientes][]
...
Si la entidad que se está actualizando no existe, la operación de actualización generará un error. Si desea almacenar una entidad sin considerar si ya existía antes, use **insert\_or\_replace_entity**. 
...
Esta técnica, denominada  *proyección*, reduce el ancho de banda y puede mejorar el rendimiento de las consultas, en especial en el caso de entidades de gran tamaño. Utilice el parámetro **select** y pase los nombres de las propiedades que desea que lleguen al cliente.
...
-   [Visite el Blog del equipo de almacenamiento de Azure][]
  ...
  [Adición de Cambio de un grupo de entidades]: #change-entities
  [Adición de una entidad]: #query-for-entity
  [Adición de un conjunto de entidades]: #query-set-entities
  [Adición de un subconjunto de propiedades de las entidades]: #query-entity-properties
