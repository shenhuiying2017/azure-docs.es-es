...
description: Aprenda a usar Microsoft Azure Portal.
services: 
documentationcenter: 
author: davidwrede
manager: erikre
...
---
# <a name="microsoft-azure-portal-overview"></a>Información general de Microsoft Azure Portal
Microsoft Azure Portal es una ubicación central desde donde se pueden aprovisionar y administrar los recursos de Azure.  Este tutorial le familiarizará con el portal y le mostrará cómo utilizar algunas de estas capacidades clave:
