<properties
   pageTitle="Errores comunes de implementación de Azure | Microsoft Azure"
...
Utilice **Get AzureRmResourceProvider** para obtener ubicaciones y tipos admitidos para un proveedor de recursos determinado.
...
Para registrar un proveedor de recursos, use el comando `azure provider register` y especifique el *espacio de nombres* para registrar.
