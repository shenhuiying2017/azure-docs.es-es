---
title: "Aplicaciones lógicas como puntos de conexión invocables | Microsoft Docs"
description: "Creación y configuración de puntos de conexión y uso de los puntos de conexión en una instancia de Azure Logic Apps"
services: logic-apps
...
| --- | --- |
| statusCode |El código de estado HTTP para responder a la solicitud entrante. Puede ser cualquier código de estado válido que comience con 2xx, 4xx o 5xx. No se permiten códigos de estado&3;xx. |
