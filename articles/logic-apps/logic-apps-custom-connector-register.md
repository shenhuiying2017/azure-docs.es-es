...
1. En Azure Portal, en el menú principal de Azure, elija **Crear un recurso**. En el cuadro de búsqueda, escriba "conector de logic apps" como filtro y presione Entrar.
...
Felicidades. Ahora, cuando cree una aplicación lógica, podrá encontrar el conector en el Diseñador de Logic Apps y agregarlo a la aplicación lógica.
