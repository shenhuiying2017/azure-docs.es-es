...
* **Empezar a trabajar rápidamente gracias a las plantillas**: para ayudarle a empezar, hemos dispuesto una [galería de plantillas][templates] que permiten crear rápidamente varias soluciones comunes. Desde soluciones B2B avanzadas hasta una conectividad de SaaS simple e incluso algunas demostraciones: la galería es la introducción más rápida a la eficacia de las aplicaciones lógicas.
...
* **Conectores administrados** : las aplicaciones lógicas necesitan acceder a datos y servicios. Los conectores administrados se crean específicamente para ayudarle cuando se conecte y trabaje con datos. Consulte la lista de conectores disponibles ahora en [conectores administrados][managedapis].
