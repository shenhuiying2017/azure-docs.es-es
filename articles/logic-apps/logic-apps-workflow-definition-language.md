...
|type|Sí|Especifica el tipo para el valor especificado. Los tipos de valores posibles son: <p>- `string`<br />- `securestring`<br />- `int`<br />- `bool`<br />- `array`<br />- `object`|
...
|startswith|Comprueba si la cadena comienza con valor, con independencia de mayúsculas o minúsculas. Por ejemplo, esta función devuelve `true`: <p>`lastindexof('hello, world', 'hello')` <p> **Número de parámetro**: 1 <p> **Nombre**: cadena <p> **Descripción**: necesaria. La cadena que puede contener el valor. <p> **Número de parámetro**: 2 <p> **Nombre**: cadena <p> **Descripción**: necesaria. El valor con el que comienza cadena.|  
|endswith|Comprueba si la cadena finaliza con un valor, con independencia de mayúsculas o minúsculas. Por ejemplo, esta función devuelve `true`: <p>`lastindexof('hello, world', 'world')` <p> **Número de parámetro**: 1 <p> **Nombre**: cadena <p> **Descripción**: necesaria. La cadena que puede contener el valor. <p> **Número de parámetro**: 2 <p> **Nombre**: cadena <p> **Descripción**: necesaria. El valor con el que puede finalizar la cadena.|  
...
|rand|Genera un entero aleatorio dentro del intervalo especificado (ambos extremos incluidos). Por ejemplo, esta función puede devolver `42`: <p>`rand(-1000,1000)` <p> **Número de parámetro**: 1 <p> **Nombre**: mínimo <p> **Descripción**: necesaria. El entero más bajo que se puede devolver. <p> **Número de parámetro**: 2 <p> **Nombre**: máximo <p> **Descripción**: necesaria. Este valor es el entero más alto que se puede devolver.|  
...
|dayOfWeek|Devuelve el día del componente de la semana de una marca de tiempo de cadena. Por ejemplo: `Wednesday`:<br /><br /> `dayOfWeek('2017-03-15T13:27:36Z')`<br /><br /> **Número de parámetro**: 1<br /><br /> **Nombre**: marca de tiempo<br /><br /> **Descripción**: necesaria. Es una cadena que contiene la hora.| 
...
|flujo de trabajo|Esta función proporciona todos los detalles del mismo propio flujo de trabajo en tiempo de ejecución. Puede obtener todo lo que está disponible en Management API, como nombre, ubicación y resourceID. Consulte la [API de REST](http://go.microsoft.com/fwlink/p/?LinkID=525617) para más información sobre las propiedades. Por ejemplo, esta función devuelve una ubicación como `westus`: <p>`workflow().location` <p> **Nota**: `@workflow` Se admite actualmente en desencadenadores.|
