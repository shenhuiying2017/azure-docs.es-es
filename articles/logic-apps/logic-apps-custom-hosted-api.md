---
title: Llamada a una API personalizada en Azure Logic Apps | Microsoft Docs
description: Uso de la API personalizada hospedada con Logic Apps
...
Para obtener información sobre la generación de API como desencadenador o acción en Aplicaciones lógicas, consulte [este artículo](../logic-apps/logic-apps-create-api-app.md).
...
## <a name="calling-into-the-api"></a>Llamada a la API
