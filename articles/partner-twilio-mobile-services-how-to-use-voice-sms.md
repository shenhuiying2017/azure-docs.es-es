<properties pageTitle="Uso de Twilio para funciones de voz y SMS | Centro de desarrollo móvil" metaKeywords="" description="Obtenga información acerca de cómo realizar tareas comunes a través de la API de Twilio con los Servicios móviles de Azure." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="How to use Twilio for voice and SMS capabilities from Mobile Services" authors="MicrosoftHelp@twilio.com" solutions="" manager="twilio" editor="" />
...
1. Complete el tutorial [Almacenamiento de scripts en control de código fuente](/en-us/documentation/articles/mobile-services-store-scripts-source-control/). Este tutorial muestra cómo configurar el control del código fuente en Servicios móviles y cómo almacenar los scripts del servidor en un repositorio Git.
...
3. Después de agregar la referencia de paquete de Twilio al objeto **dependencies**, el archivo package.json debe verse similar a lo siguiente:
	...
	>[WACOM.NOTE]La dependencia de Twilio se debe agregar como `"twilio": "~1.7.0"`, con (~). No se admite una referencia con un símbolo de intercalación (^). 
...
<h2><a id="howto_make_call"></a>Realización de llamada saliente</h2>
