---
title: Automatizar la implementación de una máquina virtual en Amazon Web Services | Microsoft Docs
...
4. Cuando termine de escribir la información necesaria, haga clic en **Crear**.
   ...
   > [!NOTE]
   > Al importar un módulo de PowerShell en Automatización de Azure, también se extraen los cmdlets. Estas actividades no aparecerán hasta que el módulo haya acabado completamente de importar y extraer los cmdlets. Este proceso puede tardar unos minutos. <br>
   > 
   > 
