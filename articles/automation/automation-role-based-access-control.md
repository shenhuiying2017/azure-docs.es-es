---
title: Control de acceso basado en rol en Automatización de Azure | Microsoft Docs
...
4. Haga clic en **Roles** en la hoja Usuarios para abrir la **hoja Roles**. En dicha hoja, puede ver el nombre del rol, el número de usuarios y los grupos asignados a dicho rol.
