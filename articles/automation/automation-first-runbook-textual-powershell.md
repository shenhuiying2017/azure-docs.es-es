...
1.	Haga clic en **Publicar** para publicar el Runbook y, a continuación, en **Sí** cuando se le solicite.![Botón Publicar](media/automation-first-runbook-textual-powershell/automation-publish-button.png)  
...
1.	Agregue parámetros para *VMName* y *VMServiceName* para el Runbook y use estas variables con el cmdlet **Start-AzureVM** como se muestra en la siguiente imagen. ![Agregar parámetro](media/automation-first-runbook-textual-powershell/automation-add-parameter.png)  
...
6.	Haga clic en **Iniciar** para iniciar el runbook. Escriba el valor de **VMName** y **VMServiceName** para la máquina virtual que va a iniciar. ![Pasar parámetro](media/automation-first-runbook-textual-powershell/automation-pass-parameter.png)  
