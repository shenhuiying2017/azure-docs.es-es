...
9. En la página **Activos**, seleccione **Agregar configuración** en la parte inferior de la página.
10. En la página **Agregar configuración**, seleccione **Agregar credenciales**.
11. En la página **Definir credenciales**, seleccione **Credenciales de Windows PowerShell** en la lista desplegable **Tipo de credenciales** y proporcione un nombre para las credenciales.
