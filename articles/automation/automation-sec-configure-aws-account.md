...
* Una suscripción a Azure y una cuenta de Automatización. Para más información sobre cómo configurar una cuenta de Automatización de Azure, consulte el artículo [Autenticación de Runbooks con una cuenta de ejecución de Azure](automation-sec-configure-azure-runas-account.md).
...
Después de crear y copiar las claves de seguridad de AWS, deberá crear un recurso de credencial con una cuenta de Automatización de Azure para almacenarlas de forma segura y hacer referencia a ellas con sus Runbooks. Siga los pasos que se describen en la sección **Creación de credenciales** en el artículo [Recursos de credenciales en Automatización de Azure](automation-certificates.md###Para crear credenciales con el Portal de Azure) y escriba la siguiente información:
...
## Pasos siguientes
* Revise el artículo [Solución de Automatización de Azure: aprovisionamiento de una máquina virtual de AWS](automation-scenario-aws-deployment.md) para aprender a crear runbooks para automatizar las tareas en AWS.
