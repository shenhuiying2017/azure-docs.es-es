---
title: Activos de certificados en Automatización de Azure | Microsoft Docs
...
4. En el menú desplegable **Tipo de credencial**, seleccione **Certificado**.
...
5. Haga clic en **Seleccionar un archivo** bajo **Cargar un archivo de certificado** para buscar un archivo .cer o .pfx. Si selecciona un archivo .pfx, especifique una contraseña y si se permitir o no su exportación.
