...
|Cmdlets|Descripción|
|:---|:---|
|[Get-AzureRmAutomationCertificate](https://msdn.microsoft.com/library/mt603765.aspx)|Recupera información sobre un certificado para utilizarlo en un runbook o en la configuración de DSC. Solo puede recuperar el propio certificado mediante la actividad Get-AzureRmAutomationCertificate.|
