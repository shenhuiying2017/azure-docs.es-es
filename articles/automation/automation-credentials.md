---
title: Recursos de credenciales en Automatización de Azure | Microsoft Docs
...
| Cmdlets | Descripción |
|:--- |:--- |
| [Get-AzureAutomationCredential](http://msdn.microsoft.com/library/dn913781.aspx) |Recupera información acerca de un recurso de credencial. Solo puede recuperar la propia credencial desde la actividad **Get-AutomationPSCredential**. |
...
### Para crear un nuevo recurso de credencial con el Portal de Azure clásico
...
4. En el menú desplegable **Tipo de credencial**, seleccione **Credencial de PowerShell**.
5. Realice los pasos del asistente y haga clic en la casilla para guardar la nueva credencial.

### Para crear un nuevo recurso de credencial con el Portal de Azure
...
### Para crear un nuevo recurso de credencial con Windows PowerShell
