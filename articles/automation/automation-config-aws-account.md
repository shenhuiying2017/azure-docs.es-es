...
* Una suscripción a Azure y una cuenta de Automatización.  Para obtener más información acerca de cómo configurar una cuenta de Azure Automation, consulte [Planeamiento de la autenticación](automation-offering-get-started.md#authentication-planning).  
