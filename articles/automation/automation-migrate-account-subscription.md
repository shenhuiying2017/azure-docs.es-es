---
title: Migrar una cuenta de Automatización y sus recursos | Microsoft Docs
...
* Para más información sobre el control de acceso basado en roles de Automatización de Azure, vea [Control de acceso basado en rol en Automatización de Azure](automation-role-based-access-control.md).
