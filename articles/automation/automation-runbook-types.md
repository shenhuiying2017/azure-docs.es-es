...
Los runbooks de Python son runbooks de texto basados en el lenguaje de scripting de Python. Azure Automation admite los runbooks tanto de Python 2 como de Python 3.
Para información sobre Python, vea [https://www.python.org/](https://www.python.org/).
Para obtener un ejemplo de un runbook de Python, vea [My first Python runbook in Azure Automation](automation-first-runbook-textual-python2.md) (Mi primer runbook de Python en Azure Automation).

## <a name="bash-runbooks"></a>Runbooks de Bash

Los runbooks de Bash son runbooks de texto basados en el shell de Bash en GNU. Para obtener información sobre Bash, vea [https://www.gnu.org/software/bash/](https://www.gnu.org/software/bash/).
