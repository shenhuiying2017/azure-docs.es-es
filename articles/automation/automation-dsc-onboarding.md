...
El cmdlet [Register-AzureRmAutomationDscNode](https://msdn.microsoft.com/library/mt603833.aspx) sirve para incorporar máquinas virtuales en el Portal de vista previa de Azure por medio de PowerShell.
...
6. Aplique de forma remota la metaconfiguración de DSC de PowerShell a las máquinas que desea incorporar:

	`Set-DscLocalConfigurationManager -Path C:\Users\joe\Desktop\DscMetaConfigs -ComputerName MyServer1, MyServer2`

7. Si no puede aplicar las metaconfiguraciones de DSC de PowerShell de forma remota, copie la carpeta de salida del paso 4 en cada máquina que vaya a incorporar. Después, llame a Set-DscLocalConfigurationManager localmente en cada máquina que vaya a incorporar.
...
7.  Aplique de forma remota la metaconfiguración de DSC de PowerShell a las máquinas que desea incorporar:
