---
title: Trabajos híbridos de runbook de Automatización de Azure | Microsoft Docs
...
> [!NOTE]
> Los trabajo híbridos de runbooks no admiten actualmente [configuraciones de DSC](automation-dsc-overview.md).
> 
> 
...
> [!NOTE]
> Actualmente la versión 7.2.11136.0 de Hybrid Runbook Worker solo admite la comunicación mediante un servidor proxy con scripts de PowerShell.  La compatibilidad con scripts de flujo de trabajo de PowerShell estará disponible en una futura versión.  
> 
> 
