...
13.  **Add-AzureAccount** tiene varios conjuntos de parámetros, por lo que necesitamos seleccionar uno antes de poder proporcionar valores de los parámetros. Haga clic en **Conjunto de parámetros** y seleccione el conjunto de parámetros **Usuario**.
...
15.  Queremos que este cmdlet use un recurso de credencial en nuestra cuenta de Automatización, por lo que seleccionaremos **Recurso de credencial** en **Origen de datos**.
...
7. Seleccione **Name**. Use **Valor constante** para el **Origen de datos** y escriba el nombre de la máquina virtual que se iniciará. Haga clic en **OK**.
8. Seleccione **ServiceName**. Use **Valor constante** para el **Origen de datos** y escriba el nombre de la máquina virtual que se iniciará. Haga clic en **Aceptar**.<br> ![Parámetros Start-AzureVM](media/automation-first-runbook-graphical/start-azurevm-params.png)
...
4. Especifique *VMName* para el campo **Name**. Mantenga *string* en **Type** y cambie **Mandatory** a *Yes*. Haga clic en **OK**.
...
- [Mi primer runbook de texto](automation-first-runbook-textual.md)
