...
1.	Haga clic en **Panel de prueba** para abrir la hoja Prueba.<br> ![Panel Prueba](media/automation-first-runbook-graphical/runbook-toolbar-test.png)
...
3.	Haga clic en **Entrada y salida** y en **Agregar entrada** para abrir la hoja Parámetro de entrada de Runbook.<br> ![Entrada y salida de runbook](media/automation-first-runbook-graphical/runbook-toolbar-InputandOutput.png)
...
5.	En el control Biblioteca, expanda **Recursos**, **Variables** y agregue **AzureSubscriptionId** al lienzo seleccionando **Agregar "Obtener variable" al lienzo**.
...
10.	Haga clic en **Parámetros**; aparece la hoja Configuración de parámetros de la actividad. 
11. En la hoja Configuración de parámetros de la actividad, haga clic en **Nombre** para que aparezca la hoja Valor del parámetro.  
12.	 En la hoja Valor del parámetro, seleccione **Entrada de Runbook** en **Origen de datos**, elija **AzureCredentialAssetName** en la lista y haga clic en **Aceptar** dos veces.   
13.	Mantenga el mouse sobre **Get Subscription ID** hasta que aparezca un círculo en la parte inferior de la forma. Haga clic en el círculo y arrastre la flecha hasta **Get Azure Credential**. La flecha que acaba de crear es un *vínculo*. Se iniciará el Runbook con **Get Subscription ID** y se ejecutará **Get Azure Credential**.<br> ![Crear vínculo entre actividades](media/automation-first-runbook-graphical/runbook-link-getsubscription-getcredential.png)
...
20.	En la hoja Valor del parámetro, seleccione **Resultado de la actividad** en **Origen de datos**, seleccione **Get Azure Credential** en la lista y haga clic en **Aceptar**.   
21.	Haga clic en **SubscriptionId** y en la hoja Valor del parámetro, seleccione **Get Subscription ID** en la lista y haga clic en **Aceptar** dos veces para volver al lienzo.
...
5. Seleccione **Get-AzureRmVM** y **Conjunto de parámetros** para ver los conjuntos de **Get-AzureRmVM**. Seleccione el conjunto de parámetros **GetVirtualMachineInResourceGroupNameParamSet**. Tenga en cuenta que **ResourceGroupName** y **Name** tienen signos de exclamación al lado. Esto indica que son parámetros necesarios. Tenga en cuenta que ambos esperan valores de cadena.
...
17. Seleccione el vínculo y, en el panel Configuración, cambie **Aplicar condición** a **Sí**. Tenga en cuenta que el vínculo se convierte en una línea discontinua que indica que la actividad de destino solo se ejecutará si la condición se resuelve como verdadera.  
...
22. Para **InputObject**, cambie **Origen de datos** a **Expresión de PowerShell** y escriba la expresión *"$VMName successfully started."*.
...
24. Para **InputObject**, cambie **Origen de datos** a **Expresión de PowerShell** y escriba la expresión *"$VMName could not start."*.
