<properties
   ...
   description="Este artículo proporciona información general sobre seguridad y los diferentes métodos de autenticación disponibles para las cuentas de Automatización en Automatización de Azure."
   services="automation"
   documentationCenter=""
   authors="MGoedtel"
   manager="jwhit"
