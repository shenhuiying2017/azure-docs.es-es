...
En este tema se muestra cómo utilizar Servicios móviles de Azure para aprovechar los datos en una aplicación de iOS. En este tutorial descargará una aplicación que almacena datos en memoria, creará un nuevo servicio móvil, integrará el servicio móvil en la aplicación y verá los cambios que se hicieron en los datos durante la ejecución de la aplicación.
...
3. [Descarga del servicio de forma local]
4. [Prueba del servicio móvil]
5. [Publicación del servicio móvil en Azure]
7. [Actualización de la aplicación para usar Servicios móviles]
...
1. Descargue GetStartedWithData, la [aplicación de ejemplo][GitHub].
...
##<a name="download-the-service-locally"></a>Descarga del servicio de forma local
