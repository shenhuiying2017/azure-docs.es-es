...
Antes de usar servicios de Twilio, primero debe  [suscribirse para obtener una cuenta][signup].  Los clientes de Microsoft Azure reciben un descuento especial;  [asegúrese de suscribirse aquí][signup].
