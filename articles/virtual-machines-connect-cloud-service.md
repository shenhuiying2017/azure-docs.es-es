<properties urlDisplayName="Infographics" pageTitle="Conexión de máquinas virtuales en un servicio en la nube de Azure" metaKeywords="Azure vm cloud service, vm cloud service" description="Learn to connect a virtual machine to an Azure cloud service." metaCanonical="http://www.windowsazure.com/en-us/manage/windows/how-to-guides/connect-to-a-cloud-service/" services="virtual-machines,cloud-services" documentationCenter="" title="" authors="kathydav" solutions="" manager="timlt" editor="" />
