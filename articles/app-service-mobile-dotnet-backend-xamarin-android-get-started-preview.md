...
En este tutorial se muestra cómo agregar un servicio de back-end basado en la nube a una aplicación Xamarin Android con Aplicaciones móviles de Azure. En este tutorial, creará tanto un nuevo servicio .NET como una aplicación simple de _To do list_ que almacena datos en el back-end de .NET.
