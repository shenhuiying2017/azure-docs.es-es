...
* **Azure PowerShell 1.0 o posterior**: Consulte [How to install and configure PowerShell](/powershell/azureps-cmdlets-docs) (Instalación y configuración de PowerShell).
