...
Este código presupone que dispone de dos variables de cadena, *accountName* y *accountKey*, que representan el nombre de la cuenta de almacenamiento y la clave de cuenta asociada.
...
Este código comprueba si la tabla con el nombre *table1* existe en la cuenta y la crea si no existe.
