...
* Finalización de [Creación de una aplicación para Windows].
* [SDK de Servicios móviles de Azure versión 2.0.0 (o posterior)][Nuget del SDK de Aplicaciones móviles de Azure]
* [Almacén de SQLite de Servicios móviles de Azure versión 1.0.2 (o posterior)][NuGet del almacén de SQLite]
...
2. En Visual Studio, abra el proyecto que completó en el tutorial [Creación de una aplicación para Windows]. Instale paquete NuGet **WindowsAzure.MobileServices.SQLiteStore** para el tiempo de ejecución de Windows 8.1 y los proyectos de Windows Phone 8.1.
    ...
    * **Windows 8.1:** en el Explorador de soluciones, haga clic con el botón derecho en el proyecto de Windows 8.1 y haga clic en **Administrar paquetes de NuGet** para ejecutar el Administrador de paquetes de NuGet. Busque **SQLiteStore** para instalar el paquete  `WindowsAzure.MobileServices.SQLiteStore`.
    * **Windows Phone 8.1:** haga clic con el botón derecho en el proyecto de Windows Phone 8.1 y haga clic en **Administrar paquetes de NuGet** para ejecutar el Administrador de paquetes de NuGet. Busque **SQLiteStore** para instalar el paquete de  `WindowsAzure.MobileServices.SQLiteStore`.
