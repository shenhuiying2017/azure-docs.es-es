...
- MSDN:
  ...
  - Compruebe su estado de elegibilidad en la [página de la cuenta de MSDN](https://msdn.microsoft.com/subscriptions/manage/deult.aspx).
...
## Pasos siguientes
¿Tiene preguntas de facturación o suscripción en Microsoft Azure? Consulte las [Preguntas más frecuentes sobre suscripciones y facturación de Azure](billing-subscription-faq.md#what-payment-options-do-i-have-in-purchasing-azure).
