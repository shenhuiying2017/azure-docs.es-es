<properties pageTitle="Chef y Máquinas virtuales de Azure" description="Describe la instalación y configuración de Chef en una máquina virtual de Azure." services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor=""/>
