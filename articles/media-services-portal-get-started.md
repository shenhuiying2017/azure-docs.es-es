<properties 
	pageTitle="Introducción a Servicios multimedia con el Portal de administración de Azure" 
	description="Este tutorial le guiará por los pasos necesarios para implementar una aplicación de entrega de contenido de vídeo a petición (VoD) con Servicios multimedia de Azure mediante el Portal de administración de Azure." 
...
#Inicio rápido: Introducción a Servicios multimedia con el Portal de administración de Azure
...
Este tutorial le indicará los pasos necesarios para implementar una aplicación básica de entrega de contenido de vídeo a petición (VoD) mediante el Portal de administración de Azure. 
