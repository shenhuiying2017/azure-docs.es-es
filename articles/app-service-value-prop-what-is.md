...
Servicios de aplicaciones de Azure es un servicio único que incluye todas las capacidades existentes de Sitios web de Azure, Servicios móviles de Azure y Servicios de Biztalk de Azure, a la vez que agrega nuevas capacidades.  [Obtenga más](http://azure.microsoft.com/documentation/services/app-service/) información acerca de cómo Servicios de aplicaciones se relaciona estos servicios existentes.
...
- [**Aplicaciones web**](app-service-web-overview.md): cree e implemente rápidamente aplicaciones web críticas que se escalan con su empresa.
- [**Aplicaciones móviles**](app-service-mobile-value-prop-preview.md): póngase en contacto con empleados, socios y clientes en cualquier dispositivo en cualquier momento.
- [**Aplicaciones de la API**](app-service-api-apps-why-best-platform.md): genere y consuma fácilmente las API en la nube y participe en la economía de la API.
- [**Lógica de aplicaciones**](app-service-logic-what-are-logic-apps.md): automatice el acceso y el uso de datos a través de nubes sin escribir código.
...
### Planes de Servicios de aplicaciones
