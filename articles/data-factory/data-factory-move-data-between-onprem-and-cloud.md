...
11. Una vez completada la creación, puede ver la hoja **Data Factory** que se muestra en la siguiente imagen:
...
5. En la hoja **Factoría de datos**, haga clic en el icono **Crear e implementar** para iniciar el **Editor** para la factoría de datos.
...
3. En la hoja **Configurar**, haga clic en **Instalar directamente en este equipo**. Esta acción descarga el paquete de instalación de la puerta de enlace, instala, configura y registra la puerta de enlace en el equipo.  
...
10. En Azure Portal, haga clic en **Aceptar** en la hoja **Configurar** y, después, en la hoja **Nueva puerta de enlace de datos**.
