...
Con la versión 12.1 del Proveedor de datos de Oracle para .NET instalado en la máquina de la puerta de enlace de administración de datos, podrá utilizar este conector de Oracle para copiar datos con las versiones inferiores de la instancia de Oracle como origen o destino. Vea la sección [Instalación](#installation) para obtener más información sobre cómo configurarlo.
...
puede que sea necesario cambiar la consulta, como se muestra en el siguiente ejemplo (mediante la función to_date):
...
2. Si recibe el mensaje de error incluso después de instalar el proveedor, lleve a cabo los siguientes pasos:
   ...
   2. Busque **Proveedor de datos de Oracle para .NET**; debería encontrar una entrada tal y como se muestra en el siguiente ejemplo:der **system.data** -> **DbProviderFactories**:
...
4. Instale <Ruta de instalación de ODP.NET>\11.2.0\client_1\odp.net\bin\4\Oracle.DataAccess.dll en la caché global de ensamblados (GAC) ejecutando `gacutil /i [provider path]`.
