...
En esta parte del paso, creará una tabla de salida denominada **EmpSQLTable** que apunta a una tabla SQL de Base de datos SQL de Azure que está representada por el servicio vinculado **AzureSqlLinkedService**.
