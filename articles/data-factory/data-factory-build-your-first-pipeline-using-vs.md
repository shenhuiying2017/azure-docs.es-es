---
title: Compilación de la primera Data Factory (Visual Studio) | Microsoft Docs
...
2. En el cuadro de diálogo **Agregar nuevo elemento**, seleccione **Servicio vinculado de Almacenamiento de Azure** en la lista y haga clic en **Agregar**.
...
5. En la página **Publicar elementos**, asegúrese de que todas las entidades de Factorías de datos están seleccionadas y haga clic en **Siguiente** para cambiar a la página **Resumen**.
...
7. Haga clic en **X** para cerrar la hoja **AzureBlobInput**.
