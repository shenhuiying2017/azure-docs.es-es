<properties 
	pageTitle="Conector de almacenamiento de datos SQL de Azure: movimiento de datos a y desde el almacenamiento de datos SQL de Azure" 
	description="Obtenga información acerca del conector de almacenamiento de datos SQL de Azure para el servicio Factoría de datos que le permite mover datos a y desde el almacenamiento de datos SQL de Azure." 
...
# Conector de almacenamiento de datos SQL de Azure: movimiento de datos a y desde el almacenamiento de datos SQL de Azure 

En este artículo se describe cómo puede usar la actividad de copia de la factoría de datos para mover datos al almacenamiento de datos SQL de Azure desde otro almacén de datos y desde otro almacén de datos a SQL de Azure. Este artículo se basa en el artículo sobre [actividades de movimiento de datos](data-factory-data-movement-activities.md) que presenta una introducción general del movimiento de datos con la actividad de copia y las combinaciones del almacén de datos admitidas.

## Ejemplo: copia de datos del almacenamiento de datos SQL de Azure a un blob de Azure

El ejemplo siguiente muestra:

1. Un servicio vinculado de tipo AzureSqlDW.
2. Un servicio vinculado de tipo AzureStorage. 
3. Un conjunto de datos de entrada de tipo AzureSqlDWTable. 
4. Un conjunto de datos de salida de tipo AzureBlob.
4. Una canalización con la actividad de copia que usa SqlDWSource y BlobSink.
...
1.	Un servicio vinculado de tipo AzureSqlDWDatabase.
2.	Un servicio vinculado de tipo AzureStorage.
3.	Un conjunto de datos de entrada de tipo AzureBlob.
4.	Un conjunto de datos de salida de tipo AzureSqlDWTable.
4.	Una canalización con la actividad de copia que usa BlobSource y SqlDWSink.
...
La canalización contiene una actividad de copia que está configurada para usar los conjuntos de datos de entrada y de salida y está programada para ejecutarse cada hora. En la definición de la canalización JSON, el tipo **source** se establece en **BlobSource** y el tipo **sink**, en **SqlDWSink**.
...
## Propiedades del servicio vinculado del almacenamiento de datos SQL de Azure
...
## Propiedades de tipo de conjunto de datos del almacenamiento de datos SQL de Azure
...
## Propiedades de tipo de actividad de copia del almacenamiento de datos SQL de Azure
...
La asignación es el misma que [Asignación de tipos de datos de SQL Server para ADO.NET](https://msdn.microsoft.com/library/cc716729.aspx).
