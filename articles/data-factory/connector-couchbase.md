---
title: Copiar datos de Couchbase con Azure Data Factory (beta) | Microsoft Docs
...
---
# <a name="copy-data-from-couchbase-using-azure-data-factory-beta"></a>Copiar datos de Couchbase con Azure Data Factory (beta)
