...
1. Agregue el siguiente código que **crea y activa una canalización** al método **Main**. Esta canalización tiene un elemento **CopyActivity** que toma **BlobSource** como origen y **BlobSink** como receptor.
...
2. Agregue el código siguiente al método **Main** para obtener el estado de un segmento de datos del conjunto de datos de salida. Solo se espera un segmento en este ejemplo.   
...
3. Agregue el código siguiente para obtener los detalles de la ejecución de un segmento de datos al método **Main** .
           ...
           Console.ReadKey();
4. Agregue el siguiente método auxiliar usado por el método **Main** a la clase **Program**.  
...
5. En el Explorador de soluciones, expanda el proyecto (**DataFactoryAPITestApp**), haga clic con el botón derecho en **Referencias**, y haga clic en **Agregar referencia**. Active la casilla del ensamblado "**System.Configuration**" y haga clic en **Aceptar**. 
6. Compile la aplicación de la consola. Haga clic en **Compilar** en el menú y en **Compilar solución**. 
7. Confirme que hay al menos un archivo en el contenedor **adftutorial** del Almacenamiento de blobs de Azure. De lo contrario, cree el archivo **Emp.txt** en el Bloc de notas con el siguiente contenido y cárguelo en el contenedor adftutorial.
   
       John, Doe
       Jane, Doe
8. Para ejecutar el ejemplo haga clic en **Depurar** -> **Iniciar depuración** en el menú. Cuando vea **Getting run details of a data slice**, espere unos minutos y presione **ENTRAR**. 
9. Use el Portal de Azure para comprobar que la factoría de datos **APITutorialFactory** se crea con los siguientes artefactos: 
...
10. Compruebe que los dos registros de empleados se han creado en la tabla "**emp**" de la base de datos de Azure SQL Database especificada.
