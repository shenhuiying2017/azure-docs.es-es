...
1. Con Visual Studio 2012, 2013 o 2015, cree una aplicación de consola .NET de C#.
	...
	6. Seleccione **C:\\ADFGetStarted** en Ubicación.
...
6. Agregue la siguiente sección **appSetttings** al archivo **App.config**. Esta configuración la usa el método auxiliar: **GetAuthorizationHeader**.
	...
	Reemplace los valores de **& lt; Identificador de aplicación & gt;**, **& lt; Contraseña & gt;**, **& lt; Id. de suscripción & gt;** e **& lt; Id. de inquilino**& gt; por sus propios valores.
...
6. Agregue el código siguiente que crea una instancia de la clase **DataPipelineManagementClient** al método **Main**. Este objeto se usa para crear una factoría de datos, un servicio vinculado, conjuntos de datos de entrada y salida, y una canalización. También se usa para supervisar los segmentos de un conjunto de datos en tiempo de ejecución.
	...
	> 
	> Actualice el nombre de la factoría de datos (**dataFactoryName**) para que sea único. El nombre de la factoría de datos debe ser único a nivel global. Consulte el tema [Data Factory: reglas de nomenclatura](data-factory-naming-rules.md) para conocer las reglas de nomenclatura para los artefactos de Data Factory.
...
8. Agregue el siguiente código que crea un **servicio vinculado de Almacenamiento de Azure** al método **Main**.

	> [AZURE.IMPORTANT] Reemplace **storageaccountname** y **accountkey** por el nombre y la clave de su cuenta de Almacenamiento de Azure.
...
9. Agregue el siguiente código que crea un **servicio vinculado SQL de Azure** al método **Main**.
 
	> [AZURE.IMPORTANT] Reemplace **servername**, **databasename**, **username** y **password** por los nombres del servidor SQL de Azure, de la base de datos, del usuario y de la contraseña.
