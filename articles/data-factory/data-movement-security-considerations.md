...
El movimiento de datos mediante Data Factory tiene la certificación:
...
### <a name="firewall-configurations-and-whitelisting-ip-addresses"></a>Configuraciones de firewall y lista de direcciones IP permitidas
