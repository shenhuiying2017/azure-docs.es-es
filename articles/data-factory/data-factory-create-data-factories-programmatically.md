...
8. Agregue el siguiente código que crea un **servicio vinculado** al método **Main**.
   ...
   > [!NOTE]
   > Use el **nombre de cuenta** y la **clave de cuenta** de su cuenta de almacenamiento de Azure para la **ConnectionString**.
   > 
   > 
...
19. Compruebe que se crea un archivo de salida en la carpeta **apifactoryoutput** en el contenedor de **adftutorial**.
