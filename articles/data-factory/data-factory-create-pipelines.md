...
Este artículo ayuda a conocer las canalizaciones y actividades de Azure Data Factory y a usarlas para construir flujos de trabajo controlados por datos de un extremo a otro para su escenario.

> [AZURE.NOTE] En este artículo se considera que ha repasado antes los artículos [Introducción a Azure Data Factory](data-factory-introduction.md) y[Creación de conjuntos de datos](data-factory-create-datasets.md). Si no tiene experiencia práctica con la creación de factorías de datos, repasar el tutorial [Creación de su primera factoría de datos](data-factory-build-your-first-pipeline.md) puede ayudarle a comprender mejor este artículo.
...
Los datos se copian en un blob nuevo cada hora. La ruta de acceso para el blob refleja la fecha y hora específicas con granularidad de hora.
...
4.	Cree una canalización con actividades que opere en los conjuntos de datos.
...
Establezca la **simultaneidad** en la definición JSON de la actividad en un valor mayor que 1 para que se procesen varios segmentos en paralelo con varias instancias de la actividad en tiempo de ejecución. Esta característica resulta útil al procesar los segmentos de relleno de fondo del pasado.
...
6. Una vez finalizada la creación de la canalización, haga clic en **Implementar** en la barra de comandos para implementar la canalización.
	...
	> [AZURE.NOTE] Durante la implementación, el servicio de Azure Data Factory realiza algunas comprobaciones de validación para ayudar a solucionar algunos problemas comunes. Si se produce un error, se mostrará la información correspondiente. Realice las acciones correctivas y, a continuación, vuelva a implementar la canalización creada. Puede usar el editor para actualizar y eliminar una canalización.

Consulte [Introducción a Azure Data Factory (Editor de Data Factory)](data-factory-build-your-first-pipeline-using-editor.md), un tutorial completo para crear una factoría de datos con una canalización.

### Uso del complemento Visual Studio
Puede usar Visual Studio para crear e implementar canalizaciones en Factoría de datos de Azure. Consulte [Introducción a Azure Data Factory (Editor de Data Factory)](data-factory-build-your-first-pipeline-using-vs.md), un tutorial completo para crear una factoría de datos con una canalización.
...
### Uso del SDK de .NET
También puede crear e implementar la canalización mediante el SDK de .NET. Este mecanismo se puede usar para crear canalizaciones mediante programación. Consulte [Creación, administración y supervisión de factorías de datos mediante programación](data-factory-create-data-factories-programmatically.md).


### Uso de la plantilla de Azure Resource Manager
Puede crear e implementar una canalización mediante una plantilla de Azure Resource Manager. Consulte [Introducción a Azure Data Factory (Azure Resource Manager)](data-factory-build-your-first-pipeline-using-arm.md).

### Uso de la API de REST
También puede crear e implementar la canalización mediante las API de REST. Este mecanismo se puede usar para crear canalizaciones mediante programación. Para más información, consulte [Creación o actualización de una canalización](https://msdn.microsoft.com/library/azure/dn906741.aspx).
