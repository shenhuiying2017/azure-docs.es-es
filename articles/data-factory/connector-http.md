...
>[!TIP]
>Para probar la solicitud HTTP para la recuperación de datos antes de configurar el conector HTTP en ADF, puede obtener información de la especificación de la API en los requisitos de cuerpo y encabezado, así como usar herramientas como el explorador web o Postman para la validación.
