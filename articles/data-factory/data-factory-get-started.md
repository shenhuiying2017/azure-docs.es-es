<properties pageTitle="Copia de datos de Almacenamiento de blobs en Base de datos SQL | Microsoft Azure" description="En este tutorial se muestra cómo usar la actividad de copia en una canalización de Data Factory de Azure para copiar datos de Almacenamiento de blobs en Base de datos SQL de Azure." Keywords: "blob SQL, Almacenamiento de blobs, copia de datos" services="data-factory" documentationCenter="" authors="spelluru" manager="jhubbard" editor="monicar"/>
