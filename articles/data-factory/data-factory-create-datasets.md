...
| -------- | ----------- | -------- | ------- |
| Nombre | Nombre del conjunto de datos | Sí | N/D |
| sección Estructura | <p>Esquema del conjunto de datos</p><p>Consulte la sección [Estructura del conjunto de datos](#Structure)para obtener más detalles</p> | Nº | N/D |
| Tipo | Tipo de conjunto de datos | Sí | N/D |
...
| anchorDateTime | Define la posición absoluta en tiempo usada por el programador para calcular los límites de los segmentos del conjunto de datos.<p>**Nota:** si AnchorDateTime tiene partes de fecha más granulares que frequency, se ignorarán las partes más granulares. Por ejemplo, si **interval**es**hourly** (frequency: hour e interval: 1) y **AnchorDateTime** contiene **minutes and seconds** las partes **minutes and seconds** de AnchorDateTime se omitirá.</p>| No | 01/01/0001 |
| Offset | Intervalo de tiempo mediante el que se desplaza el inicio y el final de todos los segmentos del conjunto de datos.<p>**Nota:** si se especifican anchorDateTime y offset, el resultado es el desplazmiento combinado.</p> | No | N/D |

### Ejemplos de anchorDateTime

**Ejemplo:** Segmentos del conjunto de datos de 23 horas que comienzan el día y hora siguientes: 2007-04-19T08:00:00
