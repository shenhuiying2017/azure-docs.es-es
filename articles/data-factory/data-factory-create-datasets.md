...
| typeProperties | Propiedades correspondientes al tipo seleccionado. Consulte la sección [Tipo de conjunto de datos](#Type) para obtener detalles sobre los tipos admitidos y sus propiedades. | Sí | N/D |
...
| availability | Define la ventana de procesamiento o el modelo de segmentación para la producción del conjunto de datos. <br/><br/>Consulte el tema [Disponibilidad del conjunto de datos](#Availability) para obtener más detalles<br/><br/>Consulte el artículo [Programación y ejecución](data-factory-scheduling-and-execution.md) para obtener más detalles sobre el modelo de segmentación del conjunto de datos | Sí | N/D
| policy | Define los criterios o la condición que deben cumplir los segmentos del conjunto de datos. <br/><br/>Consulte el tema [Directiva del conjunto de datos](#Policy) para obtener más detalles | No | N/D |
...
**frequency** está establecido en **Month** e **interval** está establecido en **1** (una vez al mes): si desea que el segmento que se va a producir el día 9 de cada mes a las 6 A.M., establecer el offset en "09.06:00:00". Recuerde que esta es la hora UTC.
