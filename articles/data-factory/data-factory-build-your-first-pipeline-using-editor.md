---
title: Compilación de la primera instancia de Data Factory (Portal de Azure) | Microsoft Docs
...
3. En la hoja **Nueva factoría de datos**, escriba **GetStartedDF** para el nombre.
...
2. Copie y pegue el fragmento de código siguiente en la ventana Borrador-1.
   ...
   > [!NOTE]
   > Consulte en la sección [Anatomía de una canalización](data-factory-create-pipelines.md#anatomy-of-a-pipeline) las propiedades JSON que se usan en el ejemplo.
   > 
   > 
...
4. Haga clic en **Implementar** en la barra de comandos para implementar la canalización. Dado que las horas de **inicio** y **fin** están establecidas en el pasado y **isPaused** está establecido en false, la canalización (actividad en la canalización) se ejecutará inmediatamente después de implementar.
...
6. Haga clic en **X** para cerrar la hoja **AzureBlobInput**.
...
9. Cuando el segmento se encuentre en el estado **Listo**, busque los datos de salida en la carpeta **partitioneddata** del contenedor **adfgetstarted** de Almacenamiento de blobs.
...
11. Haga clic en una cualquiera de las ejecuciones de la lista **Ejecuciones de actividad** para ver sus detalles (una actividad de Hive en nuestro escenario) en la ventana **Detalles de la ejecución de actividad**.
