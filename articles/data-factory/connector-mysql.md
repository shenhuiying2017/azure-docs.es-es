...
> * [Versión 1: Disponibilidad general](v1/data-factory-onprem-mysql-connector.md)
...
En concreto, este conector MySQL es compatible con la **versión 5.1 y posterior** de MySQL.
...
- Instale el [conector MySQL o Net para Microsoft Windows](https://dev.mysql.com/downloads/connector/net/) versión 6.6.5 o superior en la máquina Integration Runtime.
...
| contraseña | Especifique la contraseña de la cuenta de usuario especificada. Marque este campo como SecureString. | Sí |
...
| query | Utilice la consulta SQL personalizada para leer los datos. Por ejemplo: `"SELECT * FROM MyTable"`. | No (si se especifica "tableName" en el conjunto de datos) |
