...
En caso de la actividad de copia si el origen es del tipo **RelationalSource** (que incluye ODBC), están disponibles las propiedades siguientes en la sección typeProperties:
