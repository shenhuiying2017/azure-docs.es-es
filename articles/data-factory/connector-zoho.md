---
title: Copiar datos de Zoho con Azure Data Factory (beta) | Microsoft Docs
...
---
# <a name="copy-data-from-zoho-using-azure-data-factory-beta"></a>Copiar datos de Zoho con Azure Data Factory (beta)
...
Para copiar datos de Zoho, establezca la propiedad type del conjunto de datos en **ZohoObject**. No hay ninguna propiedad específica de tipo adicional en este tipo de conjunto de datos.
...
### <a name="zohosource-as-source"></a>ZohoSource como origen
...
| Propiedad | DESCRIPCIÓN | Requerido |
|:--- |:--- |:--- |
| Tipo | La propiedad type del origen de la actividad de copia debe establecerse en: **ZohoSource** | Sí |
