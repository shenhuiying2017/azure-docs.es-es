...
| **Origen** | **Sink** |
| ------ | ---- |
| [Blob de Azure](data-factory-azure-blob-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Azure DocumentDB, sistema de archivos en local y en IaaS de Azure, Almacén de Azure Data Lake |
| [Tabla de Azure](data-factory-azure-table-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Azure DocumentDB, Almacén de Azure Data Lake |
| [Base de datos SQL de Azure](data-factory-azure-sql-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Azure DocumentDB, Almacén de Azure Data Lake |
| [Almacenamiento de datos SQL de Azure](data-factory-azure-sql-data-warehouse-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Azure DocumentDB, Almacén de Azure Data Lake |
...
| [Almacén de Azure Data Lake](data-factory-azure-datalake-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Azure DocumentDB, sistema de archivos en local y en IaaS de Azure, Almacén de Azure Data Lake | 
| [SQL Server en IaaS](data-factory-sqlserver-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Almacén de Azure Data Lake |
| [Archivo de sistema en local y en IaaS de Azure](data-factory-onprem-file-system-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, sistema de archivos en local y en IaaS de Azure, Almacén de Azure Data Lake |
| [SQL Server en local y en IaaS de Azure](data-factory-sqlserver-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Almacén de Azure Data Lake |
| [Base de datos de Oracle en local y en IaaS de Azure](data-factory-onprem-oracle-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Almacén de Azure Data Lake |
| [Base de datos MySQL en local y en IaaS de Azure](data-factory-onprem-mysql-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Almacén de Azure Data Lake |
| [Base de datos DB2 en local y en IaaS de Azure](data-factory-onprem-db2-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Almacén de Azure Data Lake |
| [Base de datos de Teradata en local y en IaaS de Azure](data-factory-onprem-teradata-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Almacén de Azure Data Lake |
| [Base de datos de Sybase en local y en IaaS de Azure](data-factory-onprem-sybase-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Almacén de Azure Data Lake |
| [Base de datos de PostgreSQL en local y en IaaS de Azure](data-factory-onprem-postgresql-connector.md) | Blob de Azure, Tabla de Azure, Base de datos SQL de Azure, Almacenamiento de datos SQL de Azure, SQL Server en local y en IaaS de Azure, Almacén de Azure Data Lake |
...
Actividad de copia toma un conjunto de datos de entrada (**origen**) y un conjunto de datos de salida (**receptor**). La copia de datos se realiza por lotes según la programación especificada en la actividad. Para obtener información sobre cómo definir actividades en general en un nivel alto, por ejemplo, varias secciones JSON y las propiedades disponibles para todas las actividades, consulte el artículo [Descripción de canalizaciones y actividades](data-factory-create-pipelines.md).
...
- Si va a copiar datos de un **origen de datos local** en la **nube** o viceversa (por ejemplo: SQL Server local -> Blob de Azure), el movimiento de datos lo realiza en realidad **Data Management Gateway** en el entorno local sin participación alguna por parte del servicio de movimiento de datos.
...
Debe tratar el origen de datos como un origen de datos local (que está detrás de un firewall) incluso si usa **ExpressRoute** y **usar la puerta de enlace** para establecer la conectividad entre el servicio y el origen de datos.

Para obtener más información, consulte [Movimiento de datos entre orígenes locales y la nube con Data Management Gateway](data-factory-move-data-between-onprem-and-cloud.md).
