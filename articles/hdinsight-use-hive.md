<properties urlDisplayName="Use Hadoop Hive in HDInsight" pageTitle="Uso de Hive de Hadoop en HDInsight | Azure" metaKeywords="" description="Aprenda a usar Hive con HDInsight. Utilizará un archivo de registro como entrada en una tabla de HDInsight, además de usar HiveQL para consultar los datos y elaborar las estadísticas básicas." metaCanonical="" services="hdinsight" documentationCenter="" title="Use Hadoop Hive in HDInsight" authors="jgao" solutions="" manager="paulettm" editor="cgronlun" videoId="" scriptId="" />
