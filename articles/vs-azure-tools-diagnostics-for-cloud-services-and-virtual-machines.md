---
title: "Configuración de Diagnósticos en Azure Cloud Services y Azure Virtual Machines | Microsoft Docs"
...
### <a name="to-enable-diagnostics-in-visual-studio-before-deployment"></a>Habilitar los diagnósticos en Visual Studio antes de la implementación
...
### <a name="to-enable-diagnostics-in-azure-virtual-machines"></a>Para habilitar diagnósticos en máquinas virtuales de Azure
...
### <a name="to-configure-diagnostics-for-a-running-cloud-service"></a>Para configurar diagnósticos para un servicio en la nube en ejecución
