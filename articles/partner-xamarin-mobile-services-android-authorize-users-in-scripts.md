<properties urlDisplayName="Authorize Users in Scripts (Xamarin.Android)" pageTitle="Autorización a los usuarios en scripts (Xamarin.Android) - Servicios móviles de Azure" metaKeywords="autorización de usuarios de Azure, autorización de scripts de Xamarin.Android, autorizar servicios móviles" description="Obtenga información acerca de cómo autorizar a los usuarios con scripts en su aplicación de Servicios móviles de Azure para Xamarin.Android." metaCanonical="" disqusComments="1" umbracoNaviHide="1" title="Use scripts to authorize users in Mobile Services" authors="donnam" manager="dwrede" />
...
5. Repita los pasos 3 y 4 para reemplazar la operación de **lectura** existente por la siguiente función:
...
2. Haga clic en **Ejecutar** para iniciar la aplicación e iniciar sesión con el proveedor de identidades elegido. 
...
3. En la aplicación, escriba un texto en **Insert a TodoItem** (Insertar un TodoItem) y, a continuación, haga clic en **Save** (Guardar).
