<properties 
	pageTitle="Autorización a los usuarios en scripts (Xamarin.Android) - Servicios móviles de Azure" 
	description="Obtenga información acerca de cómo autorizar a los usuarios con scripts en su aplicación de Servicios móviles de Azure para Xamarin.Android." 
	authors="lindydonna" 
	manager="dwrede" 
	editor="" 
