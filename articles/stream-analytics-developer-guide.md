<properties 
	pageTitle="Guía para desarrolladores de Stream Analytics | Azure" 
	description="Obtenga información acerca de cómo desarrollar aplicaciones de análisis de secuencias de Azure" 
