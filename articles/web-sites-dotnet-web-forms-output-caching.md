...
-   [Configuración del proyecto ASP.NET para utilizar el servicio de caché de Azure.][]
-   [Modificación del archivo web.config][]
-   [Uso del almacenamiento en caché de resultados para devolver temporalmente versiones en caché de una página][]
...
Tras invocar al cmdlet de PowerShell, la creación de la memoria caché puede tardar unos minutos. Una vez creada la memoria caché, tiene el estado `Running`, está preparada para usarla con la configuración predeterminada y se puede ver y configurar en el [Portal de administración de Azure][].
...
1.  Primero, asegúrese de que ha [instalado el más reciente][] **SDK de Azure para .NET**.
