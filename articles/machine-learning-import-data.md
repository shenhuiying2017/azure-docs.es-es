<properties
	pageTitle="Importar sus datos de entrenamiento en Estudio de aprendizaje automático | Azure"
	description="Cómo importar los datos de entrenamiento a Estudio de aprendizaje automático de Azure desde varios orígenes de datos"
...
Estudio de aprendizaje automático está diseñado para trabajar con datos rectangulares o tabulares, como datos de texto delimitados o datos estructurados desde una base de datos, a pesar de que, en algunas circunstancias, es posible usar datos no rectangulares.

Se recomienda que los datos estén relativamente limpios. Es decir, querrá ocuparse de problemas como las cadenas sin comillas antes de cargar los datos en su experimento. Sin embargo, hay módulos disponibles en Estudio de aprendizaje automático que le permitirán realizar un poco de manipulación de los datos dentro de su experimento. Dependiendo de los algoritmos de aprendizaje automático que usará, es posible que deba decidir cómo controlar los problemas estructurales de los datos, como valores que faltan y datos esparcidos y existen módulos que pueden ayudar en esto. Observe la sección **Transformación de datos** de la paleta de módulos para los módulos que realizan estas funciones.

En cualquier momento del experimento puede ver o descargar los datos que genera un módulo con un clic con el botón secundario en el puerto de salida. Dependiendo del módulo, es posible que haya distintas opciones de descarga disponibles, o bien, podría tener la capacidad de ver los datos dentro del explorador web en Estudio de aprendizaje automático.
...
## Importación de un archivo de datos local

Puede cargar datos desde un disco duro local si hace lo siguiente:
...
Durante la carga, verá un mensaje que le indica que se está cargando el archivo. El tiempo de la carga dependerá del tamaño de los datos y de la velocidad de conexión con el servicio. Si sabe que el archivo demorará, puede hacer otras cosas en Estudio de aprendizaje automático mientras espera. Sin embargo, si cierra el explorador, la carga de los datos generará un error.
...
Puede importar datos desde tres orígenes de Azure:

- **Almacenamiento de blobs de Azure**: si usa el formato ARFF para almacenamiento, las columnas se asignan mediante el uso de los metadatos de encabezado. Si usa formatos TSV o CSV, las asignaciones se infieren mediante el muestreo de datos de columna. 
