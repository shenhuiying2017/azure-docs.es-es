...
##<a name="CreateProject"></a>Creación de un proyecto de servicios en la nube
...
##<a name="CustomizePHP"></a>Personalización del tiempo de ejecución de PHP integrado
...
1. Cree un proyecto de servicio de Azure y agregue un rol web de PHP, como se describe en las secciones [Creación de un proyecto de servicios en la nube](#CreateProject) e [Incorporación de roles web o de trabajo de PHP](#AddRole).
...
6. Publique la aplicación como se describe en la sección [Publicación de la aplicación](#Publish) más adelante.
...
1. Cree un proyecto de servicio de Azure y agregue un rol web de PHP, como se describe en las secciones [Creación de un proyecto de servicios en la nube](#CreateProject) e [Incorporación de roles web o de trabajo de PHP](#AddRole) anteriores.
...
##<a name="Emulators"></a>Ejecución de la aplicación en los emuladores de proceso y de almacenamiento
...
##<a name="Publish"></a>Publicación de la aplicación
