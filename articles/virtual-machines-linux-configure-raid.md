...
-   A continuación, cambie el iden**t**ificador y escriba la partición desde el identificador predeterminado "83" (Linux) hasta el identificador "fd" (Linux raid auto):
...
2.  **SLES y openSUSE**: habilite boot.md y cree mdadm.conf.
...
5.  Parámetros opcionales
  ...
  [conexión de un disco]: http://www.windowsazure.com/es-es/documentation/articles/storage-windows-attach-disk/#attachempty
