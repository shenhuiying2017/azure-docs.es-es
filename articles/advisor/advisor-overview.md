...
Para ver las recomendaciones de Advisor, debe tener acceso a al menos una suscripción. Su rol debe ser **propietario**, **colaborador** o **lector** para la suscripción. Los propietarios y los colaboradores de suscripciones pueden procesar o generar recomendaciones. Sin embargo, con un rol de **lector**, solo se pueden ver las recomendaciones de Advisor. 
...
Advisor proporciona recomendaciones para máquinas virtuales, conjuntos de disponibilidad, App Services, servidores SQL Server, bases de datos SQL Database y Redis Cache.
