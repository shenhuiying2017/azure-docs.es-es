...
## <a name="postpone-or-dismiss-advisor-recommendations"></a>Posponer o descartar recomendaciones de Advisor
...
4. Haga clic en **Postpone** (Posponer). 
