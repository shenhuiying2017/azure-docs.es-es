<properties
	pageTitle="Tutorial de Apache Storm: pruebe muestras de inicio de Storm | Microsoft Azure"
	description="Introducción al análisis de grandes cantidades de datos con Apache Storm mediante la ejecución de muestras de inicio de Storm en HDInsight. Aprenda a usar Apache Storm para procesar datos en tiempo real."
	services="hdinsight"
	documentationCenter=""
	authors="Blackmist"
	manager="paulettm"
...
# Tutorial de Apache Storm en HDInsight: introducción al análisis de grandes cantidades de datos con las muestras de inicio de Storm 
...
2. Haga clic en **NUEVO** en la esquina inferior izquierda, seleccione **SERVICIOS DE DATOS**, **ALMACENAMIENTO** y haga clic en **CREACIÓN RÁPIDA**.
	...
	![El Portal de Azure, donde puede usar la función de creación rápida para configurar una nueva cuenta de almacenamiento.](./media/hdinsight-storm-getting-started/HDI.StorageAccount.QuickCreate.png)
...
3. Haga clic en el icono de HDInsight en la segunda columna y seleccione **STORM**.
	...
	![Creación rápida](./media/hdinsight-storm-getting-started/quickcreate.png)
...
![El portal de Azure con el vínculo al panel Storm](./media/hdinsight-storm-getting-started/dashboard-link.png)
...
![Panel Storm con el formulario de envío de topología](./media/hdinsight-storm-getting-started/submit.png)
...
1. Seleccione **StormStarter - WordCount** en la lista desplegable **Archivo Jar**. Esto rellenará los campos **Nombre de la clase** y **Parámetros adicionales** con los parámetros de esta muestra.
	...
	![Panel Storm con WordCount seleccionado](./media/hdinsight-storm-getting-started/submit.png)
...
2. Haga clic en el botón **Enviar**. Tras unos instantes, el campo **Resultado** mostrará el comando usado para enviar el trabajo, así como los resultados del comando. El campo **Error** mostrará los errores que se producen en el envío de la topología.
	...
	![Botón Enviar y resultados](./media/hdinsight-storm-getting-started/submit-results.png)
...
1. Seleccione **IU de Storm** en la parte superior del panel de Storm. Se mostrará información de resumen del clúster y de las topologías en ejecución.
	...
	![interfaz de usuario de Storm que muestra el resumen de la topología](./media/hdinsight-storm-getting-started/stormui.png)
