...
## <a name="how-to-select-an-azure-virtual-network"></a>Selección de una red virtual de Azure
Las siguientes directrices le ayudan a seleccionar una red virtual para usarla con Azure AD Domain Services.

### <a name="type-of-azure-virtual-network"></a>Tipo de red virtual de Azure
...
* Implemente Azure AD Domain Services en una **subred dedicada independiente** dentro de la red virtual de Azure.
...
### <a name="scenarios-for-connecting-azure-networks"></a>Escenarios para la conexión de redes de Azure
...
#### <a name="use-the-managed-domain-in-more-than-one-azure-classic-virtual-network"></a>Utilice el dominio administrado en más de una red virtual de Azure clásico
Puede conectar otras redes virtuales de Azure clásico a la red virtual la que ha habilitado Azure AD Domain Services. Esta conexión VPN le permite usar el dominio administrado con sus cargas de trabajo implementadas en otras redes virtuales.

![Conectividad de red virtual clásica](./media/active-directory-domain-services-design-guide/classic-vnet-connectivity.png)

#### <a name="use-the-managed-domain-in-a-resource-manager-based-virtual-network"></a>Uso del dominio administrado en una red virtual basada en Resource Manager
