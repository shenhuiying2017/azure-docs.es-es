<properties
	pageTitle="Preguntas frecuentes de Active Directory Domain Services | Microsoft Azure"
...
El servicio está disponible a un precio reducido especial durante el periodo de versión preliminar pública. La facturación comenzará a practicarse a precio completo una vez que el servicio esté disponible con carácter general (GA). Consulte la [página de precios](https://azure.microsoft.com/pricing/details/active-directory-ds/) para obtener más información.
