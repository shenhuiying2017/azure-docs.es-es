...
1. [Cree una UO personalizada](active-directory-ds-admin-guide-create-ou.md). Puede delegar los permisos para administrar esta UO personalizada para los usuarios dentro del dominio administrado.
