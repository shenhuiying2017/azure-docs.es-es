...
# Cómo decidir si Active Directory Domain Services es adecuado para su caso de uso
...
## Comparación de Azure AD Domain Services con un dominio de AD de implementación personal en Azure
...
|---|:---:|:---:|
|[**Servicio administrado**](active-directory-ds-comparison.md#managed-service)|Sí|No|
|[**Implementaciones seguras**](active-directory-ds-comparison.md#secure-deployments)|Sí|El administrador debe proteger la implementación.|
|[**Servidor DNS**](active-directory-ds-comparison.md#dns-server)|Sí (servicio administrado)|Sí|
|[**Privilegios de administrador de dominio o empresa**](active-directory-ds-comparison.md#domain-or-enterprise-administrator-privileges)|No|Sí|
|[**Unión a un dominio**](active-directory-ds-comparison.md#domain-join)|Sí|Sí|
|[**Autenticación de dominio mediante NTLM y Kerberos**](active-directory-ds-comparison.md#domain-authentication-using-ntlm-and-kerberos)|Sí|Sí|
|[**Estructura de unidad organizativa personalizada**](active-directory-ds-comparison.md#custom-ou-structure)|Sí|Sí|
|[**Extensiones de esquema**](active-directory-ds-comparison.md#schema-extensions)|No|Sí|
|[**Confianzas de bosques o dominios de AD**](active-directory-ds-comparison.md#ad-domain-or-forest-trusts)|No|Sí|
|[**Lectura LDAP**](active-directory-ds-comparison.md#ldap-read)|Sí|Sí|
|[**LDAP seguro (LDAPS)**](active-directory-ds-comparison.md#secure-ldap)|Sí|Sí|
|[**Escritura LDAP**](active-directory-ds-comparison.md#ldap-write)|No|Sí|
|[**Directiva de grupo**](active-directory-ds-comparison.md#group-policy)|Simple|Completo|
|[**Implementaciones dispersas geográficamente**](active-directory-ds-comparison.md#geo-dispersed-deployments)|No|Sí|
...
## Opciones de implementación de AD personal
