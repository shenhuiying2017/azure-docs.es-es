...
> [AZURE.NOTE]Asegúrese de que la red virtual de Azure que cree o elija usar con los Servicios de dominio de Azure AD pertenezca a una región de Azure que sea compatible con dichos servicios. Para obtener una lista de regiones de Azure donde están disponibles los Servicios de dominio de Azure AD, consulte la página de [regiones](active-directory-ds-regions.md).
