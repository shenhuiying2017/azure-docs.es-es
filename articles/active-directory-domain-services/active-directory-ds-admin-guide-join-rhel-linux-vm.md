...
6. Después, haga clic en **Configuración opcional**. En el panel **Configuración opcional**, haga clic en el botón **Red**.
...
7. Con esta acción se abre el panel **Red**. En el panel **Red**, haga clic en **Red virtual** para seleccionar la red virtual en la que se debe implementar la máquina virtual Linux. Se debe abrir el panel **Red virtual** . En el panel **Red virtual**, seleccione la opción **Usar una red virtual existente**. A continuación, seleccione la red virtual en la que Servicios de dominio de Azure AD estará disponible. En este ejemplo, se ha elegido la red virtual "MyPreviewVNet".
