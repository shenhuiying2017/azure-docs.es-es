---
title: 'Versión preliminar de Servicios de dominio de Azure Active Directory: administración de DNS en dominios administrados | Microsoft Docs'
