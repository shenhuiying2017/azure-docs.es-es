<properties title="Introduction to Azure Stream Analytics" pageTitle="Introducción a Stream Analytics | Azure" description="Understand Azure Stream Analytics" metaKeywords="" services="stream analytics" solutions="" documentationCenter="" authors="jgao" videoId="" scriptId="" manager="paulettm" editor="cgronlun"/>
