<properties 
	pageTitle="Configurar aplicaciones web en el servicio de aplicaciones de Azure" 
...
# Configurar aplicaciones web en el servicio de aplicaciones de Azure #
...
**Web Sockets**. Establézcalo en **ACTIVADO** para habilitar el protocolo WebSocket; por ejemplo, si la aplicación web usa [ASP.NET SignalR](http://www.asp.net/signalr) o [socket.io](web-sites-nodejs-chat-app-socketio.md).
...
- En las aplicaciones .NET, estas configuraciones se insertarán en la sección  `AppSettings` de la configuración de .NET en tiempo de ejecución y reemplazará la configuración existente. 
...
En las aplicaciones .NET, estas cadenas de conexión se insertarán en la sección  `connectionStrings` de la configuración de .NET en tiempo de ejecución y reemplazarán las entradas existentes en las que la clave equivalga al nombre de la base de datos vinculada. 
...
- **Ruta de acceso del procesador de scripts**. La ruta absoluta del procesador de script. El procesador de script procesará las solicitudes a archivos que coincidan con esta extensión de archivo. Utilice la ruta de acceso  `D:\home\site\wwwroot` para hacer referencia al directorio raíz de la aplicación.
...
### SSL 
 ...
 En el modo básico o estándar, puede cargar certificados SSL (Secure Socket Layer, Capa de sockets seguros) para un dominio personalizado. Para obtener más información, consulte [Habilitar HTTPS para una aplicación web](web-sites-configure-ssl-certificate.md). 
...
- Ranuras de implementación. Consulte [Implementación en entornos de ensayo para aplicaciones web en el servicio de aplicaciones de Azure](web-sites-staged-publishing.md)
...
Para obtener más información, consulte [Cómo: Supervisar el estado de los extremos web](http://go.microsoft.com/fwLink/?LinkID=279906&clcid=0x409).
...
- [Escalado de una aplicación web en el servicio de aplicaciones de Azure](web-sites-scale.md)
- [Conceptos básicos de supervisión de aplicaciones web en el servicio de aplicaciones de Azure](web-sites-monitor.md)
