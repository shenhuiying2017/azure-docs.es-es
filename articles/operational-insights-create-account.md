...
##Obtener una cuenta de organización o de Microsoft###
...
Si desea conseguir una cuenta Microsoft (anteriormente denominada "Windows Live ID"), regístrese en el [inicio de sesión para cuentas Microsoft](http://go.microsoft.com/fwlink/?LinkId=396868). Se concede acceso automático a Visión operativa con una cuenta de Microsoft.


##Iniciar sesión en Visión operativa###

1. Vaya a [Visión operativa de Microsoft Azure](preview.opinsights.azure.com) y elija Iniciar sesión en la parte superior de la página.
