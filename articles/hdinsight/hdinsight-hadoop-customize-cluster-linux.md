...
> [AZURE.NOTE]La información de este artículo es específica de los clústeres de HDInsight basados en Linux. Para obtener una versión de este artículo que es específica de los clústeres basados en Windows, consulte [Personalizar los clústeres de HDInsight mediante la acción de script (Windows)](hdinsight-hadoop-customize-cluster-linux.md)
...
Los componentes personalizados reciben soporte técnico comercialmente razonable para ayudarle a solucionar el problema. Esto podría resolver el problema o pedirle que forme parte de los canales disponibles para las tecnologías de código abierto donde se encuentra la más amplia experiencia para esa tecnología. Por ejemplo, existen muchos sitios de comunidad que se pueden utilizar, como:

* [Foro de MSDN para HDInsight (en inglés)](https://social.msdn.microsoft.com/Forums/azure/home?forum=hdinsight)

* [Desbordamiento de la pila](https://stackoverflow.com)

Además, los proyectos de Apache tienen sitios del proyecto en [Apache.org](https://apache.org); por ejemplo, [Hadoop](http://hadoop.apache.org/) y [Spark](http://spark.apache.org/).
...
3. Busque las entradas que tienen __run\_customscriptaction__ en la columna __Operations__ (operaciones). Estas se crean al ejecutarse las acciones de script.
