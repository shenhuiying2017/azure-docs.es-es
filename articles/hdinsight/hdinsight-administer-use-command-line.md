...
Si no lo ha hecho ya, use el documento [Instalar y configurar la CLI Azure](../xplat-cli-install.md) para instalar y configurar la CLI de Azure.
...
##<a name="scaling"></a>Escalado de un clúster
