...
En este tema se explica cómo acceder a los registros de aplicaciones de YARN (del inglés Yet Another Resource Negotiator) que han finalizado en un clúster Hadoop en Azure HDInsight.
