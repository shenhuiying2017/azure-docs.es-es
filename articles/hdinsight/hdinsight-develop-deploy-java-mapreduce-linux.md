...
2. En la sesión SSH, use el siguiente comando para ejecutar la aplicación MapReduce:
	...
	De este modo, se usará la aplicación WordCount MapReduce para contar las palabras del archivo davinci.txt y almacenar los resultados en \_\_wasbs:///example/data/wordcountout__. Tanto el archivo de entrada como el de salida se almacenan en el almacenamiento predeterminado del clúster.
