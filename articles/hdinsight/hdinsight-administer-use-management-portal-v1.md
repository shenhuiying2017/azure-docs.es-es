---
title: Administración de clústeres de Hadoop en HDInsight mediante el portal de Azure clásico | Microsoft Docs
...
> [!WARNING]
> Las versiones más recientes de Azure PowerShell o la CLI de Azure usan de forma predeterminada Azure Resource Manager. Los clústeres de HDInsight creados con este modo no se pueden administrar mediante el Portal de Azure clásico.
> 
> 
...
> 
> Una vez RDP está habilitado para un clúster, debe actualizar la página antes de poder conectarse al clúster.
> 
> 
...
5. Haga clic en **CONECTAR** en la parte inferior de la página.
6. Haga clic en **Abrir**.
7. Escriba las credenciales y, a continuación, haga clic en **Aceptar**. Use el nombre de usuario y la contraseña que configuró al crear el clúster.
8. Haga clic en **Sí**.
9. En el escritorio, haga doble clic en **Línea de comandos de Hadoop**.
