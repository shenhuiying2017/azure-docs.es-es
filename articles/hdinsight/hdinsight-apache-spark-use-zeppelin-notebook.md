---
title: Uso de cuadernos de Zeppelin con un clúster Spark en HDInsight Linux | Microsoft Docs
...
6. En la parte superior del cuadro de diálogo FoxyProxy, cambie **Seleccionar modo** a **Uso de servidores proxy según sus patrones y prioridades predefinidos** y, a continuación, haga clic en **Cerrar**.
