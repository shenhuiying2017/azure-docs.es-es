...
> [!NOTE]
> HBase (versión 0.98.0) solo está disponible para usarlo con clústeres de HDInsight 3.1 en HDInsight (basado en Apache Hadoop y YARN 2.4.0). Para obtener información de la versión, consulte [Novedades en las versiones de clústeres de Hadoop proporcionadas por HDInsight][hdinsight-versions].
> 
> 
...
2. Haga clic en **Nuevo** en la parte inferior izquierda y, a continuación, en **Servicios de datos**, **HDInsight**, **HBase**.
   ...
   > [!NOTE]
   > También puede usar la opción **Creación personalizada**.
   > 
   > 
...
> [!NOTE]
> Después de que se elimine un clúster de HBase, puede crear otro clúster de HBase mediante el mismo contenedor de blobs predeterminado. El nuevo clúster seleccionará las tablas de HBase que creó en el clúster original.
> 
> 
