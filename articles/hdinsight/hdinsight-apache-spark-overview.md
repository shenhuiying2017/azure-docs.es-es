...
> [!NOTE]
> Para una lista de los problemas conocidos y las limitaciones con la versión actual, consulte [Problemas conocidos de Apache Spark en Azure HDInsight](hdinsight-apache-spark-known-issues.md).
> 
> 
