...
![Spark: un marco unificado](./media/hdinsight-apache-spark-overview/hdinsight-spark-overview.png)
...
![Comparación del tradicional MapReduce y Spark](./media/hdinsight-apache-spark-overview/mapreduce-vs-spark.png)
...
![Arquitectura de clúster de Spark](./media/hdinsight-apache-spark-overview/spark-architecture.png)
