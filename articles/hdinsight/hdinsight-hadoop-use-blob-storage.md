---
title: Consultar datos desde el almacenamiento de blobs compatible con HDFS | Microsoft Docs
...
> [!NOTE]
> En versiones de HDInsight anteriores a la 3.0, `asv://` se utilizaba en lugar de `wasb://`. `asv://` no debe usarse con clústeres de HDInsight 3.0 o superiores, ya que producirán un error.
> 
> 
