...
* Usar Power BI
    ...
    Vea [Visualize Hive data with Microsoft Power BI in Azure HDInsight](./hdinsight-connect-hive-power-bi.md) (Visualización de datos de Hive con Microsoft Power BI en Azure HDInsight).
...
* Usar Visual Studio
    ...
    Vea [Conectarse a Azure HDInsight y ejecutar consultas de Hive con Herramientas de Data Lake para Visual Studio](hdinsight-hadoop-visual-studio-tools-get-started.md#run-a-hive-query).
...
* Ejecutar Hive mediante la vista de Hive de Ambari.
    ...
    Vea [Use Hive View with Hadoop in Azure HDInsight](hdinsight-hadoop-use-hive-ambari-view.md) (Uso de Hive View con Hadoop en Azure HDInsight).
* Ejecutar Hive mediante Beeline.
  
    Vea [Uso de Hive con Hadoop en HDInsight con Beeline](hdinsight-hadoop-use-hive-beeline.md).
...
* Ejecute Hive mediante Hive ODBC
    ...
    Vea [Conexión de Excel a Hadoop en Azure HDInsight con el controlador ODBC de Microsoft Hive](hdinsight-connect-excel-hive-odbc-driver.md).
...
* Aprenda a [visualizar datos de Hive con Microsoft Power BI en Azure HDInsight](./hdinsight-connect-hive-power-bi.md).
* Aprenda a [usar Zeppelin para ejecutar consultas de Hive en Azure HDInsight](./hdinsight-connect-hive-zeppelin.md).
* Aprenda a [ejecutar consultas de Hive con Herramientas de Data Lake para Visual Studio](./hdinsight-hadoop-visual-studio-tools-get-started.md#run-a-hive-query).
* Aprenda a [usar Visual Studio Code para Hive, LLAP o pySpark](hdinsight-for-vscode.md).
