...
---
# <a name="use-azure-toolkit-for-intellij-to-debug-applications-remotely-on-hdinsight-spark"></a>Kit de herramientas de Azure para IntelliJ: depuración de aplicaciones de forma remota en Spark de HDInsight
