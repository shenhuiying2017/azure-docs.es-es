...
> [!NOTE]
> En los pasos que aparecen en este artículo, se da por supuesto que está usando un sistema basado en Windows con el cliente SSH PuTTY. Si usa un sistema Linux, Unix, OS X o Windows que proporcione el comando `ssh`, consulte [Utilización de SSH con Hadoop en HDInsight basado en Linux desde Linux, Unix u OS X](hdinsight-hadoop-linux-use-ssh-unix.md).
...
Históricamente, Windows no ha proporcionado ningún cliente SSH. PuTTY es un cliente SSH gráfico que se puede instalar en Windows.
...
## <a name="create-a-linux-based-hdinsight-cluster"></a>Creación de un clúster de HDInsight basado en Linux
...
## <a name="connect-to-a-linux-based-hdinsight-cluster"></a>Conexión a un clúster de HDInsight basado en Linux
