...
-	Clúster Apache Storm en HDInsight: vea [Introducción a Apache Storm en HDInsight](hdinsight-apache-storm-tutorial-getting-started.md) para conocer los pasos para crear un clúster.
