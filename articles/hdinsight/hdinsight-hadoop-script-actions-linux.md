...
La acción de script puede usarse al aprovisionar un clúster mediante el __Portal de vista previa de Azure__, __Azure PowerShell__ o __SDK .NET de HDInsight__.
