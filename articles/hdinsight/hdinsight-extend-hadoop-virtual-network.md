...
3. Cuando se hayan creado las reglas, utilice lo siguiente para aplicar el nuevo grupo de seguridad de red a una subred. Reemplace **RESOURCEGROUPNAME** por el nombre del grupo de recursos que contiene la red virtual de Azure. Reemplace **VNETNAME** y **SUBNETNAME** por el nombre de la red virtual de Azure y la subred que usará al instalar HDInsight.
