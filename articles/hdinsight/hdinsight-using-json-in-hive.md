...
* GET\_JSON_OBJECT() devuelve la representación de cadena de una matriz. Para convertir esto en una matriz de Hive, tendrá que utilizar expresiones regulares para reemplazar los corchetes '[' y ']' y, a continuación, llamar también a split para obtener la matriz.
...
Para buscar en qué materias un estudiante concreto tiene más de 80 puntos SELECT  
