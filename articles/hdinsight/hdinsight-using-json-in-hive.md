...
En este tutorial, se utiliza la consola de Hive. Para instrucciones sobre cómo abrir la consola de Hive, consulte [Uso de Hive con Hadoop en HDInsight con el escritorio remoto](hdinsight-hadoop-use-hive-remote-desktop.md).
