...
Mediante [Azure Portal][azure-portal], puede administrar clústeres basados en Linux en Azure HDInsight. Use el selector de pestañas para obtener información sobre cómo crear clústeres de Hadoop en HDInsight con otras herramientas. 
...
3. En Azure Portal, seleccione el clúster de HDInsight y luego seleccione **All settings** (Toda la configuración). En la hoja **Configuración**, seleccione **Acciones de script**.
...
5. En la hoja **Configuración**, haga clic en **Claves de Azure Storage**.
