---
title: Aprenda a usar las herramientas de Hadoop para Visual Studio en HDInsight | Microsoft Docs
...
* Una estación de trabajo con el siguiente software:
  ...
  * Visual Studio (una de las siguientes versiones):
    ...
    * Visual Studio 2015 (Community/Enterprise)
    ...
    > [!NOTE]
    > Actualmente, las herramientas de HDInsight para Visual Studio solo se incluyen en la versión en inglés.
    > 
    > 
...
![Herramientas de HDInsight para operaciones de blob mediante Explorador de servidores de Visual Studio](./media/hdinsight-hadoop-visual-studio-tools-get-started/hdinsight.visual.studio.tools.blob.operations.png)
...
2. Haga clic con el botón derecho en **hivesampletable** y, a continuación, haga clic en **Ver las primeras 100 filas** para mostrar las filas. Esta operación equivale a ejecutar la siguiente consulta de Hive usando el controlador ODBC de Hive:
