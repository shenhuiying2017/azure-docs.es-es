...
* **SQL Server**: los pasos descritos en este documento también pueden utilizarse, con algunas modificaciones, con SQL Server. Para obtener más información sobre los requisitos específicos para usar este artículo con SQL Server, consulte la sección [Uso de SQL Server](#using-sql-server).
