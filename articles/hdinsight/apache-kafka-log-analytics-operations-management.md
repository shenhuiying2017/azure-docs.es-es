...
---
# <a name="analyze-logs-for-apache-kafka-preview-on-hdinsight"></a>Análisis de registros para Apache Kafka (versión preliminar) en HDInsight
...
1. Cree un área de trabajo de Log Analytics. Para obtener más información, consulte el documento [Introducción a un área de trabajo de Log Analytics](../log-analytics/log-analytics-get-started.md).

2. Cree Kafka en un clúster de HDInsight. Para obtener más información, consulte el documento [Introducción a Apache Kafka (versión preliminar) en HDInsight](hdinsight-apache-kafka-get-started.md).
 ...
 * [Mirror Kafka between HDInsight clusters](hdinsight-apache-kafka-mirroring.md) (Reflejar Kafka entre clústeres de HDInsight)
 * [Increase the scalability of Kafka on HDInsight](hdinsight-apache-kafka-scalability.md) (Aumentar la escalabilidad de Kafka en HDInsight)
