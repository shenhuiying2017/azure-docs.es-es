---
title: Información sobre Hadoop en HDInsight mediante la Galería de ejemplos | Microsoft Docs
...
5. Haga clic en **Galería de introducción** en la parte superior de la página.
6. Haga clic en una de las muestras. Cada muestra proporciona los pasos detallados para ejecutarla. La imagen siguiente presenta la muestra del análisis de tendencias de Twitter:
