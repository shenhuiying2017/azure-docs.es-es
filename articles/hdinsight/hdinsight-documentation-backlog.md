...
Automatización | Actualización del artículo sobre [creación de un clúster Spark](hdinsight-apache-spark-jupyter-spark-sql.md) para utilizar una plantilla ARM | 1 | [Completado](hdinsight-apache-spark-jupyter-spark-sql.md#create-spark-cluster) | [@mumian](https://github.com/mumian) |- 
