...
Los nombres de archivo de la tabla son **u<NombreDeClúster>DDMesAAAAenHHMMSSsss<NombreDeTabla>**.
...
2. En el menú de **Power Query**, haga clic en **Desde Azure** y, luego, en **From Microsoft Azure Table storage** (Desde Microsoft Azure Table Storage).
