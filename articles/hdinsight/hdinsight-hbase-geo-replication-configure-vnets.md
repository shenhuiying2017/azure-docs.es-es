---
title: "Configuración de una conexión VPN entre dos redes virtuales | Microsoft Docs"
...
---
# <a name="configure-a-vpn-connection-between-two-azure-virtual-networks"></a>Configuración de una conexión VPN entre dos redes virtuales de Azure
...
## <a name="create-two-azure-vnets"></a>Creación de dos redes virtuales de Azure
...
## <a name="configure-a-vpn-connection-between-the-two-vnets"></a>Configuración de una conexión VPN entre las redes dos redes virtuales
### <a name="create-local-networks"></a>Creación de redes locales
...
1. En el Portal de Azure clásico, haga clic en **NUEVO**, **NETWORK SERVICES**, **VIRTUAL NETWORK** y **AGREGAR A RED LOCAL**.
2. Especifique:
...
### <a name="create-vpn-gateways"></a>Creación de puertas de enlace VPN
...
2. Haga clic en **CREAR PUERTA DE ENLACE** en la parte inferior de la página y, a continuación, haga clic en **Enrutamiento dinámico**.
3. Haga clic en **Sí** para continuar. Observe que el gráfico de la puerta de enlace de la página cambia a amarillo y muestra el mensaje Creando puerta de enlace. La creación de la puerta de enlace suele tardar unos 15 minutos.
...
4. Cree una copia de **DIRECCIÓN IP DE LA PUERTA DE ENLACE**. La utilizará para configurar la dirección IP de la puerta de enlace VPN para Contoso-VNet-EU en la sección siguiente.
...
### <a name="set-the-vpn-device-ip-addresses-for-local-networks"></a>Establecimiento de direcciones IP del dispositivo VPN para redes locales
...
3. Haga clic en **Contoso-LNet-EU** y luego en **EDITAR** en la parte inferior.
...
### <a name="set-vnet-gateway-keys"></a>Establecimiento de claves de puerta de enlace de red virtual
...
## <a name="check-the-vpn-connection"></a>Comprobación de la conexión VPN
