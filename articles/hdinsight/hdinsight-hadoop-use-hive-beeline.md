<properties
   ...
   description="Obtenga información acerca de cómo usar SSH para conectarse a un clúster de Hadoop en HDInsight y, luego, enviar interactivamente consultas de Hive mediante la herramienta de Beeline."
   services="hdinsight"
   documentationCenter=""
   authors="Blackmist"
   manager="paulettm"
