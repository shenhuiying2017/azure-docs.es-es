...
##<a name="<a-id="ssh"></a>connect-with-ssh"></a><a id="ssh"></a>Conexión con SSH
...
##<a name="<a-id="beeline"></a>use-the-beeline-command"></a><a id="beeline"></a>Uso del comando de Beeline
...
##<a name="<a-id="file"></a>run-a-hiveql-file"></a><a id="file"></a>Ejecución de un archivo de HiveQL
...
3. Para guardar el archivo, use __Ctrl__+___X__, escriba __Y__ y, finalmente, presione __Entrar__.
...
Si tiene Beeline instalado en un cliente fuera de su clúster, puede conectar con el siguiente comando. Reemplace __CLUSTERNAME__ por el nombre del clúster de HDInsight. Reemplace __PASSWORD__ por la contraseña de la cuenta del administrador (inicio de sesión de HTTP).
...
##<a name="<a-id="summary"></a><a-id="nextsteps"></a>next-steps"></a><a id="summary"></a><a id="nextsteps"></a>Pasos siguientes
