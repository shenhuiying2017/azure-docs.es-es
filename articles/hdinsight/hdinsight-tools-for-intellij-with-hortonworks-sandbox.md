...
Aprenda a usar las herramientas de HDInsight para IntelliJ para desarrollar aplicaciones de Apache Scala y después probar las aplicaciones en [Hortonworks Sandbox](http://hortonworks.com/products/sandbox/) cuando se ejecuta en la estación de trabajo. 

[IntelliJ IDEA](https://www.jetbrains.com/idea/) es un entorno de desarrollo integrado (IDE) de Java para el desarrollo de software informático. Después de desarrollar y probar las aplicaciones en Hortonworks Sandbox, puede moverlas a [Azure HDInsight](hdinsight-hadoop-introduction.md).
...
3. En el cuadro de diálogo **Nuevo proyecto**, siga estos pasos:
    ...
    a. En el cuadro **Nombre del proyecto**, escriba un nombre de proyecto.

    b. En el cuadro **Ubicación del proyecto**, escriba una ubicación del proyecto.

    c. Junto a la lista desplegable **SDK de proyecto**, seleccione **Nuevo**, seleccione **JDK** y, después, especifique la carpeta de Java JDK versión 1.7 o posterior. Seleccione **Java 1.8**, para el clúster Spark 2.x, o bien **Java 1.7** para el clúster Spark 1.x. La ubicación predeterminada es C:\Program Files\Java\jdk1.8.x_xxx.
...
8. En el cuadro **Name** (Nombre), introduzca un nombre, en el cuadro **Kind** (Variante), seleccione **Object** (Objeto) y, después, seleccione **Aceptar**.

    ![Creación de una ventana de creación de la nueva clase de Scala](./media/hdinsight-tools-for-intellij-with-hortonworks-sandbox/intellij-create-new-scala-class.png)
...
10. En el menú **Build** (Compilar), seleccione **Build project** (Compilar proyecto). Asegúrese de que la compilación ha finalizado correctamente.
...
4. En la ventana **Link A New Emulator** (Vincular un nuevo emulador), escriba la contraseña que ha configurado para la cuenta raíz de Hortonworks Sandbox, escriba valores similares a los de la captura de pantalla siguiente y, después, seleccione **Aceptar**. 

   ![Ventana "Vincular a nuevo emulador"](./media/hdinsight-tools-for-intellij-with-hortonworks-sandbox/intellij-link-an-emulator.png)
...
Para enviar un proyecto a un emulador, haga lo siguiente:
...
2. Haga lo siguiente:
    ...
    a. En la lista desplegable **Spark cluster (Linux only)** (Clúster de Spark [solo Linux]), seleccione su instancia local de Hortonworks Sandbox.

    b. En el cuadro **Main class name** (Nombre de la clase principal), elija o escriba el nombre de la clase principal. En este tutorial, el nombre es **GroupByTest**.
...
- Vea un [vídeo de introducción sobre las Herramientas de HDInsight para IntelliJ para el desarrollo con Spark](https://www.youtube.com/watch?v=YTZzYVgut6c).

- Para aprender a depurar aplicaciones de Spark usando el kit de herramientas de forma remota en HDInsight a través de SSH, consulte [Depuración de aplicaciones de Spark de forma remota en un clúster de HDInsight con el kit de herramientas de Azure para IntelliJ mediante SSH](hdinsight-apache-spark-intellij-tool-debug-remotely-through-ssh.md).

- Para aprender a depurar aplicaciones de Spark usando el kit de herramientas de forma remota en HDInsight a través de VPN, consulte [Uso del kit de herramientas de Azure para IntelliJ para depurar aplicaciones de forma remota en HDInsight Spark mediante VPN](hdinsight-apache-spark-intellij-tool-plugin-debug-jobs-remotely.md).
...
- Vea un vídeo sobre [cómo usar las Herramientas de HDInsight para Eclipse para crear aplicaciones de Spark](https://mix.office.com/watch/1rau2mopb6fha).
