...
- Para ver un ejemplo de cómo implementar los recursos mediante la biblioteca de cliente de .NET, consulte [Implementación de recursos de Azure mediante bibliotecas de .NET y una plantilla](../virtual-machines/arm-template-deployment.md).
