...
## <a name="running-pig-jobs-on-azure-hdinsight-using-on-premises-sql-server-integration-services"></a>Ejecución de trabajos de Pig en Azure HDInsight mediante SQL Server Integration Services local
