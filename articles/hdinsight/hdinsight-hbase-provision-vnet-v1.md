---
title: Aprovisionamiento de clústeres de HBase en una red virtual | Microsoft Docs
...
> [!IMPORTANT]
> En los pasos de este documento se usa el Portal de Azure clásico. Microsoft no recomienda usar el portal clásico al crear nuevos servicios. Para ver una explicación de las ventajas que reporta el Portal de Azure, consulte [Portal de Microsoft Azure](https://azure.microsoft.com/features/azure-portal/).
> 
> Este documento también incluye información acerca de cómo usar Azure PowerShell. Los fragmentos de código proporcionados se basan en comandos que usan Azure Service Management (ASM) para trabajar con HDInsight y están **en desuso**. Estos comandos se eliminarán el 1 de enero de 2017.
> 
...
> [!NOTE]
> Para obtener más información acerca del aprovisionamiento de un nuevo clúster de HBase usando Azure PowerShell, consulte [Aprovisionamiento de un clúster de HBase usando Azure PowerShell](#powershell).
> 
> 
...
1. En la página **Configurar clúster**, escriba o seleccione los valores siguientes:
...
2. Escriba el nombre de usuario y la contraseña que se va a usar para este clúster y, a continuación, haga clic con el botón derecho.
...
3. En la página **Cuenta de almacenamiento**, proporcione los siguientes valores:
...
4. En la página **Acciones de scripts**, seleccione la marca de verificación en la esquina inferior derecha. No haga clic en el botón para **agregar acción de script**, ya que este tutorial no requiere una configuración de clúster personalizada.
   
    ![Configurar la acción de script para personalizar un clúster de HBase de HDInsight][img-provision-cluster-page5]
   
   > [!NOTE]
   > Esta página puede utilizarse para personalizar el clúster durante la configuración. Para obtener más información, consulte [Personalización de clústeres de HDInsight mediante la acción de script](hdinsight-hadoop-customize-cluster.md).
   > 
   > 
