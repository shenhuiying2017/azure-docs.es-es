...
### Visual Studio Tools para HDInsight
...
1. Ejecute el explorador de almacenamiento de Azure. Si es la primera vez que ejecuta el Explorador de almacenamiento, se le pedirá el ***Nombre de la cuenta de almacenamiento*\_ y la __Clave de cuenta de almacenamiento**. Si ya lo ejecutó antes, use el botón *_Agregar\*\_ para agregar un nombre y una clave de cuenta de almacenamiento nuevos.
