...
> [!NOTE]
> Otra opción para definir los flujos de trabajo con HDInsight es Factoría de datos de Azure. Para más información sobre Azure Data Factory, consulte el artículo sobre el [uso de Pig y Hive con Data Factory][azure-data-factory-pig-hive].
> 
> 
...
> [!NOTE]
> Para ver las versiones de Oozie compatibles con los clústeres de HDInsight, consulte el artículo sobre las [novedades en las versiones de clústeres Hadoop proporcionadas por HDInsight][hdinsight-versions].
> 
> 
...
2. Cuando se abra el editor nano, introduzca lo siguiente como contenido del archivo:
   ...
   * **RunSqoopExport**: exporta los datos creados a partir del script de Hive a Base de datos SQL con Sqoop. Solo se ejecutarán si la acción **RunHiveScript** es correcta.
     ...
     > [!NOTE]
     > Para más información sobre el flujo de trabajo de Oozie y el uso de acciones de flujo de trabajo, consulte la documentación de [Apache Oozie 4.0][apache-oozie-400] (para la versión de HDInsight 3.0) o la [documentación de Apache Oozie 3.3.2][apache-oozie-332] (para la versión de HDInsight 2.1).
     > 
     > 
...
4. Use el comando siguiente para copiar el archivo **workflow.xml** en **wasbs:///tutorials/useoozie/workflow.xml**:
   
        hdfs dfs -copyFromLocal workflow.xml /tutorials/useoozie/workflow.xml

## <a name="create-the-database"></a>Creación de la base de datos
Siga los pasos del tutorial [Creación de una base de datos SQL](../sql-database/sql-database-get-started.md) para crear una nueva base de datos. Al crear la base de datos, utilice **oozietest** como nombre de la base de datos. También tome nota del nombre que utiliza para el servidor de base de datos, ya que lo necesitará en la sección siguiente.
...
4. Cuando se abra el editor nano, use lo siguiente como contenido del archivo:
   ...
   * Reemplace todas las instancias de **wasbs://mycontainer@mystorageaccount.blob.core.windows.net** por el valor que recibió anteriormente.
     ...
     > [!WARNING]
     > Debe utilizar la ruta de acceso completa de WASB, con la cuenta de almacenamiento y de contenedor como parte de la ruta de acceso. Con el formato corto (wasbs:///), la acción RunHiveScript generará un error cuando se inicie el trabajo.
     > 
     > 
