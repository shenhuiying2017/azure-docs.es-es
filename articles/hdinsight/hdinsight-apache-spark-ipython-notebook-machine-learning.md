...
---
# <a name="build-machine-learning-applications-to-run-on-apache-spark-clusters-on-hdinsight"></a>Creación de aplicaciones de Machine Learning para ejecutarse en clústeres de Apache Spark en HDInsight
