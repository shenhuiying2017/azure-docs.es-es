...
# <a name="hdinsight-article-index-for-the-azure-classic-portal"></a>HDInsight article index for the Azure Classic Portal
...
## <a name="hadoop:-batch-query"></a>Hadoop: Batch query
...
## <a name="hadoop-&-excel"></a>Hadoop & Excel
...
## <a name="hadoop:-advanced-techniques"></a>Hadoop: Advanced techniques
...
## <a name="hbase:-nosql-database"></a>HBase: NoSQL database
...
## <a name="apache-storm:-stream-query"></a>Apache Storm: Stream query
...
## <a name="big-data-solutions"></a>Big data solutions
...
## <a name="machine-learning-in-hdinsight"></a>Machine learning in HDInsight
