---
title: Instalación de un cuaderno de Jupyter Notebook en el equipo y conexión a un clúster de HDInsight Spark | Microsoft Docs
...
## <a name="<a-name="seealso"></a>see-also"></a><a name="seealso"></a>Otras referencias
