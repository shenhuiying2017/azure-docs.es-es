...
---
# <a name="use-azure-data-lake-store-with-apache-storm-with-hdinsight"></a>Uso del Almacén de Azure Data Lake con Apache Storm con HDInsight
...
* **ADLStoreBolt**: escribe datos en Azure Data Lake Store mediante el componente [HdfsBolt](http://storm.apache.org/javadoc/apidocs/org/apache/storm/hdfs/bolt/HdfsBolt.html).
...
* **En [Azure Portal](https://portal.azure.com): en el portal, seleccione la instancia de Azure Data Lake Store que usó con HDInsight.
