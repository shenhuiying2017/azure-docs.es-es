---
title: "Configuración de directivas de Hive en HDInsight unido a un dominio | Microsoft Docs"
...
---
# <a name="configure-hive-policies-in-domainjoined-hdinsight-preview"></a>Configuración de directivas de Hive en HDInsight unido a un dominio (versión preliminar)
...
Las instrucciones se pueden encontrar en el artículo sobre la [creación de origen de datos ODBC en Hive](hdinsight-connect-excel-hive-odbc-driver.md).  
    ...
    User Name|Escriba hiveuser1@contoso158.onmicrosoft.com.. Si difiere, actualice el nombre de dominio.
