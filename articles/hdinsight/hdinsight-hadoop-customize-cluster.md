...
**Instalar R** | https://hdiconfigactions.blob.core.windows.net/rconfigactionv02/r-installer-v02.ps1. Vea [Instalación y uso de R en clústeres de HDInsight][hdinsight-install-r].
...
2. En Configuración opcional, para la hoja **Acciones de script**, haga clic en **agregar acción de script** para proporcionar detalles sobre la acción de script, tal como se muestra a continuación:
...
Vea [Desarrollo de scripts de acción de script con HDInsight][hdinsight-write-script].
