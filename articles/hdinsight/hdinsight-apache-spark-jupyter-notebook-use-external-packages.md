---
title: Uso de paquetes externos con cuadernos de Jupyter Notebook en los clústeres de Apache Spark en HDInsight | Microsoft Docs
...
---
# Uso de paquetes externos con cuadernos de Jupyter en clústeres de Apache Spark en HDInsight Linux
...
2. En la hoja del clúster Spark, haga clic en **Vínculos rápidos** y, luego, en la hoja **Panel de clúster**, haga clic en **Jupyter Notebook**. Cuando se le pida, escriba las credenciales del clúster.
   ...
   > 
   > 
3. Cree un nuevo notebook. Haga clic en **New** (Nuevo) y luego en **Spark**.
...
1. En el fragmento de código anterior, `packages` espera una lista de coordenadas de Maven en Maven Central Repository. En este fragmento de código, `com.databricks:spark-csv_2.10:1.4.0` es la coordenada de Maven para el paquete **spark-csv**. Le mostramos cómo crear las coordenadas de un paquete.
