...
1. En [http://hortonworks.com/downloads/#sandbox](http://hortonworks.com/downloads/#sandbox), seleccione el elemento para **DESCARGAR VIRTUALBOX** para HDP 2.4 en Sandbox de Hortonworks. Se le pedirá que se registre en Hortonworks antes de que comience la descarga.
...
2. En la misma página web, seleccione el enlace que corresponde a la **guía de instalación de VirtualBox** para HDP 2.4 en Sandbox de Hortonworks. Se descargará un PDF que contiene instrucciones de instalación para la máquina virtual.
...
1. En el paso **get started** (introducción) de la página de Sandbox de Hortonworks, seleccione **View Advanced Options** (Ver opciones avanzadas). Utilice la información de esta página para iniciar sesión en el espacio aislado usando SSH. Utilice el nombre y la contraseña proporcionada.
   
   > [!NOTE]
   > Si no tiene instalado un cliente SSH, puede usar el SSH basado en web que se proporciona en la máquina virtual en http://localhost:4200/__.
   > 
   > 
