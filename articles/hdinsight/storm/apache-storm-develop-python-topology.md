...
* [Uso de Python para la transmisión de trabajos de MapReduce](../hadoop/apache-hadoop-streaming-python.md)
* [Uso de funciones definidas por el usuario (UDF) de Python en Pig y Hive](../hadoop/python-udf-hdinsight.md)
