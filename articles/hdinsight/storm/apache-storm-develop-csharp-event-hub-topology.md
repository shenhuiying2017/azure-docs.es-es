...
Aprenda a trabajar con Azure Event Hubs desde Apache Storm en HDInsight. En este documento se usa una topología de Storm en C# para leer y escribir datos desde Event Hubs
