---
title: Uso de Pig con Hadoop con .NET en HDInsight | Microsoft Docs
...
> 
> Este documento también incluye información sobre el uso del SDK de .NET para HDInsight. Los fragmentos de código proporcionados se basan en comandos que usan Azure Service Management (ASM) para trabajar con HDInsight y están **en desuso**. Estos comandos se eliminarán el 1 de enero de 2017.
> 
...
> [!NOTE]
> Al crear el certificado, asegúrese de tener en cuenta el nombre descriptivo que utilice, ya que lo utilizará más adelante.
> 
> 
...
1. Abra Visual Studio 2012, 2013 o 2015.
...
2. Presione **ENTRAR** para salir de la aplicación.
