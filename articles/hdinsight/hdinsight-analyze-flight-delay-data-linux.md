...
Si ya tiene una base de datos SQL, debe obtener el nombre del servidor. Puede encontrarlo en el [Portal Azure](https://portal.azure.com) seleccionando __Bases de datos SQL__y, después, filtrando el nombre de la base de datos que desee usar. El nombre del servidor aparece en la columna __SERVIDOR__ .
...
8. Para salir de la utilidad tsql, escriba `exit` at the `1>` .
