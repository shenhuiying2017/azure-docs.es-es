<properties
	pageTitle="Aprovisionamiento de un clúster Spark en Azure HDInsight y uso de Spark SQL desde Zeppelin y Jupyter para análisis interactivos | Microsoft Azure"
...
# Introducción: aprovisionamiento de Apache Spark en Azure HDInsight y ejecución de consultas interactivas mediante Spark SQL
...
5. Haga clic en **Grupo de recursos** para ver una lista de grupos de recursos existentes y seleccione dónde crear el clúster. También puede hacer clic en **Crear nuevo** y, a continuación, escribir el nombre del nuevo grupo de recursos. Aparece una marca de verificación verde para indicar si el nuevo nombre de grupo está disponible.
...
9. En la hoja **Nuevo clúster de HDInsight**, asegúrese de que **Anclar a Panel de inicio** está seleccionado y, a continuación, haga clic en **Crear**. Esto crea el clúster y agrega un icono para él en el panel de inicio de su Portal de Azure. El icono indicará que el clúster está aprovisionando y cambiará para mostrar el icono de HDInsight cuando se haya completado el proceso.
...
10. Una vez que termine el aprovisionamiento, haga clic en el icono del clúster Spark desde el panel de inicio para iniciar la hoja del clúster.
