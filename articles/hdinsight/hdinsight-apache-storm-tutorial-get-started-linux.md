...
2. Use el comando siguiente para iniciar una topología de ejemplo:
   ...
   > [!NOTE]
   > La parte `0.10.0.2.4.2.4-5` del nombre del archivo puede cambiar conforme HDInsight se actualiza con las versiones más recientes de Storm.
   > 
   > 
...
1. Abra en un explorador web https://CLUSTERNAME.azurehdinsight.net/stormui, donde **CLUSTERNAME** es el nombre del clúster. Se abrirá la interfaz de usuario de Storm.
