...
En este tutorial se muestra cómo implementar una aplicación web ASP.NET en un [servicio de aplicaciones de Azure](http://go.microsoft.com/fwlink/?LinkId=529714) utilizando el Asistente para publicación web de Visual Studio 2013 o Visual Studio 2013 Express para Web. 
...
<!-- la línea siguiente genera la sección "Configurar el entorno de desarrollo" como se ve en http://azure.microsoft.com/documentation/articles/web-sites-dotnet-get-started/ -->
...
3. En el cuadro de diálogo **Nuevo proyecto**, expanda **Visual C#**, seleccione **Web** y luego seleccione **Aplicación web ASP.NET MVC 5**. Póngale a la aplicación el nombre **ContactManager** y haga clic en **Aceptar**.

	![New Project dialog box](./media/web-sites-dotnet-rest-service-aspnet-api-sql-database/rr4.PNG)]

1. En el cuadro de diálogo **Nuevo proyecto ASP.NET**, seleccione la plantilla **MVC**, active **Web API** y luego haga clic en **Cambiar autenticación**.

	![New ASP.NET Project dialog box](./media/web-sites-dotnet-rest-service-aspnet-api-sql-database/rt3.PNG)

1. En el cuadro de diálogo **Cambiar autenticación**, haga clic en **Sin autenticación** y luego en **Aceptar**.

	![No Authentication](./media/web-sites-dotnet-get-started-vs2013/GS13noauth.png)

	La aplicación de ejemplo que está creando no incluirá características que requieran que los usuarios inicien sesión. Para obtener información sobre cómo implementar la autenticación y las características de autenticación, consulte la sección [Pasos siguientes](#nextsteps) al final de este tutorial. 

1. En el cuadro de diálogo **Nuevo proyecto ASP.NET**, haga clic en **Aceptar**.
...
La clase **Contacts** define qué datos se almacenarán para cada contacto, así como una clave primaria, ContactID, necesaria para la base de datos. Puede obtener más información sobre los modelos de datos en la sección [Pasos siguientes](#nextsteps) al final de este tutorial.
...
1. En el **Explorador de soluciones**, expanda la carpeta Controladores.

3. Cree el proyecto **(Ctrl+Mayús+B)**. (Debe crear el proyecto antes de usar el mecanismo de scaffolding). 

4. Haga clic con el botón secundario en la carpeta Controladores, haga clic en **Agregar** y luego en **Controlador**.
...
6. Asigne al controlador el nombre de **HomeController**. Seleccione **Contact** como su clase de modelo. Haga clic en el botón **Nuevo contexto de datos** y acepte el valor predeterminado "ContactManager.Models.ContactManagerContext" para **Nuevo tipo de contexto de datos**. Haga clic en **Add**.
...
1. En el menú **Herramientas**, seleccione **Administrador de paquetes de biblioteca** y luego **Consola del Administrador de paquetes**.
...
4. En el cuadro de diálogo **Agregar controlador**, escriba "ContactsController" como el nombre de controlador. Seleccione "Contact (ContactManager.Models)" para la opción **Model class**.  Mantenga el valor predeterminado para **Data context class**. 
...
1. Actualice la sección  *Scripts* del archivo  *Views\Home\Index.cshtml* para incluir código para obtener los tokens XSRF.
...
<h2><a name="bkmk_deploydatabaseupdate"></a>Publicación de la actualización de la aplicación en Azure y la base de datos SQL</h2>
...
1. En **ContactsManagerContext(ContactsManagerContext)**, haga clic en el icono **v** para cambiar  *Remote connection string* en la cadena de conexión para la base de datos de contactos. Haga clic en **ContactDB**.
