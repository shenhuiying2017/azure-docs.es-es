...
Sugerencias
- Para conocer las causas comunes de los problemas de suscripción si se usa una tarjeta de crédito o débito, consulte el artículo [Mi tarjeta de crédito no se acepta cuando intento suscribirme a Azure](billing-credit-card-fails-during-azure-sign-up.md).
