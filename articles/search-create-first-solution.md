...
Vaya al [Centro de descarga][Centro de descarga] para obtener Visual Studio 2013 Express para Web.
...
Vaya a [Configuración de búsqueda en el portal de Azure en vista previa][Configuración de búsqueda en el portal de Azure en vista previa] para obtener detalles sobre la configuración del servicio.
