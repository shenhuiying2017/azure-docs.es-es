---
title: "Administración de Key Vault mediante CLI | Microsoft Docs"
...
>
> Este tutorial usa la CLI 2.0 de Azure más reciente. Para ver instrucciones con la CLI anterior (basada en node.js), consulte [este tutorial equivalente](key-vault-manage-with-cli.md).
>
>
...
2. A la izquierda, haga clic en **Azure Active Directory** y seleccione el directorio en el que va a registrar la aplicación. <br> <br> Nota: Necesita seleccionar el mismo directorio que contenga la suscripción de Azure con la que ha creado la instancia de Key Vault. Si no sabe qué directorio es, haga clic en **Configuración**, identifique la suscripción con la que creó la instancia de Key Vault y anote el nombre del directorio que se muestra en la última columna.
