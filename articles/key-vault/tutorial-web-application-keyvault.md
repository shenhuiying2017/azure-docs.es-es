...
>[!IMPORTANT]
> Si se produce el error que indica que el parámetro "vault_name" debe seguir el patrón siguiente: "^[a-zA-Z0-9-]{3,24}$", el valor del parámetro -name no era único o no constituía una cadena de caracteres alfanuméricos de 3 a 24 unidades de largo.
