...
<!--Todos los temas deben tener los siguientes pasos y vínculos al siguiente conjunto lógico de contenido para mantener el interés del cliente-->
...
> [AZURE.NOTE] Si ya está usando la clave **`~/.ssh/id_rsa`**, agréguela a `ssh-add ~/.ssh/id_rsa`.
