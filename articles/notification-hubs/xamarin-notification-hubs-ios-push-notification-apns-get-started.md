---
title: Notificaciones push de iOS con Centros de notificaciones para aplicaciones Xamarin | Microsoft Docs
...
[!INCLUDE [Los Centros de notificaciones permiten notificaciones push de Apple](../../includes/notification-hubs-enable-apple-push-notifications.md)]
...
* **Java/PHP**: para ver un ejemplo de cómo enviar notificaciones push con las API de REST, consulte el artículo sobre el uso de Centros de notificaciones desde Java o PHP ([Java](notification-hubs-java-push-notification-tutorial.md) | [PHP](notification-hubs-php-push-notification-tutorial.md)).
...
Puede buscar todas las cargas posibles en la guía [Local and Push Notification Programming Guide](Guía de programación de notificaciones locales y de inserción.md) de Apple.
