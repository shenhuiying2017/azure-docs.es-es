...
Para ver un ejemplo de cómo enviar notificaciones push desde un back-end de WebAPI de ASP.NET integrado en Centros de notificaciones, consulte [Los Centros de notificaciones de Azure notifican a los usuarios con back-end de .NET](./notification-hubs-aspnet-backend-windows-dotnet-notify-users.md).

Para ver un ejemplo de cómo enviar notificaciones push con las [API de REST](https://msdn.microsoft.com/library/azure/dn223264.aspx), consulte [Uso de los Centros de notificaciones desde Java](./notification-hubs-java-backend-how-to.md) y [Uso de los Centros de notificaciones desde PHP](./notification-hubs-php-backend-how-to.md).
