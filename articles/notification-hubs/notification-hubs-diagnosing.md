...
2. **Configuración del Servicio de notificaciones de inserción de Apple (APNS)**
...
Si utiliza plantillas, asegúrese entonces de seguir las instrucciones que se describen en [Instrucciones para plantillas]. 
...
1. **Usar el portal de Azure**
	...
	c) Comience por revisar los **Mensajes entrantes**, las **Operaciones de registro**, las **Notificaciones correctas** y luego vaya a la pestaña Por plataforma para revisar los errores específicos del PNS. 
