...
En este tema se muestra cómo utilizar la paginación para administrar la cantidad de datos devueltos a la aplicación iOS desde Servicios móviles de Azure. En este tutorial, usará las propiedades **fetchLimit** y **fetchOffset** en el cliente para solicitar "páginas" específicas de datos.
...
2. Presione el botón **Run** (Ejecutar), o Comando + R, para crear el proyecto e iniciar la aplicación y, a continuación, escriba algún texto en el cuadro de texto y haga clic en el icono   más (**+**).
...
7. Actualice el método **refreshDataOnSuccess** una vez más ubicando la siguiente línea de código:
    ...
    <div class="dev-callout"><b>Nota:</b>
    <p>Este tutorial usa un escenario simplificado para definir valores de paginación codificados de forma rígida para las propiedades <strong>fetchOffset</strong> y <strong>fetchLimit</strong>. En una aplicación en tiempo real, puede usar consultas similares a las anteriores con un control de paginación o interfaz de usuario comparable para permitir a los usuarios desplazarse a las páginas anteriores y posteriores. También puede establecer   **query.includeTotalCount = YES** para obtener el recuento total de todos los elementos disponibles en el servidor, junto con los datos paginados.</p>
    </div>
...
* [Introducción a la autenticación]
  <br/>Vea cómo autenticar usuarios en su aplicación con la cuenta de Windows.
