---
title: Habilitación del cifrado de datos transparente (TDE) para SQL Server Stretch Database en Azure | Microsoft Docs
...
---
# Habilitación del cifrado de datos transparente (TDE) para Stretch Database en Azure
