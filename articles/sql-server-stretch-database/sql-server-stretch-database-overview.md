---
title: 'Almacenamiento de datos inactivos en Azure: Stretch Database | Microsoft Docs'
...
---
# <a name="introduction-to-stretch-database"></a>Introducción a Stretch Database
...
### <a name="provides-cost-effective-availability-for-cold-data"></a>Proporciona disponibilidad rentable para datos inactivos
...
Reduzca el mantenimiento y almacenamiento locales de los datos. Las copias de seguridad de los datos locales se realizan más rápidamente y terminan dentro de la ventana de mantenimiento. Se ejecutan automáticamente copias de seguridad de la parte de la nube que contiene los datos. Se reducen significativamente las necesidades de almacenamiento local. El costo de Azure Storage puede ser un 80 % inferior que el de agregar datos a una SSD local.
