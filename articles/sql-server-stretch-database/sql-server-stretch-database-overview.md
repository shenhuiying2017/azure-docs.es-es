...
### Disponibilidad rentable para datos inactivos
...
### No es preciso realizar cambios en consultas o aplicaciones
...
### Optimiza el mantenimiento local de los datos
...
### Conserva los datos seguros, incluso durante la migración
