...
### <a name="provides-costeffective-availability-for-cold-data"></a>Disponibilidad rentable para datos inactivos
...
### <a name="streamlines-onpremises-data-maintenance"></a>Optimiza el mantenimiento local de los datos
