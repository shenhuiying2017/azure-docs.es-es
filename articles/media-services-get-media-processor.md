...
<table border="2" cellspacing="0" cellpadding="5" style="border: 2px solid #000000;">
  ...
  <tbody>
    <tr>
       ...
       <td><a href="http://msdn.microsoft.com/es-es/library/jj129582.aspx"> Cadenas predefinidas de tarea para el Codificador multimedia de Azure</a></td>
    </tr>
    <tr>
		...
		<td><a href="http://msdn.microsoft.com/es-es/library/hh973635.aspx">Valores predefinidos del sistema Azure Media Packager</a></td>
    </tr>
    <tr>
        <td>Windows Azure Media Encryptor</td>
        <td>Le permite cifrar recursos multimedia con la protección PlayReady.</td>
        <td><a href="http://msdn.microsoft.com/es-es/library/hh973610.aspx">Valores predefinidos del sistema Azure Media Packager</a></td>
    </tr>
    <tr>
...
[Cadenas predefinidas de tarea para el Codificador multimedia de Azure]: http://msdn.microsoft.com/es-es/library/jj129582.aspx
