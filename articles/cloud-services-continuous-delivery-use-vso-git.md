...
10. Mientras la compilación está en curso, eche un vistazo a la definición de compilación que se creó al vincular a Azure con el asistente. Abra el menú de acceso directo de la definición de compilación y elija **Editar definición de compilación**.
    ...
    <b>Valor predeterminado</b>
     ...
     <td>
     Si es falso, una entidad de certificación raíz puede firmar los certificados de SSL.
     ...
     <td>
     Permite que se actualice una implementación existente en lugar de crear una nueva. Conserva la dirección IP.
     ...
     <td>
     Si es verdadero, no se sobrescribe una implementación no relacionada existente (se permite la actualización).
     ...
     <td>
     La ruta de acceso al archivo .pubxml de un sitio web, relativa a la carpeta raíz del repositorio. Se omite en los servicios en la nube.
     ...
     <td>
    El mismo que el nombre de servicio.
     ...
     <td>
     El nombre del sitio web o del servicio en la nube
...
Para obtener más información, consulte [Visual Studio Online][]. Para obtener sugerencias adicionales sobre el uso de Git con Visual Studio Online, consulte [Comparta su código en Git][] y, para obtener información sobre el uso de un repositorio Git que no está administrado por Visual Studio Online para publicar en Azure, consulte [Publicación del control de código fuente a Sitios web Azure][].
  ...
  [Paso 1: Inicie sesión en Visual Studio Online y cree un repositorio Git.]: #step1
