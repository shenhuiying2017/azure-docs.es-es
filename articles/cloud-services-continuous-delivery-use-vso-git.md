...
<tr><td>Permitir actualización</td><td>Permite actualizar una implementación existente en lugar de crear una nueva. Conserva la dirección IP.</td></tr><tr>
<td>No eliminar</td><td>Si el valor es true, no sobrescriba una implementación no relacionada existente (la actualización está permitida).</td></tr>
...
12. Si se hace doble clic en el nombre de la compilación, Visual Studio muestra un **Resumen de la ** en el que se incluyen los resultados de las pruebas de los proyectos de pruebas unitarias asociados.<br/>
![][29]
...
![][31]
<br/> se abrirá una nueva pestaña del explorador para mostrar el sitio en ejecución.<br/>
![][32]
