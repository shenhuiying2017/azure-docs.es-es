---
title: Creación de una aplicación web con Caché en Redis | Microsoft Docs
...
6. Agregue las dos siguientes instrucciones using en la parte superior del archivo, debajo de las otras instrucciones using.
