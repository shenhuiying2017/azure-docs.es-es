...
Para cambiar el tamaño del clúster de una caché premium en ejecución con la agrupación en clústeres habilitada, haga clic en **(VERSIÓN PRELIMINAR) Tamaño del clúster en Redis** desde la hoja **Configuración**.
