...
>[AZURE.NOTE]Caché en Redis de Azure funciona con redes virtuales clásicas. Para obtener información sobre la creación de una red virtual clásica, vea [Creación de una red virtual (clásica) usando el portal de vista previa de Azure](../virtual-network/virtual-networks-create-vnet-classic-pportal.md).
