...
Premium es un nuevo nivel destinado a las empresas que incluye todas las características del nivel Standard y otras adicionales, como un mejor rendimiento, cargas de trabajo más grandes, recuperación ante desastres y seguridad mejorada. Otras características:
...
Para obtener instrucciones acerca de cómo configurar la persistencia, consulte [Cómo configurar la persistencia para una memoria Caché en Redis de Azure Premium](cache-how-to-premium-persistence.md).
...
Para empezar a usar la agrupación en clústeres, vea [Cómo configurar la agrupación en clústeres para una memoria Caché en Redis de Azure Premium](cache-how-to-premium-clustering.md).
...
Para obtener más información, vea [Cómo configurar la compatibilidad de red virtual para una memoria Caché en Redis de Azure Premium](cache-how-to-premium-vnet.md).
