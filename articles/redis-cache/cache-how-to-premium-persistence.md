...
### <a name="what-happens-to-the-old-backups-when-a-new-backup-is-made"></a>¿Qué ocurre con las copias de seguridad antiguas cuando se realiza una nueva copia de seguridad?
...
* Si ha realizado el escalado a un tamaño menor y tiene una configuración de [bases de datos](cache-configure.md#databases) personalizada que es mayor que el [límite de bases de datos](cache-configure.md#databases) para el nuevo tamaño, los datos de dichas bases de datos no se restauran. Para más información, consulte [¿Mi configuración de bases de datos personalizada se ve afectada durante el escalado?](cache-how-to-scale.md#is-my-custom-databases-setting-affected-during-scaling)
