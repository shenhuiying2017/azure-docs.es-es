<properties 
	pageTitle="Creación y administración de Caché en Redis de Azure mediante la interfaz de la línea de comandos de Azure (CLI de Azure) | Microsoft Azure" 
