...
## <a name="register-app-aad"></a>Registro de la aplicación con Azure Active Directory
...
3. Después haga clic en el **sitio de Live Services**. 
        ...
        private async Task AuthenticateAsync()
        {
            ...
            while (user == null)
            {
                ...
                try
                {
                  ...
                  user = await App.MobileService.LoginAsync(MobileServiceAuthenticationProvider.MicrosoftAzureActiveDirectory, payload);
...
6. En el código del método  `AuthenticateAsync` anterior, sustituya **INSERT-AUTHORITY-HERE** por el nombre del inquilino en el que ha aprovisionado su aplicación; el formato debe ser https://login.windows.net/tenant-name.onmicrosoft.com. Este valor se puede copiar de la pestaña Dominio de Azure Active Directory en el [Portal de administración de Azure].
