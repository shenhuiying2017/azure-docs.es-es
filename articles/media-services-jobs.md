...
Un **trabajo** contiene metadatos sobre el procesamiento que se va a realizar. Cada **trabajo** contiene una o más **tareas** que especifican una tarea de procesamiento atómica, sus recursos de entrada, recursos de salida, un procesador multimedia y su configuración asociada. Para obtener más información sobre la configuración del codificador, vea Manuales del codificador y Esquemas de codificador.
...
[Cuotas y limitaciones](media-services-quotas-and-limitations.md): describe las cuotas usadas y las limitaciones del codificador de Servicios multimedia
