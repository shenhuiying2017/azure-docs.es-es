<properties 
	pageTitle="Cómo paginar los resultados de la búsqueda en Búsqueda de Azure" 
	description="Paginación en búsqueda de Azure" 
	services="search" 
	documentationCenter="" 
	authors="HeidiSteen" 
	manager="mblythe" 
...
- [Vídeo y tutoriales acerca de Búsqueda de Azure](http://msdn.microsoft.com/library/azure/dn818681.aspx)
