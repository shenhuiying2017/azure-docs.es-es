...
Puede pagar con tarjeta de crédito o débito, o recibir aprobación para pagar mediante factura. Para obtener más información sobre el pago mediante factura, consulte [Facturación de Azure](http://azure.microsoft.com/pricing/invoicing/).
