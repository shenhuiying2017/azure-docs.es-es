...
5. Ahora, solo tiene que replicar la configuración de `.env` en la aplicación web de Azure. Ejecute los siguientes comandos de la CLI de Azure:
    ...
    Descubra cómo funciona en la sección de [configuración de la aplicación web de Azure](app-service-web/app-service-web-get-started-php.md#configure-to-use-php).
