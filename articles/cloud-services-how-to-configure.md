...
<b>Nota:</b> 
<p>Si su servicio en la nube consta de dos o m&aacute;s m&aacute;quinas virtuales conectadas basadas en Windows Server, no es necesario que configure el acceso remoto debido a que estas maquinas virtuales se configuran autom&aacute;ticamente para el Escritorio remoto.</p> 
</div>
...
1.  Inicie sesión en el [Portal de administración][Portal de administración de Azure] y haga clic en **Servicios en la nube**. A continuación, haga clic en el nombre del servicio en la nube para abrir el panel.
