<properties
  pageTitle="Conexión de los roles de Servicios en la nube de Azure a un controlador de dominio de AD personalizado que se hospeda en Azure"
...
## Guía paso a paso para conectar los roles web y de trabajo de Azure a un controlador de dominio personalizado hospedado en Azure.
...
## Agregar la implementación del servicio en la nube a la red virtual
