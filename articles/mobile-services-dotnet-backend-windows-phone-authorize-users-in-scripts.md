<properties pageTitle="Autorización del servicio (Windows Phone) | Centro de desarrollo móvil" description="Obtenga información acerca de cómo autorizar a los usuarios en el back-end de .NET de Servicios móviles de Azure." services="" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
...
En este tema se muestra cómo autorizar a los usuarios autenticados el acceso a los datos en Servicios móviles de Azure desde una aplicación Windows Phone. En este tutorial, agregará código a los métodos de acceso a datos de su controlador para filtrar las consultas según el identificador de usuario de los usuarios autenticados, lo que garantiza que cada usuario solo pueda ver sus propios datos.
