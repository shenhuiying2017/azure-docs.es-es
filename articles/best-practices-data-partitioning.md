...
---
# <a name="data-partitioning-guidance"></a>Guía de creación de particiones de datos
...
## <a name="partitioning-strategies-for-azure-sql-database"></a>Estrategias de creación de particiones de la Base de datos SQL de Azure
...
## <a name="horizontal-partitioning-with-elastic-database"></a>Particiones horizontales con Base de datos elástica
...
## <a name="partitioning-strategies-for-azure-storage"></a>Estrategias de creación de particiones para el almacenamiento de Azure
...
Microsoft ha publicado los objetivos de escalabilidad para el Almacenamiento de Azure. Para más información, consulte la página [Azure Storage scalability and performance targets] (Acceso a datos para soluciones altamente escalables: uso de SQL, NoSQL y persistencia políglota) en el sitio web de Microsoft. Actualmente, la capacidad total de la cuenta de almacenamiento no puede superar los 500 TB (esto incluye el tamaño de los datos que se mantienen en el Almacenamiento de tablas y el Almacenamiento de blobs, así como los mensajes pendientes que se encuentran en la cola de almacenamiento).
...
## <a name="partitioning-strategies-for-azure-service-bus"></a>Estrategias de creación de particiones para el Bus de servicio de Azure
...
## <a name="partitioning-strategies-for-azure-documentdb-databases"></a>Estrategias de creación de particiones para bases de datos de Azure DocumentDB
...
*Ilustración 8.  La estructura de la arquitectura de DocumentDB*
...
## <a name="partitioning-strategies-for-azure-redis-cache"></a>Estrategias de creación de particiones para Caché en Redis de Azure
...
[Cuotas de Bus de servicio]: ./service-bus-messaging/service-bus-quotas.md
