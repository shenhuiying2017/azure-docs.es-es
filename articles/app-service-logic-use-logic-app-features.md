...
2. Para editar la acción**conector Dropbox**, haga clic en el icono de lápiz.
...
2. Desplácese a la acción `twitterconnector`, busque el valor de consulta y reemplácelo por `@concat('#', parameters('topic'))`.
	La función **concat** combina dos o más cadenas. 
...
Para obtener más información, consulte la [documentación de Node.js](http://go.microsoft.com/fwlink/?LinkID=525617&clcid=0x409). 
