...
- Integración de la implementación de contenido (imágenes, scripts y hojas de estilo) como parte del proceso de [implementación continua](web-sites-publish-source-control.md) de su sitio web Azure
