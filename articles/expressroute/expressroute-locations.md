...
| **Megaport** | Compatible | Compatible | Dallas, Las Vegas+, Los Ángeles, Melbourne, Nueva York, Seattle, Sidney, Washington DC |
...
|-----------------------|--------------------|----------------|---------------|
| **[AT&T NetBond](https://www.synaptic.att.com/clouduser/html/productdetail/ATT_NetBond.htm)** | Compatible | Próximamente | Chicago, Washington DC |
| **[Equinix](http://www.equinix.com/partners/microsoft-azure/)** | Compatible | Próximamente | Chicago, Nueva York +, Washington DC |
...
| **[Verizon](http://news.verizonenterprise.com/2014/04/secure-cloud-interconnect-solutions-enterprise/)** | Compatible | Próximamente | Chicago, Nueva York +, Washington DC |
...
| **Proveedor de servicios** |**Microsoft Azure** | **Office 365** | **Ubicaciones** |
|-----------------------|--------------------|----------------|---------------|
| **[Colt](http://www.colt.net/uk/en/news/colt-announces-dedicated-cloud-access-for-microsoft-azure-services-en.htm)** | Próximamente | No compatible | Berlín+, Fráncfort+|
