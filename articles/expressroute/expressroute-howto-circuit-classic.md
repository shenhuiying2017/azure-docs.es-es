<properties
   pageTitle="Create and modify an ExpressRoute circuit using the classic deployment model and PowerShell (Creación y modificación de un circuito ExpressRoute con el modelo de implementación clásica y PowerShell) | Microsoft Azure"
...
Consulte la página [Preguntas más frecuentes sobre ExpressRoute](expressroute-faqs.md) para conocer las opciones de ancho de banda compatibles con su proveedor. Puede elegir cualquier tamaño mayor que el tamaño de su circuito existente.
...
Cuando haya decidido el tamaño que necesita, puede usar el comando siguiente para cambiar el tamaño del circuito.
...
## Eliminación y cancelación de un circuito ExpressRoute
