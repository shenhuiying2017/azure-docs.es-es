...
## <a name="a-namecloudexchangeaco-located-at-a-cloud-exchange"></a><a name="CloudExchange"></a>Ubicación compartida en un intercambio en la nube
...
## <a name="a-nameethernetapoint-to-point-ethernet-connections"></a><a name="Ethernet"></a>Conexiones Ethernet de punto a punto
...
## <a name="a-nameipvpnaany-to-any-ipvpn-networks"></a><a name="IPVPN"></a>Redes de conexión universal (IPVPN)
