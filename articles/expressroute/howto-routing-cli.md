...
### <a name="to-add-ipv6-microsoft-peering-settings-to-an-existing-ipv4-configuration"></a>Adición de la configuración de IPv6 para el emparejamiento de Microsoft a una configuración existente de IPv4
