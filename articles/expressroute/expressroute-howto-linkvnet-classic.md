...
- Necesitará la versión más reciente de los cmdlets de Azure PowerShell. El módulo de PowerShell más reciente se puede descargar desde la sección de PowerShell de la [página de descargas de Azure](http://azure.microsoft.com/downloads). Siga las instrucciones de la página [Cómo instalar y configurar Azure PowerShell](../powershell-install-configure.md) para obtener instrucciones detalladas sobre cómo configurar el equipo para utilizar los módulos de Azure PowerShell. 
