<properties urlDisplayName="Get Started with Data" pageTitle="Introducción a los datos (WP8): Servicios móviles de Azure" metaKeywords="" description="Obtenga información acerca de cómo empezar a usar los datos de la aplicación de Windows Phone 8 de Servicios móviles de Azure." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Get started with data in Mobile Services" authors="glenga" solutions="" manager="dwrede" editor="" />
...
Este tutorial requiere Visual Studio 2012 Express para Windows Phone 8 y el [SDK de Windows Phone 8] en Windows 8. Para completar este tutorial con el fin de crear una aplicación de Windows Phone 8.1, debe usar la Actualización 2 de Visual Studio 2013 o una versión posterior.
...
1. Descargue el proyecto de aplicación de ejemplo GetStartedWithData desde el [sitio de ejemplos de código para desarrolladores]. 

	>[WACOM.NOTE]Para crear una aplicación de Windows Phone Silverlight 8.1, simplemente cambie el SO de destino en el proyecto de aplicación Windows Phone Silverlight 8 a Windows Phone 8.1. Para crear una aplicación de la Tienda Windows Phone, descargue la [versión de la aplicación de Windows Phone ](http://go.microsoft.com/fwlink/p/?LinkId=397372) del proyecto de aplicación de ejemplo GetStartedWithData. 

2. En Visual Studio, abra el proyecto descargado y examine el archivo MainPage.xaml.cs.

   	Observe que los objetos  **TodoItem** agregados se almacenan en un objeto **ObservableCollection<TodoItem>** en memoria.

3. Presione la tecla **F5** para recompilar el proyecto e iniciar la aplicación.

4. En la aplicación, escriba algún texto en el cuadro de texto y, a continuación, haga clic en el botón **Guardar**.
...
2. En el panel izquierdo, seleccione la categoría **En línea**, bosque "WindowsAzure.MobileServices"`, haga clic en **Instalar** en el paquete **Servicios móviles Azure** y, a continuación, acepte el contrato de licencia.
...
4. Haga clic en la pestaña **Panel** y anote la **dirección URL del sitio**; a continuación, haga clic en **Administrar clave** y anote la **clave de la aplicación**.
...
2. Al igual que anteriormente, escriba texto en el cuadro de texto y, a continuación, haga clic en **Guardar**.
