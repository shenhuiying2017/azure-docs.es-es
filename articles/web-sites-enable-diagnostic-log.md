<properties urlDisplayName="Enable diagnostic logging" pageTitle="Habilitación del registro de diagnóstico - Sitios web Azure" metaKeywords ="sitios web de diagnóstico de Azure, Portal de administración de Azure, diagnósticos de Azure, diagnósticos de sitios web, depuración de sitios web" description="Learn how to enable diagnostic logging and add instrumentation to your application, as well as how to access the information logged by Azure." metaCanonical="" services="web-sites" documentationCenter=".NET" title="Enable diagnostic logging for Azure Websites" authors="larryfr" solutions="" manager="wpickett" editor="" />
