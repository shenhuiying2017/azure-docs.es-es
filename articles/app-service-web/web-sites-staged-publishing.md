...
> [!NOTE] 
> Para los comandos de [versión preliminar de la CLI de Azure 2.0](https://github.com/Azure/azure-cli) para ranuras de implementación, consulte [az appservice web deployment slot](/cli/azure/appservice/web/deployment/slot).
