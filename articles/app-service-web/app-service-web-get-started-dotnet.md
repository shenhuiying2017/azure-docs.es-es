...
---
# Implementación de su primera aplicación web .NET en Azure en 5 minutos
...
6. En el terminal de la línea de comandos, cambie a un directorio de trabajo (`CD`) y clone la aplicación de ejemplo del modo siguiente:
    ...
    ![Clonación del código de ejemplo de aplicación de su primera aplicación web de Azure](./media/app-service-web-get-started-languages/dotnet-git-clone.png)
...
## Pasos siguientes
Descubra cómo crear, desarrollar e implementar aplicaciones web .NET en Azure directamente en Visual Studio en 
[Implementación de una aplicación web creada con ASP.NET en Azure App Service mediante Visual Studio](web-sites-dotnet-get-started.md).
