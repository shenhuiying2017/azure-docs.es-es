...
>[AZURE.NOTE] "Espere. ¿Qué ocurre si deseo implementar mediante FTP?" Hay un [tutorial de FTP](web-sites-php-mysql-deploy-use-ftp.md), por si lo necesita. 
...
4. Desde el menú de la izquierda, haga clic en **App Services** > **&lt;app_name > ** > **Herramientas**.
    ...
    >[AZURE.TIP] Si hace clic en **Configuración**, en lugar de en **Herramientas**, podrá acceder a la hoja **Configuración de la aplicación** 
...
4. Seleccione **Composer** en la **hoja** [Elegir extensión](../azure-portal-overview.md) (*hoja*: una página del portal que se abre horizontalmente).
