---
title: Creación, configuración e implementación de una aplicación web PHP en Azure
...
2. Ejecute el comando para crear la aplicación web de Azure con la implementación de Git. Cuando se le solicite, especifique el número de la región deseada.
   ...
   > [!NOTE]
   > Si nunca ha configurado credenciales de implementación para su suscripción de Azure, se le solicitará que las cree. App Service usa estas credenciales, no las de su cuenta de Azure, solo en implementaciones de Git e inicios de sesión FTP. 
   > 
   > 
...
5. Desde el menú de la izquierda, haga clic en **App Services** > **&lt;app_name > ** > **Herramientas**.
   ...
   > [!TIP]
   > Si hace clic en **Configuración**, en lugar de en **Herramientas**, podrá acceder a la hoja **Configuración de la aplicación** 
   > , lo que le permitirá establecer las versiones de PHP, la configuración de la aplicación y los directorios virtuales como acaba de hacer. 
   > 
   > 
6. Haga clic en **Extensiones** > **Agregar** para agregar una extensión.
7. Seleccione **Composer** en la **hoja** [Elegir extensión](../azure-portal-overview.md) (*hoja*: una página del portal que se abre horizontalmente).
8. Haga clic en **Aceptar** en la hoja **Aceptar los términos legales**. 
9. Haga clic en **Aceptar** en la hoja **Agregar extensión**.
   
    Cuando Azure haya terminado de agregar la extensión, debería ver un mensaje descriptivo emergente en la esquina, y también aparecerá  **Composer** en la lista de la hoja **Extensiones**.
...
10. De nuevo en la hoja de la aplicación web, haga clic en **Configuración** > **Configuración de la aplicación**.
...
11. Desplácese hasta la parte inferior de la hoja y cambie el directorio raíz virtual para que apunte a **site\wwwroot\public**, en lugar de a **site\wwwroot**.
...
12. Haga clic en **Guardar** en la parte superior de la hoja.
