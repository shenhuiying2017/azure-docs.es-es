...
1. En la **pantalla Inicio** o en el **menú Inicio**, busque **Windows PowerShell**. Haga clic con el botón derecho en la entrada **Windows PowerShell** y seleccione **Ejecutar como administrador**.
