...
Para obtener más información, vea cómo [implementar la aplicación en App Service](web-sites-deploy.md).
...
En el tutorial [Creación de una aplicación web ASP.NET en Azure](https://docs.microsoft.com/azure/app-service-web/web-sites-dotnet-get-started/) se muestra cómo implementar una aplicación web ASP.NET en una aplicación web en App Service mediante Visual Studio 2015.
