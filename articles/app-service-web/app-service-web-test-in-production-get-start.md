...
> [!NOTE]
> En estos pasos se supone que ya tiene una [ranura de implementación que no sea de producción](web-sites-staged-publishing.md) y que el contenido de la aplicación web deseada ya está [implementado](web-sites-deploy.md) en dicha ranura.
> 
> 
