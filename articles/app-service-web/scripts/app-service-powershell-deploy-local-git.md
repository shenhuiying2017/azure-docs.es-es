...
Antes de ejecutar este script, asegúrese de que se haya creado una conexión con Azure mediante el cmdlet `Login-AzureRmAccount` y de que el código de la aplicación está confirmado en el repositorio local de Git.
