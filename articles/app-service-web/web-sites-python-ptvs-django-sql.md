...
2. En la parte inferior del panel de navegación, haga clic en **NUEVO**, haga clic en **Datos + almacenamiento** > **Base de datos SQL**.
...
6. En la hoja **Configuración de firewall**, agregue una regla de firewall con **IP INICIAL** e **IP FINAL** establecidos en la dirección IP pública de su equipo de desarrollo. Haga clic en **Guardar**.
