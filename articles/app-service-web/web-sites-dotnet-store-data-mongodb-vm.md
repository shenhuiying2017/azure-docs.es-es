...
5. Una vez que ha iniciado sesión, puede comenzar a configurar la aplicación web de Servicio de aplicaciones. Especifique el **nombre de aplicación web**, el **plan de Servicio de aplicaciones**, **Grupo de recursos** y **Región** y luego haga clic en **Crear**.
...
Reemplace "`<vm-dns-name>`" por el nombre de DNS de la máquina virtual que ejecuta el MongoDB que creó en el paso [Creación de una máquina virtual e instalación de MongoDB de este tutorial][Creación de una máquina virtual e instalación de MongoDB de este tutorial]. Para buscar el nombre de DNS de la máquina virtual, diríjase al Portal de Azure, seleccione **Máquinas virtuales** y busque **Nombre DNS**.
