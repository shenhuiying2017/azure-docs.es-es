<properties 
	pageTitle="Creación de una aplicación de Azure de línea de negocio con autenticación de AD FS | Microsoft Azure" 
...
>[AZURE.NOTE] Para información general de las distintas opciones de autorización y autenticación empresarial para Servicio de aplicaciones de Azure, consulte [Autenticación con Active Directory local en aplicaciones de Azure](web-sites-authentication-authorization.md).
...
5.	En App\_Start\\Startup.Auth.cs, cambie las siguientes definiciones de cadena estática:
...
6.	Ahora haga los cambios correspondientes en Web.config. Abra Web.config y modifique la siguiente configuración de la aplicación:
	<pre class="prettyprint">
	&lt;appSettings>
...
9.	Configure las notificaciones de nombre, UPN y rol, como se muestra en la captura de pantalla, y haga clic en **Finalizar**.
...
11.	Configure la regla como se muestra en la captura de pantalla (con el tipo de notificación que creó en la regla personalizada) y haga clic en **Finalizar**.
