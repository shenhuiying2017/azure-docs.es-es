...
3. En la hoja [Portal de Azure](https://portal.azure.com) **Configuración** para la aplicación web, haga clic en **Credenciales de implementación** y luego especifique un nuevo nombre de usuario y contraseña.
