...
9. En el **Explorador de servidores**, haga clic con el botón secundario en la aplicación web y, a continuación, haga clic en **Asociar depurador**.
    ...
    **Nota:** si tiene algún problema para iniciar el depurador, intente hacerlo con **Cloud Explorer** en lugar de con el **Explorador de servidores**.
...
4. En el **Explorador de soluciones**, haga clic en el proyecto web (no el proyecto WebJob) y haga clic en **Publicar**.
...
6. Haga clic en la pestaña **Configuración**, cambie la **Configuración** a **Depurar** y, a continuación, haga clic en **Publicar**.
...
7. En el **Explorador de servidores**, expanda **Azure > Servicio de aplicaciones > su grupo de recursos > su aplicación web > WebJobs > Continuo** y, a continuación, haga clic con el botón secundario en **ContosoAdsWebJob**.
...
14. En el **Explorador de servidores**, haga clic en el nodo ContosoAdsWebJob y haga clic en **Ver panel**.
...
5. En la barra de direcciones de la ventana del explorador, agregue *trace.axd* a la dirección URL y después presione Entrar (la dirección URL será similar a http://localhost:53370/trace.axd).
...
1. En el **Explorador de servidores**, haga clic con el botón secundario en la aplicación web y, a continuación, haga clic en **Ver configuración** tal como hizo anteriormente.
...
3. En la ventana del explorador que ahora muestra su página **Contacto**, haga clic en **Inicio**, en **Acerca** y, a continuación, haga clic en **Contacto**.
...
1. Haga clic con el botón secundario en **Almacenamiento** en el nodo de Azure y, a continuación, haga clic en **Crear cuenta de almacenamiento**.
...
6. En la pestaña **Configurar** del portal clásico, desplácese hacia abajo hasta la sección de diagnóstico de aplicaciones y cambie **Registro de la aplicación (Almacenamiento de tablas)** a **Activado**.
...
11. En la ventana del explorador que muestra la aplicación web, haga clic en **Inicio**, en **Acerca de** y, a continuación, en **Contacto**.
...
4. En la hoja [Portal de Azure](https://portal.azure.com) **Configuración** para la aplicación web, haga clic en **Credenciales de implementación** y luego especifique un nuevo nombre de usuario y contraseña.
