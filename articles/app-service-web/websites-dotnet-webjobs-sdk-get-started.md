---
title: Creación de un WebJob .NET en el Servicio de aplicaciones de Azure | Microsoft Docs
...
4. Haga clic con el botón derecho en **Almacenamiento** en el nodo de Azure y, después, haga clic en **Crear cuenta de almacenamiento**.
...
13. Complete los campos **Nombre de usuario de base de datos** y **Contraseña de base de datos** con los datos de un administrador.
...
1. En el **Explorador de servidores**, haga clic con el botón derecho en la aplicación web en **Azure > Servicio de aplicaciones > {su grupo de recursos}** y luego haga clic en **Ver configuración**.
