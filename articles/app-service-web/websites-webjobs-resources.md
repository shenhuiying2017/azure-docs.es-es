...
* [Código fuente de script del SDK de WebJobs](https://github.com/Azure/azure-webjobs-sdk-script/) (utilizado para [Funciones de Azure](../azure-functions/functions-overview.md))
