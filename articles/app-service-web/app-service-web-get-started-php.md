---
title: "Implementación de la primera aplicación web PHP en Azure en 5 minutos (versión preliminar de CLI 2.0) | Microsoft Docs"
...
---
# <a name="deploy-your-first-php-web-app-to-azure-in-five-minutes-cli-20-preview"></a>Implementación de la primera aplicación web PHP en Azure en 5 minutos (versión preliminar de CLI 2.0)
...
4. A continuación, obtenga el código PHP de ejemplo que desea implementar. Cambie a un directorio de trabajo (`CD`) y clone la aplicación de ejemplo como se indica a continuación:
