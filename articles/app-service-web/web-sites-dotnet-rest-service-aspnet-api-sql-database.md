...
2. Reemplace el contenido del archivo *Views\\Shared\_Layout.cshtml* por el código siguiente:
...
3. Haga clic con el botón secundario en la carpeta Controllers, haga clic en **Agregar** y luego en **Controlador**.
