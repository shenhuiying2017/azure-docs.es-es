...
> 
> Para almacenar sus credenciales de GitHub en Azure, cree una aplicación web en el [Portal de Azure](https://portal.azure.com/) y [configure la implementación de GitHub](app-service-continuous-deployment.md). Solo tiene que hacer esto una vez.
> 
> 
...
5. Cuando se le solicite, escriba el nombre de usuario y la contraseña que quiera para el acceso a la base de datos.
   ...
   > [!TIP]
   > Eche un vistazo a *&lt;raíz\_repositorio>*\\ARMTemplates\\Deploy.ps1 para ver cómo genera recursos con identificadores únicos. Puede usar el mismo enfoque para crear clones de la misma implementación sin preocuparse por los nombres de recursos en conflicto.
   > 
   > 
