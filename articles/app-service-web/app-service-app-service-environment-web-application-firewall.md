...
Cuando ya tenga dos o más instancias de máquina virtual de WAF en el servicio en la nube, puede usar el [Portal de administración de Azure](https://portal.azure.com) para agregar extremos HTTP y HTTPS que la aplicación utiliza como se muestra en la imagen siguiente.
...
Consulte la [documentación sobre el control del tráfico entrante](app-service-app-service-environment-control-inbound-traffic.md) para obtener detalles sobre la restricción del tráfico en el entorno del Servicio de aplicaciones desde el WAF solo mediante la utilización de la dirección VIP del servicio en la nube. A continuación se muestra un comando PowerShell de ejemplo para realizar esta tarea para el puerto TCP 80.
