---
title: Implementación de una aplicación creada con ASP.NET en el Servicio de aplicaciones de Azure mediante Visual Studio | Microsoft Docs
...
7. En el cuadro de diálogo **Nuevo proyecto ASP.NET**, seleccione la plantilla **MVC** y haga clic en **Cambiar autenticación**.
...
9. En la sección **Microsoft Azure** del cuadro de diálogo **Nuevo proyecto ASP.NET**, asegúrese de que la casilla **Host en la nube** está activada y que **Servicio de aplicaciones** está seleccionado en la lista desplegable.
...
1. En el cuadro de diálogo **Crear servicio de aplicaciones**, haga clic en **Agregar una cuenta** e inicie sesión en Azure con el identificador y la contraseña de la cuenta que utiliza para administrar su suscripción a Azure.
...
8. En el cuadro de diálogo **Configurar plan del servicio de aplicaciones**, haga clic en **Aceptar**.
