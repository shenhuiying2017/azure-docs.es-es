...
6. Haga clic en **Base de datos** y, en la hoja **Nueva base de datos MySQL**, proporcione los valores necesarios para configurar la base de datos MySQL.
...
7. En la hoja **WordPress**, acepte los términos legales y, después, haga clic en **Crear**.
...
5. En la página **principal** de WordPress, escriba la información de configuración que WordPress necesita y, a continuación, haga clic en **Instalar WordPress**.
