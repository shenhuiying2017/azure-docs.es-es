---
title: "Implementación de su primera aplicación web ASP.NET en Azure en cinco minutos | Microsoft Docs"
...
---
# <a name="deploy-your-first-aspnet-web-app-to-azure-in-five-minutes"></a>Implementación de su primera aplicación web ASP.NET en Azure en cinco minutos
...
4. Cambie a un directorio de trabajo (`CD`) y clone la aplicación ASP.NET de ejemplo.
