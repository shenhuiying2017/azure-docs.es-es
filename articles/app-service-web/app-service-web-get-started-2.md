...
3. En **Proveedores de autenticación**, haga clic en **Azure Active Directory**. ![Autenticar, seleccionar Azure AD](./media/app-service-web-get-started/aad-login-config.png)
4. En la hoja **Configuración de Azure Active Directory**, haga clic en **Rápido** y haga clic en **Aceptar**. La configuración predeterminada creará una aplicación de Azure AD en el directorio predeterminado. ![Autenticar, configuración rápida](./media/app-service-web-get-started/aad-login-express.png)
5. Haga clic en **Guardar**. ![Autenticar, guardar configuración](./media/app-service-web-get-started/aad-login-save.png)
...
> [!NOTE]
> Las reglas de alerta son una característica de Azure. Para más información, consulte [Recibir notificaciones de alerta](../azure-portal/insights-receive-alert-notifications.md).
> 
> 
