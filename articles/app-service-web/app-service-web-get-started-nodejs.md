...
---
# Implementación de su primera aplicación web de Node.js en Azure en 5 minutos
...
6. En el terminal de la línea de comandos, cambie a un directorio de trabajo (`CD`) y clone la aplicación de ejemplo del modo siguiente:
    ...
    ![Clonación del código de ejemplo de aplicación de su primera aplicación web de Azure](./media/app-service-web-get-started-languages/node-git-clone.png)
