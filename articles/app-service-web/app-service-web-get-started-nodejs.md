...
- [CLI de Azure 2.0 (versión preliminar)](app-service-web-get-started-nodejs.md): la CLI de última generación para el modelo de implementación de Resource Manager
