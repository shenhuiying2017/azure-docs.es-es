---
title: Probar el rendimiento de la aplicación web de Azure | Microsoft Docs
...
1. Inicie sesión en el [Portal de Azure](https://portal.azure.com). Para usar una cuenta de Visual Studio Team Services que posea, inicie sesión como propietario de la cuenta.
...
1. Siga los pasos anteriores para abrir la hoja **Nueva prueba de rendimiento**. En esta hoja, elija la opción CONFIGURE TEST USING (CONFIGURAR PRUEBA CON) para abrir la hoja **Configure test using** (Configurar prueba con).  
...
2. Compruebe que el campo TEST TYPE (TIPO DE PRUEBA) esté establecido en **Visual Studio Web Test** (Prueba web de Visual Studio) y seleccione el archivo de almacenamiento de HTTP. Utilice el icono de la carpeta para abrir el cuadro de diálogo del selector de archivos.
