...
En este artículo se explica cómo migrar un nombre DNS activo a [Azure App Service](../app-service/app-service-value-prop-what-is.md) sin experimentar ningún tiempo de inactividad.
