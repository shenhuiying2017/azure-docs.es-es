...
Cuando haya inicializado el sitio web de Java tal y como se documenta en [Introducción a los Sitios web Microsoft Azure y Java](web-sites-java-get-started.md), podrá cargar su aplicación colocando el WAR en la carpeta **webapps**.
