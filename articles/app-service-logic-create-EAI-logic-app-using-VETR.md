...
1. Agrege **Validador XML de BizTalk** desde la galería y asígnele el nombre _(Validate1)_ para crear una instancia.
...
Repita los pasos anteriores para enviar una respuesta HTTP en caso de error también. Cambie la condición a ```@not(equals(actions('servicebusconnector').status,'Succeeded')).```
