---
title: Adición de servicios móviles con Servicios conectados en Visual Studio | Microsoft Docs
...
3. En el cuadro de diálogo **Agregar servicio conectado**, seleccione **Servicios móviles de Azure** y elija el botón **Configurar**. Es posible que se le pida que inicie sesión en Azure si aún no lo ha hecho.
