...
4.	Lea y acepte los términos del contrato de anunciante (la primera vez que inicia sesión en el Portal de publicación) y listo.
  ...
  > Si tiene problemas para completar el registro como vendedor, abra una incidencia de soporte técnico, tal como se indica a continuación: 1. Póngase en contacto con [Soporte técnico](http://go.microsoft.com/fwlink?LinkId=272975). 2. Elija **Registro del Panel de vendedores y su cuenta**. 3. Elija **Registro para una cuenta de desarrollador** 4. Elija un **método** de contacto.
