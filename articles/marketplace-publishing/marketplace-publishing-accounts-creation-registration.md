...
3.	Inicie sesión con su cuenta Microsoft de registro de la compañía (por ejemplo, marketplace@example.com) y, si es necesario, agregue coadministradores.
  ...
  > Si tiene problemas con el registro en el Centro para desarrolladores, abra una incidencia de soporte técnico tal como se indica a continuación:
