...
4. Inicie sesión en el [Portal de vista previa de Azure](http://portal.azure.com) mediante una de las suscripciones de Azure anteriores que se enumeran en el paso anterior.
...
> La replicación por los centros de datos tarda hasta 48 horas. Cuando se complete la replicación, la oferta se mostrará en [Azure Marketplace](http://azure.microsoft.com/marketplace).
