<properties
   pageTitle="Solución de problemas comunes de soporte técnico de publicador | Microsoft Azure"
...
En este artículo se explica cómo resolver u obtener soporte técnico para algunos escenarios comunes de Marketplace, de la manera siguiente:

## Abonos y reembolsos

En algunas circunstancias, puede que necesite solicitar un abono o un reembolso en nombre de un cliente. El servicio de soporte técnico de Microsoft puede ayudar a que las solicitudes de abono o reembolso del cliente se tengan en cuenta y se reciba respuesta a su debido tiempo*.

A continuación se muestra cómo solicitar un abono o un reembolso en nombre de un cliente.

* [AZURE.NOTE]Si un cliente o distribuidor de Azure se pone en contacto con nosotros para solicitar un reembolso o un abono, aplicaremos las mismas directivas que usamos para los servicios de Azure que ofrecemos. Si nuestras directivas indican que un abono o reembolso es pagadero, emitiremos de manera anticipada (y usted nos autorizará para que lo hagamos en su nombre) un abono o reembolso al cliente o distribuidor de Azure, según proceda. En cambio, si nuestras directivas no indican que un reembolso o abono es pagadero, instaremos al cliente o distribuidor de Azure a que se ponga en contacto con usted directamente.

  ![1\_RequestRefund][1]

  1. Navegue a las páginas de soporte técnico.
  2. Seleccione **Administración de clientes**.
  3. Seleccione **Aprobar o solicitar un reembolso de cliente**.
  4. Haga clic en **Solicitud de inicio**.

  ![2\_RequestRefund][2]

5. Especificación de información de contacto
6. Complete la sección "¿Cuál es el problema" y especifique la siguiente información:

    - Identificador de suscripción del cliente afectado
    - Nombre del cliente
    - A cuánto asciende el abono
    - Período del abono
    - Fecha de factura de ese período
    - Motivo del abono

Antes de 24 horas recibirá un correo electrónico de confirmación de que hemos recibido la información que nos proporcionó. Una vez tomada una decisión con respecto a su solicitud, se le informará del resultado.
...
- Es posible que un cliente se ponga en contacto para solicitar soporte técnico.
- Tal vez no sepa cómo validar que el cliente sea un cliente legítimo de esa oferta.
- Puede registrar una solicitud de soporte técnico para solicitar la validación de la suscripción de cliente.
...
- Abra una nueva sesión exploración de incógnito en Chrome o de InPrivate en Internet para asegurarse de que no está conectado a una cuenta personal.
- Vaya a http://sellerdashboard.microsoft.com.

![inprivate][4]

**2. Inicie sesión con su cuenta de Microsoft (MSA) de registro de la empresa** (por ejemplo, AzureStore@yourcompany.com)
...
**4. Navegue a Detalles de la cuenta y Detalles de la compañía**.
...
2. Seleccione "Publicadores".
3. Seleccione "Administradores".
...
Para los siguientes problemas, registre un problema en https://portal.azure.com.

- ¿Cómo se notifica un error de facturación?
- Observo discrepancias en los extractos de facturación o de uso.
- Necesito ayuda para comprender el extracto de facturación.


Para los problemas siguientes, cree una solicitud de soporte técnico en http://go.microsoft.com/fwlink/?LinkId=272975.

- Tengo problemas para administrar servicios web.
- ¿Cómo cambio la MSA asociada a mi cuenta de vendedor?
