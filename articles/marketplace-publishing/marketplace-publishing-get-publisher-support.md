...
Microsoft ofrece soporte técnico para una amplia variedad de productos y servicios, y asegurarse de que la consulta encuentra el equipo de soporte técnico correcto es importante para garantizar una respuesta oportuna y adecuada. Considere los siguientes escenarios que le ayudarán a dirigir su consulta al equipo adecuado.

- Si es publicador en Marketplace y todavía está desarrollando la máquina virtual, debe comunicarse con los equipos de incorporación o de proceso de Microsoft.
...
- Inicio de sesión en su cuenta de Microsoft
- Navegación a las páginas de soporte técnico de publicador
- Selección del tipo de problema y la categoría
- Solicitud de soporte técnico
- Especificación de información de contacto
- Descripción del problema

## 1\. Inicio de sesión en su cuenta de Microsoft
...
## 2\. Navegación a las páginas de soporte técnico de publicador

En el menú superior derecho, seleccione "Obtener soporte técnico"

  ![Obtención de soporte técnico][2]

## 3\. Selección del tipo de problema y la categoría

![Tipo de problema y categoría][3]
...
Describa el problema tan completamente como pueda e incluya archivos (por ejemplo, capturas de pantalla, trazas de red, etc.) que puedan resultar útiles para resolver el problema.
...
Para obtener información sobre cómo resolver problemas de soporte técnico concretos, visite: [Solución de problemas comunes en Azure Marketplace](marketplace-publishing-support-common-issues.md).
