...
Una plantilla de solución es una "matriz" para todas sus topologías. Puede definir varias topologías en una oferta o plantilla de solución. Cuando se inserta una oferta en un entorno de ensayo, se inserta con todas sus topologías. A continuación se indican los pasos para definir la oferta. - Creación de una topología: el **"identificador de la topología"** suele ser el nombre de la topología en la plantilla de solución. El identificador de la topología se usará en la dirección URL, tal como se muestra a continuación:
...
Cargue un archivo zip que contiene todos los archivos necesarios para aprovisionar esa versión específica de la topología. Este archivo zip debe contener lo siguiente: - El archivo *mainTemplate.json* y *createUiDefinition.json* como raíz. - Las plantillas vinculadas y todos los scripts necesarios.
...
## Pasos siguientes
Ahora que ya creó la plantilla de solución y envió el archivo zip con los archivos necesarios para la certificación, puede continuar y seguir las instrucciones de la [Guía de contenido de marketing de Marketplace](marketplace-publishing-push-to-staging.md) para preparar la oferta para pruebas en ensayo.
...
**Extensiones de VM** - [Información general del agente de máquina virtual y las extensiones de VM](https://msdn.microsoft.com/library/azure/dn832621.aspx) - [Características y extensiones de máquina virtual de Azure](https://msdn.microsoft.com/library/azure/dn606311.aspx)

**ARM** - [Creación de plantillas de Azure ARM](../resource-group-authoring-templates/) - [Ejemplos sencillos de plantillas de ARM](https://github.com/rjmax/ArmExamples)

**Limitaciones de cuentas de almacenamiento** - [Supervisión de limitaciones de cuentas de almacenamiento](http://blogs.msdn.com/b/mast/archive/2014/08/02/how-to-monitor-for-storage-account-throttling.aspx) - [Almacenamiento Premium](../storage/storage-premium-storage-preview-portal/#scalability-and-performance-targets-whes-ESing-premium-storage)
