...
Una vez que lo haya hecho, debe instalar la versión [más reciente](https://www.powershellgallery.com/packages/Azure-Security-Center/0.0.10) de Azure Security Center desde la galería de PowerShell.
