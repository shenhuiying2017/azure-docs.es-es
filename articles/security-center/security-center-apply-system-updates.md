...
5. Seleccione un equipo de la lista para obtener más información. Se abre otro resultado de la búsqueda con la información filtrada solo para ese equipo.
