...
El icono **Partner solutions** (Soluciones de asociados) de la hoja **Security Center** permite supervisar de un vistazo el estado de mantenimiento de las soluciones de asociados que se integran con su suscripción de Azure. ![Icono Partner solutions (Soluciones de asociados)][1]

El icono **Partner solutions** (Soluciones de asociados) muestra el número de soluciones de asociados y un resumen de estado de esas soluciones.
...
1. Seleccione el icono **Partner solutions** (Soluciones de asociados). Se abre una hoja con una lista de todas las soluciones de asociados conectadas a Security Center. ![Soluciones de socios][3]

2. Seleccione una solución de asociado. En este ejemplo, seleccionaremos la solución **F5-WAF2**. Se abre una hoja que muestra que el estado de la solución de asociado y de sus recursos asociados. Seleccione **Solution console** (Consola de soluciones) para abrir la experiencia de administración de asociados de esta solución. ![Detalle de solución de asociado][4]
