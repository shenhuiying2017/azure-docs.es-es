...
Al Centro de seguridad se accede desde el [Portal de Azure](https://azure.microsoft.com/features/azure-portal/). Para más información, consulte la [documentación del portal](https://azure.microsoft.com/documentation/services/azure-portal/).
...
Puede configurar directivas de seguridad para los grupos de recursos y las suscripciones de Azure. Configuremos una **directiva** de seguridad para la suscripción:

1. Haga clic en el icono **Directiva** de la hoja **Centro de seguridad**. ![Centro de seguridad][3]
...
3. En la hoja **Directiva de seguridad**, **Recopilación de datos** está habilitado para que recopile registros de forma automática. La extensión de supervisión se aprovisiona en todas las máquinas virtuales actuales y nuevas de la suscripción. (para desactivar la recopilación de datos, en **Recopilación de datos** seleccione Off, pero si lo hace, el Centro de seguridad dejará de proporcionar alertas y recomendaciones de seguridad).
...
5. Active las **Recomendaciones** que le gustaría ver como parte de la directiva de seguridad. Ejemplos:
 ...
 - Si se activa **Reglas de la línea base**, se examinarán todas las máquinas virtuales compatibles para identificar todas las configuraciones del sistema operativo que podrían hacer que la máquina virtual resultara más vulnerable a ataques.
...
Consulte el estado de mantenimiento y seguridad de los recursos a través de **Estado de seguridad del recurso**:

1.	Vuelva a la hoja **Centro de seguridad**.
2.	El icono **Estado de seguridad del recurso** contiene indicadores del estado de seguridad de las **máquinas virtuales**, **redes**, **SQL** y **aplicaciones**.
3.	Seleccione **Máquinas virtuales** para consultar más información.
4.	La hoja **Máquinas virtuales** muestra un resumen del estado de los programas antimalware, las actualizaciones del sistema, los reinicios y las reglas de la línea de base de las máquinas virtuales.
5.	Seleccione un elemento en **VIRTUAL MACHINE RECOMMENDATIONS** (RECOMENDACIONES SOBRE MÁQUINAS VIRTUALES) para ver más información o realizar las acciones necesarias para configurar los controles necesarios.
...
Ver el estado de sus **soluciones de asociados**:
...
2. Seleccione el icono **Soluciones de asociados**. Se abre una hoja con una lista de todas las soluciones de asociados conectadas al Centro de seguridad. ![Soluciones de socios][9]
