...
> [AZURE.NOTE] En caso de conflicto entre la directiva del nivel de suscripción y la del nivel de grupo de recursos, la del nivel de recursos tiene prioridad.
