...
Obtenga información acerca de cómo usar las capacidades del Centro de seguridad de Azure para administrar y responder a las alertas de seguridad mediante este tutorial.

> [AZURE.NOTE]La información de este documento se aplica a la versión preliminar del Centro de seguridad de Azure.

## ¿Cómo administra el Centro de seguridad de Azure las alertas de seguridad?
...
### Responder a una alerta de seguridad
...
Para descartar una tarea, haga clic en el recurso para aplicar la información adicional de visualización o aplicar la configuración recomendada. Haga clic con el botón derecho en la tarea para descartarla y verá la opción **Descartar** de modo similar a la siguiente imagen:
...
## Pasos siguientes
En este documento ha aprendido a configurar directivas de seguridad en Centro de seguridad de Azure. Para obtener más información sobre Centro de seguridad de Azure, consulte el siguiente recurso:
...
- [Blog de seguridad de Azure](http://blogs.msdn.com/b/azuresecurity/): busque entradas de blog sobre el cumplimiento y la seguridad de Azure.
