...
SendGrid es un [servicio de correo electrónico basado en la nube][] (en inglés) que proporciona un sistema fiable de [entrega de correos electrónicos transaccional][] (en inglés), escalabilidad y análisis en tiempo real, además de API flexibles que facilitan la integración personalizada. Para obtener más información, consulte <http://sendgrid.com> (en inglés).
...
5.  Reemplace los marcadores de posición del script anterior por los valores correctos:
    ...
    -   ***username* y *password***: Las credenciales de SendGrid definidas en el apartado [Creación de una cuenta de SendGrid][].
