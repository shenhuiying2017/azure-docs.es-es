...
7. Para usar el emulador de la cuenta de almacenamiento local, elija el botón de opción **Emulador de almacenamiento de Microsoft Azure** y luego elija el botón **Aceptar**.
...
13. (Opcional) Para ver este archivo que ha creado al ejecuta su servicio en la nube localmente, lleve a cabo los pasos siguientes:
    ...
    5. En la barra de menús, escriba **MyStorageTest.txt** en el cuadro de texto **Búsqueda** texto y luego elija **Entrar** para iniciar la búsqueda.
