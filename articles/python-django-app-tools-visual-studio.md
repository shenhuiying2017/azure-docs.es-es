...
**Nota:** este tutorial también está encapsulado en un [vídeo de Youtube][].

**Nota:** hay disponible un [tutorial más reciente y más extenso][] sobre PTVS 2.0 Beta.
...
Antes de comenzar a desarrollar la aplicación de Azure, debe obtener las herramientas y configurar el entorno de desarrollo. Para obtener información sobre la obtención e instalación del SDK de Azure para Python, consulte [Instalación de Python][].
...
![Nuevas plantilla de proyectos de Python][]

Haga clic en **OK** y habrá creado la primera aplicación de Django.

![Visual Studio abrió el primer proyecto de Django][]
...
![Incorporación de la aplicación a settings.py en INSTALLED\_APPS][]
...
![Incorporación de un nuevo elemento a la carpeta de plantillas][]
...
![Plantilla agregada al Explorador de soluciones][]
...
![Intellisense de plantilla para filtros de Django][]
...
![Django Hello World en un explorador y el servidor de prueba][]
...
![El depurador se detuvo en el punto de interrupción de la plantilla][]
...
![Menú de aplicación de paquetes][]
...
![Su aplicación de Django en la nube][]
