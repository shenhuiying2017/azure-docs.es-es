...
<div class="dev-center-tutorial-selector sublanding"> 
  <a href="/es-es/develop/mobile/how-to-guides/work-with-net-client-library/" title=".NET Framework">.NET Framework</a>
  	<a href="/es-es/develop/mobile/how-to-guides/work-with-html-js-client/" title="HTML/JavaScript">HTML/JavaScript</a><a href="/es-es/develop/mobile/how-to-guides/work-with-ios-client-library/" title="iOS">iOS</a><a href="/es-es/develop/mobile/how-to-guides/work-with-android-client-library/" title="Android"></a><a href="/es-es/develop/mobile/how-to-guides/work-with-xamarin-client-library/" title="AndroidXamarin" class="current">Xamarin</a>
</div>


Esta guía le muestra cómo realizar tareas comunes con el cliente del componente Xamarin para Servicios móviles de Azure, en aplicaciones Xamarin para iOS y Android. Entre las tareas incluidas se encuentran la consulta, inserción, actualización y eliminación de datos, la autenticación de usuarios y la administración de errores. Si está familiarizado con Servicios móviles, considere la posibilidad de realizar el tutorial de "Inicio rápido de Servicios móviles" ([Xamarin.iOS][tutorial rápido de Xamarin.iOS]/[Xamarin.Android][tutorial rápido de Xamarin.Android]) y el tutorial "Introducción a los datos en. NET" ([Xamarin.iOS][tutorial sobre datos de Xamarin.iOS]/[Xamarin.Android][tutorial sobre datos de Xamarin.Android]). El tutorial de inicio rápido requiere [Xamarin][descarga de Xamarin] el [SDK de Servicios móviles] y le ayuda a configurar su cuenta y a crear su primer servicio móvil.
...
- [Uso de desde un servicio móvil]
...
<h2><a name="querying"></a>Uso de desde un servicio móvil</h2>
...
### <a name="lookingup"></a>Cómo: Búsqueda de datos por identificador
...
<h2><a name="inserting"></a>Uso de de datos en un servicio móvil</h2>
...
<h2><a name="modifying"></a>Uso de de datos en un servicio móvil</h2>
...
<h2><a name="deleting"></a>Uso de de datos en un servicio móvil</h2>
...
<h2><a name="authentication"></a>Uso de de usuarios</h2>
...
<h2><a name="errors"></a>Uso de de errores</h2>
...
Ahora que el servicio móvil está validando datos y enviando respuestas de error en el servidor, puede actualizar la aplicación de .NET para poder gestionar las respuestas de error a partir de la validación.
...
<h2><a name="untyped"></a>Cómo: datos sin tipo</h2>
...
[Uso de desde un servicio móvil]: #querying
...
[Uso de datos en un servicio móvil]: #inserting
[Uso de datos en un servicio móvil]: #modifying
[Uso de datos en un servicio móvil]: #deleting
[Uso de de usuarios]: #authentication
[Uso de errores]: #errors
[Uso de pruebas unitarias]: #unit-testing 
[Uso de desde un servicio móvil]: #querying
[Uso de cliente]: #customizing
[Uso de datos sin tipo]: #untyped
[De encabezados de solicitud]: #headers
...
[Autorización de los usuarios con scripts en iOS]: /es-es/develop/mobile/tutorials/authorize-users-in-scripts-xamarin-ios
[Autorización de los usuarios con scripts en Android]: /es-es/develop/mobile/tutorials/authorize-users-in-scripts-xamarin-android
