...
Las unidades de procesamiento de Event Hubs se facturan por horas, según el número máximo de unidades seleccionadas durante la hora en cuestión. También puede [aumentar el número de unidades de rendimiento](event-hubs-auto-inflate.md) de forma automática a medida que el uso sea más frecuente.
...
El soporte técnico para Event Hubs está disponible a través de los [foros de la comunidad](https://social.msdn.microsoft.com/forums/azure/home). Se ofrece de forma gratuita soporte técnico para la administración de suscripciones y la facturación.
