---
title: Introducción a los Centros de eventos en Java con Apache Storm | Microsoft Docs
...
Para obtener más información, consulte [Información general sobre Centros de eventos][Información general sobre Centros de eventos].
...
> [!NOTE]
> Solo en este tutorial, use Storm en modo local para fines de desarrollo. Consulte [Introducción a Storm en HDInsight][Introducción a Storm en HDInsight] y la documentación oficial de [Apache Storm][Apache Storm] para obtener más información sobre los patrones y las implementaciones de Storm.
> 
> 
