...
En este tutorial, aprenderá a recopilar mensajes en un centro de eventos mediante una aplicación de consola en C# y a recuperarlos en simultáneo con la biblioteca [Event Processor Host] de C#.
