...
Para obtener más información sobre el funcionamiento con SAS, consulte [Autenticación con firma de acceso compartido en Bus de servicio](service-bus-shared-access-signature-authentication.md).
