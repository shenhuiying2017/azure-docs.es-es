---
title: "Documentación sobre Azure Event Hubs: tutoriales y referencia de API | Microsoft Docs"
description: Aprenda a usar Event Hubs para ingerir millones de eventos por segundo desde los dispositivos y aplicaciones IoT conectados en un amplio conjunto de plataformas.
services: event-hubs
author: carolz
manager: carolz
layout: LandingPage
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introducción a Event Hubs mediante Azure Portal</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/azure/event-hubs/event-hubs-messaging-exceptions">Excepciones</a></p>
                        <p><a href="/azure/event-hubs/event-hubs-quotas">Cuotas</a></p>
                    </div>
                </div>
            </div>
        </div>
