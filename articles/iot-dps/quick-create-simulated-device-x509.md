...
---
# <a name="create-and-provision-an-x509-simulated-device-using-iot-hub-device-provisioning-service-preview"></a>Creación y aprovisionamiento de un dispositivo simulado X.509 con el servicio Azure IoT Hub Device Provisioning (versión preliminar)
