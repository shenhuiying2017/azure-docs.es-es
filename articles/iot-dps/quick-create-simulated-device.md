...
---
# <a name="create-and-provision-a-simulated-device-using-iot-hub-device-provisioning-services"></a>Creación y aprovisionamiento de un dispositivo simulado con Azure IoT Hub Device Provisioning Service
