...
> [WACOM.NOTE] Esta guía asume que ha instalado AzCopy 3.0.0 o posterior. AzCopy 3.x está ahora en disponibilidad general.
> Esta guía trata también el uso de AzCopy 4.0.0, que es una versión en vista previa de AzCopy. En toda esta guía, las funciones proporcionadas solo en la versión de vista previa se designan con la mención *vista previa*.
> Tenga en cuenta que, en relación a AzCopy 4.x, la funcionalidad y las opciones de línea de comandos pueden cambiar en futuras versiones.
...
-   [Copia de archivos en un recurso compartido de archivos de Azure con AzCopy (solo versión de vista previa)][Copia de archivos en un recurso compartido de archivos de Azure con AzCopy (solo versión de vista previa)]
-   [Copia de entidades de tabla de Azure con AzCopy (solo versión de vista previa)][Copia de entidades de tabla de Azure con AzCopy (solo versión de vista previa)]
-   [Versiones de AzCopy][Versiones de AzCopy]
-   [Pasos siguientes][Pasos siguientes]

## <span id="install"></span></a> Descarga e instalación de AzCopy

1.  Descargue la [versión más reciente de AzCopy][versión más reciente de AzCopy] o la [versión más reciente de vista previa][versión más reciente de vista previa].
...
| Nombre de opción                                                        | Descripción                                                                                                                                                                                                                                                                                                                                                                                                                                 | Aplicable a Almacenamiento de blobs (S/N) | Aplicable al almacenamiento de archivos (S/N) (solo versión de vista previa) | Aplicable al almacenamiento de tablas (S/N) (solo versión de vista previa) |
|-------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------|------------------------------------------------------------------------------|----------------------------------------------------------------------------|
| **/Source:\<source\>**                                                  | Especifica los datos de origen desde los que copiar. El origen puede ser un directorio del sistema de archivos, un contenedor de blobs, un directorio virtual de blobs, un recurso compartido de archivos de almacenamiento, un directorio de archivos de almacenamiento o una tabla de Azure.                                                                                                                                              | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/Dest:\<destination\>**                                               | Especifica el destino de la copia. El destino puede ser un directorio del sistema de archivos, un contenedor de blobs, un directorio virtual de blobs, un recurso compartido de archivos de almacenamiento, un directorio de archivos de almacenamiento o una tabla de Azure.                                                                                                                                                               | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/Pattern:\<file-pattern\>**                                           | Especifica un patrón de archivos que indica qué archivos se van a copiar. El comportamiento del parámetro /Pattern viene determinado por la ubicación de los datos de origen y la presencia de la opción del modo recursivo. El modo recursivo viene especificado por la opción /S.                                                                                                                                                         
                                                                            ...
                                                                            El patrón de archivos predeterminado usado cuando no se especifica un patrón de archivos es \*.\* para una ubicación del sistema de archivos, o un prefijo vacío para una ubicación de Almacenamiento de Azure. No se admite la especificación de varios patrones de archivos.                                                                                                                                                              | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | N                                                                          |
| **/DestKey:\<clave de almacenamiento\>**                                | Especifica la clave de cuenta de almacenamiento para el recurso de destino.                                                                                                                                                                                                                                                                                                                                                                 | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/DestSAS:\<sas-token\>**                                              | Especifica una firma de acceso compartido (SAS) para el contenedor de destino (si se aplica). Encierre la SAS con comillas dobles, ya que puede contener caracteres de línea de comandos especiales.                                                                                                                                                                                                                                        
                                                                            Si el recurso de destino es una tabla o un contenedor de blobs, puede especificar esta opción seguida por el token SAS, o bien puede especificar la SAS como parte del URI del blob de destino, sin esta opción.                                                                                                                                                                                                                            
                                                                            Si el origen y el destino son blobs en ambos casos, el blob de destino debe residir dentro de la misma cuenta de almacenamiento que el blob de origen.                                                                                                                                                                                                                                                                                      | Y                                         | N                                                                            | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/SourceKey:\<clave de almacenamiento\>**                              | Especifica la clave de cuenta de almacenamiento para el recurso de origen.                                                                                                                                                                                                                                                                                                                                                                  | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/SourceSAS:\<sas-token\>**                                            | Especifica una firma de acceso compartido para el contenedor de origen (si se aplica). Encierre la SAS con comillas dobles, ya que puede contener caracteres de línea de comandos especiales.                                                                                                                                                                                                                                               
                                                                            ...
                                                                            Si el origen es una tabla, es necesario proporcionar una clave o una SAS.                                                                                                                                                                                                                                                                                                                                                                   | Y                                         | N                                                                            | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/S**                                                                  | Especifica el modo recursivo para operaciones de copia. En el modo recursivo, AzCopy copiará todos los blobs o archivos que coincidan con el patrón de archivos especificado, incluidos los que se encuentren en las subcarpetas.                                                                                                                                                                                                           | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | N                                                                          |
| **/BlobType:\<block | page\>**                                          | Especifica si el blob de destino es un blob en bloques o un blob en páginas. Esta opción solamente es aplicable cuando se carga un blob; de lo contrario, se genera un error. Si el destino es un blob y esta opción no se especifica, AzCopy, de forma predeterminada, creará un blob en bloques.                                                                                                                                          | Y                                         | N                                                                            | N                                                                          |
| **/CheckMD5**                                                           | Calcula un hash MD5 para datos descargados y comprueba que el hash MD5 almacenado en la propiedad Content-MD5 del blob o archivo coincide con el hash calculado. La comprobación MD5 se desactiva de forma predeterminada, por lo que debe especificar esta opción para realizar dicha comprobación cuando se descargan datos.                                                                                                              
                                                                            ...
                                                                            AzCopy siempre establece la propiedad Content-MD5 para un blob o archivo de Azure después de cargarlo en el servicio.                                                                                                                                                                                                                                                                                                                       | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | N                                                                          |
| **/Snapshot**                                                           | Indica si se desean transferir instantáneas. Esta opción solo es válida cuando el origen es un blob.                                                                                                                                                                                                                                                                                                                                        
                                                                            ...
                                                                            De forma predeterminada, las instantáneas no se copian.                                                                                                                                                                                                                                                                                                                                                                                     | Y                                         | N                                                                            | N                                                                          |
| **/V:[Archivo de registro detallado]**                                  | Envía mensajes con el estado detallado a un archivo de registro. El nombre predeterminado del archivo de registro detallado es `AzCopyVerbose.log` en `%LocalAppData%\Microsoft\Azure\AzCopy`. Si especifica una ubicación existente para el archivo en esta opción, el registro detallado se anexará a dicho archivo.                                                                                                                      | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/Z:[carpeta de archivos de diario]**                                  | Especifica una carpeta de archivos de diario para reanudar una operación.                                                                                                                                                                                                                                                                                                                                                                   
                                                                            ...
                                                                            Tenga en cuenta que la reanudación de una operación a partir de un archivo de diario creado por una versión anterior de AzCopy no se admite.                                                                                                                                                                                                                                                                                                | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/@:parameter-file**                                                   | Especifica un archivo que contiene parámetros. AzCopy procesa los parámetros del archivo como si hubieran sido especificados en la línea de comandos.                                                                                                                                                                                                                                                                                       
                                                                            ...
                                                                            Puede especificar varios archivos de respuesta. Sin embargo, tenga en cuenta que AzCopy no admite archivos de respuesta anidados.                                                                                                                                                                                                                                                                                                           | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/Y**                                                                  | Suprime todos los mensajes de confirmación de AzCopy.                                                                                                                                                                                                                                                                                                                                                                                       | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/L**                                                                  | Especifica solamente una operación de descripción; no se copian datos.                                                                                                                                                                                                                                                                                                                                                                      | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | N                                                                          |
| **/MT**                                                                 | Establece la hora de la última modificación del archivo descargado para que coincida con la del blob o archivo de origen.                                                                                                                                                                                                                                                                                                                   | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | N                                                                          |
| **/XN**                                                                 | Excluye un recurso origen más nuevo. El recurso no se copiará si el origen es más nuevo que el destino.                                                                                                                                                                                                                                                                                                                                     | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | N                                                                          |
| **/XO**                                                                 | Excluye un recurso de origen más antiguo. El recurso no se copiará si el recurso de origen es más antiguo que el destino.                                                                                                                                                                                                                                                                                                                   | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | N                                                                          |
| **/A**                                                                  | Carga solamente archivos que tienen el atributo de archivado establecido.                                                                                                                                                                                                                                                                                                                                                                   | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | N                                                                          |
| **/IA:[RASHCNETOI]**                                                    | Carga solamente archivos que tienen cualquiera de los atributos especificados establecido.                                                                                                                                                                                                                                                                                                                                                  
                                                                            ...
                                                                            I   Archivos no indizados                                                                                                                                                                                                                                                                                                                                                                                                                   | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | N                                                                          |
| **/XA:[RASHCNETOI]**                                                    | Excluye archivos que tienen cualquiera de los atributos especificados establecido.                                                                                                                                                                                                                                                                                                                                                          
                                                                            Los atributos disponibles son los siguientes:                                                                                                                                                                                                                                                                                                                                                                                               
                                                                            R   Archivos de solo lectura                                                                                                                                                                                                                                                                                                                                                                                                                
                                                                            A   Archivos listos para archivarse                                                                                                                                                                                                                                                                                                                                                                                                         
                                                                            S   Archivos del sistema                                                                                                                                                                                                                                                                                                                                                                                                                    
                                                                            ...
                                                                            I   Archivos no indizados                                                                                                                                                                                                                                                                                                                                                                                                                   | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | N                                                                          |
| **/Delimiter:\<delimitador\>**                                          | Indica el carácter delimitador usado para delimitar directorios virtuales en un nombre de blob.                                                                                                                                                                                                                                                                                                                                             
                                                                            ...
                                                                            Esta opción solamente se aplica para descarga de blobs.                                                                                                                                                                                                                                                                                                                                                                                     | Y                                         | N                                                                            | N                                                                          |
| **/NC:\<number-of-concurrents\>**                                       | Especifica el número de operaciones simultáneas.                                                                                                                                                                                                                                                                                                                                                                                            
                                                                            ...
                                                                            El límite máximo de operaciones simultáneas es de 512.                                                                                                                                                                                                                                                                                                                                                                                      | Y                                         | S                                                                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      (solo vista previa)                                                          | N                                                                          |
| **/SourceType:Blob|Table**                                              | Especifica que el recurso `source` es un blob disponible en el entorno de desarrollo local, que se ejecuta en el emulador de almacenamiento.                                                                                                                                                                                                                                                                                                | Y                                         | N                                                                            | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/DestType:Blob|Table**                                                | Especifica que el recurso `destination` es un blob disponible en el entorno de desarrollo local, que se ejecuta en el emulador de almacenamiento.                                                                                                                                                                                                                                                                                           | Y                                         | N                                                                            | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/PKRS:\<"key1\#key2\#key3\#..."\>**                                   | Divide el rango de claves de partición para habilitar la exportación de datos de tablas en paralelo, lo que aumenta la velocidad de la operación de exportación.                                                                                                                                                                                                                                                                            
                                                                            ...
                                                                               [aa, bb)                                                                                                                                                                                                                                                                                                                                                                                                                                 
                                                                               [bb, \<última clave de partición\>]                                                                                                                                                                                                                                                                                                                                                                                                      | N                                         | N                                                                            | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/SplitSize:**<file-size>**\<file-size\>**                             | Especifica el tamaño de la división del archivo exportado en MB.                                                                                                                                                                                                                                                                                                                                                                            
                                                                            Si esta opción no se especifica, AzCopy exportará los datos de la tabla a un único archivo.                                                                                                                                                                                                                                                                                                                                                 
                                                                            Si los datos de la tabla se exportan a un blob, y el tamaño del archivo exportado alcanza el límite de 200 GB establecido para el tamaño de un blob, AzCopy dividirá el archivo exportado, incluso si no se ha especificado esta opción.                                                                                                                                                                                                    | N                                         | N                                                                            | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/EntityOperation:\<InsertOrSkip | InsertOrMerge | InsertOrReplace\>** | Especifica el comportamiento de la importación de los datos de la tabla.                                                                                                                                                                                                                                                                                                                                                                    
                                                                            ...
                                                                            InsertOrReplace: reemplaza una entidad existente o inserta una nueva entidad si esta no existe en la tabla.                                                                                                                                                                                                                                                                                                                                 | N                                         | N                                                                            | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
| **/Manifest:\<manifest-file\>**                                         | Especifica el archivo de manifiesto para la operación de importación.                                                                                                                                                                                                                                                                                                                                                                       
                                                                            El archivo de manifiesto se genera durante la operación de exportación.                                                                                                                                                                                                                                                                                                                                                                     | N                                         | N                                                                            | S                                                                          
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     (solo vista previa)                                                        |
...
## <span id="copy-files"></span></a> Copia de archivos en Almacenamiento de archivos de Azure con AzCopy (solo versión de vista previa)
...
## <span id="copy-entities"></span></a> Copia de entidades en una Tabla de Azure con AzCopy (solo versión de vista previa)
...
El archivo de datos JSON generado sigue el formato de carga para metadatos mínimos. Para obtener más información sobre el formato de carga, consulte [Formato de carga para las operaciones del servicio Tabla][Formato de carga para las operaciones del servicio Tabla].
...
| Versión    | Novedades                                                                                                                                                                                                                                                                            |
|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **V4.0.0** | **Versión actual de vista previa. Incluye toda la funcionalidad de V3.0.0. Admite también la copia de archivos a o desde el Almacenamiento de archivos de Azure, así como la copia de entidades a o desde el Almacenamiento de tablas de Azure.**                                    |
| **V3.0.0** | **Versión actual. Modifica la sintaxis de línea de comandos de AzCopy para requerir nombres de parámetro, y rediseña la ayuda de la línea de comandos. Esta versión solo admite la copia a y desde el Almacenamiento de blobs de Azure.**                                            |
| V2.5.1     | Versión actual. Optimiza el rendimiento al utilizar las opciones /xo y /xn. Soluciona errores relacionados con caracteres especiales en nombres de archivos originales y daños en archivos de diario después de que el usuario especifica una sintaxis de línea de comandos errónea. |
...
-   [AzCopy: Carga y descarga de archivos para blobs de Microsoft Azure][AzCopy: Carga y descarga de archivos para blobs de Microsoft Azure]
  ...
  [versión más reciente de vista previa]: http://aka.ms/downloadazcopypr
  ...
  [Formato de carga para las operaciones del servicio Tabla]: http://msdn.microsoft.com/library/azure/dn535600.aspx
