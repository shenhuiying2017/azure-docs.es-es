<properties urlDisplayName="Convert a WordPress Site to a Multisite" pageTitle="Conversión de un sitio de WordPress en un multisitio" metaKeywords="WordPress, Multisitio" description="Obtenga información acerca de cómo tomar un sitio web de WordPress existente creado a través de la galería en Azure y convertirlo a multisitio de WordPress" metaCanonical="" services="web-sites" documentationCenter="PHP" title="Convert a WordPress Site to a Multisite" authors="tomfitz" solutions="" manager="wpickett" editor="" />
...
Inicie sesión en el área *wp-admin* de su sitio web; debería ver un elemento nuevo bajo el menú **Herramientas** llamado **Configuración de red**. Haga clic en **Configuración de red** y complete los detalles de su red.
...
* Inicie sesión en el portal de Azure y busque su sitio web. 
...
* Haga que *awverify* apunte a *awverify.YOUR_DOMAIN.azurewebsites.net*
...
Regrese a su sitio web a través del Portal de Azure y, en esta ocasión, haga clic en la pestaña **CONFIGURAR**. El botón **MANAGE DOMAINS** debería estar disponible. Haga clic en él.

Aparece la ventana emergente *Administrar dominios personalizados*. Aquí es donde introducirá todos los dominios que desea asignar a su sitio web. Si un dominio no aparece en este lugar, no estará disponible para asignarlo dentro de WordPress, independientemente de la configuración de DNS del dominio.
...
Tome nota de la dirección IP que aparece en la parte inferior del cuadro de diálogo. La necesitará para configurar el registro D para su dominio.
...
Es importante tener en cuenta aquí que los sitios web de Azure aceptan tanto los registros CNAME como D; sin embargo, *debe* usar un registro D para permitir una asignación correcta del dominio. Un registro CNAME no se puede reenviar a otro CNAME, que es lo que Azure creó con YOUR_DOMAIN.azurewebsites.net.
...
Después de instalar y activar el complemento, visite **Configuración** > **Asignación de dominios** para configurarlo. En el primer cuadro de texto, *Dirección IP del servidor*, indique la dirección IP que usó para configurar el registro D para el dominio. Establezca cualquier *Opción de dominio* que desee (los valores predeterminados muchas veces son válidos) y haga clic en **Guardar**.
