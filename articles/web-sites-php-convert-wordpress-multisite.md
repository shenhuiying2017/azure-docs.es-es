...
*Por [Ben Lobaugh](http://ben.lobaugh.net), [Microsoft Open Technologies Inc.](http://msopentech.com)*
...
Para obtener más información sobre la configuración de subdominios frente a subdirectorios, consulte el artículo sobre[tipos de red multisitio](http://codex.wordpress.org/Before_You_Create_A_Network#Types_of_multisite_network) (en inglés) en WordPress Codex.
