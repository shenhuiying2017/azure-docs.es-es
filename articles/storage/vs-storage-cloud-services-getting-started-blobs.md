...
- Para obtener más información sobre la manipulación de blobs mediante programación, consulte [Uso del almacenamiento de blobs en .NET](storage-dotnet-how-to-use-blobs.md).
