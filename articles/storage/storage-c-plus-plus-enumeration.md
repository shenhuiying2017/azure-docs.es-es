---
title: Enumeración de recursos de almacenamiento de Azure con la biblioteca de cliente de Almacenamiento de Microsoft Azure para C++ | Microsoft Docs
...
> [!NOTE]
> Esta guía tiene como destino la biblioteca de cliente de Almacenamiento de Azure para C++ versión 2.x, que está disponible a través de [NuGet](http://www.nuget.org/packages/wastorage) o [GitHub](https://github.com/Azure/azure-storage-cpp).
> 
> 
