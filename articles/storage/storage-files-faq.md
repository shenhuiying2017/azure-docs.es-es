...
* **P. ¿Cuándo debo usar Azure Files en lugar de Azure Blobs o Azure Disks?**  
    ...
    Obtenga más información en [Decisión sobre cuándo usar Azure Blobs, Azure Files o Azure Data Disks](storage-decide-blobs-files-disks.md).
...
* **P. ¿Cómo puedo empezar a usar Azure File Storage?**  
    ...
    * [Crear un recurso compartido de Azure File mediante el portal](storage-file-how-to-create-file-share.md#create-file-share-through-the-portal)
    * [Crear un recurso compartido de Azure File mediante Powershell](storage-file-how-to-create-file-share.md#create-file-share-through-powershell)
    * [Crear un recurso compartido de Azure File mediante la CLI](storage-file-how-to-create-file-share.md#create-file-share-through-command-line-interface-cli)
...
* **P. ¿Cómo se pueden solucionar los errores de Azure File Storage?**
    ...
    En el artículo [Solución de problemas de Azure File Storage](storage-troubleshoot-file-connection-problems.md) puede ver una guía completa de solución de problemas. 
