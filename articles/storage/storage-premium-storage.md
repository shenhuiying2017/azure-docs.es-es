...
Para obtener un tutorial completo del entorno de Azure, vea [Creación de una máquina virtual de Windows en el Portal de Azure](../virtual-machines-windows-tutorial.md).
