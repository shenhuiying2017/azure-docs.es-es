...
* **Rendimiento y límites de escala de VM**
    ...
    Para obtener la información más actualizada acerca de los niveles máximos de E/S por segundo y rendimiento (ancho de banda) de las VM compatibles con Premium Storage, consulte los artículos sobre los [tamaños de VM Windows](../virtual-machines/virtual-machines-windows-sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) o [Linux](../virtual-machines/linux/sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).
...
* [Migrar a Azure Premium Storage](storage-migration-to-premium-storage.md)
