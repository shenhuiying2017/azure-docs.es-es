...
Al llamar a **ListBlobs** en el contenedor “fotos” (igual que en el ejemplo anterior), la lista que se obtenga contendrá los objetos **CloudBlobDirectory** y **CloudBlockBlob** que representan a los directorios y blobs que existen en el nivel superior. Este sería el resultado:
...
También existe la opción de establecer el parámetro **UseFlatBlobListing** del método **ListBlobs** en **true**. De este modo, todos los blobs aparecerían como **CloudBlockBlob**, independientemente el directorio. En este momento haríamos la llamada a **ListBlobs**:
