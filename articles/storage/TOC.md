...
### [Movimiento de datos](https://msdn.microsoft.com/en-us/library/azure/mt684990.aspx)
...
## REST
### [Blobs, colas, tablas y archivos](/rest/api/storageservices/importexport/storage-import-export-service-rest-api-reference)
