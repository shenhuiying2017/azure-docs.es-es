---
title: Uso del almacenamiento de colas de Node.js | Microsoft Docs
...
* Visite el repositorio del [SDK de almacenamiento de Azure para Node][SDK de almacenamiento de Azure para Node] en GitHub.
