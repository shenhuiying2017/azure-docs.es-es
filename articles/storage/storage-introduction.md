...
---
# <a name="introduction-to-microsoft-azure-storage"></a>Introducción a Almacenamiento de Microsoft Azure
...
## <a name="what-is-azure-storage"></a>¿Qué es Almacenamiento de Azure?
...
Para obtener información de precios para la replicación de cuentas de almacenamiento, consulte [Precios de Almacenamiento de Azure](https://azure.microsoft.com/pricing/details/storage/). Consulte [Regiones de Azure](https://azure.microsoft.com/regions/#services) para más información acerca de qué servicios están disponibles en cada región.
...
* [Biblioteca de cliente de almacenamiento para Java/Android](https://azure.microsoft.com/develop/java/)
...
* [API de REST del servicio Importación/Exportación de almacenamiento](storage-import-export-service.md)
