...
Consulte el documento siguiente para empezar a [desarrollar con Blobs en páginas](storage-dotnet-how-to-use-blobs.md). Por ejemplo, vea cómo obtener acceso a Blobs en páginas mediante la biblioteca de clientes de almacenamiento para. NET. 
