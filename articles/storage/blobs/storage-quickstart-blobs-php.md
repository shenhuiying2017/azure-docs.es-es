...
* Instalación del [SDK de Azure Storage para PHP](https://github.com/Azure/azure-storage-php)
...
> [Centro para desarrolladores de PHP](https://azure.microsoft.com/en-us/develop/php/)
