...
5. En la sección **Artifact Uploaders** (Cargadores de artefactos), seleccione **Microsoft Azure Storage plugin** (Complemento de almacenamiento de Microsoft Azure).
...
3. En la sección **Microsoft Azure Storage Account Configuration** (Configuración de la cuenta de almacenamiento de Microsoft Azure):
    ...
    a. Escriba el nombre de la cuenta de almacenamiento, que puede obtener en el [portal de Azure](https://manage.windowsazure.com).
