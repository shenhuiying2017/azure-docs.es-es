...
| [New-AzureRmDisk](/powershell/module/azurerm.compute/New-AzureRmDisk) | Crea un disco utilizando la configuración de disco, nombre de disco y nombre de grupo de recursos pasados como parámetros. |
