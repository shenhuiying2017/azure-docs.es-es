...
---
# <a name="microsoft-azure-storage-performance-and-scalability-checklist"></a>Lista de comprobación de rendimiento y escalabilidad de Almacenamiento de Microsoft Azure
...
## <a name="a-nameallservicesaall-services"></a><a name="allservices"></a>Todos los servicios
...
### <a name="a-namesubheading1ascalability-targets"></a><a name="subheading1"></a>Objetivos de escalabilidad
...
#### <a name="a-namesub1bandwidthabandwidth-scalability-target-for-all-services"></a><a name="sub1bandwidth"></a>Objetivo de escalabilidad de ancho de banda para todos los servicios
...
### <a name="a-namesubheading47apartition-naming-convention"></a><a name="subheading47"></a>Convención de nomenclatura de particiones
...
##### <a name="a-namesubheading2athroughput"></a><a name="subheading2"></a>Capacidad de proceso
...
##### <a name="a-namesubheading3alink-quality"></a><a name="subheading3"></a>Calidad del enlace
...
##### <a name="useful-resources"></a>Recursos útiles
Para obtener información sobre los tamaños de máquina virtual y el ancho de banda asignado, consulte los artículos sobre [Tamaños de las máquinas virtuales Windows](../virtual-machines/virtual-machines-windows-sizes.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) o [Tamaños de las máquinas virtuales Linux](../virtual-machines/virtual-machines-linux-sizes.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json).  

#### <a name="a-namesubheading4alocation"></a><a name="subheading4"></a>Ubicación
...
### <a name="a-namesubheading5acontent-distribution"></a><a name="subheading5"></a>Distribución de contenido
...
### <a name="a-namesubheading6ausing-sas-and-cors"></a><a name="subheading6"></a>Uso de SAS y CORS
...
#### <a name="a-namesubheading7agetting-data"></a><a name="subheading7"></a>Obtención de datos
...
#### <a name="a-namesubheading8auploading-data-in-batches"></a><a name="subheading8"></a>Carga de datos en lotes
...
#### <a name="a-namesubheading9aincrease-default-connection-limit"></a><a name="subheading9"></a>Aumento del límite de conexiones predeterminado
...
#### <a name="a-namesubheading10aincrease-threadpool-min-threads-if-using-synchronous-code-with-async-tasks"></a><a name="subheading10"></a>Aumento de los subprocesos mínimos ThreadPool si se usa código sincrónico con tareas asincrónicas
...
#### <a name="a-namesubheading11atake-advantage-of-net-45-garbage-collection"></a><a name="subheading11"></a>Aprovechamiento de la recolección de elementos no usados de .NET 4.5
...
### <a name="a-namesubheading12aunbounded-parallelism"></a><a name="subheading12"></a>Paralelismo no vinculado
...
### <a name="a-namesubheading13astorage-client-libraries-and-tools"></a><a name="subheading13"></a>Herramientas y bibliotecas de cliente de almacenamiento
...
#### <a name="a-namesubheading14athrottlingserverbusy"></a><a name="subheading14"></a>Limitación y servidor ocupado
...
#### <a name="a-namesubheading15anon-retryable-errors"></a><a name="subheading15"></a>Errores que no se pueden reintentar
...
#### <a name="a-namesubheading46amultiple-clients-accessing-a-single-object-concurrently"></a><a name="subheading46"></a>Acceso simultáneo a un único objeto por parte de varios clientes
...
#### <a name="a-namesubheading17acopy-blob"></a><a name="subheading17"></a>Copia de blobs
...
#### <a name="a-namesubheading18ause-azcopy"></a><a name="subheading18"></a>Uso de AzCopy
...
#### <a name="a-namesubheading19aazure-importexport-service"></a><a name="subheading19"></a>Servicio de importación y exportación de Azure
...
### <a name="a-namesubheading20ause-metadata"></a><a name="subheading20"></a>Uso de metadatos
...
#### <a name="a-namesubheading21auploading-one-large-blob-quickly"></a><a name="subheading21"></a>Carga de un blob grande rápidamente
...
#### <a name="a-namesubheading22auploading-many-blobs-quickly"></a><a name="subheading22"></a>Carga de muchos blobs rápidamente
...
### <a name="a-namesubheading23achoosing-the-correct-type-of-blob"></a><a name="subheading23"></a>Elección del tipo correcto de blob
...
### <a name="a-namesubheading24atable-specific-scalability-targets"></a><a name="subheading24"></a>Objetivos de escalabilidad específicos de tabla
...
#### <a name="a-namesubheading25ause-json"></a><a name="subheading25"></a>Uso de JSON
...
#### <a name="a-namesubheading26anagle-off"></a><a name="subheading26"></a>Desactivación de Nagle
...
#### <a name="a-namesubheading27atables-and-partitions"></a><a name="subheading27"></a>Tablas y particiones
...
##### <a name="a-namesubheading28aappend-only-and-prepend-only-patterns"></a><a name="subheading28"></a>Patrones Solo anexar y Solo anteponer
...
##### <a name="a-namesubheading29ahigh-traffic-data"></a><a name="subheading29"></a>Datos con mucho tráfico
...
##### <a name="a-namesubheading30aquery-scope"></a><a name="subheading30"></a>Ámbito de la consulta
...
##### <a name="a-namesubheading31aquery-density"></a><a name="subheading31"></a>Densidad de consulta
...
###### <a name="a-namesubheading32afiltering"></a><a name="subheading32"></a>Filtros
...
###### <a name="a-namesubheading33aprojection"></a><a name="subheading33"></a>Proyección
...
##### <a name="a-namesubheading34adenormalization"></a><a name="subheading34"></a>Desnormalización
...
##### <a name="a-namesubheading35abatching"></a><a name="subheading35"></a>Lotes
...
##### <a name="a-namesubheading37astoring-data-series-in-a-single-entity"></a><a name="subheading37"></a>Almacenamiento de series de datos en una sola entidad
...
##### <a name="a-namesubheading38astoring-structured-data-in-blobs"></a><a name="subheading38"></a>Almacenamiento de datos estructurados en blobs
...
### <a name="a-namesubheading39ascalability-limits"></a><a name="subheading39"></a>Límites de escalabilidad
...
### <a name="a-namesubheading40anagle-off"></a><a name="subheading40"></a>Desactivación de Nagle
...
### <a name="a-namesubheading41amessage-size"></a><a name="subheading41"></a>Tamaño de los mensajes
...
### <a name="a-namesubheading42abatch-retrieval"></a><a name="subheading42"></a>Recuperación por lotes
...
### <a name="a-namesubheading43aqueue-polling-interval"></a><a name="subheading43"></a>Intervalo de sondeo de la cola
...
### <a name="a-namesubheading45aapplication-architecture"></a><a name="subheading45"></a>Arquitectura de la aplicación
