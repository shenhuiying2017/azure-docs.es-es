...
AzCopy en Linux requiere .NET Core Framework (versión 1.1.x) en la plataforma. Consulte las instrucciones de instalación en la página [.NET Core](https://www.microsoft.com/net/download/linux).
