...
* **Análisis de almacenamiento de Azure**. [Análisis de Azure Storage](/rest/api/storageservices/Storage-Analytics) proporciona las métricas y registros del servicio Azure Storage.
