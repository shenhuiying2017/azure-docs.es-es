---
title: Uso de discos administrados en plantillas de Azure Resource Manager | Microsoft Docs
description: "Detalles sobre cómo usar discos administrados en plantillas de Azure Resource Manager"
services: storage
documentationcenter: 
author: jboeshart
manager: 
...
* Visite el documento [Introducción a Azure Managed Disks](storage-managed-disks-overview.md) para más información sobre los discos administrados.
