...
> Para más información sobre OAuth 2.0, consulte las especificaciones de [][]<http://oauth.net/2/></a>.
...
![Token de encabezado de solicitud][Token de encabezado de solicitud]
...
Llegado a este punto, puede configurar los valores que desea para los demás parámetros y enviar la solicitud.
  ...
  [Nuevo servidor]: ./media/api-management-howto-oauth2/api-management-oauth2-server-1.png
  ...
  [Autorización de usuario]: ./media/api-management-howto-oauth2/api-management-user-authorization.png
  [5]: ./media/api-management-howto-oauth2/api-management-user-authorization-save.png
  [Portal para desarrolladores]: ./media/api-management-howto-oauth2/api-management-developer-portal-menu.png
  [API Eco]: ./media/api-management-howto-oauth2/api-management-apis-echo-api.png
  [Open console]: ./media/api-management-howto-oauth2/api-management-open-console.png
  [Iniciar sesión]: ./media/api-management-howto-oauth2/api-management-oauth2-signin.png
  [Token de encabezado de solicitud]: ./media/api-management-howto-oauth2/api-management-request-header-token.png
