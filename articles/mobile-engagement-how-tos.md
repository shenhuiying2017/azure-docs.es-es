<properties 
   pageTitle="Guías de procedimientos de Azure Mobile Engagement" 
   description="Guías de procedimientos para Azure Mobile Engagement" 
...
# Azure Mobile Engagement: guías de procedimientos

## Introducción

En las siguientes guías de procedimientos para la interfaz de usuario de Azure Mobile Engagement se supone que usted está familiarizado con los [conceptos] básicos[Link 6] de Azure Mobile Engagement y solo trabajará después de integrar el [SDK] de Azure Mobile Engagement[Link 5] en su aplicación. Estos tutoriales se centran en la manera en que los usuarios estándar pueden usar la [interfaz de usuario][Link 1] en lugar de en el modo en que los desarrolladores pueden usar las [API] basadas en REST HTTP[Link 4]. Si tiene dificultades con alguno de estos [tutoriales],[Link 3] consulte las [guías de solución de problemas] de Azure Mobile Engagement[Link 2].

## <a name="#First">Creación de la primera campaña de notificación de inserción</a>
...
## <a name="#Test">Prueba de la campaña de notificación de inserción</a>
...
## <a name="#Personalize">Envío de inserciones personalizadas</a>
...
## <a name="#Differentiate">Diferenciación de la notificación de inserción (en la aplicación o fuera de ella)</a>
...
## <a name="#Schedule">Programación una campaña de inserción</a>
 
### Planeación del inicio de una campaña
 
![Shedule1][18]

Es 21 de marzo y tiene un anuncio que hacer, planeado para el 22 de marzo a medianoche. 
No es necesario que esté delante de la interfaz para realizar una inserción. Puede planear de antemano el minuto exacto en que se enviarán las notificaciones.
...
> Nota: Las campañas creadas sin una fecha de finalización almacenan la inserción de forma local en el dispositivo y la muestran la próxima vez que se abre la aplicación incluso si la campaña se termina manualmente.

## <a name="#TextView">Mejora de una notificación de inserción con una vista de texto</a>
...
## <a name="#WebView">Mejora de una notificación de inserción con una vista web</a>
...
- Solo notificación: es una notificación estándar simple. Esto significa que si un usuario hace clic en ella, no aparecerá ninguna vista adicional, sino que se producirá la acción asociada a ella.
- Anuncio de texto: es una notificación que invita al usuario a echar un vistazo a una vista de texto.
- Anuncio de web: es una notificación que invita al usuario a echar un vistazo a una vista web.
