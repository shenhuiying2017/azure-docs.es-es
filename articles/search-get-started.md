<properties title="Introducci&oacute;n a B&uacute;squeda de Azure" pageTitle="Introducci&oacute;n a B&uacute;squeda de Azure" description="Introducci&oacute;n a B&uacute;squeda de Azure" metaKeywords="" services="Azure Search" solutions="" documentationCenter="" authors="Heidist" manager="mblythe" videoId="" scriptId="" />
...
-   [Exploración del panel del servicio de búsqueda][Exploración del panel del servicio de búsqueda]
-   [Prueba][Prueba]
...
1.  Inicie sesión en el [portal de Azure en vista previa][portal de Azure en vista previa] usando su suscripción actual. Tenga en cuenta que esta URL lo lleva al portal de vista previa. Es indispensable el uso del portal de vista previa.
...
1.  Especifique el encabezado de la solicitud al reemplazar el host y la clave de API por valores que son válidos para su servicio.
...
2.  En el cuerpo de la solicitud, pegue los campos que componen la definición del índice.
...
-   [Creación de un ejemplo de búsqueda geográfica con Búsqueda de Azure][Creación de un ejemplo de búsqueda geográfica con Búsqueda de Azure]
...
-   [Vídeo de Canal 9: Introducción a Búsqueda de Azure][Vídeo de Canal 9: Introducción a Búsqueda de Azure]

-   [Vídeo de Canal 9: Búsqueda de Azure y datos geoespaciales][Vídeo de Canal 9: Búsqueda de Azure y datos geoespaciales]
