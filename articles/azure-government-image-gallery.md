...
Publicador|Nombre de imagen|Descripción|SO|Tamaño del disco
---|---|---|---|---
Barracuda Networks, Inc.|Barracuda NextGen Firewall de la serie F 6.2.1-057|Nota: Este dispositivo se administra mediante una aplicación cliente, para lo cual es necesario el reenvío de TCP/807. Consulte el archivo Léame de implementación https://techlib.barracuda.com/NG61/DeployAzure...|Linux|80 GB
Barracuda Networks, Inc.|Firewall de aplicaciones web de Barracuda 8.0.1.008-20160405|Nota: esta aplicación se administra a través de una interfaz de usuario web y TCP/8000 se debe enviar para ello. Consulte el archivo Léame de implementación https://techlib.barracuda.com/WAF/Azure para más información. Las aplicaciones web de Barracuda...|Linux|50 GB
...
credativ|Debian 7 Wheezy|Debian 7 Wheezy (20160405.0) para Microsoft Azure. Debian GNU/Linux es una de las distribuciones de Linux más populares. |Linux|30 GB
credativ|Debian 8 Jessie|Debian 8 Jessie (20160405.0) para Microsoft Azure. Debian GNU/Linux es una de las distribuciones de Linux más populares. |Linux|30 GB
...
Grupo de servidores de Microsoft Windows|Windows Server 2016 Core with Containers Tech Preview 4|Server aporta la amplitud y profundidad de la experiencia de Microsoft a la hora de ofrecer servicios en la nube a escala global en la infraestructura del centro de datos. Windows Server 2016 Core with Containers Technical Preview 4...|Windows|127 GB
Grupo de servidores de Microsoft Windows|Windows Server 2016 Technical Preview 4|En el núcleo de la visión del SO en la nube de Microsoft, Windows Server aporta la amplitud y profundidad de la experiencia de Microsoft a la hora de ofrecer servicios en la nube a escala global en la infraestructura del centro de datos. Windows...|Windows|128 GB
...
- [Implementación de una máquina virtual Linux](./virtual-machines/virtual-machines-linux-create-cli-complete.md)

- [Preguntas más frecuentes sobre máquinas virtuales](./virtual-machines/virtual-machines-linux-classic-faq.md)

- [Crear y cargar su propio VHD](./virtual-machines/virtual-machines-linux-about-disks-vhds.md/)
