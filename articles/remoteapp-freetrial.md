...
<properties 
    pageTitle="Prueba gratuita de 30 días de RemoteApp"
    description="Revise la prueba gratuita de 30 días de RemoteApp." 
    services="remoteapp" 
    solutions=""
    documentationCenter="" 
    authors="lizap" 
...
# Prueba gratuita de 30 días de RemoteApp

Si tiene una suscripción de Azure, puede probar RemoteApp gratis durante 30 días. Para comenzar, simplemente inicie sesión en el Portal de administración de Azure, navegue al nodo RemoteApp y, a continuación, cree una colección. Esta es una excelente manera de probar la experiencia administrativa completa antes de convertirse a una suscripción de pago de Azure RemoteApp.  
