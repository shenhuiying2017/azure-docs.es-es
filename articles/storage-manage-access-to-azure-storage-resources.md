...
| Operación REST                                         | Método de .NET                                      | Permiso con acceso de lectura público completo | Permiso con acceso de lectura público para solo para los blobs |
|--------------------------------------------------------|--------------------------------------------------|-----------------------------------------|---------------------------------------------------|
| List Containers                                        | ListContainers                                   | Solo el propietario                              | Solo el propietario                                        |
| Create Container                                       | Creación                                           | Solo el propietario                              | Solo el propietario                                        |
| Get Container Properties                               | Propiedades                                       | Todo                                     | Solo el propietario                                        |
| Get Container Metadata                                 | Metadatos                                         | Todo                                     | Solo el propietario                                        |
| Set Container Metadata                                 | Metadatos                                         | Solo el propietario                              | Solo el propietario                                        |
| Get Container ACL                                      | BlobContainerPermissions                         | Solo el propietario                              | Solo el propietario                                        |
| Set Container ACL                                      | BlobContainerPermissions                         | Solo el propietario                              | Solo el propietario                                        |
| Delete Container                                       | Eliminar                                           | Solo el propietario                              | Solo el propietario                                        |
| List Blobs                                             | ListBlobs                                        | Todo                                     | Solo el propietario                                        |
| Put Blob                                               | Crear el método de CloudPageBlob o CloudBlockBlob | Solo el propietario                              | Solo el propietario                                        |
| Get Blob                                               | DownloadByteArray y otros                     | Todo                                     | Todo                                               |
| Get Blob Properties                                    | Propiedades                                       | Todo                                     | Todo                                               |
| Set Blob Properties                                    | SetProperties                                    | Solo el propietario                              | Solo el propietario                                        |
| Get Blob Metadata                                      | Metadatos                                         | Todo                                     | Todo                                               |
| Set Blob Metadata                                      | Metadatos                                         | Solo el propietario                              | Solo el propietario                                        |
| Put Block                                              | PutBlock                                         | Solo el propietario                              | Solo el propietario                                        |
| Get Block List (solo bloques confirmados)                 | DownloadBlockList                                | Todo                                     | Todo                                               |
| Get Block List (solo bloques sin confirmar o todos los bloques) | DownloadBlockList                                | Solo el propietario                              | Solo el propietario                                        |
| Put Block List                                         | PutBlockList                                     | Solo el propietario                              | Solo el propietario                                        |
| Delete Blob                                            | Eliminar                                           | Solo el propietario                              | Solo el propietario                                        |
| Copia de blobs                                              | CopyFromBlob                                     | Solo el propietario                              | Solo el propietario                                        |
| Instantánea de blob                                          | CreateSnapshot                                   | Solo el propietario                              | Solo el propietario                                        |
| Lease Blob                                             | Concesión                                            | Solo el propietario                              | Solo el propietario                                        |
| Put Page                                               | WritePages                                       | Solo el propietario                              | Solo el propietario                                        |
| Get Page Ranges                                        | GetPageRanges                                    | Todo                                     |                                                   |
...
>[AZURE.NOTE]Para obtener información general conceptual detallada, así como un tutorial acerca de las firmas de acceso compartido, vea [Firmas de acceso compartido](http://azure.microsoft.com/documentation/articles/storage-dotnet-shared-access-signature-part-1/).
...
Para obtener información sobre el formato del URI de una firma de acceso compartido, consulte [Delegar el acceso con una firma de acceso compartido](https://msdn.microsoft.com/library/ee395415.aspx).
...
Un cliente que reciba una firma de acceso compartido, puede usarla desde el código para así crear un objeto de tipo [StorageCredentials](https://msdn.microsoft.com/library/microsoft.windowsazure.storage.auth.storagecredentials.aspx). Esas credenciales pueden usarse para construir un objeto [CloudStorageAccount](https://msdn.microsoft.com/library/microsoft.windowsazure.storage.cloudstorageaccount.aspx) o [CloudBlobClient](https://msdn.microsoft.com/library/microsoft.windowsazure.storage.blob.cloudblobclient.aspx), los cuales pueden usarse para trabajar con el recurso, tal y como se muestra en este ejemplo:
