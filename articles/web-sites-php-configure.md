<properties 
	pageTitle="Configuración de PHP en Sitios web Azure" 
	description="Obtenga información acerca de cómo configurar la instalación de PHP predeterminada o agregar una instalación de PHP personalizada en sitios web de Azure." 
	services="" 
...
* [Uso de de la configuración predeterminada de PHP](#ChangeBuiltInPHP)
* [Uso de Habilitación de extensiones en el tiempo de ejecución de PHP integrado](#EnableExtDefaultPHP)
* [Uso de de un tiempo de ejecución de PHP personalizado](#UseCustomPHP)
...
<h2><a name="ChangeBuiltInPHP"></a>Cómo: de la configuración predeterminada de PHP</h2>
...
<h2><a name="EnableExtDefaultPHP"></a>Cómo: de extensiones en el tiempo de ejecución de PHP predeterminado</h2>
Como bien se ha mencionado en la sección anterior, la mejor forma de ver la versión de PHP predeterminada, su configuración predeterminada y las extensiones habilitadas es implementar un script que llame a [phpinfo()]. Para habilitar extensiones adicionales, siga los pasos que se detallan a continuación.
...
<h2><a name="UseCustomPHP"></a>Cómo: de un tiempo de ejecución de PHP personalizado</h2>
...
1. En la sección **handler mappings**, agregue `*.php` a EXTENSION y agregue la ruta de acceso al archivo ejecutable  `php-cgi.exe`. Si coloca el tiempo de ejecución de PHP en el directorio  `bin` en la raíz de la aplicación, la ruta de acceso será  `D:\home\site\wwwroot\bin\php\php-cgi.exe`.
...
[Configuración, supervisión y escalado de los sitios web en Azure]: http://azure.microsoft.com/manage/services/web-sites/
[Descarga del SDK de Azure para PHP]: http://azure.microsoft.com/develop/php/common-tasks/download-php-sdk/
