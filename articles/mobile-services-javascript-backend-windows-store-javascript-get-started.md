...
* [Incorporación de autenticación a la aplicación][Introducción a la autenticación]
...
<!-- URLs. -->
[Introducción a los datos]: mobile-services-javascript-backend-windows-universal-javascript-get-started-data.md
