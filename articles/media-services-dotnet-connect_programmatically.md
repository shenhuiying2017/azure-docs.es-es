...
CloudMediaContext tiene cinco sobrecargas de constructor. Se recomienda usar constructores que toman **MediaServicesCredentials** como un parámetro. Para obtener más información, vea **Reutilización de los tokens del Servicio de control de acceso** a continuación. 
