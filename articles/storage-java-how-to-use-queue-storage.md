...
* [Incorporación siguiente mensaje](#peek-message)
* [Incorporación contenido de un mensaje en cola](#change-message)
* [Incorporación de la longitud de la cola](#get-queue-length)
* [Incorporación el siguiente mensaje de la cola](#dequeue-message)
* [Opciones adicionales para quitar mensajes de la cola](#additional-options)
* [Escucha de las colas](#list-queues)
* [Esucha de una cola](#delete-queue)
...
## <a name="create-queue"> </a>Reproducción de una cola
...
## <a name="add-message"> </a>Reproducción de un mensaje a una cola
...
## <a name="peek-message"> </a>Reproducción de siguiente mensaje
...
## <a name="change-message"> </a>Reproducción de contenido de un mensaje en cola
...
## <a name="get-queue-length"> </a>Reproducción de la longitud de la cola
...
## <a name="dequeue-message"> </a>Reproducción de siguiente mensaje de la cola
...
## <a name="list-queues"> </a>Reproducción de las colas
...
## <a name="delete-queue"> </a>Reproducción de una cola
