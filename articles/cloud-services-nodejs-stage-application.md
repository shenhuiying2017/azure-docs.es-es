<properties urlDisplayName="Staging Deployment" pageTitle="Implementaci&oacute;n de ensayo de un servicio en la nube (Node.js) - Azure" metaKeywords="Azure staging, Azure application staging, Azure test environment, Azure staging environment, Azure Virtual IP swap, Azure VIP swap" description="Vea c&oacute;mo implementar su aplicaci&oacute;n de Azure en un entorno de ensayo y despu&eacute;s en un entorno de producci&oacute;n mediante el intercambio de IP virtuales (VIP)." metaCanonical=" " services="cloud-services" documentationCenter="nodejs" title="Ensayo de una aplicaci&oacute;n en Azure" authors="larryfr" solutions="" manager="wpickett" editor="" />
