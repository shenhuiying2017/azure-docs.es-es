...
1.	**Cuentas de suscripción y almacenamiento:** debe disponer de una suscripción a Azure existente y una o más cuentas de almacenamiento para utilizar el servicio de importación y exportación. Cada trabajo puede usarse para transferir datos hacia o desde solamente una cuenta de almacenamiento. En otras palabras, un trabajo no puede abarcar varias cuentas de almacenamiento. Para obtener más información acerca de cómo crear una nueva cuenta de almacenamiento, consulte [Cómo crear una cuenta de almacenamiento](../storage-create-storage-account/).
