---
title: Autenticación y autorización para Aplicaciones de API en el Servicio de aplicaciones de Azure | Microsoft Docs
...
## Información general
> [!NOTE]
> Este tema se migrará a un tema de [Autenticación/autorización del servicio de aplicaciones](../app-service/app-service-authentication-overview.md) consolidado, que abarca la web, los móviles y las aplicaciones de API.
> 
> 
