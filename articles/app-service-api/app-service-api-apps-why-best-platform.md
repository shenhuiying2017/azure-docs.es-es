...
Para empezar a trabajar con Aplicaciones de API, siga uno de los tutoriales de [Introducción a Aplicaciones de API y ASP.NET en el Servicio de aplicaciones de Azure](app-service-api-dotnet-get-started.md).
