<properties urlDisplayName="Monitor with AppDynamics" pageTitle="Uso de AppDynamics con Azure" metaKeywords="" description="Aprenda a utilizar AppDynamics para Azure." metaCanonical="" services="cloud-services" documentationCenter="" title="Uso de AppDynamics para Azure" authors="ryanwi" solutions="" manager="timlt" editor="" />
...
-   [¿Qué es AppDynamics?][¿Qué es AppDynamics?]
-   [Requisitos previos][Requisitos previos]
-   [Registro para obtener una cuenta de AppDynamics][Registro para obtener una cuenta de AppDynamics]
-   [Descarga de .NET Agent desde AppDynamics][Descarga de .NET Agent desde AppDynamics]
-   [Incorporación de .NET Agent a los roles de Azure y modificación del inicio][Incorporación de .NET Agent a los roles de Azure y modificación del inicio]
-   [Publicación de la aplicación instrumentada con AppDynamics en Azure][Publicación de la aplicación instrumentada con AppDynamics en Azure]
-   [Supervisión de una aplicación][Supervisión de una aplicación]
...
-   Controlador de AppDynamics: El agente envía su información a un servicio hospedado del controlador de AppDynamics en Azure. Con una consola basada en un explorador web, se inicia sesión en el controlador para supervisar, analizar y solucionar problemas en la aplicación.
    ...
    ![Diagrama de AppDynamics][Diagrama de AppDynamics]
...
1.  Haga clic en **Try Free** o **Sign Up** para AppDynamics en el Azure Marketplace en <https://datamarket.azure.com/browse/Applications>.
...
Las últimas actualizaciones de este documento están en la versión wiki en <http://docs.appdynamics.com/display/ADAZ/How+To+Use+AppDynamics+for+Windows+Azure>.
