...
|Característica|Entre julio y septiembre de 2014|Entre octubre y diciembre de 2014|Entre enero y marzo de 2015|Entre abril y junio de 2015|
|-----------|-------|-------|-------|-------|
|Carga de las aplicaciones de línea de negocio \(LOB\) a una colección en la nube, así como a una colección híbrida|X| | | |
|Compatibilidad con Windows Phone| |X| | |
|Panel de métricas de uso| |X| | | 	
|Aprovisionamiento de un gran número de usuarios mediante un archivo CSV | |X| | |
|Disponibilidad en centros de datos australianos| | |X| |
