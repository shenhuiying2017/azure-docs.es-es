<properties 
	pageTitle="Evaluación del rendimiento de un modelo en Aprendizaje automático de Azure | Azure" 
...
Conectar los puertos, tal y como se muestra en la Figura 1 y establezca la columna de etiqueta del **módulo Entrenar modelo** en *price*.
...
Después de ejecutar el experimento, puede hacer clic en el puerto de salida del módulo **Evaluar modelo** y seleccionar *Visualize* para ver los resultados de la evaluación. Las métricas de evaluación disponibles para los modelos de regresión son: *Mean Absolute Error*, *Root Mean Absolute Error*, *Relative Absolute Error*, *Relative Squared Error* y  *Coefficient of Determination*.
...
Figura 2. Métricas de evaluación de regresión lineal.
...
Conecte los puertos, tal y como se muestra en la Figura 5 y establezca la columna de etiqueta del módulo **Entrenar modelo** en *income*.
...
Figura 7. Resultados de la evaluación de clasificación binaria.
...
En este experimento se usará el conocido conjunto de datos [Iris](http://archive.ics.uci.edu/ml/datasets/Iris "Iris"), que contiene las instancias de 3 tipos (clases) distintos de la planta iris. Hay 4 valores de características (longitud y ancho del sépalo y del pétalo) para cada instancia. En los experimentos anteriores se entrenaron y probaron los modelos con los mismos conjuntos de datos. Aquí, se usará el módulo Dividir para crear 2 subconjuntos de los datos, de entrenamiento en el primero, y de puntuación y evaluación en el segundo. 
El conjunto de datos Iris está disponible públicamente en el repositorio [UCI Machine Learning Repository](http://archive.ics.uci.edu/ml/index.html) y se puede descargar con un módulo **Lector**.
...
Haga clic en el módulo **Lector** y establezca la propiedad *Data source* en *Web URL via HTTP*y la *URL* en http://archive.ics.uci.edu/ml/machine-learning-databases/iris/iris.data.

Establezca la fracción de instancias que se usarán para el entrenamiento en el módulo **Dividir** (en 0,7 por ejemplo).
