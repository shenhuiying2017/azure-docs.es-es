<properties pageTitle="Inicio de sesión en una máquina virtual que ejecuta Windows Server" description="Aprenda a utilizar el Portal de administración de Azure para iniciar sesión en una máquina virtual que ejecuta Windows Server." services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor="tysonn"/>
