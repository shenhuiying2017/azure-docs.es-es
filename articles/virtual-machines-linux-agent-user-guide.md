<properties urlDisplayName="Linux Agent guide" pageTitle="Guía de usuario del Agente de Linux para Azure" metaKeywords="" description="Learn how to install and configure Linux Agent (waagent) to manage your virtual machine's interaction with Azure Fabric Controller." metaCanonical="" services="virtual-machines" documentationCenter="" title="Azure Linux Agent User Guide" authors="szarkos" solutions="" manager="timlt" editor="" />
 ...
 * Crea el script init de SysV (/etc/init.d/waagent), el archivo de configuración logrotate (/etc/logrotate.d/waagent and configures the image to run the init script on boot
