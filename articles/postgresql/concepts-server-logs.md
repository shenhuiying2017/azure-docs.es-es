...
- Para obtener acceso a registros mediante la interfaz de la línea de comandos de Azure, consulte cómo [Configuración y acceso a los registros del servidor con la CLI de Azure](howto-configure-server-logs-using-cli.md).
