...
Para el nivel básico, las copias de seguridad están disponibles durante 7 días. Para el nivel estándar, las copias de seguridad están disponibles durante 35 días. Para más información, consulte el artículo de [planes de tarifa de Azure Database for PostgreSQL](concepts-pricing-tiers.md).
