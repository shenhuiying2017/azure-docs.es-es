...
## <a name="postgresql-version-957"></a>PostgreSQL 9.5.7
Consulte la [documentación de PostgreSQL](https://www.postgresql.org/docs/9.5/static/release-9-5-7.html) para obtener información sobre las mejoras y correcciones de PostgreSQL 9.5.7.
