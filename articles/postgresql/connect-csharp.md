...
# Azure Database for PostgreSQL: uso de .NET (C#) para conectarse y consultar datos
...
### **Microsoft .NET Framework y .NET Core**
...
## Instalación de referencias de Npgsql en la solución de Visual Studio
