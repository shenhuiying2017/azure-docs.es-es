<properties urlDisplayName="Get started with custom authentication" pageTitle="Introducción a la autenticación personalizada | Centro de desarrollo móvil" metaKeywords="" description="Obtenga información acerca de cómo autenticar usuarios con un nombre de usuario y una contraseña." metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Get started with custom authentication" authors="mahender" manager="dwrede" />
