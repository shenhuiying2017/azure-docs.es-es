...
Para enviar una notificación usando un servicio móvil, siga la [Introducción a los Servicios móviles](/en-us/develop/mobile/tutorials/get-started-xamarin-android/#create-new-service) y, a continuación:
