...
### <a name="a-nameaccountaaccount"></a><a name="account"></a>cuenta
...
### <a name="a-nameavailability-setaavailability-set"></a><a name="availability-set"></a>conjunto de disponibilidad
...
### <a name="a-nameclassic-modelaazure-classic-deployment-model"></a><a name="classic-model"></a>modelo de implementación clásica de Azure
...
### <a name="a-namecliaazure-command-line-interface-cli"></a><a name="cli"></a>Interfaz de la línea de comandos (CLI) de Azure
...
### <a name="a-namefault-domainafault-domain"></a><a name="fault-domain"></a>dominio de error
...
### <a name="a-namegeoageo"></a><a name="geo"></a>geoárea
...
### <a name="a-namegeo-replicationageo-replication"></a><a name="geo-replication"></a>replicación geográfica
...
### <a name="a-nameimageaimage"></a><a name="image"></a>imagen
...
### <a name="a-namelimitsalimits"></a><a name="limits"></a>límites
...
### <a name="a-nameload-balanceraload-balancer"></a><a name="load-balancer"></a>equilibrador de carga
...
### <a name="a-nameregionaregion"></a><a name="region"></a>región
...
### <a name="a-namearm-templatearesource-manager-template"></a><a name="arm-template"></a>plantilla de Resource Manager
...
### <a name="a-nameresource-provideraresource-provider"></a><a name="resource-provider"></a>proveedor de recursos
...
### <a name="a-namerolearole"></a><a name="role"></a>rol
...
### <a name="a-nameslaaservice-level-agreement-sla"></a><a name="sla"></a>contrato de nivel de servicio (SLA)
...
### <a name="a-namestorage-accountastorage-account"></a><a name="storage-account"></a>cuenta de almacenamiento
...
### <a name="a-namesubscriptionasubscription"></a><a name="subscription"></a>suscripción
...
### <a name="a-nametagatag"></a><a name="tag"></a>etiqueta
...
### <a name="a-nameupdate-domainaupdate-domain"></a><a name="update-domain"></a>dominio de actualización
...
### <a name="a-namevm-extensionavirtual-machine-extension"></a><a name="vm-extension"></a>extensión de máquina virtual
...
### <a name="a-namevnetavirtual-network"></a><a name="vnet"></a>red virtual
