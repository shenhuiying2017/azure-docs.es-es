        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Introducción a la inserción de informes con una aplicación de ejemplo.</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="https://docs.microsoft.com/en-us/rest/api/power-bi-embedded/">Referencia de la API de REST de Azure Resource Manager</a></p>
                        <p><a href="https://msdn.microsoft.com/library/mt147898.aspx">Referencia de API de REST</a></p>
                    </div>
                </div>
            </div>
        </div>
