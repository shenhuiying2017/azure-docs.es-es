...
En la actualidad, ofrecemos a los clientes de SQL Server las ventajas de la movilidad de licencias de Software Assurance, que permite la reasignación de sus licencias a servidores de terceros compartidos. Esta ventaja puede usarse en IaaS de Azure y AWS EC2.
...
SQL Database se factura según una tarifa horaria predecible basada en el [modelo de compra](sql-database-service-tiers.md). El uso real se procesa y se prorratea por horas, por lo que su factura podría mostrar fracciones de una hora. Por ejemplo, si una base de datos existe durante 12 horas al mes, la factura mostrará un uso de 0,5 días. 
...
Para más información, consulte [Precios de SQL Database](https://azure.microsoft.com/pricing/details/sql-database/) y [Niveles de servicio](sql-database-service-tiers.md).
