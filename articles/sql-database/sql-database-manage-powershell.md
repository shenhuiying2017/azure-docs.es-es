...
Copie una base de datos SQL en el mismo servidor con el cmdlet [AzureRmSqlDatabaseCopy nuevo](https://msdn.microsoft.com/library/azure/mt603644.aspx). Establezca `-CopyServerName` y `-CopyResourceGroupName` en los mismos valores que el grupo de recursos y el servidor de bases de datos de origen.
...
Elimine una base de datos SQL con el cmdlet [Remove-AzureRmSqlDatabase](https://msdn.microsoft.com/library/azure/mt619368.aspx). El grupo de recursos, el servidor y la base de datos ya deben existir en la suscripción.
