...
---
# <a name="create-a-sql-database-and-perform-common-database-setup-tasks-with-powershell-cmdlets"></a>Creación de una nueva Base de datos SQL y realización de tareas comunes de configuración de base de datos con los cmdlets de PowerShell
...
## <a name="database-setup-create-a-resource-group-server-and-firewall-rule"></a>Configuración de la base de datos: creación de un grupo de recursos, un servidor y una regla de firewall
...
### <a name="configure-a-server-firewall-rule-to-allow-access-to-the-server"></a>Configuración de una regla de firewall para permitir el acceso al servidor
Establezca una regla de firewall para tener acceso al servidor. Ejecute el comando [New-AzureRmSqlServerFirewallRule](https://msdn.microsoft.com/library/azure/mt603860\(v=azure.300\).aspx) , reemplazando las direcciones IP inicial y final por los valores válidos para el equipo.
...
El siguiente comando [New-AzureRmSqlDatabase](https://msdn.microsoft.com/library/azure/mt619339\(v=azure.300\).aspx) crea una SQL Database (en blanco) en el nivel de servicio Standard con un nivel de rendimiento S1:
...
## <a name="create-a-sql-database-powershell-script"></a>Creación de un script de PowerShell de base de datos SQL
...
* [Cmdlets de Azure SQL Database](https://msdn.microsoft.com/library/azure/mt574084\(v=azure.300\).aspx)
