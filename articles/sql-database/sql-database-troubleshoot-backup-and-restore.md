<properties
	pageTitle="Solucionar problemas de copia de seguridad y restauración de la Base de datos SQL de Azure"
	description="Obtenga información sobre cómo recuperar una base de datos de nube de errores e interrupciones mediante copias de seguridad y réplicas de Base de datos SQL de Azure."
...
Base de datos SQL mantiene réplicas de la base de datos para poder recuperar de interrupciones y errores del usuario. Las opciones disponibles dependen del nivel de servicio de la base de datos y de las opciones que elija. Vea la [Información general de continuidad empresarial](sql-database-business-continuity.md) para detalles y consideraciones de diseño.
