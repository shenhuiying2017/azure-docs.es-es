...
## <a name="troubleshooting-sync"></a>Solución de problemas de sincronización
...
## <a name="troubleshooting-the-client-agent"></a>Solución de problemas del agente cliente
...
-   Cree un nuevo agente en el mismo centro de datos que el grupo de sincronización y registre la base de datos con ese agente.
...
## <a name="troubleshooting-setup-and-maintenance"></a>Solución de problemas de configuración y mantenimiento
...
3. Añada la cuenta de usuario en el cuadro de diálogo **Propiedades**: **Iniciar sesión como servicio**.
