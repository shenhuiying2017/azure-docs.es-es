...
## <a name="a-idsubheading-8ablobtable-differences-in-server-auditing-policy-inheritance"></a><a id="subheading-8"></a>Diferencias de blobs o tablas en la herencia de directivas de auditoría de servidor
