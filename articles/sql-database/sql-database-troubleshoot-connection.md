---
title: La base de datos en el servidor no está disponible en estos momentos, al conectar con la base de datos SQL | Microsoft Docs
description: 'Solución de problemas del error '
;la: ''
base: ''
de: ''
datos: ''
