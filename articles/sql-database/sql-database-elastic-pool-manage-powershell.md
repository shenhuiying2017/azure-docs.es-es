...
Puede mover una base de datos dentro o fuera de un grupo elástico con el cmdlet [Set-AzureRmSqlDatabase](https://docs.microsoft.com/powershell/module/azurerm.sql/set-azurermsqlelasticpool).
