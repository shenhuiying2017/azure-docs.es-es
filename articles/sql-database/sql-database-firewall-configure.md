...
Los intentos de conexión desde Internet y Azure deben atravesar primero el firewall antes de poder alcanzar su base de datos o servidor de Base de datos SQL de Azure, como se muestra en el siguiente diagrama.
   ...
   ![Diagrama donde se describe la configuración del firewall de base de datos SQL.][1]
...
- En la pestaña **Configurar** de un servidor, en la sección **Servicios permitidos**, haga clic en **Sí** en la opción **Servicios de Microsoft Azure**.
...
- **Dirección IP dinámica:** si tiene una conexión a Internet con una dirección IP dinámica y tiene problemas para pasar por el firewall, puede intentar una de las siguientes soluciones:
