<properties
	pageTitle="SQL Database tutorial: Protect sensitive data with Always Encrypted (Tutorial de base de datos SQL: protección de datos confidenciales con Always Encrypted) | Microsoft Azure"
	description="Proteger datos confidenciales en la base de datos SQL en cuestión de minutos."
	keywords="tutorial de base de datos SQL, cifrado de datos en una base de datos SQL"	
...
En este tutorial se muestra cómo proteger datos confidenciales mediante la implementación de Always Encrypted en una base de datos SQL en solo unos pocos minutos mediante SQL Server Management Studio (SSMS).
...
- una cuenta de Azure y una suscripción antes de empezar. Si no tiene una, suscríbase para [una prueba gratuita](http://azure.microsoft.com/pricing/free-trial/).
...
4. **Configuración de la clave maestra** (CMK)
    ...
    Compruebe que el **almacén de certificados de Windows** está seleccionado y haga clic en **Siguiente**.
...
2. Denomine el proyecto **AlwaysEncryptedConsoleApp** y haga clic en **Aceptar**.
...
- [Giro y limpieza de claves](https://msdn.microsoft.com/library/mt607048.aspx).
