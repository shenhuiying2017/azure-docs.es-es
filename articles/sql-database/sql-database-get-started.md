---
title: 'Tutorial de Base de datos SQL: creación de una base de datos SQL | Microsoft Docs'
...
[!INCLUDE [Creación de una regla de firewall del servidor](../../includes/sql-database-create-new-server-firewall-portal.md)]
