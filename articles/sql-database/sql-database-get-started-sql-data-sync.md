...
Siga la instrucción de [Instalar un cliente de agente de SQL Data Sync](http://msdn.microsoft.com/library/jj823137.aspx) para instalar el agente. 


<h3><a id="RegisterSSDb"></a>Paso 2c: Finalizar el Asistente para el nuevo agente de SQL Data Sync</h3> 

1. 	Vuelva al Asistente de nuevo agente de SQL Data Sync.
2.	Ponga un nombre descriptivo al agente.
3.	En el menú desplegable, seleccione **REGIÓN** (centro de datos) para hospedar a este agente.
4.	En el menú desplegable, seleccione **SUSCRIPCIÓN** para hospedar a este agente.
...
Para registrar una base de datos con el agente, siga las instrucciones de [Registrar una base de datos de SQL Server con un cliente de agente](http://msdn.microsoft.com/library/jj823138.aspx).
...
2.	En el menú desplegable, seleccione **REGIÓN** (centro de datos) para hospedar a este grupo de sincronización.
...
2. Escriba las credenciales para esta sesión de la base de datos SQL: **NOMBRE DE USUARIO** y **CONTRASEÑA** de la base de datos central.
...
3.	En el menú desplegable, seleccione **DIRECCIÓN DE SINCRONIZACIÓN** para esta base de datos.
	...
	**Sincronizar desde la base de datos central**: la base de datos recibe actualizaciones desde la base de datos central. Sin embargo, no envía los cambios al concentrador.
...
5.	Haga clic en la marca de verificación otra vez. De este modo, volverá a la página **SINCRONIZACIÓN**, debajo de Bases de datos SQL. Este grupo de sincronización ahora aparece con los demás grupos de sincronización y agentes.
