---
title: "Introducción a Detección de amenazas de Base de datos SQL"
...
---
# <a name="get-started-with-sql-database-threat-detection"></a>Introducción a Detección de amenazas de Base de datos SQL
