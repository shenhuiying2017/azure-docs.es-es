<properties 
	pageTitle="Preguntas más frecuentes sobre el Escalado elástico de SQL Azure" 
...
# Preguntas más frecuentes sobre el Escalado elástico de la Base de datos SQL de Azure 
...
El objeto de información del esquema solo se usa en escenarios de combinación o división. Si una aplicación es inherentemente de un solo inquilino, no requiere el servicio de combinación o división y, por lo tanto, no es necesario rellenar el objeto de información del esquema.
...
Consulte **[Agregar una partición a una aplicación de Escalado elástico](http://azure.microsoft.com/documentation/articles/sql-database-elastic-scale-add-a-shard/)**. 

#### ¿Cuánto cuesta el Escalado elástico?
El uso de la biblioteca de Escalado elástico no incurre en costes. Los costes se acumulan solo para las bases de datos SQL de Azure que usa para particiones y el Administrador de asignación de particiones, así como los roles web/de trabajo aprovisionados para el servicio de combinación o división.
...
#### Tengo preguntas acerca del uso de Escalado elástico, ¿cómo puedo obtener ayuda? 
...
#### ¿El servicio de combinación o división aprovisiona (o elimina) una base de datos durante una operación de combinación o división? 
