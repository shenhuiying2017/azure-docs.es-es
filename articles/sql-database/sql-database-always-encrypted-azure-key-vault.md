...
* [Azure PowerShell](/powershell/azureps-cmdlets-docs), versión 1.0 o posterior. Escriba **(Get-Module azure -ListAvailable).Version** para ver qué versión de PowerShell se está ejecutando.
