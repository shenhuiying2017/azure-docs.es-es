...
# Protect sensitive data in SQL Database with data encryption and store your encryption keys in the Azure Key Vault (Protección de los datos confidenciales en Base de datos SQL con cifrado de datos y almacenamiento de las claves de cifrado en el Almacén de claves de Azure)
