...
Para más información acerca de cómo realizar la conexión a la base de datos SQL, consulte [Conexión con SQL Server Management Studio (SSMS)](sql-database-connect-to-database.md)
