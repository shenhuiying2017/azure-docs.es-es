...
### Adición de una regla de firewall de nivel a servidor a través del Portal de Azure
...
Una regla de firewall de servidor afecta a todas las bases de datos SQL del servidor SQL de Azure. Si lo que desea es configurar una regla de firewall a nivel de base de datos que afecte solo a una base de datos única, consulte [sp\_set\_firewall\_rule (Base de datos SQL Azure)](https://msdn.microsoft.com/library/dn270017.aspx").
