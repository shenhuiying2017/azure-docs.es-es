...
4. En la hoja de la base de datos, seleccione **Toda la configuración** y luego seleccione **Plan de tarifa (escalar DTU)**.
...
6. Opcionalmente, haga clic en **Ver detalles de uso** para abrir la hoja **Detalles de recomendaciones de niveles de precios** donde puede ver el nivel recomendado para la base de datos, una comparación de características entre los niveles actuales y recomendados y un gráfico del análisis de uso de recursos históricos.
