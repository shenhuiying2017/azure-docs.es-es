...
Si tiene una base de datos existente, compruebe que está alojada en Base de datos SQL v12 conectándose a la base de datos (por ejemplo con SQL Server Management Studio) y ejecutando `SELECT @@VERSION;`. El resultado esperado para una base de datos en Base de datos SQL v12 es al menos **Microsoft SQL Azure (RTM) - 12.0**. 
