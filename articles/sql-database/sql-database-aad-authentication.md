---
title: Conexión a Base de datos SQL o a Almacenamiento de datos SQL mediante autenticación de Azure Active Directory | Microsoft Docs
...
> [!NOTE]
> Los usuarios de Azure AD se marcan en los metadatos de la base de datos con el tipo E (EXTERNAL\_USER) y en los grupos con el tipo X (EXTERNAL\_GROUPS). Para obtener información, vea [sys.database\_principals](https://msdn.microsoft.com/library/ms187328.aspx).
> 
> 
