---
title: Uso de SQL Server Management Studio para determinar la compatibilidad con bases de datos SQL antes de la migración a Base de datos SQL de Azure | Microsoft Docs
