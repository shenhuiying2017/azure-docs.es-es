...
* [Conmutación por error a una base de datos secundaria con replicación geográfica mediante Transact-SQL](/sql/t-sql/statements/alter-database-azure-sql-database)
