...
## Niveles de servicio de bases de datos independientes y niveles de rendimiento
...
- Aprenda los detalles sobre los [grupos elásticos](sql-database-elastic-pool-guidance.md) y las [consideraciones de precio y rendimiento para los grupos elásticos](sql-database-elastic-pool-guidance.md).
