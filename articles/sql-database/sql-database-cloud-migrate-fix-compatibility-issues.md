...
# Solución de problemas de compatibilidad de bases de datos de SQL Server mediante el Asistente para migración de SQL Azure antes de la migración a la Base de datos SQL
