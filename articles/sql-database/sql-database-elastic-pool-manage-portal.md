...
- En el [Portal de Azure](https://portal.azure.com), haga clic en **Examinar**, en **Grupos elásticos de SQL** y, después, haga clic en el grupo con el que quiere trabajar de la lista.
...
- Haga clic en **Agregar iconos** y, después, seleccione los iconos que quiera de la galería de iconos que se muestra a la izquierda.
...
1. Haga clic en el gráfico **Uso de recursos** para abrir la hoja **Métrica**, haga clic en **Agregar alerta** y, después, rellene la información en la hoja **Agregar una regla de alerta** (el campo **Resource** se establece automáticamente en el grupo con el que está trabajando).
2. Escriba un **nombre** y una **descripción** para la alerta que resulten significativos para usted y los destinatarios.
3. Elija la **métrica** de la que quiera que se generen alertas en la lista.
...
4. Haga clic en **eDTU máx.** para configurar el valor máximo y **eDTU mín.** a fin de establecer el número mínimo de eDTU de las bases de datos del grupo.
...
2. En la hoja **Bases de datos elásticas**, en la lista de bases de datos del grupo, haga clic en la base de datos que quiere quitar y, después, haga clic en **Eliminar bases de datos**.
...
En la hoja de la base de datos, haga clic en **Crear base de datos**. La Base de datos SQL ya está configurada para el servidor y el grupo correctos, por lo que haga clic para ajustar otras opciones y, después, seleccione **Aceptar** para crear una nueva base de datos en el grupo.
