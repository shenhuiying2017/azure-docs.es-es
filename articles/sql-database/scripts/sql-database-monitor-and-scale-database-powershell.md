...
[!code-powershell[main](../../../powershell_scripts/sql-database/monitor-and-scale-database/monitor-and-scale-database.ps1 "Supervisión y escalado de una instancia única de SQL Database")]
