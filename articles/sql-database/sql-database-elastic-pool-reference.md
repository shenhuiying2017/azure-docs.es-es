...
- No se admite la importación de una base de datos directamente en un grupo. Puede importarla a una base de datos única y luego mover la base de datos a un grupo. *Sí* se admite la exportación de una base de datos desde un grupo.
