...
- Solo se admite la creación y administración de grupos de bases de datos elásticas con el [Portal de Azure](https://portal.azure.com), [PowerShell](sql-database-elastic-pool-create-powershell.md) y una biblioteca cliente de .NET (solo Azure Resource Manager). No se admiten el [Portal clásico](https://manage.windowsazure.com/) ni los comandos de administración de servicios.
...
| [Get-AzureRmSqlDatabaseActivity]() | [Obtiene el estado de la introducción y extracción de bases de datos de un grupo](https://msdn.microsoft.com/library/mt603687.aspx) |
