...
- El precio de un grupo elástico se basa en el número de eDTU del grupo y el número de bases de datos del grupo. El precio de un grupo elástico es independiente de la utilización de las bases de datos elásticas de dentro de él.
