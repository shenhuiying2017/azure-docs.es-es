...
## <a name="install-the-elastic-database-jobs-components-using-powershell"></a>Instalación de componentes de trabajos de Elastic Database mediante PowerShell
...
2. Ejecute el script .\InstallElasticDatabaseJobs.ps1 de PowerShell y proporcione valores para las variables que solicite. Este script creará los componentes descritos en [Componentes y precios de trabajos de Elastic Database](sql-database-elastic-jobs-overview.md#components-and-pricing) con la configuración de Azure Cloud Service para usar adecuadamente los componentes dependientes.
...
## <a name="install-the-elastic-database-jobs-components-using-the-portal"></a>Instalación de componentes de trabajos de Elastic Database mediante el Portal
Una vez creado el [grupo elástico](sql-database-elastic-pool-manage-portal.md), puede instalar componentes de los **trabajos de Elastic Database** para habilitar la ejecución de tareas administrativas en cada base de datos del grupo. A diferencia de lo que sucede cuando se usan las API de PowerShell de **Trabajos de Elastic Database** , la interfaz del portal está actualmente restringida exclusivamente a la ejecución en un grupo existente.

**Tiempo estimado para completar el tutorial:** 10 minutos.

1. En la vista del panel del grupo de bases de datos elásticas de [Azure Portal](https://portal.azure.com/#), haga clic en **Crear trabajo**.
2. Si va a crear un trabajo por primera vez, deberá instalar los **trabajos de Elastic Database** haciendo clic en **TÉRMINOS DE VISTA PREVIA**.
...
Si se requiere la desinstalación, elimine el grupo de recursos. Consulte [Desinstalación de componentes de trabajos de Elastic Database](sql-database-elastic-jobs-uninstall.md).

## <a name="next-steps"></a>Pasos siguientes
Asegúrese de que se cree una credencial con los derechos adecuados para la ejecución del script en cada base de datos del grupo. Para obtener más información, consulte [Protección de SQL Database](sql-database-manage-logins.md).
Consulte [Creación y administración de trabajos de Elastic Database](sql-database-elastic-jobs-create-and-manage.md).
