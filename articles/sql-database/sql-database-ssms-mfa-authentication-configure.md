i--- title: Configuración de Multi-Factor Authentication: Azure SQL | Microsoft Docs description: Use Multi-Factor Authentication con SSMS para SQL Database y SQL Data Warehouse.
