---
title: Cambio del nivel de servicio y del nivel de rendimiento de una base de datos SQL de Azure
...
4. Haga clic en la base de datos que desee cambiar.
5. En la hoja de la Base de datos SQL, haga clic en **Toda la configuración** y luego en **Plan de tarifa (escalar DTU)**.
   
   ![plan de tarifa][1]
6. Seleccione un nuevo nivel y haga clic en **Seleccionar**:
...
7. En la cinta de la izquierda, haga clic en **Notificaciones**:
...
3. Haga clic en la base de datos que cargó.
4. Compruebe el **Plan de tarifa** y confirme que está establecido en el nivel correcto.
