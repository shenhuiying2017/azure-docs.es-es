...
![Configuración de replicación geográfica de la Base de datos SQL. Recuperación ante desastres en la nube.](media/sql-database-manage-application-rolling-upgrade/Option1-1.png)
...
![Configuración de replicación geográfica de la Base de datos SQL. Recuperación ante desastres en la nube.](media/sql-database-manage-application-rolling-upgrade/Option1-2.png)
...
![Configuración de replicación geográfica de la Base de datos SQL. Recuperación ante desastres en la nube.](media/sql-database-manage-application-rolling-upgrade/Option1-3.png)
...
![Configuración de replicación geográfica de la Base de datos SQL. Recuperación ante desastres en la nube.](media/sql-database-manage-application-rolling-upgrade/Option1-4.png)
...
## Actualización de aplicaciones que dependen de la replicación geográfica para recuperación ante desastres

Si la aplicación aprovecha la replicación geográfica para la continuidad del negocio, se implementa en al menos dos regiones diferentes con una implementación activa en la región primaria y una implementación en espera en la región de la copia de seguridad. Además de los factores mencionados anteriormente, el proceso de actualización debe garantizar que:
...
![Configuración de replicación geográfica de la Base de datos SQL. Recuperación ante desastres en la nube.](media/sql-database-manage-application-rolling-upgrade/Option2-1.png)
...
![Configuración de replicación geográfica de la Base de datos SQL. Recuperación ante desastres en la nube.](media/sql-database-manage-application-rolling-upgrade/Option2-2.png)
...
![Configuración de replicación geográfica de la Base de datos SQL. Recuperación ante desastres en la nube.](media/sql-database-manage-application-rolling-upgrade/Option2-3.png)
...
![Configuración de replicación geográfica de la Base de datos SQL. Recuperación ante desastres en la nube.](media/sql-database-manage-application-rolling-upgrade/Option2-4.png)
...
- [Desconectar la replicación geográfica secundaria](https://msdn.microsoft.com/library/azure/mt603457.aspx)
