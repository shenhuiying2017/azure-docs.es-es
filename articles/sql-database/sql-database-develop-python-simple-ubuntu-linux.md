...
Consulte el artículo [Prerequisites for using the pymssql Python Driver for SQL Server (Requisitos previos para usar el controlador pymssql de Python para SQL Server)](https://msdn.microsoft.com/library/mt694094.aspx#Ubuntu-Linux).
