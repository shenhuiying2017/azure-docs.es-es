...
4. Escriba el **inicio de sesión** y **contraseña** que configuró al crear el servidor y, a continuación, haga clic en **Conectar**.
...
1. En el **Explorador de objetos**, navegue hasta la base de datos **AdventureWorks**.
2. Haga clic con el botón secundario en la base de datos y, a continuación, seleccione **Nueva consulta**.
