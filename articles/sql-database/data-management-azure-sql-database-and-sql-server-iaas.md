<properties
	pageTitle="Base de datos (PaaS) SQL y SQL Server en la nube en Máquinas virtuales de Azure (IaaS) | Microsoft Azure"
	...
	keywords="Nube de SQL Server, SQL Server en la nube, base de datos de SaaS, DBaaS"
	documentationCenter=""
	authors="jeffgoll"
	manager="jeffreyg"
	editor="cjgronlund"/>
