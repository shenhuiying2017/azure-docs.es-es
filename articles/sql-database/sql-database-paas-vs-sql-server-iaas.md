...
* [SQL Server en Azure Virtual Machines](https://azure.microsoft.com/services/virtual-machines/sql-server/): SQL Server instalado y hospedado en la nube en máquinas virtuales de Windows Server que se ejecutan en Azure, conocido también como infraestructura como servicio (IaaS).
  SQL Server en máquinas virtuales de Azure es el mismo software de SQL Server que instalaría en el servidor local; la única diferencia es que este servidor es ahora una máquina virtual hospedada en Azure. SQL Server en Azure está optimizado para migrar aplicaciones existentes de SQL Server, y todas las versiones y ediciones de SQL Server están disponibles. Además, permite hospedar tantas bases de datos como sea necesario, admite la ejecución de transacciones entre bases de datos, y ofrece un control completo de la instancia de SQL Server y el sistema operativo Windows.
...
Una de las primeras cosas que hay que comprender al comparar Azure con bases de datos SQL Server locales es que puede usarlas todas. La plataforma de datos de Microsoft aprovecha la tecnología de SQL Server y la pone a disposición de los usuarios en máquinas físicas locales, entornos en nubes privadas, entornos en nubes privadas hospedados por terceros y la nube pública de Microsoft. SQL Server en máquinas virtuales de Azure permite satisfacer necesidades únicas y diversas del negocio gracias a una combinación de implementaciones locales y hospedadas en la nube, usando el mismo conjunto de productos de servidor, herramientas de desarrollo y conocimientos en todos estos entornos.
...
|  | Los equipos que desean que Microsoft administre sus actualizaciones de bases de datos, la alta disponibilidad y la recuperación ante desastres. |Equipos que puedan configurar y administrar alta disponibilidad, recuperación ante desastres y aplicación de revisiones para SQL Server. Algunas funciones automatizadas ya incorporadas simplifican considerablemente estos aspectos. | |
...
A continuación, se ofrece el cálculo del costo pormenorizado para la aplicación en ejecución en SQL Database y en SQL Server en Azure Virtual Machines:

**Cuándo se usa Azure SQL Database:**

*Costo total de la aplicación = costos de administración muy minimizados + costos de desarrollo de software + costos de servicio de SQL Database*
...
> [!NOTE]
> Hay unas pocas características de SQL Server que no se pueden aplicar o no están disponibles en SQL Database. Consulte [SQL Database Features](sql-database-features.md) (Características de Azure SQL Database) e [información sobre Transact-SQL de SQL Database](sql-database-transact-sql-information.md) para más información. Si va a mover una solución existente de SQL Server a la nube, consulte [Migrar una base de datos a Azure SQL Database](sql-database-cloud-migrate.md). Al migrar una aplicación existente de SQL Server local a SQL Database, considere la posibilidad de actualizar la aplicación para aprovechar las capacidades de la oferta de servicios en la nube. Por ejemplo, puede considerar la posibilidad de usar [Azure Web App Service](https://azure.microsoft.com/services/app-service/web/) o [Azure Cloud Services](https://azure.microsoft.com/services/cloud-services/) en el nivel de aplicación para aumentar la relación costo-beneficios.
> 
> 
...
Para los niveles de servicio Básico, Estándar, Premium, De uso general y Crítico para la empresa de **SQL Database**, Microsoft proporciona un Acuerdo de Nivel de Servicio de disponibilidad del 99,99 %. Para obtener la información más reciente, consulte [Contrato de nivel de servicio para Base de datos SQL](https://azure.microsoft.com/support/legal/sla/sql-database/). Para obtener la información más reciente sobre niveles de servicio SQL Database y planes de continuidad del negocio admitidos, consulte [Opciones y rendimiento de SQL Database: comprender lo que está disponible en cada nivel de servicio](sql-database-service-tiers.md).
