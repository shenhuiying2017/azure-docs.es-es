...
||Equipos que no desean administrar el sistema operativo subyacente ni los valores de configuración.| Si necesita un entorno de TI personalizado con derechos administrativos completos.|
