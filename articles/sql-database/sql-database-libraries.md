...
| Node.js | Windows, Linux, Mac | [Conexión a Base de datos SQL mediante Node.js](sql-database-develop-nodejs-simple.md) | [Descargar](https://msdn.microsoft.com/library/mt652094.aspx) |
| Python | Windows, Linux, Mac | [Conexión a Base de datos SQL mediante Python](sql-database-develop-python-simple.md) | [Descargar](https://msdn.microsoft.com/library/mt694094.aspx) |
| Ruby | Windows, Linux, Mac | [Conexión a Base de datos SQL mediante Ruby](sql-database-develop-ruby-simple.md) | [Descargar](https://msdn.microsoft.com/library/mt711041.aspx) |
