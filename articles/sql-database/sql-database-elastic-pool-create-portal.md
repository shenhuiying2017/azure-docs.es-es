...
---
# <a name="create-a-new-elastic-database-pool-with-the-azure-portal"></a>Creación de un nuevo grupo de bases de datos elásticas con el Portal de Azure
...
> [!NOTE]
> Independientemente de si ya tiene un servidor o no, también puede crear un grupo desde la hoja **Grupos elásticos de SQLs** (debajo de la lista en el lado izquierdo del portal, haga clic en **Examinar** **>** **Grupos elásticos de SQL**). Si hace clic en **+Agregar** en la hoja **Grupos elásticos de SQL** se proporcionarán los pasos para crear un servidor durante el flujo de trabajo de aprovisionamiento del grupo.
> 
> 

1. En [Azure Portal](http://portal.azure.com/), bajo la lista situada en el lado izquierdo, haga clic en **Examinar** **>** **Servidores SQL** y, luego, en el servidor que contiene las bases de datos que desea agregar a un grupo.
