...
3. Para cambiar el plan de tarifa del grupo, haga clic en **Plan de tarifa**, luego en el plan de tarifa que prefiera y, después, en **Seleccionar**.

    > [AZURE.IMPORTANT] Después de elegir el plan de tarifa y hacer clic en **Aceptar** en el último paso para confirmar los cambios, no podrá cambiar el plan de tarifa del grupo.

4. Haga clic en **Configurar grupo**, donde puede agregar bases de datos y elegir la configuración de recursos para el grupo.
5. Para agregar bases de datos, haga clic en **Agregar base de datos**, luego en las bases de datos que quiera agregar y después en el botón **Seleccionar**.
