<properties
   pageTitle="Caso práctico de Azure SQL Database: GEP | Microsoft Azure"
...
## Las limitaciones de los centros de datos controlados por los usuarios
...
## La búsqueda de una solución en la nube óptima
...
![En la Ilustración 1](./media/sql-database-case-study-gep/figure1.png) Ilustración 1: Arquitectura de SMART by GEP
...
## Aumento de la satisfacción de los clientes sin ampliar los recursos de TI
...
![Logotipo de Smart](./media/sql-database-case-study-gep/smartbygeplogo.png)
