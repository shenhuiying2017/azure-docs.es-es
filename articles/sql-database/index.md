---
title: "Documentación sobre Azure SQL Database: tutoriales y referencia de API | Microsoft Docs"
description: Aprenda a usar instancias de Azure SQL Database.
...
---
<div class="content">
    <h1>Documentación de SQL Database</h1>
    <div class="introHolder" style="justify-content: space-between;">
        <div class="intro" style="min-width: 200px">
            <p>Azure SQL Database es una base de datos relacional como servicio que usa el motor Microsoft SQL Server. SQL Database es una base de datos de alto rendimiento, confiable y segura que puede usar para compilar aplicaciones y sitios web controlados por datos en el lenguaje de programación que prefiera, sin necesidad de administrar la infraestructura. Aprenda a usar SQL Database con nuestros inicios rápidos, tutoriales y ejemplos.</p>
        </div>
        <a href="https://azure.microsoft.com/en-us/resources/videos/create-sql-database-on-azure/">
            <div class="calloutHolder" style="max-width: 250px">
                ...
                <div>
                    <p style="margin-top: 0; color: #6e6e6e">Creación de una base de datos SQL en Azure. (3:12)</p>
                </div>
            </div>
        </a>
    </div>
<h2 style="margin-top: 18px; margin-bottom: 0px;">Inicios rápidos en 5 minutos</h2>
<p style="margin-top: 6px; margin-bottom: 6px;">Aprenda a crear una base de datos SQL, a administrarla mediante SQL Management Studio y a desarrollar con ella en C#, Java, Python, Node.js y Ruby:</p>
<div class="ico48Case">
    <div class="ico48Link">
...
<p>Aprenda a crear, administrar y migrar bases de datos mediante la base de datos SQL</p>
<ol>
    <li><a href="/azure/sql-database/sql-database-design-first-database">Creación y diseño del esquema para una nueva base de datos SQL</a></li>
    <li><a href="/azure/sql-database/sql-database-migrate-your-sql-server-database">Migración de una base de datos SQL Server existente para que use Azure SQL Database</a></li>
</ol>

<h2 style="margin-top: 36px">Vídeo gratuito de aprendizaje de PluralSight</h2>
...
<h2 style="margin-top: 36px">Muestras</h2>
<p>Búsqueda de scripts para administrar las tareas más habituales</p>
<ul class="spaced">
    <li><a href="/azure/sql-database/sql-database-cli-samples">CLI de Azure</a></li>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <p><a href="/powershell/elasticdatabasejobs/v0.8.33/elasticdatabasejobs">Azure PowerShell (base de datos elástica)</a></p>
                        <p><a href="/cli/azure/sql">CLI de Azure 2.0</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>REST</h3>
                        <p><a href="/rest/api/sql/">Referencia de API de REST</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Herramientas de SQL Server</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt238365.aspx">Herramientas de SQL Server</a></p>
                        ...
                        <p><a href="https://www.nuget.org/packages/Microsoft.Azure.Management.Sql">Paquete de la biblioteca de administración de SQL Database</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Controladores de SQL Server</h3>
                        <p><a href="https://msdn.microsoft.com/library/mt654049.aspx">Controladores de SQL Server</a></p>
