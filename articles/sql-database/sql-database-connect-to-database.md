...
# Conexión a una base de datos SQL de Azure con SSMS

A continuación se describen los pasos necesario para conectarse a una base de datos SQL de Microsoft Azure con SQL Server Management Studio.
