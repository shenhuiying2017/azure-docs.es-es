...
Con el Administrador de mapa de particiones implementado y los intervalos y miembros de federación registrados con el Administrador de mapa de particiones (a través de la utilidad de migración), es posible modificar la aplicación existente de Federaciones a fin de utilizar las API de Escalado elástico. Como se ilustra en la figura anterior, las conexiones de aplicación a través de las API de Escalado elástico se enrutarán mediante el Administrador de mapa de particiones a los miembros adecuados de la federación (ahora también una partición). La asignación de miembros de federación al Administrador de mapa de particiones permite que dos versiones de una aplicación, una que usa Federaciones y otra que usa Escalado elástico, se ejecuten en paralelo para comprobar la funcionalidad.   
...
Una vez que se ha realizado el cambio sobre todos los miembros existentes de la federación, la migración de la aplicación está lista.  
...
- La característica **División** del Escalado elástico no es completamente en línea. Durante una operación de división, cada shardlet individual queda sin conexión durante el desplazamiento.
- La característica de división de Escalado elástico requiere aprovisionamiento de la base de datos y administrador de esquemas manual.
