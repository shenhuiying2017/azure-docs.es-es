---
title: Exploración de tutoriales de Base de datos SQL de Azure | Microsoft Docs
...
| [Copia de una Base de datos SQL de Azure con PowerShell](sql-database-copy-powershell.md#copy-your-sql-database) |En este tutorial, aprenderá a copiar una Base de datos SQL de Azure mediante PowerShell. |
