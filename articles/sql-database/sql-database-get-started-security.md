...
[!INCLUDE [Inicio de sesión](../../includes/azure-getting-started-portal-login.md)]

[!INCLUDE [Creación de un servidor lógico de Base de datos SQL](../../includes/sql-database-sql-server-management-studio-connect-server-principal.md)]

[!INCLUDE [Creación de bases de datos SQL](../../includes/sql-database-create-new-database-user.md)]

[!INCLUDE [Creación de bases de datos SQL](../../includes/sql-database-grant-database-user-dbo-permissions.md)]

[!INCLUDE [Creación de bases de datos SQL](../../includes/sql-database-sql-server-management-studio-connect-user.md)]
