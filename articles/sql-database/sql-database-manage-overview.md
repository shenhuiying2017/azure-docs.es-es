---
title: 'Información general: herramientas de administración para Base de datos SQL'
...
> [!IMPORTANT]
> Debe usar siempre la versión más reciente de SQL Server Management Studio y de SQL Server Data Tools para Visual Studio para que pueda estar siempre al día de las actualizaciones de Microsoft Azure y Base de datos SQL. Las versiones anteriores de estas herramientas no funcionarán correctamente con Base de datos SQL.
> 
> 
