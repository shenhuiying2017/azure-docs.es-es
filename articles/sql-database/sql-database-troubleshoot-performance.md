...
3.	Puede usar vistas de administración dinámica (DMV), eventos extendidos (Xevents) y el almacén de consultas en SSMS para obtener parámetros de rendimiento en tiempo real. Vea el tema de directrices sobre el rendimiento para la supervisión detallada y sugerencias de optimización.
