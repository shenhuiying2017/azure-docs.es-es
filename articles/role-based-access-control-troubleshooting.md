...
1. Estos elementos requieren acceso al **plan de hospedaje web** que corresponde a su sitio web:  
    * Ver el nivel de precios del sitio web (p. ej., gratis, compartido, básico o estándar)
    * Configuración de escala (es decir, número de instancias, tamaño de la máquina virtual, opciones de escala automática).
