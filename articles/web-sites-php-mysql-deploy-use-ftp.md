<properties urlDisplayName="Web w/ MySQL + FTP" pageTitle="Sitio web PHP con MySQL y FTP - Tutorial de Azure" metaKeywords="" description="Un tutorial en el que se muestra cómo crear un sitio web de PHP que almacena datos en MySQL  y usar la implementación de FTP en Azure." metaCanonical="" services="web-sites" documentationCenter="PHP" title="Create a PHP-MySQL Azure Website and Deploy Using FTP" authors="tomfitz" solutions="" manager="wpickett" editor="" />
