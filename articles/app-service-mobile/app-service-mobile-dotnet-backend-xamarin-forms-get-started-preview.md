...
3. En el cuadro de diálogo **Administrador de configuración**, seleccione las casillas **Compilar** e **Implementar** del proyecto de iOS.
...
5. En el cuadro de diálogo **Administrador de configuración**, seleccione las casillas **Compilar** e **Implementar** del proyecto de Android.
...
4. En el menú **Compilar**, haga clic en **Administrador de configuración**. 
5. En el cuadro de diálogo **Administrador de configuración**, seleccione las casillas **Compilar** e **Implementar** del proyecto de Windows que ha elegido.
