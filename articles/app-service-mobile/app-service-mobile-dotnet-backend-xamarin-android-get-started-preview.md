...
* [Incorporación de autenticación a la aplicación](app-service-mobile-dotnet-backend-xamarin-android-get-started-users-preview.md) <br/>Aprenda a autenticar a los usuarios de su aplicación con un proveedor de identidades.
