---
title: "Uso de la biblioteca de cliente de aplicaciones móviles de Android"
...
### <a name="a-namegradle-buildaupdate-the-gradle-build-file"></a><a name="gradle-build"></a>Actualización del archivo de compilación de Gradle
...
### <a name="a-nameenable-internetaenable-internet-permission"></a><a name="enable-internet"></a>Habilitación de permisos de Internet
...
### <a name="a-namedata-objectadefine-client-data-classes"></a><a name="data-object"></a>Definición de clases de datos de cliente
...
### <a name="a-namecreate-clientahow-to-create-the-client-context"></a><a name="create-client"></a>Creación del contexto de cliente
...
En este código, reemplace `MobileAppUrl` por la dirección URL del back-end de la aplicación móvil, que se puede encontrar en el [Azure Portal] en la hoja del back-end de la aplicación móvil. Para que esta línea de código se compile, también debe agregar la siguiente instrucción **import** :
...
### <a name="a-namebindingahow-to-bind-data-to-the-user-interface"></a><a name="binding"></a>Enlace de datos a la interfaz de usuario
...
#### <a name="a-namelayoutahow-to-define-the-layout"></a><a name="layout"></a>Definición del diseño
...
#### <a name="a-nameadapterahow-to-define-the-adapter"></a><a name="adapter"></a>Definición del adaptador
...
### <a name="a-nameapiathe-api-structure"></a><a name="api"></a>La estructura de API
...
#### <a name="a-nameuse-adapterahow-to-use-the-adapter"></a><a name="use-adapter"></a>Uso del adaptador
...
## <a name="a-namequeryingahow-to-query-data-from-your-mobile-app-backend"></a><a name="querying"></a>Consulta de datos desde el back-end de la aplicación móvil
...
### <a name="a-nameshowallahow-to-return-all-items-from-a-table"></a><a name="showAll"></a>Devolver todos los elementos de una tabla
...
### <a name="a-namechainingahow-to-concatenate-query-methods"></a><a name="chaining"></a>Concatenación de métodos de consulta
...
## <a name="a-nameinsertingahow-to-insert-data-into-the-backend"></a><a name="inserting"></a>Inserción de datos en el back-end
...
## <a name="a-nameupdatingahow-to-update-data-in-a-mobile-app"></a><a name="updating"></a>Actualización de los datos en una aplicación móvil
...
## <a name="a-namedeletingahow-to-delete-data-in-a-mobile-app"></a><a name="deleting"></a>Eliminación de datos en una aplicación móvil
...
## <a name="a-namelookupahow-to-look-up-a-specific-item"></a><a name="lookup"></a>Búsqueda de un elemento específico
...
## <a name="a-nameuntypedahow-to-work-with-untyped-data"></a><a name="untyped"></a>Trabajo con datos sin tipo
...
### <a name="a-namejsoninstanceahow-to-create-an-instance-of-an-untyped-table"></a><a name="json_instance"></a>Creación de una instancia de tabla sin tipo
...
### <a name="a-namejsoninsertahow-to-insert-into-an-untyped-table"></a><a name="json_insert"></a>Inserción de una tabla sin tipo
...
### <a name="a-namejsondeleteahow-to-delete-from-an-untyped-table"></a><a name="json_delete"></a>Eliminación de una tabla sin tipo
...
### <a name="a-namejsongetahow-to-return-all-rows-from-an-untyped-table"></a><a name="json_get"></a>Devolución de todas las filas de una tabla sin tipo
...
## <a name="a-namecustom-apiahow-to-call-a-custom-api"></a><a name="custom-api"></a>Llamada a una API personalizada
...
## <a name="a-nameauthenticationahow-to-add-authentication-to-your-app"></a><a name="authentication"></a>Incorporación de autenticación a la aplicación
...
### <a name="a-namecachingahow-to-add-authentication-code-to-your-app"></a><a name="caching"></a>Adición del código de autenticación a su aplicación
...
### <a name="a-namecachingahow-to-cache-authentication-tokens"></a><a name="caching"></a>Almacenamiento de tokens de autenticación en la memoria caché
...
## <a name="a-namecustomizingahow-to-customize-the-client"></a><a name="customizing"></a>Personalización del cliente
...
### <a name="a-nameserializationahow-to-customize-serialization"></a><a name="serialization"></a>Personalización de la serialización
...
### <a name="a-namecolumnsahow-to-map-different-client-and-server-names"></a><a name="columns"></a>Asignación de nombres de servidor y cliente diferentes
...
### <a name="a-nametableahow-to-map-different-table-names-between-the-client-and-the-backend"></a><a name="table"></a>Asignación de nombres de tabla diferentes entre el cliente y el back-end
...
### <a name="a-nameconversionsahow-to-automate-column-name-mappings"></a><a name="conversions"></a>Asignación automática de nombres de columna
...
### <a name="a-namecomplexahow-to-store-an-object-or-array-property-into-a-table"></a><a name="complex"></a>Almacenamiento de una propiedad de objeto o matriz en una tabla
