...
* [Incorporación de autenticación a la aplicación](app-service-mobile-dotnet-backend-xamarin-ios-get-started-users-preview.md) <br/>Aprenda a autenticar a los usuarios de su aplicación a través de un proveedor de identidades.
