<properties
	pageTitle="Creación de una aplicación iOS en Aplicaciones móviles de Azure"
...
Completar este tutorial es un requisito previo para todos los tutoriales de aplicaciones móviles para aplicaciones iOS.
