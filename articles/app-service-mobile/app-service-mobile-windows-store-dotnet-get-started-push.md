...
9. En la pestaña **Configuración de aplicaciones**, anote los valores de **Secreto de cliente** y **SID del paquete**.
    ...
    ![Configuración de la aplicación en el Centro para desarrolladores](./media/app-service-mobile-windows-store-dotnet-get-started-push/mobile-services-win8-app-push-auth.png)
