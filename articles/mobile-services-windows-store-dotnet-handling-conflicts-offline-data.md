<properties pageTitle="Control de conflictos con datos sin conexión en Servicios móviles (Tienda Windows) | Centro de desarrollo móvil" description="Obtenga información acerca de cómo usar Servicios móviles de Azure para gestionar los conflictos que se producen al sincronizar datos sin conexión en su aplicación de la Tienda Windows" documentationCenter="windows" authors="wesmc7777" manager="dwrede" editor="" services=""/>
...
>[AZURE.NOTE] Para admitir la sincronización de los registros eliminados mediante la sincronización de datos sin conexión, debe habilitar la [Eliminación temporal](/es-es/documentation/articles/mobile-services-using-soft-delete/). De lo contrario, deberá quitar manualmente los registros en el almacén local o llamar a  `IMobileServiceSyncTable::PurgeAsync()` para purgar el almacén local.
