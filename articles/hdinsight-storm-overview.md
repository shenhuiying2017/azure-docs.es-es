<properties
	...
	description="Obtenga una introducción general a Apache Storm y aprenda cómo puede usar Apache Storm en HDInsight para crear soluciones de análisis de datos en tiempo real en la nube."
...
Si usa Visual Studio, las herramientas de HDInsight para Visual Studio permiten crear topologías en C# e híbridas en C# y Java para, después, enviarlas al clúster de Storm en HDInsight.
