...
* **Comprobación de la configuración de web.config**
	...
	> [AZURE.NOTE]Si la aplicación utiliza un punto de entrada distinto de **app.js**, debe reemplazar todas las apariciones de **app.js** con el punto de entrada correcto. Por ejemplo, reemplazando **app.js** por **server.js**.
