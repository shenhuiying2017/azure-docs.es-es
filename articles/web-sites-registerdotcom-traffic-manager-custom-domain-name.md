<properties title="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with Register.com" pageTitle="Configuración de un nombre de dominio Register.com para un sitio web de Azure que utiliza el Administrador de tráfico" metaKeywords="Microsoft Azure, sitios web Microsoft Azure, nombre de dominio" description="" services="web-sites" documentationCenter="" authors="larryfr, jroth" manager="wpickett" />
