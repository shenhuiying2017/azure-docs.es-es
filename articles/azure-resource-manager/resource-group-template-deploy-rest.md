...
> 
> * [Visualización de operaciones de implementación con la API de REST de Azure Resource Manager](resource-manager-troubleshoot-deployments-rest.md) para obtener información que lo ayude a solucionar el error
