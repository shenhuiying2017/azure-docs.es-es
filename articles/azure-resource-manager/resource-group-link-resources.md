...
## <a name="linking-with-rest-api"></a>Vinculación con la API de REST
...
Para obtener más ejemplos, incluido cómo recuperar información acerca de los vínculos, consulte [Recursos vinculados](https://docs.microsoft.com/rest/api/resources/resourcelinks).
