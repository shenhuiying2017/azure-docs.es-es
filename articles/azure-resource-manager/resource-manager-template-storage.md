---
title: Plantilla de Resource Manager para almacenamiento | Microsoft Docs
...
---
# <a name="storage-account-template-schema"></a>Cuenta de almacenamiento: esquema de plantilla
...
| Nombre |String<br />Obligatorio<br />Entre 3 y 24 caracteres, solo números y letras minúsculas.<br /><br />Nombre de la cuenta de almacenamiento que se creará. El nombre debe ser único en todo Azure. Considere usar la función [uniqueString](resource-group-template-functions.md#uniquestring) junto con su convención de nomenclatura, tal como se indica en el ejemplo que aparece a continuación. |
| location |String<br />Obligatorio<br />Región compatible con cuentas de almacenamiento. Para determinar las regiones válidas, consulte [Regiones admitidas](resource-manager-supported-services.md#supported-regions).<br /><br />Región para hospedar la cuenta de almacenamiento. |
| propiedades |Objeto<br />Obligatorio<br />[properties object](#properties)<br /><br />Objeto que especifica el tipo de cuenta de almacenamiento que se creará. |
