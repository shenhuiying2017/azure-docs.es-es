---
title: "Operaciones de auditoría con Resource Manager | Microsoft Docs"
...
---
# <a name="audit-operations-with-resource-manager"></a>Operaciones de auditoría con el Administrador de recursos
...
## <a name="portal-to-view-activity-logs"></a>Portal para ver registros de actividad
...
## <a name="powershell-to-view-activity-logs"></a>PowerShell para ver registros de actividad
...
2. En función de la hora de inicio que especifique, los comandos anteriores pueden devolver una lista larga de operaciones para el grupo de recursos. Puede filtrar los resultados para lo que busca ofreciendo criterios de búsqueda. Por ejemplo, si trata de investigar cómo se detuvo una aplicación web, podría ejecutar el siguiente comando.  
    ...
    En este ejemplo se muestra que usario@contoso.com. ha realizado una acción de detención. 
...
## <a name="azure-cli-to-view-activity-logs"></a>CLI de Azure para ver registros de actividad
...
## <a name="rest-api-to-view-audit-logs"></a>API de REST para ver registros de auditoría
