---
title: "Plantilla de Resource Manager para un secreto en un almacén de claves | Microsoft Docs"
...
---
# <a name="key-vault-secret-template-schema"></a>Esquema de la plantilla del secreto del Almacén de claves
...
| Nombre | Valor |
| --- | --- |
| type |Enum<br />Obligatorio<br />**secrets** (cuando se implementa como un recurso secundario del almacén de claves) o<br /> **Microsoft.KeyVault/vaults/secrets** (cuando se implementa como un recurso de nivel superior)<br /><br />Tipo de recurso que se creará. |
...
| Nombre | Valor |
| --- | --- |
| Valor |Cadena<br />Obligatorio<br /><br />Valor del secreto que se almacenará en el almacén de claves. Al pasar un valor para esta propiedad, use un parámetro de tipo **securestring**. |
