---
title: Historial de versiones de Azure Diagnostics | Microsoft Docs
...
SDK de Azure 2.8 agregó la capacidad de enviar datos de diagnóstico a [Application Insights](../application-insights/app-insights-cloudservices.md), lo que permitió diagnosticar los problemas tanto en la aplicación como en la infraestructura y el sistema.
