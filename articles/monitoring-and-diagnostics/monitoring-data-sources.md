...
| Registros de diagnóstico de Azure Monitor | Eventos | [Consulte la lista aquí](monitoring-overview-of-diagnostic-logs.md#supported-services-and-schema-for-resource-diagnostic-logs) | <ul><li>**Storage Blob o centro de eventos:** [configuración de diagnóstico](monitoring-overview-of-diagnostic-logs.md#resource-diagnostic-settings)</li></ul> |
