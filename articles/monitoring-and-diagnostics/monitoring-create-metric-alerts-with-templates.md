...
## <a name="resource-manager-template-for-a-simple-metric-alert"></a>Plantilla de Resource Manager para una alerta de métrica simple
...
Guarde el archivo JSON siguiente como simplemetricalert.json para usarlo en este tutorial.
...
La explicación del esquemas y las propiedades de una regla de alertas [está disponible aquí](https://docs.microsoft.com/en-us/rest/api/monitor/metricalerts/createorupdate).
...
Guarde el archivo JSON siguiente como simplemetricalert.parameters.json y modifíquelo según sea necesario.
...
## <a name="resource-manager-template-for-a-more-advanced-metric-alert"></a>Plantilla de Resource Manager para una alerta de métrica más avanzada
Las alertas de métrica más recientes admiten las alertas relacionadas con métricas de varias dimensiones además de admitir varios criterios. Puede usar la siguiente plantilla para crear una alerta de métrica más avanzada relacionada con métricas dimensionales y especificar varios criterios.

Guarde el archivo JSON siguiente como advancedmetricalert.json para usarlo en este tutorial.
...
Guarde y modifique el archivo JSON siguiente como advancedmetricalert.parameters.json para usarlo en este tutorial.
...
* Obtenga más información sobre [alertas en Azure](monitoring-overview-unified-alerts.md)
* Obtenga más información para [crear un grupo de acciones con plantillas de Resource Manager](monitoring-create-action-group-with-resource-manager-template.md)
