...
7. *Alertas de métrica*: si la señal es una métrica, se puede filtrar la ventana de alerta con la utilización de varios puntos de datos o dimensiones para el recurso de Azure especificado. 
