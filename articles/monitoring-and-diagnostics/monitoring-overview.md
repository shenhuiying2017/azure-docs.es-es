...
Hay una variedad de herramientas para supervisar el entorno de Azure, desde el código de aplicación que se ejecuta en Azure a los servicios y la infraestructura que ejecutan ese código. Estas herramientas funcionan conjuntamente para ofrecer la supervisión en la nube integral e incluyen:
