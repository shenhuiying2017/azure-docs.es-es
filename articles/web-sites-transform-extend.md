...
###<a id="SiteSample"></a> Ejemplo de extensión de aplicación web: Administrador PHP
...
El código de la extensión de la aplicación web se encuentra en %HOME%\SiteExtensions\[nombre-de-extensión]. Llamaremos a esto raíz de extensión.  
