...
- Solicite una invitación para la versión preliminar de [Laboratorio de desarrollo y pruebas de Azure](https://azure.microsoft.com/campaigns/devtest-lab/). Esta aplicación le permite administrar entornos de laboratorio de desarrollo y pruebas mediante plantillas y configurar cuotas y directivas para su uso dentro de la organización.
