...
La siguiente información describe cómo usar el servicio BLOB de Azure como repositorio de artefactos de compilación creados por una solución de integración continua Hudson. Uno de los escenarios en que esto le puede resultar útil es para codificar en un entorno de desarrollo ágil (con el uso de Java o de otros lenguajes), cuando las compilaciones se ejecutan según una integración continua y si necesita un repositorio para los artefactos de compilación, a fin de que, por ejemplo, pueda compartirlos con otros miembros de la organización, con los clientes o para mantener un archivo.
...
Información generalInformación general sobre Hudson
---------------------------------------------------
...
-   Una solución de integración continua Hudson.
    ...
    2.  En un símbolo del sistema que se abre en la carpeta que contiene Hudson WAR, ejecute Hudson WAR. Por ejemplo, si ha descargado la versión 3.0.1:
...
Uso del servicio BLOB Uso del servicio BLOB con la integración continua Hudson
------------------------------------------------------------------------------
...
5.  En la sección **Artifact Uploaders**, seleccione **Azure Storage plugin**.
...
5.  En la sección **Post-build Actions** de la configuración del trabajo, haga clic en **Upload artifacts to Azure Blob storage**.
