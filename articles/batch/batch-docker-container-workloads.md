...
* Versiones del SDK: los SDK de Batch admiten las imágenes de contenedor como en las siguientes versiones: 
...
* Cuentas: en su cuenta de Azure, debe crear una cuenta de Batch y, opcionalmente, una cuenta de Azure Storage.
