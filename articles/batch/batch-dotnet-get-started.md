...
* **Cuenta de almacenamiento**: para conocer las opciones de cuenta de almacenamiento en Batch, consulte la [introducción a las características de Batch](batch-api-basics.md#azure-storage-account).
