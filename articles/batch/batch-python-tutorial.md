...
Navegue a la siguiente línea en **python\_tutorial\_client.py** para comenzar con el paso 1:
...
Después de cargar los archivos de datos y el script de tarea en la cuenta de Almacenamiento, *python\_tutorial\_client.py* inicia su interacción con el servicio Lote mediante el módulo Python de Lote. Para ello, se crea una instancia de [BatchServiceClient][py_batchserviceclient]\:
...
Existen varios enfoques para supervisar la ejecución de tareas. La función `wait_for_tasks_to_complete` de *python\_tutorial\_client.py* proporciona un ejemplo sencillo de tareas de supervisión para un estado determinado; en este caso, el estado [completado][py_taskstate].
...
[1]: ./media/batch-python-tutorial/batch_workflow_01_sm.png "Crear contenedores en Almacenamiento de Azure"
...
[3]: ./media/batch-python-tutorial/batch_workflow_03_sm.png "Crear grupo de Lote"
[4]: ./media/batch-python-tutorial/batch_workflow_04_sm.png "Crear trabajo de Lote"
...
[7]: ./media/batch-python-tutorial/batch_workflow_07_sm.png "Descargar el resultado de la tarea desde Almacenamiento"
[8]: ./media/batch-python-tutorial/batch_workflow_sm.png "Flujo de trabajo de solución de Lote (diagrama completo)"
[9]: ./media/batch-python-tutorial/credentials_batch_sm.png "Credenciales de Lote en el Portal"
