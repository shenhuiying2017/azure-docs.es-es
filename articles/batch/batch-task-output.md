---
title: Almacenamiento de salidas de trabajos y tareas en Lote de Azure | Microsoft Docs
...
Mediante la técnica descrita en este artículo, puede ver la salida de las tareas en **Archivos de salida guardados** y en **Registros guardados** en [Azure Portal][portal].
...
> [!TIP]
> Puede encontrar el [código fuente][github_file_conventions] de la biblioteca de convenciones de archivos de Lote de Azure en GitHub en el SDK de Microsoft Azure del repositorio. NET.
> 
> 
...
> [!TIP]
> La variante de salida también designa en qué lugar de Azure Portal aparece un archivo determinado. Los archivos categorizados como *TaskOutput* aparecen en "Archivos de salida de tarea" y los archivos *TaskLog* aparecen en "Registros de tareas".
> 
> 
