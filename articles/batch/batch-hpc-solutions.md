---
title: Soluciones de lote y HPC en la nube | Microsoft Docs
...
> [!NOTE]
> En las soluciones HPC y de ejecución por lotes, una instancia en ejecución de una aplicación normalmente se denomina un *trabajo* y cada trabajo podría dividirse en *tareas*. Y los recursos de proceso en clúster para la aplicación se denominan a menudo *nodos de ejecución*.
> 
> 
...
> [!NOTE]
> Azure presenta nuevos servicios con cierta frecuencia que podrían ser útiles para su escenario. Si tiene alguna pregunta, póngase en contacto con un [asociado de Azure](https://pinpoint.microsoft.com/es-ES/search?keyword=azure) o envíe un correo electrónico a *bigcompute@microsoft.com*.
> 
> 
