...
Se necesita la dirección IP de una NIC en la máquina virtual. Recupere las NIC unidas a una máquina virtual con el comando siguiente. Si ya conoce la dirección IP que desea probar en la máquina virtual, puede omitir este paso.
...
Ejecute el cmdlet `az network watcher test-ip-flow` para probar el tráfico. En este ejemplo se usa la primera dirección IP de la primera NIC.
