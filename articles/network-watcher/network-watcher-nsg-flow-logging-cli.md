...
Para más información acerca de la estructura del registro, consulte la [introducción a los registros de flujo de grupos de seguridad de red](network-watcher-nsg-flow-logging-overview.md).
