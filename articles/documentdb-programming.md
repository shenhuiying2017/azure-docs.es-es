...
-	**Encapsulación:** los procedimientos almacenados pueden utilizarse para agrupar la lógica empresarial en un solo lugar. Esto tiene dos ventajas:
...
La creación y la ejecución de operadores de desencadenadores, procedimiento almacenado y consultas personalizadas son compatibles a través de la [API REST](https://msdn.microsoft.com/library/azure/dn781481.aspx) y los [SDK cliente](https://msdn.microsoft.com/library/azure/dn781482.aspx) en muchas plataformas como .NET, Node.js y JavaScript. **Este tutorial utiliza el [SDK de Node.js ](http://dl.windowsazure.com/documentDB/nodedocs/)** para ilustrar la sintaxis y el uso de procedimientos almacenados, desencadenadores y UDF.   
...
-	JavaScript: sistema de tipo JSON [http://www.json.org/js.html](http://www.json.org/js.html) 
-	Extensibilidad de base de datos segura y portátil: [http://dl.acm.org/citation.cfm?id=276339](http://dl.acm.org/citation.cfm?id=276339) 
-	Arquitectura de base de datos orientada al servicio: [http://dl.acm.org/citation.cfm?id=1066267&coll=Portal&dl=GUIDE](http://dl.acm.org/citation.cfm?id=1066267&coll=Portal&dl=GUIDE) 
-	Hospedaje del tiempo de ejecución de .NET en Microsoft SQL Server: [http://dl.acm.org/citation.cfm?id=1007669](http://dl.acm.org/citation.cfm?id=1007669) 
