...
# Instalación del componente de trabajo de la base de datos elástica

El [grupo de bases de datos elásticas (vista previa)](sql-database-elastic-pool-portal.md) proporciona un modelo de predicción para la implementación de un gran número de bases de datos. Una vez creado el grupo de bases de datos elásticas, podrá usar los **trabajos de bases de datos elásticas** para ejecutar tareas administrativas en cada base de datos del grupo de bases de datos elásticas. Por ejemplo, puede implementar un nuevo esquema como, por ejemplo, establecer una directiva de RLS en cada base de datos, para restringir la visualización de datos confidenciales solo a las personas con las credenciales correctas. A continuación se muestra cómo instalar **trabajos de bases de datos elásticas**.
...
* Grupo de bases de datos elásticas. Vea [Creación de un grupo de bases de datos SQL de Azure elásticas (vista previa)](sql-database-elastic-pool-portal.md).
