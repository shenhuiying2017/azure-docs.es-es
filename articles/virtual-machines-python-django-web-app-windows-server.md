...
3.  Use el *Escritorio remoto* para iniciar sesión en la máquina virtual de Azure recién creada.
...
Para obtener más información acerca de la configuración de los entornos de Python y Django, consulte la [guía de instalación](../python-how-to-install/).
...
7.  Descargue wfastcgi.py desde [CodePlex](http://go.microsoft.com/fwlink/?LinkID=316392&clcid=0x409) y guárdelo en C:\\Python27\\Scripts. Esta es la ubicación de los comandos anteriores utilizados para registrar el controlador de FastCGI. También puede instalarlo utilizando el Instalador de plataforma web. Busque “WFastCGI”.
