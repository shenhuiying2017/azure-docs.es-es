<properties title="Forecasting-Exponential Smoothing" pageTitle="Previsión-Suavizado exponencial | Azure" description="Servicio web: Suavizado exponencial-de pronóstico" metaKeywords="" services="machine-learning" solutions="" documentationCenter="" authors="jaymathe" manager="paulettm" editor="cgronlun" videoId="" scriptId="" />

<tags ms.service="machine-learning" ms.workload="data-services" ms.tgt_pltfrm="na" ms.devlang="na" ms.topic="article" ms.date="10/08/2014" ms.author="jaymathe" /> 


#Previsión-Suavizado exponencial 
...
Hay varias maneras de utilizar el servicio de forma automática ([aquí](http://microsoftazuremachinelearning.azurewebsites.net/etsForecasting.aspx) se puede ver una aplicación de ejemplo).
