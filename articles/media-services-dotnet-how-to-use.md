...
<table data-morhtml="true" border="2" cellspacing="0" cellpadding="5" style="border: 2px solid #000000;">
  <thead data-morhtml="true">
    <tr data-morhtml="true">
       <th data-morhtml="true">Escenario</th>
       <th data-morhtml="true">Descripci&oacute;n</th>
    </tr>
  </thead>
  <tbody data-morhtml="true">
    <tr data-morhtml="true">
        <td data-morhtml="true">Creaci&oacute;n de flujos de trabajo de un extremo a otro</td>
        <td data-morhtml="true">Genere flujos de trabajo multimedia completos en toda la nube. Desde la carga de medios a la distribuci&oacute;n de contenido, los Servicios multimedia ofrecen una serie de componentes que pueden combinarse para administrar flujos de trabajo espec&iacute;ficos de aplicaciones. Entre las capacidades actuales se encuentran la carga, el almacenamiento, el cifrado, la conversi&oacute;n de formato, la protecci&oacute;n de contenido y la entrega de transmisi&oacute;n bajo demanda.</td>
    </tr>
    <tr data-morhtml="true">
        <td data-morhtml="true">Creaci&oacute;n de flujos de trabajo h&iacute;bridos</td>
        <td data-morhtml="true">Puede integrar los Servicios multimedia con procesos y herramientas existentes. Por ejemplo, codifique el contenido in situ y, a continuaci&oacute;n, c&aacute;rguelo en los Servicios multimedia para realizar la transcodificaci&oacute;n en varios formatos y entregue a trav&eacute;s de CDN de Azure o un CDN de otro proveedor. Los Servicios multimedia pueden llamarse individualmente a trav&eacute;s de las API de REST est&aacute;ndar para la integraci&oacute;n con servicios y aplicaciones externas.</td>
    </tr>
    <tr data-morhtml="true">
        <td data-morhtml="true">Ofrecimiento de compatibilidad en la nube para reproductores multimedia</td>
        <td data-morhtml="true">Puede crear, administrar y entregar contenido multimedia en varios dispositivos multimedia (incluidos los dispositivos iOS, Android y Windows) y distintas plataformas.</td>
    </tr>
  </tbody>
</table>
...
A continuación se muestra una lista de SDK de clientes y marcos de reproductores compatibles. Para obtener más información sobre estos y otros marcos de reproductores y SDK planificados, y la funcionalidad que pueden admitir, consulte [Desarrollo de clientes de los Servicios multimedia](http://social.msdn.microsoft.com/Forums/en-US/MediaServices/thread/e9092ec6-2dfc-44cb-adce-1dc935309d2a) en los foros de los Servicios multimedia.
...
-   [Complemento de transmisión suave para OSMF 2.0](http://go.microsoft.com/fwlink/?LinkId=275022). Para obtener información sobre el uso de este complemento, consulte [Uso del complemento de transmisión suave para Adobe Open Source Media Framework](http://go.microsoft.com/fwlink/?LinkId=275034).
...
Ahora que dispone de una visión general de los Servicios multimedia, diríjase al tema [Configuración de su equipo para Servicios multimedia](http://go.microsoft.com/fwlink/?LinkId=301751).
