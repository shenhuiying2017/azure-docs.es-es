<properties
   pageTitle="Crear una implementación de varias máquinas virtuales mediante Azure x-plat cli | Azure"
   description="Aprenda a crear una implementación de varias máquinas virtuales con Azure x-plat CLI"
...
# Crear una implementación de varias máquinas virtuales mediante Azure x-plat cli

El siguiente script le mostrará cómo configurar una implementación de varios servicios en la nube y varias máquinas virtuales en una red virtual usando la Interfaz de líneas de comandos entre plataformas de Azure (xplat-cli).
