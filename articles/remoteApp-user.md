...
Para que los usuarios puedan ver y usar las aplicaciones en RemoteApp, debe concederles acceso. Esta es la parte fácil: en la ficha **Acceso de usuario**, escriba la información de cuenta del usuario al que quiere conceder acceso a este servicio.
...
RemoteApp de Azure tiene dos métodos de implementación: híbrida y nube. Cada uno usa distintas identidades de usuario para el acceso de usuario a las aplicaciones.
