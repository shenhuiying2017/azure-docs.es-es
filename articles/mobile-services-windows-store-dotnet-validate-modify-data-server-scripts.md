<properties 
	pageTitle="Uso de scripts de servidor para validar y modificar datos (Tienda Windows) | Centro de desarrollo móvil" 
	description="Obtenga información acerca de cómo utilizar scripts de servidor para validar, modificar y aumentar los datos de la aplicación de la Tienda Windows con Servicios móviles de Azure." 
