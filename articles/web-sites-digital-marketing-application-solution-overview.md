<properties urlDisplayName="Resources" pageTitle="Creación de una campaña de marketing digital en Sitios web Azure" metaKeywords="" description="This guide provides a technical overview of how to use Azure Websites to create digital marketing campaigns. This includes deployment, social media integration, scaling strategies, and monitoring." metaCanonical="" services="" documentationCenter="" title="Create a Digital Marketing Campaign on Azure Websites" authors="jroth" solutions="" manager="wpickett" editor="mollybos" />
...
![DigitalMarketingDeploy1][Implementación de marketing digital 1]
...
![DigitalMarketingFrameworkVersions][Versiones de marco de trabajo para marketing digital]
...
![DigitalMarketingFacebook][Facebook para marketing digital]

Para obtener acceso a un tutorial acerca de cómo usar esta plantilla con Sitios web, consulte [Creating a Facebook app using ASP.NET MVC Facebook Templates and hosting them for free on Azure Websites][fbtutorial]. Para obtener acceso a una aplicación de ejemplo y a un tutorial detallado, consulte [ASP.NET MVC Facebook Birthday App][fbbirthdayapp] y [The new Facebook application template and library for ASP.NET MVC][fbvstemplate].
...
![DigitalMarketingAutoScale][Autoescala para marketing digital]
...
<div class="dev-callout">
<strong>Nota:</strong>
<p>Si se trata de aplicaciones web que optan por usar los servicios en la nube y los roles web, hay una opción adicional para escalar en función de la longitud de los elementos de una cola. En un servicio en la nube, los roles que procesan colas back-end constituyen un patrón de arquitectura común. Para obtener más información acerca del ajuste de escala de los servicios en la nube, consulte <a href="http://www.windowsazure.com/es-es/manage/services/cloud-services/how-to-scale-a-cloud-service/">Escalación de un servicio en la nube</a>.</p>
</div>
...
![DigitalMarketingMonitor][Supervisión de marketing digital]
...
![DigitalMarketingUsageOverview][Introducción al uso de marketing digital]

Si observa que está a punto de agotar estas cuotas, considere cambiar de **libre** a **dompartido** o de **compartido** a **estándar**. En el modo **estándar**, tiene recursos dedicados en una o varias máquinas virtuales pequeñas, medianas o grandes. 
...
Por último, los sitios web con el modo estándar pueden permitir las alertas y la supervisión de extremos. Una supervisión de extremos trata regularmente de alcanzar el sitio web y, a continuación, genera informes sobre el tiempo de respuesta. Las alertas ofrecen notificaciones por correo electrónico si el tiempo de respuesta supera el umbral especificado. Para obtener más información, consulte la sección de supervisión del escenario de [presencia web global][scenarioglobalweb] y el tema, [Recepción de notificaciones de alerta y administración de reglas de alerta en Azure][receivealerts].
...
<tr>
   ...
   <td valign="top">- <a href="http://www.windowsazure.com/es-es/manage/services/web-sites/how-to-create-websites/">Creación e implementación de un sitio web</a></td>
</tr>
<tr>
   <td valign="middle"><strong>Implementación</strong></td>
   <td valign="top">- <a href="http://azure.microsoft.com/es-es/documentation/articles/web-sites-deploy/">Implementación de un sitio web de Azure</a><br/>- <a href="http://www.windowsazure.com/es-es/develop/net/common-tasks/publishing-with-git/">Publicación en Sitios web Azure desde el control de código fuente</a></td>
</tr>
<tr>
   <td valign="middle"><strong>Redes sociales</strong></td>
   <td valign="top">- <a href="http://www.windowsazure.com/es-es/develop/net/tutorials/web-site-with-sql-database/">Implementación de una aplicación ASP.NET MVC segura con suscripción, OAuth y Base de datos SQL</a><br/>- <a href="http://blogs.msdn.com/b/africaapps/archive/2013/02/20/creating-a-facebook-app-using-asp-net-mvc-facebook-templates-and-hosting-them-for-free-on-windows-azure-websites.aspx">Creación de una aplicación de Facebook con plantillas de Facebook para ASP.NET MVC</a><br/>- <a href="http://blogs.msdn.com/b/webdev/archive/2012/12/13/the-new-facebook-application-template-and-library-for-asp.net-mvc.aspx">Plantilla de aplicación y biblioteca de Facebook para ASP.NET MVC</a></td>
</tr>
<tr>
   <td valign="middle"><strong>Escala</strong></td>
   <td valign="top">- <a href="http://www.windowsazure.com/es-es/manage/services/web-sites/how-to-scale-websites/">Escalación de sitios web</a></td>
</tr>
<tr>
   <td valign="middle"><strong>Medios enriquecidos</strong></td>
   <td valign="top">- <a href="http://msdn.microsoft.com/es-es/library/windowsazure/dn223282.aspx">Introducción a los escenarios y conceptos de los Servicios multimedia de Azure</a></td>
</tr>
<tr>
   <td valign="middle"><strong>Monitor</strong></td>
   <td valign="top">- <a href="http://www.windowsazure.com/es-es/manage/services/web-sites/how-to-monitor-websites/">Supervisión de sitios web</a><br/>- <a href="http://msdn.microsoft.com/library/windowsazure/dn306638.aspx">Recepción de notificaciones de alerta y administración de reglas de alerta en Azure</a></td>.
</tr>
</table>
  ...
  [scenarioglobalweb]:/es-es/manage/services/web-sites/global-web-presence-solution-overview/
  
  
  [publishingwithgit]:/es-es/develop/net/common-tasks/publishing-with-git/
  [gitstaging]:http://www.bradygaster.com/post/multiple-environments-with-windows-azure-web-sites
  [deploysecurewebsite]:/es-es/develop/net/tutorials/web-site-with-sql-database/
  ...
  [servicemanagementapi]:http://msdn.microsoft.com/es-es/library/windowsazure/ee460799.aspx
  [powershell]:http://msdn.microsoft.com/es-es/library/windowsazure/jj152841.aspx
  [pricing]:https://www.windowsazure.com/es-es/pricing/details/web-sites/
  [scalewebsite]:/es-es/manage/services/web-sites/how-to-scale-websites/
  
  [mediaservices]:http://msdn.microsoft.com/es-es/library/windowsazure/dn223282.aspx
  [caching]:http://msdn.microsoft.com/es-es/library/windowsazure/dn386094.aspx
  [monitoring]:/es-es/manage/services/web-sites/how-to-monitor-websites/
  [newrelic]:/es-es/develop/net/how-to-guides/new-relic/
