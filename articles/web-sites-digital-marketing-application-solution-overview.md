...
[Sitios web Azure][] es una buena opción para ambos escenarios. Permite crear con rapidez, admite varios lenguajes y marcos de trabajo, se escala para satisfacer la demanda de los usuarios y aloja muchos sistemas de control de código fuente e implementación. Con el uso de Azure, también puede tener acceso a otros servicios de Azure, como los Servicios multimedia, que pueden mejorar una campaña de marketing.

Aunque se pueden usar las plataformas [Servicios en la nube de Azure][] o [Máquinas virtuales de Azure][] para hospedar sitios web, no se trata de la opción ideal para este escenario, salvo que se precise de alguna característica que Sitios web Azure no ofrece. Para conocer las opciones, consulte [Sitios web, Servicios en la nube y Máquinas virtuales de Azure: cuándo usar cada uno][].
...
![Implementación de marketing digital 1][]
...
![Versiones de marco de trabajo para marketing digital][]
...
![Facebook para marketing digital][]

Para obtener acceso a un tutorial acerca de cómo usar esta plantilla con Sitios web, consulte [Creating a Facebook app using ASP.NET MVC Facebook Templates and hosting them for free on Azure Websites][]. Para obtener acceso a una aplicación de ejemplo y a un tutorial detallado, consulte [ASP.NET MVC Facebook Birthday App][] y [The new Facebook application template and library for ASP.NET MVC][].
...
-   Ajuste de escala manual a través del [Portal de administración de Azure][].
-   Ajuste de escala mediante programación a través de la [API de administración de servicios][] o el [scripting de PowerShell][].
...
![Autoescala para marketing digital][]
...
Para obtener más información acerca del ajuste de escala de los sitios web, consulte [Escalación de sitios web][]. Este tema también está estrechamente relacionado con la supervisión. Para obtener más información, consulte la sección de esta guía que trata sobre la [supervisión de la campaña][Supervisión de la campaña].
...
![Supervisión de marketing digital][]

Por ejemplo, puede consultar los patrones y niveles de uso teniendo en cuenta métricas como **CPU Time**, **Requests** y **Data Out**. Todas estas métricas aumentarán a medida que la campaña de marketing adquiera mayor popularidad. La información acerca del uso puede usarse para decidir si escalar horizontal o verticalmente. Para obtener más información, consulte [Supervisión de sitios web][].
...
![Introducción al uso de marketing digital][]
...
| Ámbito                  | Recursos                                                                                                                                                                 |
|-------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Plan**                | - [Sitios web Azure, Servicios en la nube y Máquinas virtuales: cuándo usar cada uno][].                                                                                 |
| **Creación**            | - [Creación e implementación de un sitio web][]                                                                                                                          |
| **Implementación**      | - [Implementación de un sitio web de Azure][]                                                                                                                            
                           - [Publicación en Sitios web Azure desde el control de código fuente][1]                                                                                                  |
| **Redes sociales**      | - [Implementación de una aplicación ASP.NET MVC segura con suscripción, OAuth y Base de datos SQL][]                                                                     
                           - [Create a Facebook app using ASP.NET MVC Facebook Templates][Creating a Facebook app using ASP.NET MVC Facebook Templates and hosting them for free on Azure Websites]  
                           - [Facebook application template and library for ASP.NET MVC][The new Facebook application template and library for ASP.NET MVC]                                          |
| **Escala**              | - [Escalación de sitios web][2]                                                                                                                                          |
| **Medios enriquecidos** | - [Introducción a los escenarios y conceptos de los Servicios multimedia de Azure][]                                                                                     |
| **Monitor**             | - [Supervisión de sitios web][3]                                                                                                                                         
                           - [Recepción de notificaciones de alerta y administración de reglas de alerta en Azure][].                                                                                |
  ...
  [Escalación de un servicio en la nube]: http://www.windowsazure.com/es-es/manage/services/cloud-services/how-to-scale-a-cloud-service/
  ...
  [Creación e implementación de un sitio web]: http://www.windowsazure.com/es-es/manage/services/web-sites/how-to-create-websites/
  [Implementación de un sitio web de Azure]: http://azure.microsoft.com/es-es/documentation/articles/web-sites-deploy/
  [1]: http://www.windowsazure.com/es-es/develop/net/common-tasks/publishing-with-git/
  ...
  [2]: http://www.windowsazure.com/es-es/manage/services/web-sites/how-to-scale-websites/
  [3]: http://www.windowsazure.com/es-es/manage/services/web-sites/how-to-monitor-websites/
