...
![Implementación de marketing digital 1][Implementación de marketing digital 1]
...
![Versiones de marco de trabajo para marketing digital][Versiones de marco de trabajo para marketing digital]
...
![Facebook para marketing digital][Facebook para marketing digital]

Para obtener acceso a un tutorial acerca de cómo usar esta plantilla con Sitios web, consulte [Creating a Facebook app using ASP.NET MVC Facebook Templates and hosting them for free on Azure Websites][Creating a Facebook app using ASP.NET MVC Facebook Templates and hosting them for free on Azure Websites]. Para obtener acceso a una aplicación de ejemplo y a un tutorial detallado, consulte [ASP.NET MVC Facebook Birthday App][ASP.NET MVC Facebook Birthday App] y [The new Facebook application template and library for ASP.NET MVC][The new Facebook application template and library for ASP.NET MVC].
...
-   Ajuste de escala manual a través del [Portal de administración de Azure][Portal de administración de Azure].
-   Ajuste de escala mediante programación a través de la [API de administración de servicios][API de administración de servicios] o el [scripting de PowerShell][scripting de PowerShell].
...
![Autoescala para marketing digital][Autoescala para marketing digital]
...
Para obtener más información acerca del ajuste de escala de los sitios web, consulte [Escalación de sitios web][Escalación de sitios web]. Este tema también está estrechamente relacionado con la supervisión. Para obtener más información, consulte la sección de esta guía que trata sobre la [supervisión de la campaña][Supervisión de la campaña].

<div class="dev-callout">
<strong>Nota:</strong>
<p>Si se trata de aplicaciones web que optan por usar los servicios en la nube y los roles web, hay una opci&oacute;n adicional para escalar en funci&oacute;n de la longitud de los elementos de una cola. En un servicio en la nube, los roles que procesan colas back-end constituyen un patr&oacute;n de arquitectura com&uacute;n. Para obtener m&aacute;s informaci&oacute;n acerca del ajuste de escala de los servicios en la nube, consulte <a href="http://www.windowsazure.com/es-es/manage/services/cloud-services/how-to-scale-a-cloud-service/">Escalaci&oacute;n de un servicio en la nube</a>.</p>
</div>

## <a name="integrate"></a>Integración con otros servicios

Un sitio de marketing digital a menudo incorporará medios enriquecidos, como la transmisión por secuencias de vídeo. El hospedaje de estos sitios en Azure ofrece una estrecha integración con los servicios de Azure relacionados. Por ejemplo, puede usar los Servicios multimedia de Azure para codificar y transmitir vídeo para el sitio web. Para obtener más información acerca de los Servicios multimedia, consulte [Introducción a los escenarios y conceptos de los Servicios multimedia de Azure][Introducción a los escenarios y conceptos de los Servicios multimedia de Azure].

Se pueden usar otros servicios de Azure para crear una aplicación más sólida. Por ejemplo, la plataforma Servicios web puede usar el almacenamiento en caché distribuido que ofrece el nuevo servicio [Windows Azure Cache Service (vista previa)][Windows Azure Cache Service (vista previa)]. También puede usar los Servicios de almacenamiento de Azure para almacenar los recursos y datos de la aplicación. Por ejemplo, los gráficos, vídeos y otros archivos grandes se pueden almacenar en blobs de forma duradera. Los servicios de base de datos, como Base de datos SQL de Azure y MySQL, también están disponibles para los requisitos de datos relacionales.
...
![Supervisión de marketing digital][Supervisión de marketing digital]

Por ejemplo, puede consultar los patrones y niveles de uso teniendo en cuenta métricas como **CPU Time**, **Requests** y **Data Out**. Todas estas métricas aumentarán a medida que la campaña de marketing adquiera mayor popularidad. La información acerca del uso puede usarse para decidir si escalar horizontal o verticalmente. Para obtener más información, consulte [Supervisión de sitios web][Supervisión de sitios web].
...
![Introducción al uso de marketing digital][Introducción al uso de marketing digital]
...
Además de usar el Portal de administración para obtener esta información, hay una serie de herramientas de terceros que ofrecen datos de supervisión avanzados de los sitios web. Por ejemplo, puede instalar un complemento New Relic de la Tienda Azure. Para obtener acceso a un tutorial acerca de cómo usar New Relic para la supervisión, consulte [Administración del rendimiento de la aplicación New Relic en Sitios web Azure][Administración del rendimiento de la aplicación New Relic en Sitios web Azure].

Por último, los sitios web con el modo estándar pueden permitir las alertas y la supervisión de extremos. Una supervisión de extremos trata regularmente de alcanzar el sitio web y, a continuación, genera informes sobre el tiempo de respuesta. Las alertas ofrecen notificaciones por correo electrónico si el tiempo de respuesta supera el umbral especificado. Para obtener más información, consulte la sección de supervisión del escenario [presencia web global][consulte esa información] y el tema [Recepción de notificaciones de alerta y administración de reglas de alerta en Azure][Recepción de notificaciones de alerta y administración de reglas de alerta en Azure].
...
<tr>
   ...
   <td valign="top">- <a href="http://www.windowsazure.com/es-es/manage/services/web-sites/how-to-create-websites/">Creaci&oacute;n e implementaci&oacute;n de un sitio web</a></td>
</tr>
<tr>
   <td valign="middle"><strong>Implementaci&oacute;n</strong></td>
   <td valign="top">- <a href="http://azure.microsoft.com/es-es/documentation/articles/web-sites-deploy/">Implementaci&oacute;n de un sitio web de Azure</a><br/>- <a href="http://www.windowsazure.com/es-es/develop/net/common-tasks/publishing-with-git/">Publicaci&oacute;n en Sitios web Azure desde el control de c&oacute;digo fuente</a></td>
</tr>
<tr>
   <td valign="middle"><strong>Redes sociales</strong></td>
   <td valign="top">- <a href="http://www.windowsazure.com/es-es/develop/net/tutorials/web-site-with-sql-database/">Implementaci&oacute;n de una aplicaci&oacute;n ASP.NET MVC segura con suscripci&oacute;n, OAuth y Base de datos SQL</a><br/>- <a href="http://blogs.msdn.com/b/africaapps/archive/2013/02/20/creating-a-facebook-app-using-asp-net-mvc-facebook-templates-and-hosting-them-for-free-on-windows-azure-websites.aspx">Create a Facebook app using ASP.NET MVC Facebook Templates</a><br/>- <a href="http://blogs.msdn.com/b/webdev/archive/2012/12/13/the-new-facebook-application-template-and-library-for-asp.net-mvc.aspx">Facebook application template and library for ASP.NET MVC</a></td>
</tr>
<tr>
   <td valign="middle"><strong>Escala</strong></td>
   <td valign="top">- <a href="http://www.windowsazure.com/es-es/manage/services/web-sites/how-to-scale-websites/">Escalaci&oacute;n de sitios web</a></td>
</tr>
<tr>
   <td valign="middle"><strong>Medios enriquecidos</strong></td>
   <td valign="top">- <a href="http://msdn.microsoft.com/es-es/library/windowsazure/dn223282.aspx">Introducci&oacute;n a los escenarios y conceptos de los Servicios multimedia de Azure</a></td>
</tr>
<tr>
  ...
  [presencia web global]: http://www.windowsazure.com/es-es/manage/services/web-sites/global-web-presence-solution-overview/
  ...
  [Implementación de una aplicación ASP.NET MVC segura con suscripción, OAuth y Base de datos SQL en un Sitio web Azure]: /es-es/develop/net/tutorials/web-site-with-sql-database/
  [una lista de bibliotecas disponibles que admiten la API de Twitter]: https://dev.twitter.com/docs/twitter-libraries#dotnet
  ...
  [The new Facebook application template and library for ASP.NET MVC]: http://blogs.msdn.com/b/webdev/archive/2012/12/13/the-new-facebook-application-template-and-library-for-asp.net-mvc.aspx
  [Portal de administración de Azure]: http://manage.windowsazure.com/
  [API de administración de servicios]: http://msdn.microsoft.com/es-es/library/windowsazure/ee460799.aspx
  ...
  [Información sobre el precio de Sitios web]: https://www.windowsazure.com/es-es/pricing/details/web-sites/
  ...
  [Introducción a los escenarios y conceptos de los Servicios multimedia de Azure]: http://msdn.microsoft.com/es-es/library/windowsazure/dn223282.aspx
  ...
  [Administración del rendimiento de la aplicación New Relic en Sitios web Azure]: /es-es/develop/net/how-to-guides/new-relic/
  ...
  [Windows Azure Cache Service (vista previa)]: http://msdn.microsoft.com/es-es/library/windowsazure/dn386094.aspx
