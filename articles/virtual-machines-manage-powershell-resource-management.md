<properties
   pageTitle="Tareas comunes de la máquina virtual con el modo Administrador de recursos en Azure PowerShell"
   description="Proporciona comandos para las tareas comunes de la máquina virtual con el modo Administrador de recursos en Azure PowerShell."
...
# Tareas comunes de máquinas virtuales con Azure PowerShell en modo Administrador de recursos
...
Muchas tareas que se realizan cada día para administrar las máquinas virtuales pueden automatizarse mediante cmdlets de Azure PowerShell en modo Administrador de recursos de Azure. En este artículo se proporcionan comandos de ejemplo para las tareas más sencillas, así como vínculos a artículos que muestran los comandos para tareas más complejas.
...
Si ejecuta el comando con el nombre de grupo de recursos "MyRG" y con la máquina virtual de nombre "MyVM", debería ver algo parecido a lo siguiente:
