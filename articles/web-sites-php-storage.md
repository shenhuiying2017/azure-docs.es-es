...
En este tutorial se explica cómo crear un sitio web PHP y usar el servicio de almacenamiento de tablas de Azure en el back-end. En este tutorial se asume que tiene [PHP](http://www.php.net/manual/en/install.php) y un servidor web instalados en el equipo. Las instrucciones de este tutorial se pueden seguir en cualquier sistema operativo, incluidos Windows, Mac y Linux. Una vez completada esta guía, dispondrá de un sitio web PHP que se ejecuta en Azure y, además, podrá tener acceso al servicio de almacenamiento de tablas.
...
1.  [Instalación de Git](http://git-scm.com/book/en/Getting-Started-Installing-Git)
...
3.  Descargue **[composer.phar](http://getcomposer.org/composer.phar)** en la raíz del proyecto.
...
3.  Haga clic en **Servicios de datos**, **Almacenamiento** y, a continuación, haga clic en **Quick Create**.

    ![Crear un sitio web personalizado](./media/web-sites-php-storage/storage-quick-create.png)

    Escriba un valor de **URL** y seleccione el centro de datos de su sitio web en la lista desplegable **REGIÓN**. Haga clic en el botón **Create Storage Account** en la parte inferior del cuadro de diálogo.

    ![Rellenar detalles del sitio web](./media/web-sites-php-storage/storage-quick-create-details.png)

    Una vez creada la cuenta de almacenamiento, se mostrará el texto **Creation of Storage Account '[NOMBRE]' completed successfully**.
...
5.  Haga clic en **Manage Keys** en la barra de aplicaciones de la parte inferior.
...
6.  Anote el nombre de la cuenta de almacenamiento que ha creado y también la clave principal.
    ...
    ![Seleccionar Administrar claves](./media/web-sites-php-storage/storage-access-keys.png)

7.  Abra **init.php** y reemplace `[YOUR_STORAGE_ACCOUNT_NAME]` y `[YOUR_STORAGE_ACCOUNT_KEY]` por el nombre de cuenta y la clave que ha anotado en el paso anterior. Guarde el archivo.
...
3.  Haga clic en **Proceso**, **Sitio web** y, a continuación, en **Quick Create**.

    ![Crear un sitio web personalizado](./media/web-sites-php-storage/website-quick-create.png)

    Escriba un valor de **URL** y seleccione el centro de datos de su sitio web en la lista desplegable **REGIÓN**. Haga clic en el botón **Create New Web Site** en la parte inferior del cuadro de diálogo.

    ![Rellenar detalles del sitio web](./media/web-sites-php-storage/website-quick-create-details.png)
...
4.  Haga clic en el nombre del sitio web que se muestra en la lista para abrir el panel **QUICKSTART** del sitio web.
...
2.  Abra GitBash (o un terminal, si Git está en `PATH`), cambie los directorios al directorio raíz de la aplicación y ejecute los siguientes comandos (**Nota:** estos son los mismos pasos que se muestran al final de la sección **Creación de un sitio web de Azure y configuración de la publicación Git**):
...
3.  Diríjase a **http://[dominio del sitio web]/createtable.php** a fin de crear la tabla para la aplicación.
4.  Diríjase a **http://[dominio del sitio web]/index.php** para empezar a usar la aplicación.
