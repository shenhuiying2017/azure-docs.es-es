...
- **Una estación de trabajo con Azure PowerShell**. Consulte [Instalar Azure PowerShell 1.0 y versiones posteriores](data-lake-analytics-manage-use-powershell.md#install-azure-powershell-10-and-greater).
