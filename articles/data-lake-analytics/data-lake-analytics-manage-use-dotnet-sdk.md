<properties 
   pageTitle="Administración de Azure Data Lake Analytics con el SDK de .NET de Azure | Azure" 
...
# Administración de Azure Data Lake Analytics con el SDK de .NET para Azure
...
## Conexión a Azure Data Lake Analytics
...
La cuenta de Análisis de Data Lake y las cuentas de almacenamiento dependientes deben ubicarse en el mismo centro de datos de Azure. Sin embargo, el grupo de Resource Manager se puede ubicar en un centro de datos distinto.
