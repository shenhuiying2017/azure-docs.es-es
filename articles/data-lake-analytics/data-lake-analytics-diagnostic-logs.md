...
2. Dentro de estos contenedores, los registros se almacenan con la siguiente estructura.
   ...
   > [!NOTE]
   > Las entradas `##` de la ruta de acceso contienen el año, mes, día y hora en que se creó el registro. Data Lake Analytics crea un archivo cada hora, por lo que `m=` siempre contiene un valor de `00`.
   > 
   > 
...
> [!NOTE]
> **SubmitTime**, **StartTime**, **EndTime** y **Paralelismo** proporcionan información sobre una operación y solo contendrán algún valor si una operación se ha iniciado o completado. Por ejemplo, **SubmitTime** contiene un valor después de que **operationName** indique **JobSubmitted**.
> 
> 
