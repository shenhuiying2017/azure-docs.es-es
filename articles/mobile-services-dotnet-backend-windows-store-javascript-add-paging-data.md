<properties 
	pageTitle="Incorporación de paginación a datos (JavaScript): Servicios móviles de Azure" 
	description="Obtenga información acerca de cómo utilizar la paginación para administrar la cantidad de datos devueltos a la aplicación de JavaScript de la Tienda Windows desde los Servicios móviles.ata returned to your Windows Store JavaScript app from Mobile Services." 
