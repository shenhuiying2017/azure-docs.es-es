---
title: Autenticación y autorización en el Servicio de aplicaciones de Azure | Microsoft Docs
...
> [!IMPORTANT]
> Como las aplicaciones móviles se ejecutan en dispositivos de cliente, las aplicaciones móviles *no* se consideran aplicaciones de confianza y no deberían usar un flujo de entidades de servicio. En su lugar, deben utilizar un flujo de usuario que se ha mencionado anteriormente.
> 
> 
