...
Además de escalar verticalmente el plan de tarifa, puede aumentar el número de instancias que tiene el servicio. Esto se conoce como *Reducción vertical* o *Reducción horizontal*. Vea el artículo sobre [Escalación del recuento de instancias de forma manual o automática](../azure-portal/insights-how-to-scale.md) para obtener más información sobre *Reducción vertical* y *Reducción horizontal*.

Para obtener más información sobre los planes de Servicio de aplicaciones, consulte [Introducción detallada sobre los planes del Servicio de aplicaciones de Azure](azure-web-sites-web-hosting-plans-in-depth-overview.md). Para obtener información de los precios y características de planes Servicios de aplicaciones individuales, consulte [Detalles de precios del Servicio de aplicaciones](/pricing/details/app-service/).

Por último, la escalación funciona de una forma distinta si desea usar un [entorno del Servicio de aplicaciones](app-service-app-service-environments-readme.md) dedicado. Consulte [Escalado de aplicaciones web en un entorno del Servicio de aplicaciones](../app-service-web/app-service-web-scale-a-web-app-in-an-app-service-environment.md) para obtener más información.
