...
* **Caché en rol** se actualizó para utilizar la versión 4.3 del **SDK de Microsoft Azure Storage**. Hasta ahora, **Caché en Rol** usaba la versión 1.7 del SDK de Almacenamiento de Azure.
