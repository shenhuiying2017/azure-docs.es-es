---
title: Cómo funciona Servicio de aplicaciones de Azure
...
---
# <a name="how-app-service-works"></a>Cómo funciona Servicio de aplicaciones
Servicio de aplicaciones de Azure es un servicio en la nube diseñado para resolver los problemas prácticos a los que se enfrentan hoy en día los ingenieros. Servicio de aplicaciones se centra en ofrecer una productividad superior sin que perjudique a la necesidad de entregar aplicaciones a escala de nube. Servicio de aplicaciones también proporciona las características y marcos necesarios para crear aplicaciones de línea de negocio, al tiempo que ofrece soporte a los desarrolladores con los lenguajes de desarrollo más populares (.NET, Java, PHP, Node.JS y Python).
Con Servicio de aplicaciones, los desarrolladores pueden:
...
* Ejecución de tareas asincrónicas y trabajos por lotes: ejecute código en un proceso en segundo plano o active el código basado en eventos (como los mensajes que llegan a una cola de almacenamiento de Azure) y horas programadas (CRON).
* Escalado de la aplicación: use una de las numerosas opciones para escalar su servicio horizontal y verticalmente de forma automática según el tráfico y el uso de los recursos. Configure entornos privados dedicados a las aplicaciones   
