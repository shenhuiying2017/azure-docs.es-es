...
| [`az webapp log config`](/cli/azure/webapp/log?view=azure-cli-latest#az-webapp-log-config) | Configura los registros que conservará una aplicación web de Azure. |
| [`az webapp log download`](/cli/azure/webapp/log?view=azure-cli-latest#az-webapp-log-download) | Descarga los registros de una aplicación web de Azure en el equipo local. |
