...
Este script de ejemplo crea un grupo de recursos, un plan de App Service de Linux y una aplicación web. A continuación, implementa una aplicación de ASP.NET Core con un contenedor de Docker de Azure Container Registry.
