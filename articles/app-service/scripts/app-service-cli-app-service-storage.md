...
Este script de ejemplo crea una cuenta de Azure Storage y una aplicación web de Azure. A continuación, vinculará la cuenta de almacenamiento a la aplicación web mediante la configuración de la aplicación.
...
| [`az storage account show-connection-string`](/cli/azure/storage/account?view=azure-cli-latest#az_storage_account_show_connection_string) | Obtiene la cadena de conexión para una cuenta de almacenamiento. |
