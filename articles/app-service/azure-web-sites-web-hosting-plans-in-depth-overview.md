...
description: "Obtenga información acerca de cómo funcionan los planes de App Service y cómo benefician a su experiencia de administración."
keywords: app service, azure app service, escala, escalable, plan de app service, costo de app service
...
---
# <a name="azure-app-service-plans-in-depth-overview"></a>Introducción detallada sobre los planes de Azure App Service
...
## <a name="apps-and-app-service-plans"></a>Aplicaciones y planes de App Service

Una aplicación de App Service se puede asociar a un solo plan de dicho servicio en un momento determinado.
...
Como un único grupo de recursos puede tener varios planes de App Service, se pueden asignar diferentes aplicaciones a diferentes recursos físicos.
...
Puede crear un plan de App Service vacío desde la experiencia de exploración del plan de App Service o como parte de la creación de la aplicación.
...
A continuación, puede seleccionar o crear el plan de App Service para la nueva aplicación.
...
## <a name="move-an-app-to-a-different-app-service-plan"></a>Cambio de una aplicación a un plan de App Service diferente
...
## <a name="clone-an-app-to-a-different-app-service-plan"></a>Clonación de una aplicación en un plan de App Service diferente
...
> [!IMPORTANT]
> La clonación presenta algunas limitaciones sobre las que puede leer en [Clonación de aplicaciones de Azure App Service mediante Azure Portal](../app-service-web/app-service-web-app-cloning-portal.md).
...
Puede cambiar el plan de tarifa y el tamaño de la instancia haciendo clic en el elemento **Escalar verticalmente** en la configuración de la aplicación o del plan de App Service. Los cambios se aplicarán al plan de App Service y afectarán a todas las aplicaciones que hospede.
