...
En [Azure Portal](https://portal.azure.com), haga clic en **Nuevo** > 
**Web y móvil** y, a continuación, seleccione **Aplicación web** u otro tipo de aplicación de App Service.
...
> [!IMPORTANT]
> Se muestran únicamente los planes válidos (es decir, los que están en el mismo grupo de recursos y ubicación geográfica).
