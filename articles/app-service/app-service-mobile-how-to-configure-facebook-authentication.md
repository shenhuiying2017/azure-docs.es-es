...
7. En **Iniciar sesión en Facebook**, haga clic en **Configurar** y elija **Configuración** en el panel de navegación del lado izquierdo, bajo **Iniciar sesión en Facebook**.
8. Agregue el **URI de redirección** de la aplicación a **Valid OAuth redirect URIs** (URI de redirección de OAuth válidos) y haga clic en **Save Changes** (Guardar cambios).
