---
title: "Creación de una aplicación de Ruby con Azure Web Apps en Linux | Microsoft Docs"
...
[Azure Web Apps](../app-service-web-overview.md) proporciona un servicio de hospedaje web muy escalable y con aplicación de revisiones de un modo automático. En esta guía de inicio rápido se muestra cómo crear una aplicación de Ruby on Rails básica en la aplicación e implementarla a continuación en Azure como Aplicación web en Linux.
...
Use el comando [az appservice plan create](https://docs.microsoft.com/cli/azure/appservice/plan#az_appservice_plan_create) para crear un plan de App Service para su aplicación web.
...
Una vez que la implementación haya finalizado, reinicie la aplicación web para que la implementación surta efecto mediante el comando [az webapp restart](https://docs.microsoft.com/cli/azure/webapp#az_webapp_restart), como se muestra aquí:
