...
Para más información, consulte [Configuración de la experimentación](../desktop-workbench/experimentation-service-configuration.md).
...
Para obtener más información sobre el servicio Administración de modelos, consulte [Introducción a Administración de modelos](../desktop-workbench/model-management-overview.md)
...
Para obtener más información, consulte [Uso de MMLSpark en Azure Machine Learning](../desktop-workbench/how-to-use-mmlspark.md).
...
Además de Azure Machine Learning, hay una amplia variedad de opciones en Azure para generar, implementar y administrar modelos de aprendizaje automático. [Puede encontrar más información sobre ellas aquí.](../desktop-workbench/overview-more-machine-learning.md)
