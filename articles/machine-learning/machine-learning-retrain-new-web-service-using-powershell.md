<properties
	pageTitle="Reciclaje de un servicio web nuevo mediante los cmdlets de PowerShell para administración de aprendizaje automático | Microsoft Azure"
...
# Reciclaje de un servicio web nuevo mediante los cmdlets de PowerShell para administración de aprendizaje automático
...
Debe haber configurado un experimento de entrenamiento y un experimento predictivo tal como se muestra en los modelos de reciclaje de Machine Learning mediante programación. Para obtener información sobre la creación de experimentos de entrenamiento y predictivos, vea [Volver a entrenar modelos de aprendizaje automático mediante programación](Volver a entrenar modelos de aprendizaje automático mediante programación.md).
...
En los recursos, busque [modelo entrenado], actualice el valor de *uri* en el nodo *locationInfo* con el identificador URI del blob ilearner. El identificador URI se genera mediante la combinación de *BaseLocation* y *RelativeLocation* a partir de la llamada de reciclaje de BES.
...
Debe utilizar el cmdlet [Import-AzureRmMlWebService](https://msdn.microsoft.com/library/azure/mt767925.aspx) para convertir el archivo JSON modificado en una definición de servicio web que puede usar para actualizar el experimento predictivo.
