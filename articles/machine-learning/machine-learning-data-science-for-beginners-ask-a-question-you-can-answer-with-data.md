<properties
   pageTitle="Realización de preguntas que pueden responderse con datos | Microsoft Azure"
...
*Ciencia de datos para principiantes* es una introducción rápida a la ciencia de datos en cinco vídeos de corta duración.
  ...
  * Vídeo 1: [Las cinco preguntas a las que responde la ciencia de datos](machine-learning-data-science-for-beginners-the-5-questions-data-science-answers.md). **Ya disponible.**
