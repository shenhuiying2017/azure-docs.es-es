...
4. Envíe el servicio web como entrada de la competición y podrá ver la puntuación pública que obtiene en la página de la competición de la galería de Cortana Intelligence. Si consigue aparecer en el marcador, celébrelo como se merece.  
   Después de enviar una entrada correctamente, puede volver al experimento de inicio, repetir todos los pasos, actualizar el experimento predictivo, actualizar el servicio web y enviar una nueva entrada.   

**¿Puedo usar herramientas de código abierto para participar en estas competiciones?**

Los participantes de la competición usan el Estudio de aprendizaje automático de Azure, un servicio basado en la nube y que se incluye dentro del conjunto de Cortana Intelligence, para desarrollar modelos de ciencia de datos y crear entradas para participar en la competición. El Estudio de aprendizaje automático no solo proporciona una interfaz gráfica de usuario para crear experimentos de aprendizaje automático, sino que también permite aprovechar sus propios scripts de R o Python para la ejecución nativa. El tiempo de ejecución de R y Python en el Estudio de aprendizaje automático incluye un amplio conjunto de paquetes de R o Python de código abierto y también permite importar sus propios paquetes como parte del experimento. El Estudio de aprendizaje automático también incluye un servicio integrado de Jupyter Notebook para que pueda llevar a cabo exploración de datos de estilo libre. Por supuesto, siempre puede descargar los conjuntos de datos usados en la competición y explorarlos en su herramienta favorita fuera del Estudio de aprendizaje automático. 
...
En una competición típica, se puede limitar el número de entradas a las que se puedan enviar a un intervalo de 24 horas (de las 00:00:00 a las 23:59:59 hora UTC) y al número total de entradas que pueda enviar durante el tiempo que dure la competición. Recibirá los mensajes de error que corresponda cuando se supere una limitación. 
...
No. Debe utilizar un área de trabajo gratuito o estándar para participar. Puede abrir el experimento de inicio de la competición en un área de trabajo de invitado, pero no podrá crear una entrada válida para el envío. 

**¿Puedo participar con un área de trabajo en cualquier región de Azure?**

La plataforma de competición actual solo admite el envío de entradas que se realice desde un área de trabajo de la región centro-sur de EE. UU. de Azure. Todas las áreas de trabajo gratuitas se encuentran en el centro-sur de EE. UU. pero si decide usar un área de trabajo estándar, asegúrese de que se encuentre en la región centro-sur de EE. UU. de Azure. De lo contrario, no se realizará el envío. 
