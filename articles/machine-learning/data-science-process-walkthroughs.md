<properties 
    pageTitle="Tutoriales del proceso de ciencia de los datos en equipos | Microsoft Azure" 
...
Los tutoriales completos detallados aquí demuestran los pasos del proceso de ciencia de los datos en equipos en **escenarios específicos**. En ello se ilustra cómo combinar servicios y herramientas en la nube y locales en un flujo de trabajo o una canalización con el fin de crear una aplicación inteligente.
