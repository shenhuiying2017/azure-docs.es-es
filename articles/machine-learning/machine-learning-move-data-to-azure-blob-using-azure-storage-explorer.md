...
El Explorador de almacenamiento de Azure es una herramienta gratuita basada en Windows para inspeccionar y modificar datos de una cuenta de almacenamiento de Azure. Se puede descargar en el [Explorador de almacenamiento de Azure](http://azurestorageexplorer.codeplex.com/).
