---
title: Mover datos hacia y desde el almacenamiento de blobs de Azure con el Explorador de almacenamiento de Azure | Microsoft Docs
...
> 
> [!NOTE]
> Para ver una introducción completa al almacenamiento de blobs de Azure, consulte [Aspectos básicos del blob de Azure](../storage/storage-dotnet-how-to-use-blobs.md) y [Servicio BLOB de Azure](https://msdn.microsoft.com/library/azure/dd179376.aspx).
> 
> 
