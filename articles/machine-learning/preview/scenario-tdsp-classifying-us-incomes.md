...
* [Ejecución](experiment-execution-configuration.md)
...
En este ejemplo, se ejecuta código en el **entorno de proceso local**. Consulte los documentos de Azure Machine Learning para más información sobre las [opciones de ejecución](experiment-execution-configuration.md).
