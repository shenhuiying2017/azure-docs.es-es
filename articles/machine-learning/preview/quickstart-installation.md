...
Actualmente, la aplicación de escritorio de Azure Machine Learning Workbench solo se puede instalar en los siguientes sistemas operativos: 
- Windows 10
- Windows Server 2016
- macOS Sierra

>[!NOTE]
>macOS High Sierra aún no es compatible.
