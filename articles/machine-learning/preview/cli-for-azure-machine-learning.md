---
title: Instalación y uso de la CLI de aprendizaje automático para las principales tareas de Azure Machine Learning
...
>[!NOTE]
>La CLI que se entrega con los servicios de Azure Machine Learning es distinta de la [CLI de Azure](https://docs.microsoft.com/en-us/cli/azure/?view=azure-cli-latest) que se usa para administrar los recursos de Azure.
...
+ [Install and start using Azure Machine Learning](quickstart-installation.md) (Instalación de Azure Machine Learning y comenzar a trabajar con él).
