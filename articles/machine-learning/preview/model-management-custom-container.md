...
1. Un archivo dependencies.yml: para administrar las dependencias que se pueden instalar de [PyPi]( https://pypi.python.org/pypi), puede utilizar el archivo conda_dependencies.yml desde el proyecto de Workbench o crea el suyo propio. Este es el enfoque recomendado para la instalación de las dependencias de Python en las que se puede instalar PIP.
