<properties
	pageTitle="Solución de problemas de reentrenamiento de un servicio web clásico de Azure Machine Learning | Microsoft Azure"
...
#Solución de problemas de reentrenamiento de un servicio web clásico de Azure Machine Learning

## Información general sobre reentrenamiento
...
Para ver un tutorial completo del proceso de reentrenamiento de un servicio web clásico, consulte [Volver a entrenar modelos de aprendizaje automático mediante programación](machine-learning-retrain-models-programmatically.md).
...
1.	Llame al servicio web de aprendizaje: la llamada se realiza a Batch Execution Service (BES), no a Request Response Service (RRS). Puede usar el código C# de ejemplo en la página de ayuda de la API para realizar la llamada.
2.	Busque los valores de *BaseLocation*, *RelativeLocation* y *SasBlobToken*: estos valores se devuelven en el resultado de la llamada al servicio web de aprendizaje. ![muestra la salida del ejemplo reentrenamiento y los valores de BaseLocation, RelativeLocation y SasBlobToken.][image6]
