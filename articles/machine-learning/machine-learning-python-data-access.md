---
title: Acceso a conjuntos de datos con la biblioteca de cliente de Python de Aprendizaje automático | Microsoft Docs
...
9. Seleccione el fragmento de código y cópielo en la ventana que se muestra.
   
    ![Código de acceso][intermediate-dataset-access-code]
10. Pegue el código en el Bloc de notas.
    
     ![Bloc de notas][ipython-intermediate-dataset]
11. Puede visualizar los datos con matplotlib. Esto se muestra en un histograma de la columna de tiempo:
