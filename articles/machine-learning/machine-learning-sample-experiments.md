<properties
    pageTitle="Copia de experimentos de ejemplo de Aprendizaje automático | Microsoft Azure"
...
3. Puede encontrar los experimentos que cumplan con sus requisitos de las siguientes maneras:
    * **Seleccione los filtros de la izquierda.** Por ejemplo, para examinar los experimentos que utilizan un algoritmo de detección de anomalías basado en PCA, seleccione **Experiment** (Experimento) en **Categories** (Categorías), y **PCA-Based Anomaly Detection** (Detección de anomalías basada en PCA) en **Algorithms Used** (Algoritmos usados). Si no ve ese algoritmo, haga clic en **Show All** (Mostrar todo) en la parte inferior de la lista.<br></br> ![](./media/machine-learning-sample-experiments/refine-the-view.png)
