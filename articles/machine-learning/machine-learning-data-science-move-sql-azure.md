<properties pageTitle="Mover datos a una base de datos SQL de Azure para Aprendizaje automático de Azure | Azure" description="Crear tabla SQL y cargar datos en ella" services="machine-learning" documentationCenter="" authors="fashah" manager="jacob.spoelstra" editor="" videoId="" [hee scriptId="" />
...
* Acceso a una **Base de datos SQL de Azure**. Si debe configurar una Base de datos SQL de Azure, [Introducción a Base de datos SQL de Microsoft Azure](sql-database-get-started.md) ofrece información sobre cómo aprovisionar una nueva instancia de una Base de datos SQL de Azure.
