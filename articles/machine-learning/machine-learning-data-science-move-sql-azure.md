...
* Acceso a una **base de datos SQL de Azure**. Si debe configurar una base de datos SQL de Azure, [Introducción a Base de datos SQL de Microsoft Azure](sql-database-get-started.md) proporciona información sobre cómo aprovisionar una nueva instancia de una base de datos SQL de Azure.
