...
- Para seguir los pasos de esta guía, primero debe [instalar Azure ML Workbench](../service/quickstart-installation.md).
...
Felicidades. El script aprovecha la potencia de GPU a través de un contenedor de Docker.
