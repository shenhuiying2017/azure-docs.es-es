...
Cree una cuenta de Experimentación de Machine Learning e instale la aplicación Azure Machine Learning Workbench. Para más información, vea [Creación de cuentas de la versión preliminar de Azure Machine Learning e instalación de Azure Machine Learning Workbench](../service/quickstart-installation.md).
