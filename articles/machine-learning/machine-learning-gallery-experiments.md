...
3. Cuando esté preparado para publicar el experimento en la Galería, seleccione **Publicar en la galería** en la lista de acciones debajo del lienzo de experimentos.
    ...
    ![Seleccionar "Publicar en la galería"](media/machine-learning-gallery-experiments/publish-experiment-to-gallery.png)
...
9. Para publicar el experimento en la Galería, active la casilla **Aceptar**.
    ...
    ![Activar la casilla Aceptar para publicar el experimento](media/machine-learning-gallery-experiments/ok-checkmark.png)
...
![Seleccionar Editar para editar el experimento](media/machine-learning-gallery-experiments/edit-button.png)
...
![Seleccionar "Editar" para editar detalles y "Listo" cuando haya finalizado](media/machine-learning-gallery-experiments/edit-details-page.png)
...
![Seleccionar "Configuración" para cambiar la visibilidad del experimento o eliminarlo](media/machine-learning-gallery-experiments/settings-button.png)
