...
- itemName (string, optional) – nombre del elemento 
- itemDescription (string, optional) – descripción del elemento 
- itemCategory (string, optional) – categoría del elemento
...
* item (comprados) – matriz con una entrada por cada elemento comprado.<br><br> 
Formato de compra: 
