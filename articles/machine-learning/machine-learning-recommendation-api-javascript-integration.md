...
- elemento (cadena, obligatorio) – Identificador único del elemento - itemName (cadena, opcional)
– nombre del elemento - itemDescription (cadena, opcional)
– descripción del elemento - itemCategory (cadena, opcional)– categoría del elemento - seeds (matriz de cadena, opcional)
– valores de inicialización que han generado la consulta de recomendación.
