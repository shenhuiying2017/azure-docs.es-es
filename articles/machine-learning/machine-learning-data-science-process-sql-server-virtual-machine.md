<properties 
	pageTitle="Procesar datos de SQL Azure | Azure" 
...
#<a name="heading"></a>Procesar datos en una máquina virtual de SQL Server en Azure
...
1. [Mediante SQL](#sql)
2. [Mediante un lenguaje de programación como Python](#python) 
