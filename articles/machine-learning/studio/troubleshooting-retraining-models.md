...
Para ver un tutorial completo del proceso de reentrenamiento de un servicio web clásico, consulte [Reentrenamiento mediante programación de modelos de Machine Learning](retrain-models-programmatically.md).
...
2. Vaya a la pestaña Aprendizaje automático. ![Pestaña Machine Learning.][image4]
...
1. Inicie sesión en el [Portal de Azure clásico](https://manage.windowsazure.com).
2. Vaya a la pestaña Aprendizaje automático. ![Interfaz de usuario del área de trabajo de Machine Learning.][image4]
