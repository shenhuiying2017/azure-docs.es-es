...
description: El módulo de PowerShell para Azure Machine Learning está disponible en versión preliminar pública. Use PowerShell para crear y administrar áreas de trabajo, experimentos, servicios web y mucho más.
...
---
# <a name="powershell-module-for-microsoft-azure-machine-learning"></a>Módulo de PowerShell para Microsoft Azure Machine Learning
...
## <a name="what-is-the-machine-learning-powershell-module"></a>¿Qué es el módulo de PowerShell de Machine Learning?
