---
title: "Cuadernos de Jupyter de la Galería de Azure AI | Microsoft Docs"
description: "Detecte cuadernos de Jupyter en la Galería de Azure AI."
...
---
# <a name="discover-jupyter-notebooks-in-the-azure-ai-gallery"></a>Descubrimiento de cuadernos de Jupyter en la Galería de Azure AI
...
## <a name="discover"></a>Descubra
  Para buscar los cuadernos en la galería, abra la [galería](http://gallery.cortanaintelligence.com) y haga clic en **Notebooks** en la parte superior de la página principal de la galería.

 La página **[Jupyter Notebooks](https://gallery.cortanaintelligence.com/notebooks)** muestra una lista de los cuadernos más populares.
...
3. Seleccionar la región y el área de trabajo que desea usar
    ...
    ![Abrir Jupyter notebook desde la Galería](./media/gallery-jupyter-notebooks/open-notebook-from-gallery.png)
...
3. Señale con el mouse en un bloc de notas y seleccione **Abrir bloc de notas**
    ...
    ![Abrir bloc de notas de la galería desde dentro de Machine Learning Studio](./media/gallery-jupyter-notebooks/open-notebook-from-studio.png)
