---
title: Configuración de una máquina virtual de Azure SQL Server como servidor del Bloc de notas de IPython | Microsoft Docs
...
Para conectar discos de datos adicionales, siga los pasos descritos en [Acoplamiento de un disco de datos a una máquina virtual de Windows](../virtual-machines/virtual-machines-windows-classic-attach-disk.md), que le guiarán a través de la:
...
1. En el **Explorador de objetos de SQL Server Management Studio**, haga clic con el botón derecho en el nombre de la instancia de SQL Server (el nombre de la máquina virtual) y luego en **Propiedades**.
   
   ![Propiedades del servidor][7]
2. En la página **Seguridad**, en **Autenticación de servidor**, seleccione **Modo de autenticación de Windows y SQL Server** y, a continuación, haga clic en **Aceptar**.
...
4. En el **Explorador de objetos**, haga clic con el botón derecho en el servidor y luego en **Reiniciar**. (También se debe reiniciar Agente SQL Server si está en ejecución).
