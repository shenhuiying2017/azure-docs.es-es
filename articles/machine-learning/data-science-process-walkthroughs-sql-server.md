---
title: Tutoriales de ciencia de datos de SQL Server mediante R, Python y T-SQL | Microsoft Docs
...
En el tutorial sobre el [uso de SQL Server](machine-learning-data-science-process-sql-walkthrough.md) se muestra cómo crear e implementar modelos de clasificación y regresión de aprendizaje automático mediante SQL Server y un conjunto de datos de carreras y tarifas de taxi de la ciudad de Nueva York disponible públicamente.
