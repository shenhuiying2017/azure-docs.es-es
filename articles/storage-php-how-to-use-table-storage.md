<properties 
	pageTitle="Uso del almacenamiento de tablas (PHP) | Microsoft Azure" 
...
* [Establecimiento una tabla](#CreateTable)
* [Establecimiento una entidad a una tabla](#AddEntity)
* [Uso de una sola entidad](#RetrieveEntity)
* [Uso de todas las entidades de una partición](#RetEntitiesInPartition)
* [Uso de un subconjunto de entidades de una partición](#RetrieveSubset)
* [Uso de un subconjunto de propiedades de las entidades](#RetPropertiesSubset)
* [Establecimiento una entidad](#UpdateEntity)
* [Uso de operaciones de tabla](#BatchOperations)
* [Uso de una tabla](#DeleteTable)
...
##<a id="GetClientLibrary"></a>Obtención de las bibliotecas de cliente de Azure
...
##<a id="AddEntity"></a>Procedimiento: una entidad a una tabla
...
##<a id="RetrieveEntity"></a>Procedimiento: de una sola entidad
...
##<a id="RetEntitiesInPartition"></a>Procedimiento: todas las entidades de una partición
...
##<a id="RetrieveSubset"></a>Procedimiento: un subconjunto de entidades de una partición
...
##<a id="RetPropertiesSubset"></a>Procedimiento: un subconjunto de propiedades de las entidades
...
##<a id="UpdateEntity"></a>Procedimiento: de una entidad
...
##<a id="DeleteEntity"></a>Procedimiento: una entidad
...
##<a id="BatchOperations"></a>Procedimiento: de operaciones de tabla
...
##<a id="DeleteTable"></a>Procedimiento: de una tabla
