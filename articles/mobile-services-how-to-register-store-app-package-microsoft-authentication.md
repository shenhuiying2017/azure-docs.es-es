<properties urlDisplayName="Shared Access Signature Part 1" pageTitle="Registro del paquete de la aplicación de la Tienda Windows para la autenticación de Microsoft" metaKeywords="" description="Obtenga información acerca de cómo registrar su aplicación de la Tienda Windows para la autenticación de Microsoft en la aplicación de Servicios móviles de Azure." metaCanonical="" services="mobile-services" documentationCenter="Mobile" title="Register your Windows Store app package for Microsoft authentication" authors="glenga" solutions="" manager="dwrede" editor="" />
...
[Autenticación de una aplicación de la Tienda Windows con el inicio de sesión único de Live Connect]: /en-us/develop/mobile/tutorials/single-sign-on-windows-8-dotnet
