...
Independientemente de la imagen que use, hay consideraciones sobre la concesión de licencias en cualquier momento que comparta una aplicación con los usuarios. Consulte los [Detalles de concesión de licencias de RemoteApp](remoteapp-licensing.md) para obtener más información.
