<properties title="What is in the RemoteApp template images?" pageTitle="¿Cuáles son las imágenes de plantilla de RemoteApp?" description="Obtenga información sobre las imágenes de plantilla incluidas con RemoteApp." metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo" manager="mbaldwin" />
...
Independientemente de la imagen que use, hay consideraciones sobre la concesión de licencias en cualquier momento que comparta una aplicación con los usuarios. Consulte los [detalles de concesión de licencias de RemoteApp](http://azure.microsoft.com/es-es/documentation/articles/remoteapp-licensing/) para obtener más información.
...
**Información legal importante:** esta imagen no incluye una licencia de Microsoft Office y *no se puede usar para producción*. La imagen de Office 2013 Professional Plus está pensada solo para uso de prueba. Si quiere usar aplicaciones de Office en Azure RemoteApp para producción, deberá usar la imagen de Office 365 ProPlus. Para obtener más detalles acerca de la obtención de licencias de RemoteApp, consulte [¿Cómo funciona a obtención de licencias de Azure RemoteApp?](http://azure.microsoft.com/es-es/documentation/articles/remoteapp-licensing/)  
