...
Creación de un servicio en la nube usando Quick Create
------------------------------------------------------

1.  En el [Portal de administración](http://manage.windowsazure.com/), haga clic en **New**, después en **Servicio en la nube** y, finalmente, en **Quick Create**.
...
3.  Haga clic en **Add new certificate** o **Upload**. **Add a Certificate** se abrirá.

    ![CloudServices\_AddaCertificate](./media/cloud-services-how-to-create-deploy/CloudServices_AddaCertificate.png)

4.  En **Certificate file**, utilice **Browse** para seleccionar el certificado (archivo .pfx) que quiera usar.
...
2.  Haga clic en **Quick Start** (el icono situado a la izquierda de **Panel**) para abrir la página **Quick Start** que se muestra a continuación. (También puede implementar su servicio en la nube usando **Upload** en el panel).
...
4.  Haga clic en **Implementación producción** o **Implementación ensayo**.
    ...
    Cuando seleccione un entorno de implementación, se abrirá **Upload a Package**.

    ![CloudServices\_UploadaPackage](./media/cloud-services-how-to-create-deploy/CloudServices_UploadaPackage.png)

5.  En **Nombre de implementación**, escriba un nombre para la nueva implementación; por ejemplo, MyCloudServicev1.
