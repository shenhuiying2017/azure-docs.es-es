...
##  <a name="a-nameapilista-api-list"></a><a name="APIList"></a> API list  
...
##  <a name="a-nameproducta-operation"></a><a name="Product"></a> Operation  
...
##  <a name="a-namecodesamplesa-code-samples"></a><a name="CodeSamples"></a> Ejemplos de código  
