...
+ Asegúrese de que hay una aplicación lógica en su suscripción. Para obtener más información, [cree su primera aplicación lógica](../logic-apps/logic-apps-create-a-logic-app.md)
