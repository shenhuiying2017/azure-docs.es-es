...
Nota: una directiva global que no tiene ninguna directiva superior al elemento *base* es siempre una directiva *no-op* o no tiene efecto.

  [Referencia de directivas]: ../api-management-policy-reference
  [producto]: ../api-management-howto-add-products
  [API]: ../api-management-howto-add-products/#add-apis
  [operación]: ../api-management-howto-add-operations
