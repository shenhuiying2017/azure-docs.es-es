...
Para más información, puede ver el vídeo [Role-Based Access Control in API Management](https://channel9.msdn.com/Blogs/AzureApiMgmt/Role-Based-Access-Control-in-API-Management/player) (Control de acceso basado en rol de API Management).
