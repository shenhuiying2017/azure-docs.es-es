...
Haga clic en **Directivas** en el menú **Administración de API** de la izquierda y, a continuación, seleccione **API Eco/Recurso GET (en caché)** en la lista desplegable **Operación**.
