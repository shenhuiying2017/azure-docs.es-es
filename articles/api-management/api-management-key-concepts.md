...
Para obtener una lista completa de las directivas de Administración de API, consulte [Referencia de la directiva][Referencia de la directiva]. Para obtener más información acerca del uso y la configuración de directivas, consulte [Directivas de Administración de API][Directivas de Administración de API]. Para ver un tutorial sobre la creación de un producto con directivas de cuota y límite de tasas, consulte [Creación y definición de configuraciones de productos avanzadas][Creación y definición de configuraciones de productos avanzadas]. Para ver una demostración, vea el siguiente vídeo.
