...
|Nombre|string|Nombre de la API. No debe estar vacía. La longitud máxima es de 100 caracteres.|  
...
|Cuerpo|string|Un marcador de posición para la parte del ejemplo de código del fragmento de código.|  
...
|Nombre|string|Nombre de la operación. No debe estar vacía. La longitud máxima es de 100 caracteres.|  
