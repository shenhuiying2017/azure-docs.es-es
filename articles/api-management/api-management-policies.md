...
##  <a name="a-nameproxypoliciesa-policies"></a><a name="ProxyPolicies"></a> Directivas  
...
-   [Directivas avanzadas](api-management-advanced-policies.md#AdvancedPolicies)  
    ...
    -   [Set status code](api-management-advanced-policies.md#SetStatus) (Establecer código de estado): cambia el código de estado HTTP al valor especificado.  
