<properties title="An&aacute;lisis de datos de sensor usando Hive con HDInsight" pageTitle="An&aacute;lisis de datos de sensor usando Hive y Microsoft Azure HDInsight (Hadoop)" description="Vea c&oacute;mo usar Hive y Excel para analizar y visualizar datos de sensor con HDInsight (Hadoop)" metaKeywords="Azure hdinsight hive, Azure hdinsight hive sensor, azure hadoop hive, azure hadoop sensor, azure hadoop excel, azure hdinsight excel" services="hdinsight" solutions="" documentationCenter="big-data" authors="larryfr" videoId="" scriptId="" />
...
-   Un clúster de HDInsight (Hadoop). Consulte [Aprovisionamiento de clústeres de Hadoop en HDInsight][Aprovisionamiento de clústeres de Hadoop en HDInsight] para obtener más información sobre la creación de un clúster.

-   Microsoft Excel 2013

    > [WACOM.NOTE] Microsoft Excel se usa para la visualización de datos con [Power View][Power View], que actualmente solo está disponible en Windows.
