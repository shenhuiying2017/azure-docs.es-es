<properties 
	pageTitle="Recomendaciones de Aprendizaje automático de Azure: Integración con JavaScript" 
...
Parámetros: \* evento \(cadena\) – “purchase” \* elementos \(comprados [] \) – matriz con una entrada por cada elemento comprado.<br><br> Formato de compra: \* item \(cadena\) - Identificador único del elemento. \* recuento \(int. o cadena\) – número de elementos comprados. \* precio \(flotante o cadena\) – campo opcional – precio del elemento.
...
Parámetros: \* evento \(cadena\) – “userlogin” \* usuario \(cadena\) – identificación única del usuario. <script> if \(typeof AzureMLRecommendationsEvent=="undefined"\) { AzureMLRecommendationsEvent = []; } AzureMLRecommendationsEvent.push\({event: "userlogin", user: “ABCD10AA” }\); </script>
