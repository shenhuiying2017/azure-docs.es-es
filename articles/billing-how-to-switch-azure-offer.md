...
> [AZURE.NOTE] Para cambiar a otra oferta, [póngase en contacto con el soporte técnico](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade).
...
> [AZURE.NOTE] Debido a las restricciones relacionadas con la facturación, no se puede cambiar de oferta dentro del primer ciclo de facturación posterior a la creación de una suscripción.
