<properties urlDisplayName="Service Bus AMQP Overview" pageTitle="Información general sobre AMQP para el Bus de servicio - Azure " metaKeywords="" description="Obtenga información acerca de cómo utilizar Advanced Message Queuing Protocol (AMQP) 1.0 en Azure." metaCanonical="" services="service-bus" documentationCenter=".NET" title="" authors="sethm" solutions="" manager="timlt" editor="mattshel" />
