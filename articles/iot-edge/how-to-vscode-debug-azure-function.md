...
3. En la ventana **Seleccionar carpeta**, vaya al proyecto **FilterFunction** y haga clic en **Select Folder as EXE_DIR** (Seleccionar carpeta como EXE_DIR).
...
6. Puede reutilizar `deployment.json` para la reimplementación. En la paleta de comandos, escriba y seleccione **Edge: Restart Edge** (Edge: reiniciar Edge) para obtener la función de filtro que se ejecuta con la versión de depuración.
...
4. Vuelva a presionar **F5**. Después, seleccione el proceso al que desea agregarlo.
