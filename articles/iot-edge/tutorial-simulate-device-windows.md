...
3. Instale [Python en Windows][lnk-python] y asegúrese de que puede usar el comando pip. Este tutorial se probó con las versiones de Python >=2.7.9 y >=3.5.4.  
