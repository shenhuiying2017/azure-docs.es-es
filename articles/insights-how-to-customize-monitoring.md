<properties title="How to customize monitoring" pageTitle="Personalización de la supervisión" description="Learn how to customize monitoring charts in Azure." authors="awills" manager="kamrani" />
