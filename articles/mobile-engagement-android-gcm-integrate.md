...
Asegúrese de tener los permisos siguientes su  `AndroidManifest.xml` (después de la `</etiqueta application>`).
...
Si aún no lo ha hecho, cree un **clave de API de servidor** en la [Consola de desarrolladores de Google].
...
Ahora compruebe la integración mediante la lectura de Cómo probar la integración de Engagement en Android.
