...
żQué es una firma de acceso compartido?
---------------------------------------
...
żCuándo debe usar una firma de acceso compartido?
-------------------------------------------------
...
Un escenario común en el que es útil una SAS es un servicio en el que los usuarios leen y escriben sus propios datos en la cuenta de almacenamiento. Existen dos patrones de diseńo típicos en los escenarios en los que una cuenta de almacenamiento guarda datos de usuario:
