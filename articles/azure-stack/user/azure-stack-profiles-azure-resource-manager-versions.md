...
Las API de Azure Compute proporcionan acceso mediante programación a las máquinas virtuales y sus recursos de apoyo. Para más información, consulte [Azure Compute](https://docs.microsoft.com/en-us/rest/api/compute/).
