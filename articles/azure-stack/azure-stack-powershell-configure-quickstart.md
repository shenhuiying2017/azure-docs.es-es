...
> [!note]  
> Para especificar un grupo de recursos, debe tener un grupo de recursos en su suscripción. Para obtener más información acerca de las suscripciones, consulte [Introducción a los planes, ofertas, cuotas y suscripciones](azure-stack-plan-offer-quota-overview.md).
