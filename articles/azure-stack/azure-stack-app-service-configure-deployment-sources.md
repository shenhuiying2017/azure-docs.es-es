...
6. Escriba la **URL**; debe ser la dirección del Portal de Azure Stack; por ejemplo, https://portal.local.azurestack.external.
...
7. Copie el **URI de redirección**.  En una implementación de Azure Stack predeterminada, el URI de redirección tiene el formato https://portal.local.azurestack.external/TokenAuthorize, si está trabajando en un sustituto de dominio diferente a su dominio de azurestack.local. ![Aplicación de OneDrive - Agregar plataforma web][12]
