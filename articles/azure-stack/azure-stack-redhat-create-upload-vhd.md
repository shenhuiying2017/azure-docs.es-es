...
* En Azure, todos los discos duros virtuales deben tener un tamaño virtual alineado con 1 MB. Al convertir un disco sin procesar en VHD, debe asegurarse de que su tamaño es un múltiplo de 1 MB antes de la conversión. Se puede encontrar más información en los siguientes pasos.
...
Ya está listo para usar el disco duro virtual de Red Hat Enterprise Linux para crear nuevas máquinas virtuales de Azure Stack. Si es la primera vez que carga el archivo .vhd en Azure Stack, consulte [Agregar elementos de Marketplace con la herramienta de publicación](azure-stack-marketplace-publisher.md).
