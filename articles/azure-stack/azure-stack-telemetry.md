...
Los datos del sistema, o telemetría, de Azure Stack se cargan automáticamente en Microsoft mediante la Experiencia del usuario asociada. Los datos que se recopilan de la telemetría de Azure Stack los usan los equipos de Microsoft principalmente para mejorar las experiencias de los clientes y de cara a los análisis de seguridad, mantenimiento, calidad y rendimiento.
...
No se recomienda desactivar la telemetría en su organización, ya que proporciona datos que mejoran la funcionalidad y estabilidad del producto. Sin embargo, reconocemos que en algunos casos puede ser necesario. 
...
2.  Para deshabilitarla: `Set-Telemetry -Disable`
