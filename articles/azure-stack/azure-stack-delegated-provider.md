...
* Los operadores de Azure Stack se denominan **proveedores delegados**. Pueden pertenecer a otras organizaciones (por ejemplo, a otros inquilinos de Azure Active Directory).
