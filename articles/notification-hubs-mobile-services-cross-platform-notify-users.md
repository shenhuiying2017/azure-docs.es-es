...
<div class="dev-center-tutorial-selector sublanding">
    <a href="/es-es/documentation/articles/notification-hubs-mobile-services-cross-platform-notify-users/" title="Servicios m&oacute;viles" class="current">Servicios m&oacute;viles</a>
...
6.  Reemplace la función de inserción por el código siguiente:
...
7.  Actualice el script para reemplazar *`<NOTIFICATION_HUB_NAME>`* y *`<FULL_SAS_CONNECTION_STRING>`* por los valores de su centro de notificaciones y, a continuación, haga clic en **Save**.

8.  Detenga el emulador de dispositivo o desinstale la aplicación cliente existente del dispositivo.
...
9.  Implemente y ejecute nuevamente la aplicación cliente y compruebe que el registro se realice correctamente y que aparezca un identificador de registro nuevo.

10. Escriba texto como antes y agregue el elemento nuevo.
...
11. (Opcional) Implemente la aplicación cliente en un segundo dispositivo y después ejecute la aplicación e inserte el texto.
...
-   **[Notification Hub How to for Windows Store][]**
  ...
  [iOS]: /es-es/manage/services/notification-hubs/breaking-news-ios
