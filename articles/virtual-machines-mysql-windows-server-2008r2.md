<properties pageTitle="Creación de una máquina virtual que ejecuta MySQL en Azure" description="Cree una máquina virtual de Azure que ejecute Windows Server 2008 R2 y, a continuación, instale y configure una base de datos MySQL en la máquina virtual." services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor="tysonn"/>
...
Una vez creada una máquina virtual, conecte un disco de datos. Este disco ofrece almacenamiento de datos que necesitará para instalar MySQL. Consulte [Cómo conectar un disco de datos a una máquina Virtual de Windows](http://azure.microsoft.com/es-es/documentation/articles/storage-windows-attach-disk/) y siga las instrucciones para conectar un disco vacío.
...
9. Acepte los términos de licencia y, a continuación, haga clic en **Siguiente**.

10. Haga clic en **Typical** (Típico) para instalar las características comunes.

11. Haga clic en **Instalar**.

12. Inicie el Asistente para configuración de MySQL y haga clic en **Siguiente**.

13. Seleccione **Configuración detallada** y haga clic en Siguiente.

14. Seleccione **Equipo del servidor** si piensa ejecutar MySQL con otras aplicaciones en el servidor o la opción que mejor se adapte a sus necesidades.  Haga clic en **Siguiente**.

15. Seleccione **Base de datos multifuncional** o la opción que mejor se adapte a sus necesidades.  Haga clic en **Siguiente**.

16. Seleccione la unidad de datos que ha acoplado en la sección anterior.

	![Configure MySQL][MySQLConfig5]

17. Seleccione **Apoyo de decisiones (DSS)/OLAP** o la opción que mejor se adapte a sus necesidades.  Haga clic en **Siguiente**.

18. Seleccione **Habilitar redes TCP/IP** y **Agregar la excepción del firewall para este puerto**; se creará una regla entrante en al Firewall de Windows llamada **MySQL Server**.

	![Configure MySQL][MySQLConfig7]

19. Si necesita almacenar texto en un lenguaje muy diferente, seleccione **Mejor soporte para plurilingüismo**. De lo contrario, elija una de las demás opciones.  Haga clic en **Siguiente**.

	![Configure MySQL][MySQLConfig8]

20. Seleccione **Instalar como servicio de Windows** y **Iniciar MySQL Server automáticamente**.  Seleccione también **Incluir el directorio Bin en la RUTA DE ACCESO de Windows**. Haga clic en **Siguiente**.

	![Configure MySQL][MySQLConfig9]

21. Especifique la contraseña raíz. No active **Habilitar acceso raíz desde equipos remotos** ni **Crear una cuenta anónima**.  Haga clic en **Siguiente**.

	![Configure MySQL][MySQLConfig10]

22. Haga clic en **Ejecutar** y espere a que finalice la configuración.
...
27. Para crear una base de datos y conceder los permisos de usuario  `mysqluser` en ella, ejecute los comandos siguientes:
