<properties title="How to create a custom template image for RemoteApp" pageTitle="Creación de una imagen de plantilla personalizada para RemoteApp" description="Obtenga información acerca de cómo crear una imagen de plantilla personalizada para RemoteApp. Puede usar esta plantilla con una implementación híbrida o en la nube." metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo" manager="kathyw" />
