<properties title="How to create a custom template image for RemoteApp" pageTitle="Creación de una imagen de plantilla personalizada para RemoteApp" description="Learn how to create a custom template image for RemoteApp. You can use this template with either a hybrid or cloud deployment." metaKeywords="" services="" solutions="" documentationCenter="" authors="elizapo" manager="kathyw" />
...
- La función de Agente de conexión a Escritorio remoto *no* se debe instalar.
...
1. Instale el rol Host de sesión de Escritorio remoto (RDSH, Remote Desktop Session Host) y la característica Experiencia de escritorio:
	...
	4. Seleccione **Instalación basada en características o en roles** y luego haga clic en **Siguiente**.
	5. Seleccione la máquina local en la lista y haga clic en **Siguiente**.
	6. Seleccione **Servicios de Escritorio remoto** y luego haga clic en **Siguiente**.
	7. Expanda **Infraestructura e interfaces de usuario** y seleccione **Experiencia de escritorio**.
	8. Haga clic en **Agregar características** y luego en **Siguiente**.
	9. En la página Servicios de Escritorio remoto, haga clic en **Siguiente**.
	10. Haga clic en **Host de sesión de Escritorio remoto**.
	11. Haga clic en **Agregar características** y luego en **Siguiente**.
	12. En la página Confirmar selecciones de instalación, seleccione **Reiniciar automáticamente el servidor de destino en caso necesario** y luego haga clic en **Sí** en la advertencia de inicio.
