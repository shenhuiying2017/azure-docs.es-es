...
5. Reemplace los marcadores de posición del script anterior por los valores correctos:
	...
	- **_from-address_**: la dirección de la que procede el correo electrónico. Considere usar una dirección de dominio registrada que pertenezca a su organización.
     ...
     > [AZURE.NOTE] Si no tiene un dominio registrado, en su lugar puede usar el dominio de su servicio móvil, con el formato *notifications@_your-mobile-service_.azure-mobile.net*. No obstante, se ignoran los mensajes enviados al dominio del servicio móvil.
