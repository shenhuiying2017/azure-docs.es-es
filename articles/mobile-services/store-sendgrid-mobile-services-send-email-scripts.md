---
title: Envío de correo electrónico con SendGrid | Microsoft Docs
...
5. Reemplace los marcadores de posición del script anterior por los valores correctos:
   ...
   * ***username* y *password***: las credenciales de SendGrid que identificó en [Creación de una cuenta de SendGrid].
