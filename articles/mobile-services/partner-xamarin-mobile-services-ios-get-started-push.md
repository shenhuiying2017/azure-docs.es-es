---
title: Incorporación de notificaciones de inserción a la aplicación de Servicios móviles (Xamarin.iOS) - Servicios móviles
...
> [!IMPORTANT]
> Debido a los requisitos de APNS, debe implementar y realizar una prueba de las notificaciones push en un dispositivo compatible con iOS (iPhone o iPad) en lugar de hacerlo en un emulador.
> 
> 
