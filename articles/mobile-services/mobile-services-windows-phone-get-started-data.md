---
title: Incorporación de Servicios móviles a una aplicación existente (WP8) | Microsoft Docs
...
7. En el archivo MainPage.cs, agregue o quite la marca de comentario en las siguientes instrucciones `using`:
   
           using Microsoft.WindowsAzure.MobileServices;
        using Newtonsoft.Json;
8. En esta carpeta DataModel, reemplace la definición de clase **TodoItem** por el siguiente código:
