---
title: Registro para la autenticación de Azure Active Directory | Microsoft Docs
...
6. Una vez agregada la aplicación, haga clic en la pestaña **Configurar** y copie la **Id. de cliente** para la aplicación.
   ...
   > [!NOTE]
   > Para un servicio móvil de back-end de .NET, también debe editar el valor de **URL de respuesta** en **Inicio de sesión único** para que sea la dirección URL del servicio móvil añadido con la ruta de acceso, *signin-aad*. Por ejemplo, `https://todolist.azure-mobile.net/signin-aad`
   > 
   > 
