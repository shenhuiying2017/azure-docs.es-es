...
5. En **Descargar y ejecutar la aplicación**, haga clic en **Descargar**.
    ...
    De este modo se descarga el proyecto para la aplicación de *lista de pendientes* de muestra que está conectada al servicio móvil y que hace referencia al componente de Servicios móviles de Azure para Xamarin.iOS. Guarde el archivo comprimido del proyecto en el equipo local y anote dónde lo guardó.
