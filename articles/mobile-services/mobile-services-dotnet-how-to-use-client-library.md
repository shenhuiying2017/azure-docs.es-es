---
title: Trabajo con la biblioteca de cliente administrada de Servicios móviles (Windows | Microsoft Docs
...
> [!NOTE]
> Cuando necesite enviar notificaciones a los usuarios registrados específicos, es importante requerir autenticación antes del registro y, a continuación, comprobar que el usuario está autorizado para registrarse con una etiqueta específica. Por ejemplo, se debe comprobar que un usuario no se registra con una etiqueta de Id. de usuario de otra persona. Para obtener más información, consulte [Envío de notificaciones de inserción a usuarios autenticados](mobile-services-dotnet-backend-windows-store-dotnet-push-notifications-app-users.md).
> 
> 
