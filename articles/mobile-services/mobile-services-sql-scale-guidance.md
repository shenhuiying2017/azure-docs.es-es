---
title: Escalamiento de servicios móviles respaldados por Base de datos SQL | Microsoft Docs
...
Para obtener más información sobre índices, consulte las [anotaciones de índice en Entity Framework][anotaciones de índice en Entity Framework]. Para conocer más sugerencias sobre la optimización de índices, consulte [Indexación avanzada](#AdvancedIndexing) al final de este documento.
...
* [Restricciones entre claves principales y claves externas][Restricciones entre claves principales y claves externas]
