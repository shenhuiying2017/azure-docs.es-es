...
El cliente de Servicios móviles permite registrar las notificaciones de inserción con Centros de notificaciones de Azure. Al efectuar el registro, obtendrá un URI de canal de la plataforma Windows. A continuación, proporcione este valor junto con las etiquetas cuando se cree el registro. El código siguiente se registra para recibir notificaciones de inserción en una aplicación de Tienda Windows que utiliza el Servicio de notificación de Windows (WNS):
...
Tenga en cuenta que en este ejemplo se incluyen dos etiquetas en el registro. Para obtener más información, consulte [Incorporación de notificaciones de inserción a la aplicación](mobile-services-dotnet-backend-windows-universal-dotnet-get-started-push.md)
...
##<a name="binding"></a>Enlazar datos a la interfaz de usuario en un servicio móvil
