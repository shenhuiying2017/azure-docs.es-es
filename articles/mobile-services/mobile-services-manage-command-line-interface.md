---
title: Administración de un servicio móvil desde la línea de comandos | Microsoft Docs
...
> [!NOTE]
> Los comandos de la CLI relacionados con "list" y "script" solo funcionan con el backend de JavaScript.
> 
> 
