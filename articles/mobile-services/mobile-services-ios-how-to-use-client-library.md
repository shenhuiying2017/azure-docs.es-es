---
title: Cómo usar la biblioteca de cliente de iOS para Servicios móviles de Azure
...
> [!NOTE]
> Esta guía usa el último [SDK de Servicios móviles de iOS](https://go.microsoft.com/fwLink/?LinkID=266533&clcid=0x409). Si el proyecto utiliza una versión anterior del SDK, actualice primero el marco de trabajo en Xcode.
> 
> 
...
* **Inicio de sesión administrado por el cliente**: la *aplicación* solicita un token al proveedor de identidades y presenta dicho token a Servicios móviles de Azure para su autenticación.
...
Veamos cómo se pueden almacenar en la memoria caché los tokens del proyecto [Inicio rápido de servicios móviles]; puede aplicar pasos similares a cualquier proyecto. [!INCLUDE [mobile-services-ios-authenticate-app-with-token](../../includes/mobile-services-ios-authenticate-app-with-token.md)]
