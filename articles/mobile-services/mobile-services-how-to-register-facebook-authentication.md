...
4. Escriba un **Nombre para mostrar** único para la aplicación, elija **Aplicaciones para páginas** en **Categoría**, haga clic en **Crear Id. de aplicación** y complete el ejercicio de seguridad.

	Esto crea un nuevo identificador de aplicación de Facebook.

5. Haga clic en **Configuración**, escriba el dominio de su servicio móvil en **Dominios de aplicación**, escriba un **correo electrónico de contacto** opcional, y haga clic en **gregar plataforma** y seleccione **Página web**.
...
9. Haga clic en **Estado y revisión** > **Sí** para activar el acceso público general a su aplicación.
