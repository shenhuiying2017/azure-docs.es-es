...
<!-- URLs. -->
[Introducción a los datos]: mobile-services-dotnet-backend-windows-universal-dotnet-get-started-data.md
...
[Versión de back-end de JavaScript]: ../mobile-services-windows-store-get-started.md
