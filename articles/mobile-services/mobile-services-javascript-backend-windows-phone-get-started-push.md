---
title: Incorporación de notificaciones de inserción a la aplicación Servicios móviles (Tienda Windows) | Microsoft Docs
...
> [!NOTE]
> Para enviar notificaciones de inserción a una aplicación de la Tienda Windows Phone 8.1, siga la versión [Aplicación de la Tienda Windows](mobile-services-javascript-backend-windows-universal-dotnet-get-started-push.md) de este tutorial.
> 
> 
...
5. En el Explorador de soluciones, expanda **Propiedades**, abra el archivo WMAppManifest.xml, haga clic en la pestaña **Funcionalidades** y asegúrese de que la funcionalidad **ID\_\_\_CAP\_\_\_PUSH\_NOTIFICATION** esté activada.
