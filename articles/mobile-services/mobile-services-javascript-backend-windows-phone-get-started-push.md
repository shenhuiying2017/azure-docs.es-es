...
>[AZURE.NOTE] Para enviar notificaciones de inserción a una aplicación de la Tienda Windows Phone 8.1, siga la versión [Aplicación de la Tienda Windows](mobile-services-javascript-backend-windows-universal-dotnet-get-started-push.md) de este tutorial.
