---
title: Introducción a Servicios móviles de Azure para aplicaciones PhoneGap/Cordova | Microsoft Docs
...
5. En **Descargar y ejecutar la aplicación**, haga clic en **Descargar**.
    ...
    De este modo se descarga el proyecto para la aplicación *To do list* de ejemplo que está conectada al servicio móvil, además del SDK de JavaScript para Servicios móviles. Guarde el archivo comprimido del proyecto en el equipo local y anote dónde lo guardó.
...
> [!NOTE]
> Puede revisar el código que tiene acceso a su servicio móvil para consultar e insertar datos, que se encuentra en el archivo js/index.js.
> 
> 
