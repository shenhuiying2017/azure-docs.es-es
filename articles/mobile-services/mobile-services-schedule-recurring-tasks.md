---
title: Programación de tareas back-end en un servicio móvil back-end de JavaScript | Microsoft Docs
...
1. En el [Portal de Azure clásico], haga clic en la pestaña **Datos** para el servicio móvil y haga clic en **+Crear**.
2. En **Nombre de tabla** escriba *Updates* y haga clic en el botón de comprobación.
...
1. Haga clic en la pestaña **Programador** y, a continuación, en **+Crear**.
   ...
   > 
   > 
2. En el cuadro de diálogo del programador, especifique *getUpdates* para **Nombre de trabajo**, establezca el intervalo de programación y las unidades, y haga clic en el botón de comprobación.
   
       De esta forma, se crea un nuevo trabajo con el nombre **getUpdates**.
3. Haga clic en el nuevo trabajo que acaba de crear, haga clic en la ficha **Script** y reemplace la función de marcador de posición **getUpdates** por el código siguiente:
...
1. Haga clic en **Ejecutar una vez** para probar el script.
   
       De esta forma, se guarda y ejecuta el trabajo mientras se mantiene deshabilitado en el programador.
2. Haga clic en el botón de retroceso, en **Datos**, en la tabla **Updates**, en **Examinar** y compruebe que se han insertado los datos de Twitter en la tabla.
3. Haga clic en el botón de retroceso y en **Programador**, seleccione **getUpdates** y haga clic en **Habilitar**.
