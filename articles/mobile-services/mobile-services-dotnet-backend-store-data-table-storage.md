---
title: Creación de un servicio móvil back-end de .NET que usa almacenamiento de tablas | Microsoft Docs
...
1. Modifique el tipo de datos de **TodoItem** para que derive de **StorageData** en lugar de **EntityData**, de la siguiente manera.
   ...
   > [!NOTE]
   > El tipo **StorageData** tiene una propiedad Id. que requiere una clave compuesta que es una cadena con el formato *partitionId*,*rowValue*.
   > 
   > 
...
4. Reemplace el método **GetAllTodoItems** existente por el siguiente código.
...
2. Ejecute la aplicación de cliente de inicio rápido conectada al servicio móvil.
...
3. Agregue nuevos elementos para generar cambios en la base de datos.
