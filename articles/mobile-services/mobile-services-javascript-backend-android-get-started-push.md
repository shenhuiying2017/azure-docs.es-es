...
---
title: Introducción a las notificaciones push (JavaScript para Android) | Microsoft Docs
...
[!INCLUDE [Incorporación de Play Services](../../includes/mobile-services-add-google-play-services.md)]
...
2. En la aplicación, escriba texto significativo como *A new Mobile Services task* y, a continuación, haga clic en el botón **Add** (Agregar).
