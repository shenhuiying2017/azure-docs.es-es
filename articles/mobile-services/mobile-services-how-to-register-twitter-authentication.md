---
title: Registro para la autenticación de Twitter | Microsoft Docs
...
2. Escriba los valores **Nombre**, **Descripción** y **Sitio web** para su aplicación, y luego escriba uno de los siguientes formatos de direcciones URL en **URL de devolución de llamada**.
   ...
   * **Back-end de JavaScript**: `https://<mobile_service>.azure-mobile.net/login/twitter`
     ...
     > [!NOTE]
     > Asegúrese de usar el formato correcto de ruta de acceso a dirección URL de redireccionamiento para su tipo de back-end de Servicios móviles. Si es incorrecto, la autenticación no se realizará correctamente. &nbsp;
     > 
     > 
...
4. Haga clic en la pestaña **Claves y tokens de acceso** en el panel de la aplicación y anote los valores de **Clave del consumidor** y **Secreto del consumidor**.
   ...
   > 
   > 
5. Haga clic en la pestaña **Configuración**, desplácese hacia abajo y asegúrese de que la casilla **Permitir que se use esta aplicación para iniciar sesión en Twitter** esté activada y haga clic en **Actualizar configuración**.
