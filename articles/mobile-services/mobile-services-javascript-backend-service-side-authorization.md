---
title: Autorización en el servicio de usuarios en un servicio móvil back-end de JavaSscript | Microsoft Docs
...
> * [Back-end de .NET](mobile-services-dotnet-backend-service-side-authorization.md)
> * [Back-end de JavaScript](mobile-services-javascript-backend-service-side-authorization.md)
> 
> 
...
> Para información sobre la versión de Aplicaciones móviles equivalente de este tema, vea [este código de ejemplo](https://github.com/Azure/azure-mobile-apps-node/blob/master/samples/personal-table/tables/TodoItem.js#L38).
> 
> 
...
2. Haga clic en **Script**, seleccione la operación **Insertar**, sustituya el script existente por la siguiente función y haga clic en **Guardar**.
   ...
   > [!NOTE]
   > Asegúrese de que el [esquema dinámico](https://msdn.microsoft.com/library/azure/jj193175.aspx) esté habilitado. De lo contrario, la columna *userId* no se agrega automáticamente. Esta configuración está habilitada de forma predeterminada para un nuevo servicio móvil.
   > 
   > 
...
1. Observe que cuando ejecute la aplicación del lado cliente, aunque ya existan elementos en la tabla *TodoItem* de tutoriales anteriores, no se devuelven elementos. Esto ocurre porque se insertaron elementos anteriores sin la columna Id. de usuario y ahora cuentan con valores nulos. Compruebe que los elementos recién agregados tienen un valor userId asociado en la tabla *TodoItem*.
