---
title: Uso de servicios móviles para cargar imágenes en el almacenamiento de blobs (Android) | Microsoft Docs
...
2. Agregue este código para iniciar la aplicación de cámara de Android. A continuación, puede sacar fotografías y cuando una le parezca correcta, pulse **Guardar**, con ello se almacenará en el archivo que acaba de crear.
