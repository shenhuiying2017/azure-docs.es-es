---
title: Solución de problemas en el backend .NET de Servicios móviles | Microsoft Docs
...
> [!NOTE]
> Los Servicios móviles actualmente solo son compatibles con ASP.NET 5.1; ASP.NET 5.2 no es compatible actualmente. La actualización de los paquetes de NuGet de ASP.NET a 5.2.* puede producir un error después de la implementación.
> 
> 
