---
title: Introducción a Servicios móviles de Azure para aplicaciones de HTML/JavaScript | Microsoft Docs
...
4. En **Descargar y ejecutar la aplicación**, haga clic en **Descargar**.
      ...
      De este modo se descargan los archivos del sitio web para la aplicación *To do list* de ejemplo conectada al servicio móvil. Guarde el archivo comprimido en el equipo local y anote dónde lo guardó.
...
3. En la aplicación, escriba un texto significativo, como *Realice el tutorial*, en **Introducir nueva tarea** y, a continuación, haga clic en **Agregar**.
   ...
   > [!NOTE]
   > Puede revisar el código de acceso al servicio móvil para consultar e insertar datos; este se encuentra en el archivo page.js.
   > 
   > 
