---
title: Registro para la autenticación de Google | Microsoft Docs
...
1. Diríjase al sitio web [Google apis](http://go.microsoft.com/fwlink/p/?LinkId=268303), inicie sesión con las credenciales de su cuenta de Google, haga clic en **Crear proyecto**, proporcione un **Nombre de proyecto**, y haga clic en **Crear**.
2. En el menú desplegable **Productos y servicios**, haga clic en **Administrador de API** y, en **API sociales**, haga clic en **API de Google+** > **Habilitar API**.
3. Haga clic en **Credenciales** > **Pantalla de consentimiento de OAuth**, seleccione su **Dirección de correo electrónico**, escriba un **Nombre de producto** y haga clic en **Guardar**.
4. En la pestaña **Credenciales**, haga clic en **Agregar credenciales** > **Id. de cliente de OAuth 2.0** y luego seleccione **Aplicación web**.
5. Escriba la dirección URL de su servicio móvil en **Orígenes de JavaScript autorizados**, reemplace la dirección URL generada en **Autorizar URI de redirección** por uno de los siguientes formatos de dirección URL y luego haga clic en **Crear**:
...
1. En la siguiente pantalla, tome nota de los valores de id. de cliente y el secreto del cliente.
