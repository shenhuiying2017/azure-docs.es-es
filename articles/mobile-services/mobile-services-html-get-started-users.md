---
title: Incorporación de autenticación a la aplicación HTML/JavaScript | Microsoft Docs
...
2. En el archivo page.js, localice la línea de código situada al final del archivo que llama a la función refreshTodoItems y reemplácela por el código siguiente:
   ...
   > [!IMPORTANT]
   > En una aplicación de PhoneGap, también debe agregar los siguientes complementos al proyecto:
   > 
