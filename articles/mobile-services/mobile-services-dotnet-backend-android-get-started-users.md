---
title: Introducción a la autenticación (Android) | Microsoft Docs
...
1. Abra el proyecto que ha creado al completar el tutorial [Introducción a los Servicios móviles].
2. En el menú **Run** (Ejecutar), haga clic en **Run app** (Ejecutar aplicación) para iniciar la aplicación y, a continuación, compruebe que se lleva a cabo una excepción no controlada con el código de estado 401 (No autorizado) después de que se inicie la aplicación.
