...
Esta funcionalidad se agregará a la aplicación que creó cuando completó el tutorial [Incorporación de Servicios móviles a una aplicación existente](mobile-services-windows-phone-get-started-data.md) . Para hacer esto, debe completar los siguientes pasos:
...
Este tutorial se basa en el ejemplo GetStartedWithData, una simple aplicación TodoList. Antes de iniciar este tutorial, primero debe completar el tutorial [Incorporación de servicios móviles a una aplicación existente](mobile-services-windows-phone-get-started-data.md).
