---
title: Introducción a Servicios móviles de Azure y Sencha
...
3. Haga clic en **Crear tabla TodoItems** para crear una tabla donde almacenar los datos de la aplicación.
   ...
   > [!NOTE]
   > NO descargue la aplicación HTML del Portal de Azure clásico. En su lugar, crearemos manualmente una aplicación Sencha Touch en la siguiente sección.
   > 
   > 
4. Anote el valor de **appKey** y **appUrl** en el Portal de Azure clásico. Usará esos valores en otras secciones de este tutorial.
...
> [!NOTE]
> Solo puede usar este método cuando haya generado la aplicación mediante el comando <code>sencha generate app</code>.
> 
> 
