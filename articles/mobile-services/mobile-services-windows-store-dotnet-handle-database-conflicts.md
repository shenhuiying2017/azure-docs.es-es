---
title: Control de conflictos de escritura de base de datos con la simultaneidad optimista (Tienda Windows) | Microsoft Docs
...
3. En el Explorador de soluciones de Visual Studio, abra MainPage.cs en el proyecto compartido. Agregue el controlador de eventos a la MainPage para el evento `LostFocus` de TextBox como se muestra a continuación.
...
1. En MainPage.cs para el proyecto compartido, agregue la definición para el método `UpdateToDoItem()` de MainPage con referencia en el controlador de eventos, como se muestra a continuación.
