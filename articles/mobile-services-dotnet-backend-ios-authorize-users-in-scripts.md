<properties 
	pageTitle="Autorización del servicio (iOS) | Centro de desarrollo móvil" 
	description="Aprenda a autorizar a los usuarios en el back-end de .NET de Servicios móviles de Azure." 
