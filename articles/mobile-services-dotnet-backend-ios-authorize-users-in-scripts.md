<properties pageTitle="Autorización del servicio (iOS) | Centro de desarrollo móvil" description="Aprenda a autorizar a los usuarios en el back-end de .NET de Servicios móviles de Azure." services="mobile-services" documentationCenter="ios" authors="krisragh" manager="dwrede" editor=""/>
