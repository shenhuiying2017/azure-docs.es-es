...
> [AZURE.IMPORTANT] Los niveles de rendimiento estarán disponibles cuando Microsoft Azure DocumentDB esté en versión de disponibilidad general. Esta versión está programada para abril de 2015.
...
Para obtener más información sobre los precios y la administración de datos con Microsoft Azure DocumentDB, consulte estos recursos:
...
Para obtener más información acerca de DocumentDB, consulte la [documentación](http://azure.microsoft.com/documentation/services/documentdb/) de Microsoft Azure DocumentDB. 
