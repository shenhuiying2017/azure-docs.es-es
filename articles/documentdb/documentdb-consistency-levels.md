...
* La coherencia de obsolescencia limitada garantiza que las lecturas vayan con retraso respecto a las escrituras en un máximo de versiones *K* o prefijos de un documento o el intervalo de tiempo *t*. 
...
| Garantía | Alta | De obsolescencia entrelazada | Sesión | Ocasional |
| --- | --- | --- | --- | --- |
...
| **Lecturas monotónicas** |yes |Sí, entre regiones fuera de la ventana de obsolescencia y dentro de una región todo el tiempo. |Sí, para la sesión dada |No |
| **Escrituras monotónicas** |Sí |Sí |Sí |Sí |
| **Lectura de sus escrituras** |Sí |Sí (en la región de escritura) | Sí |No |
...
> [!NOTE]
> No se admite la configuración del nivel de coherencia predeterminado en el [emulador de Azure DocumentDB](documentdb-nosql-local-emulator.md). 
...
| None |Seleccionar entre fuerte, de obsolescencia entrelazada, de sesión y eventual |No aplicable |
