...
* `<default-consistency-level>` El nivel de coherencia predeterminado de la cuenta de Azure Cosmos DB. Para más información, consulte [Niveles de coherencia en Azure Cosmos DB](documentdb-consistency-levels.md).
