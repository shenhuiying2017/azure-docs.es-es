...
### [Servicios multiinquilino](http://blogs.msdn.com/b/documentdb/archive/2014/12/03/scaling-a-multi-tenant-application-with-azure-documentdb.aspx)
...
#### [¿Qué es la compatibilidad de protocolos para MongoDB?](documentdb-protocol-mongodb.md)
...
### [Análisis de datos en tiempo real con Azure Stream Analytics](../stream-analytics/stream-analytics-define-outputs.md#documentdb.md)
...
## [Foros de MSDN](https://social.msdn.microsoft.com/forums/azure/en-US/home?forum=AzureDocumentDB)
## [Preguntas en DocumentDB](documentdb-community.md#contact-the-team)
## [Portal de comunidad](documentdb-community.md)
## [Eventos y grabaciones](documentdb-community.md#events-and-recordings)
