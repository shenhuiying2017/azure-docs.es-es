...
![Funcionalidades de Azure Cosmos DB para aplicaciones móviles](media/documentdb-mobile-apps-with-xamarin/documentdb-for-mobile.png)

* Consultas completas sobre datos sin esquema. Azure Cosmos DB almacena datos como documentos JSON sin esquema en colecciones heterogéneas. Ofrece [consultas completas y rápidas](documentdb-sql-query.md) sin tener que preocuparse de esquemas o índices.
* Rendimiento rápido. Solo se tardan unas milésimas de segundos en leer y escribir documentos con Azure Cosmos DB. Los desarrolladores pueden especificar el rendimiento que necesitan y Azure Cosmos DB lo respeta con Acuerdos de Nivel de Servicio (SLA) del 99,99 %.
...
* Distribución global. Los usuarios de aplicaciones móviles están moviéndose de un lado para otro, con frecuencia por todo el mundo. Azure Cosmos DB es una [base de datos distribuida globalmente](documentdb-distribute-data-globally.md). Haga clic en el mapa para permitir que sus datos sean accesibles para sus usuarios.
...
![Inicio rápido de Azure Cosmos DB para aplicaciones móviles](media/documentdb-mobile-apps-with-xamarin/documentdb-quickstart.png)

O bien, si ya tiene una aplicación de Xamarin, puede agregar el [paquete NuGet de Azure Cosmos DB](documentdb-sdk-dotnet-core.md). Azure Cosmos DB admite bibliotecas compartidas de Xamarin.IOS, Xamarin.Android y Xamarin Forms.
...
![Agente de permisos y usuarios de Azure Cosmos DB](media/documentdb-mobile-apps-with-xamarin/documentdb-resource-token-broker.png)
...
![Rendimiento a gran escala de Azure Cosmos DB a petición](media/documentdb-mobile-apps-with-xamarin/documentdb-scale.png)
...
![Azure Cosmos DB escala en regiones geográficas](media/documentdb-mobile-apps-with-xamarin/documentdb-replicate-globally.png)
...
* Aprenda sobre la [compatibilidad geoespacial en Azure Cosmos DB](documentdb-geospatial.md).
