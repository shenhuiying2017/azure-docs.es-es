---
title: Conmutaciones por error regionales de Azure Cosmos DB | Microsoft Docs
description: "Obtenga información sobre el modo en que funcionan las conmutaciones por error manuales y automáticas con Azure Cosmos DB."
services: cosmosdb
documentationcenter: 
author: arramac
manager: jhubbard
...
![Implementación de aplicaciones distribuidas globalmente con Azure Cosmos DB](./media/documentdb-regional-failovers/app-deployment.png)
...
![Errores de la región de lectura en Azure Cosmos DB](./media/documentdb-regional-failovers/read-region-failures.png)
...
![Prioridades de conmutación por error de Azure Cosmos DB](./media/documentdb-regional-failovers/failover-priorities.png)
...
![Errores de la región de escritura en Azure Cosmos DB](./media/documentdb-regional-failovers/write-region-failures.png)
...
![Conmutaciones por error manuales de Azure Cosmos DB](./media/documentdb-regional-failovers/manual-failovers.png)
...
* Obtenga información sobre la compatibilidad de Cosmos DB con la [distribución global](documentdb-distribute-data-globally.md)
* Más información sobre la [coherencia global con Azure Cosmos DB](documentdb-consistency-levels.md)
