---
title: "PDF de la hoja de referencia rápida de SQL de DocumentDB | Microsoft Docs"
...
---
# <a name="documentdb-sql-query-cheat-sheet-pdf"></a>PDF de la hoja de referencia de consultas SQL de DocumentDB
La **Hoja de referencia rápida de consultas SQL de DocumentDB** ayuda a escribir rápidamente consultas para datos de DocumentDB ya que se muestran las consultas de base de datos comunes, las palabras clave, las funciones integradas y los operadores en una hoja de referencia PDF fácil de imprimir. 
...
## <a name="download-the-documentdb-sql-query-cheat-sheet-pdf"></a>Descarga del PDF de la hoja de referencia de consultas SQL de DocumentDB
...
**Descargue aquí la hoja de referencia rápida SQL: [Hoja de referencia rápida SQL de Microsoft Azure DocumentDB](http://go.microsoft.com/fwlink/?LinkId=623215)**
