...
##<a name="<a-id="prerequisites"></a>prerequisites"></a><a id="Prerequisites"></a>Requisitos previos
...
##<a name="<a-id="overviewl"></a>overview-of-the-documentdb-data-migration-tool"></a><a id="Overviewl"></a>Información general sobre la herramienta de migración de datos de DocumentDB
...
##<a name="<a-id="install"></a>installing-the-documentdb-data-migration-tool"></a><a id="Install"></a>Instalación de la herramienta de migración de datos de DocumentDB
...
##<a name="<a-id="json"></a>import-json-files"></a><a id="JSON"></a>Importación de archivos JSON
...
##<a name="<a-id="mongodb"></a>import-from-mongodb"></a><a id="MongoDB"></a>Importación desde MongoDB
...
##<a name="<a-id="mongodbexport"></a>import-mongodb-export-files"></a><a id="MongoDBExport"></a>Importación de archivos de exportación de MongoDB
...
##<a name="<a-id="sql"></a>import-from-sql-server"></a><a id="SQL"></a>Importación desde SQL Server
...
##<a name="<a-id="csv"></a>import-csv-files---convert-csv-to-json"></a><a id="CSV"></a>Importación de archivos CSV - Conversión de CSV a JSON
...
##<a name="<a-id="azuretablesource"></a>import-from-azure-table-storage"></a><a id="AzureTableSource"></a>Importación de almacenamiento de tablas de Azure
...
##<a name="<a-id="dynamodbsource"></a>import-from-amazon-dynamodb"></a><a id="DynamoDBSource"></a>Importar desde Amazon DynamoDB
...
##<a name="<a-id="blobimport"></a>import-files-from-azure-blob-storage"></a><a id="BlobImport"></a>Importación de archivos desde el almacenamiento de blobs de Azure
...
##<a name="<a-id="documentdbsource"></a>import-from-documentdb"></a><a id="DocumentDBSource"></a>Importación desde DocumentDB
...
##<a name="<a-id="hbasesource"></a>import-from-hbase"></a><a id="HBaseSource"></a>Importar desde HBase
...
##<a name="<a-id="documentdbbulktarget"></a>import-to-documentdb-(bulk-import)"></a><a id="DocumentDBBulkTarget"></a>Importación a DocumentDB (importación masiva)
...
> [AZURE.NOTE] La configuración del nivel de rendimiento solo se aplica a la creación de la colección. Si la colección especificada ya existe, no se modificará su capacidad de proceso.
...
##<a name="<a-id="documentdbseqtarget"></a>import-to-documentdb-(sequential-record-import)"></a><a id="DocumentDBSeqTarget"></a>Importación a DocumentDB (importación de registros secuenciales)
...
> [AZURE.NOTE] La configuración de la capacidad de proceso solo se aplica a la creación de colecciones. Si la colección especificada ya existe, no se modificará su capacidad de proceso.
...
##<a name="<a-id="indexingpolicy"></a>specify-an-indexing-policy-when-creating-documentdb-collections"></a><a id="IndexingPolicy"></a>Especificar una directiva de indexación al crear colecciones DocumentDB
...
> [AZURE.NOTE] Si no especifica una directiva de indización, se aplicará la directiva predeterminada. Para obtener más información sobre las directivas de indexación, consulte [Directivas de indexación de DocumentDB](documentdb-indexing-policies.md).
