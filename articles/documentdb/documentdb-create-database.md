---
title: Cómo crear una base de datos en DocumentDB | Microsoft Docs
description: Averigüe cómo crear una base de datos mediante el portal de servicios en línea para Azure DocumentDB, la veloz base de datos de documentos NoSQL global.
...
1. En la barra de accesos directos del [Portal de Azure](https://portal.azure.com/), haga clic en **DocumentDB (NoSQL)**. Si **DocumentDB (NoSQL)** no está visible, haga clic en **Más servicios** y, después, en **DocumentDB (NoSQL)**.
...
1. En la hoja **DocumentDB (NoSQL)**, seleccione la cuenta en la que desea agregar una base de datos de NoSQL de DocumentDB. Si no se muestra ninguna cuenta, deberá [crear una cuenta de DocumentDB](documentdb-create-account.md).
2. En la hoja **Cuenta de DocumentDB**, haga clic en **Agregar base de datos**.
...
3. En la hoja **Agregar base de datos**, escriba el identificador de la base de datos nueva. Cuando se valida el nombre, aparece una marca de verificación verde en el cuadro **Id.**. y, a continuación, haga clic en **Aceptar**.
   
    ![Captura de pantalla que muestra cómo crear una base de datos, en la que se resalta el botón Agregar base de datos, el cuadro de identificador y el botón Aceptar](./media/documentdb-create-database/docdb-database-creation-4.png)
4. La base de datos nueva aparece ahora en el modo **Bases de datos** de la hoja **Cuenta de DocumentDB**.
