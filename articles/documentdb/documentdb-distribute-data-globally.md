...
* [Aprovisionamiento de rendimiento y almacenamiento para una colección][throughputandstorage]
* [API de hospedaje múltiple mediante los SDK de REST, .NET, Java, Python y Node][developingwithmultipleregions]
