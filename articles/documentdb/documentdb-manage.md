<properties 
	pageTitle="Administración de la capacidad de DocumentDB | Microsoft Azure" 
...
Puede crear cualquier número de colecciones para cumplir con los requisitos de escala de proceso y almacenamiento de sus aplicaciones. Las colecciones se pueden crear a través del [Portal de vista previa de Azure](https://portal.azure.com/) o mediante cualquiera de los [SDK de DocumentDB](https://msdn.microsoft.com/library/azure/dn781482.aspx).
