...
Se pueden crear cuentas de DocumentDB mediante [Azure Portal](documentdb-create-account.md) o mediante [una plantilla de ARM o la CLI de Azure](documentdb-automation-resource-manager-cli.md).
...
Con DocumentDB, a medida que escala sus aplicaciones, podrá crear más colecciones o bases de datos o ambas. Las bases de datos se pueden crear a través de [Azure Portal](documentdb-create-database.md) o mediante cualquiera de los [SDK de DocumentDB](documentdb-dotnet-samples.md).   
