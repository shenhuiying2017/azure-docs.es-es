---
title: Sintaxis SQL y consulta SQL para DocumentDB | Microsoft Docs
...
> [!NOTE]
> Antes del 17/03/2015, DocumentDB admitía las llamadas de UDF sin el prefijo "udf." como SELECT REGEX\_MATCH(). Este patrón de llamada está desusado.
> 
> 
