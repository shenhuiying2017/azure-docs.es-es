---
title: Ejecutar un trabajo de Hadoop con Azure DocumentDB y HDInsight | Microsoft Docs
...
---
# <a name="DocumentDB-HDInsight"></a>Ejecutar un trabajo de Apache Hive, Pig o Hadoop con DocumentDB y HDInsight
