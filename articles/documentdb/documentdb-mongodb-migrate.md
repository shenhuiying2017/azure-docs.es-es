...
* Obtenga su [cadena de conexión de la API de MongoDB](documentdb-connect-mongodb-account.md).

Si está importando datos de MongoDB y planea su uso con la API de DocumentDB, debe usar la herramienta de migración de datos para importar datos. Para más información, consulte [Herramienta de migración de datos](documentdb-import-data.md).
...
* Aumente el rendimiento: la duración de la migración de datos depende de la cantidad de rendimiento configurado para las colecciones. Asegúrese de aumentar el rendimiento para migraciones de datos más grandes. Después de haber completado la migración, reduzca el rendimiento para ahorrar costos. Para más información sobre cómo aumentar el rendimiento en [Azure Portal](https://portal.azure.com), consulte [Niveles de rendimiento y planes de tarifa de Azure Cosmos DB](documentdb-performance-levels.md).
