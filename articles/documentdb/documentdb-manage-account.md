...
Si está utilizando la cadena de conexión en la [herramienta de migración de base de datos de Azure Cosmos DB](documentdb-import-data.md), anexe el nombre de la base de datos al final de la cadena de conexión. `AccountEndpoint=< >;AccountKey=< >;Database=< >`.
...
![Eliminación de una cuenta de Azure Cosmos DB en Azure Portal](./media/documentdb-manage-account/deleteaccount.png)
...
![Eliminación de una cuenta de Azure Cosmos DB en Azure Portal](./media/documentdb-manage-account/delete-account-confirm.png)
