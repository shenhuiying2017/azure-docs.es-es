...
Puede crear usuarios y permisos mediante uno de los SDK de Base de datos de documentos o a través de las API REST. Consulte la sección Desarrollo de la [página de documentación de DocumentDB](http://go.microsoft.com/fwlink/p/?LinkID=402319) para obtener información sobre cómo desarrollar aplicaciones.
