---
title: Administración de recursos de Almacenamiento de blobs de Azure con el Explorador de almacenamiento (versión preliminar) | Microsoft Docs
...
3. Haga clic con el botón derecho en **Contenedores de blob** y (en el menú contextual) seleccione **Crear contenedor de blobs**.
   
   ![Menú contextual Crear contenedores de blobs][0]
4. Aparecerá un cuadro de texto debajo de la carpeta **Contenedores de blob**. Escriba el nombre del contenedor de blobs. Para ver una lista de reglas y restricciones en la nomenclatura de contenedores de blob, consulte la sección [Crear un contenedor](storage/storage-dotnet-how-to-use-blobs.md#create-a-container).
...
4. Haga clic con el botón derecho en el contenedor de blobs que desea ver y (en el menú contextual) seleccione **Abrir editor de contenedores de blobs**. También puede hacer doble clic en el contenedor de blobs que desea ver.
...
Los contenedores de blobs se pueden crear fácilmente y eliminarse según sea necesario. (Para ver cómo eliminar blobs individuales, consulte la sección [Administración de blobs de un contenedor de blobs](..md#managing-blobs-in-a-blob-container)).
...
2. En el panel izquierdo, expanda la cuenta de almacenamiento que contiene el contenedor de blobs que desea ver.
3. Expanda **Contenedores de blob** de la cuenta de almacenamiento.
4. Haga clic con el botón derecho en el contenedor de blobs que desea eliminar y (en el menú contextual) seleccione **Eliminar**. También puede presionar **Suprimir** para eliminar el contenedor de blobs actualmente seleccionado.
...
7. Después, un segundo cuadro de diálogo **Firma de acceso compartido** mostrará el contenedor de blobs junto con la dirección URL y las QueryStrings que se pueden utilizar para acceder al recurso de almacenamiento. Seleccione **Copiar** junto a la dirección URL que desea copiar al Portapapeles.
...
7. Siga estos pasos según la tarea que desea realizar:
   ...
   * **Cargar archivos en un contenedor de blobs**
     ...
     3. Especifique el **tipo de blob**. El artículo [Introducción al Almacenamiento de blobs de Azure mediante .NET](storage/storage-dotnet-how-to-use-blobs.md#blob-service-concepts) explica las diferencias entre los distintos tipos de blob.
