<properties urlDisplayName="Service Bus Topics" pageTitle="Uso de los temas del bus de servicio (Python) - Azure" metaKeywords="Introducción a los temas del Bus de servicio de Azure Service publicación suscripción mensajería Python" description="Obtenga información acerca del uso de los temas de Bus de servicio y suscripciones de Azure. Los ejemplos de código están escritos para aplicaciones Python." metaCanonical="" services="service-bus" documentationCenter="Python" title="How to Use Service Bus Topics/Subscriptions" authors="huvalo" solutions="" manager="wpickett" editor="" />
...
**create\_topic** también admite opciones adicionales, que
permiten sobrescribir la configuración de tema predeterminada como el tiempo que dura
la transmisión de un mensaje o el tamaño máximo de un tema. El ejemplo siguiente muestra cómo
establecer el tamaño máximo del tema en 5 GB durante un tiempo de transmisión de 1 minuto:
...
"LowMessages" con un **SqlFilter** que solo selecciona los mensajes que tienen una propiedad **messagenumber** menor o igual a 3: 
...
Ahora que ha aprendido los conceptos básicos de los temas del bus de servicio, siga estos
...
-   Referencia de API para [SqlFilter][].
  ...
  [Conceptos de tema]: ../../../DevCenter/dotNet/Media/sb-topics-01.png
