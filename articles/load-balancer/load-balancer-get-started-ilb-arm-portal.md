...
4. En la hoja **Cree un equilibrador de carga**, escriba un **nombre** para el equilibrador de carga.
5. En **Esquema**, haga clic en **Interno**.
...
6. En **Asignación de direcciones IP**, haga clic en **Dinámica** o **Estática**, dependiendo de si desea que la dirección IP del equilibrador de carga sea fija (estática) o no.
...
7. En **Grupo de recursos**, especifique el nombre de un grupo de recursos nuevo para el equilibrador de carga, o haga clic en **Seleccionar existente** y seleccione un grupo de recursos existente. 
...
4. En **Intervalo**, especifique la frecuencia de sondeo de la aplicación.
5. En **Umbral incorrecto**, especifique cuántos intentos fallidos deben producirse antes de que la VM back-end se marque como incorrecta.
5. Haga clic en **Aceptar** para crear el sondeo.
