<properties
   pageTitle="Creación de un equilibrador de carga interno mediante la CLI de Azure en Resource Manager | Microsoft Azure"
...
1. Si nunca ha usado la CLI de Azure, consulte [Instalación y configuración de la interfaz de la línea de comandos de Azure](../../articles/xplat-cli-install.md). Siga las instrucciones hasta el punto de seleccionar su cuenta y su suscripción a Azure.
...
1. Creación de un conjunto de equilibrador de carga interno
    ...
    >[AZURE.NOTE] Todos los recursos de un equilibrador de carga interno, como redes virtuales y subredes de la red virtual, deben estar en el mismo grupo de recursos y en la misma región.
...
2. Cree una NIC llamada *lb-nic2-be* y asóciela a la regla NAT *rdp2* y el grupo de direcciones de back-end *beilb*.

        azure network nic create -g nrprg -n lb-nic2-be --subnet-name nrpvnetsubnet --subnet-vnet-name nrpvnet -d "/subscriptions/####################################/resourceGroups/nrprg/providers/Microsoft.Network/loadBalancers/nrplb/backendAddressPools/beilb" -e "/subscriptions/####################################/resourceGroups/nrprg/providers/Microsoft.Network/loadBalancers/nrplb/inboundNatRules/rdp2" eastus

3. Cree una máquina virtual llamada *DB1* y asóciela a la NIC llamada *lb-nic1-be*. Se crea una cuenta de almacenamiento llamada *web1nrp* antes de ejecutarse el comando que aparece a continuación:
...
4. Cree una máquina virtual llamada *DB2* y asóciela a la NIC llamada *lb-nic2-be*. Se creó una cuenta de almacenamiento llamada *web1nrp* antes de ejecutar el comando que aparece a continuación.
