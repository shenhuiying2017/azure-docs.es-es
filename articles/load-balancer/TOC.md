...
## [Sondeos del equilibrador de carga](load-balancer-custom-probe-overview.md)
## [Puertos de alta disponibilidad](load-balancer-ha-ports-overview.md)
## [Compatibilidad de IPv6](load-balancer-ipv6-overview.md)
## [Varios servidores front-end](load-balancer-multivip-overview.md)
...
## [Equilibrio de carga de máquinas virtuales en una zona](tutorial-load-balancer-standard-public-zonal-portal.md)  
...
## [Configuración del modo de distribución de Load Balancer](load-balancer-distribution-mode.md)
