---
title: "Creación de un equilibrador de carga interno mediante PowerShell con el modelo de implementación clásica | Microsoft Docs"
...
Obtenga información sobre cómo [realizar estos pasos con el modelo de Resource Manager](load-balancer-get-started-ilb-arm-ps.md).
...
### <a name="an-internet-facing-multitier-application"></a>Una aplicación de niveles múltiples accesible desde Internet
