...
---
# <a name="a-namegetstartedacreating-an-internetfacing-load-balancer-in-resource-manager-by-using-powershell"></a><a name="get-started"></a>Creación de un equilibrador de carga orientado a Internet en Resource Manager mediante PowerShell
...
## <a name="create-a-frontend-ip-pool-and-a-backend-address-pool"></a>Creación de un grupo de direcciones IP front-end y un grupo de direcciones back-end
