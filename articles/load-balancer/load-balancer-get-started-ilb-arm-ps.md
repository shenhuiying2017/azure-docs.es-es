---
title: "Creación de un equilibrador de carga interno mediante PowerShell en el Administrador de recursos | Microsoft Docs"
...
Puede encontrar las instrucciones detalladas para crear una máquina virtual y asignarla a una NIC en la documentación: [Creación de una máquina virtual de Azure con PowerShell](../virtual-machines/virtual-machines-windows-ps-create.md).
