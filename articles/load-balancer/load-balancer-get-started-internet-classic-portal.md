...
---
title: Introducción a la creación de un equilibrador de carga accesible desde Internet en un modelo de implementación clásica con el Portal de Azure clásico | Microsoft Docs
...
10. En la página **Especifique los detalles del punto de conexión**, escriba un nombre para el punto de conexión y luego haga clic en la marca de verificación.
