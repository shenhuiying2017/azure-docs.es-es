...
## Mucho más que simples aplicaciones web##
...
- **Ajuste de escala automático**: Aplicaciones web le permite ampliar y reducir rápidamente sus recursos para hacer frente a cualquier carga de trabajo entrante de los clientes. Seleccione manualmente el número y el tamaño de las máquinas virtuales o configure el ajuste de escala automático para escalar sus servidores en función de la carga o de una programación.
- **Integración continua**: configure flujos de trabajo de integración e implementación continuas con VSO, GitHub, TeamCity, Hudson o BitBucket, con los que podrá compilar, probar e implementar automáticamente su aplicación web en cada operación de protección de código o pruebas de integración correctas.
...
- **Prueba de producción**: lleve las implementaciones de ensayo a un nivel superior y realice [pruebas A/B][Tip] para comprobar el nuevo código con una fracción configurable de su tráfico dinámico. 
...
Para obtener más información sobre la plataforma Servicio de aplicaciones de Azure, consulte [Servicio de aplicaciones de Azure][appservice].
