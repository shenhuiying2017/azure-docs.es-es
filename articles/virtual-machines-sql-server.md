...
Este tema se ha trasladado a una [nueva ubicación][] en la biblioteca.

Para obtener información sobre cómo crear una máquina virtual de SQL Server mediante la imagen proporcionada por la plataforma, consulte [Aprovisionamiento de una máquina virtual de SQL Server en Azure][].

Para obtener la información completa más actualizada sobre el uso de SQL Server en máquinas virtuales de Azure, consulte [SQL Server en máquinas virtuales de Azure][] en la biblioteca.
