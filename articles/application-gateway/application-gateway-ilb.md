...
- El elemento *FrontendIPConfigurations* describe los detalles de ILB relevantes para configurar Puerta de enlace de aplicaciones con un ILB. 

- El elemento *Type* de dirección IP front-end debe establecerse en 'Private'
...
Utilice el cmdlet `Get-AzureApplicationGateway` para comprobar el estado de la puerta de enlace. Si *Start-AzureApplicationGateway* se realizó correctamente en el paso anterior, State debería ser *Running* y Vip y DnsName deben tener entradas válidas. Este ejemplo muestra el cmdlet en la primera línea, seguido de la salida. En este ejemplo, la puerta de enlace se está ejecutando y está lista para asumir tráfico.

**Nota:** la puerta de enlace de aplicaciones está configurada para aceptar tráfico en el extremo ILB configurado de 10.0.0.10 en este ejemplo.
