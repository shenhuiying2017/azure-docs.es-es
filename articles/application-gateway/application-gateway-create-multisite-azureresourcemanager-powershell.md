...
### <a name="step-2"></a>Paso 2
Configure del grupo de direcciones IP de back-end llamado "pool01"y "pool2" con las direcciones IP "10.0.1.100, 10.0.1.101,10.0.1.102" para "pool1" y "10.0.1.103, 10.0.1.104, 10.0.1.105" para "pool2".
...
> [!IMPORTANT]
> El aprovisionamiento de Puerta de enlace de aplicaciones es una operación larga y puede tardar algún tiempo en completarse.
> 
> 
