---
title: Configuración de la directiva SSL en Azure Application Gateway mediante PowerShell
...
La siguiente salida es un ejemplo de ejecución de `Get-AzureRmApplicationGatewaySslPredefinedPolicy`.
