...
Para aprender a configurar una puerta de enlace de aplicaciones con una aplicación web como miembro del grupo de servidores back-end, visite [Configure App web apps with Application Gateway](application-gateway-web-app-powershell.md) (Configuración de aplicaciones web con Application Gateway).
