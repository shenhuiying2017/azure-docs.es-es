...
3. Los servidores que configurará para usar la Puerta de enlace de aplicaciones deben existir o tener sus puntos de conexión creados en la red virtual o tener una VIP/IP pública asignada.
