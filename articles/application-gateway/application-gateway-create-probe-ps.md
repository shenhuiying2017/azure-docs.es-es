<properties 
   pageTitle="Creación de un sondeo personalizado para uso de PowerShell en el Administrador de recursos de puerta de enlace de aplicaciones | Microsoft Azure"
   description="Aprenda a crear un sondeo personalizado para la puerta de enlace de aplicaciones mediante PowerShell en el Administrador de recursos."
...
# Creación de un sondeo personalizado para la puerta de enlace de aplicaciones mediante el Administrador de recursos de Azure
...
## Creación de un objeto de configuración de la puerta de enlace de aplicaciones con sondeo personalizado 
...
Configure la puerta de enlace de aplicaciones "poolsetting01" para el tráfico del grupo de back-end. Este paso también tiene una configuración de tiempo de espera para la respuesta del grupo de back-end a una solicitud de puerta de enlace de aplicaciones. Cuando una respuesta de back-end alcanza un límite de tiempo de espera, la puerta de enlace de aplicaciones cancela la solicitud. Esto es diferente del tiempo de espera de sondeo que es solo para que la respuesta de back-end a las comprobaciones de sondeo.
...
En el ejemplo, el sondeo personalizado está configurado para comprobar la dirección URL contoso.com/path/custompath.htm cada 30 segundos. Se configura un umbral de tiempo de espera de 120 segundos con el número máximo de 8 solicitudes de sondeo con error.
...
Elimine la configuración de sondeo de la puerta de enlace de aplicaciones con `Remove-AzureRmApplicationGatewayProbeConfig`.
