---
title: "Configuración de una puerta de enlace de aplicaciones existente para hospedar varios sitios de Azure Portal | Microsoft Docs"
...
2. Cree un nuevo agente de escucha para cada puerta de enlace de aplicaciones del sitio que lo admitirá.
...
Esto completa la configuración de una puerta de enlace de aplicaciones existentes con compatibilidad multisitio a través de Azure Portal.
...
[multisitio]: ./media/application-gateway-create-multisite-portal/multisite.png
