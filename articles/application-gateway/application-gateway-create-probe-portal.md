...
Navegue a http://portal.azure.com y seleccione una puerta de enlace de aplicaciones existente.

![Introducción a Application Gateway][1]

### <a name="step-2"></a>Paso 2
Haga clic en **Sondeos** y después en el botón **Agregar** para agregar un sondeo nuevo.
...
* **Host** : es el nombre de host que se utiliza para el sondeo. Solo se puede aplicar cuando se ha configurado un entorno multisitio en Application Gateway; de lo contrario hay que usar '127.0.0.1'. Es diferente al nombre de host de máquina virtual.
...
> [!IMPORTANT]
> El nombre de host no es el nombre del servidor. Es el nombre del host virtual que se ejecuta en el servidor de aplicaciones. El sondeo se envía a http://(nombre de host):(puerto de httpsetting)/urlPath
> 
> 
