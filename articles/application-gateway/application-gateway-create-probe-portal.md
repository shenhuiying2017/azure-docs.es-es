---
title: Creación de un sondeo personalizado para Puerta de enlace de aplicaciones mediante el portal | Microsoft Docs
...
> [!IMPORTANT]
> El nombre de host no es el nombre del servidor. Es el nombre del host virtual que se ejecuta en el servidor de aplicaciones. El sondeo se envía a http://(nombre de host):(puerto de configuración http)/urlPath
> 
> 
