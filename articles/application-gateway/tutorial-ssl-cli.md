---
title: 'Crear una puerta de enlace de aplicaciones con terminación SSL: CLI de Azure'
...
---
# <a name="tutorial-create-an-application-gateway-with-ssl-termination-using-the-azure-cli"></a>Tutorial: crear una puerta de enlace de aplicaciones con terminación SSL mediante la CLI de Azure
...
Si lo prefiere, puede realizar los pasos de este tutorial mediante [Azure PowerShell](tutorial-ssl-powershell.md).
