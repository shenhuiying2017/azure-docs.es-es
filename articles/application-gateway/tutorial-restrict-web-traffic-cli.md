---
title: Restringir el tráfico web con un firewall de aplicaciones web - CLI de Azure
...
---
# <a name="tutorial-restrict-web-traffic-with-a-web-application-firewall-using-the-azure-cli"></a>Tutorial: restringir el tráfico web con un firewall de aplicaciones web mediante la CLI de Azure
...
Si lo prefiere, puede seguir los pasos de este tutorial mediante [Azure PowerShell](tutorial-restrict-web-traffic-powershell.md).
...
> [Crear una puerta de enlace de aplicaciones con terminación SSL](./tutorial-ssl-cli.md)