...
# Configuración de la directiva SSL y SSL de extremo a extremo con Application Gateway mediante PowerShell
...
## Deshabilitación de las versiones de protocolo SSL en una puerta de enlace de aplicaciones existente
