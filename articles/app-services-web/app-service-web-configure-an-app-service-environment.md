...
Esto es mucho menos problemático para las aplicaciones que se encuentran en ejecución que cambiar el tamaño de recursos de cálculo con cargas de trabajo en ejecución. Para obtener detalles sobre el escalado de aplicaciones web en un entorno del Servicio de aplicaciones vaya a [Escalado de aplicaciones web en un entorno del Servicio de aplicaciones][HowtoScale].
...
Para empezar a trabajar con entornos del Servicio de aplicaciones, vea [Creación de un entorno del Servicio de aplicaciones][HowtoCreateASE].
