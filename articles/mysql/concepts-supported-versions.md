...
Consulte la [documentación](https://dev.mysql.com/doc/relnotes/mysql/5.7/en/news-5-7-20.html) de MySQL para obtener más información sobre las mejoras y correcciones de MySQL 5.7.20.
