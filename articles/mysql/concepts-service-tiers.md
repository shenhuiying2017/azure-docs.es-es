...
- [Administración de un único servidor en Azure Portal](quickstart-create-mysql-server-database-using-azure-portal.md)
- [Administración de un único servidor con la CLI de Azure](quickstart-create-mysql-server-database-using-azure-cli.md)
