...
# Azure Database for MySQL: uso de Java para conectarse y consultar datos
...
- Incluir el archivo jar de JDBC (por ejemplo, mysql-connector-java-5.1.42-bin.jar) en la ruta de clase de la aplicación.
