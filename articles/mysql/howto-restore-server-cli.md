...
Para el nivel básico, las copias de seguridad están disponibles durante 7 días. Para el nivel estándar, las copias de seguridad están disponibles durante 35 días. Para más información, consulte el artículo de [planes de tarifa de Azure Database for MySQL](concepts-pricing-tiers.md).
...
| Nombre | myserver-restored | Nombre del nuevo servidor que se crea mediante el comando de restauración. |
