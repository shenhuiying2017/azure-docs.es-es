...
* Consultas geoespaciales. Muchas aplicaciones móviles ofrecen en la actualidad experiencias en contexto geográfico. Gracias a la compatibilidad de primera clase con [tipos geoespaciales](geospatial.md), DocumentDB permite que crear de estas experiencias sea fácil de conseguir.
...
![Inicio rápido de Azure Cosmos DB para aplicaciones móviles](media/mobile-apps-with-xamarin/documentdb-quickstart.png)
...
![Rendimiento a gran escala de Azure Cosmos DB a petición](media/mobile-apps-with-xamarin/documentdb-scale.png)
...
![Azure Cosmos DB escala en regiones geográficas](media/mobile-apps-with-xamarin/documentdb-replicate-globally.png)
