...
La [API para MongoDB](../documentdb/documentdb-protocol-mongodb.md) de Azure Cosmos DB admite las [consultas de shell de MongoDB](https://docs.mongodb.com/manual/tutorial/query-documents/). 
