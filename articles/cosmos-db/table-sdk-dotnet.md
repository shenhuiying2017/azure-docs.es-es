...
description: "Obtenga información acerca de Table API de Azure Cosmos DB, incluidas las fechas de lanzamiento, las fechas de retirada y los cambios realizados en cada versión."
services: cosmos-db
...
| [0.9.0-preview](#0.1.0-preview) |11 de noviembre de 2017 |--- |
