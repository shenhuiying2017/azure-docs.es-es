---
title: 'Azure Cosmos DB: ejemplos de .NET para la API de SQL | Microsoft Docs'
...
También necesita el [paquete NuGet Microsoft.Azure.DocumentDB](http://www.nuget.org/packages/Microsoft.Azure.DocumentDB/). 
...
Para más información sobre cómo escribir consultas, consulte [Consulta SQL en Azure Cosmos DB](sql-api-sql-query.md).
