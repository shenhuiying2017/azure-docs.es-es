...
En esta sección del tutorial, puede usar Azure Cloud Shell (en su explorador de Internet) o la [CLI de Azure 2.0](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli) instalada localmente. Si usa la CLI de Azure localmente, asegúrese de que ejecuta la versión 2.0 o posterior. Ejecute `az --version` en el símbolo del sistema para comprobar la versión. 
...
Creación de una cuenta de Azure Cosmos DB con el comando [`az cosmosdb create`](/cli/azure/cosmosdb#create).
