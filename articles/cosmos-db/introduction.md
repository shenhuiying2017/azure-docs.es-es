...
El rendimiento se puede aprovisionar en un contenedor de Cosmos DB en granularidades de unidades de solicitud por segundo y [por minuto (RU/m)](request-units-per-minute.md). El procesamiento aprovisionado en granularidad por minuto se usa para administrar picos inesperados de la carga de trabajo producidos en una granularidad por segundo. 
