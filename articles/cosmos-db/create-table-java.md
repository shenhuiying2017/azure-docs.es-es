...
2. Abra el archivo config.properties y copie las propiedades necesarias de la cadena de conexión en el archivo de configuración.

3. Guarde el archivo config.properties.
