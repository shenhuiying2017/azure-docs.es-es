---
title: Uso de Azure Table Storage o Azure Cosmos DB desde Node.js | Microsoft Docs
...
## <a name="add-an-azure-comsos-db-connection"></a>Incorporación de una conexión de Azure Cosmos DB
...
Si la operación se realiza correctamente, `result` contiene la etiqueta [ETag](http://en.wikipedia.org/wiki/HTTP_ETag) del registro insertado y `response` contiene información sobre la operación.
...
También hay un ejemplo de continuación (continuationsample.js) en el [repositorio azure-storage-node](https://github.com/Azure/azure-storage-node/tree/master/examples/samples) de GitHub. 
