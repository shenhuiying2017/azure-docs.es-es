...
[!code-powershell[main](../../../powershell_scripts/cosmosdb/get-account-keys/get-account-keys.ps1?highlight=36-40 "Obtención de las claves para una cuenta de Azure Cosmos DB")]
