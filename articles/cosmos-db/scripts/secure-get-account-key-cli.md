...
[!code-azurecli[main](../../../cli_scripts/cosmosdb/scale-cosmosdb-get-account-key/secure-cosmosdb-get-account-key.sh?highlight=22-25 "Obtención de claves de cuenta de Azure Cosmos DB")]
...
| [az cosmosdb list-keys](/cli/azure/sql/server#create) | Crea un servidor lógico que hospeda la base de datos SQL. |
