...
[!code-powershell[principal](../../../powershell_scripts/cosmosdb/create-firewall/create-firewall.ps1?highlight=35-36,39-43 "Creación de un firewall para Azure Cosmos DB")]
