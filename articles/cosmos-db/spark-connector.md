...
Para comenzar, descargue el conector de Spark a Azure Cosmos DB del repositorio [azure-cosmosdb-spark](https://github.com/Azure/azure-cosmosdb-spark/) en GitHub.
...
* Consulte [Apache Spark en Azure HDInsight](../hdinsight/spark/apache-spark-jupyter-spark-sql.md) para implementar Apache Spark en la nube para implementaciones críticas mediante [Azure HDInsight](https://azure.microsoft.com/services/hdinsight/apache-spark/).

Versiones oficialmente compatibles:

| Componente | Versión |
|---------|-------|
|Spark de Apache|2.0.2, 2.1.0, 2.2.0|
| Scala| 2.10, 2.11|
| SDK de Java para SQL de Azure Cosmos DB | 1.14.0, 1.15.0 |
...
El fragmento de código siguiente muestra cómo utilizar el conector en una sesión de Spark; consulte `azure-cosmosdb-spark` en el [repositorio de GitHub](https://github.com/Azure/azure-cosmosdb-spark) para obtener ejemplos de Python.
