...
- Restricción de las direcciones IP de origen entrantes. App Services tiene una característica de integración de la red virtual que ayuda a restringir las direcciones IP de origen entrantes a través de grupos de seguridad de red (NSG). Si no conoce las redes virtuales de Azure, se trata de una funcionalidad que permite colocar muchos de los recursos de Azure en una red no enrutable sin conexión a Internet cuyo acceso controla. Vea [Integración de su aplicación con una red virtual de Azure](../app-service-web/web-sites-integrate-with-vnet.md) para obtener más información.
