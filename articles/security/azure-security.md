...
## <a name="20-summary-azure-security-capabilities"></a>2.0 Resumen de las funcionalidades de seguridad de Azure
...
### <a name="21-security-features-implemented-to-secure-the-azure-platform"></a>2.1 Características de seguridad implementadas para proteger la plataforma Azure:
...
### <a name="22-security-features-offered-by-azure-to-secure-data-and-application"></a>2.2 Características de seguridad que ofrece Azure para proteger datos y aplicaciones
...
## <a name="30-operations"></a>3.0 Operaciones
...
### <a name="31-operations-management-suite-security-and-audit-dashboard"></a>3.1 Panel Seguridad y auditoría de Operations Management Suite
...
## <a name="40-applications"></a>4.0 Aplicaciones
...
### <a name="41-web-application-vulnerability-scanning"></a>4.1 Examen de vulnerabilidades para aplicaciones web
...
### <a name="42-penetration-testing"></a>4.2 Pruebas de penetración
...
### <a name="43-web-application-firewall"></a>4.3 Firewall de aplicaciones web
...
### <a name="44-authentication-and-authorization-in-azure-app-service"></a>4.4 Autenticación y autorización en Azure App Service
...
### <a name="45-layered-security-architecture"></a>4.5 Arquitectura de seguridad por niveles
...
### <a name="46-web-server-diagnostics-and-application-diagnostics"></a>4.6 Diagnóstico del servidor web y diagnóstico de aplicaciones
...
#### <a name="461-web-server-diagnostics"></a>4.6.1 Diagnóstico del servidor web
...
#### <a name="462-application-diagnostics"></a>4.6.2 Diagnóstico de aplicaciones
...
## <a name="50-storage"></a>5.0 Almacenamiento
...
### <a name="51-role-based-access-control-rbac"></a>5.1 Control de acceso basado en rol (RBAC)
...
### <a name="52-shared-access-signature"></a>5.2 Firma de acceso compartido
...
### <a name="53-encryption-in-transit"></a>5.3 Cifrado en tránsito
...
### <a name="54-encryption-at-rest"></a>5.4 Cifrado en reposo
...
### <a name="55-storage-analytics"></a>5.5 Storage Analytics
...
### <a name="56-enabling-browser-based-clients-using-cors"></a>5.6 Habilitación de clientes basados en explorador mediante CORS
...
## <a name="60-networking"></a>6.0 Redes
...
### <a name="61-network-layer-controls"></a>6.1 Controles de nivel de red
...
#### <a name="611-network-security-groups"></a>6.1.1 Grupos de seguridad de red
...
#### <a name="612-route-control-and-forced-tunneling"></a>6.1.2 Control de ruta y tunelización forzada
...
#### <a name="613-virtual-network-security-appliances"></a>6.1.3 Dispositivos de seguridad de red virtual
...
### <a name="66-web-application-firewall"></a>6.6 Firewall de aplicaciones web
...
### <a name="611-log-analytics-nsgs"></a>6.11 Grupos de seguridad de red de Log Analytics
...
## <a name="70-compute"></a>7.0 Proceso
...
### <a name="71-antimalware--antivirus"></a>7.1 Antimalware y antivirus
...
### <a name="72-hardware-security-module"></a>7.2 Módulo de seguridad de hardware
...
### <a name="73-virtual-machine-backup"></a>7.3 Copia de seguridad de máquina virtual
...
### <a name="75-sql-vm-tde"></a>7.5 TDE de máquina virtual de SQL
...
### <a name="76-vm-disk-encryption"></a>7.6 Cifrado de discos de máquinas virtuales
...
### <a name="77-virtual-networking"></a>7.7 Redes virtuales
...
### <a name="78-patch-updates"></a>7.8 Actualizaciones de revisiones
...
### <a name="79-security-policy-management-and-reporting"></a>7.9 Informes y administración de directivas de seguridad
...
## <a name="80-identify-and-access-management"></a>8.0 Administración de identidades y acceso
...
### <a name="81-secure-identity"></a>8.1 Protección de la identidad
...
### <a name="82-secure-apps-and-data"></a>8.2 Protección de aplicaciones y datos
