...
>[!NOTE]
Primero debe haber completado correctamente los pasos descritos en el artículo [Introducción](security-azure-log-integration-get-started.md) antes de realizar los pasos de este artículo.
