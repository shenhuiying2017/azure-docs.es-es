...
- [Azure log Integration frequently asked questions (FAQ)](security-azure-log-integration-faq.md) (Preguntas más frecuentes sobre la integración de registros de Azure). Este artículo de preguntas más frecuentes responde a preguntas acerca de la integración de registros de Azure.
