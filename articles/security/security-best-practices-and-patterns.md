<properties
   pageTitle="Patrones y procedimientos recomendados de seguridad en Azure | Microsoft Azure"
   description="En este artículo se analizan procedimientos recomendados y patrones útiles para mejorar la seguridad de las implementaciones de Azure."
   services="security"
