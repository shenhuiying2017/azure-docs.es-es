...
![texto alternativo](images/fedramp-architectural-diagram.png?raw=true "Azure Security and Compliance Blueprint: automatización de aplicaciones web para FedRAMP")
