        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Más información sobre Azure Security</h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Estoy pensando en Azure para mi empresa. ¿Qué seguridad ofrece Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="http://aka.ms/sharedresponsibility">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">¿Cómo comparte Microsoft responsabilidades de seguridad con mi organización?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-isolation">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">¿Cómo aísla Azure mis recursos de los recursos de otros clientes de Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-storage-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Introducción a la seguridad en el almacenamiento</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/security-network-overview">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Introducción a la seguridad de red</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-log-audit">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">¿Cuáles son las opciones de supervisión y registro disponibles en Azure?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-encryption-atrest">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">¿Cómo protege Azure los datos en reposo?</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Cifrado de máquinas virtuales de Azure</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        ...
                        <h3>Notas del producto</h3>
                        <ul class="noBullet">
                            <li style="list-style: none;">
                                <a class="barLink" href="http://aka.ms/SecurityResponsepaper">Respuesta de seguridad de Azure en la nube</a>
                            </li>
                            <li style="list-style: none;">
                ...
                <div class="card">
                    <div class="cardText">
                        ...
                        <ul class="noBullet">
                            ...
                            <li style="list-style: none;">
                                <a class="barLink" href="/azure/security/azure-service-fabric-security-best-practices">Seguridad de Service Fabric</a>
                            </li>
                            <li style="list-style: none;">
        ...
        <div class="cardPadding">
            <div class="card">
                <div class="cardText">
                     ...
                     <ul class="noBullet">
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-database-security-checklist">Protección de bases de datos</a>
                        </li>
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-operational-security-checklist">Seguridad operativa</a>
                        </li>
                        <li style="list-style: none;">
                            <a class="barLink" href="/azure/security/azure-service-fabric-security-checklist">Seguridad de Service Fabric</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Cumplimiento normativo</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding" style="padding-bottom: 0;">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h2 style="margin-top: 0">Recursos &amp; Servicios</h2>
                    </div>
                </div>
            </div>
        </div>
        ...
        <a href="https://www.microsoft.com/en-us/trustcenter/">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Centro de confianza de MSFT</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="https://azuremarketplace.microsoft.com/en-us/marketplace/apps?search=security&page=1">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Asociados de seguridad de Azure</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-cyber-services">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Consultoría de ciberseguridad</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <a href="/azure/security/azure-security-disk-encryption">
            <div class="cardSize">
                <div class="cardPadding">
                    <div class="card" style="min-height: 0;padding-bottom: 24px; text-align: center;">
                        <div class="cardText">
                            <p style="font-size: 1.12rem;">Cifrado de discos</p>
                        </div>
                    </div>
                </div>
            </div>
