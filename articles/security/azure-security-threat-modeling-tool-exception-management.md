...
## <a name="a-idservicedebugawcf--do-not-include-servicedebug-node-in-configuration-file"></a><a id="servicedebug"></a>WCF: no incluya el nodo serviceDebug en el archivo de configuración
...
## <a name="a-idservicemetadataawcf--do-not-include-servicemetadata-node-in-configuration-file"></a><a id="servicemetadata"></a>WCF: no incluya el nodo serviceMetadata en el archivo de configuración
...
| Attributes              | Genérico, .NET Framework 3 |
| Referencias              | [MSDN](https://msdn.microsoft.com/library/ff648500.aspx), [Fortify Kingdom](https://vulncat.fortify.com/en/vulncat/index.html) |
...
## <a name="a-idexceptionaensure-that-proper-exception-handling-is-done-in-aspnet-web-api"></a><a id="exception"></a>Asegúrese de que se realiza un tratamiento adecuado de las excepciones en ASP.NET Web API
...
# <a name="by-action"></a>Por acción
# <a name="by-controller"></a>Por controlador
...
## <a name="a-idmessagesado-not-expose-security-details-in-error-messages"></a><a id="messages"></a>No exponga detalles de seguridad en los mensajes de error
...
## <a name="a-iddefaultaimplement-default-error-handling-page"></a><a id="default"></a>Implemente una página de control de errores predeterminado
...
## <a name="a-iddeploymentaset-deployment-method-to-retail-in-iis"></a><a id="deployment"></a>Establezca el método de implementación como deployment retail en IIS
...
## <a name="a-idfailaexceptions-should-fail-safely"></a><a id="fail"></a>Las excepciones deben generar un error con seguridad
