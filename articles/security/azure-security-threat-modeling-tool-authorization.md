...
| Cliente móvil | <ul><li>[Implementación de detección implícita de jailbreak o rooting](#rooting-detection)</li></ul> |
...
| Attributes              | N/D; Proveedor de identidades; ADFS, Proveedor de identidades; Azure AD |
