...
Puede aprender más sobre las redes virtuales de Azure en el artículo [Información general sobre redes virtuales](../virtual-network/virtual-networks-overview.md).
...
Para más información sobre los **grupos de seguridad de red**, lea el artículo [¿Qué es un grupo de seguridad de red?](../virtual-network/virtual-networks-nsg.md).
...
Para más información sobre las **rutas definidas por el usuario**, consulte el artículo [¿Qué son las rutas definidas por el usuario y el reenvío IP?](../virtual-network/virtual-networks-udr-overview.md).

### Dispositivos de seguridad de red virtual
Aunque los grupos de seguridad de red, las rutas definidas por el usuario y la tuenlización forzada proporcionan un nivel de seguridad en las capas de red y transporte del [modelo OSI](https://en.wikipedia.org/wiki/OSI_model), hay veces en que querrá habilitar la seguridad en niveles más altos que la red.
...
## Acceso remoto seguro y conectividad entre entornos
...
Para más información sobre la conectividad **VPN de punto a sitio**, consulte el artículo [Configuración de una conexión punto a sitio a una red virtual mediante PowerShell](../vpn-gateway/vpn-gateway-howto-point-to-site-rm-ps.md).
...
Para más información sobre las **VPN de sitio a sitio a Azure**, consulte el artículo [Creación de una red virtual con una conexión VPN de sitio a sitio mediante el Portal de Azure y Azure Resource Manager](../vpn-gateway/vpn-gateway-howto-site-to-site-resource-manager-portal.md).

Para más información sobre cómo planear la **conectividad entre locales basada en VPN**, consulte [Planeamiento y diseño de puerta de enlace de VPN](../vpn-gateway/vpn-gateway-plan-design.md).
...
Para más información sobre **vínculos WAN dedicados** entre la ubicación local y redes virtuales de Azure, lea el artículo [Introducción técnica de ExpressRoute](../expressroute/expressroute-introduction.md).
...
Para más información sobre las redes VPN de sitio a sitio entre redes virtuales de Azure, lea el artículo [Configuración de una conexión entre dos redes virtuales mediante Azure Resource Manager y PowerShell](../vpn-gateway/vpn-gateway-vnet-vnet-rm-ps.md).
...
Para más información sobre la Puerta de enlace de aplicaciones de Azure, lea el artículo [Introducción a Puerta de enlace de aplicaciones](../application-gateway/application-gateway-introduction.md).

### Equilibrio de carga de nivel de red
A diferencia del equilibrio de carga basado en HTTP, el equilibrio de carga de nivel de red toma las decisiones en función de la dirección IP y el número de puerto (TCP o UDP). Puede beneficiarse del equilibrio de carga de nivel de red en Azure con Azure Load Balancer. Algunas características importantes de Azure Load Balancer son:
...
Para más información sobre Azure Load Balancer externo, lea el artículo [Equilibrador de carga accesible desde Internet entre varias máquinas virtuales o servicios](../load-balancer/load-balancer-internet-overview.md).

Para más información sobre Azure Load Balancer interno, lea el artículo [Información general sobre el equilibrador de carga interno](../load-balancer/load-balancer-internal-overview.md).
...
Para más información sobre el equilibrio de carga global con el Administrador de tráfico de Azure, lea el artículo [¿Qué es el Administrador de tráfico?](../traffic-manager/traffic-manager-overview.md).
...
Para más información sobre el registro de grupo de seguridad de red, lea el artículo [Análisis del registro para grupos de seguridad de red (NSG)](../virtual-network/virtual-network-nsg-manage-log.md).
...
Para más información sobre el **servidor DNS de red virtual de Azure**, consulte el artículo [Información general sobre redes virtuales](../virtual-network/virtual-networks-overview.md).

Para más información sobre el uso de **servidores DNS propios** en una red virtual de Azure, consulte el artículo [Administración de servidores DNS usados por una red virtual (VNet)](../virtual-network/virtual-networks-manage-dns-in-vnet.md).
...
Para más información sobre DNS de Azure, lea [Introducción a DNS de Azure](../dns/dns-overview.md).
...
Para más información sobre las redes perimetrales y cómo implementarlas en Azure, lea el artículo [Servicios en la nube de Microsoft y seguridad de red](../best-practices-network-security.md).
...
Para más información sobre Azure Security Center, consulte el artículo [Introducción a Azure Security Center](../security-center/security-center-intro.md).
