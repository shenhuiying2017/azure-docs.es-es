...
## <a name="a-idsensitive-entitiesaidentify-sensitive-entities-in-your-solution-and-implement-change-auditing"></a><a id="sensitive-entities"></a>Identificación de las entidades confidenciales de la solución e implementación de la auditoría de cambios
...
## <a name="a-idauditingaensure-that-auditing-and-logging-is-enforced-on-the-application"></a><a id="auditing"></a>Comprobación de que la auditoría y el registro se aplican en la aplicación
...
## <a name="a-idlog-rotationaensure-that-log-rotation-and-separation-are-in-place"></a><a id="log-rotation"></a>Comprobación de que la rotación de registros y la separación están en funcionamiento
...
## <a name="a-idlog-sensitive-dataaensure-that-the-application-does-not-log-sensitive-user-data"></a><a id="log-sensitive-data"></a>Comprobación de que la aplicación no registra datos confidenciales del usuario
...
## <a name="a-idlog-restricted-accessaensure-that-audit-and-log-files-have-restricted-access"></a><a id="log-restricted-access"></a>Comprobación de que los archivos de registro y auditoría tienen acceso restringido
...
## <a name="a-iduser-managementaensure-that-user-management-events-are-logged"></a><a id="user-management"></a>Comprobación de que se registran los eventos de administración de usuario
...
## <a name="a-idinbuilt-defensesaensure-that-the-system-has-inbuilt-defenses-against-misuse"></a><a id="inbuilt-defenses"></a>Comprobación de que el sistema tiene defensas integradas contra usos indebidos
...
## <a name="a-iddiagnostics-loggingaenable-diagnostics-logging-for-web-apps-in-azure-app-service"></a><a id="diagnostics-logging"></a>Habilitación del registro de diagnóstico para aplicaciones web en Azure App Service
...
## <a name="a-ididentify-sensitive-entitiesaensure-that-login-auditing-is-enabled-on-sql-server"></a><a id="identify-sensitive-entities"></a>Comprobación de que está habilitada la auditoría de inicio de sesión en SQL Server
...
## <a name="a-idthreat-detectionaenable-threat-detection-on-azure-sql"></a><a id="threat-detection"></a>Habilitamiento de la detección de amenazas en Azure SQL
...
## <a name="a-idanalyticsause-azure-storage-analytics-to-audit-access-of-azure-storage"></a><a id="analytics"></a>Uso de Análisis de Azure Storage para auditar el acceso de Azure Storage
...
## <a name="a-idsufficient-loggingaimplement-sufficient-logging"></a><a id="sufficient-logging"></a>Implementación de suficientes registros
...
## <a name="a-idaudit-failure-handlingaimplement-sufficient-audit-failure-handling"></a><a id="audit-failure-handling"></a>Implementación de un control suficiente de errores de auditoría
...
## <a name="a-idlogging-web-apiaensure-that-auditing-and-logging-is-enforced-on-web-api"></a><a id="logging-web-api"></a>Comprobación de que la auditoría y el registro se aplican en Web API
...
## <a name="a-idlogging-field-gatewayaensure-that-appropriate-auditing-and-logging-is-enforced-on-field-gateway"></a><a id="logging-field-gateway"></a>Comprobación de que se aplican la auditoría y registro adecuados en la puerta de enlace de campo
...
## <a name="a-idlogging-cloud-gatewayaensure-that-appropriate-auditing-and-logging-is-enforced-on-cloud-gateway"></a><a id="logging-cloud-gateway"></a>Comprobación de que se aplican la auditoría y registro adecuados en la puerta de enlace de nube
