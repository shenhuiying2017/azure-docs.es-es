<properties pageTitle="Introducción a Servicios móviles para Xamarin.Android" metaKeywords="aplicación de Azure Xamarin.Android, servicio móvil XamarinAndroid, introducción a Azure Xamarin.Android" writer="craigd" description="Learn how to use Azure Mobile Services with your Xamarin.Android app." metaCanonical="" documentationCenter="Mobile" title="Get started with Mobile Services" authors="donnam" manager="dwrede" />
