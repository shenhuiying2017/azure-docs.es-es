...
4. En **Download and run app** (Descargar y ejecutar la aplicación), haga clic en **Download** (Descargar). 
...
2. En Xamarin Studio o Visual Studio, haga clic en **File** (Archivo) y luego en **Open** (Abrir), vaya a los archivos de ejemplo descomprimidos y seleccione **XamarinTodoQuickStart.Android.sln** para abrirlos.
...
3. Presione el botón **Ejecutar** para compilar el proyecto e iniciar la aplicación. Se le solicitará que seleccione un emulador o un dispositivo USB conectado. 
	...
	> [AUZRE.NOTE] Para poder ejecutar el proyecto en el emulador de Android, debe definir al menos un dispositivo virtual de Android (AVD). Use el administrador AVD para crear y administrar estos dispositivos.
