...
>[AZURE.NOTE] Si desea ver el código fuente de la aplicación finalizada, haga clic <a href="https://github.com/RickSaling/mobile-services-samples/tree/futures/GettingStartedWithAuth/Android" target="_blank">aquí</a>.
...
[Incorporación de Servicios móviles a una aplicación existente]: /es-es/develop/mobile/tutorials/get-started-with-data-android
