<properties pageTitle="Extensión de máquina virtual Docker para Linux en Azure" description="Describe Docker y contenedores, las extensiones de máquinas virtuales de Azure y apunta a más recursos para crear contenedores de Docker tanto desde xplat-cli como desde el portal." services="virtual-machines" documentationCenter="" authors="squillace" manager="timlt" editor=""/>
...
[Cómo empezar a trabajar rápidamente con Docker en Azure Marketplace]: http://azure.microsoft.com/es-es/documentation/articles/virtual-machines-docker-ubuntu-quickstart/
