...
<properties 
    pageTitle="Solución de problemas con las colecciones en la nube: creación"
...
# Solución de problemas con las colecciones en la nube: creación

Errores comunes vistos en el Portal de administración de Azure:

	No se pudo alcanzar el servidor DNS
	ProvisioningTimeout
