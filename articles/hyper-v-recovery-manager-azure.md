<properties 
	pageTitle="Tutorial: Configuración de la protección entre un sitio de VMM local y Azure" 
...
# Tutorial: Configuración de la protección entre un sitio de VMM local y Azure
...
<UL>
<LI>Si desea obtener más información para una implementación completa, lea las Guías de <a href="http://go.microsoft.com/fwlink/?LinkId=321294">planeación</a> e <a href="http://go.microsoft.com/fwlink/?LinkId=402679">implementación</a>.</LI>
...
<h2><a id="prerequisites" name="prerequisites" href="#prerequisites"></a>Requisitos previos</h2>
...
<LI><a href="#storage">Paso 3: Agregar una cuenta de almacenamiento de Azure</a>: cree una cuenta si no tiene una. </LI>
...
<LI><a href="#clouds">Paso 5: Configurar la protección de la nube</a>: defina la configuración de la protección para las nubes de VMM.</LI>
<LI><a href="#NetworkMapping">Paso 6: Configurar asignación de red</a>: opcionalmente puede configurar la asignación de red para asignar redes de VM de origen a redes Azure de destino.</LI>
<LI><a href="#virtualmachines">Paso 7: Habilitar protección para las máquinas virtuales</a>: habilite la protección para las máquinas virtuales ubicadas en las nubes de VMM protegidas.</LI>
<LI><a href="#test">Paso 8: Prueba de la implementación</a>: puede ejecutar una conmutación por error de prueba para una sola máquina virtual o puede crear un plan de recuperación y ejecutar una conmutación por error de prueba para el plan para asegurarse de que está funcionando.</LI>
</UL>
...
<P>Compruebe la barra de estado para confirmar que el almacén se ha creado correctamente. El almacén aparecerá como <b>Activo</b> en la página principal de Servicios de recuperación.</P>
 ...
 <a name="download"></a> <h3>Paso 2: Generación de una clave de registro e instalación del proveedor de Azure Site Recovery</h3>
...
3. En **Preparar servidores VMM**, haga clic en **Generar archivo de clave de registro**. La clave será válida para 5 días a partir del momento en que se genera. Copie el archivo al servidor VMM. Lo necesitará al configurar el proveedor.
...
3. En **Comprobación de requisitos previos** seleccione detener el servicio VMM para iniciar la configuración del proveedor. Este servicio se detendrá y se volverá a iniciar automáticamente cuando finalice la configuración.
...
<h3><a id="storage"></a>Paso 3: Creación de una cuenta de almacenamiento de Azure</h3>
...
<h3><a id="agent"></a>Paso 4: Instalación del agente de los Servicios de recuperación de Azure en servidores host de Hyper-V</h3>
...
<h3><a id="test"></a>Paso 8: Prueba de la implementación</h3>
