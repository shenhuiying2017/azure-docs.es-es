...
---
title: Uso del Portal de Azure para restaurar máquinas virtuales | Microsoft Docs
...
> [!NOTE]
> El Portal proporciona una opción de creación rápida para la máquina virtual restaurada. Si quiere personalizar la configuración de la máquina virtual restaurada, use PowerShell para restaurar los discos en copia de seguridad y adjuntarlos a la opción de configuración de máquina virtual. Consulte [Restauración de máquinas virtuales con configuraciones de red especiales](#restoring-vms-with-special-network-configurations).
> 
> 
