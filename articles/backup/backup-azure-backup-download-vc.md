...
El servidor local (cliente de Windows o servidor de Windows Server o SCDPM) debe autenticarse con un almacén de copia de seguridad antes de realizar copia de seguridad datos en Azure. La autenticación se realiza mediante las "credenciales de almacén". El concepto de credenciales de almacén es similar al concepto de un archivo de "configuración de publicación" que se usa en Azure PowerShell.
...
2.  Haga clic en **Servicios de recuperación** en el panel de navegación izquierdo y seleccione el almacén de copia de seguridad que ha creado. Haga clic en el icono de nube para obtener la vista de inicio rápido de almacén de copia de seguridad. <br/> ![Vista rápida][1]

3.  En la página de Inicio rápido, haga clic en **Descargar credenciales de almacén**. El portal genera el archivo de credenciales de almacén, que está disponible para su descarga. <br/> ![Descargar][2]
