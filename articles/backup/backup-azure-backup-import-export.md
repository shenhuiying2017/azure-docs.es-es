...
5. Una o más unidades de disco duro internas SATA II/III de 3,5 pulgadas. El servicio Importación/Exportación de Azure solo admite unidades de disco duro internas SATA II/III de 3,5 pulgadas. No se admiten unidades de disco duro con un tamaño superior a 10 TB. Estas unidades de disco duro pueden estar conectadas internamente, por medio de un conector SATA compatible, o externamente, a través de un adaptador de USB SATA II/III. Consulte la [documentación del servicio Importación/Exportación de Azure](../storage/storage-import-export-service.md) para conocer el conjunto más reciente de unidades de disco duro y adaptadores USB SATA que admite el servicio.
