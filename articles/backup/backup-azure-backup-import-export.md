...
Guarde toda esta información ya que tendrá que volver a proporcionarla en los pasos siguientes.
...
| /sk:<*StorageAccountKey*> | La clave de cuenta para la cuenta de almacenamiento en la que se importarán los datos. Este valor tiene que ser igual al que se especificó durante la creación del grupo de protección o directiva de copia de seguridad.|
