...
Si observa que la copia de seguridad (más de 12 horas) o la restauración (más de 6 horas) se prolongan demasiado en el tiempo, asegúrese de seguir las [Prácticas recomendadas de copia de seguridad](backup-azure-vms-introduction.md#best-practices). Asegúrese también de que las aplicaciones utilicen [Azure Storage de forma óptima](backup-azure-vms-introduction.md#total-vm-backup-time) para copias de seguridad. 
...
1. Se bloquea el acceso de red a Storage mediante NSG<br>
