---
title: 'Azure Backup: Copia de seguridad sin conexión para DPM y Azure Backup Server | Microsoft Docs'
...
> [!NOTE]
> El proceso de copia de seguridad sin conexión para el agente de Microsoft Azure Recovery Services (MARS) es distinto del de System Center DPM y el de Azure Backup Server. Para más información sobre el uso de copia de seguridad sin conexión con el agente de MARS, consulte [este artículo](backup-azure-backup-import-export.md). No se admite la copia de seguridad sin conexión para copias de seguridad de estado del sistema realizadas mediante el agente de Azure Backup. 
>
