...
Azure Files Backup se encuentra actualmente en versión preliminar, así que solo las cuentas de almacenamiento admitidas se pueden configurar para copia de seguridad. Asegúrese de que la cuenta de almacenamiento que busca es una cuenta de almacenamiento compatible.
...
Compruebe si el recurso compartido de archivos ya está protegido en el mismo almacén de Recovery Services. Asegúrese de que el recurso compartido de archivos que desea proteger no se ha eliminado recientemente.
...
La copia de seguridad de recursos compartidos de archivos de Azure estará disponible en las siguientes zonas geográficas a partir del *23 de febrero*.
...
En cualquier momento dado, puede tener hasta 200 instantáneas para un recurso compartido de archivos, incluidas las que se realizan con Azure Backup, según se define en la directiva. Si las copias de seguridad empiezan a generar errores debido a que alcanzan este límite, elimine los puntos de restauración a petición como corresponda.
...
Actualmente, Azure Files Backup no se admite para cuentas de almacenamiento que tengan habilitadas las redes virtuales. Deshabilite las redes virtuales en las cuentas de almacenamiento de las que quiera realizar una copia de seguridad. 
...
Al intentar eliminar un recurso compartido de archivos, se mostrará la lista de copias de seguridad que también se eliminarán si continúa y se buscará una confirmación. No se puede restaurar un recurso compartido de archivos eliminado.
...
Es posible acceder a todas las instantáneas realizadas por Azure Backup desde el portal, PowerShell o la CLI. Puede montarlas mediante el procedimiento aquí descrito.
