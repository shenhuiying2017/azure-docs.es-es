...
### <a name="why-cant-i-protect-file-shares-connected-to-a-sync-group-in-azure-file-sync-br"></a>¿Por qué no puedo proteger recursos compartidos de archivos conectados a un grupo de sincronización en Azure File Sync? <br/>
...
Cuando se elimina un recurso compartido de archivos de Azure, se muestra la lista de copias de seguridad que también se eliminarán y se solicita una confirmación. No se puede restaurar un recurso compartido de archivos de Azure eliminado.
