...
6. Haga clic en **Instalar** para comenzar la instalación del agente. El agente de Backup instala .NET Framework 4.5 y Windows PowerShell (si todavía no está instalado) para completar la instalación.
...
10. Haga clic en **Finalizar** El Asistente para registrar servidor registra el servidor con Backup.
...
2. En el Agente de Backup, haga clic en **Programar copia de seguridad**.
...
1. En el agente de Backup, haga clic en **Iniciar copia de seguridad** para completar la propagación inicial a través de la red.
...
* [Copias de seguridad de cargas de trabajo en Azure con Microsoft Azure Backup Server](backup-azure-microsoft-azure-backup.md)
