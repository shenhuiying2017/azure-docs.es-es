---
title: Copia de seguridad desde Windows Server o un cliente de Windows en Azure con Copia de seguridad de Azure mediante el modelo de implementación de Resource Manager | Microsoft Docs
