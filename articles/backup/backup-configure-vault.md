...
Para hacer una copia de seguridad de los archivos y los datos de Windows Server en Azure, debe crear un almacén de copia de seguridad en la región geográfica donde desea almacenar los datos. Este tutorial le guiará a través de:

- la creación del almacén que se va a utilizar para almacenar copias de seguridad de
- descargar una credencial de almacén
- la instalación de un agente de copia de seguridad
- información general de las tareas de administración de copia de seguridad disponibles a través del portal de administración
...
3. En el **página Inicio rápido**, haga clic en **las credenciales de almacén de descarga** para solicitar el portal para generar y descargar las credenciales de almacén que va a utilizar para registrar el servidor con el almacén de copia de seguridad.

    El portal generará una credencial de almacén mediante una combinación del nombre del almacén y la fecha actual.

4. Haga clic en **Guardar** para descargar las credenciales de almacén en la carpeta de descargas de la cuenta local, o seleccione **Guardar como** desde el **Guardar** menú para especificar una ubicación para las credenciales de almacén. No es posible editar las credenciales de almacén. Por lo tanto, no hay motivo para hacer clic en Abrir. Una vez que se hayan descargado las credenciales, se le solicitará que abra la carpeta. Haga clic en **x** para cerrar este menú.

##Descarga e instalación de un agente de copia de seguridad

1. En el [Portal de administración de](https://manage.windowsazure.com).
2. Haga clic en **Servicios de recuperación de**, a continuación, seleccione un almacén de copia de seguridad para ver su página de inicio rápido.
3. En la página de inicio rápido, seleccione el tipo de agente que desee descargar. Puede elegir **Descargar Azure Backup Agent**, **Windows Server y System Center Data Protection Manager**, o **Windows Server Essentials**. Para obtener más información, consulte:
	...
	* [Instalar el agente de copia de seguridad de Azure para Windows Server 2012 y System Center 2012 SP1 - Data Protection Manager](http://technet.microsoft.com/library/hh831761.aspx#BKMK_installagent)
	* [Instalar a Azure Backup Agent para Windows Server 2012 Essentials](http://technet.microsoft.com/library/jj884318.aspx)
...
1. Inicie sesión en el [Portal de administración](https://manage.windowsazure.com).
2. Haga clic en **Servicios de recuperación de**, a continuación, haga clic en el nombre del almacén de copia de seguridad para ver la página de inicio rápido.
3. Haga clic en **panel** para ver el resumen de uso para el servidor. En la parte inferior del panel puede llevar a cabo las tareas siguientes:

    - **Administrar certificado**. Si un certificado se usó para registrar un servidor, utilícelo para actualizar el certificado. Si está utilizando las credenciales de almacén, no use **Administrar certificado**.
    - **Eliminar**. Elimina el almacén de credenciales de copia de seguridad actual. En caso de que ya no se use un almacén de credenciales de copia de seguridad, puede eliminarlo para liberar espacio de almacenamiento. **Eliminar** sólo está habilitado después de eliminar todos los servidores registrados del almacén.
    - **Almacén de credenciales**. Use este elemento del menú de vista rápida para configurar las credenciales de almacén.

4. Haga clic en **elementos protegidos** para ver los elementos que se han hecho copias de los servidores. Esta lista solo tiene propósitos informativos.
