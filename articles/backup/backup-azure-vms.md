<properties
	pageTitle="Copia de seguridad de máquinas virtuales de Azure | Microsoft Azure"
	description="Procedimientos para realizar una copia de seguridad de una máquina virtual de Azure."
	services="backup"
	documentationCenter=""
	authors="Jim-Parker"
	manager="jwhit"
...
Este artículo proporciona los procedimientos para realizar la copia de seguridad de máquinas virtuales de Azure, a fin de protegerlas de acuerdo con las directivas de retención y copia de seguridad de su empresa.
...
Una máquina virtual de Azure se registra para asociarla al servicio Copia de seguridad de Azure. El registro suele ser una actividad que solo se realiza una vez.
...
4. En el menú contextual **Elementos registrados**, elija las máquinas virtuales que desea registrar. Si hay dos o más máquinas virtuales con el mismo nombre, use el servicio en la nube para distinguirlas.
    ...
    Se crea un trabajo para cada máquina virtual que seleccionó.
...
3. Haga clic en **PROTEGER**, en la parte inferior de la página.
    ...
    Se abrirá el **Asistente para protección de elementos**. El asistente solo muestra las máquinas virtuales que están registradas, pero no protegidas. Aquí es donde selecciona las máquinas virtuales que desea proteger.
...
4. Elija una **programación de copia de seguridad** para hacer una copia de seguridad de las máquinas virtuales que seleccionó. Puede seleccionar una directiva de un conjunto existente o definir una nueva.
    ...
    >[AZURE.NOTE]Una directiva de copia de seguridad incluye un esquema de retención de las copias de seguridad programadas. Si selecciona una directiva de copia de seguridad, no podrá modificar las opciones de retención en el paso siguiente.
...
5. Elija un **intervalo de retención** para asociarlo a las copias de seguridad.
    ...
    Se crea un trabajo para configurar la directiva de protección y asociar las máquinas virtuales a esa directiva para cada máquina virtual que seleccionó.
...
1. Haga clic en el botón **Realizar copia de seguridad ahora** en la parte inferior de la página **Elementos protegidos**.
...
Una vez completada la copia de seguridad inicial, el estado de la máquina virtual en la pestaña **Elementos protegidos** será *Protegido*.
