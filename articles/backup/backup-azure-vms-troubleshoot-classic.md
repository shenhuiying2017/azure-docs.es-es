...
| Copia de seguridad | No se pudo realizar la operación debido a que no existe la máquina virtual. | No se puede realizar la copia de seguridad, ya que se ha eliminado la máquina virtual configurada para dicha copia de seguridad. Detenga las futuras copias de seguridad accediendo a la vista de elementos de copia de seguridad (Configuración > Elementos de copia de seguridad > haga clic en el nombre del elemento) y seleccione Detener copia de seguridad. Puede conservar los datos seleccionando la opción correspondiente. Más adelante, puede reanudar la protección de esta máquina virtual haciendo clic en Reanudar copia de seguridad.|
