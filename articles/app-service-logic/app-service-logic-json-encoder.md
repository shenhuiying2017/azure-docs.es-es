...
El codificador JSON de BizTalk puede usarse como una acción. No tiene ningún desencadenador.
...
- Haga clic en ->
	...
	![Lista de acciones][4]
- El codificador JSON de BizTalk admite solo una acción. Seleccione *Xml to JSON* (XML a JSON)
