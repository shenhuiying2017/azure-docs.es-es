...
3.	Configure el conector de Bus de servicio de Azure de la forma siguiente:
	...
	- **Nombre**: asigne un nombre al conector de Bus de servicio de Azure
	- **Configuración del paquete**
		- **Cadena de conexión**: la cadena de conexión para el Bus de servicio de Azure. Ejemplo: Extremo=sb://[espacio de nombres].servicebus.windows.net;SharedAccessKeyName=[nombre];SharedAccessKey=[clave]
		- **Nombre de la entidad**: el nombre de la cola o tema
		- **Nombre de suscripción**: el nombre de la suscripción para recibir mensajes. 
