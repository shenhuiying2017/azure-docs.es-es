---
title: Uso del conector del bus de servicio de Azure en Aplicaciones lógicas | Microsoft Docs
...
> [!NOTE]
> Esta versión del artículo se aplica a la versión de esquema 2014-12-01-preview de las aplicaciones lógicas. Para la versión de esquema 2015-08-01-preview, haga clic en [API de Bus de servicio](../connectors/connectors-create-api-servicebus.md).
> 
> 
