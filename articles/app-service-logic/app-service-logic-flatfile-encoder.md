...
1. Seleccione el componente "Esquemas" ![Elemento Esquemas del Codificador de archivos sin formato de BizTalk][2].
2. Luego, seleccione "Agregar nuevo" en la hoja Esquemas que se abre ![Lista de acciones del Codificador de archivos sin formato de BizTalk][7].
3. Seleccione una de las tres opciones para proporcionar el esquema. Las opciones son CARGAR NUEVO ESQUEMA, GENERAR DESDE JSON Y GENERAR DESDE ARCHIVO SIN FORMATO ![Lista de acciones del Codificador de archivos sin formato de BizTalk][8].
4. Siga los pasos para proporcionar el esquema, según la selección realizada en el paso anterior. Verá que el esquema se ha cargado: ![Lista de acciones del Codificador de archivos sin formato de BizTalk][9]
