...
El conector de Chatter le permite conectarse a Chatter y realizar tareas comunes, como publicar un mensaje. Por ejemplo, puede buscar una fuente de Chatter y cuando encuentre algo específico, puede publicar ese mensaje de Chatter en un grupo de ventas.

Puede agregar el conector Chatter a sus datos de flujo de trabajo y empresarial y datos de proceso como parte de este flujo de trabajo.
