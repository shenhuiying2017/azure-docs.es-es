...
* [Crear un contenedor de Funciones de Azure](https://ms.portal.azure.com/#create/Microsoft.FunctionApp "Crear un contenedor de Funciones de Azure")  
...
* [Más información sobre las asignaciones](app-service-logic-enterprise-integration-maps.md "Información sobre las asignaciones de Enterprise Integration")  
