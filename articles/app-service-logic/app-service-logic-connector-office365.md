---
title: Uso del conector de Office 365 en aplicaciones lógicas | Microsoft Docs
...
> [!NOTE]
> Esta versión del artículo se aplica a la versión de esquema 2014-12-01-preview de las aplicaciones lógicas. Para la versión de esquema 2015-08-01-preview, haga clic en [API de Outlook de Office 365](../connectors/connectors-create-api-office365-outlook.md) o [API de usuarios de Office 365](../connectors/connectors-create-api-office365-users.md).
> 
> 
...
5. Conectarse a Office 365 requiere autorizar la aplicación lógica para poder acceder a su cuenta. Haga clic en "Autorizar" para proporcionar las credenciales de inicio de sesión de Office 365: ![][5]
6. Se le redirigirá a la página de inicio de sesión de Office 365 y podrá autenticarse con las credenciales de su cuenta de Office 365: ![][6] ![][7]
7. Una vez completada la autorización, se muestran los desencadenadores de Office 365: ![][8]
8. Seleccione el desencadenador "Nuevo correo electrónico" y se mostrarán todos los parámetros de entrada.
9. Cambie la frecuencia del desencadenador a 'Minutos' y haga clic en ✓: ![][9]
10. El desencadenador 'Nuevo correo electrónico' de Office 365 está configurado, y puede ver también los parámetros de salida: ![][10]
11. Seleccione "Conector de Office 365" en la sección "Usados recientemente" en la galería y se agregará una nueva acción de "Office 365".
12. Seleccione "Enviar evento" en la lista de acciones y se mostrarán los parámetros de entrada de la acción "Enviar evento": ![][11]
13. Especifique los detalles del evento y haga clic en ✓: ![][12]
14. Seleccione "Conector de Office 365" en la sección "Usados recientemente" en la galería y se agregará una nueva acción de "Office 365".
15. Seleccione "Agregar contacto" en la lista de acciones y se mostrarán los parámetros de entrada de la acción "Agregar contacto": ![][13]
16. Haga clic en '+' junto al campo 'Dirección de correo electrónico' y seleccione el valor de campo de salida 'Desde' del desencadenador: ![][14]
17. Haga clic en ✓ y la configuración de la acción se habrá completado: ![][15]
18. Seleccione "Conector de Office 365" en la sección "Usados recientemente" en la galería y se agregará una nueva acción de "Office 365".
19. Seleccione "Enviar correo electrónico" en la lista de acciones y se mostrarán los parámetros de entrada de la acción "Enviar correo electrónico": ![][19]
20. Proporcione los detalles necesarios para enviar el correo electrónico. Puede crear un mensaje escribiendo algo como aparece a continuación. Cuando la acción 'Enviar correo electrónico' esté configurada, haga clic en ✓:
    
     Body - @concat('You got a new sales enquiry from',triggers().output.body.From)
    
    ![][20]
21. Seleccione "Conector de Office 365" en la sección "Usados recientemente" en la galería y se agregará una nueva acción de "Office 365".
22. Seleccione "Responder a" en la lista de acciones y se mostrarán los parámetros de entrada de la acción "Responder a": ![][16]
23. Haga clic en '+' junto al campo 'Desde' y seleccione el valor del identificador de mensaje de salida del desencadenador, y, después, haga clic en ✓: ![][17]
24. Haga clic en Aceptar en la pantalla del editor de Aplicación lógica y, a continuación, haga clic en ’Crear’. Se tardará aproximadamente 30 segundos en completar la creación.
25. Envíe un correo electrónico a la cuenta que configuró con el desencadenador. Debería ver un correo electrónico en su cuenta de correo personal y eventos del calendario y contactos en la cuenta de correo de la empresa. Además, obtendrá una respuesta en la que se le indicará que se responderá a las consultas sobre ventas en breve.
