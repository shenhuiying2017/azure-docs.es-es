---
title: Conexión a la puerta de enlace de datos local de las Aplicaciones lógicas | Microsoft Docs
...
> [!WARNING]
> Actualmente existe una limitación, y es que la instalación de la puerta de enlace local solo se realizará mediante una cuenta que se haya registrado con Power BI. Mientras tanto, registre cualquier cuenta con "Power BI (gratis)" para completar la instalación correctamente.
> 
> 
...
4. Complete la información para asociar la puerta de enlace a su cuenta (lo que incluye seleccionar el **nombre de la instalación** pertinente).
...
2. Seleccione la casilla **Connect via on-premises data gateway** (Conectarse a través de la puerta de enlace de datos local).
