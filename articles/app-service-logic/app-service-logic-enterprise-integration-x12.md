...
> [!NOTE]
> Esta página abarca las características de X12 de Logic Apps. Para más información sobre EDIFACT, haga clic [aquí](app-service-logic-enterprise-integration-edifact.md).
> 
> 
...
1. Escriba *integration* en el cuadro de búsqueda del filtro; después, seleccione **Cuentas de integración** en la lista de resultados. ![](./media/app-service-logic-enterprise-integration-x12/x12-1-3.png)
2. En la hoja **Cuentas de integración** que se abre, seleccione la cuenta de integración en la que va a crear el acuerdo. Si no ve ninguna lista con cuentas de integración, [cree una antes](app-service-logic-enterprise-integration-accounts.md "Todo sobre las cuentas de integración"). ![](./media/app-service-logic-enterprise-integration-x12/x12-1-4.png)
3. Seleccione el icono **Acuerdos**. Si no lo ve, agréguelo antes. ![](./media/app-service-logic-enterprise-integration-x12/x12-1-5.png)
4. Seleccione el botón **Agregar** en la hoja Acuerdos que se abre. ![](./media/app-service-logic-enterprise-integration-agreements/agreement-2.png)
5. Escriba un **nombre** para el acuerdo; después, seleccione **Tipo de contrato**, **Asociado del host**, **Identidad del host**, **Asociado invitado**, **Identidad del invitado** en la hoja Acuerdos que se abre. ![](./media/app-service-logic-enterprise-integration-x12/x12-1.png)
6. Cuando haya establecido las propiedades de configuración de recepción, seleccione el botón **Aceptar**. Continuemos:
...
1. Seleccione el icono de **Acuerdos** de la hoja Cuenta de integración; verá en la lista el acuerdo que acaba de agregar. ![](./media/app-service-logic-enterprise-integration-x12/x12-7.png)
