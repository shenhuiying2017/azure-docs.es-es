...
Cuando haya [creado una cuenta de integración](app-service-logic-enterprise-integration-accounts.md) y [agregado los asociados](app-service-logic-enterprise-integration-partners.md), podrá generar un contrato de X12 siguiendo estos pasos:  
