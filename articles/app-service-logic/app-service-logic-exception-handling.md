...
1. La condición de **Filter Array** es cualquier elemento de `@result()` cuyo estado sea igual a `Failed`.  Esto filtra la matriz de todos los resultados de acción de `My_Scope` por solo una matriz de resultados de acción con error.
