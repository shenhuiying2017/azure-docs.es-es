...
Para la plantilla completa, consulte [Aplicación lógica con una plantilla de aplicación de API](https://github.com/tfitzmac/AppServiceTemplates/blob/master/LogicAppAndAPIApp.json).
