---
title: Uso del conector de SQL en Aplicaciones lógicas | Microsoft Docs
...
> [!NOTE]
> Esta versión del artículo se aplica a la versión de esquema 2014-12-01-preview de las aplicaciones lógicas. Para la versión de esquema 2015-08-01-preview de SQL Azure, haga clic en [API de SQL Azure](../connectors/connectors-create-api-sqlazure.md).
> 
> 
...
> [!NOTE]
> El esquema devuelto por esta instrucción identifica las propiedades disponibles en el conector. Todas las columnas deben tener nombres.
> 
> 
...
> [!NOTE]
> Este paso solo es necesario si está utilizando SQL Server local detrás del firewall.
> 
> 
