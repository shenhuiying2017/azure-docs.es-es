...
User Name | Sí | Escriba un nombre de usuario con el que puede iniciar sesión en el servidor SQL Server. Si se conecta a un servidor SQL Server local, escriba dominio\nombre de usuario. 
