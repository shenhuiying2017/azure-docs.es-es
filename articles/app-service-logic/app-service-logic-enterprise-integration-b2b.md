...
5. Seleccione la acción **AS2 - Decode AS2 message** (AS2: descodificar mensaje AS2). ![](./media/app-service-logic-enterprise-integration-b2b/b2b-6.png)
...
8. Ahora, agregue la acción Decode X12 message (Descodificar mensaje X12) seleccionando de nuevo **Agregar una acción**. ![](./media/app-service-logic-enterprise-integration-b2b/b2b-9.png)
9. Escriba la palabra **x12** en el cuadro de búsqueda para filtrar todas las acciones que quiera usar. ![](./media/app-service-logic-enterprise-integration-b2b/b2b-10.png)
10. Seleccione la acción **X12 - Decode X12 message** (X12: descodificar mensaje X12) que va a agregar a la Aplicación lógica ![](./media/app-service-logic-enterprise-integration-b2b/b2b-as2message.png)
...
13. Agregar la acción **Respuesta** seleccionando **Agregar una acción**. ![](./media/app-service-logic-enterprise-integration-b2b/b2b-14.png)
14. Escriba la palabra **response** en el cuadro de búsqueda para filtrar todas las acciones que quiera usar. ![](./media/app-service-logic-enterprise-integration-b2b/b2b-15.png)
15. Seleccione la acción **Respuesta** para agregarla. ![](./media/app-service-logic-enterprise-integration-b2b/b2b-16.png)
16. Establezca el campo **CUERPO** de la respuesta mediante la expresión siguiente para acceder a la MDN de la salida de la acción **Decode X12 message** (Descodificar mensaje X12).
    
    @base64ToString(body('Decode\_AS2\_message')?['OutgoingMdn']?['Content'])

![](./media/app-service-logic-enterprise-integration-b2b/b2b-17.png)

1. Guarde el trabajo. ![](./media/app-service-logic-enterprise-integration-b2b/transform-5.png)
