---
title: Información y creación de una aplicación de API de reglas de BizTalk en la aplicación lógica | Microsoft Docs
...
5. En la nueva hoja que se abre, escriba la siguiente información:
   1. Nombre: proporcione un nombre para su aplicación de API de reglas
   2. Plan del Servicio de aplicaciones: seleccione o cree un nuevo plan del Servicio de aplicaciones
   3. Nivel de precios: elija el nivel de precios en el que desea que resida esta aplicación
   4. Grupo de recursos: seleccione o cree el grupo de recursos donde debe residir la aplicación
   5. Suscripción: seleccione la suscripción que desea usar
   6. Ubicación: elija la ubicación geográfica en la que desearía implementar la aplicación.
6. Seleccione *Crear*. En unos minutos su aplicación de API de reglas de BizTalk se habrá creado.
...
1. Seleccione "Agregar" para comenzar a agregar nuevas definiciones de vocabulario.
