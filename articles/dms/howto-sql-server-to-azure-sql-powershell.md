...
En el ejemplo siguiente se crea un servicio denominado *MyDMS* en el grupo de recursos *MyDMSResourceGroup*, que se encuentra en la región *Este de EE. UU.* mediante una subred virtual denominada *MySubnet*.
