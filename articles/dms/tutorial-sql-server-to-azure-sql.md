...
description: "En este artículo se describe información sobre cómo migrar bases de datos de instancias locales de SQL Server a SQL de Azure mediante Azure Database Migration Service."
services: dms
author: HJToland3
ms.author: jtoland
manager: jhubbard
...
> * Crear un proyecto de migración de Azure Database Migration Service
...
6.  Seleccione **AdventureWorks2012**, elija **Agregar**y, luego, seleccione **Start Assessment** (Iniciar evaluación).
...
7.  Seleccione **Siguiente** en **Connect to target server** (Conectar a servidor de destino), especifique los detalles de conexión de destino de la base de datos de Azure SQL Database, seleccione **Conectar** y, luego, elija la base de datos **AdventureWorks2012** que había aprovisionado previamente en Azure SQL Database.
...
1.  Inicie sesión en Azure Portal, seleccione **+ Crear un recurso**, busque Azure Database Migration Service y, luego, seleccione **Azure Database Migration Service** en la lista desplegable.
...
3.  En la pantalla **Database Migration Service**, especifique un nombre para el servicio, la suscripción, una red virtual y el plan de tarifa.
    ...
    Para obtener más información sobre los costos y planes de tarifa, vea la página de precios.
