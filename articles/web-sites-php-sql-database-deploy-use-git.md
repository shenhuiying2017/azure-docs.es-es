...
Ahora puede navegar a **http://localhost/registration/index.php** para probar la aplicación.
...
3. Vaya a **http://[nombre del sitio].azurewebsites.net/index.php** para comenzar a usar la aplicación.
