<properties pageTitle="Creación de una máquina virtual que ejecuta Linux en Azure" description="Aprenda a crear una máquina virtual de Azure que ejecuta Linux utilizando una imagen de Azure." services="virtual-machines" documentationCenter="" authors="KBDAzure" manager="timlt" editor="tysonn"/>
...
> [AZURE.NOTE] Aunque no es necesario que tenga experiencia con máquinas virtuales de Azure para completar este tutorial, sí necesita una cuenta de Azure. Puede crear una cuenta de evaluación gratuita en pocos minutos. Para obtener más información, consulte [Creación de una cuenta de Azure](http://www.windowsazure.com/es-es/develop/php/tutorials/create-a-windows-azure-account/). 
