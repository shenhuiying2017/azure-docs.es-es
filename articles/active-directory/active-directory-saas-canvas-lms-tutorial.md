<properties pageTitle="Tutorial: Integración de Azure Active Directory con Canvas LMS | Microsoft Azure" description="Aprenda cómo usar Canvas LMS con Azure Active Directory para habilitar el inicio de sesión único, el aprovisionamiento automatizado, etc." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Tutorial: integración de Azure Active Directory con Canvas LMS
>[AZURE.TIP]Para enviar comentarios, haga clic [aquí](http://go.microsoft.com/fwlink/?LinkId=524182).
...
7.  En el panel de navegación izquierdo, seleccione **Autenticación** y, a continuación, haga clic en **Agregar nueva configuración de SAML**.
...
8.  En la página Curent Integration (integración actual) realice los siguientes pasos:
    ...
    2.  En el portal de Azure, en la página de diálogo **Configurar inicio de sesión único en Canvas**, copie el valor de **Dirección URL del inicio de sesión remoto** y péguelo en el cuadro de texto **Dirección URL de inicio de sesión**.
    3.  En el portal de Azure, en la página de diálogo **Configurar inicio de sesión único en Canvas**, copie el valor de **Dirección URL del inicio de sesión remoto** y péguelo en el cuadro de texto **Dirección URL de cierre de sesión**.
...
5.  En la página de diálogo Agregar nuevo usuario, realice los pasos siguientes:
    ...
    2.  En el cuadro de texto **Correo electrónico**, escriba la dirección de correo electrónico del usuario.
    3.  En el cuadro de texto **Inicio de sesión**, escriba la dirección de correo electrónico de Azure AD del usuario.
    4.  Seleccione **Enviar correo electrónico al usuario sobre la creación de esta cuenta**.
