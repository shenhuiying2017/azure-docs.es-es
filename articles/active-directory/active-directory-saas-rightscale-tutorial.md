...
4. **[Creación de un usuario de prueba de RightScale](#creating-a-rightscale-test-user)**: para tener un homólogo de Britta Simon en RightScale que esté vinculado a la representación de ella en Azure AD.
...
5. En la página **Configurar inicio de sesión único en RightScale**, lleve a cabo estos pasos y haga clic en **Siguiente**:
...
5. Para configurar SSO para la aplicación, debe iniciar sesión en su inquilino de RightScale como administrador.
