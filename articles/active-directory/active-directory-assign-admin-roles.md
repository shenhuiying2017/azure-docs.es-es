...
- **Administrador de servicios**: administra las solicitudes de servicio y supervisa el estado del servicio.
    > [AZURE.NOTE]
    > Para asignar el rol de administrador del servicio a un usuario, el administrador global debe asignar antes permisos administrativos al usuario en el servicio, como Exchange Online y, a continuación, asignar el rol de administrador del servicio al usuario en el Portal de administración de Azure. 
