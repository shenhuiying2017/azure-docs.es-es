...
5.	Una vez completado, vuelva a las ventanas del explorador que muestran el Portal de Azure clásico, haga clic en la casilla para confirmar que completó el procedimiento y, finalmente, haga clic en **Siguiente** y **Completar**.
