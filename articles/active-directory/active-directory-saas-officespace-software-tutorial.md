...
> [!NOTE]
> Puede usar cualquier otra API o herramienta de creación de cuentas de usuario de OfficeSpace Software ofrecida por OfficeSpace Software para aprovisionar cuentas de usuario de AAD.
> 
> 
