...
|Permitir los siguientes sitios web si la seguridad mejorada de IE está habilitada|Si la seguridad mejorada de IE está habilitada en el servidor que va a tener instalado el agente, es preciso permitir los siguientes sitios web.</br></br><li>https://login.microsoftonline.com</li><li>https://secure.aadcdn.microsoftonline-p.com</li><li>https://login.windows.net</li><li>El servidor de federación de la organización en el que confía Azure Active Directory, por ejemplo: https://sts.contoso.com</li>
