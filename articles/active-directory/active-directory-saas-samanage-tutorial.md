...
## Adición de Samanage desde la galería
...
4.  Haga clic en **Agregar** en la parte inferior de la página.
    ...
    ![Agregar aplicación](./media/active-directory-saas-samanage-tutorial/tutorial_general_03.png "Agregar aplicación")
...
Esta relación de vínculo se establece mediante la asignación del valor del **nombre de usuario** en Azure AD como valor de **Username** (Nombre de usuario) en Samanage.
...
3. **[Creación de un usuario de prueba de Samanage](#creating-a-Samanage-test-user)**: para tener un homólogo de Britta Simon en Samanage que esté vinculado a la representación de ella en Azure AD.
...
3.  En la página de diálogo Configurar las opciones de la aplicación, siga estos pasos:
    ...
    a. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL con el siguiente patrón: `https://<Company Name>.samanage.com/saml_login/<Company Name>`.
	
	b. Haga clic en **Siguiente**.

	> [AZURE.NOTE] Tenga en cuenta que estos no son valores reales. Tendrá que actualizar estos valores con la dirección URL de inicio de sesión real. Para obtener estos valores, consulte el paso 8.c o póngase en contacto con Samanage.
...
8.  Navegue hasta la sección **Login using SAML** (Iniciar sesión con SAML), realice los pasos siguientes:
    ...
    ![Inicio de sesión mediante SAML](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_003.png "Inicio de sesión mediante SAML")

    a. Haga clic en **Enable Single Sign-On with SAML** (Habilitar inicio de sesión único con SAML).

    b. En el cuadro de texto **Identity Provider URL** (Dirección URL de proveedor de identidades), coloque el valor de **Id. de proveedor de identidad** del Asistente para configuración de aplicaciones de Azure AD.

    c. Confirme que el valor de **Login URL** (Dirección URL de inicio de sesión) coincide con el de **URL de inicio de sesión** del paso 3.

	d. En el cuadro de texto **Logout URL** (Dirección URL de cierre de sesión), coloque el valor de **Dirección URL de cierre de sesión remoto** del Asistente para configuración de aplicaciones de Azure AD.
...
### Creación de un usuario de prueba en Samanage
...
2.  Haga clic en **Dashboard** (Panel) y seleccione **Setup** (Configuración) en el panel de navegación izquierdo.
    ...
    ![Configuración](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_001.png "Configuración")
...
5.  Escriba el **nombre** y la **dirección de correo electrónico** de la cuenta de Azure AD que desee aprovisionar y haga clic en **Create user** (Crear usuario).

    ![Crear usuario](./media/active-directory-saas-samanage-tutorial/tutorial_samanage_008.png "Crear usuario")

	>[AZURE.NOTE]El titular de la cuenta de AAD recibirá un mensaje de correo y seguirá un vínculo para confirmar su cuenta para que se active. Puede usar cualquier otra API o herramienta de creación de cuentas de usuario de Samanage que proporcione Samanage para aprovisionar cuentas de usuario de AAD.
