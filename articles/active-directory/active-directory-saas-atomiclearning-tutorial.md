<properties
	pageTitle="Tutorial: integración de Azure Active Directory con Atomic Learning | Microsoft Azure"
...
# Tutorial: integración de Azure Active Directory con Atomic Learning
...
## Adición de Atomic Learning desde la galería
...
Para que el inicio de sesión único funcione, Azure AD debe saber cuál es el usuario homólogo de Atomic Learning para un usuario de Azure AD. Es decir, es necesario establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Atomic Learning. Esta relación de vínculo se establece mediante la asignación del valor del **nombre de usuario** en Azure AD como el valor del **nombre de usuario** en Atomic Learning.
...
4. **[Creación de un usuario de prueba de Atomic Learning](#creating-an-atomic-learning-test-user)**: para tener un homólogo de Britta Simon en Atomic Learning que esté vinculado a la representación de ella en Azure AD.
...
### Creación de un usuario de prueba de Atomic Learning
