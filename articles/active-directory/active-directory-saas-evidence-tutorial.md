...
6.  En el panel de resultados, seleccione **Evidence.com** y haga clic en **Completar** para agregar la aplicación.
...
2.  En la siguiente pantalla, seleccione **Inicio de sesión único de Microsoft Azure AD** y haga clic en **Siguiente**.

3.  En la pantalla Configurar dirección URL de la aplicación, escriba la dirección URL donde los usuarios iniciarán sesión en la dirección URL de inquilino de Evidence.com (ejemplo: ) y haga clic en **Siguiente**. 
...
6.  Haga clic en **Agency Single Sign On**
 
7.  Seleccione **SAML Based Single Sign On**
 
8.  Copie los valores de **URL del emisor**, **Inicio de sesión único** y **Cierre de sesión único** que se muestran en el Portal de Azure clásico y en los campos correspondientes en Evidence.com.
