...
9. En la página **Configurar dirección URL de la aplicación** , realice los pasos siguientes:
    ...
    b. En el cuadro de texto **URL de respuesta de TOPdesk – Public**, pegue la **dirección URL de AssertionConsumerService de TOPdesk - Public** (por ejemplo, "*https://qssolutions.topdesk.net/tas/public/login/saml*")
...
3. En el cuadro de diálogo Nueva persona, realice los pasos siguientes:
    ...
    b. En el cuadro de texto Apellido, escriba el apellido de una cuenta válida de Azure Active Directory que quiera aprovisionar.
