...
3. Visite **Seguridad de aplicaciones** y establezca nativo en la característica **Inicio de sesión único**.
...
1. En el Portal de Azure clásico, seleccione la confirmación de configuración de inicio de sesión único y, luego, haga clic en **Completar** para cerrar el cuadro de diálogo **Configurar inicio de sesión único**.
