...
* Puede permitir que los usuarios inicien sesión automáticamente en Synergi mediante inicio de sesión único (SSO) con sus cuentas de Azure AD.
...
* Una suscripción habilitada para el SSO en Synergi
...
En esta sección, configurará y probará el SSO de Azure AD con Synergi mediante un usuario de prueba llamado "Britta Simon".

Para que el SSO funcione, Azure AD debe saber cuál es el usuario homólogo en Synergi de un usuario de Azure AD. En otras palabras, es necesario establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Synergi.
...
Para configurar y probar el SSO de Azure AD con Synergi, es preciso completar los siguientes bloques de creación:
...
En esta sección, habilitará el SSO de Azure AD en el portal clásico y lo configurará en la aplicación Synergi.
...
3. En la página de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
  ...
  1. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL usada por los usuarios para iniciar sesión en la aplicación de Synergi con el siguiente patrón: **https://\<nombre_empresa\>.irmsecurity.com/sso/\<identificador_organización\>**. 
  2. click **Siguiente**
...
5. En la página de diálogo **Proporcione información sobre este usuario** , realice los pasos siguientes:
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-synergi-tutorial/create_aaduser_05.png) 
...
6. En la página de diálogo **Perfil de usuario** , realice los pasos siguientes:
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-synergi-tutorial/create_aaduser_06.png) 
...
### <a name="create-an-synergi-test-user"></a>Creación de un usuario de prueba de Synergi
