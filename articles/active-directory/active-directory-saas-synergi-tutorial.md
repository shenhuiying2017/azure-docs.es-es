...
3. En la página de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
    ...
    a. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL usada por los usuarios para iniciar sesión en la aplicación de Synergi con el siguiente patrón: **https://\<nombre_empresa\>.irmsecurity.com/sso/\<identificador_organización\>**.
...
5. En el cuadro de diálogo **Proporcione información sobre este usuario**, siga estos pasos:  ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-synergi-tutorial/create_aaduser_05.png) 
...
6. En el cuadro de diálogo **Perfil de usuario**, siga estos pasos: ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-synergi-tutorial/create_aaduser_06.png) 
...
### <a name="creating-an-synergi-test-user"></a>Creación de un usuario de prueba de Synergi
