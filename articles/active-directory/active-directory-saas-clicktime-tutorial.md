...
##Agregar ClickTime desde la galería
...
1.  En el Portal de Azure clásico, en la página de integración de la aplicación **ClickTime**, haga clic en **Configurar inicio de sesión único** para abrir el cuadro de diálogo **Configurar inicio de sesión único**.
    ...
    ![Habilitar el inicio de sesión único](./media/active-directory-saas-clicktime-tutorial/tic777277.png "Habilitar el inicio de sesión único")
...
2.  En la barra de herramientas de la parte superior, haga clic en **Compañía** y, luego, en **Contactos**.
    ...
    ![Contactos](./media/active-directory-saas-clicktime-tutorial/tic777282.png "Personas")
...
>[AZURE.NOTE] Puede usar cualquier otra API o herramienta de creación de cuentas de usuario de ClickTime ofrecida por ClickTime para aprovisionar cuentas de usuario de Azure AD.
