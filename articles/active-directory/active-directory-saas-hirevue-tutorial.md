...
# Tutorial: Integración de Azure Active Directory con HireVue
...
## Adición de HireVue desde la galería
...
7. En el panel de resultados, seleccione **HireVue** y después haga clic en **Completar** para agregar la aplicación.
...
3. **[Creación de un usuario de prueba de HireVue](#creating-a-predictix-price-reporting-test-user)**: para tener un homólogo de Britta Simon en HireVue que esté vinculado a la representación de ella en Azure AD.
...
2. En la página **¿Cómo desea que los usuarios inicien sesión en HireVue?**, seleccione **Inicio de sesión único de Azure AD** y después haga clic en **Siguiente**.
...
5. Para configurar el inicio de sesión único para su aplicación, póngase en contacto con el equipo de soporte técnico de HireVue en [samlsupport@hirevue.com](mailTo:samlsupport@hirevue.com) y proporcione lo siguiente:
...
5. En la página del cuadro de diálogo **Proporcione información sobre este usuario**, realice los pasos siguientes: ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-hirevue-tutorial/create_aaduser_05.png)
...
6.  En la página del cuadro de diálogo **Perfil de usuario**, realice los pasos siguientes: ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-hirevue-tutorial/create_aaduser_06.png)
...
### Creación de un usuario de prueba de HireVue
