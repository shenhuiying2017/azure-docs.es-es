<properties
	pageTitle="Tutorial: Integración de Azure Active Directory con Everbridge | Microsoft Azure"
...
# Tutorial: Integración de Azure Active Directory con Everbridge
...
## Incorporación de Everbridge desde la galería
...
7. En el panel de resultados, seleccione **Everbridge** y después haga clic en **Completar** para agregar la aplicación.
...
3. **[Creación de un usuario de prueba de Everbridge](#creating-a-everbridge-test-user)**: para tener un homólogo de Britta Simon en Everbridge que esté vinculado a su representación en Azure AD.
...
2. En la página **¿Cómo desea que los usuarios inicien sesión en Everbridge?**, seleccione **Inicio de sesión único de Azure AD** y después haga clic en **Siguiente**.
...
6. En el menú de la parte superior, haga clic en la pestaña **Settings** (Configuración) y seleccione **Single Sign-On** (Inicio de sesión único) en **Security** (Seguridad).
	...
	a. En el cuadro de texto **Name** (Nombre), escriba el nombre del proveedor de identidades (por ejemplo, el nombre de la compañía).
...
### Creación de un usuario de prueba para Everbridge

En esta sección, creará una usuaria llamada Britta Simon en Everbridge. Colabore con el equipo de soporte técnico de Everbridge a través de <mailto:support@everbridge.com> para agregar los usuarios a la plataforma Everbridge.
