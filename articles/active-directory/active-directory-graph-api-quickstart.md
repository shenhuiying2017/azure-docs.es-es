---
title: Guía de inicio rápido de la API Graph de Azure AD | Microsoft Docs
...
4. En el campo que se encuentra inmediatamente debajo de Post, escriba lo siguiente:
   ...
   > [!NOTE]
   > Sustituya & lt; el token de acceso & gt; por el token de acceso del directorio de Azure AD.
   > 
   > 
