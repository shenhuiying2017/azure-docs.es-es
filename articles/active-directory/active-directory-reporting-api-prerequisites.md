<properties
    pageTitle="Requisitos previos para acceder a la API de generación de informes de Azure AD | Microsoft Azure"
...
# Requisitos previos para acceder a la API de generación de informes de Azure AD 
...
5. Para el recurso **Azure Active Directory** de la sección de **permisos a otras aplicaciones**, haga clic en la lista desplegable **Permisos de aplicación** y seleccione **Leer datos de directorio**.
...
## Recopilar los valores de configuración del directorio
