...
El objetivo de este tutorial es mostrar cómo integrar Degreed con Azure Active Directory (Azure AD).  
...
2. En la página **How would you like users to sign on to Degreed** (¿Cómo desea que los usuarios inicien sesión en Degreed?), seleccione **Inicio de sesión único de Azure AD** y, después, haga clic en **Siguiente**.
...
Al hacer clic en el icono de Degreed en el panel de acceso, debería iniciar sesión automáticamente en su aplicación Degreed.
