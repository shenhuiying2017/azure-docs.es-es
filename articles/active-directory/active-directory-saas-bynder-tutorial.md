...
1. En la página **Configurar inicio de sesión único en Bynder**, realice los pasos siguientes y haga clic en **Siguiente**:
    ...
    b. Haga clic en **Next**.
2. Para configurar el inicio de sesión único para la aplicación, póngase en contacto con el equipo de soporte técnico de Bynder. Adjunte el archivo de metadatos descargado y compártalo con el equipo de Bynder para que le configure el inicio de sesión único.
