...
# Tutorial: Integración de Azure Active Directory con Bynder
...
7. En el panel de resultados, seleccione **Bynder** y luego haga clic en **Completar** para agregar la aplicación.
...
4. Si quiere configurar la aplicación en el **modo iniciado por el proveedor de servicios**, en la página de diálogo **Configurar las opciones de la aplicación**, haga clic en **"Mostrar la configuración avanzada (opcional)"** y después escriba la **URL de inicio de sesión** y haga clic en **Siguiente**.
	...
	a. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL con el siguiente patrón: `https://<company name>.getbynder.com/login/`
...
### Creación de un usuario de prueba de Bynder
