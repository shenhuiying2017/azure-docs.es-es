...
**Para agregar un propietario a un grupo desde el Portal de administración de Azure**
...
**Para quitar un propietario de un grupo desde el Portal de administración de Azure**
