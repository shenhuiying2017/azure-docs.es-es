<properties
	pageTitle="Administración de nombres de dominio personalizados en Azure Active Directory | Microsoft Azure"
...
-   [Managing custom domain names](active-directory-add-manage-domain-names.md) (Administración de nombres de dominio).
