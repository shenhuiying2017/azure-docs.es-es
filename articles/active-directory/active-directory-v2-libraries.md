...
- **Bibliotecas de middleware de servidor**: las utilizan las aplicaciones web para iniciar la sesión de un usuario y las API web para validar los tokens que se envían mediante clientes nativos u otros servidores.
...
## Bibliotecas de middleware de servidor compatibles de Microsoft
| Plataforma| Nombre de la biblioteca| Descargar | Código fuente | Muestra |
| :-: | :-: | :-: | :-: | :-: |
...
| .NET 4.x | Middleware de OWIN OAuth Bearer para ASP.Net | [Microsoft.Owin.Security.OAuth (NuGet)][ServerLib-Net4-Owin-Oauth-Lib] | [Proyecto de Katana (CodePlex)][ServerLib-Net4-Owin-Oauth-Repo] | [Ejemplo de la API web][ServerLib-Net4-Owin-Oauth-Sample] |
...
## Bibliotecas de middleware de servidores compatibles 
Próximamente


## Contenido relacionado
Consulte la [introducción a la versión 2.0 del modelo de aplicación de Azure AD v2][AAD-App-Model-V2-Overview] para obtener más información sobre el punto de conexión v2.0 de Azure AD.
...
[ServerLib-Net4-Owin-Oauth-Sample]: https://azure.microsoft.com/es-ES/documentation/articles/active-directory-v2-devquickstarts-dotnet-api/
...
[ServerLib-Node-Sample]: https://azure.microsoft.com/es-ES/documentation/articles/active-directory-v2-devquickstarts-node-web/
