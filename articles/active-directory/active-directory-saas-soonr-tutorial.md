...
2. Para obtener el SSO configurado para la aplicación, consulte la Guía de integración de SSO de Soonr Workplace o puede hacer referencia a los socios de integración para obtener más detalles.
...
> [!NOTE]
> Si necesita crear manualmente un usuario, es preciso que se ponga en contacto con el equipo de soporte técnico de Soonr Workplace.
> 
> 
