...
- Puede permitir que los usuarios inicien sesión automáticamente en Bridge mediante inicio de sesión único (SSO) con sus cuentas de Azure AD.
...
- Una suscripción habilitada para el SSO en Bridge
...
En esta sección, configurará y probará el SSO de Azure AD con Bridge mediante un usuario de prueba llamado "Britta Simon".

Para que el SSO funcione, Azure AD debe saber cuál es el usuario homólogo en Bridge de un usuario de Azure AD. Es decir, es necesario establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de Bridge.
...
En esta sección, habilitará el SSO de Azure AD en el portal clásico y lo configurará en la aplicación Bridge.
...
3. En la página de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
  ...
  1. En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL con el siguiente patrón: `https://<company name>.bridgeapp.com`.
  2. En el cuadro de texto **Identificador**, escriba una dirección URL con el siguiente patrón: `https://<company name>.bridgeapp.com`
...
### <a name="create-a-bridge-test-user"></a>Creación de un usuario de prueba de Bridge
...
En esta sección, habilitará a Britta Simon para que use el SSO de Azure concediéndole acceso a Bridge.
