<properties
	pageTitle="Tutorial: integración de Azure Active Directory con Deputy | Microsoft Azure"
...
# Tutorial: integración de Azure Active Directory con Deputy
...
## Adición de Deputy desde la galería
...
7. En el panel de resultados, seleccione **Deputy** y luego haga clic en **Completar** para agregar la aplicación.
...
3. **[Creación de un usuario de prueba de Deputy](#creating-a-deputy-test-user)**: para tener un homólogo de Britta Simon en Deputy que esté vinculado a la representación de ella en Azure AD.
...
2. En la página **¿Cómo desea que los usuarios inicien sesión en Deputy?**, seleccione **Inicio de sesión único de Azure AD** y luego haga clic en **Siguiente**.
...
3. En la página de diálogo **Configurar las opciones de la aplicación**, si desea configurar la aplicación en el **modo iniciado por el proveedor de identidades**, siga estos pasos y haga clic en **Siguiente**:
	...
	a. En el cuadro de texto **Identificador**, escriba una dirección URL con el siguiente patrón: `https://<your-subdomain>.<region>.deputy.com`.

    b. En el cuadro de texto **URL de respuesta**, escriba una dirección URL con el siguiente patrón: `https://<your-subdomain>.<region>.deputy.com/exec/devapp/samlacs`.
...
4. Si quiere configurar la aplicación en el **modo iniciado por el proveedor de servicios**, en la página de diálogo **Configurar las opciones de la aplicación**, haga clic en **"Mostrar la configuración avanzada (opcional)"** y después escriba la **URL de inicio de sesión** y haga clic en **Siguiente**.
	...
	a. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL con el siguiente patrón: `https://<your-subdomain>.<region>.deputy.com`.

	b. Haga clic en **Siguiente**.

	> [AZURE.NOTE] El sufijo de la región de Deputy es opcional o debe usar uno de los siguientes: au | na | eu |as |la |af |an |ent-au |ent-na |ent-eu |ent-as | ent-la | ent-af | ent-an
...
6. Vaya a la dirección URL siguiente: https://(your-subdomain).deputy.com/exec/config/system_config. Vaya a **Configuración de seguridad** y haga clic en **Editar**.
...
8. En esta página de **configuración de seguridad**, siga estos pasos.
	...
	b. Abra el certificado codificado en base 64 en el Bloc de notas, copie su contenido en el portapapeles y luego péguelo en el cuadro de texto **Certificado OpenSSL**.
	...
	d. En el cuadro de texto URL de SSO de SAM, reemplace `<your subdomain>` por el subdominio.

	e. En el cuadro de texto Dirección URL de inicio de sesión único de SAML, reemplace `<saml sso url>` por la URL de SSO de SAML que haya copiado desde el Portal de Azure clásico.
...
### Creación de usuario de prueba de Deputy
...
4.  Realice los pasos siguientes y haga clic en **Guardar e invitar**.
    ...
    a. En el cuadro de texto **Nombre**, escriba **Britta** y **Simon**.
	...
	>[AZURE.NOTE]El titular de la cuenta de AAD recibirá un mensaje de correo y seguirá un vínculo para confirmar su cuenta para que se active. Puede usar cualquier otra API o herramienta de creación de cuentas de usuario de Deputy que proporcione Deputy para aprovisionar cuentas de usuario de AAD.
