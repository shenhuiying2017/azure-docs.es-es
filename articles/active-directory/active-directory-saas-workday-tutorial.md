...
3. En la página **Configurar dirección URL de la aplicación**, realice los pasos siguientes y luego haga clic en **Siguiente**.
   ...
   > [!NOTE]
   > Su URL de respuesta debe tener un subdominio (por ejemplo, www, wd2, wd3, wd3-impl, wd5, wd5-impl). Usando algo como *http://www.myworkday.com* funciona, pero no *http://myworkday.com*.
   > 
   > 
