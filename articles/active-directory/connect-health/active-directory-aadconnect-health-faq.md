...
Azure AD Connect Health tiene una [instalación](active-directory-aadconnect-health-agent-install.md) para Azure Alemania. Todos los datos de los clientes de la nube en Alemania se conservan en la nube de Azure Alemania.
...
Nº La instalación de los agentes no requerirá que reinicie el servidor. Sin embargo, la instalación de algunos de los requisitos previos podría requerir el reinicio del servidor.
...
Nº Actualmente no se admite un mecanismo para especificar un nombre de usuario y una contraseña arbitrarios para la autenticación básica.
...
Azure AD Connect Health genera la alerta si no recibe todos los puntos de datos del servidor en las últimas dos horas. [Más información](active-directory-aadconnect-health-data-freshness.md).
