...
* Una suscripción habilitada para el inicio de sesión único (SSO) en AirWatch
...
## <a name="enable-the-application-integration-for-airwatch"></a>Habilitación de la integración de aplicaciones para AirWatch
