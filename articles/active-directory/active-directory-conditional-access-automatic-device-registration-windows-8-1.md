---
title: Configure el registro automático de dispositivos para dispositivos Windows 8.1 unidos a un dominio| Microsoft Docs
...
---
# <a name="configure-automatic-device-registration-for-windows-8.1-domain-joined-devices"></a>Configuración del registro automático de dispositivos para dispositivos Windows 8.1 unidos a un dominio
...
## <a name="configure-the-group-policy-for-your-windows-8.1-domain-joined-devices"></a>Configure la Directiva de grupo para sus dispositivos Windows 8.1 unidos a un dominio
...
## <a name="unregistering-your-windows-8.1-domain-joined-devices"></a>Anulación del registro de sus dispositivos Windows 8.1 unidos a un dominio
...
## <a name="event-viewer-&-errors-for-windows-8.1-domain-joined-devices"></a>Visor de eventos y errores para dispositivos Windows 8.1 unidos a un dominio
