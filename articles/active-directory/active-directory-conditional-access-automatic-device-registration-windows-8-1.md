---
title: "Configuración del registro automático de dispositivos para dispositivos Windows 8.1 unidos a un dominio| Microsoft Docs"
description: " Pasos para configurar una directiva de grupo para que los dispositivos con Windows 8.1 unidos a un dominio se registren automáticamente en Azure AD. "
...
---
# <a name="configure-automatic-device-registration-for-windows-81-domain-joined-devices"></a>Configuración del registro automático de dispositivos para dispositivos Windows 8.1 unidos a un dominio
...
## <a name="configure-the-group-policy-for-your-windows-81-domain-joined-devices"></a>Configure la Directiva de grupo para sus dispositivos Windows 8.1 unidos a un dominio
...
7. Seleccione el botón de opción Habilitado y, a continuación, haga clic en Aplicar. Haga clic en **OK**.
...
## <a name="unregistering-your-windows-81-domain-joined-devices"></a>Anulación del registro de sus dispositivos Windows 8.1 unidos a un dominio
...
* Opción 1: **anule el registro de un dispositivo Windows 8.1 unido a un dominio con Configuración de PC**
  ...
  2. Seleccione **Abandonar**.
     Este proceso debe repetirse para cada usuario del dominio que ha iniciado sesión en el equipo y se ha unido automáticamente al área de trabajo.
...
## <a name="event-viewer--errors-for-windows-81-domain-joined-devices"></a>Visor de eventos y errores para dispositivos Windows 8.1 unidos a un dominio
El registro de eventos de Windows de la máquina Windows 8.1 mostrará mensajes relacionados con el registro de dispositivos. Encontrará mensajes para eventos con éxito y sin éxito. 

El registro de eventos puede encontrarse en el Visor de eventos en **Registros de aplicaciones y servicios** > **Microsoft** > **Windows > Unión al área de trabajo**.
