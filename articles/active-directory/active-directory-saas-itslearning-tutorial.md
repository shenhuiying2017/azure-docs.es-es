...
- Puede controlar en Azure AD quién tiene acceso a itslearning.
...
1. Adición de itslearning desde la galería
...
4. En el cuadro de búsqueda, escriba **itslearning**.
...
5. En el panel de resultados, seleccione **itslearning** y luego haga clic en el botón **Agregar** para agregar la aplicación.
...
Para que el inicio de sesión único funcione, Azure AD debe saber cuál es el usuario homólogo de itslearning para un usuario de Azure AD. Es decir, es necesario establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de itslearning.

Para establecer la relación de vínculo, en itslearning, asigne el valor de **nombre de usuario** de Azure AD como valor de **nombre de usuario**.
...
3. **[Creación de un usuario de prueba de itslearning](#creating-an-itslearning-test-user)**: para tener un homólogo de Britta Simon en itslearning que esté vinculado a la representación de ella en Azure AD.
4. **[Asignación del usuario de prueba de Azure AD](#assigning-the-azure-ad-test-user)** : para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Testing Single Sign-On](#testing-single-sign-on)** : para comprobar si funciona la configuración.

### <a name="configuring-azure-ad-single-sign-on"></a>Configuración del inicio de sesión único de Azure AD

En esta sección, habilitará el inicio de sesión único de Azure AD en Azure Portal y configurará el inicio de sesión único en la aplicación itslearning.

**Para configurar el inicio de sesión único de Azure AD con itslearning, realice los pasos siguientes:**

1. En Azure Portal, en la página de integración de la aplicación **itslearning**, haga clic en **Inicio de sesión único**.
...
3. En la sección **Dominio y direcciones URL de itslearning**, lleve a cabo los pasos siguientes:

    ![Configurar inicio de sesión único](./media/active-directory-saas-itslearning-tutorial/tutorial_itslearning_url.png)

    a. En el cuadro de texto **URL de inicio de sesión**, escriba una URL como:
    | |
    |--| 
    | `https://www.itslearning.com/index.aspx`|
    | `https://us1.itslearning.com/index.aspx`|

    b. En el cuadro de texto **Identificador**, escriba una dirección URL como: `urn:mace:saml2v2.no:services:com.itslearning`
...
6. Para configurar el inicio de sesión único en el lado de **itslearning**, necesita enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de itslearning](mailto:support@itslearning.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
En esta sección, creará un usuario llamado Britta Simon en itslearning. Colabore con el [equipo de soporte técnico de cliente de itslearning](mailto:support@itslearning.com) para agregar los usuarios a la plataforma de itslearning. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.
...
**Para asignar Britta Simon a itslearning, realice los pasos siguientes:**
...
Al hacer clic en el icono de itslearning del Panel de acceso, debería entrar en la página de inicio de sesión de la aplicación itslearning. Haga clic en **Iniciar sesión con Windows Azure ACS1** para iniciar sesión correctamente en la aplicación.
