...
3. **[Creación de un usuario de prueba de Workstars](#create-a-workstars-test-user)**: para tener un homólogo de Britta Simon en Workstars que esté vinculado a su representación en Azure AD.
...
3. En la sección **Dominio y direcciones URL de Workstars**, lleve a cabo los pasos siguientes:
...
5. Haga clic en el botón **Guardar** .
    ...
    ![Botón Configurar inicio de sesión único](./media/active-directory-saas-workstars-tutorial/tutorial_general_400.png)

6. En la sección **Configuración de Workstars**, haga clic en **Configurar Workstars** para abrir la ventana **Configurar inicio de sesión**. Copie la **URL del servicio de inicio de sesión único de SAML, el identificador de entidad de SAML y la dirección URL de cierre de sesión** de la sección **Referencia rápida**.

    ![Configuración de Workstars](./media/active-directory-saas-workstars-tutorial/tutorial_workstars_configure.png) 

7. En otra ventana del explorador web, inicie sesión en su sitio de la compañía de Workstars como administrador.

8. En la barra de herramientas principal, haga clic en **Configuración**.

    ![Configuración de Workstars](./media/active-directory-saas-workstars-tutorial/tutorial_workstars_sett.png)

9. Vaya a **Iniciar sesión** > **Configuración**.
...
10. En la página **Configuración de inicio de sesión único (SAML)** , siga estos pasos:
