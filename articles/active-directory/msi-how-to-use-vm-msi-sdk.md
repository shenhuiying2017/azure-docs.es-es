...
[!INCLUDE[preview-notice](../../includes/active-directory-msi-preview-notice.md)] En este artículo se proporciona una lista de ejemplos de SDK que demuestran el uso de sus SDK de Azure respectivos con MSI.
...
- Para habilitar MSI en una máquina virtual de Azure, consulte [Configuración de una identidad de servicio administrada (MSI) en una máquina virtual con Azure Portal](msi-qs-configure-portal-windows-vm.md).
