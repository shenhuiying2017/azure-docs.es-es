...
1. En el panel de resultados, seleccione **HackerOne** y, luego, haga clic en **Completar** para agregar la aplicación.
...
1. En la página **Configurar inicio de sesión único en HackerOne**, lleve a cabo estos pasos y luego haga clic en **Siguiente**:
...
4. A continuación, vaya a **Autenticación** y haga clic en el botón **Agregar configuración de SAML**.
   
    ![Configurar inicio de sesión único](./media/active-directory-saas-hackerone-tutorial/tutorial_hackerone_003.png)
5. En el diálogo **Configuración de SAML**, realice los pasos siguientes:
