...
[DirSync con inicio de sesión único](https://msdn.microsoft.com/library/azure/dn441213.aspx): federe su entorno de Active Directory local con Azure AD mediante AD FS para proporcionar un inicio de sesión único.
