...
- Para obtener una lista completa de todas las actividades de auditoría, consulte [Referencia sobre actividades de auditoría de Azure AD](active-directory-reporting-activity-audit-reference.md)
