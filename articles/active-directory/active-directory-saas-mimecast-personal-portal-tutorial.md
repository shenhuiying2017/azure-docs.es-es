...
* Una suscripción habilitada para inicio de sesión único (SSO) en Mimecast Personal Portal
...
4. Haga clic en **Agregar** en la parte inferior de la página.
   ...
   ![Agregar aplicaciones](./media/active-directory-saas-mimecast-personal-portal-tutorial/IC749321.png "Agregar aplicaciones")
