<properties
	pageTitle="Tutorial: Integración de Azure Active Directory con &amp;frankly | Microsoft Azure"
...
# Tutorial: integración de Azure Active Directory con &frankly
...
## Adición de &frankly desde la galería
...
4. Si quiere configurar la aplicación en el **modo iniciado por el proveedor de servicios**, en la página de diálogo **Configurar las opciones de la aplicación**, haga clic en **"Mostrar la configuración avanzada (opcional)"** y después escriba la **URL de inicio de sesión** y haga clic en **Siguiente**.
	...
	a. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL con el siguiente patrón: `https://andfrankly.com/saml/okta/?saml_sso=<tenant id>`

	b. Haga clic en **Siguiente**.

	> [AZURE.NOTE] Tenga en cuenta que estos no son valores reales. Tendrá que actualizar estos valores con la dirección URL de inicio de sesión, el identificador y la dirección URL de respuesta reales. Póngase en contacto con [help@andfrankly.com](emailTo:help@andfrankly.com) para obtener esos valores.
...
6. Para obtener SSO configurado para su aplicación, póngase en contacto con el equipo de soporte de &frankly a través de [help@andfrankly.com](emailTo:help@andfrankly.com). Adjunte el archivo de metadatos descargado y compártalo con el equipo de &frankly para que le configure el inicio de sesión único.
...
### Crear un usuario de prueba de &frankly
