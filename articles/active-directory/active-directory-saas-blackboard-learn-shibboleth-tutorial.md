...
Esta relación de vínculo se establece mediante la asignación del valor del **nombre de usuario** en Azure AD como valor de **Username** en Blackboard Learn - Shibboleth.
...
2. En la página **How would you like users to sign on to Blackboard Learn - Shibboleth** (¿Cómo desea que los usuarios inicien sesión en Blackboard Learn - Shibboleth?), seleccione **Inicio de sesión único de Microsoft Azure AD** y haga clic en **Siguiente**.
...
3. En la página de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
    ...
    > [!NOTE]
    > Podrá encontrar todos estos valores en el documento de metadatos de federación que le proporcionó su asociado de Blackboard Learn.
    > 
    > 
...
5. En la página de diálogo **Proporcione información sobre este usuario** , realice los pasos siguientes:
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-blackboard-learn-shibboleth-tutorial/create_aaduser_05.png) 
...
6. En el cuadro de diálogo **Perfil de usuario**, siga estos pasos:  ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-blackboard-learn-shibboleth-tutorial/create_aaduser_06.png) 
...
### <a name="creating-an-blackboard-learn---shibboleth-test-user"></a>Creación de un usuario de prueba de Blackboard Learn - Shibboleth
