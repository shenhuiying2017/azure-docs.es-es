...
## <a name="enable-the-application-integration-for-teamseer"></a>Habilitación de la integración de aplicaciones para TeamSeer
El objetivo de esta sección es describir cómo se habilita la integración de aplicaciones en TeamSeer.

**Siga estos pasos con el fin de habilitar la integración de aplicaciones para TeamSeer:**
