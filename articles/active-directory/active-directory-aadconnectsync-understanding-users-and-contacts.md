...
- Independientemente del orden en el que leamos los directorios de Active Directory de origen, el resultado final siempre debe ser el mismo.
- Una cuenta activa siempre aporta información de inicio de sesión, **userPrincipalName** y **sourceAnchor** incluidos.
- Una cuenta deshabilitada aportará userPrincipalName y sourceAnchor, a menos que sea un buzón vinculado.
