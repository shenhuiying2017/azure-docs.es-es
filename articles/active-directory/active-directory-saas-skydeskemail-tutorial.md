...
3. En la página de diálogo **SAML Authentication** (Autenticación SAML), siga estos pasos:
   ...
   > [!NOTE]
   > Para usar la autenticación basada en SAML, o debe haber **comprobado el dominio** o configurado la **dirección URL del portal**. Puede configurar la dirección URL del portal con el nombre único.
   > 
   > 
