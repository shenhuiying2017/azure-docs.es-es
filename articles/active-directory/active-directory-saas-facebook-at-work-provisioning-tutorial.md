...
4. Establezca el **modo de aprovisionamiento** en **Automático**. 
    ...
    ![Aprovisionamiento](./media/active-directory-saas-facebook-at-work-provisioning-tutorial/provisioning.png)
