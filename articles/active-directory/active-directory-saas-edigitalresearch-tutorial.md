<properties
	pageTitle="Tutorial: integración de Azure Active Directory con eDigitalResearch | Microsoft Azure"
...
# Tutorial: integración de Azure Active Directory con eDigitalResearch
...
## Incorporación de eDigitalResearch desde la galería
...
7. En el panel de resultados, seleccione **eDigitalResearch** y, a continuación, haga clic en **Completar** para agregar la aplicación.
...
El objetivo de esta sección es mostrar cómo configurar y probar el inicio de sesión único de Azure AD con eDigitalResearch con una usuaria de prueba llamada "Britta Simon".
...
Para configurar y probar el inicio de sesión único de Azure AD con eDigitalResearch, es preciso completar los siguientes bloques de creación:
...
En esta sección, habilitará el inicio de sesión único de Azure AD en el portal clásico y configurará el inicio de sesión único en la aplicación eDigitalResearch.
...
2. En la página **¿Cómo desea que los usuarios inicien sesión en eDigitalResearch?**, seleccione **Inicio de sesión único de Azure AD** y después haga clic en **Siguiente**.
...
3. En la página de diálogo **Configurar las opciones de la aplicación**, realice los pasos siguientes y haga clic en **Siguiente**:
	...
	> [AZURE.NOTE] El valor de la dirección URL de respuesta de sesión de este tutorial es solo un marcador de posición. Para obtener el valor real para su entorno, póngase en contacto con eDigitalResearch.
...
### Creación de un usuario de prueba de eDigitalResearch
