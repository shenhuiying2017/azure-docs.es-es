...
Esta relación de vínculo se establece mediante la asignación del valor del **nombre de usuario** en Azure AD como el valor del **nombre de usuario** en Birst Agile Business Analytics.
...
1. En el Portal de Azure clásico, en la página de integración de la aplicación **Birst Agile Business Analytics**, haga clic en **Configurar inicio de sesión único** para abrir el cuadro de diálogo **Configurar inicio de sesión único**.
