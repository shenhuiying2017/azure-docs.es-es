<properties
	...
	description="Cómo crear una aplicación de una página Angular JS con la que los usuarios pueden iniciar sesión utilizando tanto la cuenta personal de Microsoft como sus cuentas profesionales o educativas."
...
# Vista previa del modelo de aplicaciones v2.0: agregar inicio de sesión a una aplicación de una página AngularJS

El tutorial de inicio rápido para aplicaciones AngularJS aún no está listo... Compruébelo de nuevo pronto y busque actualizaciones de @AzureAD en Twitter.
