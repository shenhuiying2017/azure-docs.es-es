...
3. **[Creación de usuarios de prueba de Showpad](#creating-a-showpad-test-user)** : para tener un homólogo de Britta Simon en Showpad que esté vinculado a la representación de ella en Azure AD.
...
1. En la página **Configurar inicio de sesión único en Showpad**, lleve a cabo estos pasos y luego haga clic en **Siguiente**:
...
2. Inicie la sesión en el inquilino de Showpad como administrador.
...
4. Vaya a **Inicio de sesión único** y haga clic en "**Habilitar**".
...
5. En el cuadro de diálogo **Agregar un servicio de SAML 2.0** , realice los pasos siguientes:
