...
4. En el cuadro de búsqueda, escriba **CS Stars**.

    ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-cs-stars-tutorial/tutorial_csstars_search.png)

5. En el panel de resultados, seleccione **CS Stars** y luego haga clic en el botón **Agregar** para agregar la aplicación.
...
3. **[Creación de un usuario de prueba de CS Stars](#creating-a-cs-stars-test-user)**: para tener un homólogo de Britta Simon en CS Stars que esté vinculado a la representación del usuario en Azure AD.
...
3. En la sección **Dominio y direcciones URL de CS Stars**, lleve a cabo los pasos siguientes:
...
<CS>
6. Para configurar el inicio de sesión único en **CS Stars**, necesita enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de CS Stars](http://www.marshclearsight.com/support/). 
<CE>
