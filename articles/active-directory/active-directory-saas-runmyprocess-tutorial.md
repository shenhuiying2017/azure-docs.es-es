...
8.  En la sección **Método de autenticación**, realice los pasos siguientes:
    ...
    2.  En el Portal de Azure clásico, en la página de diálogo **Configurar inicio de sesión único en RunMyProcess**, copie el valor de **Dirección URL de SAML SSO** y péguelo en el cuadro de texto **Redireccionamiento de SSO**.
