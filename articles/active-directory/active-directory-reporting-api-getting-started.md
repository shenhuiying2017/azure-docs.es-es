...
- Navegue hasta el [Portal de Azure clásico](https://manage.windowsazure.com/).
- Vaya al inquilino de Azure AD.
...
- En la sección "Permisos para otras aplicaciones":
	- En Azure Active Directory > Permisos de la aplicación, seleccione **Leer datos de directorio**.
...
El script enumera todos los informes disponibles y devuelve los resultados del informe AccountProvisioningEvents en la ventana de PowerShell en formato JSON. También crea archivos con la misma salida en JSON, texto y XML. Puede experimentar modificando el script para que devuelva datos de otros informes y convertir en comentario los formatos de salida que no necesite.
...
## Pasos siguientes
- ¿Tiene curiosidad sobre qué informes de seguridad, auditoría y actividad están disponibles? Consulte [Informes de actividad, auditoría y seguridad de Azure AD](active-directory-view-access-usage-reports.md).
...
- Consulte la página de la [versión preliminar de informes y eventos de Azure AD](https://msdn.microsoft.com/library/azure/ad/graph/howto/azure-ad-reports-and-events-preview) para obtener más detalles sobre el servicio REST de la API de Azure AD Graph.
