...
- Sitios con varios centros de datos conectadas entre sí en los que desea mantener tanto tráfico dentro del centro de datos como sea posible, y no utilizar vínculos entre centros de datos que suelen ser caros y tener una latencia elevada. Puede implementar conectores en cada centro de datos para servir solo las aplicaciones que residen en el centro de datos, guardar vínculos valiosos entre centros de datos y proporcionar una experiencia completamente transparente para los usuarios.
