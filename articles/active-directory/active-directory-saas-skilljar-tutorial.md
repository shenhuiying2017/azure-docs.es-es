...
4. En el cuadro de búsqueda, escriba **Skilljar**.

    ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-skilljar-tutorial/tutorial_skilljar_search.png)

5. En el panel de resultados, seleccione **Skilljar** y luego haga clic en el botón **Agregar** para agregar la aplicación.
...
Para establecer la relación de vínculo, en Skilljar, asigne el valor del **nombre de usuario** en Azure AD como valor del **nombre de usuario**.
...
En esta sección, habilitará el inicio de sesión único de Azure AD en Azure Portal y lo configurará en la aplicación Skilljar.

**Para configurar el inicio de sesión único de Azure AD con Skilljar, realice los pasos siguientes:**

1. En Azure Portal, en la página de integración de la aplicación **Skilljar**, haga clic en **Inicio de sesión único**.
...
3. En la sección **Dominio y direcciones URL de Skilljar**, lleve a cabo los pasos siguientes:
    ...
    b. En el cuadro de texto **Identificador**, escriba una dirección URL con el siguiente patrón: `https://<companyname>.skilljar.com/`

    > [!NOTE] 
    > Estos valores no son reales. Debe actualizarlos con la dirección URL y el identificador reales de inicio de sesión. Póngase en contacto con el [equipo de soporte técnico de Skilljar](http://support.skilljar.com/hc/) para obtener estos valores. 
...
6. Para configurar el inicio de sesión único en **Skilljar**, hay que enviar el **XML de metadatos** descargado y el **valor de formato de identificador de nombre urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress** al [equipo de soporte técnico de Skilljar](http://support.skilljar.com/hc/). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
>[!NOTE]
>Si necesita crear manualmente un usuario, es preciso que se ponga contacto con el [equipo de soporte técnico de Skilljar](http://support.skilljar.com/hc/). 
> 
