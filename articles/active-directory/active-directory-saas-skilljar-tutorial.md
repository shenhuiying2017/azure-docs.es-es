...
El objetivo de este tutorial es mostrar cómo integrar Skilljar con Azure Active Directory (Azure AD). Integrar Skilljar con Azure AD proporciona las siguientes ventajas:
...
7. En el panel de resultados, seleccione **Skilljar** y luego haga clic en **Completar** para agregar la aplicación.
...
3. **[Creación de un usuario de prueba de Skilljar](#creating-a-skilljar-test-user)**: para tener un homólogo de Britta Simon en Skilljar que esté vinculado a la representación de ella en Azure AD.
...
1. En la página **Configurar inicio de sesión único en Skilljar**, siga estos pasos:
    ...
    c. Haga clic en **Next**.
2. Para configurar el SSO para su aplicación, póngase en contacto con el equipo de soporte técnico de Skilljar por correo electrónico, incluya el valor del **Formato de identificador de nombre** del paso anterior y adjunte el archivo de metadatos descargado.
...
El objetivo de esta sección es permitir que Britta Simon use el inicio de sesión único de Azure concediéndole acceso a Skilljar.
