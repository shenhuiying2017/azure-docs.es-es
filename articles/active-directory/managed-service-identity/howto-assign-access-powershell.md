...
- Para habilitar MSI en una máquina virtual de Azure, consulte [Configuración de Managed Service Identity (MSI) de una máquina virtual de Azure con PowerShell](qs-configure-powershell-windows-vm.md).
