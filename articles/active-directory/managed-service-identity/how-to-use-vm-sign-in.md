...
Consulte [Servicios de Azure que admiten la autenticación de Azure AD](services-support-msi.md#azure-services-that-support-azure-ad-authentication) para ver una lista de recursos que admite Azure AD y que se han probado con la identidad de servicio administrada, y sus respectivos identificadores de recurso.
...
- Para habilitar la MSI en una máquina virtual de Azure, consulte [Configuración de una identidad de servicio administrada (MSI) en una máquina virtual con PowerShell](qs-configure-powershell-windows-vm.md) o [Configuración de una identidad de servicio administrada (MSI) en una máquina virtual con la CLI de Azure](qs-configure-cli-windows-vm.md)
