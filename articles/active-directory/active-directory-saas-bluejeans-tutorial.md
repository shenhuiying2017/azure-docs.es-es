...
* Una suscripción habilitada para inicio de sesión único (SSO) en BlueJeans
...
## <a name="enable-the-application-integration-for-bluejeans"></a>Habilitación de la integración de aplicaciones para BlueJeans
