...
# Tutorial: Integración de Azure Active Directory con BenSelect
...
## Adición de BenSelect desde la galería
...
Esta relación de vínculo se establece asignando el valor del **nombre de usuario** en Azure AD como el valor del **nombre de usuario** en BenSelect.
...
3. **[Creación de un usuario de prueba de BenSelect](#creating-a-benselect-test-user)**: para tener un homólogo de Britta Simon en BenSelect que esté vinculado a su representación en Azure AD.
...
4. En la página **¿Cómo desea que los usuarios inicien sesión en BenSelect?**, seleccione **Inicio de sesión único de Azure AD** y después haga clic en **Siguiente**.
...
7. Para que SSO se configure para su aplicación, póngase en contacto con el equipo de soporte técnico de BenSelect a través de [support@selerix.com](mailto:support@selerix.com) y especifique:
	...
	> [AZURE.NOTE] Debe mencionar que esta integración requiere el algoritmo SHA256 (no se admite SHA1) para establecer el SSO en el servidor apropiado, como app2101.
...
5. En la página del cuadro de diálogo **Proporcione información sobre este usuario**, realice los pasos siguientes: ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-benselect-tutorial/create_aaduser_05.png)
...
6.  En la página del cuadro de diálogo **Perfil de usuario**, realice los pasos siguientes: ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-benselect-tutorial/create_aaduser_06.png)
...
### Creación de un usuario de prueba de BenSelect
...
> [AZURE.NOTE] Si necesita crear manualmente un usuario, es preciso que se ponga contacto con el equipo de soporte técnico de BenSelect a través de <mailto:support@selerix.com>.
