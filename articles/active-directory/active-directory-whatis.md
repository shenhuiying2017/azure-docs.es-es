<properties
	...
	description="Utilice Azure Active Directory para ampliar sus identidades locales existentes en la nube o desarrollar aplicaciones integradas de Azure AD."
...
- [Inicio de sesión único](https://msdn.microsoft.com/library/azure/dn510976.aspx)
- [Informes y análisis](active-directory-view-access-usage-reports.md)
- [Autoservicio](http://aka.ms/ssproverview)
- [Aplicaciones locales](active-directory-application-proxy-configure.md)
- [Contrato de nivel de servicio](https://msdn.microsoft.com/library/azure/dn532272.aspx)
- [Administración de identidades](fundamentals-identity.md)
