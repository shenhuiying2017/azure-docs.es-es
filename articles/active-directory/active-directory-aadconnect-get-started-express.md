...
2. Vaya a **AzureADConnect.msi** y haga doble clic en él.
3. En la pantalla de bienvenida, active la casilla para aceptar los términos de licencia y haga clic en **Continuar**. ![Bienvenida a Azure AD Connect](./media/active-directory-aadconnect-get-started-express/welcome.png)
