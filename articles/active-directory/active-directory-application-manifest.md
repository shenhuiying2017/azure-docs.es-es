<properties
   ...
   description="Proporciona detalles adicionales sobre el manifiesto de aplicación de Azure AD, que acompaña a cada configuración de aplicación en un inquilino de Azure AD."
...
### Ejemplo paso a paso
Ahora vamos a recorrer los pasos necesarios para actualizar la configuración de identidad de la aplicación mediante el manifiesto de aplicación:

1. Navegue hasta el [Portal de Azure][AZURE-PORTAL] e inicie sesión con una cuenta que tenga privilegios de administrador o coadministrador de servicios.
...
Eso es todo. Ahora puede ejecutar la aplicación con la nueva configuración de aplicación, según los cambios realizados en el manifiesto.
