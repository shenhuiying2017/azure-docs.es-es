...
> [!NOTE]
> El portal de usuarios solo está disponible con el Servidor Multi-Factor Authentication. Si utiliza Multi-Factor Authentication en la nube, remita a sus usuarios a [Configuración de mi cuenta para la verificación en dos pasos](./../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-first-time.md) o [Administración de la configuración de la verificación en dos pasos](./../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-manage-settings.md).
...
6. Abra un explorador web desde cualquier equipo y vaya a la dirección URL donde se instaló el portal de usuario (por ejemplo, https://mfa.contoso.com/MultiFactorAuth). Asegúrese de que no aparezca ningún error ni advertencia de certificado.
