...
* **Admite el restablecimiento de contraseña de usuarios que usan la** [sincronización de hash de contraseñas](./../connect/active-directory-aadconnectsync-implement-password-hash-synchronization.md): cuando el servicio de restablecimiento de contraseña detecta que una cuenta de usuario sincronizada está habilitada para la sincronización de hash de contraseñas, la contraseña local y de la nube de la cuenta se restablecen al mismo tiempo. La escritura diferida de contraseñas no depende de la sincronización de hash de contraseñas.
