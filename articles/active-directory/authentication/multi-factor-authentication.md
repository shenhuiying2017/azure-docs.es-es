...
description: Qué es Azure Multi-Factor Authentication, por qué usar MFA y los distintos métodos y versiones disponibles.
...
- Lea [Cómo funciona Azure Multi-Factor Authentication](concept-mfa-howitworks.md).
