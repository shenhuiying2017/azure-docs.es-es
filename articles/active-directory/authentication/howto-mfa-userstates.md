...
Ambas opciones solicitan a los usuarios registrarse en Azure Multi-Factor Authentication la primera vez que inicien sesión después de activar los requisitos. Ambas opciones también funcionan con la [configuración de Azure Multi-Factor Authentication](howto-mfa-mfasettings.md).
...
El _acceso condicional_ es una característica de pago de Azure Active Directory, con muchas opciones de configuración. Estos pasos describen cómo crear una directiva. Para más información, consulte [Acceso condicional en Azure Active Directory](../active-directory-conditional-access-azure-portal.md).
...
- Obtener sugerencias sobre los [procedimientos recomendados para el acceso condicional](../active-directory-conditional-access-best-practices.md).

- Administrar la configuración de Azure Multi-Factor Authentication de [los usuarios y sus dispositivos](howto-mfa-userdevicesettings.md)
