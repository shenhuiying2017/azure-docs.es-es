...
Si los usuarios [tienen problemas con la verificación en dos pasos](./../../multi-factor-authentication/end-user/multi-factor-authentication-end-user-troubleshoot.md), ayúdelos a autodiagnosticar problemas. 
