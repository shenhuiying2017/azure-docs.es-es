...
* Una suscripción habilitada para el inicio de sesión único en FreshGrade
...
## <a name="add-freshgrade-from-the-gallery"></a>Adición de FreshGrade desde la galería
...
En esta sección, podrá configurar y probar el inicio de sesión único (SSO) de Azure AD con FreshGrade con un usuario de prueba llamado "Britta Simon".
...
3. En la página de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
  ...
  1. En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL con el siguiente patrón: `https://<your-subdomain>.freshgrade.com` o `https://<your-subdomain>.onboarding.freshgrade.com`.
  2. click **Siguiente**
4. En la página **Configurar inicio de sesión único en FreshGrade**, realice los pasos siguientes:
  ...
  3. Haga clic en **Descargar metadatos**y luego guarde el archivo en el equipo.
...
### <a name="create-a-azure-ad-test-user"></a>Creación de un usuario de prueba de Azure AD
...
5. En la página de diálogo **Proporcione información sobre este usuario** , realice los pasos siguientes:
    ...
    ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-freshgrade-tutorial/create_aaduser_05.png) 
  1. En Tipo de usuario, seleccione Nuevo usuario de la organización.
  2. En el cuadro de texto **Nombre de usuario**, escriba**BrittaSimon**.
  3. Haga clic en **Siguiente**.
6. En la página de diálogo **Perfil de usuario** , realice los pasos siguientes:

   ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-freshgrade-tutorial/create_aaduser_06.png) 
...
### <a name="create-a-freshgrade-test-user"></a>Creación de un usuario de prueba de FreshGrade
