<properties 
    pageTitle="Introducción a la autenticación basada en certificados en Android | Microsoft Azure" 
...
# Introducción a la autenticación basada en certificados en Android (versión preliminar pública)  
...
La versión del sistema operativo del dispositivo debe ser Android 5.0 (Lollipop) y posterior.
