...
* Una suscripción habilitada para el inicio de sesión único en TargetProcess
...
El objetivo de esta sección es habilitar el inicio de sesión único de Azure AD en el Portal de Azure clásico y configurar el inicio de sesión único en la aplicación TargetProcess. 
...
3. En la página de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
  ...
  1. En el cuadro de texto **Dirección URL de inicio de sesión**, escriba la dirección URL que los usuarios utilizan para iniciar sesión en la aplicación TargetProcess (p. ej.: *https://fabrikam.TargetProcess.com/*).
  2. Haga clic en **Siguiente**.
4. En la página **Configurar inicio de sesión único en TargetProcess** , siga estos pasos:
  ...
  2. Haga clic en **Siguiente**.
5. Inicie sesión en su aplicación TargetProcess como administrador.
...
8. Haga clic en **Inicio de sesión único**.
...
9. En el cuadro de diálogo Configuración de inicio de sesión único, siga estos pasos:
  ...
  1. Haga lic en **Habilitar inicio de sesión único**.
  2. En el Portal de Azure clásico, en la página **Configurar inicio de sesión único en TargetProcess**, copie el valor de **Dirección URL del servicio de inicio de sesión único** y péguelo en el cuadro de texto **URL de inicio de sesión**.
  3. Abra el certificado descargado en el Bloc de notas, copie el contenido y luego péguelo en el cuadro de texto **Certificado** .
  4. Haga clic en **Habilitar aprovisionamiento de JIT**.
