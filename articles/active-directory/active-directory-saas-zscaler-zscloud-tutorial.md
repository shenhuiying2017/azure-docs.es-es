<properties pageTitle="Tutorial: Integración de Azure Active Directory con Zscaler ZSCloud | Microsoft Azure" description="Aprenda cómo usar Zscaler ZSCloud con Azure Active Directory para habilitar el inicio de sesión único, el aprovisionamiento automatizado, etc." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Tutorial: Integración de Azure Active Directory con Zscaler ZSCloud
>[AZURE.TIP]Para enviar comentarios, haga clic [aquí](http://go.microsoft.com/fwlink/?LinkId=614878).
  
El objetivo de este tutorial es mostrar la integración de Azure y ZScaler ZSCloud. En la situación descrita en este tutorial se supone que ya cuenta con los elementos siguientes:
...
##Habilitación de la integración de aplicaciones para ZScaler ZSCloud
...
7.  En el panel de resultados, seleccione **ZScaler ZSCloud** y, luego, haga clic en **Completa** para agregar la aplicación.

    ![Zscaler ZSCloud](./media/active-directory-saas-zscaler-zscloud-tutorial/IC800277.png "Zscaler ZSCloud")

##Configuración del inicio de sesión único
  
El objetivo de esta sección es describir cómo se habilita la autenticación de los usuarios en ZScaler ZSCloud con su cuenta de Azure AD usando el protocolo SAML basado en la federación. Como parte de este procedimiento, es necesario cargar un certificado codificado en base 64 en su inquilino de ZScaler ZSCloud. Si no está familiarizado con este procedimiento, consulte [Conversión de un certificado binario en un archivo de texto](http://youtu.be/PlgrzUZ-Y1o).
...
2.  En la página **¿Cómo desea que los usuarios inicien sesión en ZScaler ZSCloud?**, seleccione **Inicio de sesión único de Microsoft Azure AD** y, luego , haga clic en **Siguiente**.
...
Para permitir que los usuarios de Azure AD inicien sesión en ZScaler ZSCloud, deben aprovisionarse a ZScaler ZSCloud. En el caso de ZScaler ZSCloud, el aprovisionamiento es una tarea manual.
