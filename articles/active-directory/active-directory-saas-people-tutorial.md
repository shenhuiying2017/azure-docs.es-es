...
* Puede permitir que los usuarios inicien sesión automáticamente en People (SSO) con sus cuentas de Azure AD.
...
### <a name="create-a-people-test-user"></a>Creación de un usuario de prueba de People
...
El objetivo de esta sección es permitir que Britta Simon use el inicio de sesión único de Azure, para lo cual se le concederá acceso a People.
