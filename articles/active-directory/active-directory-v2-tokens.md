...
> [!TIP]
> Como práctica, para inspeccionar las notificaciones en el token de identificador de ejemplo, pegue el token de identificador de ejemplo en [calebb.net](https://calebb.net).
>
>
