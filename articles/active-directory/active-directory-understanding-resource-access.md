<properties
    pageTitle="Descripción de acceso a los recursos de Azure | Microsoft Azure" 
...
> [AZURE.NOTE] El comando **Editar directorio** del Portal de Azure clásico no está disponible para los usuarios que han iniciado sesión con una cuenta profesional o educativa, porque con dichas cuentas solo pueden iniciar sesión en el directorio al que pertenecen.
