...
8. En la página **Configuración de SAML**, realice los siguientes pasos: <br><br>![Qué es Azure AD Connect][14]
    ...
    a. Como **identificador único**, seleccione **NameID**.

    b. En **El identificador único se asigna a**, seleccione **nombre de usuario**.

    c. Para cargar el archivo de metadatos descargado, haga clic en **Examinar** para seleccionar el archivo y, luego, en **Cargar archivo**.
