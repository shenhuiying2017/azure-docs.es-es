...
---
# <a name="add-new-users--or-users-with-microsoft-accounts-to-azure-active-directory"></a>Incorporación de nuevos usuarios o de usuarios con cuentas Microsoft en Azure Active Directory
