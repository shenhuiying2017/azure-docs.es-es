...
* Sus aplicaciones, como las aplicaciones web de SharePoint, están establecidas para usar la autenticación de Windows integrada. Para obtener más información, consulte [Habilitar la compatibilidad con la autenticación Kerberos](https://technet.microsoft.com/library/dd759186.aspx) o, para SharePoint, consulte [Planear la autenticación Kerberos en SharePoint 2013](https://technet.microsoft.com/library/ee806870.aspx).
...
4. Seleccione **Confiar en este equipo para la delegación solo a los servicios especificados** y, en **Servicios a los que esta cuenta puede presentar credenciales delegadas**, agregue el vade la identidad SPN del servidor de aplicaciones.
...
> [!IMPORTANT]
> Si el UPN local y el UPN de Azure Active Directory no son idénticos, tendrá que configurar la [identidad de inicio de sesión delegada](#delegated-login-identity) para que funcione la autenticación previa.
> 
> 
...
* Las aplicaciones que no son de Windows suelen obtener la identidad del usuario en forma de un nombre de usuario o un nombre de cuenta SAM, no como una dirección de correo electrónico (nombreDeUsuario@domain).
...
Si se produce un error en el proceso SSO, aparecerá en el registro de eventos de la máquina del conector como se explica en [Solución de problemas](active-directory-application-proxy-troubleshoot.md).
