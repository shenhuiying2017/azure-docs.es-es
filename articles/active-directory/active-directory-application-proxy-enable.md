...
3. Seleccione **Configurar** en la página del directorio y desplácese hacia abajo hasta **Proxy de aplicación**.
...
4. Cuando finalice la instalación, se agregan dos nuevos servicios a su servidor:
 	...
 	- El **Conector de Proxy de aplicación de Microsoft AAD** habilita la conectividad
	- El **Actualizador del Conector de Proxy de aplicación de Microsoft AAD** es un servicio de actualización automatizada que comprueba periódicamente las nuevas versiones del conector y lo actualiza según sea necesario.
