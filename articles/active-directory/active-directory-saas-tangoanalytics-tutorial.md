...
4. En el cuadro de búsqueda, escriba **Tango Analytics**.
...
5. En el panel de resultados, seleccione **Tango Analytics** y luego haga clic en el botón **Agregar** para agregar la aplicación.
...
3. **[Creación de un usuario de prueba de Tango Analytics](#creating-a-tango-analytics-test-user)**: para tener un homólogo de Britta Simon en Tango Analytics vinculado a la representación del usuario en Azure AD.
...
3. En la sección **Dominio y direcciones URL de Tango Analytics**, lleve a cabo los pasos siguientes:
...
6. Para configurar el inicio de sesión único en **Tango Analytics**, es preciso enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de Tango Analytics](mailto:support@tangoanalytics.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
