...
Durante los últimos 15 años o más, las organizaciones emplean el método tradicional de unirse a un dominio para que los dispositivos conectados funcionen. Así, ha permitido a los usuarios iniciar sesión en sus dispositivos con sus cuentas profesionales de AD y a los responsables de TI administrar completamente estos dispositivos. Las organizaciones suelen confían en los métodos de creación de imágenes para aprovisionar los dispositivos de los usuarios y usan generalmente System Center Configuration Manager (SCCM) o la directiva de grupo para administrarlos.

Unirse a un dominio en Windows 10 proporcionará las siguientes ventajas después de haberse conectado a Azure AD:

- SSO (inicio de sesión único) para recursos de Azure AD desde cualquier parte.
- Acceso al almacén empresarial de Windows mediante cuentas profesionales (sin necesidad de una cuenta Microsoft).
- Movilidad de las configuraciones de usuario en conformidad con la empresa entre dispositivos que usan cuentas profesionales (no se requiere ninguna cuenta Microsoft)
- Autenticación segura e inicio de sesión único para cuentas profesionales con Microsoft Passport y Windows Hello.
- Posibilidad de restringir el acceso a los dispositivos en conformidad con las políticas para dispositivos de la organización.

##Requisitos previos

El principal sigue siendo unirse a un dominio; pero además, para obtener las ventajas de inicio de sesión único para Azure AD, la movilidad de las configuraciones con cuentas profesionales o el acceso a la Tienda Windows con cuentas profesionales, necesita lo siguiente:
...
Para habilitar el acceso condicional, puede crear una directiva que permita el acceso a dispositivos 'unidos a un dominio' sin ninguna implementación adicional. Para administrar el control de acceso basado en el cumplimiento del dispositivo, necesitará lo siguiente:
...
6.	Haga clic con el botón derecho en **Unir automáticamente equipos cliente al área de trabajo** y luego seleccione **Editar**.
