...
1. En la página **Configurar inicio de sesión único en Ariba** , siga estos pasos:
    ...
    b. Haga clic en **Siguiente**.
2. Para configurar el inicio de sesión único para su aplicación, póngase en contacto con el equipo de asistencia técnica de Ariba en el teléfono **1-866-218-2155**.
...
### <a name="creating-a-ariba-test-user"></a>Creación de un usuario de prueba de Ariba
