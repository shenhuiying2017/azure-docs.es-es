...
[How to make a change to the default configuration](active-directory-aadconnectsync-change-the-configuration.md) (Realización de un cambio en la configuración predeterminada) | En él se explica cómo cambiar una configuración común para los flujos de atributo.
