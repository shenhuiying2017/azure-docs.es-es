...
7. Haga clic en el botón **Guardar** .
    ...
    ![Botón Configurar inicio de sesión único](./media/active-directory-saas-veracode-tutorial/tutorial_general_400.png)

8. En la sección **Configuración de Veracode**, haga clic en **Configurar Veracode** para abrir la ventana **Configurar inicio de sesión**. Copie el valor de **Identificador de entidad de SAML** de la **sección Referencia rápida**
