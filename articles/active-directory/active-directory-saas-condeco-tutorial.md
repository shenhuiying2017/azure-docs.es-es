...
El objetivo de este tutorial es mostrar cómo integrar Condeco con Azure Active Directory (Azure AD). Integrar Condeco con Azure AD proporciona las siguientes ventajas:
...
7. En el panel de resultados, seleccione **Condeco** y luego haga clic en **Completar** para agregar la aplicación.
...
3. **[Creación de un usuario de prueba de Condeco](#creating-a-Condeco-test-user)**: para tener un homólogo de Britta Simon en Condeco que esté vinculado a la representación de ella en Azure AD.
...
2. En la página **¿Cómo desea que los usuarios inicien sesión en Condeco?**, seleccione **Inicio de sesión único de Azure AD** y después haga clic en **Siguiente**.
...
1. En la página **Configurar inicio de sesión único en Condeco**, siga estos pasos:
...
2. Para que se configure el SSO para la aplicación, póngase en contacto con su equipo de soporte técnico de Condesco a través de supportna@condecosoftware.com y adjunte el archivo de metadatos descargado a su correo electrónico.
...
El objetivo de esta sección es probar la configuración del inicio de sesión único de Azure AD mediante el panel de acceso. Al hacer clic en el icono de Condeco en el Panel de acceso, debería iniciar sesión automáticamente en su aplicación Condeco.
