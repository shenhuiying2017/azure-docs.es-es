...
4. En el cuadro de búsqueda, escriba **Condeco**.

    ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-condeco-tutorial/tutorial_condeco_search.png)

5. En el panel de resultados, seleccione **Condeco** y luego haga clic en el botón **Agregar** para agregar la aplicación.
...
Para establecer la relación de vínculo, en Condeco, asigne el valor de **nombre de usuario** de Azure AD como valor de **nombre de usuario**.
...
3. **[Crear un usuario de prueba de Condeco](#creating-a-condeco-test-user)**: para tener un homólogo de Britta Simon en Condeco que esté vinculado a la representación del usuario en Azure AD.
4. **[Asignación del usuario de prueba de Azure AD](#assigning-the-azure-ad-test-user)** : para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Testing Single Sign-On](#testing-single-sign-on)** : para comprobar si funciona la configuración.

### <a name="configuring-azure-ad-single-sign-on"></a>Configuración del inicio de sesión único de Azure AD

En esta sección, habilitará el inicio de sesión único de Azure AD en Azure Portal y configurará el inicio de sesión único en la aplicación Condeco.

**Para configurar el inicio de sesión único de Azure AD con Condeco, realice los pasos siguientes:**

1. En Azure Portal, en la página de integración de la aplicación **Condeco**, haga clic en **Inicio de sesión único**.
...
3. En la sección **Dominio y direcciones URL de Condeco**, lleve a cabo los pasos siguientes:
    ...
    > [!NOTE] 
    > Este valor no es real. Actualícelo con la dirección URL de inicio de sesión real. Póngase en contacto con el [equipo de soporte técnico de Condeco](mailTo:supportna@condecosoftware.com) para obtener este valor. 
...
6. Para configurar el inicio de sesión único en **Condeco**, debe enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de Condeco](mailTo:supportna@condecosoftware.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
