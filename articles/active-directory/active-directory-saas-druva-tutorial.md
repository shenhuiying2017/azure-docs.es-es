...
## <a name="enable-the-application-integration-for-druva"></a>Habilitación de la integración de aplicaciones para Druva
...
4. Haga clic en **Agregar** en la parte inferior de la página.
   ...
   ![Agregar aplicaciones](./media/active-directory-saas-druva-tutorial/IC749321.png "Agregar aplicaciones")
