...
---
# <a name="protect-a-web-api-using-bearer-tokens-from-azure-ad"></a>Proteger una API web con tokens portadores de Azure AD
...
5. Siga las indicaciones y cree una nueva **Aplicación web y/o API web**.
  ...
  * Para el campo **AppID URI** (URI de AppID), introduzca un identificador específico del inquilino, p. ej.`https://contoso.onmicrosoft.com/TodoListService`
6. Guarde la configuración.  Deje abierto el portal (también deberá registrar su aplicación cliente en breve).
...
## <a name="3-configure-a-client-application--run-the-service"></a>3. Configuración de una aplicación cliente y ejecución del servicio
...
* Vuelva a [Azure Portal](https://portal.azure.com).
...
* En la página **Configuración**, elija **Permisos necesarios** y luego **Agregar**.  Busque y seleccione TodoListService y agregue el permiso **Access TodoListService** (Acceso TodoListService) en **Permisos delegados**; luego, seleccione **Listo**.
