...
Se puede acceder al objeto de aplicación de la aplicación a través de Graph API de Azure AD, el editor de manifiestos de aplicación de [Azure Portal][AZURE-Portal] o de [cmdlets de Azure AD PowerShell](https://docs.microsoft.com/powershell/azure/overview?view=azureadps-2.0), tal como y como se representa mediante su [entidad Application][AAD-Graph-App-Entity] de OData.

Se puede acceder al objeto de entidad de servicio de la aplicación a través de Graph API de Azure AD o de [cmdlets de Azure AD PowerShell](https://docs.microsoft.com/powershell/azure/overview?view=azureadps-2.0), tal como se representa mediante su entidad [ServicePrincipal][AAD-Graph-Sp-Entity] de OData.
