...
4. Azure AD valida la dirección URL de respuesta contrastándola con la dirección URL de respuesta registrada que se configuró en Azure Portal.
...
#### <a name="authentication-flow-for-native-application-to-api"></a>Flujo de autenticación para aplicación nativa a API
#### <a name="description-of-protocol-flow"></a>Descripción del flujo de protocolo
