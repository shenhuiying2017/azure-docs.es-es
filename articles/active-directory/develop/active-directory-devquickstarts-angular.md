...
7. Adal.js utiliza el flujo implícito de OAuth para comunicarse con Azure AD.  Debe habilitar el flujo implícito para la aplicación; para ello, siga estos pasos:
  * Haga clic en la aplicación y elija **Manifiesto** para abrir el editor directo de manifiestos.
  * Busque la propiedad `oauth2AllowImplicitFlow`. Establezca su valor en `true`.
  * Haga clic en **Guardar** para guardar el manifiesto.
