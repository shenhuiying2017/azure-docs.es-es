...
* Use una biblioteca de clases portable (PCL) única para autenticar a los usuarios y obtener tokens para la API de Azure AD Graph.
...
Esta acción permite que la aplicación consulte la API Graph para los usuarios.
...
4. Adjunte el token de acceso a la solicitud de API Graph en la cabecera de **autorización**:
