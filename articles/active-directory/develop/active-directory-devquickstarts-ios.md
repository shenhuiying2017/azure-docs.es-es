...
## <a name="4----use-adal-to-get-tokens-from-aad"></a>4.    Usar ADAL para obtener tokens de AAD
...
## <a name="5-build-and-run-the-application"></a>5. Compilar y ejecutar la aplicación
