...
El objetivo de este tutorial es mostrar cómo integrar Kindling con Azure Active Directory (Azure AD).  
...
3. **[Creación de un usuario de prueba de Kindling](#creating-a-kindling-test-user)** : para tener un homólogo de Britta Simon en Kindling que esté vinculado a la representación de ella en Azure AD.
...
Para configurar el inicio de sesión único para Kindling, se necesita un dominio registrado. Si aún no dispone de un dominio registrado, póngase en contacto con el equipo de soporte técnico de Kindling enviando un mensaje de correo electrónico a [support@kindlingapp.com](mailto:support@kindlingapp.com).  
...
3. En la página de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
    ...
    a. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL que usan los usuarios para iniciar sesión en su aplicación de Kindling con el siguiente patrón: `https://<company name>.kindlingapp.com/`.

    b. Póngase en contacto con el equipo de soporte técnico de Kindling [support@kindlingapp.com](mailto:support@kindlingapp.com) para obtener el valor de **Emisor** y **URL de respuesta**.   
...
1. En la página **Configurar inicio de sesión único en Kindling** , siga estos pasos:
...
El objetivo de esta sección es crear un usuario llamado Britta Simon en Kindling.
Kindling admite el aprovisionamiento Just-In-Time. Ya lo ha habilitado en [Configuración del inicio de sesión único de Azure AD](#configuring-azure-ad-single-single-sign-on).
