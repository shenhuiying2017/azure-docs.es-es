...
4. En el cuadro de búsqueda, escriba **Anaplan**.

    ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-anaplan-tutorial/tutorial_anaplan_search.png)

5. En el panel de resultados, seleccione **Anaplan** y luego haga clic en el botón **Agregar** para agregar la aplicación.
...
Para establecer la relación de vínculo, en Anaplan, asigne el valor de **nombre de usuario** de Azure AD como valor de **Nombre de usuario**.
...
3. **[Creación de un usuario de prueba de Anaplan](#creating-an-anaplan-test-user)**: para tener un homólogo de Britta Simon en Anaplan que esté vinculado a la representación del usuario en Azure AD.
4. **[Asignación del usuario de prueba de Azure AD](#assigning-the-azure-ad-test-user)** : para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Testing Single Sign-On](#testing-single-sign-on)** : para comprobar si funciona la configuración.

### <a name="configuring-azure-ad-single-sign-on"></a>Configuración del inicio de sesión único de Azure AD

En esta sección, habilitará el inicio de sesión único de Azure AD en Azure Portal y configurará el inicio de sesión único en la aplicación Anaplan.

**Para configurar el inicio de sesión único de Azure AD con Anaplan, realice los pasos siguientes:**

1. En Azure Portal, en la página de integración de la aplicación **Anaplan**, haga clic en **Inicio de sesión único**.
...
3. En la sección **Dominio y direcciones URL de Anaplan**, lleve a cabo los pasos siguientes:
    ...
    b. En el cuadro de texto **Identificador**, escriba una dirección URL con el siguiente patrón: `https://<subdomain>.anaplan.com`

    > [!NOTE] 
    > Estos valores no son reales. Debe actualizarlos con la dirección URL y el identificador reales de inicio de sesión. Póngase en contacto con el [equipo de soporte de cliente de Anaplan](mailto:support@anaplan.com) para obtener estos valores. 
...
6. En la sección **Configuración de Anaplan**, haga clic en **Configurar Anaplan** para abrir la ventana **Configurar inicio de sesión**. Copie la **URL del servicio de inicio de sesión único de SAML, el identificador de entidad de SAML y la dirección URL de cierre de sesión** de la sección **Referencia rápida**.

    ![Configurar inicio de sesión único](./media/active-directory-saas-anaplan-tutorial/tutorial_anaplan_configure.png) 

7. Para configurar el inicio de sesión único en **Anaplan**, es preciso enviar el **XML de metadatos** descargado, el **identificador de identidad de SAML**, la **dirección del servicio de inicio de sesión único de SAML** y la **dirección URL de cierre de sesión** al [equipo de soporte técnico de Anaplan](mailto:support@anaplan.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
En esta sección, creará un usuario llamado Britta Simon en Anaplan. Colabore con el [equipo de soporte técnico de Anaplan](mailto:support@anaplan.com) para agregar los usuarios a la plataforma Anaplan.
