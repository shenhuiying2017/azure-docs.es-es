<properties
	pageTitle="Tutorial: Integración de Azure Active Directory con Anaplan | Microsoft Azure"
...
# Tutorial: Integración de Azure Active Directory con Anaplan
...
## Incorporación de Anaplan desde la galería
...
Esta relación de vínculo se establece asignando el valor del **nombre de usuario** en Azure AD como el valor del **nombre de usuario** en Anaplan.
...
1. En el Portal clásico, en la página de integración de aplicaciones de **Anaplan**, haga clic en **Configurar inicio de sesión único** para abrir el cuadro de diálogo **Configurar inicio de sesión único**.
...
3. En la página de diálogo **Configurar las opciones de la aplicación**, realice los pasos siguientes y haga clic en **Siguiente**:
    ...
    a. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL con el siguiente patrón: `https://sdp.anaplan.com/frontdoor/saml/<tenant name>`
...
4. En la página **Configurar inicio de sesión único en Anaplan**, realice los pasos siguientes y haga clic en **Siguiente**:
...
5. Para que SSO se configure para su aplicación, póngase en contacto con el equipo de soporte técnico de Anaplan a través de [support@anaplan.com](mailto:support@anaplan.com) y especifique:
...
### Creación de un usuario de prueba de Anaplan
