...
Para configurar y probar el inicio de sesión único (SSO) de Azure AD con Anaplan, es preciso completar los siguientes bloques de creación:
...
3. En el cuadro de diálogo **Configurar las opciones de la aplicación**, realice los pasos siguientes y haga clic en **Siguiente**:
  ...
  1. En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL con el siguiente patrón: `https://sdp.anaplan.com/frontdoor/saml/<tenant name>`.
  2. Haga clic en **Siguiente**.

    > [!NOTE] 
    > El valor de la dirección URL de inicio de sesión de este tutorial es solo un marcador de posición. Para obtener el valor real para su entorno, póngase en contacto con el soporte técnico de Anaplan.
    > 
...
### <a name="create-a-anaplan-test-user"></a>Creación de un usuario de prueba de Anaplan
...
El objetivo de esta sección es permitir que Britta Simon use el inicio de sesión único (SSO) de Azure, para lo cual se le concederá acceso a Anaplan.
