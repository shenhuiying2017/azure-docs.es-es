...
El objetivo de este tutorial es mostrar cómo integrar Moxtra con Azure Active Directory (Azure AD).
...
7. En el panel de resultados, seleccione **Moxtra** y, luego, haga clic en **Completar** para agregar la aplicación.
...
3. **[Creación de un usuario de prueba de Moxtra](#creating-a-moxtra-test-user)** : para tener un homólogo de Britta Simon en Moxtra que esté vinculado a la representación de ella en Azure AD.
...
3. En la página del cuadro de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
  ...
  1. En el cuadro de texto **URL de inicio de sesión**, escriba la siguiente dirección URL: **https://www.moxtra.com/service/#login**. 
...
4. En la página **Configurar inicio de sesión único en Moxtra** , siga estos pasos:
  ...
  2. Haga clic en **Siguiente**.
5. En otra ventana del explorador, inicie sesión en su sitio de la compañía de Moxtra como administrador.
6. En la barra de herramientas de la izquierda, haga clic en **Consola de administración > Inicio de sesión único de SAML** y, luego, en **Nuevo**.
   
  ![Configurar inicio de sesión único](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_06.png) 
7. En la página **SAML** , realice los siguientes pasos:
   
  ![Configurar inicio de sesión único](./media/active-directory-saas-moxtra-tutorial/tutorial_moxtra_08.png)   
  1. En el cuadro de texto **Nombre** , escriba el nombre de la configuración (por ejemplo, *SAML*). 
  2. En el Portal de Azure clásico, en la página de diálogo **Configurar inicio de sesión único en Moxtra**, copie el valor de **Id. de entidad** y péguelo en el cuadro de texto **Id. de entidad de IdP**. 
  3. En el Portal de Azure clásico, en la página del cuadro de diálogo **Configurar inicio de sesión único en Moxtra**, copie el valor de **Dirección URL del inicio de sesión remoto** y péguelo en el cuadro de texto **Dirección URL de inicio de sesión**. 
  4. En el cuadro de texto **AuthnContextClassRef**, escriba **urn:oasis:names:tc:SAML:2.0:ac:classes:Password**. 
  5. En el Portal de Azure clásico, en la página del cuadro de diálogo **Configurar inicio de sesión único en Moxtra**, copie el valor de **Formato de identificador de nombre** y péguelo en el cuadro de texto **Formato de NameID**. 
  6. Abra el certificado descargado en el Bloc de notas, copie el contenido y luego péguelo en el cuadro de texto **Certificado** .    
  7. En el cuadro de texto del dominio de correo electrónico SAML, escriba su dominio de correo electrónico SAML.    
...
19. Para agregar asignaciones de atributos personalizados a la configuración de atributos de token de SAML, en el menú de la parte superior, haga clic en **Atributos** para abrir el cuadro de diálogo **Atributos de token de SAML**. 
   
  ![Configurar inicio de sesión único](./media/active-directory-saas-moxtra-tutorial/tutorial_general_80.png) 
11. En cada fila de datos de la tabla anterior, realice los pasos siguientes:
   
     | Nombre del atributo | Valor de atributo |
     | --- | --- |
     | firstname |givenname |
     | lastname |surname |
     | idpid |*\<el valor **Id. de entidad** del cuadro de diálogo **Configurar inicio de sesión único en Moxtra** en el Portal de Azure clásico \>* |
  ...
  2. En el cuadro de diálogo **Agregar atributo de usuario** , escriba el nombre y el valor del atributo mostrados para esa fila en la tabla. 
...
### <a name="create-a-moxtra-test-user"></a>Creación de un usuario de prueba de Moxtra
...
3. En el cuadro de diálogo **Agregar usuario** , realice los pasos siguientes:
  1. En el cuadro de texto **Nombre**, escriba **Britta**.
  2. En el cuadro de texto **Apellidos**, escriba **Simon**.
  3. En el cuadro de texto **Correo electrónico** , escriba la dirección de correo electrónico de Britta en el Portal de Azure clásico.
  4. En el cuadro de texto **Division** (División), escriba **Dev**.
  5. En el cuadro de texto **Department** (Departamento), escriba **IT**.
  6. Seleccione **Administrador**.
  7. Haga clic en **Agregar**.

### <a name="assign-the-azure-ad-test-user"></a>Asignación del usuario de prueba de Azure AD
El objetivo de esta sección es permitir que Britta Simon use el inicio de sesión único de Azure, para lo cual se le concederá acceso a Moxtra.
