<properties
	pageTitle="Cmdlets de Azure Active Directory para configurar las opciones de grupo | Microsoft Azure"
...
--------------------------------------|-----------------------------------------------
 <ul><li>ClassificationList<li>Tipo: Cadena<li>Valor predeterminado: “” | Una lista de valores de clasificación delimitados por coma que se puede aplicar a grupos unificados.                
 <ul><li>EnableGroupCreation<li>Tipo: Booleano<li>Valor predeterminado: True | Marca que indica si se permite la creación de grupos unificados en el directorio.                               
 <ul><li>GroupCreationAllowedGroupId<li>Tipo: Cadena<li>Valor predeterminado: “” | GUID del grupo de seguridad al que se permite crear grupos unificados incluso cuando EnableGroupCreation == false.
 <ul><li>UsageGuidelinesUrl<li>Tipo: Cadena<li>Valor predeterminado: “” | Un vínculo a las instrucciones de uso de grupos.                                                                       
...
## Referencia de objeto SettingsTemplate (objeto Group.Unified de SettingsTemplate)
