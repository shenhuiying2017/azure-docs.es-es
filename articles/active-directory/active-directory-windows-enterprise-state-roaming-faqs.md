...
2. Cuando ya se tenga el GUID, debe agregar la clave del registro **HKEY\_LOCAL\_MACHINE\\SOFTWARE\\Microsoft\\Windows\\SettingSync\\WinMSIPC<GUID del identificador de inquilino>**. En la clave del **GUID del identificador de inquilino**, cree un nuevo valor de cadena múltiple (REG-MULTI-SZ) denominado **AllowedRMSServerUrls**. Para sus datos, especifique las direcciones URL del punto de distribución licencias de los otros inquilinos de Azure a los que accede el dispositivo.
...
## ¿Cuál es la recomendación de Microsoft para habilitar la itinerancia en Windows 10?
...
## ¿Qué ocurre cuando mi organización adquiere Azure RMS después de usar la itinerancia?
