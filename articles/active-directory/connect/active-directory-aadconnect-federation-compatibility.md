...
| Clientes de correo electrónico enriquecidos, como Outlook y ActiveSync |Compatible |Para más información sobre las directivas de acceso de cliente, consulte [Limiting Access to Office 365 Services Based on the Location of the Client](https://technet.microsoft.com/library/hh526961.aspx) |
...
Sailpoint IdentityNow implementa el estándar de identidad ampliamente utilizado WS Federation/WS-Trust a fin de proporcionar un inicio de sesión único y un marco de intercambio de atributos.
