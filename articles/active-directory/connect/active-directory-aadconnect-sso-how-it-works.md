...
1. El usuario intenta acceder a una aplicación web (por ejemplo, Outlook Web App en https://outlook.office365.com/owa/) desde un dispositivo corporativo unido a un dominio dentro de la red corporativa.
...
3. El usuario escribe su nombre de usuario en la página de inicio de sesión de Azure AD.
  ...
  >[!NOTE]
  >Para [ciertas aplicaciones](./active-directory-aadconnect-sso-faq.md#what-applications-take-advantage-of-domainhint-or-loginhint-parameter-capability-of-seamless-sso), se omiten los pasos 2 y 3.
...
![Inicio de sesión único de conexión directa: flujo de aplicación web](./media/active-directory-aadconnect-sso/sso2.png)
...
![Inicio de sesión único de conexión directa: flujo de aplicación nativa](./media/active-directory-aadconnect-sso/sso14.png)
