...
### [Instalación mediante permisos de administrador delegado de SQL](active-directory-aadconnect-sql-delegation.md)
...
### [Opciones de dispositivos](active-directory-azure-ad-connect-device-options.md)
#### [Habilitación de la escritura diferida](active-directory-aadconnect-feature-device-writeback.md)
#### [Tareas de posconfiguración de la combinación de Azure AD híbrido](active-directory-azure-ad-connect-hybrid-azure-ad-join-post-config-tasks.md)
...
##### [Privacidad del usuario e inicio de sesión único de conexión directa de Azure AD](active-directory-aadconnect-sso-gdpr.md)
...
##### [Privacidad del usuario y autenticación de paso a través de Azure Active Directory](active-directory-aadconnect-pass-through-authentication-gdpr.md)
...
### [Sincronización de cuentas de usuarios invitados que utilizan el correo electrónico para el inicio de sesión](active-directory-aadconnect-guest-sync.md)


## Administración de Azure AD Connect Sync
### [Privacidad del usuario y Azure AD Connect](active-directory-aadconnect-gdpr.md)
### [Ubicación preferida de los datos para los recursos de Office 365](active-directory-aadconnectsync-feature-preferreddatalocation.md)
...
### [Conectividad SQL](active-directory-aadconnect-tshoot-sql-connectivity.md)
