...
El script debe devolver un único objeto [CloseImportConnectionResults[cicres]`Write-Output (New-Object Microsoft.MetadirectoryServices.CloseImportConnectionResults)` a la canalización, por ejemplo: ]
