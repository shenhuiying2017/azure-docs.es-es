...
3. En la página **Configurar dirección URL de la aplicación**, realice los pasos siguientes:
   ...
   1. En el cuadro de texto **Dirección URL de inicio de sesión de FM:Systems**, escriba la **dirección URL de respuesta** de FM:Systems (p. ej.: *https://dpr.fmshosted.com/fminteract/ConsumerService2.aspx*).
      ...
      > [!WARNING]
      > Este valor lo puede proporcionar el equipo de soporte técnico de FM:Systems.
      > 
      > 
...
5. Envíe el archivo de metadatos descargado al equipo de soporte técnico de FM: Systems.
   ...
   > [!NOTE]
   > El equipo de soporte técnico de FM: Systems es el que tiene que realizar la configuración real de SSO. Cuando SSO se haya habilitado en su suscripción recibirá una notificación.
   > 
   > 
...
> [!NOTE]
> Puede usar cualquier otra API o herramienta de creación de cuentas de usuario de FM:Systems que proporcione FM:Systems para aprovisionar cuentas de usuario de AAD.
> 
> 
