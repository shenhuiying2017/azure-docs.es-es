...
3. En la página de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
    ...
    a. En el cuadro de texto **Identificador**, escriba la dirección URL usada para identificar la aplicación ADP GlobalView mediante uno de los siguientes patrones: `https://<server name>.globalview.adp.com/federate2` o `https://<server name>.globalview.adp.com/federate`.
...
1. En la página **Configurar inicio de sesión único en ADP GlobalView** , siga estos pasos:
    ...
    b. Haga clic en **Next**.
2. Para configurar el inicio de sesión único para su aplicación, póngase en contacto con el equipo de soporte técnico de ADP GlobalView y proporcione lo siguiente: 
   ...
   * La **dirección URL del servicio de cierre de sesión único**
    ...
    > [AZURE.NOTE] Una vez que el equipo de **ADP GlobalView** configure la instancia, pídales el valor de **RelayState**. Siga los pasos a continuación para configurarlo. Después de la configuración, puede probar la integración. Tenga en cuenta que se trata de una configuración importante para el funcionamiento de esta integración de la aplicación.

1. Para configurar el valor de RelayState en Azure AD, siga estos pasos: 
...
2. En el Portal de Azure clásico, seleccione la confirmación de la configuración de inicio de sesión único y haga clic en **Siguiente**.
...
### <a name="creating-a-adp-globalview-test-user"></a>Creación de un usuario de prueba de ADP GlobalView
...
El objetivo de esta sección es permitir que Britta Simon use el inicio de sesión único de Azure concediéndole acceso a ADP GlobalView.
