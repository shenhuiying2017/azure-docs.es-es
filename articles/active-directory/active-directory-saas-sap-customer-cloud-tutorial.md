<properties
	pageTitle="Tutorial: Integración de Azure Active Directory con SAP Cloud for Customer | Microsoft Azure"
...
## Adición de SAP Cloud for Customer desde la galería
...
4. En el portal clásico, en la página de integración de aplicaciones de **SAP Cloud for Customer**, haga clic en **Configurar inicio de sesión único**.
	 
	![Configurar inicio de sesión único][6]

5. En la página **¿Cómo desea que los usuarios inicien sesión en SAP Cloud for Customer?**, seleccione **Inicio de sesión único de Azure AD** y luego haga clic en **Siguiente**.
...
7. En la página **Configurar inicio de sesión único en SAP Cloud for Customer**, siga estos pasos:
...
8. Para configurar SSO, siga estos pasos:
	...
	i. Especifique si el empleado puede elegir manualmente entre iniciar sesión con el Id. de usuario y una contraseña o mediante SSO, para lo que debe seleccionar la **Manual Identity Provider Selection** (Selección manual de proveedor de identidades).

	j. En la sección **SSO URL** (URL de SSO), especifique la dirección URL que deben utilizar los empleados para iniciar sesión en el sistema. En la lista **URL Sent to Employee** (URL que se envía a empleado), puede elegir una de las siguientes opciones:
...
### Creación de un usuario de prueba de SAP Cloud for Customer
...
> [AZURE.NOTE] Asegúrese de que el valor de NameID coincide con el campo de nombre de usuario de la plataforma SAP Cloud for Customer.
