...
Para todas las características de pago de Azure AD, que se extienden a los usuarios de B2B mediante la funcionalidad de colaboración B2B, es necesario conceder licencias con las licencias de pago de Azure AD (Básico, Premium P1 o Premium P2, en función de las características que se vayan a usar). El espacio empresarial invitador obtendrá 5 derechos de usuario de B2B con cada licencia de pago de Azure AD. Esto quiere decir que cada licencia de pago de Azure AD que otorga derechos a un usuario empleado en un inquilino ahora también incluye derechos a 5 usuarios de B2B invitados al inquilino.
