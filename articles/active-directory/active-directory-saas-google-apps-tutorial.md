...
2. Desde la lista **Directorio**, seleccione el directorio al que le gustaría agregar Google Apps.
...
1. En Azure AD, en la página de inicio rápido para Google Apps, haga clic en el botón **Configurar inicio de sesión único**.

	![Botón de inicio de sesión único de configuración][6]

2. Se abrirá un cuadro de diálogo y verá una pantalla que le pregunta "¿Cómo desea que los usuarios inicien sesión Google Apps?". Seleccione **Inicio de sesión único de Azure AD** y luego haga clic en **Siguiente**.
...
6. Haga clic en **Seguridad**. Si no ve el vínculo, puede estar oculto bajo el menú **Más controles** en la parte inferior de la pantalla.
...
8. Realice los cambios de configuración siguientes:
	...
	- Seleccione **Configuración de SSO con un proveedor de identidades de terceros**.

	- En Azure AD, copie la **dirección URL del servicio de inicio de sesión único** y péguela en la **dirección URL de la página de inicio de sesión** en Google Apps.

	- En Azure AD, copie la **dirección URL del servicio de cierre de sesión único** y péguela en la **dirección URL de la página de cierre de sesión** en Google Apps.

	- En Azure AD, copie la **dirección URL de cambio de contraseña** y péguela en el campo **Cambiar dirección URL de contraseña** en Google Apps.

	- En Google Apps, para el **certificado de comprobación**, cargue el certificado que descargó en el paso n.º 4.
...
11. Haga clic en **Completar** para cerrar el cuadro de diálogo. Para probar la configuración, vea la sección siguiente titulada [Asignación de usuarios a Google Apps](#step-4-assign-users-to-google-apps).
...
1. Inicie sesión en la [consola de administración de Google Apps](http://admin.google.com/)con su cuenta de administrador y haga clic en **Seguridad**. Si no ve el vínculo, puede estar oculto bajo el menú **Más controles** en la parte inferior de la pantalla.

	![Haga clic en Seguridad.][10]

2. En la página **Seguridad**, haga clic en **Referencia de la API**.
...
3. Seleccione **Habilitar acceso a la API**.
	...
	> [AZURE.IMPORTANT]Para cada usuario que piense aprovisionar en Google Apps, el nombre de usuario en Azure Active Directory *debe* vincularse a un dominio personalizado. Por ejemplo, Google Apps no aceptará los nombres de usuario con un aspecto parecido a bob@contoso.onmicrosoft.com. Por el contrario, sí se aceptará bob@contoso.com. Puede cambiar el dominio de un usuario existente editando sus propiedades en Azure AD. A continuación, se incluyen instrucciones sobre cómo establecer un dominio personalizado para Azure Active Directory y Google Apps.

4. Si no ha agregado un nombre de dominio personalizado para Azure Active Directory todavía, siga estos pasos:

	- En el panel de navegación izquierdo del [Portal de administración de Azure](https://manage.windowsazure.com), haga clic en **Active Directory**. En la lista de directorios, seleccione el directorio. 

	- Haga clic en **Dominios** desde el menú de nivel superior y, a continuación, haga clic en **Agregar un dominio personalizado**.

		![Incorporación de un dominio personalizado][17]

	- Escriba su nombre de dominio en el campo **Nombre de dominio**. Debe ser el mismo nombre de dominio que pensaba utilizar para Google Apps. Cuando esté listo, haga clic en el botón **Agregar**.

		![Escriba el nombre de dominio.][18]

	- Haga clic en **Siguiente** para ir a la página de comprobación. Para comprobar que es propietario de este dominio, debe editar los registros DNS del dominio según los valores proporcionados en esta página. Puede optar por realizar la comprobación con **registros MX** o **registros TXT** según lo que seleccione para la opción **Tipo de registro**. Para obtener instrucciones detalladas sobre cómo comprobar el nombre de dominio con Azure AD, vea [Incorporación de su propio nombre de dominio a Azure AD](https://go.microsoft.com/fwLink/?LinkID=278919&clcid=0x409).
...
5. Ahora que ha comprobado todos los dominios con Azure AD, debe comprobarlos de nuevo ahora con Google Apps. Para cada dominio que no esté registrado aún con Google Apps, realice los pasos siguientes:
	...
	- Seleccione **Agregar otro dominio** y escriba el nombre del dominio que desee agregar.

		![Especificación de un nombre de dominio][22]

	- Haga clic en **Continuar y comprobar la propiedad de dominio**. A continuación, siga los pasos para comprobar que posee el nombre de dominio. Para obtener instrucciones completas sobre cómo comprobar el dominio con Google Apps, consulte [Comprobación de la propiedad del sitio con Google Apps](https://support.google.com/webmasters/answer/35179).

	- Repita los pasos anteriores para todos los dominios adicionales que se va a agregar a Google Apps.

	> [AZURE.WARNING]Si cambia el dominio principal para el inquilino de Google Apps, y si ya ha configuran el inicio de sesión único con Azure AD, tendrá que repetir el paso 3 en [Paso dos: Habilitación de inicio de sesión único](#step-two-enable-single-sign-on).

6. En la [consola de administración de Google Apps](http://admin.google.com/), haga clic en **Roles administrativos**.

	![Haga clic en Google Apps][26]

7. Determine qué cuenta de administrador le gustaría usar para administrar el aprovisionamiento de usuarios. Para el **rol administrativo** de esa cuenta, edite los **privilegios** para ese rol. Asegúrese de que tiene todos los **privilegios de la API de administrador** habilitados de manera que esta cuenta pueda usarse para el aprovisionamiento.
...
9. En la página de inicio rápido de Google Apps, haga clic en **Configurar aprovisionamiento de usuario**.

	![Configuración de aprovisionamiento de usuario][24]

10. En el cuadro de diálogo que se abre, haga clic en **Habilitar aprovisionamiento de usuarios** para autenticar la cuenta de administrador de Google Apps que desea utilizar para administrar el aprovisionamiento.
