...
## <a name="enable-the-application-integration-for-bamboohr"></a>Habilitación de la integración de aplicaciones para BambooHR
...
## <a name="assig-users"></a>Asignación de usuarios
