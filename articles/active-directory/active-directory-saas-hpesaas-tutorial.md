...
3. Para abrir el diálogo **Agregar usuario**, en la barra de herramientas de la parte inferior, haga clic en **Agregar usuario**.
...
4. En la página de diálogo **Proporcione información sobre este usuario**, realice los pasos siguientes:
    ...
    c. Haga clic en **Next**.
5. En la página de diálogo **Perfil de usuario**, realice los siguientes pasos:
...
6. En la página de diálogo **Obtener contraseña temporal**, haga clic en **Crear**.
