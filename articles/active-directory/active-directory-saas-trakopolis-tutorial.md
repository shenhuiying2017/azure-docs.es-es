...
6. En el cuadro de búsqueda, escriba **Trakopolis**.<br><br> ![Aplicaciones](./media/active-directory-saas-trakopolis-tutorial/tutorial_trakopolis_01.png)<br>
7. En el panel de resultados, seleccione **Trakopolis** y, a continuación, haga clic en **Completar** para agregar la aplicación. <br><br>![Aplicaciones](./media/active-directory-saas-trakopolis-tutorial/tutorial_trakopolis_02.png)<br>
