...
7.  Al crear un objeto de entidad de servicio mediante el [módulo de PowerShell de Azure AD](https://docs.microsoft.com/powershell/azuread/v2/azureactivedirectory).
