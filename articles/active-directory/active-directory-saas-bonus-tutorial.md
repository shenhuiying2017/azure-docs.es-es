...
1.  En el Portal de Azure clásico, en la página de integración de aplicaciones de **Bonus.ly**, haga clic en **Configurar inicio de sesión único** para abrir el cuadro de diálogo **Configurar inicio de sesión único**.
...
8.  En la página de diálogo **SAML**, realice los pasos siguientes:
    ...
    3.  En el Portal de Azure clásico, en la página de diálogo **Configurar inicio de sesión único en Bonus.ly**, copie el valor de **URL de inicio de sesión remoto** y péguelo en el cuadro de texto **URL de inicio de sesión de IdP**.
...
10. En el Portal de Microsoft Azure clásico, seleccione la confirmación de configuración y, luego, haga clic en **Completar** para cerrar el cuadro de diálogo **Configurar inicio de sesión único**.
