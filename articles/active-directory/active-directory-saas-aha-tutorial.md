...
* Una suscripción habilitada para el inicio de sesión único (SSO) en Aha!
...
## <a name="enable-the-application-integration-for-aha"></a>Habilitación de la integración de aplicaciones para Aha!
