...
1.  En el Portal de Azure clásico, en la página de integración de la aplicación **Aha!**, haga clic en **Configurar inicio de sesión único** para abrir el cuadro de diálogo **Configurar inicio de sesión único**.
