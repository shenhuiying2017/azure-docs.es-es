...
description: "Obtenga información sobre cómo configurar dispositivos registrados en Azure Active Directory."
...
---
# <a name="how-to-configure-azure-active-directory-registered-windows-10-devices"></a>Configuración de dispositivos Windows 10 registrados en Azure Active Directory
...
![Registro](./media/device-management-azuread-registered-devices-windows10-setup/09.png)
