<properties
	pageTitle="Tutorial: Integración de Azure Active Directory con Tidemark | Microsoft Azure"
...
# Tutorial: integración de Azure Active Directory con Tidemark
...
7. En el panel de resultados, seleccione **Tidemark** y, luego, haga clic en **Completar** para agregar la aplicación.
...
4. **[Creación de un usuario de prueba de Tidemark](#creating-a-tidemark-test-user)**: para tener un homólogo de Britta Simon en Tidemark vinculado a su representación en Azure AD.
...
3. En la página de diálogo **Configurar las opciones de la aplicación**, realice los pasos siguientes:
    ...
    a. En el cuadro de texto URL de inicio de sesión, escriba la dirección URL de inicio de sesión de los usuarios en la aplicación Tidemark con los siguientes patrones: **“https://contoso.tidemark.com/login”** o **"https://contoso.tidemark.net/login"**.
...
### Creación de un usuario de prueba de Tidemark
...
> [AZURE.NOTE] Si necesita crear manualmente un usuario, es preciso que se ponga contacto con el equipo de soporte técnico de Tidemark.
