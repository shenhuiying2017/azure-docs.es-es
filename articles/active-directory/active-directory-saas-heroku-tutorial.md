...
3. En la página de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
   ...
   > 
    ...
    a. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL que los usuarios utilizan para iniciar sesión en su aplicación de Heroku con el siguiente patrón: **"https://sso.heroku.com/saml/\<nombre de la compañía\>/init"**. 

    b. En el cuadro de texto **Identificador**, escriba una dirección URL con el siguiente patrón: "**https://sso.heroku.com/saml/\<nombre de la compañía\>**".  
...
### <a name="creating-an-heroku-test-user"></a>Creación de un usuario de prueba de Heroku
