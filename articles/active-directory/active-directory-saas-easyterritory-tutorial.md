...
- Puede permitir que los usuarios inicien sesión automáticamente en EasyTerritory (SSO) con sus cuentas de Azure AD.
...
En esta sección, habilitará el inicio de sesión único de Azure AD en el Portal de administración de Azure y configurará el inicio de sesión único en la aplicación EasyTerritory.
...
3. En la sección **Dominio y direcciones URL de EasyTerritory**, si quiere configurar la aplicación en **IDP initiated mode** (Modo iniciado por IDP), realice los siguientes pasos:
   ...
   1. En el cuadro de texto **Identificador**, escriba una dirección URL con el siguiente patrón: `https://apps.easyterritory.com/<tenant id>/DEV/`
   2. En el cuadro de texto **URL de respuesta**, escriba una dirección URL con el siguiente patrón: `https://apps.easyterritory.com/<tenant id>/DEV/AuthServices/Acs`.
...
4. Si quiere configurar la aplicación en **SP initiated mode** (Modo iniciado por SP), en la sección **Dominio y direcciones URL de EasyTerritory**, realice los siguientes pasos:
  ...
  1. Haga clic en la opción **Mostrar configuración avanzada de URL**.
  2. En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL con el siguiente patrón: `https://<company name>.easyterritory.com/`.

    >[!NOTE] 
    >Estos valores no son reales. Tendrá que actualizar estos valores con la dirección URL de inicio de sesión, el identificador y la dirección URL de respuesta reales. Póngase en contacto con [equipo de soporte técnico de EasyTerritory](mailto:sales@easyterritory.com) para obtener esos valores.
...
### <a name="create-an-easyterritory-test-user"></a>Creación de un usuario de prueba en EasyTerritory
...
En esta sección, habilitará a Britta Simon para que use el SSO de Azure concediéndole acceso a EasyTerritory.
