...
## <a name="enable-the-application-integration-for-huddle"></a>Habilitación de la integración de aplicaciones para Huddle
...
4. Haga clic en **Agregar** en la parte inferior de la página.
   ...
   ![Agregar aplicaciones](./media/active-directory-saas-huddle-tutorial/IC749321.png "Agregar aplicaciones")
