---
layout: LandingPage
description: "Aprenda a sincronizar directorios y a habilitar el inicio de sesión único. En la documentación se muestra cómo integrar un conjunto completo de funcionalidades de administración de identidades."
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Desarrollo de aplicaciones con Azure Active Directory</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <h3>Otros</h3>
                        <p><a href="/azure/active-directory/active-directory-service-limits-restrictions">Restricciones y límites del servicio</a></p>
                    </div>
                </div>
            </div>
        </div>
