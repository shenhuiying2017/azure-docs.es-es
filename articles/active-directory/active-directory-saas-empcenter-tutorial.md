...
5. Envíe el archivo de metadatos descargado al equipo de soporte técnico de EmpCenter.
   ...
   > [!NOTE]
   > El equipo de soporte técnico de EmpCenter es el que tiene que realizar la configuración real de SSO. Cuando SSO se haya habilitado en su suscripción recibirá una notificación.
   > 
   > 
