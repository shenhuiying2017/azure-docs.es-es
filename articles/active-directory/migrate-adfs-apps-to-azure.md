...
- Funcionalidades de notificaciones en token
    ...
    - Reglas de transformación de emisiones de notificaciones complejas (consulte este documento para más información sobre las asignaciones de notificaciones admitidas)
