...
7. En la página **Configuración de SAML** , realice los siguientes pasos:
   ...
   2. En el Portal de Azure clásico, en la página del cuadro de diálogo **Configurar inicio de sesión único en XMatters OnDemand**, copie el valor de **Id. de proveedor de identidad** y péguelo en el cuadro de texto **Id. de proveedor de identidad**.
   3. En el Portal de Azure clásico, en la página del cuadro de diálogo **Configurar inicio de sesión único en XMatters OnDemand**, copie el valor de **Dirección URL del servicio de inicio de sesión único** y péguelo en el cuadro de texto **Dirección URL de inicio de sesión único**.
   4. En el Portal de Azure clásico, en la página del cuadro de diálogo **Configurar inicio de sesión único en XMatters OnDemand**, copie el valor de **Dirección URL del servicio de cierre de sesión único** y péguelo en el cuadro de texto **Dirección URL de cierre de sesión único**.
...
5. En la sección **Agregar un usuario** , realice estos pasos:
   ...
   1. Escriba los valores de **UserID**, **Nombre**, **Apellido**, **Sitio** de una cuenta de AAD válida que quiera aprovisionar.
   2. Haga clic en **Guardar**.

> [!NOTE]
> Puede usar cualquier otra API o herramienta de creación de cuentas de usuario de XMatters OnDemand ofrecida por XMatters OnDemand para aprovisionar cuentas de usuario de AAD.
> 
> 
