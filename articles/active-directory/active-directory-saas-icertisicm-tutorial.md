...
7. En el panel de resultados, seleccione **Icertis Contract Management Platform** y haga clic en **Completar** para agregar la aplicación.
...
2. En la página **¿Cómo desea que los usuarios inicien sesión en Icertis Contract Management Platform?**, seleccione **Inicio de sesión único de Microsoft Azure AD** y haga clic en **Siguiente**.
...
3. En el cuadro de diálogo **Configurar las opciones de la aplicación**, realice los pasos siguientes y haga clic en **Siguiente**:
  ...
  1. En el cuadro de texto **URL de inicio de sesión**, escriba una dirección URL con el siguiente patrón: `https://<company name>.icertis.com`.
  2. Haga clic en **Siguiente**.

   >[!NOTE]
   >Tenga en cuenta que estos no son valores reales. Tendrá que actualizar estos valores con la dirección URL de inicio de sesión real. Para obtener estos valores, póngase en contacto con Icertis Contract Management Platform.
   >

1. En la página **Configurar inicio de sesión único en Icertis Contract Management Platform**, realice los pasos siguientes y haga clic en **Siguiente**:
...
### <a name="create-a-icertis-contract-management-platform-test-user"></a>Creación de un usuario de prueba de Icertis Contract Management Platform
