...
5. Haga clic en el botón **Guardar** .
    ...
    ![Botón Configurar inicio de sesión único](./media/active-directory-saas-perceptionunitedstates-tutorial/tutorial_general_400.png)

6. En la sección **Configuración de Perception United States (no UltiPro)**, haga clic en **Configurar Perception United States (no UltiPro)** para abrir la ventana**Configurar inicio de sesión**. Copie el valor de **Identificador de entidad de SAML** de la **sección Referencia rápida**
