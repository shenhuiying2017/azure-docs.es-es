...
4. En el cuadro de búsqueda, escriba **Opal**, seleccione **Opal** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.

    ![Opal en la lista de resultados](./media/active-directory-saas-opal-tutorial/tutorial_opal_addfromgallery.png)
...
3. **[Creación de un usuario de prueba de Opal](#create-an-opal-test-user)**: para tener un homólogo de Britta Simon en Opal que esté vinculado a la representación del usuario en Azure AD.
...
2. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/active-directory-saas-opal-tutorial/tutorial_opal_samlbase.png)

3. En la sección **Dominio y direcciones URL de Opal**, lleve a cabo los pasos siguientes:

    ![Información de dominio y direcciones URL de inicio de sesión único de Opal](./media/active-directory-saas-opal-tutorial/tutorial_opal_url.png)
...
4. La aplicación Opal espera las aserciones de SAML en un formato específico. Configure las siguientes notificaciones para esta aplicación. Puede administrar los valores de estos atributos en la sección **Atributos de usuario** de la página de integración de aplicaciones. La siguiente captura de pantalla le muestra un ejemplo de esto.
    ...
    ![Configurar el atributo de inicio de sesión único](./media/active-directory-saas-opal-tutorial/tutorial_opal_attribute.png)
...
5. En la sección **Atributos de usuario** del cuadro de diálogo **Inicio de sesión único**, configure el atributo token de SAML como muestra la imagen y siga estos pasos:
    ...
    ![Configurar la adición del inicio de sesión único](./media/active-directory-saas-opal-tutorial/tutorial_attribute_04.png)

    ![Configurar la adición del atributo del inicio de sesión único](./media/active-directory-saas-opal-tutorial/tutorial_attribute_05.png)
...
6. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/active-directory-saas-opal-tutorial/tutorial_opal_certificate.png) 

7. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/active-directory-saas-opal-tutorial/tutorial_general_400.png) 

8. Para configurar el inicio de sesión único en **Opal**, necesita enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de Opal](mailto:support@workwithopal.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/active-directory-saas-opal-tutorial/create_aaduser_01.png)

2. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/active-directory-saas-opal-tutorial/create_aaduser_02.png)

3. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/active-directory-saas-opal-tutorial/create_aaduser_03.png)

4. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/active-directory-saas-opal-tutorial/create_aaduser_04.png)
...
2. En la lista de aplicaciones, seleccione **Opal**.

    ![Vínculo a Opal en la lista de aplicaciones](./media/active-directory-saas-opal-tutorial/tutorial_opal_app.png)  
