...
4. Haga clic en **Siguiente** y haga clic en el botón **Iniciar prueba** para que Azure Active Directory intente conectarse al punto de conexión SCIM. Si fallan los intentos, se mostrará la información de diagnóstico.  
...
9. En **Herramientas**, haga clic en **Reiniciar aprovisionamiento de cuentas** para comenzar el proceso de aprovisionamiento.
...
1. En la pantalla resultante, seleccione el segundo botón **Configurar aprovisionamiento de cuentas**.
2. En el cuadro de diálogo, escriba la dirección URL expuesta a Internet y el puerto del punto de conexión SCIM. Esto podría ser algo como http://testmachine.contoso.com:9000 o http://<ip-address>: 9000 /, donde <ip-address> es la dirección IP expuesta a Internet.  
3. Haga clic en **Siguiente** y haga clic en el botón **Iniciar prueba** para que Azure Active Directory intente conectarse al punto de conexión SCIM. Si fallan los intentos, se mostrará la información de diagnóstico.  
...
8. En **Herramientas**, haga clic en **Reiniciar aprovisionamiento de cuentas** para comenzar el proceso de aprovisionamiento.
