...
## <a name="enable-the-application-integration-for-sciforma"></a>Habilitación de la integración de aplicaciones para Sciforma
El objetivo de esta sección es describir cómo se habilita la integración de aplicaciones en Sciforma.

**Siga estos pasos con el fin de habilitar la integración de aplicaciones en Sciforma:**
...
4. Haga clic en **Agregar** en la parte inferior de la página.
    ...
    ![Agregar aplicaciones](./media/active-directory-saas-sciforma-tutorial/IC749321.png "Agregar aplicaciones")
...
5. Reenvíe el archivo de metadatos al equipo de soporte técnico de Sciforma. El equipo de soporte técnico configura un inicio de sesión único para usted.
