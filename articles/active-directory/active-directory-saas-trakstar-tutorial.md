...
3. **[Creación de un usuario de prueba de Trakstar](#creating-a-Trakstar-test-user)**: para tener un homólogo de Britta Simon en Trakstar que esté vinculado a su representación en Azure AD.
