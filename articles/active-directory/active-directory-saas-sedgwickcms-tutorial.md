...
4. En el cuadro de búsqueda, escriba **Sedgwick CMS**, seleccione **Sedgwick CMS** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
    ...
    ![Sedgwick CMS en la lista de resultados](./media/active-directory-saas-sedgwickcms-tutorial/tutorial_sedgwickcms_addfromgallery.png)
...
3. **[Creación de un usuario de prueba en Sedgwick CMS](#create-a-sedgwick-cms-test-user)**: para tener un homólogo de Britta Simon en Sedgwick CMS que esté vinculado a la representación del usuario en Azure AD.
...
2. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/active-directory-saas-sedgwickcms-tutorial/tutorial_sedgwickcms_samlbase.png)

3. En la sección **Dominio y direcciones URL de Sedgwick CMS**, lleve a cabo los pasos siguientes:

    ![Información de dominio y direcciones URL de inicio de sesión único de Sedgwick CMS](./media/active-directory-saas-sedgwickcms-tutorial/tutorial_sedgwickcms_url.png)
...
4. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/active-directory-saas-sedgwickcms-tutorial/tutorial_sedgwickcms_certificate.png) 

5. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/active-directory-saas-sedgwickcms-tutorial/tutorial_general_400.png)

6. Para configurar el inicio de sesión único en **Sedgwick CMS**, es preciso enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de Sedgwick CMS](https://www.sedgwick.com/contact/Pages/contactform.aspx). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/active-directory-saas-sedgwickcms-tutorial/create_aaduser_01.png)

2. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/active-directory-saas-sedgwickcms-tutorial/create_aaduser_02.png)

3. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/active-directory-saas-sedgwickcms-tutorial/create_aaduser_03.png)

4. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/active-directory-saas-sedgwickcms-tutorial/create_aaduser_04.png)
...
En esta sección, creará un usuario llamado Britta Simon en Sedgwick CMS. Colabore con el [equipo de soporte técnico de Sedgwick CMS](https://www.sedgwick.com/contact/Pages/contactform.aspx) para agregar los usuarios a la plataforma de Sedgwick CMS. Los usuarios se tienen que crear y activar antes de usar el inicio de sesión único.  
...
2. En la lista de aplicaciones, seleccione **Sedgwick CMS**.
    ...
    ![Vínculo a Sedgwick CMS en la lista de aplicaciones](./media/active-directory-saas-sedgwickcms-tutorial/tutorial_sedgwickcms_app.png)  
