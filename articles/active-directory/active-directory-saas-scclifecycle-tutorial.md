...
- Puede controlar en Azure AD quién tiene acceso a SCC LifeCycle.
- Puede habilitar que los usuarios inicien sesión automáticamente en SCC LifeCycle (Inicio de sesión único) con sus cuentas de Azure AD.
...
1. Adición de SCC LifeCycle desde la galería
...
4. En el cuadro de búsqueda, escriba **SCC LifeCycle**.
...
5. En el panel de resultados, seleccione **SCC LifeCycle** y luego haga clic en el botón **Agregar** para agregar la aplicación.
...
Para que el inicio de sesión único funcione, Azure AD debe saber cuál es el usuario homólogo de SCC LifeCycle para un usuario de Azure AD. Es decir, es necesario establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de SCC LifeCycle.

Para establecer la relación de vínculo, en SCC LifeCycle, asigne el valor de **nombre de usuario** de Azure AD como valor de **Nombre de usuario**.
...
3. **[Creación de un usuario de prueba de SCC LifeCycle](#creating-an-scc-lifecycle-test-user)**: para tener un homólogo de Britta Simon en SCC LifeCycle vinculado a la representación del usuario en Azure AD.
4. **[Asignación del usuario de prueba de Azure AD](#assigning-the-azure-ad-test-user)** : para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Testing Single Sign-On](#testing-single-sign-on)** : para comprobar si funciona la configuración.

### <a name="configuring-azure-ad-single-sign-on"></a>Configuración del inicio de sesión único de Azure AD

En esta sección, habilitará el inicio de sesión único de Azure AD en Azure Portal y lo configurará en la aplicación SCC LifeCycle.
...
3. En la sección **Dominio y direcciones URL de SCC LifeCycle**, lleve a cabo los pasos siguientes:
...
6. Para configurar el inicio de sesión único en **SCC LifeCycle**, debe enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de SCC LifeCycle](mailto:lifecycle.support@scc.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
**Para asignar a Britta Simon a SCC LifeCycle, realice los pasos siguientes:**
...
Al hacer clic en el icono de SCC LifeCycle en el Panel de acceso, debería iniciar sesión automáticamente en su aplicación SCC LifeCycle.
