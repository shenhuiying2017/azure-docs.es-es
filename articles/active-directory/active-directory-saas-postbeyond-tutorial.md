...
3. **[Creación de un usuario de prueba de PostBeyond](#creating-a-PostBeyond-test-user)**: para tener un homólogo de Britta Simon en PostBeyond que esté vinculado a la representación de ella en Azure AD.
