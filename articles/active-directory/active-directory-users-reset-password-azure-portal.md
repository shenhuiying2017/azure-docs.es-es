...
---
# <a name="reset-the-password-for-a-user-in-azure-active-directory---public-preview"></a>Restablecimiento de la contraseña de un usuario en la versión preliminar pública de Azure Active Directory
