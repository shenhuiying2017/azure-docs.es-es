...
## <a name="enable-the-application-integration-for-thoughtworks-mingle"></a>Habilitación de la integración de aplicaciones para Thoughtworks Mingle
El objetivo de esta sección es describir cómo habilitar la integración de las aplicaciones para Thoughtworks Mingle.

**Siga estos pasos con el fin de habilitar la integración de aplicaciones para Thoughtworks Mingle:**
