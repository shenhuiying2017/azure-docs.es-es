...
4. En el cuadro de búsqueda, escriba **TiViTz**.

    ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-tivitz-tutorial/tutorial_tivitz_search.png)

5. En el panel de resultados, seleccione **TiViTz** y luego haga clic en el botón **Agregar** para agregar la aplicación.
...
3. En la sección **Dominio y direcciones URL de TiViTz**, lleve a cabo los pasos siguientes:
...
6. Para configurar el inicio de sesión único en el lado de **TiViTz**, necesita enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de TiViTz](mailto:info@tivitz.com).
