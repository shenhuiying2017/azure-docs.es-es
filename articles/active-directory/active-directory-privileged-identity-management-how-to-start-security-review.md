---
title: Inicio de una revisión de acceso | Microsoft Docs
...
> [!NOTE]
> Si no ha agregado la aplicación PIM al panel del Portal de Azure, consulte los pasos que se indican en [Introducción a Azure Privileged Identity Management](active-directory-privileged-identity-management-getting-started.md).
> 
> 
