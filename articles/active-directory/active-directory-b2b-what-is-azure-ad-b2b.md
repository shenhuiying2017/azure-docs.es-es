---
title: "Colaboración de Azure Active Directory B2B (versión preliminar): integración sencilla y segura de los asociados de la nube | Microsoft Docs"
...
---
# <a name="azure-ad-b2b-collaboration-preview-simple-secure-cloud-partner-integration"></a>Vista previa de la colaboración B2B de Azure AD: integración sencilla y segura de los asociados de la nube
...
Consulte [la publicación de blog en la que se anuncia la versión preliminar pública](http://blogs.technet.com/b/ad/archive/2015/09/15/learn-all-about-the-azure-ad-b2b-collaboration-preview.aspx) y vea este vídeo con [información detallada](https://channel9.msdn.com/Series/Azure-Active-Directory-Videos-Demos/Azure-Active-Directory-B2B-collaboration-demo) en el que se describe la colaboración de Azure AD B2B.

Para obtener más información sobre una comparación de los casos de uso para la colaboración B2B de Azure AD, Azure AD B2C y la aplicación multiinquilino de Azure AD, consulte [Comparación de funcionalidades para administrar identidades externas con Azure Active Directory](active-directory-b2b-compare-external-identities.md).
