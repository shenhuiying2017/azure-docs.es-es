...
## <a name="enable-the-application-integration-for-clever"></a>Habilitación de la integración de aplicaciones para Clever
...
4. Haga clic en **Agregar** en la parte inferior de la página.
   ...
   ![Agregar aplicaciones](./media/active-directory-saas-clever-tutorial/IC749321.png "Agregar aplicaciones")
...
1. En el Portal de Azure clásico, en la página de integración de aplicaciones de **Clever**, haga clic en **Configurar inicio de sesión único** para abrir el cuadro de diálogo **Configurar inicio de sesión único**.
...
7. En la página **Instant Login** (Inicio de sesión instantáneo), realice los pasos siguientes:
   ...
   1. Escriba la **Dirección URL de inicio de sesión**.  
      ...
      >[!NOTE]
      >La **URL de inicio de sesión** es un valor personalizado. El valor real puede obtenerlo del equipo de soporte técnico de Clever.
      > 
