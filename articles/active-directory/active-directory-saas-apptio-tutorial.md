...
4. En el cuadro de búsqueda, escriba **Apptio**, seleccione **Apptio** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
    ...
    ![Apptio en la lista de resultados](./media/active-directory-saas-apptio-tutorial/tutorial_apptio_addfromgallery.png)
...
2. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/active-directory-saas-apptio-tutorial/tutorial_apptio_samlbase.png)
...
3. En la sección **Dominio y direcciones URL de Apptio**, realice los siguientes pasos si desea configurar la aplicación en el modo iniciado por IDP:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Apptio](./media/active-directory-saas-apptio-tutorial/tutorial_apptio_url.png)

    En el cuadro de texto **Identificador**, escriba el valor `urn:federation:apptio`.

4. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.

    ![Vínculo de descarga del certificado](./media/active-directory-saas-apptio-tutorial/tutorial_apptio_certificate.png) 
...
5. La aplicación Apptio Software espera las aserciones de SAML en un formato concreto. Configure las siguientes notificaciones para esta aplicación. Puede administrar los valores de estos atributos en la sección "**Atributos de usuario**" de la página de integración de aplicaciones. Observe que **Identificador de usuario** tiene asignado **user.mail**. Hay otros tres atributos (**fullname, mail y role**) que es necesario configurar. La siguiente captura de pantalla le muestra un ejemplo de esto.
    ...
    ![Configurar inicio de sesión único](./media/active-directory-saas-apptio-tutorial/tutorial_apptio_attributes.png)       
...
6. En la sección **Atributos de usuario** del cuadro de diálogo **Inicio de sesión único**, configure el atributo token de SAML como muestra la imagen y siga estos pasos:
    ...
    ![Configurar inicio de sesión único](./media/active-directory-saas-apptio-tutorial/tutorial_attribute_04.png)

    ![Configurar inicio de sesión único](./media/active-directory-saas-apptio-tutorial/tutorial_attribute_05.png)
...
8. Haga clic en el botón **Guardar** .
    ...
    ![Botón Configurar inicio de sesión único](./media/active-directory-saas-apptio-tutorial/tutorial_general_400.png)
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/active-directory-saas-apptio-tutorial/create_aaduser_01.png)

2. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/active-directory-saas-apptio-tutorial/create_aaduser_02.png)

3. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/active-directory-saas-apptio-tutorial/create_aaduser_03.png)

4. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/active-directory-saas-apptio-tutorial/create_aaduser_04.png)
...
2. En la lista de aplicaciones, seleccione **Apptio**.
    ...
    ![Vínculo a Apptio en la lista de aplicaciones](./media/active-directory-saas-apptio-tutorial/tutorial_apptio_app.png)  
