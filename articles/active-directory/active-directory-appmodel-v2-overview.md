...
- Si compiló una aplicación durante el período de vista previa de 2015 de la versión 2.0 del punto de conexión, no olvide [informarse sobre los últimos cambios en los protocolos](active-directory-v2-preview-oidc-changes.md) que hemos realizado.
