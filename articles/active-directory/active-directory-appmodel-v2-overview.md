...
> [AZURE.NOTE]Esta información se aplica a la versión preliminar pública del modelo de aplicaciones v2.0. Para obtener instrucciones acerca de la integración con el servicio de Azure AD disponible con carácter general, consulte la [Guía para desarrolladores de Azure Active Directory](active-directory-developers-guide.md).
