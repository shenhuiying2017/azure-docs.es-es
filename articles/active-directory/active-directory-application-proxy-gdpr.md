...
Para obtener información general del proxy de aplicación de Azure AD, consulte [Provisión de acceso remoto seguro a aplicaciones locales](manage-apps/application-proxy.md).
