...
6. En el cuadro de búsqueda, escriba **GaggleAMP**. ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_01.png)
...
2. En la lista de aplicaciones, seleccione **GaggleAMP**. ![Lista de Azure](./media/active-directory-saas-gaggleamp-tutorial/tutorial_gaggleamp_50.png)
