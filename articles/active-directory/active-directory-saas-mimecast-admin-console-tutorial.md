<properties pageTitle="Tutorial: Integración de Azure Active Directory con Mimecast Admin Console | Microsoft Azure" description="Aprenda a usar Mimecast Admin Console con Azure Active Directory para habilitar el inicio de sesión único, el aprovisionamiento automatizado, etc." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Tutorial: Integración de Azure Active Directory con Mimecast Admin Console
>[AZURE.TIP]Para enviar comentarios, haga clic [aquí](http://go.microsoft.com/fwlink/?LinkId=529833).
...
9.  En la sección **Perfil de autenticación**, realice estos pasos:
    ...
    2.  Seleccione **Aplicar la autenticación SAML a Mimecast Admin Console**.
