...
* Una suscripción habilitada para inicio de sesión único (SSO) en Mimecast Admin Console
...
4. Haga clic en **Agregar** en la parte inferior de la página.
   ...
   ![Agregar aplicaciones](./media/active-directory-saas-mimecast-admin-console-tutorial/IC749321.png "Agregar aplicaciones")
