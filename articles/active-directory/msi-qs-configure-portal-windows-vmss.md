...
- Mediante Azure Portal, asigne a una identidad de servicio administrada de un conjunto de escalado de máquinas virtuales de Azure [acceso a otro recurso de Azure](msi-howto-assign-access-portal.md).
