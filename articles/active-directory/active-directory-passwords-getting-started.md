...
7.  Después de configurar la directiva de restablecimiento de contraseña del usuario como desea para su inquilino, haga clic en el botón **Guardar** en la parte inferior de la pantalla.
  ...
  >[AZURE.NOTE] Se recomienda usar una directiva de restablecimiento de la contraseña del usuario de dos desafíos, con el fin de que pueda ver cómo funciona esta funcionalidad en el caso más complejo.
...
> [AZURE.NOTE] Si se solicita una credencial, asegúrese de que la cuenta de administrador que especifique para AzureADCredential sea una **cuenta de administrador en la nube (creada en Azure AD)**, no una cuenta federada (creada en una versión local de AD y sincronizado en Azure AD).
