...
5. Haga clic en el botón **Guardar** .
    ...
    ![Botón Configurar inicio de sesión único](./media/active-directory-saas-spaceiq-tutorial/tutorial_general_400.png)

6. En la sección **Configuración de SpaceIQ**, haga clic en **Configurar SpaceIQ** para abrir la ventana **Configurar inicio de sesión**. Copie el valor de **Identificador de entidad de SAML** de la **sección Referencia rápida**
