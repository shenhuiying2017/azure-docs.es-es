---
title: Uso del control de acceso (Java) - Microsoft Azure
...
1. En el [Portal de administración de Azure][Portal de administración de Azure], haga clic en **Active Directory**, seleccione un espacio de nombres de control de acceso y, a continuación, haga clic en **Administrar**. Se abre el portal de administración de ACS.
