<properties pageTitle="Tutorial: integración de Azure Active Directory con Gigya | Microsoft Azure" description="Aprenda a usar Gigya con Azure Active Directory para habilitar el inicio de sesión único, el aprovisionamiento automático, etc." services="active-directory" authors="MarkusVi"  documentationCenter="na" manager="stevenpo"/>
<tags ms.service="active-directory" ms.devlang="na" ms.topic="article" ms.tgt_pltfrm="na" ms.workload="identity" ms.date="08/01/2015" ms.author="markvi" />
#Tutorial: integración de Azure Active Directory con Gigya
>[AZURE.TIP]Para enviar comentarios, haga clic [aquí](http://go.microsoft.com/fwlink/?LinkId=528575).
...
7.  En el panel de resultados, seleccione **Gigya** y, a continuación, haga clic en **Completar** para agregar la aplicación.
...
3.  En la página **Configurar dirección URL de la aplicación**, en el cuadro de texto **URL de inicio de sesión de Gigya**, escriba su dirección URL con el siguiente patrón "**http://company.gigya.com*" y, a continuación, haga clic en **Siguiente**.
...
4.  En la página **Configuración de inicio de sesión único en Gigya**, haga clic en **Descargar certificado** y, a continuación, guarde el archivo de certificado en el equipo.
...
6.  Vaya a **Settings > SAML Login** (Configuración > Inicio de sesión de SAML) y, a continuación, haga clic en el botón **Add** (Agregar).

    ![Inicio de sesión de SAML](./media/active-directory-saas-gigya-tutorial/IC789532.png "Inicio de sesión de SAML")

7.  En la sección **SAML Login** (Inicio de sesión de SAML), realice los pasos siguientes:
...
3.  En el cuadro de diálogo Invite Users (Invitar a usuarios), realice los pasos siguientes:
    ...
    1.  En el cuadro de texto **Email** (Correo electrónico), escriba el alias de correo electrónico de la cuenta válida de Azure Active Directory que desee aprovisionar.
    2.  Haga clic en **Invite User** (Invitar a usuario).
