...
6. En el cuadro de búsqueda, escriba **Mixpanel**.
...
Esta relación de vínculo se establece asignando el valor del **nombre de usuario** en Azure AD como el valor del **nombre de usuario** en Mixpanel.
...
2. En la página **Cómo desea que los usuarios inicien sesión en Mixpanel**, seleccione **Inicio de sesión único de Microsoft Azure AD** y haga clic en **Next** (Siguiente).
...
4. En la página **Configure single sign-on at Mixpanel** (Configurar inicio de sesión único en Mixpanel), realice los pasos siguientes:
...
6. En la parte inferior de la página, haga clic en el pequeño icono de **engranaje** de la esquina izquierda.

	![Inicio de sesión único de Mixpanel](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_06.png)

7. Haga clic en la pestaña **Access security** (Seguridad de acceso) y después en **Change settings** (Cambiar la configuración).

	![Configuración de Mixpanel](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_08.png)
    
8. En la página de diálogo **Change your certificate** (Cambiar su certificado), haga clic en **Choose file** (Elegir archivo) para cargar el certificado descargado y después haga clic en **Next** (Siguiente).

	![Configuración de Mixpanel](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_09.png)

9. En el Portal de Azure clásico, en la página de diálogo **Configure single sign-on at Mixpanel** (Configurar inicio de sesión único en Mixpanel) copie el valor de **Dirección URL del servicio de inicio de sesión único**, péguelo en el cuadro de texto de dirección URL de autenticación en la página de diálogo **Change your authentication URL** (Cambiar dirección URL de la autenticación) y haga clic en **Siguiente**.
...
1. En el **Portal de Azure clásico**, en el panel de navegación izquierdo, haga clic en **Active Directory**.
	...
	![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-mixpanel-tutorial/create_aaduser_09.png)
...
2. En la lista de aplicaciones, seleccione **Mixpanel**.
	...
	![Configurar inicio de sesión único](./media/active-directory-saas-mixpanel-tutorial/tutorial_mixpanel_50.png)
