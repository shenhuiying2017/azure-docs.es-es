...
5. Siga las indicaciones y cree una nueva **Aplicación de cliente nativa**. El **nombre** de la aplicación describirá su aplicación a los usuarios finales. El **URI de redirección** es una combinación de esquema y cadena que utilizará Azure AD para devolver las respuestas de los tokens.  Escriba un valor específico para la aplicación, por ejemplo, `http://DirectorySearcher`. Haga clic en **Crear** para crear la aplicación.
