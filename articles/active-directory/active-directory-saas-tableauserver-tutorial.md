...
3. **[Creación de un usuario de prueba de Tableau Server](#creating-a-tableauserver-test-user)**: para tener un homólogo de Britta Simon en Tableau Server que esté vinculado a la representación de ella en Azure AD.
...
3. En la página **¿Cómo desea que los usuarios inicien sesión en Tableau Server?**, seleccione **Inicio de sesión único de Azure AD** y después haga clic en **Siguiente**.
   
    ![Configurar inicio de sesión único](./media/active-directory-saas-tableauserver-tutorial/tutorial_tableauserver_03.png)
4. En la página de diálogo **Configurar las opciones de la aplicación**, realice los pasos siguientes y haga clic en **Siguiente**:
...
1. En la página **Configurar inicio de sesión único en Tableau Server**, lleve a cabo estos pasos y haga clic en **Siguiente**:
