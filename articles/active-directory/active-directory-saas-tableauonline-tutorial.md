<properties
	pageTitle="Tutorial: Integración de Azure Active Directory con Tableau Online | Microsoft Azure"
...
4. **[Creación de un usuario de prueba de Tableau Online](#creating-a-Tableau-Online-test-user)**: para tener un homólogo de Britta Simon en Tableau Online que esté vinculado a la representación de ella en Azure AD.
...
5. En la página **Configuración de inicio de sesión único en Tableau Online**, haga clic en **Descargar metadatos** y luego guarde el archivo en el equipo.
...
8. En una ventana de explorador diferente, inicie sesión en su aplicación de Tableau Online como administrador. Vaya a **Configuración** y luego a **Autenticación**.
...
1. En el portal clásico, para abrir la vista de aplicaciones, en la
2. vista de directorios, haga clic en **Aplicaciones** en el menú superior.

	![Asignar usuario][201]

3. En la lista de aplicaciones, seleccione **Tableau Online**.
...
5. En la lista Todos los usuarios, seleccione **Britta Simon**.
