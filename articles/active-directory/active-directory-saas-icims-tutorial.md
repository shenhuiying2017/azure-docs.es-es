...
1. En la página **Configurar inicio de sesión único en ICIMS** , siga estos pasos:
...
### <a name="creating-a-icims-test-user"></a>Creación de un usuario de prueba de ICIMS
