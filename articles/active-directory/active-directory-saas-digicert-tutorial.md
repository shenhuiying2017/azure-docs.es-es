...
5. En el panel de resultados, seleccione **DigiCert** y luego haga clic en el botón **Agregar** para agregar la aplicación.
...
3. **[Creación de un usuario de prueba de DigiCert](#creating-a-digicert-test-user)**: para tener un homólogo de Britta Simon en DigiCert que esté vinculado a la representación de Azure AD de usuario.
