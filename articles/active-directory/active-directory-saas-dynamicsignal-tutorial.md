...
4. En el cuadro de búsqueda, escriba **Dynamic Signal**, seleccione **Dynamic Signal** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
    ...
    ![Dynamic Signal en la lista de resultados](./media/active-directory-saas-dynamicsignal-tutorial/tutorial_dynamicsignal_addfromgallery.png)
...
3. **[Creación de un usuario de prueba de Dynamic Signal](#create-a-dynamic-signal-test-user)**: para tener un homólogo de Britta Simon en Dynamic Signal que esté vinculado a su representación en Azure AD.
...
2. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/active-directory-saas-dynamicsignal-tutorial/tutorial_dynamicsignal_samlbase.png)

3. En la sección **Dynamic Signal Domain and URLs** (Dominio y direcciones URL de Dynamic Signal), lleve a cabo los pasos siguientes:
 
    ![Información sobre dominio y direcciones URL de inicio de sesión único de Dynamic Signal](./media/active-directory-saas-dynamicsignal-tutorial/tutorial_dynamicsignal_url.png)
...
4. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/active-directory-saas-dynamicsignal-tutorial/tutorial_dynamicsignal_certificate.png) 

5. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/active-directory-saas-dynamicsignal-tutorial/tutorial_general_400.png)
    
6. En la sección **Configuración de Dynamic Signal**, haga clic en **Configurar Dynamic Signal** para abrir la ventana **Configurar inicio de sesión**. Copie la **URL del servicio de inicio de sesión único de SAML, el identificador de entidad de SAML y la dirección URL de cierre de sesión** de la sección **Referencia rápida**.

    ![Configuración de Dynamic Signal](./media/active-directory-saas-dynamicsignal-tutorial/tutorial_dynamicsignal_configure.png) 
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/active-directory-saas-dynamicsignal-tutorial/create_aaduser_01.png)

2. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/active-directory-saas-dynamicsignal-tutorial/create_aaduser_02.png)

3. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/active-directory-saas-dynamicsignal-tutorial/create_aaduser_03.png)

4. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/active-directory-saas-dynamicsignal-tutorial/create_aaduser_04.png)
...
2. En la lista de aplicaciones, seleccione **Dynamic Signal**.
    ...
    ![El vínculo de Dynamic Signal en la lista de aplicaciones](./media/active-directory-saas-dynamicsignal-tutorial/tutorial_dynamicsignal_app.png)  
