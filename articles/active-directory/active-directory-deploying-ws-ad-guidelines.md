...
- [Instalación de un controlador de dominio de Active Directory de réplica en una red virtual de Azure](../virtual-network/virtual-networks-install-replica-active-directory-domain-controller.md)
