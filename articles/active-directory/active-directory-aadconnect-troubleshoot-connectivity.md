...
Este error aparecerá cuando el propio asistente no pueda ponerse en contacto con el proxy.
...
Aparecerá este error si no se puede establecer comunicación con el punto de conexión **https://secure.aadcdn.microsoftonline-p.com** y el administrador global tiene MFA habilitado.  
...
- Si ve esto, examine la configuración de proxy en [netsh](active-directory-aadconnect-prerequisites.md#connectivity) y compruebe si es correcta.
