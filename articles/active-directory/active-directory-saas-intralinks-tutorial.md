...
3. En la página del cuadro de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
    ...
    a. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL que usan los usuarios para iniciar sesión en la aplicación de Intralinks con el siguiente patrón: **https://\<nombre de la compañía\>.Intralinks.com/?PartnerIdpId=https://sts.windows.net/\<id. de inquilino de AzureAD\>/**.
...
### <a name="adding-intralinks-via-or-elite-application"></a>Adición de la aplicación VIA o Elite de Intralinks
...
10. Obtenga la dirección URL de SSO iniciado por el proveedor de servicios del equipo de Intralinks para la otra aplicación Intralinks y escríbala tal como se muestra a continuación. 
    ...
    a. En el cuadro de texto URL de inicio de sesión, escriba la dirección URL que usan los usuarios para iniciar sesión en la aplicación de Intralinks con el siguiente patrón: **https://\<nombre de la compañía\>.Intralinks.com/?PartnerIdpId=https://sts.windows.net/\<AzureADTenantID\>/**.
