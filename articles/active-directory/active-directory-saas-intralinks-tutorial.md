...
4. **[Creación de un usuario de prueba de Intralinks](#creating-an-intralinks-test-user)**: para tener un homólogo de Britta Simon en Intralinks que esté vinculado a la representación de ella en Azure AD.
...
> [AZURE.NOTE] Tenga en cuenta que esta característica solo está disponible para los clientes de la SKU Premium de Azure AD y no está disponible para los clientes de SKU Básico o Gratis.
