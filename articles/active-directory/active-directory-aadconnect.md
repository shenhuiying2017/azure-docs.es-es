...
| Solución | Escenario |
| ----- | ----- |
| Antes de comenzar | <li>[Azure AD Connect: hardware y requisitos previos](active-directory-aadconnect-prerequisites.md)</li> |
