...
4. En el cuadro de búsqueda, escriba **Agiloft**, seleccione **Agiloft** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
    ...
    ![Agiloft en la lista de resultados](./media/active-directory-saas-agiloft-tutorial/tutorial_agiloft_addfromgallery.png)
...
2. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
    ...
    ![Cuadro de diálogo Inicio de sesión único](./media/active-directory-saas-agiloft-tutorial/tutorial_agiloft_samlbase.png)
...
3. En la sección **Dominio y direcciones URL de Agiloft**, realice los siguientes pasos si desea configurar la aplicación en el modo iniciado por IDP:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Agiloft](./media/active-directory-saas-agiloft-tutorial/tutorial_agiloft_url.png)
...
4. Active **Mostrar configuración avanzada de URL** y siga estos pasos si desea configurar la aplicación en el modo iniciado por **SP**:
    ...
    ![Información de dominio y direcciones URL de inicio de sesión único de Agiloft](./media/active-directory-saas-agiloft-tutorial/tutorial_agiloft_url1.png)
...
5. En la sección **Certificado de firma de SAML**, haga clic en **Certificado (Base64)** y, luego, guarde el archivo de certificado en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/active-directory-saas-agiloft-tutorial/tutorial_agiloft_certificate.png) 

6. Haga clic en el botón **Guardar** .

    ![Botón Configurar inicio de sesión único](./media/active-directory-saas-agiloft-tutorial/tutorial_general_400.png)
...
7. En la sección **Configuración de Agiloft**, haga clic en **Configurar Agiloft** para abrir la ventana **Configurar inicio de sesión**. Copie la **URL del servicio de inicio de sesión único de SAML, el identificador de entidad de SAML y la dirección URL de cierre de sesión** de la sección **Referencia rápida**.
    ...
    ![Configuración de Agiloft](./media/active-directory-saas-agiloft-tutorial/tutorial_agiloft_configure.png) 
...
9. Haga clic en **Setup** (Configuración) (en el panel izquierdo) y, a continuación, en **Access** (Acceso).
    ...
    ![Configuración de Agiloft](./media/active-directory-saas-agiloft-tutorial/setup1.png) 

10. Haga clic en el botón **"Configure SAML 2.0 Single Sign-On"** (Configurar inicio de sesión único de SAML 2.0). 
    
    ![Configuración de Agiloft](./media/active-directory-saas-agiloft-tutorial/setup2.png) 
...
11. Aparece un cuadro de diálogo del asistente. En el cuadro de diálogo, haga clic en la pestaña **"Identity Provider Details"** (Detalles del proveedor de identidades) y rellene los campos siguientes:  
    ...
    ![Configuración de Agiloft](./media/active-directory-saas-agiloft-tutorial/setup4.png) 
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/active-directory-saas-agiloft-tutorial/create_aaduser_01.png)

2. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/active-directory-saas-agiloft-tutorial/create_aaduser_02.png)

3. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/active-directory-saas-agiloft-tutorial/create_aaduser_03.png)

4. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/active-directory-saas-agiloft-tutorial/create_aaduser_04.png)
...
2. En la lista de aplicaciones, seleccione **Agiloft**.
    ...
    ![Vínculo a Agiloft en la lista de aplicaciones](./media/active-directory-saas-agiloft-tutorial/tutorial_agiloft_app.png)  
