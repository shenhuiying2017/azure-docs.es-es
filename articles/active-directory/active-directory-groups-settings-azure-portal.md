<properties
	pageTitle="Administración de los miembros de un grupo en la versión preliminar de Azure Active Directory | Microsoft Azure | Microsoft Azure"
...
# Administración de la configuración de un grupo en la versión preliminar de Azure Active Directory
...
5. En la hoja **Grupo - *nombreDelGrupo***, seleccione **Propiedades**.
