...
4. En el cuadro de búsqueda, escriba **Lucidchart**.
...
5. En el panel de resultados, seleccione **Lucidchart** y luego haga clic en el botón **Agregar** para agregar la aplicación.
...
3. **[Creación de un usuario de prueba de Lucidchart](#creating-a-lucidchart-test-user)**: el objetivo es tener un homólogo de Britta Simon en Lucidchart que esté vinculado a la representación del usuario en Azure AD.
...
3. En la sección **Dominio y direcciones URL de Lucidchart**, lleve a cabo los pasos siguientes:
...
7. En el menú de la parte superior, haga clic en **Equipo**.
...
9. En la página de diálogo **Configuración de la autenticación SAML** , realice los pasos siguientes:
