...
description: "Obtenga información sobre cómo configurar dispositivos unidos a Azure Active Directory."
...
---
# <a name="how-to-configure-azure-active-directory-joined-devices"></a>Configuración de dispositivos unidos a Azure Active Directory
