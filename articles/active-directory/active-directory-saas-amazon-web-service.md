---
title: 'Tutorial: Integración de Azure Active Directory con Amazon Web Service (AWS) | Microsoft Docs'
...
3. **[Creación de un usuario de prueba de Amazon Web Service (AWS)](#creating-a-halogen-software-test-user)**: para tener un homólogo de Britta Simon en Amazon Web Service (AWS) que esté vinculado a la representación de ella en Azure AD.
