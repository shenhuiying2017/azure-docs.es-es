...
1. En la página **Configuración de inicio de sesión único en Asana**, haga clic en **Descargar certificado** y luego guarde el archivo de certificado en el equipo. Además, puede copiar el valor de dirección URL SSO SAML.
...
4. En la ventana **Configuración de la organización**, haga clic en **Administración**. Después, haga clic en **Members must log in via SAML** (Los miembros deben iniciar sesión mediante SAML) para habilitar la configuración de SSO. Lleve a cabo los siguiente pasos:
