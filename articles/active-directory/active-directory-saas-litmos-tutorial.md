...
1. Copie el valor de **The SAML endpoint for litmos is:** (El punto de conexión de SAML para Litmos es).

	![Inicio de sesión único de Azure AD][26]


3. En el Portal de Azure clásico, en la página de diálogo **Configurar las opciones de la aplicación**, realice los pasos siguientes:
...
4. En la página **Configurar inicio de sesión único en Litmos**, siga estos pasos:
