...
3. En la página de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
    ...
    a. En el cuadro de texto **URL del identificador**, escriba la dirección URL que usan los usuarios para iniciar sesión en la aplicación de Reward Gateway con el siguiente patrón: 
...
1. En la página **Configurar inicio de sesión único en Reward Gateway**, siga estos pasos:
...
2. Para configurar el inicio de sesión único para su aplicación, póngase en contacto con el [equipo de soporte técnico](mailTo:clientsupport@rewardgateway.com) de Reward Gateway y proporcione lo siguiente:
...
5. En el cuadro de diálogo **Proporcione información sobre este usuario**, siga estos pasos:  ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-reward-gateway-tutorial/create_aaduser_05.png) 
...
6. En el cuadro de diálogo **Perfil de usuario**, siga estos pasos: ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-reward-gateway-tutorial/create_aaduser_06.png) 
...
### <a name="creating-an-reward-gateway-test-user"></a>Creación de un usuario de prueba de Reward Gateway
