...
Ahora puede conceder a una máquina virtual acceso a un servidor SQL de Azure.  En este paso, puede utilizar un servidor SQL existente o crear uno nuevo.  Para crear un servidor y una base de datos con Azure Portal, siga esta [Guía de inicio rápido de Azure SQL](~/articles/sql-database/sql-database-get-started-portal.md). También hay guías de inicio rápido que utilizan la CLI de Azure y Azure PowerShell en la [documentación de Azure SQL](~/articles/sql-database/index.yml).
...
- [Autenticación universal con SQL Database y SQL Data Warehouse (compatibilidad de SSMS con MFA)](~/articles/sql-database/sql-database-ssms-mfa-authentication.md)
- [Configuración y administración de la autenticación de Azure Active Directory con SQL Database o SQL Data Warehouse](~/articles/sql-database/sql-database-aad-authentication-configure.md)
...
- Más información sobre la [compatibilidad de Azure SQL con la autenticación de Azure AD](~/articles/sql-database/sql-database-aad-authentication.md).
- Más información sobre la [configuración de la compatibilidad de Azure SQL con la autenticación de Azure AD](~/articles/sql-database/sql-database-aad-authentication-configure.md).
