...
El objetivo de este tutorial es mostrar cómo integrar HR2day by Merces con Azure Active Directory (Azure AD).  
...
Esta relación de vínculo se establece mediante la asignación del valor del **nombre de usuario** en Azure AD como valor de **Username** en HR2day by Merces.
...
1. En el Portal de Azure clásico, en la página de integración de aplicaciones de **HR2day by Merces**, en el menú de la parte superior, haga clic en **Atributos** para abrir el cuadro de diálogo 
**Atributos de token de SAML**. 
...
2. En el menú de la parte superior, haga clic en **Inicio rápido** to open the **Inicio rápido** .
...
### <a name="creating-a-hr2day-by-merces-test-user"></a>Creación de un usuario de prueba de HR2day by Merces
