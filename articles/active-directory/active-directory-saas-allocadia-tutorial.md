...
8. Para configurar el inicio de sesión único en **Allocadia**, debe enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de Allocadia](mailTo:support@allocadia.com). Ellos se encargan de realizar esta configuración para que la conexión de SSO de SAML esté establecida correctamente en ambos lados.
