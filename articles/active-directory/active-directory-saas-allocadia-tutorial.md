...
4. En el cuadro de búsqueda, escriba **Allocadia**.
...
5. En el panel de resultados, seleccione **Allocadia** y luego haga clic en el botón **Agregar** para agregar la aplicación.
...
Para establecer la relación de vínculo, en Allocadia, asigne el valor de **nombre de usuario** de Azure AD como valor de **nombre de usuario**.
...
3. **[Creación de un usuario de prueba de Allocadia](#creating-an-allocadia-test-user)**: para tener un homólogo de Britta Simon en Allocadia que esté vinculado a la representación del usuario en Azure AD.
4. **[Asignación del usuario de prueba de Azure AD](#assigning-the-azure-ad-test-user)** : para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Testing Single Sign-On](#testing-single-sign-on)** : para comprobar si funciona la configuración.

### <a name="configuring-azure-ad-single-sign-on"></a>Configuración del inicio de sesión único de Azure AD

En esta sección, habilitará el inicio de sesión único de Azure AD en Azure Portal y configurará el inicio de sesión único en la aplicación Allocadia.

**Para configurar el inicio de sesión único de Azure AD con Allocadia, realice los pasos siguientes:**

1. En Azure Portal, en la página de integración de la aplicación **Allocadia**, haga clic en **Inicio de sesión único**.
...
3. En la sección **Dominio y direcciones URL de Allocadia**, lleve a cabo los pasos siguientes:
    ...
    > [!NOTE] 
    > Estos valores no son reales. Actualice estos valores con el identificador y la URL de respuesta reales. Póngase en contacto con el [equipo de soporte técnico de Allocadia](mailTo:support@allocadia.com) para obtener estos valores.
...
8. Para configurar el inicio de sesión único en **Allocadia**, debe enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de Allocadia](mailTo:support@allocadia.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
La aplicación admite aprovisionamiento de usuarios Just-In-Time. Después se crean usuarios de autenticación en la aplicación automáticamente.
