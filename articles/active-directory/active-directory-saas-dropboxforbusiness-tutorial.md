...
1.  En el Portal de Azure clásico, en la página de integración de aplicaciones de **Dropbox para Empresas**, haga clic en **Configurar inicio de sesión único** para abrir el cuadro de diálogo **Configurar inicio de sesión único**.
...
3.  En la página **Configurar dirección URL de la aplicación**, realice los pasos siguientes:
	...
	b. En el panel de navegación de la izquierda, haga clic en **Consola de administración**.
	...
	c. En **Consola de administración**, haga clic en la opción **Autenticación** del panel de navegación izquierdo.
	...
	d. En la sección **Inicio de sesión único**, seleccione **Habilitar inicio de sesión único** y haga clic en **Más** para expandir esta sección.
	...
	e. Copie la dirección URL a continuación de **Los usuarios pueden iniciar sesión especificando su dirección de correo electrónico o pueden ir directamente a**.
	...
	f. En el Portal de Azure clásico, en el cuadro de texto de la dirección URL de **Inicio de sesión de Dropbox para Empresas**, pegue la dirección URL.
...
4. En la página **Configurar inicio de sesión único en Dropbox para Empresas**, haga clic en **Descargar certificado** y guarde el archivo de certificado en el equipo.
...
5. En su inquilino de Dropbox para Empresas, en la sección **Inicio de sesión único** de la página **Autenticación**, realice los pasos siguientes:
	...
	b. En el Portal de Azure clásico, en la página de diálogo **Configurar inicio de sesión único en Dropbox para Empresas**, copie el valor de **Dirección URL de la página de inicio de sesión** y péguelo en el cuadro de texto **Dirección URL de inicio de sesión**.
	...
	d. Haga clic en el botón **Elegir certificado** y acceda al **archivo de certificado codificado en base 64**.


	e. Haga clic en el botón **Guardar cambios** para completar la configuración del inquilino de Dropbox para Empresas.
...
1. En el Portal de Azure clásico, en la página de integración de aplicaciones de **Dropbox para Empresas**, haga clic en **Configurar aprovisionamiento de usuarios** para abrir el cuadro de diálogo **Configurar aprovisionamiento de usuarios**.
...
3. En el cuadro de diálogo **Sign in to Dropbox to link with Azure AD** (Iniciar sesión en Dropbox para vincularlo a Azure AD), inicie sesión en su inquilino de Dropbox para Empresas.
...
4. Haga clic en **Permitir** para conceder a Azure AD acceso a Dropbox.
...
5. Para finalizar la configuración, haga clic en el botón **Completar**.
...
Como primer paso de verificación, puede comprobar el estado del aprovisionamiento, haciendo clic en la opción **Panel** de la página de integración de aplicaciones de **Dropbox para Empresas** en el Portal de Azure clásico.
