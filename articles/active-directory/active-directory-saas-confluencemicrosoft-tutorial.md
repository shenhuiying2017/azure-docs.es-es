...
Para establecer la relación de vínculo, en Confluence SAML SSO by Microsoft, asigne el valor del **nombre de usuario** de Azure AD como valor del **nombre de usuario**.
...
6. Póngase en contacto con [Microsoft](mailto:waadpartners@microsoft.com) con la siguiente información para el complemento de Confluence.
...
7. En otra ventana del explorador web, inicie sesión en la instancia de Confluence como administrador.
