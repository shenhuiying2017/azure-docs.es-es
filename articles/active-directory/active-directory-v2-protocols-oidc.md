...
Para más información sobre las notificaciones en un elemento id\_token, consulte la [Referencia de los tokens del punto de conexión v2.0](active-directory-v2-tokens.md).
