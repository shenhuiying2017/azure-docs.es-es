...
También puede usar la función especial ExtractMailPrefix() para quitar el sufijo de dominio de la dirección de correo electrónico o del nombre principal de usuario, lo que provoca que solo se pase la primera parte del nombre de usuario (por ejemplo, "joesmith" en lugar de joesmith@contoso.com).
