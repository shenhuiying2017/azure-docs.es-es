...
---
# <a name="add-a-custom-domain-name-to-azure-active-directory-preview"></a>Adición de un nombre de dominio personalizado a la versión preliminar de Azure Active Directory
