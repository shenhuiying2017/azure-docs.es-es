<properties
	pageTitle="Tutorial: Integración de Azure Active Directory con 360° Online | Microsoft Azure"
...
# Tutorial: Integración de Azure Active Directory con 360° Online
...
## Adición de 360° Online desde la Galería
...
4. **[Creación de un usuario de prueba de 360° Online](#creating-a-360-online-test-user)**: para tener un homólogo de Britta Simon en 360° Online que esté vinculado a su representación en Azure AD.
...
2. En la página **¿Cómo desea que los usuarios inicien sesión en 360° Online?**, seleccione **Inicio de sesión único de Microsoft Azure AD** y haga clic en **Siguiente**.

	![Configurar inicio de sesión único](./media/active-directory-saas-360online-tutorial/tutorial_360online_03.png)

3. En la página del cuadro de diálogo **Configurar dirección URL de la aplicación**, realice los pasos siguientes y luego haga clic en **Siguiente**.

	![Configurar inicio de sesión único](./media/active-directory-saas-360online-tutorial/tutorial_360online_04.png)

    a. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL que usan los usuarios para iniciar sesión en su aplicación de 360° Online con el siguiente patrón: `https://<company name>.public360online.com`.

    b. Haga clic en **Siguiente**.

4. En la página del cuadro de diálogo **Configurar dirección URL de la aplicación**, realice los pasos siguientes y luego haga clic en **Siguiente**.
...
### Creación de un usuario de prueba de 360° Online
