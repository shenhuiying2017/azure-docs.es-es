<properties
	pageTitle="Tutorial: Integración de Azure Active Directory con CA PPM | Microsoft Azure"
...
# Tutorial: Integración de Azure Active Directory con CA PPM
...
## Incorporación de CA PPM desde la galería
...
Esta relación de vínculo se establece asignando el valor del **nombre de usuario** en Azure AD como el valor del **nombre de usuario** en CA PPM.
...
5. En la página del cuadro de diálogo **Proporcione información sobre este usuario**, siga estos pasos:![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-cappm-tutorial/create_aaduser_05.png)
...
6.  En la página del cuadro de diálogo **Perfil de usuario**, siga estos pasos: ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-cappm-tutorial/create_aaduser_06.png)
...
### Creación de un usuario de prueba de CA PPM
