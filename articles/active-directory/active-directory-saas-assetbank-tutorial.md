...
1. En la página **¿Cómo desea que los usuarios inicien sesión en Asset Bank?**, seleccione **Inicio de sesión único de Microsoft Azure AD** y después haga clic en **Siguiente**.
