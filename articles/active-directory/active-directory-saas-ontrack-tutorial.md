...
- Puede permitir que los usuarios inicien sesión automáticamente en OnTrack (inicio de sesión único) con sus cuentas de Azure AD.
...
1. Adición de OnTrack desde la galería
...
4. En el cuadro de búsqueda, escriba **OnTrack**, seleccione **OnTrack** en el panel de resultados y, luego, haga clic en el botón **Agregar** para agregar la aplicación.
    ...
    ![OnTrack en la lista de resultados](./media/active-directory-saas-ontrack-tutorial/tutorial_ontrack_addfromgallery.png)
...
Para que el inicio de sesión único funcione, Azure AD debe saber cuál es el usuario homólogo de OnTrack para un usuario de Azure AD. Es decir, es necesario establecer una relación de vínculo entre un usuario de Azure AD y el usuario relacionado de OnTrack.

Para establecer la relación de vínculo, en OnTrack, asigne el valor de **nombre de usuario** de Azure AD como valor de **Nombre de usuario**.
...
3. **[Creación de un usuario de prueba de OnTrack](#create-an-ontrack-test-user)**: para tener un homólogo de Britta Simon en OnTrack que esté vinculado a la representación del usuario en Azure AD.
4. **[Asignación del usuario de prueba de Azure AD](#assign-the-azure-ad-test-user)**, para permitir que Britta Simon use el inicio de sesión único de Azure AD.
5. **[Prueba del inicio de sesión único](#test-single-sign-on)**: para comprobar si la configuración funciona.

### <a name="configure-azure-ad-single-sign-on"></a>Configuración del inicio de sesión único de Azure AD

En esta sección, habilitará el inicio de sesión único de Azure AD en Azure Portal y lo configurará en su aplicación OnTrack.

**Para configurar el inicio de sesión único de Azure AD con OnTrack, realice los pasos siguientes:**

1. En Azure Portal, en la página de integración de la aplicación **OnTrack**, haga clic en **Inicio de sesión único**.

    ![Vínculo Configurar inicio de sesión único][4]

2. En el cuadro de diálogo **Inicio de sesión único**, en **Modo** seleccione **Inicio de sesión basado en SAML** para habilitar el inicio de sesión único.
 
    ![Cuadro de diálogo Inicio de sesión único](./media/active-directory-saas-ontrack-tutorial/tutorial_ontrack_samlbase.png)

3. En la sección **Dominio y direcciones URL de OnTrack**, lleve a cabo los pasos siguientes:

    ![Información acerca del inicio de sesión único de dominio y direcciones URL de OnTrack](./media/active-directory-saas-ontrack-tutorial/tutorial_ontrack_url.png)
...
4. En la sección **Certificado de firma de SAML**, haga clic en **XML de metadatos** y luego guarde el archivo de metadatos en el equipo.
    ...
    ![Vínculo de descarga del certificado](./media/active-directory-saas-ontrack-tutorial/tutorial_ontrack_certificate.png)
...
5. La aplicación OnTrack espera las aserciones de SAML en un formato específico, que requiere que se agreguen asignaciones de atributos personalizados a la configuración de los atributos del token de SAML. Configure las siguientes notificaciones para esta aplicación. Puede administrar los valores de estos atributos en la sección "**Atributos de usuario**" de la página de integración de aplicaciones. 
    ...
    ![Configurar inicio de sesión único](./media/active-directory-saas-ontrack-tutorial/tutorial_attribute.png)
...
6. En la sección **Atributos de usuario** del cuadro de diálogo **Inicio de sesión único**, configure el atributo del token de SAML como muestra la imagen anterior y realice los siguientes pasos:
    ...
    ![Configurar inicio de sesión único](./media/active-directory-saas-ontrack-tutorial/tutorial_attribute_04.png)   

    ![Configurar inicio de sesión único](./media/active-directory-saas-ontrack-tutorial/tutorial_attribute_05.png)
...
7. Haga clic en el botón **Guardar** .
    ...
    ![Botón Configurar inicio de sesión único](./media/active-directory-saas-ontrack-tutorial/tutorial_general_400.png)

8. Para configurar el inicio de sesión único en el lado de **OnTrack**, necesita enviar el archivo **XML de metadatos** descargado al [equipo de soporte técnico de OnTrack](mailto:CustomerService@insigniagroup.com). Dicho equipo lo configura para establecer la conexión de SSO de SAML correctamente en ambos lados.
...
1. En el panel izquierdo de Azure Portal, haga clic en el botón **Azure Active Directory**.
    ...
    ![Botón Azure Active Directory](./media/active-directory-saas-ontrack-tutorial/create_aaduser_01.png)

2. Para mostrar la lista de usuarios, vaya a **Usuarios y grupos** y, luego, haga clic en **Todos los usuarios**.

    ![Vínculos "Usuarios y grupos" y "Todos los usuarios"](./media/active-directory-saas-ontrack-tutorial/create_aaduser_02.png)

3. En la parte superior del cuadro de diálogo **Todos los usuarios**, haga clic en **Agregar** para abrir el cuadro de diálogo **Agregar**.

    ![Botón Agregar](./media/active-directory-saas-ontrack-tutorial/create_aaduser_03.png)

4. En el cuadro de diálogo **Usuario** , realice los pasos siguientes:

    ![Cuadro de diálogo Usuario](./media/active-directory-saas-ontrack-tutorial/create_aaduser_04.png)
...
**Para asignar a Britta Simon a OnTrack, realice los pasos siguientes:**
...
2. En la lista de aplicaciones, seleccione **OnTrack**.
    ...
    ![Vínculo a OnTrack en la lista de aplicaciones](./media/active-directory-saas-ontrack-tutorial/tutorial_ontrack_app.png)  
