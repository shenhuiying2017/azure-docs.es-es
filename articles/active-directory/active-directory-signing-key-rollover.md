...
> [AZURE.IMPORTANT] La próxima sustitución de claves de firma está programada para el 15 de agosto de 2016 y **no** afectará a las aplicaciones que se agregaron desde la galería de aplicaciones de Azure AD (incluidas las personalizadas), las aplicaciones locales publicadas a través del proxy de aplicación, las aplicaciones de inquilinos B2C de Azure AD o las aplicaciones que se integran con ACS o ADFS.
...
### <a name="vs2012"></a>Aplicaciones Web de protección de recursos y creado con Visual Studio 2012
...
### <a name="vs2010"></a> Las aplicaciones web de protección de recursos y creadas con Visual Studio 2008 o 2010 y Windows Identity Foundation (WIF) v1.0 para .NET 3.5
...
### <a name="other"></a> Aplicaciones Web y API de protección de recursos que usan cualquier otra biblioteca o que implementan manualmente cualquiera de los protocolos admitidos
