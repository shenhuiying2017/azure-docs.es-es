...
Azure AD establece el elemento `Issuer` en `https://login.microsoftonline.com/<TenantIDGUID>/` donde <TenantIDGUID> es el id. de inquilino del inquilino de Azure AD.
