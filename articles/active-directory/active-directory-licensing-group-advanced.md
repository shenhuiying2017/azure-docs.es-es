...
# <a name="azure-active-directory-group-based-licensing-additional-scenarios"></a>Escenarios adicionales de licencias basadas en grupos de Azure Active Directory
