...
3. En la página de diálogo **Configurar las opciones de la aplicación** , realice los pasos siguientes:
  ...
  1. En el cuadro de texto **URL de inicio de sesión**, escriba la dirección URL utilizada por los usuarios para iniciar sesión en la aplicación de Origami con el siguiente patrón: **https://live.origamirisk.com/origami/account/login?account=\<nombre de la compañía\>**. 
...
7. En la página del cuadro de diálogo Single Sign On Setup (Configuración de inicio de sesión único), siga estos pasos:
  ...
  1. Seleccione **Enable Single Sign On**(Habilitar el inicio de sesión único).
  2. En el Portal de Azure clásico, copie el valor de **Dirección URL de inicio de sesión único de SAM**L y péguelo en el cuadro de texto **Identity Provider's Sign-in Page URL** (Dirección URL de página de inicio de sesión del proveedor de identidades).
  3. En el Portal de Azure clásico, copie el valor de **DIRECCIÓN URL DEL SERVICIO DE CIERRE DE SESIÓN ÚNICO** y péguelo en el cuadro de texto **Identity Provider's Sign-out Page URL** (Dirección URL de página de cierre de sesión del proveedor de identidades).
  4. Haga clic en **Browse** (Examinar) para cargar el certificado que ha descargado desde el Portal de Azure clásico.
...
6. En la página de diálogo **Perfil de usuario** , realice los pasos siguientes:
  ...
  ![Creación de un usuario de prueba de Azure AD](./media/active-directory-saas-origami-tutorial/create_aaduser_06.png) 
...
### <a name="create-an-origami-test-user"></a>Creación de un usuario de prueba de Origami
...
5. En el cuadro de diálogo Add New User (Agregar nuevo usuario), realice los pasos siguientes:
  ...
  1. En el cuadro de texto **User Name** (Nombre de usuario), escriba el nombre de usuario de Britta Simon en el Portal de Azure clásico.
  2. En el cuadro de texto **Password** (Contraseña), escriba una contraseña.
  3. En el cuadro de texto **Confirm Password** (Confirmar contraseña), escriba la contraseña de nuevo.
  4. En el cuadro de texto **Nombre**, escriba **Britta**.
  5. En el cuadro de texto **Apellidos**, escriba **Simon**.
...
En esta sección, habilitará a Britta Simon para que use el inicio de sesión único (SSO) de Azure, para lo cual le concederá acceso a Origami.
