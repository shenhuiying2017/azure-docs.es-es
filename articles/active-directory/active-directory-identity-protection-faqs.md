...
## <a name="how-can-i-sort-users-in-users-flagged-for-risk"></a>¿Cómo se pueden clasificar usuarios como "Usuarios marcados en riesgo"?

**R:** Descargue los usuarios marcados para informes de riesgo haciendo clic en **Descargar** en la parte superior de la página **Usuarios marcados en riesgo**. A continuación, puede ordenar los datos descargados en función de los campos disponibles, incluyendo la última actualización (UTC).
