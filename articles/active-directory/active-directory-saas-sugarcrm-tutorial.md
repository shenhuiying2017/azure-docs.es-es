...
9. En la sección **Autenticación SAML** , realice los pasos siguientes:
    ...
    a. En el Portal de Azure clásico, en la página de diálogo **Configurar inicio de sesión único en SugarCRM**, copie el valor de **Dirección URL de inicio de sesión remoto** y péguelo en el cuadro de texto **Dirección URL de inicio de sesión**.
   
    b. En el Portal de Azure clásico, en la página de diálogo **Configurar inicio de sesión único en SugarCRM**, copie el valor de **Dirección URL de inicio de sesión remoto** y péguelo en el cuadro de texto **SLO URL** (Dirección URL de SLO).
    ...
    d. Abra el certificado codificado en base&64; en el Bloc de notas, copie su contenido en el Portapapeles y luego pegue todo el certificado en el cuadro de texto **Certificado X.509** .
...
5. En la pestaña **Perfil de usuario** , realice los siguientes pasos:
    ...
    a. Escriba el nombre de usuario, el apellido y la dirección de correo electrónico de un usuario de Azure Active Directory válido en los cuadros de texto relacionados.
