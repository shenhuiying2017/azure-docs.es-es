...
Azure Portal se ejecuta de manera excelente en tabletas, Mac y PC modernos. Si necesita administrar los recursos de Azure desde un dispositivo móvil, pruebe la aplicación móvil de Azure disponible en iPhone y Android. Para más información, consulte la [Aplicación móvil de Azure](https://azure.microsoft.com/features/azure-portal/mobile-app/).
