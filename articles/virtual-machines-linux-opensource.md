...
- [Trabajo Carga de su propia imagen de distro](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-create-upload-vhd/) (y también instrucciones de uso de una [distribución respaldada por Azure](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-endorsed-distributions/))
...
1. [Trabajo Carga de su propia imagen de Ubuntu](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-create-upload-vhd-ubuntu/)
2. [Trabajo Pila LAMP de Ubuntu](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-install-lamp-stack/)
2. [Imágenes: Pila LAPP](http://azure.microsoft.com/marketplace/partners/bitnami/lappstack54310ubuntu1404/)
3. [Trabajo Clústeres de MySQL](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-mysql-cluster/)
4. [Trabajo Node.js y Cassandra](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-nodejs-running-cassandra/)
5. [Trabajo Bloc de notas de IPython](http://azure.microsoft.com/documentation/articles/virtual-machines-python-ipython-notebook/)
...
2. [Galería de imágenes](http://azure.microsoft.com/marketplace/partners/OpenLogic/)
3. [Trabajo Preparación de una máquina virtual personalizada basada en CentOS para Azure](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-create-upload-vhd-centos/)
...
6. [Trabajo Instalación de Apache Qpid Proton-C para AMQP y Bus de servicio](http://msdn.microsoft.com/library/azure/dn235560.aspx)
...
11. [Trabajo Instalación y ejecución de MySQL](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-mysql-use-opensuse/)
12. [Trabajo Preparación de un SLES personalizado o una máquina virtual openSUSE](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-create-upload-vhd-suse/)  
...
10. [Galería de imágenes](http://azure.microsoft.com/marketplace/partners/coreos/)  
11. [Trabajo Uso de CoreOS en Azure](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-coreos-how-to/)
...
17. [Trabajo Instalación del agente de Linux de Azure](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-agent-user-guide/)
...
19. [Creación de una implementación de varias máquinas virtuales mediante Azure x-plat cli](http://azure.microsoft.com/documentation/articles/virtual-machines-create-multi-vm-deployment-xplat-cli/)
...
23. [API de REST de administración de servicios Azure](https://msdn.microsoft.com/library/azure/ee460799.aspx) (referencia)
...
2. [Trabajo uso del Bus de servicio desde Java con AMQP 1.0](http://msdn.microsoft.com/library/azure/jj841073.aspx)
3. [Trabajo Configurar Tomcat7 en Linux con el Portal de Azure](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-setup-tomcat7-linux/)
...
5. [SDK de administración de servicios de Azure: Ruby](https://github.com/MSOpenTech/azure-sdk-for-ruby)
    - [Trabajo Instalación de Ruby on Rails](http://azure.microsoft.com/documentation/articles/virtual-machines-ruby-rails-web-app-linux/)
    - [Trabajo Instalación de Ruby on Rails con Capistrano, Nginx, Unicorn y PostgreSQL](http://azure.microsoft.com/documentation/articles/virtual-machines-ruby-deploy-capistrano-host-nginx-unicorn/)
6. [SDK de administración de servicios de Azure: Python](https://github.com/Azure/azure-sdk-for-python)
    - [Trabajo Aplicación web Hello World en Django (Mac-Linux)](http://azure.microsoft.com/documentation/articles/virtual-machines-python-django-web-app-linux/)
...
8. [SDK de administración de servicios de Azure: PHP](https://github.com/MSOpenTech/azure-sdk-for-php)
    - [Trabajo Instalación de la pila LAMP en una máquina virtual de Azure](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-install-lamp-stack/)
...
1. [Creación de una implementación de varias máquinas virtuales mediante Azure x-plat cli](http://azure.microsoft.com/documentation/articles/virtual-machines-create-multi-vm-deployment-xplat-cli/)
...
3. MongoDB
    - [Trabajo Creación de una aplicación Node.js en Azure con MongoDB y el complemento de MongoLab](http://azure.microsoft.com/documentation/articles/store-mongolab-web-sites-nodejs-store-data-mongodb/)
4. Cassandra
    - [Trabajo Ejecución de Cassandra con Linux en Azure y acceso desde Node.js](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-nodejs-running-cassandra/)
5. Redis
...
2. Hadoop/Cloudera  
	...
	- [Trabajo Empezar a trabajar con Hadoop y Hive con HDInsight](http://azure.microsoft.com/documentation/articles/hdinsight-get-started/)  
3. [HDInsight de Azure](http://azure.microsoft.com/services/hdinsight/): un servicio Hadoop totalmente administrado en Azure.

### Datos relacionales
2. MySQL
    - [Trabajo Instalación y ejecución de MySQL](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-mysql-use-opensuse/)
    - [Trabajo Optimización del rendimiento de MySQL en Azure](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-optimize-mysql-perf/)
    - [Trabajo Clústeres de MySQL](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-mysql-cluster/)
    - [Trabajo creación de una base de datos de MySQL con Marketplace](http://azure.microsoft.com/documentation/articles/store-php-create-mysql-database/)
    - [Trabajo Django y MySQL en Sitios web Azure con Python y Visual Studio](http://azure.microsoft.com/documentation/articles/web-sites-python-ptvs-django-mysql/)
    - [Trabajo PHP y MySQL en Sitios web Azure con WebMatrix](http://azure.microsoft.com/documentation/articles/web-sites-php-mysql-use-webmatrix/)
7. MariaDB
    - [Trabajo creación de un clúster con varios maestros de MariaDbs](http://azure.microsoft.com/documentation/articles/virtual-machines-mariadb-cluster/)
7. PostgreSQL
    - [Trabajo Instalación de Ruby on Rails con Capistrano, Nginx, Unicorn y PostgreSQL](http://azure.microsoft.com/documentation/articles/virtual-machines-ruby-deploy-capistrano-host-nginx-unicorn/)
...
1. Docker
	...
	- [Cómo usar una máquina docker en Azure]
	- [Cómo usar docker con enjambre en Azure]
...
[Cómo usar una máquina docker en Azure]: ../virtual-machines-docker-machine/
[Cómo usar docker con enjambre en Azure]: ../virtual-machines-docker-swarm/
