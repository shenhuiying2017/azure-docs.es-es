...
[¿Qué es el almacenamiento en cola?][]   
 ...
 [Carga de una cola][]   
 [Carga un mensaje en una cola][]   
 [Carga del siguiente mensaje][]   
 [Carga siguiente mensaje de la cola][]   
 [Carga contenido de un mensaje en cola][]   
 [Carga para quitar mensajes de la cola][]   
 [Carga la longitud de la cola][]   
 [Carga una cola][]   
 [Pasos siguientes][]
...
-   Visite el [blog del equipo de almacenamiento de Azure][].
  ...
  [Carga de una cola]: #create-queue
  [Carga un mensaje en una cola]: #insert-message
  [Carga del siguiente mensaje]: #peek-message
  [Carga siguiente mensaje de la cola]: #get-message
  [Carga contenido de un mensaje en cola]: #change-contents
  [Carga para quitar mensajes de la cola]: #advanced-get
  [Carga la longitud de la cola]: #get-queue-length
  [Carga una cola]: #delete-queue
