...
Si va a crear conjunto de escalado desde su propia imagen personalizada, en lugar de hacer referencia a una imagen de máquina virtual desde la galería, el comando _Set-AzureRmVmssStorageProfile_ debe ser similar al siguiente:
```PowerShell
