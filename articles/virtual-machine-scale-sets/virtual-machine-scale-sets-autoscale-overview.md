...
Para ver ejemplos del uso de PowerShell para configurar el escalado automático, consulte [Ejemplos de inicio rápido de Powershell de Azure Insights](../azure-portal/insights-powershell-samples.md).

## <a name="set-up-scaling-using-azure-cli"></a>Configuración del escalado con la CLI de Azure

Para ver ejemplos del uso de la CLI de Azure para configurar el escalado automático, consulte [Ejemplos de inicio rápido de CLI multiplataforma de Azure Insights](../azure-portal/insights-cli-samples.md).
