...
- No planee más de 20 máquinas virtuales por cuenta de almacenamiento (a no ser que establezca la propiedad _overprovision_ en "falso", en cuyo caso puede aumentar hasta 40).
...
**R.** 100 si usa imágenes de plataforma que se puedan distribuir entre varias cuentas de almacenamiento. Si usa imágenes personalizadas, hasta 40 (si la propiedad _overprovision_ está establecida en "falso", 20 de forma predeterminada), porque las imágenes personalizadas se limitan a una única cuenta de almacenamiento durante la vista previa.
