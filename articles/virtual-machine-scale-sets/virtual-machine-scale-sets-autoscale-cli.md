...
Para crear reglas de escalado automático, necesita un conjunto de escalado de máquinas virtuales ya existente. Puede crear un conjunto de escalado mediante [Azure Portal](virtual-machine-scale-sets-portal-create.md), la [CLI de Azure 2.0](virtual-machine-scale-sets-create.md#create-from-azure-cli) o [Azure PowerShell](virtual-machine-scale-sets-create.md#create-from-powershell).
