...
La capacidad del conjunto de escalado tarda unos minutos en actualizarse. Si reduce la capacidad de un conjunto de escalado, las máquinas virtuales con los identificadores de instancia más altos se eliminan primero.
