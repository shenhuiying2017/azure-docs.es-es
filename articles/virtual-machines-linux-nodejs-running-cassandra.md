...
Use el comando "sudo waagent -deprovision+user" para quitar la información específica de la instancia de máquina virtual. Consulte [Cómo capturar una máquina virtual Linux](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-capture-image/) para usarla como una plantilla. Encontrará más detalles en el proceso de captura de imagen. 
