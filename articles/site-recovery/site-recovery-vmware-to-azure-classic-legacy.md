---
title: Replicación de máquinas virtuales de VMware y servidores físicos en Azure con Azure Site Recovery (heredado) | Microsoft Docs
...
6. Si ejecuta Linux:
   ...
   4. Extraiga los archivos del instalador comprimidos con gzip ejecutando: **tar –xvzf Microsoft-ASR\_UA\_8.4.0.0\_RHEL6-64*** ![Servidor de destino principal de Linux](./media/site-recovery-vmware-to-azure-classic-legacy/linux-tar.png)
...
> [!NOTE]
> Pueden pasar hasta 15 minutos después de completar el registro hasta que el servidor de destino maestro se muestre en el portal. Para que se actualice inmediatamente, haga clic en **Actualizar** en la pestaña **Servidores de configuración**.
> 
> 
...
5. Tenga en cuenta que debe reiniciar el equipo para completar la instalación. En **Servidor de configuración** > **Detalles del servidor**, compruebe que el servidor de proceso aparece y que está correctamente registrado en el almacén.
...
2. Puede modificar el nombre que se asignará al equipo de Azure después de la conmutación por error así como el tamaño de la máquina virtual de Azure. También puede seleccionar la red de Azure a la que se conectará el equipo después de la conmutación por error.
   ...
   > [!NOTE]
   > El [Migration of networks](../resource-group-move-resources.md) entre grupos de recursos de la misma suscripción o entre suscripciones no se admite en las redes usadas para implementar Site Recovery.
   > 
   > 
