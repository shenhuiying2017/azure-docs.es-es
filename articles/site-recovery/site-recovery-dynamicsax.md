...
• Se ha creado un almacén de los servicios de Azure Site Recovery en una suscripción de Microsoft Azure 

• Además, si Azure es su sitio de recuperación, debe ejecutar la herramienta de evaluación de la disponibilidad de máquinas virtuales de Azure en las máquinas virtuales para asegurarse de que son compatibles con las máquinas virtuales de Azure y los servicios de Azure Site Recovery.
