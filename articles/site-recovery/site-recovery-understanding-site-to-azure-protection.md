<properties
	pageTitle="Replicación de Hyper-V con Azure Site Recovery | Microsoft Azure"
...
# Replicación de Hyper-V con Azure Site Recovery
...
## Configuración del entorno de origen para la replicación entre una ubicación local y Azure
...
### Finalizar la protección en la máquina virtual
