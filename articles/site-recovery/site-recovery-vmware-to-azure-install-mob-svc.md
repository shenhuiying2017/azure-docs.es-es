...
> Si está utilizando un servidor de configuración para replicar máquinas virtuales de Azure IaaS de una suscripción o región de Azure a otra, utilice el método de instalación basado en línea de comandos.
