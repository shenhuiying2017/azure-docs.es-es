...
|Microsoft-ASR\_UA\*RHEL6-64*release.tar.gz| RHEL 6.4, 6.5, 6.6 (solo de 64 bits) </br> CentOS 6.4, 6.5, 6.6 (solo 64 bits) |
...
|Microsoft-ASR_UA\*Ubuntu-14.04-64\*release.tar.gz | Ubuntu 14.04 (solo de 64 bits)|
