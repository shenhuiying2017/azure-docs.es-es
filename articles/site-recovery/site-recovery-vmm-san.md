...
8. En **Nombre del servidor**, especifique un nombre descriptivo para identificar el servidor VMM en el almacén.
	...
	![Registro de servidor](./media/site-recovery-vmm-san/SRSAN_ProviderRegKeyServerName.png)
