...
Si no ve la máquina virtual de Azure para seleccionarla cuando habilita la replicación, puede deberse a que queda alguna configuración obsoleta de Site Recovery en la máquina virtual de Azure. Esta situación podría darse en los siguientes casos:
