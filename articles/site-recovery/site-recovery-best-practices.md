...
**Máquinas virtuales** | Necesitará al menos una máquina virtual en el servidor de Hyper-V de origen. Las máquinas virtuales que se replican a Azure deben cumplir los [requisitos previos de las máquinas virtuales de Azure](#azure-virtual-machine-requirements). | Al menos una máquina virtual en el servidor de Hyper-V de origen. Las máquinas virtuales que se replican a Azure deben cumplir los [requisitos previos de las máquinas virtuales de Azure](#azure-virtual-machine-requirements). | Al menos una VM en la nube VMM de origen.
