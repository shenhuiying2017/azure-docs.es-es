...
- **Planificación de capacidad**: para obtener instrucciones, use la [Planificación de capacidad para la réplica de Hyper-V](http://www.microsoft.com/es-es/download/details.aspx?id=39057).
