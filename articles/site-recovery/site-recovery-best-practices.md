...
- **Planeación de capacidad**: lea sobre [Planificación de capacidad para la réplica de Hyper-V](http://www.microsoft.com/download/details.aspx?id=39057) si va a replicar máquinas virtuales de Hyper-V.
