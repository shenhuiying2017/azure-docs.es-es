...
# <a name="replicate-applications"></a>Replicación de aplicaciones
...
Una vez completada la protección, puede tratar de realizar una conmutación por error de prueba para comprobar si la aplicación aparece en Azure o no.
