---
title: "Ejecución de una conmutación por error de prueba para la replicación de Hyper-V (sin System Center VMM) en Azure | Microsoft Docs"
description: "Se resumen los pasos necesarios para ejecutar una conmutación por error para la replicación de máquinas virtuales de Hyper-V a Azure mediante el servicio Azure Site Recovery."
