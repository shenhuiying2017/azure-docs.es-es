...
description: "Describe cómo implementar Azure Site Recovery para orquestar la replicación, ejecutar la conmutación por error y la recuperación de máquinas virtuales de Hyper-V que están en nubes de VMM en Azure mediante Azure Portal"
...
---
# <a name="replicate-hyperv-virtual-machines-in-vmm-clouds-to-azure-using-the-azure-portal"></a>Replicación de máquinas virtuales de Hyper-V que están en nubes VMM en Azure mediante Azure Portal
...
Para una implementación completa, se recomienda que siga todos los pasos del artículo. Pero si dispone de poco tiempo, este es un resumen rápido con vínculos a información adicional.
...
|  **Limitaciones de Azure** |Si usa GRS, necesita otra cuenta LRS para el registro<br/><br/> Las cuentas de almacenamiento creadas en Azure Portal no pueden moverse entre grupos de recursos.<br/><br/> Premium Storage no se admite. |
...
Azure cuenta con dos modelos de implementación diferentes (../resource-manager-deployment-model

> ) para crear recursos y trabajar con ellos: Azure Resource Manager y clásico. Azure cuenta también con dos portales: el Portal de Azure clásico y Azure Portal. En este artículo se describe cómo realizar la implementación en Azure Portal. 
> 
> 

Site Recovery en Azure Portal incluye nuevas características:

* Los servicios de Azure Backup y Azure Site Recovery se combinan en un único almacén de Recovery Services para que pueda configurar y administrar la continuidad empresarial y la recuperación ante desastres (BCDR) desde una sola ubicación. Un panel unificado permite supervisar y administrar operaciones en los sitios locales y en la nube pública de Azure.
...
* En Azure Portal puede replicar máquinas en cuentas de almacenamiento de Azure Resource Manager. En una conmutación por error, Site Recovery crea máquinas virtuales basadas en Resource Manager en Azure.
...
## <a name="onpremises-prerequisites"></a>Requisitos previos locales
...
#### <a name="commandline-installation-for-the-azure-site-recovery-provider"></a>Instalación mediante la línea de comandos del proveedor de Azure Site Recovery
...
### <a name="install-the-azure-recovery-services-agent-on-hyperv-hosts"></a>Instale el agente de los Servicios de recuperación de Azure en servidores host de Hyper-V
...
#### <a name="set-up-internet-proxy-access-to-site-recovery-from-hyperv-hosts"></a>Configuración del acceso de proxy a Internet para Site Recovery desde hosts de Hyper-V
