---
title: "Configuración de una directiva de replicación para replicar servidores físicos de VMware en Azure con Azure Site Recovery | Microsoft Docs"
description: "Resume los pasos necesarios para configurar una directiva de replicación al replicar servidores físicos locales en Azure Storage mediante el servicio Azure Site Recovery"
...
---
# <a name="step-8-set-up-a-replication-policy-for-physical-server-replication-to-azure"></a>Paso 8: Configuración de una directiva de replicación para replicar servidores físicos en Azure


En este artículo se describe cómo configurar una directiva de replicación al replicar servidores físicos de Windows/Linux mediante el servicio [Azure Site Recovery](site-recovery-overview.md) en Azure Portal.
...
3. En **Umbral de RPO**, especifique el límite de RPO. Este valor indica la frecuencia con que se crean puntos de recuperación de datos. Se genera una alerta cuando la replicación continua supera este límite.
...
Vaya a [Paso 9: Instalación de Mobility Service](physical-walkthrough-install-mobility.md)
