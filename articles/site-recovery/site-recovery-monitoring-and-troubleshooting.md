...
### <a name="vmware/physical-site-deployment-for-replication-between-on-premises-and-azure."></a>Implementación del sitio de VMware/físico para la replicación entre una ubicación local y Azure.
...
### <a name="vmm-site-deployment-for-replication-between-on-premises-site."></a>Implementación del sitio de VMM para la replicación entre el sitio local.
...
### <a name="vmm-site-deployment-for-replication-between-on-premises-&-azure."></a>Implementación del sitio de VMM para la replicación entre el sitio local y Azure.
...
### <a name="hyper-v-site-deployment-for-replication-between-on-premises-&-azure"></a>Implementación del sitio de Hyper-V para la replicación entre el sitio local y Azure
...
## <a name="monitor-configuration,-protection-and-recovery-operations"></a>Supervisar las operaciones de configuración, protección y recuperación
...
## <a name="monitor-replication-health-for-virtual-machine"></a>Supervisar el estado de replicación de la máquina virtual
...
![Solucionar problemas de Hyper-V locales](media/site-recovery-monitoring-and-troubleshooting/image19.png)
...
## <a name="reaching-out-for-microsoft-support"></a>Contacto con el soporte técnico de Microsoft
...
* [Understand & Troubleshoot Hyper-V Replica Guide](http://www.microsoft.com/en-in/download/details.aspx?id=29016) (Guía de descripción y solución de problemas de Réplica de Hyper-V) 

## <a name="common-asr-errors-and-their-resolutions"></a>Errores de ASR comunes y sus soluciones
...
### <a name="configuration-server,-process-server,-master-target"></a>Servidor de configuración, Servidor de proceso y Destino principal
...
Si el botón **Conectar** del portal está atenuado y no está conectado a Azure a través de una conexión Express Route o VPN de sitio a sitio, deberá crear y asignar a la máquina virtual una dirección IP pública antes de poder usar RDP/SSH. Siga estos pasos para agregar una dirección IP pública en la interfaz de red de la máquina virtual.  
