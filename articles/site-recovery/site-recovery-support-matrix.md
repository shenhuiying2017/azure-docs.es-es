...
# Matriz de compatibilidad de Azure Site Recovery

En este artículo se resumen los sistemas operativos y los componentes compatibles con las implementaciones de Azure Site Recovery. Cada escenario de implementación tiene una lista de requisitos previos y componentes compatibles, disponible en cada artículo de la implementación, pero en este tema los resume.

## Sistemas operativos compatibles para servidores de virtualización


**Replicar** | **Lo que se replica** | **Replicación en** | **Sistema operativo del host**
---|---|---|--- 
**Hosts de Hyper-V** | Cualquier carga de trabajo | Las tablas de Azure | Windows Server 2012 R2 con las últimas actualizaciones
**Hosts de Hyper-V en nubes de VMM** | Cualquier carga de trabajo | Las tablas de Azure | Windows Server 2012 R2 con las últimas actualizaciones
**Hosts de Hyper-V en nubes de VMM** | Cualquier carga de trabajo | Sitio secundario de VMM | Al menos Windows Server 2012 con las últimas actualizaciones
**VCenter o hosts de VMware** | Cualquier carga de trabajo | Las tablas de Azure | vCenter 5.5 o 6.0 (compatible solo con características de 5.5) <br/><br/> vSphere 6.0, 5.5 o 5.1 con las últimas actualizaciones
**VCenter o hosts de VMware** | Cualquier carga de trabajo | Sitio secundario de VMware | vCenter 5.5 o 6.0 (compatible solo con características de 5.5) <br/><br/> vSphere 6.0, 5.5 o 5.1 con las últimas actualizaciones

## Requisitos de compatibilidad para las máquinas replicadas
...
**Máquinas virtuales de Hyper-V en la nube de VMM** | Cualquier carga de trabajo | Las tablas de Azure | Cualquier sistema operativo invitado [compatible con Azure](https://technet.microsoft.com/library/cc794868.aspx)<br/><br/> Las máquinas virtuales deben cumplir los [requisitos de Azure](site-recovery-best-practices.md#azure-virtual-machine-requirements)
**Máquinas virtuales de Hyper-V en nubes de VMM** | Cualquier carga de trabajo | Sitio secundario de VMM | Cualquier sistema operativo invitado [compatible con Hyper-V](https://technet.microsoft.com/library/mt126277.aspx)
