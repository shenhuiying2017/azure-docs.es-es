---
title: Replicación de máquinas virtuales de Hyper-V (en nubes de VMM) en un sitio de VMM secundario | Microsoft Docs
...
5. La ubicación de instalación está establecida en **<UnidadDeSistema>\\Program Files\\Microsoft System Center 2012 R2\\Virtual Machine Manager\\bin**. Haga clic en el botón Instalar para iniciar la instalación del proveedor.
