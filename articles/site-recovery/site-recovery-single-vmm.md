...
---
title: 'Azure Site Recovery: replicación de máquinas virtuales de Hyper-V en un único servidor VMM | Microsoft Docs'
...
8. Si desea crear planes de recuperación, especifique el mismo servidor VMM de origen que de destino.
