---
title: "Creación de planes de recuperación | Microsoft Docs"
...
* Puede ampliar los planes de recuperación con scripts y acciones manuales. Tenga en cuenta lo siguiente:
  ...
  * Si utiliza VMM en la implementación, tenga en cuenta que:
    ...
    * Si la ruta de acceso del recurso compartido de biblioteca es remota, o local pero no se comparte con MSCVMMLibrary, configure el recurso compartido como se indica a continuación (por ejemplo, con \\\libserver2.contoso.com\share\):
      * Abra el Editor del Registro y navegue hasta HKEY_LOCAL_MACHINE\SOFTWARE\MICROSOFT\Azure Site Recovery\Registration.
...
1. Haga clic en la pestaña **Planes de recuperación** > **Crear plan de recuperación**.
   Especifique un nombre para el plan de recuperación y un origen y destino. El servidor de origen debe tener máquinas virtuales habilitadas para conmutación por error y recuperación.
...
## <a name="customize-recovery-plans"></a>Personalización de planes de recuperación
...
## <a name="extend-recovery-plans-with-scripts"></a>Extensión de planes de recuperación con scripts
...
### <a name="create-a-vmm-script"></a>Creación de un script de VMM
...
### <a name="create-an-azure-automation-runbook"></a>Creación de un runbook de automatización de Azure
...
### <a name="add-custom-settings-to-a-recovery-plan"></a>Adición de una configuración personalizada a un plan de recuperación
...
5. Si va a agregar un runbook de automatización de Azure, especifique la **cuenta de Azure Automation** en que se encuentra el runbook y seleccione el valor de **Script de runbook de Azure** adecuado.
