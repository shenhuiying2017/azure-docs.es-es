...
* Una cuenta de Almacenamiento de Azure. Si no tiene ninguna cuenta de Azure Storage, puede usar el [CLI de Azure 2.0: Administrar cuentas de almacenamiento][lnk-manage-storage] para crear una o usar el portal para [Crear una cuenta de almacenamiento][lnk-portal-storage].
