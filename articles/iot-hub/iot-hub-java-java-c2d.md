...
---
# <a name="tutorial-how-to-send-cloud-to-device-messages-with-iot-hub-and-java"></a>Tutorial: cómo enviar mensajes de la nube a un dispositivo con el Centro de IoT y Java
