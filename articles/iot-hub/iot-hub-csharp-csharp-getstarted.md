<properties
	pageTitle="Introducción al centro de IoT | Microsoft Azure"
...
Al final de este tutorial habrá creado tres aplicaciones de consola de Windows:
...
- [Send Cloud-to-Device messages with IoT Hub] (Envío de mensajes de nube a dispositivo con el centro de IoT) muestra cómo enviar mensajes a dispositivos y procesar los comentarios de entrega generados por el centro de IoT.
