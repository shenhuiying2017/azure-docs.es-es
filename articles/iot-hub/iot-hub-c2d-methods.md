...
> [!NOTE]
> El artículo [IoT Hub SDKs][lnk-hub-sdks] (Los SDK de IoT Hub) proporciona información acerca de los SDK que puede usar para crear las aplicaciones que se ejecuten en dispositivos y en el back-end de la solución.
> 
> 
