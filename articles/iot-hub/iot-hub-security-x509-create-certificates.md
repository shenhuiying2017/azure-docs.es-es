...
1. Abra una ventana de PowerShell como *administrador*.  
   **NOTA:** Debe abrirla en el propio PowerShell, no en PowerShell ISE, Visual Studio Code u otras herramientas que encapsulen la consola de PowerShell subyacente.  Si se usa PowerShell no basado en consola, se colgarán los comandos `openssl` siguientes.
