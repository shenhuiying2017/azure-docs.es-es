...
Consulte la introducción al uso de estos dispositivos [aquí](https://azure.microsoft.com/develop/iot/get-started/) o visite nuestro [repositorio](https://github.com/Azure/azure-iot-sdks) de GitHub y busque en los documentos de dispositivo por idioma.

## Pasos siguientes

Aprenda más sobre el desarrollo de soluciones con dispositivos **certificados para IoT** [aquí](http://azure.com/iotdev).
