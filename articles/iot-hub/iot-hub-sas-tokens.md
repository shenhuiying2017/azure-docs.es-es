---
title: Generación de tokens de seguridad del Centro de IoT | Microsoft Docs
...
**Nota sobre el prefijo**: el prefijo URI se calcula por segmento y no por carácter. Por ejemplo, `/a/b` es un prefijo de `/a/b/c`, pero no de `/a/bc`.
...
> [!NOTE]
> Es posible generar un token seguro mediante la herramienta [Explorador de dispositivos][lnk-device-explorer] de la herramienta .NET.
> 
> 
