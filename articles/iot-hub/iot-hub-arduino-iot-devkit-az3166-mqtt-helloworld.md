...
3. Conecte el DevKit al equipo.
    Código de VS detecta automáticamente el DevKit y abre las páginas siguientes:
...
![carpeta-ejemplos](media/iot-hub-arduino-iot-devkit-az3166-mqtt-helloworld/examples.png)
