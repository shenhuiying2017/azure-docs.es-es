...
---
# <a name="send-messages-from-the-cloud-to-your-simulated-device-with-iot-hub-net"></a>Envío de mensajes desde la nube al dispositivo simulado con IoT Hub (.NET)
