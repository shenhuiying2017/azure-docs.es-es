---
title: "Conexión de Intel Edison (Node) a Azure IoT: Introducción | Microsoft Docs"
...
---
# <a name="connect-your-intel-edison-device-to-your-iot-hub-using-nodejs"></a>Conexión de un dispositivo Intel Edison a su IoT Hub mediante Node.js
...
Vaya a [Creación de un centro de IoT Hub y registro de Intel Edison](iot-hub-intel-edison-kit-node-lesson2-prepare-azure-iot-hub.md).
