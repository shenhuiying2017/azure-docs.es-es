---
title: "Información de la limitación y las cuotas de Azure IoT Hub | Microsoft Docs"
...
Cada IoT Hub se aprovisiona con un determinado número de unidades en una SKU específica (para más información, consulte [Precios de Azure IoT Hub][lnk-pricing]). El valor de SKU y el número de unidades determinan la cuota diaria máxima de mensajes que puede enviar.

El valor de SKU también determina los valores de limitación que aplica IoT Hub a las operaciones.
...
> [!NOTE]
> En cualquier momento, es posible aumentar las cuotas o las limitaciones si aumenta el número de unidades aprovisionadas en IoT Hub.
> 
> [!IMPORTANT]
...
> [!NOTE]
> Actualmente, el número máximo de dispositivos que pueden conectarse a un solo IoT Hub es de 500 000. Si quiere aumentar este límite, póngase en contacto con el [soporte técnico de Microsoft](https://azure.microsoft.com/support/options/).
