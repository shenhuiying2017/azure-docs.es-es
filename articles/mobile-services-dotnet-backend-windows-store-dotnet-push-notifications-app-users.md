<properties pageTitle="Envío de notificaciones de inserción a usuarios autenticados" description="Obtenga información acerca de cómo enviar notificaciones de inserción a servicios 
	específicos="servicios móviles, centros de notificaciones" documentationCenter="windows" authors="ggailey777" manager="dwrede" editor=""/>
