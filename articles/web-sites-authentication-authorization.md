<properties 
	pageTitle="Usar Active Directory para la autenticación en el servicio de aplicaciones de Azure" 
...
# Usar Active Directory para la autenticación en el servicio de aplicaciones de Azure #
