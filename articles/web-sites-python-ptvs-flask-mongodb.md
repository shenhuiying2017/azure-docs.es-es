<properties 
	...
	description="Obtenga información acerca de cómo usar las herramientas de Python para Visual Studio para crear una aplicación Flask que almacene datos en una instancia de base de datos de MongoDB y se pueda implementar en un sitio web." 
...
En este tutorial, usaremos las [herramientas de Python para Visual Studio][] a fin de crear una aplicación de sondeos sencilla mediante una de las plantillas de ejemplo de PTVS. Este tutorial también se encuentra disponible como [vídeo](https://www.youtube.com/watch?v=eql-crFgrAE)
...
1.  En la parte inferior del panel de navegación, haga clic en **NEW**.
  	...
  	![Botón Nuevo](./media/web-sites-python-ptvs-flask-mongodb/PollsCommonAzurePlusNew.png)

1.  Haga clic en **ALMACÉN** y en **MongoLab**.

  	![Cuadro de diálogo Elegir complemento](./media/web-sites-python-ptvs-flask-mongodb/PollsCommonMongoLabAddon1.png)
...
1.  Seleccione un grupo de región/afinidad en el que ubicar el servicio de base de datos. Si va a usar la base de datos desde la aplicación de Azure, seleccione la misma región en la que implementará la aplicación.
  	...
  	![Cuadro de diálogo Personalizar complemento](./media/web-sites-python-ptvs-flask-mongodb/PollsCommonMongoLabAddon2.png)
...
1.  Haga clic en **INFORMACIÓN DE CONEXIÓN**.  Puede usar el botón Copiar para colocar el valor de **MONGOLAB_URI** en el Portapapeles.
...
1.  Cree una conexión nueva.  Necesitará el valor de **MONGOLAB_URI** que hemos recuperado en la sección anterior.
...
1.  En la página de conexión, establezca el valor **Nombre** con el nombre que desee para la conexión.  Establezca también los campos **Dirección** y **Puerto** para la  *address* y el  *port* de **MONGOLAB_URI**.
...
1.  En la página de autenticación, establezca **Base de datos** y **Nombre de usuario** con el  *name* de **MONGOLAB_URI**.  Establezca también el valor **Contraseña** para la  *password* de **MONGOLAB_URI**.
...
1.  En el **Explorador de soluciones**, haga clic con el botón secundario en el nodo del proyecto y seleccione **Publicar**.
  	...
  	![Cuadro de diálogo Publicación web](./media/web-sites-python-ptvs-flask-mongodb/PollsCommonPublishWebSiteDialog.png)
...
1.  Seleccione un **Nombre de sitio** y una **Región** y haga clic en **Crear**.
  	...
  	![Cuadro de diálogo Crear sitio en Microsoft Azure](./media/web-sites-python-ptvs-flask-mongodb/PollsCommonCreateWebSite.png)
...
1.  En el menú superior, haga clic en **CONFIGURAR**.
  	...
  	![Menú superior](./media/web-sites-python-ptvs-flask-mongodb/PollsCommonWebSiteTopMenu.png)

1.  Desplácese hacia abajo hasta la sección **Configuración de la aplicación** y establezca los valores para **REPOSITORY_NAME**, **MONGODB_HOST** y **MONGODB_DATABASE**, como se describe en la sección anterior.

  	![Configuración de aplicaciones](./media/web-sites-python-ptvs-flask-mongodb/PollsCommonWebSiteConfigureSettingsMongoDB.png)

1.  En el menú inferior, haga clic en **GUARDAR**, en **REINICIAR** y, por último, en **EXAMINAR**.

  	![Menú inferior](./media/web-sites-python-ptvs-flask-mongodb/PollsCommonWebSiteConfigureBottomMenu.png)
