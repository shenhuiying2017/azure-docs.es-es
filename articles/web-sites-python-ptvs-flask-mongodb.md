<properties 
	...
	description="Aprenda a usar las herramientas de Python para Visual Studio para crear una aplicación de Flask que almacene datos en una instancia de base de datos MongoDB y puedan implementarse en un sitio web."" 
	services="" 
...
En este tutorial, crearemos una aplicación de sondeos sencilla con la utilización de una de las plantillas de ejemplo de PTVS. Este tutorial también se encuentra disponible en [vídeo](https://www.youtube.com/watch?v=eql-crFgrAE).
