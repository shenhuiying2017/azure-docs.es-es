...
Una vez recuperada la base de datos, podrá configurarla para el uso. Para ello siga los pasos descritos en la guía [Finalización de una base de datos recuperada](articles/sql-database-recovered-finalize.md).
###PowerShell 
Use PowerShell para realizar la recuperación de la base de datos mediante programación.
