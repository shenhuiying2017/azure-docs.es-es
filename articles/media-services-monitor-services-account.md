...
**Nota:** existen costes adicionales asociados a la supervisión de los datos de almacenamiento en el Portal de administración de Azure. Para obtener más información, consulte [Facturación del análisis de almacenamiento](http://go.microsoft.com/fwlink/?LinkId=256667).
...
Supervisión del uso de almacenamiento de blobs (opcional)
---------------------------------------------------------
...
1.  Al finalizar la configuración de la supervisión, haga clic en **Save**. De manera similar a las métricas de Servicios multimedia, debería empezar a ver los datos de supervisión en el panel al cabo de una hora aproximadamente. Las métricas se almacenan en la cuenta de almacenamiento en cuatro tablas denominadas \$MetricsTransactionsBlob, \$MetricsTransactionsTable, \$MetricsTransactionsQueue y \$MetricsCapacityBlob. Para obtener más información, consulte [Storage Analytics Metrics](http://go.microsoft.com/fwlink/?LinkId=256668).
