<properties 
	pageTitle="Configuración de un nombre de dominio de Dotster para un sitio web de Azure" 
	description="Obtenga información acerca de cómo configurar un sitio web de Azure para usar un nombre de dominio registrado con Dotster" 
	services="web-sites" 
	documentationCenter="" 
	authors="blackmist" 
	manager="wpickett" 
...
En este artículo se ofrecen instrucciones acerca del uso de un nombre de dominio personalizado que se ha adquirido en [Dotster.com](https://dotster.com) con Sitios web Azure.
...
5. Especifique los campos **Host** y **Points To (Apunta a)** para el registro. Una vez terminado, haga clic en el botón **Add (Agregar)**.
    ...
    * Al agregar un registro CNAME, debe configurar el campo **Host** con el subdominio que desee usar. Por ejemplo, **www**. Debe definir el campo **Apunta a** con el nombre de dominio **.azurewebsites.net** de su Sitio web Azure. Por ejemplo, **contoso.azurwebsites.net**.

    * Cuando agregue un registro A, debe establecer el campo **Host** a **@** (esto representa el nombre del dominio raíz, como **contoso.com**) o el subdominio que desea usar (por ejemplo, **www**). Debe establecer el campo **Points to** en la dirección IP de su sitio web de Azure.
		...
		> 
		> * Un valor **Host** de **www** con un valor de **Apunta a** de **&lt;nombredesusitioweb&gt;.azurewebsites.net**.
		> 
		> O bien
		> 
		> * Un valor **Host** de **awverify.www** que **Apunta a** un valor de **awverify.&lt;nombredesusitioweb&gt;.azurewebsites.net**.
		> 
