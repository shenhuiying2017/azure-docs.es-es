...
4.  Una vez creado el sitio web, se mostrará el texto **Creating web site <*nombre del sitio web*> succeeded**. Puede explorar el sitio web haciendo clic en **Browse** en la parte inferior de la página del portal.
...
8. **Certificates**: En modo estándar, puede cargar certificados SSL para los dominios personalizados.
...
* **Monitoring**: En los sitios web en modo estándar, puede usar esta característica para probar la disponibilidad de los extremos HTTP o HTTPS.
