...
* Para información sobre cómo publicar aplicaciones administradas en Azure Marketplace, consulte [Aplicaciones administradas en Marketplace](publish-marketplace-app.md).