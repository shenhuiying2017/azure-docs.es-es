...
En el [Portal de Azure](https://portal.azure.com), puede administrar las aplicaciones web a través de una serie de *blades*, que son contenedores de los distintos componentes. (Para obtener información general del Portal de Azure, consulte la guía de cambios del [Portal](http://go.microsoft.com/fwlink/?LinkId=529715)). 
...
- **Configuración** para ver una lista de todas las opciones de administración.
...
**Aspectos básicos** muestra información básica acerca de la aplicación, como la dirección URL, ubicación, plan del [Servicio de aplicaciones](http://go.microsoft.com/fwlink/?LinkId=529714) y estado actual (en ejecución, detenido, etc.).
...
**Supervisión** también incluye elementos para configurar el análisis, configurar la supervisión de aplicaciones y crear pruebas de disponibilidad. Para obtener más información, consulte [Conceptos básicos de supervisión para las aplicaciones web en el Servicio de aplicaciones de Azure](web-sites-monitor.md).
...
- [Escalación de una aplicación web en Servicio de aplicaciones de Azure](how-to-scale-websites.md).
- [Ejecución de tareas en segundo plano con WebJobs](web-sites-create-web-jobs.md)
- [Copias de seguridad ](web-sites-backup.md) y [restauración de aplicaciones web de Azure](web-sites-restore.md)
