<properties title="Learn how to configure an Azure website that uses Traffic Manager to use a domain name registered with Directnic" pageTitle="Configuración de un nombre de dominio de Directnic para un sitio web de Azure mediante el Administrador de tráfico" metaKeywords="Microsoft Azure, Sitios web Microsoft Azure, Directnic, Traffic Manager" description="Obtenga información acerca de cómo configurar un sitio web de Azure que usa el Administrador de tráfico para usar un nombre de dominio registrado con Directnic" services="web-sites" documentationCenter="" authors="larryfr,jroth" manager="wpickett" />
