...
En esta migración la solución utiliza Base de datos SQL de Azure, pero no es la única base de datos que se admite en Azure. Las compañías también usan MySQL, MongoDB, Microsoft Azure DocumentDB, entre otros, a través de complementos que se pueden comprar en la [Tienda de Azure](http://aka.ms/azurestore). 
