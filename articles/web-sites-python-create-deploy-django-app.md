...
Creación del sitio web en el portal
-----------------------------------

El primer paso para crear la aplicación consiste en crear el sitio web a través del Portal de administración de Azure. Para ello, deberá iniciar sesión en el portal y hacer clic en el botón NEW de la esquina inferior izquierda. Aparecerá una ventana. Haga clic en **Quick Create**, especifique una dirección URL y seleccione **Create Web Site**.
