...
9. Escriba el nombre de la cuenta de almacenamiento en **Nombre de cuenta**.
   ...
   > 
   > 
10. En el cuadro **Clave de cuenta**, escriba la clave principal o cópiela del [Portal de Azure clásico](http://go.microsoft.com/fwlink/?LinkID=213885) y péguela. Para copiar esta clave:
