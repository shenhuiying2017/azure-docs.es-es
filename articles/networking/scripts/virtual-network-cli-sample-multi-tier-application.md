...
[!code-azurecli[main](../../../cli_scripts/virtual-network/virtual-network-multi-tier-application/virtual-network-multi-tier-application.sh  "Red virtual para la aplicación de niveles múltiples")]
