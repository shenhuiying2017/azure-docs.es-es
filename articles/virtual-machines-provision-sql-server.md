<properties urlDisplayName="Install SQL Server" pageTitle="Aprovisionamiento de una m&aacute;quina virtual de SQL Server en Azure " metaKeywords="Azure tutorial creating SQL Server, SQL Server vm, configuring SQL Server" description="Un tutorial que le ense&ntilde;a c&oacute;mo crear y configurar una m&aacute;quina virtual de SQL Server en Azure." metaCanonical="" services="virtual-machines" documentationCenter="" title="Aprovisionamiento de una m&aacute;quina virtual de SQL Server en Azure" authors="selcint" solutions="" manager="jeffreyg" editor="tyson" />
...
-   [Conectarse al Portal de administración de Azure y aprovisionar una máquina virtual desde la galería][Conectarse al Portal de administración de Azure y aprovisionar una máquina virtual desde la galería]
-   [Abrir la máquina virtual con Escritorio remoto y finalizar la configuración][Abrir la máquina virtual con Escritorio remoto y finalizar la configuración]
-   [Finalizar los pasos de configuración para conectarse a la máquina virtual con SQL Server Management Studio en otro equipo][Finalizar los pasos de configuración para conectarse a la máquina virtual con SQL Server Management Studio en otro equipo]
...
1.  Inicie sesión en el [Portal de administración de Azure][Portal de administración de Azure] con su cuenta. Si no tiene una cuenta de Azure, visite [Evaluación gratuita de Azure][Evaluación gratuita de Azure].
...
3.  En la página **Create a Virtual Machine**, seleccione una imagen de máquina virtual que contenga SQL Server y, a continuación, haga clic en la flecha de avance en la parte inferior de la página. Para conocer la información más actualizada sobre las imágenes compatibles de SQL Server en Azure, consulte el tema [Introducción a SQL Server en máquinas virtuales de Azure][Introducción a SQL Server en máquinas virtuales de Azure] en el conjunto de documentación [SQL Server en máquinas virtuales de Azure][SQL Server en máquinas virtuales de Azure].
    ...
    > -   Puede actualizar una instancia existente de SQL Server Evaluation Edition a otra edición de SQL Server bajo el contrato de [Movilidad de Licencias de Microsoft a través de Software Assurance en Azure][Movilidad de Licencias de Microsoft a través de Software Assurance en Azure] siguiendo los pasos en [Actualizar a una edición diferente de SQL Server 2014][Actualizar a una edición diferente de SQL Server 2014]. Para obtener información sobre cómo comprar la copia con licencia de SQL Server, consulte [Cómo comprar SQL Server][Cómo comprar SQL Server].
...
4.  En la primera página de **Configuración de máquina virtual**, proporcione la siguiente información:
    ...
    -   En el cuadro **NEW PASSWORD**, escriba una contraseña segura. Para obtener más información, consulte [Contraseñas seguras][Contraseñas seguras].
    ...
    > Seleccione A4 cuando use imágenes de SQL Server 2012 o 2014 Enterprise optimizado para cargas de trabajo transaccionales.
    > Seleccione A7 cuando use SQL Server 2012 o 2014 Enterprise optimizado para cargas de trabajo de almacenamiento de datos.
    > El tamaño seleccionado limita la cantidad de discos de datos que puede configurar. Para obtener la información más actualizada sobre los tamaños disponibles de máquina virtual y la cantidad de discos de datos que puede adjuntar a una máquina virtual, consulte [Tamaños de máquina virtual para Azure][Tamaños de máquina virtual para Azure].

    Haga clic en la flecha de avance en la esquina inferior derecha para continuar.

    ![Configuración de MV][Configuración de MV]
...
-   [Creación de un extremo TCP para la máquina virtual][Creación de un extremo TCP para la máquina virtual]
-   [Apertura de puertos TCP en el firewall de Windows][Apertura de puertos TCP en el firewall de Windows]
-   [Configuración de SQL Server para escuchar en el protocolo TCP][Configuración de SQL Server para escuchar en el protocolo TCP]
-   [Configuración de SQL Server para autenticación de modo mixto][Configuración de SQL Server para autenticación de modo mixto]
-   [Creación de inicios de sesión para la autenticación de SQL Server][Creación de inicios de sesión para la autenticación de SQL Server]
-   [Determinación del nombre DNS de la máquina virtual][Determinación del nombre DNS de la máquina virtual]
-   [Conexión al motor de base de datos desde otro equipo][Conexión al motor de base de datos desde otro equipo]
-   [Conexión al motor de base de datos desde su aplicación] (\#cdea)

El siguiente diagrama resume la ruta de conexión:

![Conexión a una máquina virtual de SQL Server][Conexión a una máquina virtual de SQL Server]
...
1.  Conéctese a la máquina virtual a través del Escritorio remoto de Windows. Una vez que ha iniciado sesión, en el menú de inicio, haga clic en **Ejecutar**, escriba **WF.msc** y, a continuación, haga clic en **Aceptar**.
    ...
    ![Iniciar el programa de firewall][Iniciar el programa de firewall]
...
4.  En el cuadro de diálogo **Protocolo y puertos**, seleccione **TCP**. Seleccione **Puertos locales específicos** y escriba el número de puerto para la instancia del motor de base de datos (**1433** para la instancia predeterminada o la opción que haya elegido para el puerto privado en el paso referido al extremo).
    ...
    ![Puerto TCP 1433][Puerto TCP 1433]
...
Abra puertos adicionales para otros componentes cada vez que sea necesario. Para obtener más información, consulte [Configurar Firewall de Windows para permitir el acceso a SQL Server][Configurar Firewall de Windows para permitir el acceso a SQL Server].
...
3.  En el Explorador de objetos de SQL Server Management Studio, haga clic con el botón secundario en el nombre de la instancia de SQL Server (el nombre de la máquina virtual) y, a continuación, haga clic en **Propiedades**.
    ...
    ![Propiedades del servidor][Propiedades del servidor]
...
4.  En la página **Seguridad**, en **Autenticación de servidor**, seleccione **Modo de autenticación de Windows y SQL Server** y, a continuación, haga clic en **Aceptar**.
    ...
    ![Seleccionar el modo de autenticación][Seleccionar el modo de autenticación]
...
2.  Haga clic con el botón secundario en la carpeta **Seguridad**, señale **Nuevo** y seleccione **Inicio de sesión...**.
    ...
    ![Nuevo inicio de sesión][Nuevo inicio de sesión]
...
10. En la lista **Idioma predeterminado**, deje el valor **predeterminado**.
    ...
    ![Propiedades de inicio de sesión][Propiedades de inicio de sesión]
...
6.  Haga clic en **Connect**.
    ...
    ![Conectar mediante SSMS][Conectar mediante SSMS]
...
Para obtener más información, consulte [How to Troubleshoot Connecting to the SQL Server Database Engine][How to Troubleshoot Connecting to the SQL Server Database Engine].

## <span id="Optional"></span>Pasos siguientes</a>

Ha visto cómo crear y configurar SQL Server en una máquina virtual de Azure mediante el uso de la imagen de plataforma. Cuando utilice SQL Server en Máquinas virtuales de Azure, le recomendamos seguir las pautas detalladas que aparecen en la documentación [SQL Server en máquinas virtuales de Azure][SQL Server en máquinas virtuales de Azure] en la biblioteca. Este conjunto de documentación incluye una serie de artículos y tutoriales que proporcionan pautas detalladas. La serie incluye las siguientes secciones:

[SQL Server en máquinas virtuales de Azure][SQL Server en máquinas virtuales de Azure]

[Introducción a SQL Server en máquinas virtuales de Azure][Introducción a SQL Server en máquinas virtuales de Azure]

[Preparar la migración a SQL Server en máquinas virtuales de Azure][Preparar la migración a SQL Server en máquinas virtuales de Azure]
...
[Implementación de SQL Server en máquinas virtuales de Azure][Implementación de SQL Server en máquinas virtuales de Azure]
...
[Consideraciones de conectividad para SQL Server en máquinas virtuales de Azure][2]
...
[Consideraciones de rendimiento para SQL Server en Máquinas virtuales de Azure][Consideraciones de rendimiento para SQL Server en Máquinas virtuales de Azure]

[Consideraciones de seguridad para SQL Server en Máquinas virtuales de Azure][Consideraciones de seguridad para SQL Server en Máquinas virtuales de Azure]

[Solucionar problemas y supervisar SQL Server en máquinas virtuales de Azure][Solucionar problemas y supervisar SQL Server en máquinas virtuales de Azure]

[Alta disponibilidad y recuperación ante desastres para SQL Server en máquinas virtuales de Azure][Alta disponibilidad y recuperación ante desastres para SQL Server en máquinas virtuales de Azure]
...
[Copias de seguridad y restauración para SQL Server en Máquinas virtuales de Azure][Copias de seguridad y restauración para SQL Server en Máquinas virtuales de Azure]

[Business Intelligence de SQL Server en Máquinas virtuales de Azure][Business Intelligence de SQL Server en Máquinas virtuales de Azure]
...
[Almacenamiento de datos de SQL Server en Máquinas virtuales de Azure][Almacenamiento de datos de SQL Server en Máquinas virtuales de Azure]

[Artículos técnicos para SQL Server en Máquinas virtuales de Azure][Artículos técnicos para SQL Server en Máquinas virtuales de Azure]

-   [Artículo técnico: Descripción de Base de datos SQL de Azure y SQL Server en máquinas virtuales de Azure][Artículo técnico: Descripción de Base de datos SQL de Azure y SQL Server en máquinas virtuales de Azure]

-   [Artículo técnico: Estrategias de desarrollo y patrones de aplicación de SQL Server en máquinas virtuales de Azure][Artículo técnico: Estrategias de desarrollo y patrones de aplicación de SQL Server en máquinas virtuales de Azure]

-   [Artículo técnico: Implementar Business Intelligence de SQL Server en Máquinas virtuales de Azure][Artículo técnico: Implementar Business Intelligence de SQL Server en Máquinas virtuales de Azure]

-   [Artículo técnico: Guía de rendimiento para SQL Server en Máquinas virtuales de Azure][Artículo técnico: Guía de rendimiento para SQL Server en Máquinas virtuales de Azure]

-   [Artículo técnico: Control de visor de informes de Reporting Services y servidores de informes basados en máquinas virtuales de Microsoft Azure][Artículo técnico: Control de visor de informes de Reporting Services y servidores de informes basados en máquinas virtuales de Microsoft Azure]
  ...
  [Movilidad de Licencias de Microsoft a través de Software Assurance en Azure]: http://www.windowsazure.com/es-es/pricing/license-mobility/
  [Actualizar a una edición diferente de SQL Server 2014]: http://go.microsoft.com/fwlink/?LinkId=396915
  [Cómo comprar SQL Server]: http://www.microsoft.com/es-es/sqlserver/get-sql-server/how-to-buy.aspx
  [Contraseñas seguras]: http://msdn.microsoft.com/library/ms161962.aspx
  [Tamaños de máquina virtual para Azure]: http://msdn.microsoft.com/es-es/library/azure/dn197896.aspx
  ...
  [Conexión a una máquina virtual de SQL Server]: ./media/virtual-machines-provision-sql-server/SQLVMConnectionsOnAzure.GIF
  [Iniciar el programa de firewall]: ./media/virtual-machines-provision-sql-server/12Open-WF.png
  [Nueva regla]: ./media/virtual-machines-provision-sql-server/13New-FW-Rule.png
  [Puerto TCP 1433]: ./media/virtual-machines-provision-sql-server/14Port-1433.png
  [Permitir conexiones]: ./media/virtual-machines-provision-sql-server/15Allow-Connection.png
  [Perfil público]: ./media/virtual-machines-provision-sql-server/16Public-Profile.png
  [Nombre de la regla]: ./media/virtual-machines-provision-sql-server/17Rule-Name.png
  [Configurar Firewall de Windows para permitir el acceso a SQL Server]: http://msdn.microsoft.com/es-es/library/cc646023.aspx
  ...
  [Reiniciar el motor de base de datos]: ./media/virtual-machines-provision-sql-server/11Restart.png
  [Habilitar o deshabilitar un protocolo de red de servidor]: http://msdn.microsoft.com/es-es/library/ms191294.aspx
  [Consideraciones de conectividad para SQL Server en máquinas virtuales de Azure]: http://go.microsoft.com/fwlink/?LinkId=294723
  [1]: http://go.microsoft.com/fwlink/?LinkId=294719
  [Iniciar SSMS]: ./media/virtual-machines-provision-sql-server/18Start-SSMS.png
  [Conectar al servidor]: ./media/virtual-machines-provision-sql-server/19Connect-to-Server.png
  [Propiedades del servidor]: ./media/virtual-machines-provision-sql-server/20Server-Properties.png
  [Seleccionar el modo de autenticación]: ./media/virtual-machines-provision-sql-server/21Mixed-Mode.png
  [Reinicio]: ./media/virtual-machines-provision-sql-server/22Restart2.png
  [Nuevo inicio de sesión]: ./media/virtual-machines-provision-sql-server/23New-Login.png
  [Propiedades de inicio de sesión]: ./media/virtual-machines-provision-sql-server/24Test-Login.png
  [sysadmin]: ./media/virtual-machines-provision-sql-server/25sysadmin.png
  [Crear un inicio de sesión]: http://msdn.microsoft.com/es-es/library/aa337562.aspx
  [Conectar mediante SSMS]: ./media/virtual-machines-provision-sql-server/33Connect-SSMS.png
