...
2. En el Portal de administración de Azure, en la parte inferior izquierda de la página web, haga clic sucesivamente en **+NUEVO**, **PROCESO**, **MÁQUINA VIRTUAL** y, a continuación, en **FROM GALLERY**.
...
4. En la página **Configuración de la máquina virtual**, proporcione la siguiente información:
    ...
    > Seleccione A3 o un tamaño superior cuando use SQL Server Enterprise Edition.
   	> Seleccione A4 cuando se usan las imágenes de SQL Server 2012 o 2014 Enterprise optimizado para cargas de trabajo transaccionales.  
   	> Seleccione A7 cuando se usan las imágenes de SQL Server 2012 o 2014 Enterprise optimizado para cargas de trabajo de almacenamiento de datos. 
...
5. En la segunda página **Configuración de la máquina virtual** puede configurar los recursos relacionados con las redes, el almacenamiento y la disponibilidad:
	...
	- En el cuadro **REGIÓN/GRUPO DE AFINIDAD/RED VIRTUAL**, seleccione una región en la que se hospedará esta imagen virtual.
	- En **Cuenta de almacenamiento**, seleccione una cuenta de almacenamiento existente o seleccione una generada automáticamente.
...
1. Una vez que se completa el aprovisionamiento, haga clic en el nombre de la máquina virtual para ir a la página PANEL. En la parte inferior de la página, haga clic en **Conectar**.
...
4. En la página **Agregar un extremo a una máquina virtual**, haga clic en **Agregar un extremo independiente** y, a continuación, en la flecha de avance para continuar.

	
5. En la página **Especifique los detalles del extremo**, proporcione la información siguiente.

	- En el cuadro **NAME**, proporcione un nombre para el extremo.
...
6. En el cuadro de diálogo **Acción**, seleccione **Permitir la conexión** y, a continuación, haga clic en **Siguiente**.
...
7. En el cuadro de diálogo **Perfil**, seleccione **Público** y, a continuación, haga clic en **Siguiente**. 
...
3. En el panel de la consola, haga clic en **Protocolos para _nombre de la instancia_**. (La instancia predeterminada es **Protocolos para MSSQLSERVER**.)
...
1. Mientras esté conectado a la máquina virtual con Escritorio remoto, en el menú de inicio, haga clic en **Todos los programas**, **Microsoft SQL Server _versión_** y, a continuación, haga clic en **SQL Server Management Studio**. 
...
5. En el cuadro **Contraseña**, escriba una contraseña para el usuario nuevo. Vuelva a escribir esa contraseña en el cuadro **Confirmar contraseña**.
