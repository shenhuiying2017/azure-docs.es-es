...
El almacenamiento de blobs, tablas y colas se incluye en todas las cuentas de almacenamiento, mientras que el almacenamiento de archivos está disponible mediante solicitud en la [página de vista previa de Azure][página de vista previa de Azure].

Una cuenta de almacenamiento es un espacio de nombres único que proporciona acceso a Almacenamiento de Azure. Cada cuenta de almacenamiento puede contener hasta 500 TB de datos de blobs, colas, tablas y archivos combinados. Consulte [Objetivos de escalabilidad y rendimiento del almacenamiento de Azure][Objetivos de escalabilidad y rendimiento del almacenamiento de Azure] para obtener información sobre la capacidad de las cuentas de almacenamiento de Azure.
...
Para conjuntos de datos de gran tamaño donde las restricciones de red hacen imposible la carga o descarga de datos en el almacenamiento de blobs a través de una conexión, puede enviar una unidad de disco duro a Microsoft para importar o exportar datos directamente desde el centro de datos con el [servicio de importación y exportación de Azure][servicio de importación y exportación de Azure]. También puede copiar datos de blobs en la cuenta de almacenamiento o entre cuentas de este tipo.
...
-   [Documentación del almacenamiento de Azure][Documentación del almacenamiento de Azure]
...
-   [Uso del almacenamiento de tablas en .NET][Uso del almacenamiento de tablas en .NET]
-   [Uso del almacenamiento en cola en .NET][Uso del almacenamiento en cola en .NET]

### Para desarrolladores de Java/Android

-   [Uso del almacenamiento de blobs de Java/Android][Uso del almacenamiento de blobs de Java/Android]
-   [Uso del almacenamiento de tablas de Java/Android][Uso del almacenamiento de tablas de Java/Android]
-   [Uso del almacenamiento de colas de Java/Android][Uso del almacenamiento de colas de Java/Android]

### Para desarrolladores de Node.js

-   [Uso del almacenamiento de blobs en Node.js][Uso del almacenamiento de blobs en Node.js]
-   [Uso del almacenamiento de tablas en Node.js][Uso del almacenamiento de tablas en Node.js]
-   [Uso del almacenamiento de colas en Node.js][Uso del almacenamiento de colas en Node.js]

### Para desarrolladores de PHP

-   [Uso del almacenamiento de blobs en PHP][Uso del almacenamiento de blobs en PHP]
-   [Uso del almacenamiento de tablas en PHP][Uso del almacenamiento de tablas en PHP]
-   [Uso del almacenamiento de colas en PHP][Uso del almacenamiento de colas en PHP]

### Para desarrolladores de Ruby

-   [Uso del almacenamiento de blobs en Ruby][Uso del almacenamiento de blobs en Ruby]
-   [Uso del almacenamiento de tablas en Ruby][Uso del almacenamiento de tablas en Ruby]
-   [Uso del almacenamiento de colas en Ruby][Uso del almacenamiento de colas en Ruby]

### Para desarrolladores de Python

-   [Uso del almacenamiento de blobs en Python][Uso del almacenamiento de blobs en Python]
-   [Uso del almacenamiento de tablas en Python][Uso del almacenamiento de tablas en Python]
-   [Uso del almacenamiento de colas en Python][Uso del almacenamiento de colas en Python]
  ...
  [PHP]: /es-es/develop/php/
  [Ruby]: /es-es/develop/ruby/
  [Python]: /es-es/develop/python/
