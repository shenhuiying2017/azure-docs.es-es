<properties urlDisplayName="Get Started with Mobile Analytics" pageTitle="Introducci&oacute;n al an&aacute;lisis m&oacute;vil | Centro de desarrollo m&oacute;vil" metaKeywords="" description="Introducci&oacute;n al an&aacute;lisis m&oacute;vil" metaCanonical="" disqusComments="1" umbracoNaviHide="1" documentationCenter="Mobile" title="Introducci&oacute;n al an&aacute;lisis m&oacute;vil" authors="mahender" manager="kirillg"/>
...
En este tutorial, agregará funciones de análisis móvil a su aplicación mediante [Capptain][Capptain]. Los análisis móviles le permiten determinar el modo en que los usuarios interactúan con su aplicación y cuáles son las secciones que están impulsando la mayor actividad. Para comenzar a obtener estos datos, instrumentaremos su aplicación con el SDK de Capptain.
...
1.  [Inicialización del SDK de Capptain][Inicialización del SDK de Capptain]
2.  [Sobrecarga de UIViewController][Sobrecarga de UIViewController]

Este tutorial requiere lo siguiente:

-   Una cuenta de [Capptain][Capptain]
-   Una aplicación de [nivel estándar de Servicios móviles][nivel estándar de Servicios móviles]
