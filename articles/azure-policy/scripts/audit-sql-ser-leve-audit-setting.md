---
title: "Ejemplo de JSON de Azure Policy: Auditar la configuración de auditoría en el nivel de SQL Server | Microsoft Docs"
description: "Esta directiva de ejemplo de JSON audita la configuración de auditoría de SQL Server si esa configuración no coincide con una configuración especificada."
