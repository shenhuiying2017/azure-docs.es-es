---
title: 'Ejemplo de JSON de Azure Policy: SKU permitidas de SQL DB | Microsoft Docs'
description: Esta directiva de ejemplo de JSON requiere que las bases de datos de SQL Database usen una SKU aprobada.
