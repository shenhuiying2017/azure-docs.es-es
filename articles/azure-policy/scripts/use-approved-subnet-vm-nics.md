---
title: "Ejemplo de JSON de Azure Policy: Usar subred aprobada para las interfaces de red de máquinas virtuales | Microsoft Docs"
description: Esta directiva de ejemplo de JSON requiere que las interfaces de red usen una subred aprobada.
...
---
# <a name="use-approved-subnet-for-vm-network-interfaces"></a>Usar subred aprobada para las interfaces de red de máquinas virtuales

Esta directiva requiere que las interfaces de red usen una subred aprobada. Se especifica el identificador de la subred aprobada.
