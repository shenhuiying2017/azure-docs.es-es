---
title: 'Ejemplo de JSON de Azure Policy: Requerir el cifrado de la cuenta de almacenamiento | Microsoft Docs'
description: La directiva de ejemplo de JSON requiere que la cuenta de almacenamiento use el cifrado de BLOB.
