---
title: "Ejemplo de JSON de Azure Policy: aplicación de un patrón de coincidencia | Microsoft Docs"
description: "Esta directiva de ejemplo de JSON requiere que los recursos cumplan el patrón de coincidencia para las convenciones de nomenclatura."
...
---
# <a name="enforce-match-pattern-for-naming-conventions"></a>Aplicación del patrón de coincidencia para las convenciones de nomenclatura
