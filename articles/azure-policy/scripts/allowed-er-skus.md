---
title: 'Ejemplo de JSON de Azure Policy: SKU permitidas de ExpressRoute | Microsoft Docs'
description: Esta directiva de ejemplo de JSON requiere que ExpressRoute use una SKU aprobada.
...
---
# <a name="allowed-express-route-skus"></a>SKU permitidas de ExpressRoute
