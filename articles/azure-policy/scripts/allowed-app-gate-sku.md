---
title: 'Ejemplo de JSON de Azure Policy: SKU permitidas de Application Gateway | Microsoft Docs'
description: Esta directiva de ejemplo de JSON requiere que Application Gateways use una SKU aprobada.
