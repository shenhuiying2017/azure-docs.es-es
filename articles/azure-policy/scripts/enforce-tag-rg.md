---
title: 'Ejemplo de JSON de Azure Policy: Aplicar etiqueta y su valor en grupos de recursos | Microsoft Docs'
description: Esta directiva de ejemplo de JSON requiere una etiqueta y un valor en un grupo de recursos.
