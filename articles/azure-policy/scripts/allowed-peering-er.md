---
title: "Ejemplo de JSON de Azure Policy: Ubicación de emparejamiento permitida para ExpressRoute | Microsoft Docs"
...
---
# <a name="allowed-peering-location-for-express-route"></a>Ubicación de emparejamiento permitida para ExpressRoute
