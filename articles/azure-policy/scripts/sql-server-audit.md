---
title: 'Ejemplo de JSON de Azure Policy: Auditar la configuración de auditoría de SQL Server | Microsoft Docs'
description: Esta directiva de ejemplo de JSON audita la configuración de la auditoría de SQL Server.
