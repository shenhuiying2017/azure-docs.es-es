---
title: 'Ejemplo de JSON de Azure Policy: NSG X en cada subred | Microsoft Docs'
description: "Esta directiva de ejemplo de JSON requiere que se use un grupo de seguridad de red específico con cada subred virtual."
