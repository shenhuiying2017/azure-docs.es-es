---
title: 'Ejemplo de JSON de Azure Policy: Aplicar etiqueta y su valor predeterminado | Microsoft Docs'
description: Esta directiva de ejemplo de JSON anexa un nombre y valor de etiqueta especificado, si no se proporciona esa etiqueta.
