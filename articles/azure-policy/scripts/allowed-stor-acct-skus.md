---
title: 'Ejemplo de JSON de Azure Policy: SKU de cuenta de almacenamiento permitida | Microsoft Docs'
description: La directiva de ejemplo de JSON requiere que las cuentas de almacenamiento usen una SKU aprobada.
...
---
# <a name="allowed-storage-account-skus"></a>SKU de cuenta de almacenamiento permitida

Esta directiva requiere que las cuentas de almacenamiento usen una SKU aprobada. Se especifica una matriz de las SKU aprobadas.
