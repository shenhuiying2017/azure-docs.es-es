---
title: 'Ejemplo de JSON de Azure Policy: Auditar el cifrado de datos transparentes en SQL Database| Microsoft Docs'
description: Esta directiva de ejemplo de JSON audita si una base de datos SQL no tiene el cifrado de datos transparente habilitado.
