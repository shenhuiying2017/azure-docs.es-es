---
title: 'Ejemplo de JSON de Azure Policy: Tipos de recursos no permitidos | Microsoft Docs'
description: "Esta directiva de ejemplo de JSON prohíbe la implementación de tipos de recursos especificados."
...
---
# <a name="not-allowed-resource-types"></a>Tipos de recursos no permitidos

Esta directiva prohíbe la implementación de tipos de recursos especificados. Se especifica una matriz de los tipos de recurso que se bloquearán.
