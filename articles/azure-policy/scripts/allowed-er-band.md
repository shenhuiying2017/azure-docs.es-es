---
title: 'Ejemplo de JSON de Azure Policy: Ancho de banda permitido de ExpressRoute | Microsoft Docs'
description: Esta directiva de ejemplo de JSON requiere que ExpressRoute use un conjunto de anchos de banda especificados.
...
---
# <a name="allowed-express-route-bandwidth"></a>Ancho de banda permitido de ExpressRoute
