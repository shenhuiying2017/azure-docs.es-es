---
title: 'Ejemplo de JSON de Azure Policy: Extensiones de máquina virtual no permitidas | Microsoft Docs'
description: Esta directiva de ejemplo de JSON prohíbe el uso de las extensiones especificadas.
...
---
# <a name="not-allowed-vm-extensions"></a>Extensiones de máquina virtual no permitidas
