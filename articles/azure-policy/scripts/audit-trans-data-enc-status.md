---
title: 'Ejemplo de JSON de Azure Policy: Auditar el estado del cifrado de datos transparentes | Microsoft Docs'
description: "Esta directiva de ejemplo de JSON audita el cifrado de datos transparente de SQL Database si no está habilitado."
...
---
# <a name="audit-transparent-data-encryption-status"></a>Auditar el estado del cifrado de datos transparente

Esta directiva audita el cifrado de datos transparente de SQL Database si no está habilitado.
