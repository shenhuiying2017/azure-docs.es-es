...
En este tema se describe cómo administrar y supervisar las entidades del bus de servicio mediante el [Portal de administración de Azure][]. Con el portal, se obtiene una visión integral del estado de las colas y los temas. También puede supervisar su uso.
