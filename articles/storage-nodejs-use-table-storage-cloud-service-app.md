...
En este tutorial se supone que ha completado los tutoriales de [Aplicación web Node.js](http://www.windowsazure.com/es-es/develop/nodejs/tutorials/getting-started/) y [Node.js con Express](http://www.windowsazure.com/es-es/develop/nodejs/tutorials/web-app-with-express/).
