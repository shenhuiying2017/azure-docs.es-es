...
2. Escriba el nombre del contenedor nuevo en el cuadro de diálogo **Crear contenedor de blobs** y después elija **Aceptar**.
...
2. En el cuadro de diálogo **Cargar nuevo archivo**, seleccione el botón **Examinar** para especificar el archivo que desea cargar y después escriba un nombre de carpeta en el cuadro **Carpeta (opcional)**.
