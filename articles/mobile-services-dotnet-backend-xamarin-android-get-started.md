<properties urlDisplayName="Get Started with Mobile Services for Xamarin Android apps" pageTitle="Introducción a Servicios móviles para aplicaciones de Android de Xamarin - Servicios móviles de Azure" metaKeywords="" description="Siga este tutorial para empezar a usar Servicios móviles de Azure para el desarrollo de Xamarin Android." metaCanonical="" services="" documentationCenter="Mobile" title="Get Started with Mobile Services for Xamarin Android apps" authors="donnam" solutions="" manager="dwrede" editor="mollybos" />
