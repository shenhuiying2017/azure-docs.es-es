...
Si la cadena no es especialmente larga, puede usar entonces [sp_executesql][] como es habitual.
...
<!--MSDN references-->
[sp_executesql]: https://msdn.microsoft.com/es-es/library/ms188001.aspx
