...
## Pares de región
Azure organiza un conjunto de pares de región y garantiza que solo una región del par se someterá al mantenimiento planeado. Azure no implementará ninguna actualización en regiones emparejadas simultáneamente durante un mantenimiento planeado. Consulte la tabla siguiente para obtener información sobre los pares de región actuales:
