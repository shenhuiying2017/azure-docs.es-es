...
Aprenda a definir un flujo de trabajo y a ejecutarlo en HDInsight. Para conocer el coordinador de Oozie, consulte [Uso del coordinador de Oozie de tiempo con HDInsight][Uso del coordinador de Oozie de tiempo con HDInsight].
...
8.  Haga clic en **Run Script** o presione **F5** para ejecutar el script. La salida debe ser similar a:
...
-   [Uso del coordinador de Oozie de tiempo con HDInsight][Uso del coordinador de Oozie de tiempo con HDInsight]
