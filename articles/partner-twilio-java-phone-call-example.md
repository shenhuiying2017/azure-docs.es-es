...
1. Adquiera una cuenta de Twilio y un token de autenticación. Para comenzar a usar Twilio, puede considerar los precios en [http://www.twilio.com/pricing][twilio_pricing]. Puede registrarse en [https://www.twilio.com/try-twilio][try_twilio]. Para obtener información sobre la API proporcionada por Twilio, consulte [http://www.twilio.com/api][twilio_api].
...
5. Asegúrese de que el keystore cacerts contenga el certificado de la entidad de certificación Equifax Secure con la huella digital MD5 67:CB:9D:C0:13:24:8A:82:9B:B2:17:1E:D1:1B:EC:D4 (el número de serie es 35:DE:F4:CF y la huella digital SHA1 es D2:32:09:AD:23:D3:14:23:21:74:E4:0D:7F:9D:62:13:97:86:63:3A). Este es el certificado de entidad de certificación del servicio [https://api.twilio.com][twilio_api_service] emitido por la entidad de certificados (CA) que se tendrá en consideración cada ver que use las API de Twilio. Para obtener información sobre cómo agregar este certificado CA a su almacén de certificados CA de JDK, consulte [Incorporación de un certificado al almacén de certificados CA de Java][add_ca_cert].
...
* En lugar de usar un formulario web, puede usar blobs de almacenamiento de Azure o una base de datos SQL para almacenar los números de teléfono y el texto de llamada. Para obtener más información sobre cómo usar los blobs de Azure Storage en Java, consulte el artículo sobre [cómo usar el servicio Blob Storage desde Java][howto_blob_storage_java]. Para obtener más información sobre cómo usar SQL Database en Java, consulte [Usar bases de datos SQL en Java][howto_sql_azure_java].
...
* [Cómo usar Twilio para las funcionalidades de voz y SMS en Java][howto_twilio_voice_sms_java]
