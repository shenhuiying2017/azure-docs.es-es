<properties 
	pageTitle="Cómo realizar una llamada de teléfono desde Twilio (Java) - Azure" 
...
1. Adquiera una cuenta de Twilio y un token de autenticación. Para comenzar a usar Twilio, puede considerar los precios en [http://www.twilio.com/pricing][twilio_pricing]. Puede registrarse en [https://www.twilio.com/try-twilio][try_twilio]. Para obtener información acerca de la API proporcionada por Twilio, consulte [http://www.twilio.com/api][twilio_api].
2. Obtenga el JAR de Twilio. En [https://github.com/twilio/twilio-java][twilio_java_github], podrá descargar el código fuente de GitHub y crear su propio archivo JAR, o bien descargar un archivo JAR previamente generado (con o sin dependencias).
...
A continuación le indicamos los paseos de alto nivel que deberá dar para ejecutar su aplicación; los detalles de estos pasos se pueden encontrar en [Crear una aplicación Hello World con el complemento de Azure para Eclipse con Java (de Microsoft Open Technologies)][azure_java_eclipse_hello_world].
...
Cuando esté listo para realizar implementaciones en Azure, vuelva a compilar para realizar la implementación en la nube, implemente en Azure y ejecute http://*your_hosted_name*.cloudapp.net/TwilioCloud/callform.jsp en el explorador (reemplace su valor por  *your_hosted_name*).
...
## Otras referencias
* [Cómo usar Twilio para las capacidades de voz y SMS en Java][howto_twilio_voice_sms_java]
* [Agregar un certificado al almacén de certificados CA de Java][add_ca_cert]
