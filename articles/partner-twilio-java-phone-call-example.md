<properties urlDisplayName="How to Make a Phone Call from Twilio in Java" pageTitle="Cómo realizar una llamada de teléfono desde Twilio (Java) - Azure" metaKeywords="Llamada de Twilio de Azure, sitio web de llamadas de Twilio, Java de Twilio de Azure" description="Aprenda a realizar una llamada telefónica desde una página web con Twilio en una aplicación Java en Azure." metaCanonical="" services="" documentationCenter="Java" title="How to Make a Phone Call Using Twilio in a Java Application on Azure" authors="MicrosoftHelp@twilio.com; robmcm" videoId="" scriptId="" solutions="" manager="twilio" editor="mollybos" />
...
2. Obtenga el JAR de Twilio. En [https://github.com/twilio/twilio-java][twilio_java_github] puede descargar los orígenes de GitHub y crear su propio archivo JAR, o bien, puede descargar un archivo JAR generado previamente (con o sin dependencias).
...
Cuando esté listo para implementar en Azure, recompile para su implementación en la nube, implemente en Azure y ejecute http://*su_nombre_hospedado*.cloudapp.net/TwilioCloud/callform.jsp en el explorador (sustituya su valor por *su_nombre_hospedado*).
