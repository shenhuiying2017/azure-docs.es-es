<properties title="Supervisi&oacute;n, diagn&oacute;stico y soluci&oacute;n de problemas de Almacenamiento de Microsoft Azure" pageTitle="Supervisi&oacute;n, diagn&oacute;stico y soluci&oacute;n de problemas de Almacenamiento | Azure" description="Use caracter&iacute;sticas como an&aacute;lisis de almacenamiento, registro del lado cliente y otras herramientas de terceros para identificar, diagnosticar y solucionar problemas relacionados con Almacenamiento de Azure." metaKeywords="Azure storage  monitoring  diagnosing  logging  troubleshooting  performance  storage client library  Azure blob   Azure unstructured data   Azure unstructured storage   Azure blob   Azure blob storage  Azure queue   Azure asynchronous processing   Azure queue   Azure queue storage Azure table   Azure nosql   Azure large structured data store   Azure table   Azure table storage  Azure file storage  Azure file  Azure file share  Azure" services="storage" solutions="" documentationCenter="" authors="v-dobett" videoId="" scriptId="" manager="adinah" />
...
-   [Introducción][Introducción]
    ...
    -   [Cómo está organizada esta guía][Cómo está organizada esta guía]
-   [Supervisión del servicio de almacenamiento][Supervisión del servicio de almacenamiento]

    -   [Supervisión del estado del servicio][Supervisión del estado del servicio]
    -   [Supervisión de la capacidad][Supervisión de la capacidad]
    -   [Supervisión de la disponibilidad][Supervisión de la disponibilidad]
    -   [Supervisión del rendimiento][Supervisión del rendimiento]
-   [Diagnóstico de problemas de almacenamiento][Diagnóstico de problemas de almacenamiento]

    -   [Problemas de estado del servicio][Problemas de estado del servicio]
    -   [Problemas de rendimiento][Problemas de rendimiento]
    -   [Diagnóstico de errores][Diagnóstico de errores]
    -   [Problemas del emulador de almacenamiento][Problemas del emulador de almacenamiento]
    -   [Herramientas de registro de almacenamiento][Herramientas de registro de almacenamiento]
    -   [Uso de herramientas de registro de red][Uso de herramientas de registro de red]
-   [Traza de un extremo a otro][Traza de un extremo a otro]

    -   [Correlación de datos de registro][Correlación de datos de registro]
    -   [Id. de solicitud de cliente][Id. de solicitud de cliente]
    -   [Identificador de solicitud de servidor][Identificador de solicitud de servidor]
    -   [Marcas de tiempo][Marcas de tiempo]
-   [Guía de solución de problemas][Guía de solución de problemas]

    -   [Las métricas muestran una AverageE2ELatency alta y una AverageServerLatency baja][Las métricas muestran una AverageE2ELatency alta y una AverageServerLatency baja]
    -   [Las métricas muestran una AverageE2ELatency baja y una AverageServerLatency baja, pero el cliente tiene latencia alta][Las métricas muestran una AverageE2ELatency baja y una AverageServerLatency baja, pero el cliente tiene latencia alta]
    -   [Las métricas muestran una AverageServerLatency alta][Las métricas muestran una AverageServerLatency alta]
    -   [Observa retrasos inesperados en la entrega de mensajes de una cola][Observa retrasos inesperados en la entrega de mensajes de una cola]
    -   [Las métricas muestran un aumento de PercentThrottlingError][Las métricas muestran un aumento de PercentThrottlingError]
    -   [Las métricas muestran un aumento de PercentTimeoutError][Las métricas muestran un aumento de PercentTimeoutError]
    -   [Las métricas muestran un aumento de PercentNetworkError][Las métricas muestran un aumento de PercentNetworkError]
    -   [El cliente recibe mensajes HTTP 403 (prohibido)][El cliente recibe mensajes HTTP 403 (prohibido)]
    -   [El cliente recibe mensajes HTTP 404 (no encontrado)][El cliente recibe mensajes HTTP 404 (no encontrado)]
    -   [El cliente recibe mensajes HTTP 409 (conflicto)][El cliente recibe mensajes HTTP 409 (conflicto)]
    -   [Las métricas muestran un PercentSuccess bajo o las entradas de registro de análisis tienen operaciones con el estado de transacción ClientOtherErrors][Las métricas muestran un PercentSuccess bajo o las entradas de registro de análisis tienen operaciones con el estado de transacción ClientOtherErrors]
    -   [Las métricas de capacidad muestran un aumento inesperado en el uso de la capacidad de almacenamiento][Las métricas de capacidad muestran un aumento inesperado en el uso de la capacidad de almacenamiento]
    -   [Se producen reinicios inesperados de máquinas virtuales que tienen muchos VHD adjuntos][Se producen reinicios inesperados de máquinas virtuales que tienen muchos VHD adjuntos]
    -   [El problema se presenta al usar el emulador de almacenamiento para realizar tareas de desarrollo o pruebas][El problema se presenta al usar el emulador de almacenamiento para realizar tareas de desarrollo o pruebas]
    -   [Se producen problemas al instalar el SDK de Windows Azure para .NET][Se producen problemas al instalar el SDK de Windows Azure para .NET]
    -   [Tiene otro problema distinto relacionado con un servicio de almacenamiento][Tiene otro problema distinto relacionado con un servicio de almacenamiento]
-   [Apéndices][Apéndices]

    -   [Apéndice 1: Uso de Fiddler para capturar tráfico HTTP y HTTPS][Apéndice 1: Uso de Fiddler para capturar tráfico HTTP y HTTPS]
    -   [Apéndice 2: Uso de Wireshark para capturar tráfico de red][Apéndice 2: Uso de Wireshark para capturar tráfico de red]
    -   [Apéndice 3: Uso del Analizador de mensajes de Microsoft para capturar tráfico de red][Apéndice 3: Uso del Analizador de mensajes de Microsoft para capturar tráfico de red]
    -   [Apéndice 4: Uso de Excel para ver métricas y datos de registro][Apéndice 4: Uso de Excel para ver métricas y datos de registro]
    -   [Apéndice 5: Supervisión con Application Insights para Visual Studio Online][Apéndice 5: Supervisión con Application Insights para Visual Studio Online]
...
La sección “[Supervisión del servicio de almacenamiento][Supervisión del servicio de almacenamiento]” describe cómo supervisar el estado y el rendimiento de los servicios de Almacenamiento de Azure con las métricas de análisis de Almacenamiento de Azure (métricas de Almacenamiento).

La sección “[Diagnóstico de problemas de almacenamiento][Diagnóstico de problemas de almacenamiento]” describe cómo diagnosticar problemas con el registro de análisis de Almacenamiento de Azure (registro de Almacenamiento). También explica cómo habilitar el registro del lado cliente con los recursos de una de las bibliotecas de cliente como, por ejemplo, la biblioteca de cliente de Almacenamiento para .NET o el SDK de Azure para Java.

La sección “[Traza de un extremo a otro][Traza de un extremo a otro]” describe cómo poner en correlación la información que contienen diversos archivos de registro y datos de métricas.

La sección “[Guía de solución de problemas][Guía de solución de problemas]” proporciona una guía de solución de problemas para algunos de los problemas habituales relacionados con el almacenamiento que puede encontrarse.

Los “[Apéndices][Apéndices]” contienen información sobre el uso de otras herramientas, como Wireshark y Netmon para analizar datos de paquetes de red, Fiddler para analizar mensajes HTTP/HTTPS y el Analizador de mensajes de Microsoft para poner en correlación los datos de registro.

## <a name="monitoring-your-storage-service"></a>Supervisión del servicio de almacenamiento

Si conoce la supervisión de rendimiento de Windows, las métricas de Almacenamiento son algo así como los contadores del monitor de rendimiento de Windows, pero en Almacenamiento de Azure. En las métricas de Almacenamiento, encontrará un conjunto completo de métricas (o “contadores”, según la terminología del monitor de rendimiento de Windows) como la disponibilidad del servicio, el número total de solicitudes realizadas al servicio o el porcentaje de solicitudes correctas realizadas al servicio (para ver una lista completa de las métricas disponibles, consulte [Esquema de las tablas de métricas del análisis de almacenamiento][Esquema de las tablas de métricas del análisis de almacenamiento] en MSDN). Puede especificar si quiere que el servicio de almacenamiento recopile y agregue métricas cada hora o cada minuto. Para más información sobre cómo habilitar las métricas y supervisar las cuentas de almacenamiento, consulte el tema sobre [cómo habilitar las métricas de almacenamiento][cómo habilitar las métricas de almacenamiento] en MSDN.

Puede elegir las métricas horarias que quiere mostrar en el Portal de Azure y configurar reglas que notifiquen a los administradores por correo electrónico cada vez que una métrica horaria supere un umbral determinado (para más información, consulte la página [Recibir notificaciones de alerta y administrar reglas de alerta en Azure][Recibir notificaciones de alerta y administrar reglas de alerta en Azure]). El servicio de almacenamiento recopila métricas con un modelo de mejor esfuerzo, pero es posible que no registre todas las operaciones de almacenamiento.

La figura 2 de abajo muestra la página Monitor del portal, donde puede ver métricas como, por ejemplo, las cifras de disponibilidad, solicitudes totales y latencia media de una cuenta de almacenamiento. También se configuró una regla de notificación para que se envíe una alerta a un administrador si la disponibilidad desciende por debajo de un nivel determinado. Al observar estos datos, uno de los aspectos que podría investigar es que el porcentaje de operaciones correctas del servicio Tabla sea inferior al 100% (para más información, consulte la sección “[Las métricas muestran un PercentSuccess bajo o las entradas de registro de análisis tienen operaciones con el estado de transacción ClientOtherErrors][Las métricas muestran un PercentSuccess bajo o las entradas de registro de análisis tienen operaciones con el estado de transacción ClientOtherErrors]”).

![][1]

*Figura 2. Visualización de métricas de almacenamiento en el portal*
...
-   Investigar problemas potenciales con herramientas de diagnóstico, como se examina más adelante en la sección “[Diagnóstico de problemas de almacenamiento][Diagnóstico de problemas de almacenamiento]”.
...
La sección “[Guía de solución de problemas][Guía de solución de problemas]” de esta guía describe varios problemas habituales de los servicios de almacenamiento relacionados con la disponibilidad.
...
En el Portal de Azure, en la página **Monitor** de la cuenta de almacenamiento, puede agregar reglas de alertas para que le notifiquen si alguna de las métricas de rendimiento de este servicio llega a ser inferior o superior a un umbral que especifique.

La sección “[Guía de solución de problemas][Guía de solución de problemas]” de esta guía describe varios problemas habituales de los servicios de almacenamiento relacionados con el rendimiento.
...
-   Cambios significativos respecto de los valores de línea base que está supervisando, como se describe en la sección anterior, “[Supervisión del servicio de almacenamiento][Supervisión del servicio de almacenamiento]”.
...
La sección “[Guía de solución de problemas][Guía de solución de problemas]”, más adelante en esta misma guía, proporciona más información sobre algunos problemas habituales relacionados con el rendimiento que puede encontrarse.
...
> [WACOM.NOTE] Recuerde que es de esperar que observe algunos errores intermitentes: por ejemplo, errores de aplicaciones o errores debidos a estados transitorios de la red.
...
-   [Códigos de error comunes de la API de REST][Códigos de error comunes de la API de REST]
-   [Códigos de error del servicio Blob][Códigos de error del servicio Blob]
-   [Códigos de error del servicio Cola][Códigos de error del servicio Cola]
-   [Códigos de error del servicio Tabla][Códigos de error del servicio Tabla]
...
-   Fiddler (<http://www.telerik.com/fiddler>) es un proxy de depuración web que le permite examinar los datos de encabezados y cargas de los mensajes de solicitud y respuesta HTTP y HTTPS. Para más información, consulte “[Apéndice 1: Uso de Fiddler para capturar tráfico HTTP y HTTPS][Apéndice 1: Uso de Fiddler para capturar tráfico HTTP y HTTPS]”.
-   Monitor de red de Microsoft (Netmon) (<http://www.microsoft.com/es-es/download/details.aspx?id=4865>) y Wireshark (<http://www.wireshark.org/>) son analizadores de protocolos de red gratuitos que le permiten ver información detallada de los paquetes de una gran variedad de protocolos de red. Para más información sobre Wireshark, consulte “[Apéndice 2: Uso de Wireshark para capturar tráfico de red][Apéndice 2: Uso de Wireshark para capturar tráfico de red]”.
...
## <a name="end-to-end-tracing"></a>Traza de un extremo a otro
...
### <a name="client-request-id"></a>Identificador de solicitud de cliente
...
> [WACOM.NOTE] Es posible que varias solicitudes compartan el mismo identificador de solicitud de cliente, porque el cliente puede asignar ese valor (aunque la biblioteca de cliente de Almacenamiento asigne un
...
> [WACOM.NOTE] El servicio de almacenamiento siempre asigna un identificador de solicitud de servidor único a cada solicitud que recibe, de modo que cada reintento del cliente y cada operación incluida en un lote tiene un identificador de solicitud de servidor único.
...
La siguiente ilustración de la herramienta de supervisión del portal muestra un ejemplo en el que la **AverageE2ELatency** es significativamente más alta que la **AverageServerLatency**.
...
> [WACOM.NOTE] También puede ver la **E2ELatency** y la **ServerLatency** de cada operación de almacenamiento en los datos de registro del registro de Almacenamiento.
...
Para más información sobre el uso de Wireshark para solucionar problemas de red, consulte “[Apéndice 2: Uso de Wireshark para capturar tráfico de red][Apéndice 2: Uso de Wireshark para capturar tráfico de red]”.

Para más información sobre el uso del Analizador de mensajes de Microsoft para solucionar problemas de red, consulte “[Apéndice 3: Uso del Analizador de mensajes de Microsoft para capturar tráfico de red][Apéndice 3: Uso del Analizador de mensajes de Microsoft para capturar tráfico de red]”.
...
En el caso de que la **AverageServerLatency** de las solicitudes de descarga de BLOB sea alta, debe usar los registros del registro de Almacenamiento para ver si se repiten varias solicitudes del mismo BLOB (o conjunto de BLOB). Con las solicitudes de carga de BLOB, debe investigar qué tamaño de bloques está usando el cliente (por ejemplo, los bloques con un tamaño inferior a 64 K pueden provocar sobrecargas, salvo que las lecturas se realicen también en fragmentos de menos de 64 K), y si hay varios clientes que están cargando bloques al mismo BLOB en paralelo. Además, debe comprobar las métricas por minuto para ver si, en el número de solicitudes, hay picos que hacen que se superen los objetivos de escalabilidad por segundo: consulte también “[Las métricas muestran un aumento de PercentTimeoutError][Las métricas muestran un aumento de PercentTimeoutError]”.
...
> [WACOM.NOTE] Aquí puede ver una lista de comprobación completa con otros problemas que se deben tener en cuenta: “Lista de comprobación de diseño de aplicaciones basadas en almacenamiento escalables y de rendimiento adecuado”.
...
Los errores de limitación se producen cuando supera los objetivos de escalabilidad de un servicio de almacenamiento. El servicio de almacenamiento hace esto para asegurarse de que ningún cliente o inquilino pueda usar el servicio a expensas de otros. Para más información, consulte [Objetivos de escalabilidad y rendimiento del almacenamiento de Azure][Objetivos de escalabilidad y rendimiento del almacenamiento de Azure] para ver detalles sobre los objetivos de escalabilidad de las cuentas de almacenamiento y los objetivos de rendimiento de las particiones que hay dentro de las cuentas de almacenamiento.
...
-   [Aumento transitorio de PercentThrottlingError][Aumento transitorio de PercentThrottlingError]
-   [Aumento permanente del error PercentThrottlingError][Aumento permanente del error PercentThrottlingError]
...
Si observa que hay picos en el valor de **PercentThrottlingError** y que coinciden con los períodos de gran actividad de la aplicación, debe implementar en el cliente una estrategia de interrupción de reintentos exponencial (no lineal): esto reducirá la carga inmediata de la partición y facilitará que la aplicación suavice los picos de tráfico. Para más información sobre cómo implementar directivas de reintentos con la biblioteca de cliente de Almacenamiento, consulte el tema sobre el [espacio de nombres Microsoft.WindowsAzure.Storage.RetryPolicies][espacio de nombres Microsoft.WindowsAzure.Storage.RetryPolicies] en MSDN.

> [WACOM.NOTE] También es posible que aparezcan picos en el valor de **PercentThrottlingError** que no coincidan con los períodos de gran actividad de la aplicación: el motivo más probable, en ese caso, es que el servicio de almacenamiento esté moviendo particiones para mejorar el equilibrio de carga.

#### <a name="permanent-increase-in-PercentThrottlingError"></a>Aumento permanente del error PercentThrottlingError

Si observa que el valor de **PercentThrottlingError** es alto de forma constante después de un aumento permanente en los volúmenes de transacciones, o al realizar las primeras pruebas de carga de la aplicación, tiene que evaluar cómo está usando la aplicación las particiones de almacenamiento, y si se está acercando a los objetivos de escalabilidad de una cuenta de almacenamiento. Por ejemplo, si observa errores de limitación en una cola (que cuenta como una sola partición), debe considerar la posibilidad de usar colas adicionales para repartir las transacciones por varias particiones. Si observa errores de limitación en una tabla, tiene que plantearse la opción de usar otro esquema de particiones para repartir las transacciones por varias particiones con una variedad más amplia de valores de clave de partición. Una causa habitual de este problema es el antipatrón anexar/anteponer, con el que se selecciona la fecha como la clave de partición y, luego, todos los datos de un determinado día se escriben en una sola partición: si hay carga, esto puede provocar un cuello de botella de escritura. Debe pensar en usar otro diseño de particiones o evaluar si usar el almacenamiento de BLOB puede ser una solución más adecuada. También debe comprobar si la limitación se produce debido a picos en el tráfico e investigar posibles formas de suavizar el patrón de solicitudes.
...
> [WACOM.NOTE] Las pruebas de rendimiento deberían revelar todos los diseños de consulta ineficientes de la aplicación.
...
> [WACOM.NOTE] Puede que, temporalmente, no vea los errores de tiempo de espera, dado que el servicio de almacenamiento equilibra la carga de las solicitudes moviendo una partición a un nuevo servidor.
...
<table>
 <tr>
    <td><b>Origen</b></td>
    <td><b>Nivel de detalle</b></td>
    <td><b>Nivel de detalle</b></td>
    <td><b>Id. de solicitud de cliente</b></td>
    <td><b>Texto de operaci&oacute;n</b></td>
 </tr>
 <tr>
    ...
    <td>3</td>
    <td>85d077ab-…</td>
    <td>Iniciando operaci&oacute;n con ubicaci&oacute;n Primary seg&uacute;n modo de ubicaci&oacute;n PrimaryOnly.</td>
 </tr>
 <tr>
    <td>Microsoft.WindowsAzure.Storage</td>
    <td>Informaci&oacute;n</td>
    <td>3</td>
    <td>85d077ab-…</td>
    <td>Iniciando solicitud sincr&oacute;nica a https://domemaildist.blob.core.windows.netazure<br>imblobcontainer/blobCreatedViaSAS.txt?
 ...
 <tr>
  ...
  <td>
  Se inici&oacute; una excepci&oacute;n mientras se esperaba respuesta: El servidor remoto devolvi&oacute; un error: (403) Prohibido.. 
  </td>
 </tr>
 <tr>
  <td>
  ...
  <td>
  Respuesta recibida. C&oacute;digo de estado = 403, Id. de solicitud = 9d67c64a-64ed-4b0d-9515-3b14bbcdc63d, Content-MD5 = , ETag = . 
  </td>
 </tr>
 <tr>
  <td>
  ...
  <td>
  Se inici&oacute; una excepci&oacute;n durante la operaci&oacute;n: El servidor remoto devolvi&oacute; un error: (403) Prohibido.. 
  </td>
 </tr>
 <tr>
  <td>
  ...
  <td>
  Comprobando si se debe reintentar la operaci&oacute;n. N&uacute;mero de reintentos = 0, C&oacute;digo de estado HTTP = 403, Excepci&oacute;n = El servidor remoto devolvi&oacute; un error: (403) Prohibido.. 
  </td>
 </tr>
 <tr>
  <td>
  ...
  <td>
  La siguiente ubicaci&oacute;n se estableci&oacute; como Primary, de acuerdo con el modo de ubicaci&oacute;n. 
  </td>
 </tr>
 <tr>
  <td>
  ...
  <td>
  La directiva de reintentos no permiti&oacute; un reintento. Error: El servidor remoto devolvi&oacute; un error: (403) Prohibido. 
  </td>
 </tr>
</table>
...
-   ¿El parámetro de versión de la clave SAS (por ejemplo, **sv=2012-02-12**) coincide con la versión de la biblioteca de cliente de Almacenamiento que está utilizando? Siempre debe usar la última versión de la biblioteca de cliente de Almacenamiento. Para más información sobre el control de versiones de token de SAS y las dependencias de la versión de la biblioteca de cliente, consulte [][4].
...
-   [El cliente u otro proceso eliminaron anteriormente el objeto][El cliente u otro proceso eliminaron anteriormente el objeto]
-   [Un problema de autorización de Firma de acceso compartido (SAS)][Un problema de autorización de Firma de acceso compartido (SAS)]
-   [El código JavaScript del lado cliente no tiene permiso para acceder al objeto][El código JavaScript del lado cliente no tiene permiso para acceder al objeto]
...
<table>
  ...
  <tr>
    <td>07b26a5d-...</td>
    <td>
    M&eacute;todo <b>DeleteIfExists</b> para eliminar el contenedor de BLOB. Tenga en cuenta que esta operaci&oacute;n incluye una 
    solicitud <b>HEAD</b> para comprobar la existencia del contenedor.</td>
  </tr>
  <tr>
    <td>e2d06d78…</td>
    <td>
    M&eacute;todo <b>CreateIfNotExists</b> para crear el contenedor de BLOB. Tenga en cuenta que esta operaci&oacute;n incluye una 
    solicitud <b>HEAD</b> que comprueba la existencia del contenedor. La opci&oacute;n 
    <b>HEAD</b> devuelve un mensaje 404 pero contin&uacute;a.</td>
  </tr>
  <tr>
    <td>de8b1c3c-...</td>
    <td>
    M&eacute;todo <b>UploadFromStream</b> para crear el BLOB. La opci&oacute;n 
    Se produce un error en la solicitud <b>PUT</b> con un mensaje 404.</td>
  </tr>
</table>
...
<table>
  <tr>
    ...
    <td>
      <b>Texto de operaci&oacute;n</b>
    </td>
  </tr>
  <tr>
    <td>07b26a5d-...</td>
    <td>&nbsp;Iniciando solicitud sincr&oacute;nica a https://domemaildist.blob.core.windows.net/azuremmblobcontainer.</td>
  </tr>
  <tr>
    <td>07b26a5d-...</td>
  ...
  <tr>
    <td>07b26a5d-...</td>
    <td>&nbsp;Respuesta recibida. C&oacute;digo de estado = 200, Id. de solicitud = eeead849-...Content-MD5 = , ETag =
    &quot;0x8D14D2DC63D059B&quot;.</td>
  </tr>
  <tr>
    <td>07b26a5d-...</td>
    <td>&nbsp;Los encabezados de respuesta se procesaron correctamente y se continu&oacute; con el resto de la operaci&oacute;n.</td>
  </tr>
  <tr>
    <td>07b26a5d-...</td>
    <td>&nbsp;Descargando el cuerpo de respuesta.</td>
  </tr>
  <tr>
    <td>07b26a5d-...</td>
    <td>&nbsp;Operaci&oacute;n completada correctamente.</td>
  </tr>
  <tr>
    <td>07b26a5d-...</td>
    <td>&nbsp;Iniciando solicitud sincr&oacute;nica a https://domemaildist.blob.core.windows.net/azuremmblobcontainer.</td>
  ...
  <tr>
    <td>07b26a5d-...</td>
    <td>&nbsp;Respuesta recibida. C&oacute;digo de estado = 202, Id. de solicitud = 6ab2a4cf-..., Content-MD5 = , ETag = .</td>
  </tr>
  <tr>
    <td>07b26a5d-...</td>
    <td>&nbsp;Los encabezados de respuesta se procesaron correctamente y se continu&oacute; con el resto de la operaci&oacute;n.</td>
  ...
  <tr>
    <td>e2d06d78-...</td>
    <td>&nbsp;Iniciando solicitud asincr&oacute;nica a https://domemaildist.blob.core.windows.net/azuremmblobcontainer.</td>
  </tr>
  <tr>
    <td>e2d06d78-...</td>
  ...
  <tr>
    <td>de8b1c3c-...</td>
    <td>&nbsp;Iniciando solicitud sincr&oacute;nica a https://domemaildist.blob.core.windows.net/azuremmblobcontainer/blobCreated.txt.</td>
  </tr>
  <tr>
    <td>de8b1c3c-...</td>
    <td>&nbsp;StringToSign =
  ...
  <tr>
    <td>de8b1c3c-...</td>
    <td>&nbsp;Prepar&aacute;ndose para escribir datos de solicitud.</td>
  </tr>
  <tr>
    <td>e2d06d78-...</td>
    <td>&nbsp;Se inici&oacute; una excepci&oacute;n mientras se esperaba respuesta: El servidor remoto devolvi&oacute; un error: (404) No encontrado..</td>
  </tr>
  <tr>
    <td>e2d06d78-...</td>
    <td>&nbsp;Respuesta recibida. C&oacute;digo de estado = 404, Id. de solicitud = 353ae3bc-..., Content-MD5 = , ETag = .</td>
  </tr>
  <tr>
    <td>e2d06d78-...</td>
    <td>&nbsp;Los encabezados de respuesta se procesaron correctamente y se continu&oacute; con el resto de la operaci&oacute;n.</td>
  ...
  <tr>
    <td>de8b1c3c-...</td>
    <td>&nbsp;Escribiendo datos de solicitud.</td>
  </tr>
  <tr>
    <td>de8b1c3c-...</td>
    <td>&nbsp;Esperando respuesta.</td>
  ...
  <tr>
    <td>e2d06d78-...</td>
    <td>&nbsp;Se inici&oacute; una excepci&oacute;n mientras se esperaba respuesta: El servidor remoto devolvi&oacute; un error: (409) Conflicto..</td>
  </tr>
  <tr>
    <td>e2d06d78-...</td>
    <td>&nbsp;Respuesta recibida. C&oacute;digo de estado = 409, Id. de solicitud = c27da20e-..., Content-MD5 = , ETag = .</td>
  </tr>
  <tr>
    <td>e2d06d78-...</td>
    <td>&nbsp;Descargando el cuerpo de respuesta del error.</td>
  </tr>
  <tr>
    <td>de8b1c3c-...</td>
    <td>&nbsp;Se inici&oacute; una excepci&oacute;n mientras se esperaba respuesta: El servidor remoto devolvi&oacute; un error: (404) No encontrado..</td>
  ...
  <tr>
    <td>de8b1c3c-...</td>
    <td>&nbsp;Respuesta recibida. C&oacute;digo de estado = 404, Id. de solicitud = 0eaeab3e-..., Content-MD5 = , ETag = .</td>
  </tr>
  <tr>
    <td>de8b1c3c-...</td>
    <td>&nbsp;Se inici&oacute; una excepci&oacute;n durante la operaci&oacute;n: El servidor remoto devolvi&oacute; un error: (404) No encontrado..</td>
  </tr>
  <tr>
    <td>de8b1c3c-...</td>
    <td>&nbsp;La directiva de reintentos no permiti&oacute; un reintento. Error: El servidor remoto devolvi&oacute; un error: (404) No encontrado..</td>
  </tr>
  <tr>
    <td>e2d06d78-...</td>
    <td>&nbsp;La directiva de reintentos no permiti&oacute; un reintento. Error: El servidor remoto devolvi&oacute; un error: (409) Conflicto..</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td>C&oacute;digo de estado HTTP</td>
    <td>404</td>
  </tr>
  <tr>
    <td>Tipo de autenticaci&oacute;n</td>
    <td>Sas</td>
  </tr>
  <tr>
...
> [WACOM.NOTE] Puede utilizar las Herramientas de desarrollo F12 de Internet Explorer para seguir paso a paso los mensajes que se intercambian entre el explorador y el servicio de almacenamiento al solucionar problemas de JavaScript del lado cliente.

Estos errores se producen porque el explorador web implementa la restricción de seguridad [directiva del mismo origen][directiva del mismo origen], que impide que una página web llame a una API de un dominio que no sea el dominio del que proviene la página.

Una solución alternativa al problema de JavaScript consiste en configurar el Uso compartido de recursos entre orígenes (CORS) para el servicio de almacenamiento al que está accediendo el cliente. Para más información, consulte [Compatibilidad con Uso compartido de recursos entre orígenes (CORS) para los Servicios de almacenamiento de Azure][Compatibilidad con Uso compartido de recursos entre orígenes (CORS) para los Servicios de almacenamiento de Azure] en MSDN.
...
<table>
  <tr>
    ...
    <td>
      <b>Nombre del contenedor</b>
    </td>
    <td>
      <b>Id. de solicitud de cliente</b>
    </td>
  </tr>
  <tr>
...
El código de la aplicación cliente elimina un contenedor de BLOB y, justo después, vuelve a crearlo con el mismo nombre: el método **CreateIfNotExists** (identificador de solicitud de cliente bc881924-…), finalmente, experimenta el error HTTP 409 (conflicto). Cuando un cliente elimina contenedores de BLOB, tablas o colas, transcurre un breve período hasta que el nombre vuelve a estar disponible.
...
Puede encontrar una lista de códigos de error habituales de la API de REST que devuelven los servicios de almacenamiento en la página [Códigos de error comunes de la API de REST][Códigos de error comunes de la API de REST].
...
En general, cada operación individual de entrada o salida de un VHD desde una máquina virtual se traduce en operaciones **Get Page** o **Put Page** en el blob en páginas subyacente. Por lo tanto, puede usar el IOPS estimado para su entorno con el fin de ajustar la cantidad de VHD que puede tener en una sola cuenta de almacenamiento, en función del comportamiento específico de la aplicación. No recomendamos tener más de 40 discos en una sola cuenta de almacenamiento. Consulte [Objetivos de escalabilidad y rendimiento del almacenamiento de Azure][5] para ver los detalles de los objetivos de escalabilidad actuales de las cuentas de almacenamiento: en concreto, la tasa de solicitudes total y el ancho de banda total correspondientes al tipo de cuenta de almacenamiento que esté usando.
Si supera los objetivos de escalabilidad de su cuenta de almacenamiento, debe colocar los VHD en varias cuentas de almacenamiento diferentes para reducir la actividad en cada una de las cuentas.
...
-   [La característica “X” no funciona en el emulador de almacenamiento][La característica “X” no funciona en el emulador de almacenamiento]
-   [Error “El valor de uno de los encabezados HTTP no está en el formato correcto” al usar el emulador de almacenamiento][Error “El valor de uno de los encabezados HTTP no está en el formato correcto” al usar el emulador de almacenamiento]
-   [La ejecución del emulador de almacenamiento requiere privilegios administrativos][La ejecución del emulador de almacenamiento requiere privilegios administrativos]

#### <a name="feature-X-is-not-working"></a>La característica “X” no funciona en el emulador de almacenamiento

El emulador de almacenamiento no admite todas las características de los servicios de almacenamiento de Azure como, por ejemplo, el servicio de archivos. Para más información, consulte [Diferencias entre el emulador de almacenamiento y los servicios de almacenamiento de Azure][Diferencias entre el emulador de almacenamiento y los servicios de almacenamiento de Azure] en MSDN.
...
Para más información, consulte [Inicializar el emulador de almacenamiento con la herramienta de línea de comandos][Inicializar el emulador de almacenamiento con la herramienta de línea de comandos] en MSDN (también puede inicializar el emulador de almacenamiento en Visual Studio, lo que requiere igualmente privilegios administrativos).

### <a name="you-are-encountering-problems-installing-the-Windows-Azure-SDK"></a>Se producen problemas al instalar el SDK de Windows Azure para .NET
...
Para más información sobre el uso de Fiddler, consulte “[Apéndice 1: Uso de Fiddler para capturar tráfico HTTP y HTTPS][Apéndice 1: Uso de Fiddler para capturar tráfico HTTP y HTTPS]”.

Para más información sobre el uso de Wireshark, consulte “[Apéndice 2: Uso de Wireshark para capturar tráfico de red][Apéndice 2: Uso de Wireshark para capturar tráfico de red]”.

Para más información sobre el uso del Analizador de mensajes de Microsoft, consulte “[Apéndice 3: Uso del Analizador de mensajes de Microsoft para capturar tráfico de red][Apéndice 3: Uso del Analizador de mensajes de Microsoft para capturar tráfico de red]”.
...
Fiddler es una herramienta útil para analizar el tráfico HTTP y HTTPS entre la aplicación cliente y el servicio de almacenamiento de Azure que está utilizando. Puede descargar Fiddler de <http://www.telerik.com/fiddler>.

> [WACOM.NOTE] Fiddler puede descodificar el tráfico HTTPS. Para entender cómo lo hace y comprender las implicaciones para la seguridad, debe leer atentamente la documentación de Fiddler.
...
-   Guardar los datos de tráfico capturados. En el menú principal, vaya a **File** (Archivo), haga clic en **Save** (Guardar) y, después, haga clic en **All Sessions** (Todas las sesiones): esto le permitirá guardar el tráfico en un archivo de sesión. Más adelante, puede recargar un archivo de sesión para analizarlo o enviárselo al soporte técnico de Microsoft si se lo solicita.
...
Wireshark es un analizador de protocolos de red que le permite ver información detallada sobre los paquetes de una gran variedad de protocolos de red. Puede descargar Wireshark de <http://www.wireshark.org/>.
...
4.  Agregue un filtro al cuadro de texto **Capture Filter** (Filtro de captura). Por ejemplo, **host contosoemaildist.table.core.windows.net** configurará Wireshark para que capture solamente los paquetes enviados al extremo del servicio Tabla de la cuenta de almacenamiento **contosoemaildist** o desde dicho extremo. Para ver una lista completa de los filtros de captura, consulte <http://wiki.wireshark.org/CaptureFilters>.
...
Para configurar una sesión de traza web del tráfico HTTP y HTTPS con el Analizador de mensajes de Microsoft, ejecute la aplicación Analizador de mensajes de Microsoft y, luego, en el menú **Archivo**, haga clic en **Captura/seguimiento**. En la lista de escenarios de seguimiento disponibles, seleccione **Proxy web**. Luego, en el panel **Configuración de escenario de seguimiento**, en el cuadro de texto **HostnameFilter**, agregue los nombres de los extremos de almacenamiento (puede buscar estos nombres en el Portal de Azure). Por ejemplo, si el nombre de su cuenta de almacenamiento de Azure es **contosodata**, debe agregar lo siguiente al cuadro de texto **HostnameFilter**:

    contosodata.blob.core.windows.net contosodata.table.core.windows.net contosodata.queue.core.windows.net

> [WACOM.NOTE] Un carácter de espacio separa los nombres de host.

Cuando esté listo para empezar a recopilar datos de seguimiento, haga clic en el botón **Iniciar con**.

Para más información sobre el seguimiento de **Proxy web** del Analizador de mensajes de Microsoft, consulte el tema sobre el [Proveedor PEF-WebProxy][Proveedor PEF-WebProxy] en TechNet.
...
Para más información sobre el seguimiento del Nivel de vínculo local del Analizador de mensajes de Microsoft, consulte [Proveedor PEF-NDIS-PacketCapture][Proveedor PEF-NDIS-PacketCapture] en TechNet.

### <a name="appendix-4"></a>Apéndice 4: Uso de Excel para ver métricas y datos de registro

Hay muchas herramientas que le permiten descargar los datos de métricas de Almacenamiento del almacenamiento de tablas de Azure en un formato delimitado con el que es fácil cargar los datos en Excel para verlos y analizarlos. Los datos de registro de Almacenamiento del almacenamiento de BLOB de Azure ya están en un formato delimitado que puede cargar en Excel. Sin embargo, tendrá que agregar los encabezados de columna correspondientes de acuerdo con la información de [Formato del registro del análisis de almacenamiento][Formato del registro del análisis de almacenamiento] y [Esquema de las tablas de métricas del análisis de almacenamiento][12].
...
Cuando se escribió este documento, Application Insights se encontraba en una versión preliminar. Puede ver más información en [Application Insights para Visual Studio Online en MSDN][Application Insights para Visual Studio Online en MSDN].
  ...
  [Se producen problemas al instalar el SDK de Windows Azure para .NET]: #you-are-encountering-problems-installing-the-Windows-Azure-SDK
  ...
  [Esquema de las tablas de métricas del análisis de almacenamiento]: http://msdn.microsoft.com/es-es/library/azure/hh343264.aspx
  [cómo habilitar las métricas de almacenamiento]: http://go.microsoft.com/fwlink/?LinkId=510865
  [Recibir notificaciones de alerta y administrar reglas de alerta en Azure]: http://msdn.microsoft.com/library/azure/dn306638.aspx
  ...
  [facturación del Almacenamiento de Windows Azure: ancho de banda, transacciones y capacidad]: http://blogs.msdn.com/b/windowsazurestorage/archive/2010/07/09/understanding-windows-azure-storage-billing-bandwidth-transactions-and-capacity.aspx
  [0]: http://msdn.microsoft.com/es-es/library/azure/hh343260.aspx
  [almacenamiento con redundancia geográfica con acceso de lectura y opciones de redundancia de Almacenamiento de Windows Azure]: http://blogs.msdn.com/b/windowsazurestorage/archive/2013/12/04/introducing-read-access-geo-replicated-storage-ra-grs-for-windows-azure-storage.aspx
  [Códigos de error comunes de la API de REST]: http://msdn.microsoft.com/es-es/library/azure/dd179357.aspx
  [Códigos de error del servicio Blob]: http://msdn.microsoft.com/es-es/library/azure/dd179439.aspx
  [Códigos de error del servicio Cola]: http://msdn.microsoft.com/es-es/library/azure/dd179446.aspx
  [Códigos de error del servicio Tabla]: http://msdn.microsoft.com/es-es/library/azure/dd179438.aspx
  [usar el registro del lado servidor]: http://go.microsoft.com/fwlink/?LinkId=510867
  [registro del lado cliente con la biblioteca de cliente de Almacenamiento]: http://go.microsoft.com/fwlink/?LinkId=510868
  [3]: ./media/storage-monitoring-diagnosing-troubleshooting/high-e2e-latency.png
  [Al algoritmo Nagle no le gustan las solicitudes pequeñas]: http://blogs.msdn.com/b/windowsazurestorage/archive/2010/06/25/nagle-s-algorithm-is-not-friendly-towards-small-requests.aspx
  [Depurar, trazar y generar perfiles]: http://msdn.microsoft.com/es-es/library/7fe0dd2y(v=vs.110).aspx
  ...
  [espacio de nombres Microsoft.WindowsAzure.Storage.RetryPolicies]: http://msdn.microsoft.com/es-es/library/microsoft.windowsazure.storage.retrypolicies.aspx
  ...
  [Delegar el acceso con una firma de acceso compartido]: http://msdn.microsoft.com/es-es/library/azure/ee395415.aspx
  ...
  [directiva del mismo origen]: http://www.w3.org/Security/wiki/Same_Origin_Policy
  [Compatibilidad con Uso compartido de recursos entre orígenes (CORS) para los Servicios de almacenamiento de Azure]: http://msdn.microsoft.com/es-es/library/windowsazure/dn535601.aspx
  [5]: http://msdn.microsoft.com/es-es/library/azure/dn249410.aspx
  ...
  [Diferencias entre el emulador de almacenamiento y los servicios de almacenamiento de Azure]: http://msdn.microsoft.com/es-es/library/gg433135.aspx
  [Inicializar el emulador de almacenamiento con la herramienta de línea de comandos]: http://msdn.microsoft.com/es-es/library/gg433132.aspx
  ...
  [aquí]: http://www.wireshark.org/docs/wsug_html_chunked/ChAdvFollowTCPSection.html
  [9]: ./media/storage-monitoring-diagnosing-troubleshooting/wireshark-screenshot-3.png
  [Guía del usuario de Wireshark]: http://www.wireshark.org/docs/wsug_html_chunked/
  [Proveedor PEF-WebProxy]: http://technet.microsoft.com/es-es/library/jj674814.aspx
  ...
  [Proveedor PEF-NDIS-PacketCapture]: http://technet.microsoft.com/es-es/library/jj659264.aspx
  [Formato del registro del análisis de almacenamiento]: http://msdn.microsoft.com/es-es/library/hh343259.aspx
  [12]: http://msdn.microsoft.com/es-es/library/hh343264.aspx
  [Application Insights para Visual Studio Online en MSDN]: http://msdn.microsoft.com/es-es/library/dn481095.aspx
