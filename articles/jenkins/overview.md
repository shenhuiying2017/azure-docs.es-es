...
- [Aplicación web de Azure](/azure/app-service-web/app-service-web-overview). Consulte los [procedimientos](deploy-Jenkins-app-service-plugin.md) para empezar a trabajar.
