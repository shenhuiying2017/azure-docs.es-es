...
- Cambio de nombre de `RemoteDependencyModule` a `DependencyTrackingTelemetryModule`.
- Cambio de nombre de `CustomPerformanceCounterCollectionRequest` a `PerformanceCounterCollectionRequest`.
