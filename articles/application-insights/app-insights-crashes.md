...
Si aún no lo ha hecho, agregue [Application Insights al proyecto de la aplicación][platforms] y vuelva a publicarlo.
...
![En el gráfico de bloqueos, haga clic en Reglas de alerta y, a continuación, en Agregar alerta](./media/app-insights-crashes/appinsights-d023-alert.png)
