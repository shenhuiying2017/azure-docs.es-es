...
## <a name="run-the-application-and-see-metrics"></a>Ejecución de la aplicación y visualización de las métricas
...
* [Insertar llamadas a TrackException en el código](app-insights-api-custom-events-metrics.md#trackexception).
...
* [Realice el seguimiento de métricas y eventos personalizados](app-insights-web-track-usage.md) para más información sobre cómo se usa la aplicación tanto en el servidor como en el cliente.
