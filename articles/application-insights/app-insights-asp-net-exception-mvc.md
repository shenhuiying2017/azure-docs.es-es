...
![Selección de errores](./media/app-insights-asp-net-exception-mvc/012-start.png)
...
![Seleccione una instancia de una solicitud con error y, en los detalles de la excepción, obtenga las instancias de la excepción.](./media/app-insights-asp-net-exception-mvc/030-req-drill.png)
...
![Obtener detalles](./media/app-insights-asp-net-exception-mvc/040-exception-drill.png)
...
![Obtener detalles](./media/app-insights-asp-net-exception-mvc/050-exception-properties.png)
...
![Obtener detalles](./media/app-insights-asp-net-exception-mvc/viewCustomEvents.png)
...
![Obtener detalles](./media/app-insights-asp-net-exception-mvc/060-req-related.png)
