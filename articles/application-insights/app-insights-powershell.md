...
## <a name="enterprise-price-plan"></a>Plan de precios de Enterprise
...
* Si solo desea usar el plan de precios Básico predeterminado, puede omitir el recurso de plan de precios de la plantilla.
