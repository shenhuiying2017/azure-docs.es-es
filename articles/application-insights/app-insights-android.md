...
> [AZURE.NOTE]Se recomienda usar [HockeyApp](http://support.hockeyapp.net/kb/client-integration-android/hockeyapp-for-android-sdk) para obtener informes de bloqueo, análisis, distribución y administración de comentarios.
...
Siga la [guía de configuración](https://github.com/Microsoft/ApplicationInsights-Android#-3-setup) indicada a continuación:
