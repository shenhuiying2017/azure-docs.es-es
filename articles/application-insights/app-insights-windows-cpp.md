<properties pageTitle="Application Insights para aplicaciones C++" description="Analice el uso y el rendimiento de su aplicación C++ con Application Insights." services="application-insights" documentationCenter="cpp" authors="crystk" manager="jakubo""/>
