...
![La instrumentación de Application Insights de la aplicación envía datos de telemetría al recurso de Application Insights en el Portal de Azure.](./media/app-service-app-insights-get-started/01-scheme.png)
...
> [AZURE.NOTE]  En este punto, quizás desea seguir adelante y experimentar. Sin embargo, si desea ver qué puede hacer Application Insights, siga leyendo...
...
![Hoja de información general](./media/app-service-app-insights-get-started/01-find.png)
...
![Hoja de servidores](./media/app-service-app-insights-get-started/04.png)
...
![editar el gráfico](./media/app-service-app-insights-get-started/05.png)
...
![Buscar instancias](./media/app-service-app-insights-get-started/06.png)

Use filtros para centrarse en determinados tipos de evento y en valores de propiedad de su elección:

![Filtrar por propiedades](./media/app-service-app-insights-get-started/07.png)
...
![Elementos relacionados y detalles de propiedades](./media/app-service-app-insights-get-started/08.png)
...
![Crear un elemento de trabajo](./media/app-service-app-insights-get-started/09.png)
...
![Análisis](./media/app-service-app-insights-get-started/10.png)
...
![Análisis](./media/app-service-app-insights-get-started/11.png)
...
![Paneles](./media/app-service-app-insights-get-started/12.png)
...
[![Introducción animada](./media/app-service-app-insights-get-started/video-front-1.png)](https://www.youtube.com/watch?v=fX2NtGrh-Y0)
