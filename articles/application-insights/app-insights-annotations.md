...
3. En una ventana de explorador independiente, abra (o cree) la plantilla de versión que administra sus implementaciones de Visual Studio Team Services.
...
5. De nuevo en la hoja Acceso a la API, cree una nueva clave de API y realice una copia de ella.
