...
Si ha creado el proyecto en Visual Studio de 2015, ya debe disponer de Application Insights. De lo contrario, siga la [Guía de introducción](https://github.com/Microsoft/ApplicationInsights-aspnetcore/wiki/Getting-Started).
