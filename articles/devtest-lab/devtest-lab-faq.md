<properties
	pageTitle="Preguntas más frecuentes sobre Azure DevTest Labs | Microsoft Azure"
...
### ¿Por qué debería usar Azure DevTest Labs? 
...
### ¿Cómo se usa Azure DevTest Labs? 
...
### ¿Cómo se factura Azure DevTest Labs? 
...
### ¿Cuáles son los diferentes niveles de seguridad en Azure DevTest Labs?  
...
### ¿Por qué no puedo ver determinadas máquinas virtuales en la hoja Azure Virtual Machines que sí veo en Azure DevTest Labs?
...
### ¿Cómo se pueden mover las máquinas virtuales de Azure existentes a mi laboratorio de Azure DevTest Labs? 
...
1. [Cree la imagen personalizada](devtest-lab-create-template.md) dentro del laboratorio de Azure DevTest Labs.
