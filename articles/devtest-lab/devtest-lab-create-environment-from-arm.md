---
title: "Creación de entornos de varias máquinas virtuales con plantillas de Azure Resource Manager | Microsoft Docs"
description: "Obtenga información acerca de cómo crear entornos de varias máquinas virtuales en Azure DevTest Labs a partir de una plantilla de Azure Resource Manager"
...
- Los usuarios tienen el mismo control de directivas de máquinas virtuales para los entornos que el que tienen para las máquinas virtuales de un solo laboratorio.
...
Como uno de los procedimientos recomendados con infraestructura como código y configuración como código, las plantillas de entorno deben administrarse con control de código fuente. Azure DevTest Labs sigue este procedimiento y carga todas las plantillas de Azure Resource Manager directamente desde los repositorios de GitHub o VSTS Git. Hay un par de reglas para organizar las plantillas de Azure Resource Manager en un repositorio:
...
1. Una vez creado el entorno, selecciónelo en la lista **My virtual machines** (Mis máquinas virtuales) para abrir la hoja del grupo de recursos y examinar los recursos aprovisionados en el entorno.
