...
Por ejemplo, si ha creado una nueva red virtual y deseaba aplicarla a todos los laboratorios existentes, puede hacerlo rápidamente mediante una plantilla de Azure Resource Manager.
