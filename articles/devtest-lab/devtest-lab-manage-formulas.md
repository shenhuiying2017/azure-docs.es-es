...
> [!NOTE]
> Fórmulas: al igual que las [imágenes personalizadas](devtest-lab-create-template.md), le permiten crear una imagen base desde un archivo VHD. La imagen base se puede usar luego para aprovisionar una nueva máquina virtual. Para que le sea más fácil decidir cuál es la adecuada para su entorno concreto, consulte el artículo [Comparación de imágenes personalizadas y fórmulas en DevTest Labs](devtest-lab-comparing-vm-base-image-types.md).
> 
> 
