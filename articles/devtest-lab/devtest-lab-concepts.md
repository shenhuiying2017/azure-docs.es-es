<properties
	pageTitle="Conceptos de DevTest Labs | Microsoft Azure"
...
Los artefactos son archivos JSON basados de [Azure Resource Manager](../resource-group-overview.md) que contienen instrucciones para realizar la implementación y aplicar la configuración.

##Repositorios de artefacto
