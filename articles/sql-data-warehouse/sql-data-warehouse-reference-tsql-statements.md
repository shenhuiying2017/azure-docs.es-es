...
Para más ejemplos de TSQL, consulte [Información general de referencia de Almacenamiento de datos SQL][Información general de referencia de Almacenamiento de datos SQL].
