...
description: Vínculos a contenido de referencia para los temas de lenguaje Transact-SQL utilizados por SQL Data Warehouse.
...
Para obtener más referencias de TSQL, consulte [Elementos del lenguaje T-SQL de SQL Data Warehouse](sql-data-warehouse-reference-tsql-language-elements.md).
