...
#Integración de servicios con Almacenamiento de datos SQL
...
Además, estamos trabajando para establecer relaciones más estrechas con proveedores de otros servicios del ecosistema de Azure.

##Power BI
La integración de Power BI permite a los usuarios aprovechar en gran medida la capacidad de procesamiento de Almacenamiento de datos SQL con los informes dinámicos y la visualización de Power BI. Actualmente, la integración con Power BI incluye:

+ **Conexión directa**: una conexión más avanzada con aplicación de lógica en Almacenamiento de datos SQL. Esto permitirá agilizar los análisis en una escala mayor.
...
##Factoría de datos de Azure
Factoría de datos de Azure ofrece a los usuarios una plataforma administrada para crear canalizaciones complejas de extracción, transformación y carga. La integración de Almacenamiento de datos SQL con Factoría de datos de Azure incluye lo siguiente:

+ **Movimiento de datos**: programar la transferencia de datos a través de diversos servicios locales y de Azure.
...
+ **Resultado del trabajo:** enviar los resultados de los trabajos de Análisis de transmisores directamente al Almacenamiento de datos SQL.

Consulte [Integración con Análisis de transmisores de Azure](../sql-data-warehouse-integrate-azure-stream-analytics.md) o la [documentación de Análisis de transmisores de Azure](https://azure.microsoft.com/documentation/services/stream-analytics/) para obtener más información.
