...
## Arquitectura de procesamiento paralelo masivo
...
## Optimizado para cargas de trabajo de almacenamiento de datos
...
**Herramientas de terceros:** un gran número de proveedores de herramientas de terceros ha certificado la integración de sus herramientas con Almacenamiento de datos SQL. Para ver una lista completa, consulte los [asociados de soluciones de SQL Data Warehouse][asociados de soluciones de SQL Data Warehouse].
