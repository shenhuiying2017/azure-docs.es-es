<properties
   pageTitle="Búsqueda de consultas de usuario de larga ejecución en Almacenamiento de datos SQL de Azure | Microsoft Azure"
   description="Aprenda a supervisar su carga de trabajo y buscar consultas de larga ejecución en Almacenamiento de datos SQL de Azure mediante vistas de administración dinámica (DMV)."
...
# Búsqueda de consultas de larga ejecución
