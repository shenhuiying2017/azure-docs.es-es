---
title: Administración de bases de datos en Almacenamiento de datos SQL de Azure | Microsoft Docs
...
### Portal de Azure
El [Portal de Azure][Portal de Azure] es un portal basado en web donde se pueden crear, actualizar y eliminar bases de datos, así como supervisar recursos de bases de datos. Es una herramienta muy útil si se está empezando a trabajar con Azure, se administran pocas bases de datos de almacenamiento de datos o hay que hacer algo rápidamente.

Para empezar a usar el Portal de Azure, consulte [Creación de Almacenamiento de datos SQL (Portal de Azure)][Creación de Almacenamiento de datos SQL (Portal de Azure)].
...
Las DMV son las herramientas esenciales de la administración de Almacenamiento de datos SQL. Casi toda la información que se presenta en el portal se basa en DMV. Para ver una lista de las DMV de Almacenamiento de datos SQL, consulte [Vistas del sistema de Almacenamiento de datos SQL][Vistas del sistema de Almacenamiento de datos SQL].

Para comenzar, consulte [Conexión y consultas con SQLCMD][Conexión y consultas con SQLCMD] y [Creación de una base de datos (PowerShell)][Creación de una base de datos (PowerShell)].
...
Para más información sobre el escalado de DWU, consulte [Scale performance][Scale performance] \(Escalado del rendimiento).
...
Para más información, consulte [Pause compute][Pause compute] \(Pausa del proceso) y [Resume compute][Resume compute] \(Reanudación del proceso).
...
Para buscar las consultas de larga ejecución, consulte [Supervisión de la carga de trabajo con DMV][Supervisión de la carga de trabajo con DMV].
