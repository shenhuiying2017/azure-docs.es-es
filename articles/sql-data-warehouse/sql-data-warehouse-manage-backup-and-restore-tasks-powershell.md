<properties
   pageTitle="Copia de seguridad y restauración en Almacenamiento de datos SQL de Azure (PowerShell) | Microsoft Azure"
...
Copia de seguridad y restauración de una base de datos en Almacenamiento de datos SQL mediante PowerShell.
