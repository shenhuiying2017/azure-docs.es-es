...
* [Vistas del sistema de Transact-SQL][Transact-SQL system views]
* [Cmdlets de PowerShell][PowerShell cmdlets]

## <a name="next-steps"></a>Pasos siguientes
Para obtener información de desarrollo, consulte la [información general sobre este tema][development overview].
