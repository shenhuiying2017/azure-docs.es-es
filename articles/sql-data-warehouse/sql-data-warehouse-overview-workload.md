...
## Pasos siguientes
Ahora que ya conoce un poco Almacenamiento de datos SQL, aprenda a [crear un Almacenamiento de datos SQL][crear un Almacenamiento de datos SQL] y [cargar datos de ejemplo][cargar datos de ejemplo] rápidamente.
