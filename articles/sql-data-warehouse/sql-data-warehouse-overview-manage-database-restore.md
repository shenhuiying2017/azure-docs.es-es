<properties
   pageTitle="Restauración de bases de datos en Almacenamiento de datos SQL de Azure (información general) | Microsoft Azure"
...
# Restauración de bases de datos en Almacenamiento de datos SQL de Azure (información general)
