---
title: Procedimientos recomendados para Almacenamiento de datos SQL de Azure | Microsoft Docs
...
Consulte también cómo [pausar][pausar], [reanudar][reanudar] y [escalar los recursos de proceso][escalar los recursos de proceso]
...
Consulte también [Transacciones en el Almacenamiento de datos SQL][Transacciones en el Almacenamiento de datos SQL], [Optimización de transacciones para Almacenamiento de datos SQL][Optimización de transacciones para Almacenamiento de datos SQL]
...
Consulte también [Manage table statistics][Manage table statistics] \(Administración de estadísticas en tablas), [CREATE STATISTICS][CREATE STATISTICS], [UPDATE STATISTICS][UPDATE STATISTICS]
...
Consulte también [Carga de datos en Almacenamiento de datos SQL de Azure][Carga de datos en Almacenamiento de datos SQL de Azure], [Guía para el uso de PolyBase en Almacenamiento de datos SQL][Guía para el uso de PolyBase en Almacenamiento de datos SQL], [Azure SQL Data Warehouse loading patterns and strategies][Azure SQL Data Warehouse loading patterns and strategies] \(Modelos y estrategias de carga en Almacenamiento de datos SQL de Azure), [Carga de datos con Data Factory de Azure][Carga de datos con Data Factory de Azure], [Movimiento de datos hacia y desde Almacenamiento de datos SQL de Azure mediante Data Factory de Azure][Movimiento de datos hacia y desde Almacenamiento de datos SQL de Azure mediante Data Factory de Azure], [CREATE EXTERNAL FILE FORMAT][CREATE EXTERNAL FILE FORMAT], [Create Table As Select (CTAS) en Almacenamiento de datos SQL][Create Table As Select (CTAS) en Almacenamiento de datos SQL]
...
Consulte también [Información general de las tablas][Información general de las tablas], [Distribución de tablas][Distribución de tablas], [Selección de la distribución de tablas][Selección de la distribución de tablas], [CREATE TABLE][CREATE TABLE], [CREATE TABLE AS SELECT][CREATE TABLE AS SELECT]
...
Consulte también [Creación de particiones de tablas][Creación de particiones de tablas].
...
Consulte también [Descripción de las transacciones][Descripción de las transacciones], [Optimización de transacciones][Optimización de transacciones], [Creación de particiones de tablas][Creación de particiones de tablas], [TRUNCATE TABLE][TRUNCATE TABLE], [ALTER TABLE][ALTER TABLE], [Create Table As Select (CTAS)][Create Table As Select (CTAS)]
...
Consulte también [Introducción a las tablas][Introducción a las tablas], [Tipos de datos para tablas][Tipos de datos para tablas], [CREATE TABLE][CREATE TABLE]
...
Consulte también [Índices de tablas][Índices de tablas], [Guía de índices de almacén de columnas][Guía de índices de almacén de columnas] y [Regeneración de índices de almacén de columnas][Regeneración de índices de almacén de columnas]
...
Consulte también [Simultaneidad y administración de cargas de trabajo][Simultaneidad y administración de cargas de trabajo].
...
Consulte también [Simultaneidad y administración de cargas de trabajo][Simultaneidad y administración de cargas de trabajo], [sys.dm\_pdw\_waits][sys.dm\_pdw\_waits].
