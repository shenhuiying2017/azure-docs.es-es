---
title: Vistas de sistema del Almacenamiento de datos SQL | Microsoft Docs
...
> [!NOTE]
> Para utilizar estas vistas, inserte 'pdw\_nodes\_' en el nombre, como se muestra en la tabla siguiente.
> 
> 
...
| sys.dm\_pdw\_nodes\_exec\_sessions |[sys.dm\_exec\_sessions](https://msdn.microsoft.com/es-ES/library/ms176013.aspx) |
...
## Vistas INFORMATION\_SCHEMA de SQL Server
...
## Pasos siguientes
Para obtener más información de referencia, vea [Información general de referencia de Almacenamiento de datos SQL][Información general de referencia de Almacenamiento de datos SQL].
