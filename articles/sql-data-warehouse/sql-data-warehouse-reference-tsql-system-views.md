...
- [dbo.server_quotas (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn308512.aspx)
- [sys.bandwidth_usage (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn269985.aspx)
- [sys.database_connection_stats (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn269986.aspx)
- [sys.database_firewall_rules (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.database_usage (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/azure/ff951626.aspx)
- [sys.event_log (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn270018.aspx)
- [sys.database_firewall_rules (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.firewall_rules (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/azure/ff951627.aspx)
- [sys.resource_stats (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn269979.aspx)
- sys.resource_usage (Base de datos SQL de Azure)
...
>[AZURE.NOTE]Para utilizar estas vistas, inserte 'pdw_nodes_' en el nombre, como se muestra en la tabla siguiente.
...
| sys.dm_pdw_nodes_tran_commit_table | La documentación de Transact-SQL no está disponible. |
...
Estos son vínculos a las vistas de esquema de información de SQL Server disponibles en SQL Server PDW. Todas las vistas INFORMATION_SCHEMA que esperaría ver en SQL Server están disponibles en SQL Server PDW.
