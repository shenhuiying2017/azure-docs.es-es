<properties
   pageTitle="Vistas de sistema del Almacenamiento de datos SQL | Microsoft Azure"
...
## Vistas de catálogo de la Base de datos SQL

- [dbo.server\_quotas (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn308512.aspx)
- [sys.bandwidth\_usage (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn269985.aspx)
- [sys.database\_connection\_stats (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn269986.aspx)
- [sys.database\_firewall\_rules (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.database\_usage (Base de datos SQL de Azure)](https://msdn.microsoft.com/library/dn270020.aspx)
- [sys.event\_log (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn270018.aspx)
- [sys.database\_firewall\_rules (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn269982.aspx)
- [sys.firewall\_rules (Base de datos SQL de Azure)](https://msdn.microsoft.com/library/dn269980.aspx)
- [sys.resource\_stats (Base de datos SQL de Azure)](http://msdn.microsoft.com/library/dn269979.aspx)
- [sys.resource\_usage (Base de datos SQL de Azure)](https://msdn.microsoft.com/library/dn270016.aspx)
...
## Lista de las DMV del servidor SQL disponibles en el almacenamiento de datos SQL
...
Es por esto que cada una de estas DMV tiene una columna específica denominada pdw\_node\_id. Se trata del identificador para el nodo de cálculo. En PDW el nodo de cálculo es un concepto más fuerte para la arquitectura. En el almacenamiento de datos de SQL, la arquitectura se basa más en las distribuciones.

>[AZURE.NOTE] Para utilizar estas vistas, inserte 'pdw\_nodes\_' en el nombre, como se muestra en la tabla siguiente.
...
| sys.dm\_pdw\_nodes\_exec\_sessions | [sys.dm\_exec\_sessions (Transact-SQL)](https://msdn.microsoft.com/es-ES/library/ms176013.aspx) |
...
| sys.dm\_pdw\_nodes\_os\_dispatchers | La documentación de Transact-SQL no está disponible. |
...
| sys.dm\_pdw\_nodes\_os\_memory\_node\_access\_stats | La documentación de Transact-SQL no está disponible. |
...
| sys.dm\_pdw\_nodes\_os\_spinlock\_stats | La documentación de Transact-SQL no está disponible. |
...
| sys.dm\_pdw\_nodes\_tran\_commit\_table | La documentación de Transact-SQL no está disponible. |
...
## PolyBase dmvs de SQL Server 2016 disponibles en Almacenamiento de datos SQL
...
## DMV de la base de datos SQL disponibles en el almacenamiento de datos SQL
...
Estos son vínculos a las vistas de esquema de información de SQL Server disponibles en SQL Server PDW. Todas las vistas INFORMATION\_SCHEMA que esperaría ver en SQL Server están disponibles en SQL Server PDW.
