...
SQL Data Warehouse ofrece dos niveles de rendimiento optimizados para cargas de trabajo de análisis. Un nivel de rendimiento es una opción que determina la configuración del almacenamiento de datos. Esta opción es una de las primeras decisiones que toma al crear un almacenamiento de datos.  
...
## <a name="data-warehouse-limits"></a>Límites de almacenamiento de datos
...
| Nivel de rendimiento | N.º máximo de consultas simultáneas | Nodos de proceso | Distribuciones por nodo de proceso | Memoria máxima por distribución (MB) | Memoria máxima por almacenamiento de datos (GB) |
|:-------------:|:----------------------:|:-------------:|:------------------------------:|:--------------------------------:|:----------------------------------:|
| DW100         | 4                      | 1             | 60                             | 400                              |  24                                |
| DW200         | 8                      | 2             | 30                             | 800                              |  48                                |
...
El nivel de rendimiento Optimizado para Compute proporciona 2.5 veces más memoria por consulta que el nivel de rendimiento Optimizado para Elasticity. Esta memoria adicional ayuda al nivel de rendimiento Optimizado para Compute a ofrecer su rendimiento de alta velocidad.  Los niveles de rendimiento para el nivel de rendimiento Optimizado para Compute oscilan entre DW1000c y DW30000c. 

| Nivel de rendimiento | N.º máximo de consultas simultáneas | Nodos de proceso | Distribuciones por nodo de proceso | Memoria máxima por distribución (GB) | Memoria máxima por almacenamiento de datos (GB) |
|:-------------:|:----------------------:|:-------------:|:------------------------------:|:--------------------------------:|:----------------------------------:|
...
Para asegurarse de que cada consulta tenga recursos suficientes para ejecutarse de forma eficaz, SQL Data Warehouse realiza un seguimiento del uso de los recursos de proceso. Para hacerlo, asigna espacios de simultaneidad a cada consulta. El sistema coloca las consultas en una cola en la que esperan hasta que haya suficientes [espacios de simultaneidad](resource-classes-for-workload-management.md#concurrency-slots) disponibles. 
...
| Nivel de rendimiento | N.º máximo de consultas simultáneas | Espacios de simultaneidad disponibles | Ranuras utilizadas por smallrc | Ranuras utilizadas por mediumrc | Ranuras utilizadas por largerc | Ranuras utilizadas por xlargerc |
|:-------------:|:--------------------------:|:---------------------------:|:---------------------:|:----------------------:|:---------------------:|:----------------------:|
