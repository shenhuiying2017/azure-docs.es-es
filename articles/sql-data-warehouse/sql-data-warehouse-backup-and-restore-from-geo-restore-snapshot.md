...
Para recuperar una base de datos, use el cmdlet [Start-AzureSqlDatabaseRecovery][].
...
6. Supervise el progreso de la recuperación.
...
2. **Modificación de las reglas de firewall**: Compruebe las reglas de firewall en el servidor de destino y asegúrese de que están habilitadas las conexiones desde los equipos cliente o Azure al servidor y a la base de datos recién recuperada.
