---
title: Carga de datos del Almacenamiento de blobs de Azure en Almacenamiento de datos SQL de Azure (Data Factory de Azure) | Microsoft Docs
...
## Antes de empezar
Para familiarizarse con Data Factory de Azure, consulte [Introducción al servicio Data Factory de Azure][Introducción al servicio Data Factory de Azure].
...
* **Data Factory de Azure**: Data Factory de Azure realizará la carga en sí, así que necesita una instancia de Data Factory para crear la canalización del movimiento de datos. Si aún no tiene una, aprenda a crearla en el paso 1 de [Compilación de la primera Data Factory de Azure con el Portal de Azure/Editor de Data Factory][Compilación de la primera Data Factory de Azure con el Portal de Azure/Editor de Data Factory].
...
* [Movimiento de datos hacia y desde Almacenamiento de datos SQL de Azure mediante Data Factory de Azure][Movimiento de datos hacia y desde Almacenamiento de datos SQL de Azure mediante Data Factory de Azure]. Este es el tema de referencia principal para el uso de Data Factory de Azure con Almacenamiento de datos SQL de Azure.
