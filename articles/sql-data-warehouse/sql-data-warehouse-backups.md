<properties
   pageTitle="Copias de seguridad de SQL Data Warehouse| Microsoft Azure"
...
> [AZURE.IMPORTANT] Si elimina una instancia de servidor de SQL lógica, todas las bases de datos que pertenecen a la instancia también se eliminan y no se pueden recuperar. No puede restaurar un servidor eliminado.
