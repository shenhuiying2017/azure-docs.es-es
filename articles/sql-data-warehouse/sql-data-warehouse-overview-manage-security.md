...
En este artículo se describen los fundamentos de la protección de una base de datos de Azure SQL Data Warehouse. En concreto, este artículo le ayudará a empezar a trabajar con los recursos para limitar el acceso, proteger los datos y supervisar las actividades en una base de datos.
...
La autenticación indica a cómo demostrar su identidad al conectarse a la base de datos. Actualmente, SQL Data Warehouse admite la autenticación de SQL Server con un nombre de usuario y una contraseña, además de Azure Active Directory. 
...
Después, conéctese a la base de datos de **SQL Data Warehouse** con el inicio de sesión de administrador de servidor y cree un usuario de base de datos basado en el inicio de sesión de servidor que acaba de crear.
...
La autorización hace referencia a lo que se puede hacer en la base de datos de Azure SQL Data Warehouse, y la controlan los permisos y las pertenencias del rol de la cuenta de usuario. Como procedimiento recomendado, debe conceder a los usuarios los privilegios mínimos necesarios. Azure SQL Data Warehouse facilita la administración con roles en T-SQL:
