<properties
   pageTitle="Elementos del lenguaje Transact-SQL de Almacenamiento de datos SQL | Microsoft Azure"
   description="Lista de vínculos a contenido de referencia para los elementos del lenguaje Transact-SQL utilizados para Almacenamiento de datos SQL."
...
## Lotes, control de flujo y variables
...
- [SET@variable\_local](https://msdn.microsoft.com/library/ms189484.aspx)
...
## Caracteres comodín que deben coincidir
...
- [!= (No igual a)](https://msdn.microsoft.com/library/vstudio/bb399278.aspx)
