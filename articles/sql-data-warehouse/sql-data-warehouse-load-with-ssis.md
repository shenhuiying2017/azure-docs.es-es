<properties
   pageTitle="Carga de datos con SQL Server Integration Services (SSIS) | Microsoft Azure"
...
# Carga de datos con SQL Server Integration Services (SSIS)

En este tutorial se muestra cómo crear un paquete de SQL Server Integration Services (SSIS) para mover datos desde una gran variedad de orígenes de datos a Almacenamiento de datos SQL. Opcionalmente, puede reestructurar, transformar y limpiar los datos cuando pasen por el flujo de datos de SSIS.

Después de finalizar este tutorial, sabrá hacer lo siguiente.
...
## Opciones para cargar datos con SSIS
...
## Paso 2: Creación del flujo de datos básico
...
## Paso 3: Configuración del adaptador de origen
...
## Paso 4: Conexión del adaptador de origen al adaptador de destino
...
## Paso 6: Ejecución del paquete de SSIS para cargar los datos
...
- Aprenda más sobre el flujo de datos de SSIS. Comience aquí: [Flujo de datos][].
- Aprenda a depurar paquetes y a solucionar problemas relacionados directamente en el entorno de diseño. Comience aquí: [Herramientas para solucionar problemas con el desarrollo de paquetes][].
- Aprenda a implementar sus proyectos y paquetes de SSIS en un servidor de Integration Services o en otra ubicación de almacenamiento. Comience aquí: [Implementación de proyectos y paquetes][].
...
[Herramientas para solucionar problemas con el desarrollo de paquetes]: https://msdn.microsoft.com/library/ms137625.aspx
[Implementación de proyectos y paquetes]: https://msdn.microsoft.com/library/hh213290.aspx

<!--Other Web references-->
[Microsoft SQL Server 2016 Integration Services Feature Pack for Azure]: http://go.microsoft.com/fwlink/?LinkID=626967
[Evaluaciones de SQL Server]: https://www.microsoft.com/es-ES/evalcenter/evaluate-sql-server-2016
