<properties
   pageTitle="Copia de seguridad y restauración en Almacenamiento de datos SQL de Azure (REST) | Microsoft Azure"
...
# Copia de seguridad y restauración de una base de datos en Almacenamiento de datos SQL de Azure (REST)
...
Copia de seguridad y restauración de una base de datos en Almacenamiento de datos SQL mediante API de REST
