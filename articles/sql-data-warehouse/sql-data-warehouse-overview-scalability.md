<properties
   pageTitle="Escalabilidad del rendimiento de Almacenamiento de datos SQL de Azure | Microsoft Azure"
   description="Descripción de las funcionalidades de escalado horizontal del rendimiento en Almacenamiento de datos SQL de Azure Realice el escalado horizontal ajustando las DWU o pause y reanude los recursos de proceso para ahorrar costos."
...
- Escalado de rendimiento mediante el ajuste de unidades de almacenamiento de datos (DWU)
...
- [Escalado del rendimiento con Portal de Azure][]
- [Escalado del rendimiento con PowerShell][]
- [Escalado del rendimiento con las API de REST][]
- [Escalado del rendimiento con TSQL][]
...
[Escalado del rendimiento con Portal de Azure]: ./sql-data-warehouse-manage-scale-out-tasks.md#task-1-scale-performance
[Escalado del rendimiento con PowerShell]: ./sql-data-warehouse-manage-scale-out-tasks-powershell.md#task-1-scale-performance
[Escalado del rendimiento con las API de REST]: ./sql-data-warehouse-manage-scale-out-tasks-rest-api.md#task-1-scale-performance
[Escalado del rendimiento con TSQL]: ./sql-data-warehouse-manage-scale-out-tasks-tsql.md
