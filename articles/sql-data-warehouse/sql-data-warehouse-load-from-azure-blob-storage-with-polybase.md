...
## Pasos siguientes
Para cargar todos los datos de Contoso Retail Data Warehouse, use el script en Para obtener más sugerencias sobre desarrollo, consulte la [información general sobre desarrollo de Almacenamiento de datos SQL][].
