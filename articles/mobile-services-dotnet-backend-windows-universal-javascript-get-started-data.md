...
<ol start="8"><li><p>En el Explorador de soluciones, vaya a la subcarpeta <strong>services\mobileService\scripts</strong>, abra el archivo de script service.js y observe la nueva variable global, similar al ejemplo siguiente:</p> 
