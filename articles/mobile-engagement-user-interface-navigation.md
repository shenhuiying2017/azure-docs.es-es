<properties 
   ...
   description="Información general de la interfaz de usuario para la sección de navegación de Azure Mobile Engagement" 
...
El portal de frontend de la interfaz de usuario en: https://YourApp.portal.mobileengagementwindows.net/ contiene los siguientes elementos de navegación: un encabezado, un pie de página, una barra lateral, navegación de cookie detallada y una cinta de opciones específicas de la aplicación.
