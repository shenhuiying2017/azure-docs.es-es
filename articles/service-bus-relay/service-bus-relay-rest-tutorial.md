...
# Tutorial de REST Service Bus Relay
...
2. Aplique el atributo [ServiceBehaviorAttribute](https://msdn.microsoft.com/library/system.servicemodel.servicebehaviorattribute.aspx) a la clase **IImageService** para indicar que la clase es una implementación de un contrato de WCF:
	...
	Como se mencionó anteriormente, este espacio de nombres no es un espacio de nombres tradicional. Más bien, forma parte de la arquitectura de WCF que identifica el contrato. Para más información, consulte el tema [Nombres de contratos de datos](https://msdn.microsoft.com/library/ms731045.aspx) en la documentación de WCF.
...
4. Después del elemento `<services>`, cree un elemento `<behaviors>` con el contenido siguiente, pero reemplace "SAS\_KEY" por la clave de *firma de acceso compartido* (SAS) que obtuvo antes en [Azure Portal][].
...
- [Información general sobre la arquitectura de Azure Service Bus](../service-bus/service-bus-fundamentals-hybrid-solutions.md#relays)
