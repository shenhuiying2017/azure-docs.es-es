...
3. Realice una llamada **POST** al sistema con la entrada para opiniones, frases clave e idioma. Las direcciones URL tendrán el siguiente aspecto:
   
        POST https://westus.api.cognitive.microsoft.com/text/analytics/v2.0/sentiment
        POST https://westus.api.cognitive.microsoft.com/text/analytics/v2.0/keyPhrases
        POST https://westus.api.cognitive.microsoft.com/text/analytics/v2.0/languages
4. Esta llamada devolverá una respuesta con formato JSON con los id. y las propiedades detectadas. El siguiente es un ejemplo de la salida para las opiniones (se excluyen los detalles de error). En el caso de las opiniones, se devolverá una puntuación entre 0 y 1 para cada documento:
...
2. Use los mismos encabezados definidos en la Tarea 2 para realizar una llamada **POST** al punto de conexión de temas:
