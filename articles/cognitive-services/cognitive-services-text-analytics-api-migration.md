---
title: "Actualización a la versión 2 de la API de análisis de texto | Microsoft Azure"
...
---
# <a name="upgrading-to-version-2-of-the-text-analytics-api"></a>Actualización a la versión 2 de la API de Text Analytics
...
### <a name="part-1-get-a-new-key"></a>Parte 1: obtener una clave nueva
...
2. Haga clic en **Regístrese**. Este vínculo le llevará al portal de administración de Azure, donde puede registrarse en el servicio.
3. Seleccione un plan. Puede seleccionar el **nivel Gratis de 5 000 transacciones/mes**. Como se trata de un plan gratuito, no se le cobrará por utilizar el servicio. No se olvide de iniciar sesión en su suscripción de Azure. 
4. Después de registrarse en Text Analytics, se le proporcionará una **clave de API**. Copie esta clave, ya que la necesitará para los servicios de API.
...
### <a name="part-4a-update-the-formats-for-sentiment-key-phrases-and-languages"></a>Parte 4a: actualizar los formatos de opinión, frases clave e idiomas
...
#### <a name="output-from-sentiment"></a>Salida de opinión
**Versión 1**
...
#### <a name="output-from-key-phrases"></a>Salida de frases clave
**Versión 1**
...
#### <a name="output-from-languages"></a>Salida de idiomas
**Versión 1**
...
### <a name="part-4b-update-the-formats-for-topics"></a>Parte 4b: Actualizar los formatos de temas
#### <a name="endpoints"></a>Extremos
...
### <a name="part-5-test-it"></a>Parte 5: realizar pruebas
