...
Podrá agregar esta funcionalidad a la aplicación que creó cuando completó el tutorial de [Introducción a los Servicios móviles](/es-es/documentation/articles/mobile-services-windows-phone-get-started/) o de [Introducción a los datos](/es-es/documentation/articles/mobile-services-windows-phone-get-started-data/). Para hacer esto, debe completar los siguientes pasos:
...
Este tutorial está basado en el inicio rápido de Servicios móviles. Antes de comenzar este tutorial, primero debe completar [Introducción a los Servicios móviles](/es-es/documentation/articles/mobile-services-windows-phone-get-started/) o [Introducción a los datos](/es-es/documentation/articles/mobile-services-windows-phone-get-started-data/). Este tutorial usa Visual Studio 2012 Express para Windows Phone.
