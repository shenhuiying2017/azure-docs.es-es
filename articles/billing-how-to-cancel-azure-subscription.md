...
ms.openlocfilehash: f89eb8d951bffac6e2312373dcf8da4f94dae2c1


---
# <a name="cancel-your-azure-subscription"></a>Cancelación de su suscripción de Azure
Cancelación de la suscripción de Azure desde el [Centro de cuentas de Azure](https://account.windowsazure.com/subscriptions). Después de cancelar la suscripción, el acceso a los servicios y recursos de Azure finalizará.
...
## <a name="cancel-subscription"></a>Cancelación de la suscripción
