...
<th>
Revisión de compatibilidad de kernel
...
<td>
[Se requiere solo para 12.04 o 12.04.01 (en inglés)][Se requiere solo para 12.04 o 12.04.01 (en inglés)]

</td>
<td>
Paquete: En el repositorio de paquetes bajo walinuxagent
 Origen: [GitHub][GitHub]
...
<td>
CentOS 6.3: [controladores de LIS][aquí] (en inglés); controladores CentOS 6.4+: en kernel

</td>
<td>
[Se requiere solo para 6.3 (en inglés)][Se requiere solo para 6.3 (en inglés)]

</td>
<td>
Paquete: en el [repositorio de paquetes de Open Logic][repositorio de paquetes de Open Logic] (en inglés) bajo walinuxagent
 Origen: [GitHub][GitHub]
...
<td>
Paquete: en repositorio, nombre: WALinuxAgent
 Origen: [GitHub][GitHub]
...
<td>
Paquete: en el repositorio [Cloud:Tools][Cloud:Tools], nombre: WALinuxAgent
 Código fuente: [GitHub][GitHub]
...
<sup>1</sup> **Nota:** CoreOS en Azure se encuentra actualmente en vista previa de desarrollador (*alpha*).
