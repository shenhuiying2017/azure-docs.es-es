---
title: Adición de almacenamiento de Azure con Servicios conectados en Visual Studio | Microsoft Docs
...
3. En el cuadro de diálogo **Agregar servicio conectado**, seleccione **Almacenamiento de Azure** y elija el botón **Configurar**. Es posible que se le pida que inicie sesión en Azure si aún no lo ha hecho.
   
    ![Cuadro de diálogo Agregar servicio conectado - Almacenamiento](./media/vs-azure-tools-connected-services-storage/IC796703.png)
4. En el cuadro de diálogo **Almacenamiento de Azure**, elija una cuenta de almacenamiento existente y seleccione **Agregar**.
