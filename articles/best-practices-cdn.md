---
title: Orientación sobre la Red de entrega de contenido (CDN) | Microsoft Docs
...
Considere la posibilidad de restringir el acceso al contenido de la red CDN por país. La red CDN de Azure le permite filtrar las solicitudes en función del país de origen y restringir el contenido que se entrega. Para más información, consulte [Restringir el acceso al contenido por país](cdn/cdn-restrict-access-by-country.md).
