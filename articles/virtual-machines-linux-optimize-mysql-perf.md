<properties 
	pageTitle="Optimización del rendimiento de MySQL en máquinas virtuales de Azure con Linux" 
...
Los siguientes pasos muestran cómo crear RAID en Azure mediante el Portal de administración de Windows Azure. También puede configurar RAID mediante scripts de Windows PowerShell. 
En este ejemplo, configuraremos RAID 0 con 4 discos.  

####Paso 1: Agregar un disco de datos a la máquina virtual  
...
####Paso 2: Crear RAID con los discos adicionales
Siga las instrucciones de este artículo para obtener información detallada acerca de la configuración de RAID:  

[http://cassandra.apache.org](http://azure.microsoft.com/documentation/articles/virtual-machines-linux-configure-RAID/)
...
####Paso 3: Configurar una nueva ruta de acceso de almacenamiento
Use el comando siguiente:  

	root@mysqlnode1:~# mkdir -p /RAID0/mysql

####Paso 4: Copiar los datos originales en la nueva ruta de acceso de almacenamiento
Use el comando siguiente:  

	root@mysqlnode1:~# cp -rp /var/lib/mysql/* /RAID0/mysql/

####Paso 5: Modificar permisos para que MySQL pueda tener acceso (lectura y escritura) al disco de datos
Use el comando siguiente:  
...
Por ejemplo, modifique  el archivo /etc/fstab de vim y agregue noatime tal como se muestra a continuación.  
...
###Paso 1: Modificar el archivo limits.conf
...
###Paso 2: Actualizar el sistema con los nuevos límites
...
###Paso 1: Modificar el archivo my.cnf agregando las líneas siguientes al final   

	long_query_time = 2
	slow_query_log = 1
	slow_query_log_file = /RAID0/mysql/mysql-slow.log

###Paso 2: Reiniciar el servidor mysql
	service  mysql  restart

###Paso 3: Comprobar si la configuración surte efecto con el comando "Show"
...
|Parámetros de	|Valores predeterminados	|Optimización
|-----------|-----------|-----------
|**innodb_buffer_pool_size**	|None	|7 G
