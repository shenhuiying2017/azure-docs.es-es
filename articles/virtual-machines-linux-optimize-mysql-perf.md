<properties pageTitle="Optimización del rendimiento de MySQL en máquinas virtuales de Azure con Linux" description="Aprenda a optimizar MySQL ejecutado en una máquina virtual (VM) de Azure con Linux." services="virtual-machines" documentationCenter="" authors="NingKuang" manager="timlt" editor="tysonn"/>
...
[http://cassandra.apache.org](http://azure.microsoft.com/es-es/documentation/articles/virtual-machines-linux-configure-RAID/)
