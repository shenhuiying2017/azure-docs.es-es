...
1. Abra el archivo default.js e inserte el siguiente código después del código que crea la instancia de **MobileServiceClient**:
...
6. Abra el archivo Package.appxmanifest y asegúrese de que, en la pestaña **IU de la aplicación**, la opción **Capacidad de aviso** está establecida en **Sí**.
...
[Envío de notificaciones de difusión a suscriptores]: /es-es/documentation/articles/notification-hubs-windows-store-javascript-send-breaking-news/
[Envío de notificaciones basadas en plantillas a suscriptores]: /es-es/documentation/articles/notification-hubs-windows-store-javascript-send-localized-breaking-news/
