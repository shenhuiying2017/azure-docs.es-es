<properties title="Detalles de configuraci&oacute;n de una granja de servidores de SharePoint" pageTitle="Detalles de configuraci&oacute;n de una granja de servidores de SharePoint" description="Describe la configuraci&oacute;n predeterminada de las granjas de SharePoint." metaKeywords="" services="virtual-machines" solutions="" documentationCenter="" authors="josephd" videoId="" scriptId="" manager="timlt"/>
...
Para obtener información adicional, consulte [Granja de servidores de SharePoint][Granja de servidores de SharePoint].
