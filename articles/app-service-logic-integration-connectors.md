...
Validador XML de BizTalk | Una aplicación de API **Acción**. Valida los datos XML en esquemas XML predefinidos. Puede usar   esquemas basados en instancias de archivo sin formato, instancias JSON o conectores existentes. 
...
> [AZURE.NOTE] Si el xml de entrada tiene un nodo simple con un atributo (como "<authorid= "1">abc</author>"), entonces la salida JSON de la biblioteca es {"author": { "@id" : "1", "#text": "abc"}}. Para controlar el atributo "Id", se agrega una nueva clave "#text" para el contenido de texto del nodo. Para controlar este tipo de nodo, agregue una clave constante. Esto es así por el diseño de la biblioteca Newtonsoft.Json. Cuando inserte esto en SQL, use "JSONOutput.Author.#text"; no use "JsonOutput.Author".
...
--- | ---
Nombre | Escriba un nombre para la aplicación de API. Por ejemplo, llámela *RulesDiscountTaxCode* o *APIAppValidateXML*.
...
Reglas de BizTalk | Agregue los vocabularios y cree sus reglas IF THEN. Consulte [Uso de reglas de BizTalk](app-service-logic-use-biztalk-rules.md). 
...
En el Portal de administración de Azure, abra su aplicación de API de BizTalk. En la sección **Operaciones**, puede ver diferentes operaciones de administración. Por ejemplo, puede:
...
[Creación de una aplicación lógica de EAI con VETR](app-service-logic-create-EAI-logic-app-using-VETR.md)<br/>
[Transformación de documentos XML](app-service-logic-transform-xml-documents.md)<br/>
[Uso de Reglas de BizTalk](app-service-logic-use-biztalk-rules.md)<br/>
