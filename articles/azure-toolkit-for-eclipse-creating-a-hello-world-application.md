<properties
    pageTitle="Creación de un servicio en la nube Hello World para Azure en Eclipse"
...
1. En el cuadro de diálogo **Publicar en Azure**:
    1. Si no hay aún ninguna suscripción que seleccionar en la lista **Suscripción**, siga estos pasos para importar la información de suscripción:
        ...
        1. Todavía en el cuadro de diálogo **Importar información de suscripción**, haga clic en el botón **Examinar**, seleccione el archivo de configuración de publicación que guardó localmente en el paso anterior y luego haga clic en **Abrir**. La pantalla debe parecerse a la siguiente: ![][ic644267].
        1. Haga clic en **Aceptar**.
    1. En **Suscripción**, seleccione la suscripción que quiera usar para la implementación.
