...
- Compatibilidad con el registro manual de orígenes de datos adicionales. Ahora los usuarios pueden usar "Crear entrada manual" en el portal del **Catálogo de datos de Azure**, o bien usar la API de REST de **Catálogo de datos de Azure** para registrar los siguientes orígenes de datos:
...
> [AZURE.NOTE] "Abrir en SQL Server Data Tools" requiere Visual Studio 2013 con la Update 4 y las herramientas de SQL Server para instalarse. Para instalar la versión más reciente de SQL Server Data Tools, visite [Descargar las últimas herramientas de datos SQL Server](https://msdn.microsoft.com/library/mt204009.aspx).
...
- Compatibilidad con el registro y la detección de vistas y paquetes de SAP HANA. Los usuarios pueden registrar orígenes de datos de SAP HANA con la herramienta de registro de orígenes de datos del **Catálogo de datos de Azure** y pueden anotar y detectar los orígenes de datos de SAP HANA registrados con el portal del **Catálogo de datos de Azure**.
...
- La capacidad de anclar y desanclar activos de datos en el portal del **Catálogo de datos de Azure**. Los usuarios pueden elegir anclar activos de datos para que sea más sencillo volver a detectarlos y usarlos.
- Una página principal recientemente rediseñada en el portal del **Catálogo de datos de Azure**. La nueva página principal incluye información sobre la actividad de usuarios actual, incluidos activos publicados recientemente, activos anclados y búsquedas guardadas, así como información sobre la actividad en el catálogo en su totalidad.
...
- El **Catálogo de datos de Azure** está ahora disponible en dos nuevas regiones de Azure. Los clientes pueden aprovisionar el **Catálogo de datos de Azure** en las regiones de Europa del Norte y Sudeste Asiático, además del este de EE. UU., oeste de EE. UU., Europa Occidental y este de Australia. Para más información, consulte [Regiones de Azure](https://azure.microsoft.com/regions/).
