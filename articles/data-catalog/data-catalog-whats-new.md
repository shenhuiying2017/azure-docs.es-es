...
## <a name="whats-new-for-the-week-of-september-16-2016-release"></a>Novedades de la versión correspondiente a la semana del 16 de septiembre de 2016
...
* Soporte para personalizar el nombre del catálogo en el portal de Data Catalog. Los administradores de Data Catalog ya pueden proporcionar el texto que se mostrará en el título del portal como, por ejemplo, el nombre de la organización.
...
A partir de la semana del 26 de agosto de 2016, se agregaron las siguientes funcionalidades a Azure Data Catalog:
...
## <a name="whats-new-for-the-week-of-august-5-2016-release"></a>Novedades de la versión correspondiente a la semana del 5 de agosto de 2016
A partir de la semana del 5 de agosto de 2016, se agregaron las siguientes funcionalidades a Azure Data Catalog:

* Actualizaciones de la vista de propiedades en el portal de Data Catalog. Ahora, todas las propiedades de los recursos de datos se muestran y administran en un panel único, redimensionable que proporciona una experiencia más eficaz y reconocible.

## <a name="whats-new-for-the-week-of-july-29-2016-release"></a>Novedades de la versión correspondiente a la semana del 29 de julio de 2016
A partir de la semana del 29 de julio de 2016, se agregaron las siguientes funcionalidades a Azure Data Catalog:
...
## <a name="whats-new-for-the-week-of-july-22-2016-release"></a>Novedades de la versión correspondiente a la semana del 22 de julio de 2016
A partir de la semana del 22 de julio de 2016, se agregaron las siguientes funcionalidades a Azure Data Catalog:
...
* Compatibilidad con idiomas adicionales en el portal de Azure Data Catalog y en la herramienta de registro de origen de datos, para un total de 18 idiomas. La experiencia de usuario de Catálogo de datos de Azure se traducirá en función de las preferencias de idioma establecidas en Windows o en el explorador web del usuario.

## <a name="whats-new-for-the-week-of-july-8-2016-release"></a>Novedades de la versión correspondiente a la semana del 8 de julio de 2016
A partir de la semana del 8 de julio de 2016, se agregaron las siguientes funcionalidades a Azure Data Catalog:
...
## <a name="whats-new-for-the-week-of-june-24-2016-release"></a>Novedades de la versión correspondiente a la semana del 24 de junio de 2016
A partir de la semana del 24 de junio de 2016, se agregaron las siguientes funcionalidades a Azure Data Catalog:
...
## <a name="whats-new-for-the-week-of-june-17-2016-release"></a>Novedades de la versión correspondiente a la semana del 17 de junio de 2016
A partir de la semana del 17 de junio de 2016, se agregaron las siguientes funcionalidades a Azure Data Catalog:
...
## <a name="whats-new-for-the-week-of-may-20-2016-release"></a>Novedades de la versión correspondiente a la semana del 20 de mayo de 2016
...
Para más información sobre el glosario empresarial, consulte [Configuración del glosario empresarial para el etiquetado regulado](data-catalog-how-to-business-glossary.md)  

## <a name="whats-new-for-the-week-of-may-6-2016-release"></a>Novedades de la versión correspondiente a la semana del 6 de marzo de 2016
A partir de semana del 6 de marzo de 2016, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:

* Un glosario empresarial que permite a los administradores del Catálogo definir términos y jerarquías empresariales para crear un vocabulario empresarial común. Los usuarios pueden etiquetar recursos de datos registrados con términos del glosario para que resulte más fácil de detectar y comprender el contenido del catálogo. Para más información, vea [Configuración del glosario empresarial para el etiquetado regulado](data-catalog-how-to-business-glossary.md).  
...
## <a name="whats-new-for-the-week-of-march-11-2016-release"></a>Novedades de la versión correspondiente a la semana del 11 de marzo de 2016
A partir de semana del 11 de marzo de 2016, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:

* Un punto de conexión de API de REST consolidado para acceder mediante programación a las funcionalidades de búsqueda y a las funcionalidades de administración de activos del catálogo del servicio Catálogo de datos de Azure. El punto de conexión de API de búsqueda existente y el punto de conexión de API de catálogo están en desuso y se interrumpirán el 21 de marzo de 2016. No hay ningún cambio en la semántica de la API; solo cambia el URI del punto de conexión. Para más información, consulte la [referencia de la API de REST de Azure Data Catalog](https://msdn.microsoft.com/library/azure/mt267595.aspx). Para obtener ejemplos de la API, consulte [Muestras para desarrolladores de Azure Data Catalog](data-catalog-samples.md).

## <a name="whats-new-for-the-week-of-february-19-2016-release"></a>Novedades de la versión correspondiente a la semana del 19 de febrero de 2016
A partir de la semana del 19 de febrero de 2016, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:
...
## <a name="whats-new-for-the-week-of-february-5-2016-release"></a>Novedades de la versión correspondiente a la semana del 5 de febrero de 2016
A partir de semana del 5 de febrero de 2016, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:
...
## <a name="whats-new-for-the-week-of-january-29-2016-release"></a>Novedades de la versión correspondiente a la semana del 29 de enero de 2016
A partir de semana del 29 de enero de 2016, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:

* Compatibilidad con el registro manual de orígenes de datos adicionales. Ahora los usuarios pueden usar "Crear entrada manual" en el portal de Catálogo de datos de Azure, o bien usar la API de REST de Catálogo de datos de Azure para registrar los siguientes orígenes de datos:
...
## <a name="whats-new-for-the-week-of-january-22-2016-release"></a>Novedades de la versión correspondiente a la semana del 22 de enero de 2016
A partir de semana del 22 de enero de 2016, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:

* Compatibilidad con el registro y la detección de vistas y paquetes de SAP HANA. Los usuarios pueden registrar orígenes de datos de SAP HANA con la herramienta de registro de orígenes de datos de Catálogo de datos de Azure, así como anotar y detectar los orígenes de datos de SAP HANA registrados con el portal de Catálogo de datos de Azure.

## <a name="whats-new-for-the-week-of-january-8-2016-release"></a>Novedades de la versión correspondiente a la semana del 8 de enero de 2016
...
## <a name="whats-new-for-the-week-of-december-18-2015-release"></a>Novedades de la versión correspondiente a la semana del 18 de diciembre de 2015
...
## <a name="whats-new-for-the-week-of-december-4-2015-release"></a>Novedades de la versión correspondiente a la semana del 4 de diciembre de 2015
...
## <a name="whats-new-for-the-week-of-november-20-2015-release"></a>Novedades de la versión correspondiente a la semana del 20 de noviembre de 2015
A partir de semana del 20 de noviembre de 2015, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:
...
> [!NOTE]
> "Abrir en Power BI Desktop" requiere la instalación de una versión actual de Power BI Desktop. Si encuentra problemas o errores al usar esta característica, asegúrese de que tiene la versión más reciente de Power BI Desktop en [PowerBI.com](https://powerbi.com).
> 
> 

## <a name="whats-new-for-the-week-of-november-13-2015-release"></a>Novedades de la versión correspondiente a la semana del 13 de noviembre de 2015
A partir de semana del 13 de noviembre de 2015, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:

* Compatibilidad con la autenticación LDAP para orígenes de datos de Teradata. Al registrar tablas y vistas de Teradata, los usuarios pueden elegir conectarse a Teradata mediante LDAP así como autenticación TD2.
...
## <a name="whats-new-for-the-week-of-november-6-2015-release"></a>Novedades de la versión correspondiente a la semana del 6 de noviembre de 2015
A partir de semana del 6 de noviembre de 2015, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:
...
## <a name="whats-new-for-the-week-of-october-30-2015-release"></a>Novedades de la versión correspondiente a la semana del 30 de octubre de 2015
...
## <a name="whats-new-for-the-week-of-october-23-2015-release"></a>Novedades de la versión correspondiente a la semana del 23 de octubre de 2015
A partir de semana del 23 de octubre de 2015, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:
...
## <a name="whats-new-for-the-week-of-october-16-2015-release"></a>Novedades de la versión correspondiente a la semana del 16 de octubre de 2015
...
* Compatibilidad con búsquedas guardadas en el portal de Catálogo de datos de Azure. Los usuarios pueden guardar términos de búsqueda y filtrar selecciones para repetir con facilidad búsquedas anteriores y definir vistas útiles del contenido del Catálogo. El usuario puede marcar una búsqueda guardada como su búsqueda predeterminada. Cuando un usuario hace clic en el icono de búsqueda de "lupa" en la página principal del portal de Catálogo de datos de Azure o en la página de "introducción", el usuario va a parar directamente a la búsqueda guardada marcada como predeterminada.

## <a name="whats-new-for-the-week-of-october-9-2015-release"></a>Novedades de la versión correspondiente a la semana del 9 de octubre de 2015
A partir de semana del 9 de octubre de 2015, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:
...
## <a name="whats-new-for-the-week-of-october-2-2015-release"></a>Novedades de la versión correspondiente a la semana del 2 de octubre de 2015
A partir de semana del 2 de octubre de 2015, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:
...
* Compatibilidad con la autorización de grupos de seguridad de Azure Active Directory. Los administradores del catálogo pueden permitir el acceso al catálogo a los grupos de seguridad y a las cuentas de usuario, lo que facilita la administración del acceso a Catálogo de datos de Azure.
...
## <a name="whats-new-for-the-week-of-september-25-2015-release"></a>Novedades de la versión correspondiente a la semana del 25 de septiembre de 2015
A partir de la semana del 25 de septiembre de 2015, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:
...
## <a name="whats-new-for-the-week-of-september-18-2015-release"></a>Novedades de la versión correspondiente a la semana del 18 de septiembre de 2015
...
* Una nueva experiencia de detección de orígenes de datos "introductoria" en el portal de Catálogo de datos de Azure. Cuando los usuarios entran en la página "detectar" del portal de Azure Data Catalog sin escribir un término de búsqueda, se muestra información general del contenido del catálogo, incluidas las etiquetas que se usan con más frecuencia, así como los expertos, los tipos de orígenes de datos y los tipos de objeto.
...
* Compatibilidad para el registro y la detección de bases de datos de SQL Server y clústeres de HDFS como contenedores. Al registrar tablas y vistas de Oracle o HDFS, Catálogo de datos de Azure creará una entrada para la base de datos, así como para las tablas y las vistas. La base de datos se puede detectar y anotar mediante el portal de Catálogo de datos de Azure. Los usuarios también pueden buscar y filtrar el contenido de una base de datos o clúster además de buscar y filtrar el contenido del catálogo.

> [!NOTE]
> Las vistas y las tablas de SQL Server y archivos HDFS que se han registrado antes de la versión del 11 de septiembre se deben volver a registrar mediante la herramienta de registro de orígenes de datos antes de que se agregue la entrada de la base de datos al catálogo o al clúster. Registrar de nuevo un origen de datos no afecta a las anotaciones agregadas por los usuarios en el portal de Catálogo de datos de Azure.
> 
> 

## <a name="whats-new-for-the-week-of-september-4-2015-release"></a>Novedades de la versión correspondiente a la semana del 4 de septiembre de 2015
A partir de la semana del 4 de septiembre de 2015, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:
...
## <a name="whats-new-for-the-week-of-august-21-2015-release"></a>Novedades de la versión correspondiente a la semana del 21 de agosto de 2015 
A partir de la semana del 21 de agosto de 2015, se agregaron las siguientes funcionalidades al Catálogo de datos de Azure:
