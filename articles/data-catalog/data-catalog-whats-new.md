...
- Compatibilidad con el registro manual de orígenes de datos adicionales. Los usuarios ahora pueden usar "Crear entrada manual" en el portal del **Catálogo de datos de Azure** o usar la API de REST de **Catálogo de datos de Azure** para registrar los siguientes orígenes de datos:
...
- Compatibilidad con el registro y la detección de vistas y paquetes de SAP HANA. Los usuarios pueden registrar orígenes de datos de SAP HANA mediante la herramienta de registro de orígenes de datos del **Catálogo de datos de Azure** y pueden anotar y detectar los orígenes de datos de SAP HANA registrados mediante el portal del **Catálogo de datos de Azure**.
