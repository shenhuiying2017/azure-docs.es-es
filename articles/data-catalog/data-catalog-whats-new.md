...
- Compatibilidad con el registro manual de tipos de orígenes de datos conocidos. Los usuarios pueden escribir manualmente información del origen de datos mediante el portal del **Catálogo de datos de Azure** de todos los tipos de orígenes de datos admitidos por el **Catálogo de datos de Azure**.
