<properties
   pageTitle="Preguntas frecuentes sobre el Catálogo de datos de Azure | Microsoft Azure"
...
##<a name="q:-does-azure-data-catalog-work-with-this-other-data-source-i’m-interested-in?"></a>P: ¿Funciona el Catálogo de datos de Azure con este otro origen de datos que me interesa?
...
## <a name="q:-my-question-isn’t-answered-here-–-what-should-i-do?"></a>P: Mi pregunta no está respondida aquí. ¿Qué debo hacer?
