<properties
   pageTitle="Registro de orígenes de datos | Microsoft Azure"
...
## <a name="registering-data-sources"></a>Registro de orígenes de datos
...
Para registrar un origen de datos, basta con iniciar la herramienta de registro de orígenes de datos del **Azure Data Catalog** en el portal de **Azure Data Catalog**. Inicie sesión con su cuenta profesional o educativa (las mismas credenciales de Azure Active Directory que emplea para iniciar sesión en el portal) y seleccione el origen de datos que quiera registrar.
Vea el tutorial [Introducción al Catálogo de datos de Azure](data-catalog-get-started.md) para obtener las instrucciones paso a paso.
...
## <a name="sources-supported"></a>Orígenes admitidos
...
## <a name="including-previews"></a>Inclusión de vistas previas
