---
title: 'Tutorial: Procesamiento de facturas EDIFACT mediante Servicios de BizTalk de Azure | Microsoft Docs'
...
---
# Tutorial: procesamiento de facturas de EDIFACT mediante los Servicios de BizTalk de Azure
...
5. Deje Tutorial Client en ejecución. Haga clic en **Bus de servicio** > ***el espacio de nombres del Bus de servicio*** > **Colas**, y compruebe que se hayan creado las tres colas.
...
8. Actualice el archivo EDIBridge.config para incluir detalles de configuración.
   ...
   * En *<behaviors>*, proporcione el espacio de nombres ACS y la clave asociada a la suscripción de Servicios de BizTalk.
