---
title: Notas de la versión de los Servicios de BizTalk de Azure | Microsoft Docs
...
No se puede copiar el archivo <ruta de acceso a DLL> en "bin\\Debug\\FileName.dll". El proceso no puede obtener acceso al archivo "bin\\Debug\\FileName.dll" porque está siendo usado en otro proceso.
...
* Abre de nuevo el archivo .bcs desde el Explorador de soluciones.
  ...
  '<nombre antiguo>'El archivo asociado de la entidad'<nombre antiguo>.bridgeconfig' no existe.  
...
**Solución alternativa**. Puede solucionar este problema mediante la eliminación de los archivos .tbd situados en <unidad del sistema>:\\Users<usuario>\\AppData\\Local\\Microsoft\\VisualStudio\\11.0.
