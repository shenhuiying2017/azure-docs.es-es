---
title: Guía técnica de migración de soluciones de EDI de BizTalk Server a BizTalk Services | Microsoft Docs
...
## <a name="which-version-of-biztalk-server-edi-artifacts-can-be-migrated-to-biztalk-services"></a>¿Qué versión de los artefactos de EDI de BizTalk Server se puede migrar a Servicios de BizTalk?
...
* [*Integrar un servicio de flujo de trabajo de WCF con temas y colas de Service Bus*](https://msdn.microsoft.com/library/azure/hh709041.aspx), por Paolo Salvatori. 
...
El procesamiento de EDI de BizTalk Server tiene el concepto de "contratos de reserva".  Servicios de BizTalk **no** tiene un concepto de contrato de reserva hasta ahora.  Vea los temas de la documentación de BizTalk [El rol de los contratos en el procesamiento de EDI](http://go.microsoft.com/fwlink/p/?LinkId=237317) y [Configuración de las propiedades del contrato global o de reserva](https://msdn.microsoft.com/library/bb245981.aspx) para obtener información sobre cómo se usan los acuerdos de reserva en BizTalk Server.
