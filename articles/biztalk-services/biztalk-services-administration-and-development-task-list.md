...
| --- | --- | --- | --- |
| 1. |Administrador |Creación de la suscripción de Microsoft Azure con una cuenta de Microsoft o una cuenta de la organización |[Portal de Azure](https://portal.azure.com) |
| 2. |Administrador |Cree o aprovisione un servicio de BizTalk. |[Creación de un servicio de BizTalk](https://msdn.microsoft.com/library/azure/dn232347.aspx) |
...
| 8. |Administrador |Con [REST](https://msdn.microsoft.com/library/azure/dn232347.aspx), supervise el estado de su instancia de BizTalk Services, incluidas las métricas de rendimiento. |[BizTalk Services: pestañas Panel, Monitor y Escala](http://go.microsoft.com/fwlink/p/?LinkID=302281) |
