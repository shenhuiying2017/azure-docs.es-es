<properties urlDisplayName="Get Started with Authentication" pageTitle="Introducción a la autenticación (JavaScript) | Centro de desarrollo móvil" metaKeywords="" description="Aprenda a usar Servicios móviles para autenticar a los usuarios de la aplicación JavaScript de la Tienda Windows a través de una variedad de proveedores de identidad, como Google, Facebook, Twitter y Microsoft." services="mobile-services" documentationCenter="Mobile" title="Get started with authentication in Mobile Services" authors="glenga" solutions="" manager="dwrede" editor="" />
...
<ol start="5">
<li><p>(Opcional) Complete los pasos descritos en <a href="/es-es/documentation/articles/mobile-services-how-to-register-store-app-package-microsoft-authentication/">Registro del paquete de la aplicación de la Tienda Windows para la autenticación de Microsoft</a>.</p>
...
[Autorizar a los usuarios con scripts]: /es-es/documentation/articles/mobile-services-windows-store-javascript-authorize-users-in-scripts
