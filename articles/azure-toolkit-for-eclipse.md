<properties
    pageTitle="Kit de herramientas de Azure para Eclipse"
...
<!-- Legacy MSDN URL = https://msdn.microsoft.com/es-ES/library/azure/hh694271.aspx -->
...
[Autenticación de usuarios web con el servicio de control de acceso de Azure mediante Eclipse]: http://go.microsoft.com/fwlink/?LinkID=262380
[Cómo mantener los datos de sesión con afinidad de sesión]: http://go.microsoft.com/fwlink/?LinkID=699539
[Cómo usar el almacenamiento en caché colocado]: http://go.microsoft.com/fwlink/?LinkID=699542
[Cómo usar el almacenamiento en caché dedicado]: http://go.microsoft.com/fwlink/?LinkID=699543
[Cómo usar JMS con AMQP 1.0 en Azure con Eclipse]: http://go.microsoft.com/fwlink/?LinkID=699544
[Cómo usar la descarga SSL]: http://go.microsoft.com/fwlink/?LinkID=699545
[Instalación del Kit de herramientas de Azure para Eclipse]: http://go.microsoft.com/fwlink/?LinkID=699546
[Habilitar la afinidad de la sesión]: http://go.microsoft.com/fwlink/?LinkID=699548
[Descarga SSL]: http://go.microsoft.com/fwlink/?LinkID=699549
