...
En esta sección se muestra cómo asociar un disco de datos vacío a una máquina virtual. Consulte el [tutorial sobre cómo asociar un disco de datos][] para obtener más información sobre la asociación de discos vacíos y discos existentes.
