<properties urlDisplayName="Create a virtual machine" pageTitle="Creaci&oacute;n de una m&aacute;quina virtual que ejecuta Windows en Azure" metaKeywords="Azure capture image vm, capturing vm" description="Aprenda a crear una m&aacute;quina virtual de Windows en Azure y, a continuaci&oacute;n, iniciar sesi&oacute;n y acoplar un disco de datos." metaCanonical="" services="virtual-machines" documentationCenter="" title="" authors="kathydav, rasquill" solutions="" manager="timlt" editor="tysonn" />
...
[VÍDEO: Introducción a los VHD - Qué ocurre en realidad][VÍDEO: Introducción a los VHD - Qué ocurre en realidad]

[VÍDEO: P+F con Mark Russinovich - ¿Microsoft Azure se ejecuta en Windows?][VÍDEO: P+F con Mark Russinovich - ¿Microsoft Azure se ejecuta en Windows?]

[VÍDEO: Incorporación de una nueva máquina virtual a una granja web haciendo imágenes reutilizables][VÍDEO: Incorporación de una nueva máquina virtual a una granja web haciendo imágenes reutilizables]

[VÍDEO: Incorporación de unidades de discos duros virtuales, cuentas de almacenamiento y escalado de máquinas virtuales][VÍDEO: Incorporación de unidades de discos duros virtuales, cuentas de almacenamiento y escalado de máquinas virtuales]

[VÍDEO: Scott Guthrie empieza por las máquinas virtuales][VÍDEO: Scott Guthrie empieza por las máquinas virtuales]

[VÍDEO: Conceptos básicos de discos y almacenamiento con máquinas virtuales de Azure][VÍDEO: Conceptos básicos de discos y almacenamiento con máquinas virtuales de Azure]
  ...
  [Acerca de VHD en Azure]: http://msdn.microsoft.com/es-es/library/azure/dn790344.aspx
  ...
  [VÍDEO: Introducción a los VHD - Qué ocurre en realidad]: http://azure.microsoft.com/es-es/documentation/videos/getting-started-with-azure-virtual-machines
  [VÍDEO: P+F con Mark Russinovich - ¿Microsoft Azure se ejecuta en Windows?]: http://azure.microsoft.com/es-es/documentation/videos/mark-russinovich-windows-on-azure
  [VÍDEO: Incorporación de una nueva máquina virtual a una granja web haciendo imágenes reutilizables]: http://azure.microsoft.com/es-es/documentation/videos/adding-virtual-machines-web-farm
  [VÍDEO: Incorporación de unidades de discos duros virtuales, cuentas de almacenamiento y escalado de máquinas virtuales]: http://azure.microsoft.com/es-es/documentation/videos/adding-drives-scaling-virtual-machines
  [VÍDEO: Scott Guthrie empieza por las máquinas virtuales]: http://azure.microsoft.com/es-es/documentation/videos/virtual-machines-scottgu
  [VÍDEO: Conceptos básicos de discos y almacenamiento con máquinas virtuales de Azure]: http://azure.microsoft.com/es-es/documentation/videos/storage-and-disks-virtual-machines
