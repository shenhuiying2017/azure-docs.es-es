...
Los valores [namespace], [issuer name] e [issuer key] se obtienen del Portal de administración de Azure. Para obtener más información, consulte [Utilización de las colas del bus de servicio][].
...
Utilizando la aplicación .NET de ejemplo descrita anteriormente y una aplicación Java similar tomada de la guía complementaria [Uso de la API de Java Message Service (JMS) con el bus de servicio y AMQP 1.0][], es posible intercambiar mensajes entre .NET y Java.
...
Para obtener más información, consulte la [Guía para desarrolladores sobre AMQP 1.0 del bus de servicio][]. Aquí se incluye una lista detallada de las API incompatibles.
