<properties 
	pageTitle="Uso de AMQP 1.0 con la API .NET del bus de servicio - Azure" 
...
<h2>Introducción al bus de servicio</h2>
...
<h2>Descarga del SDK del bus de servicio.</h2>

La compatibilidad con AMQP 1.0 está disponible en el SDK del bus de servicio 2.1 o posterior. Puede descargar el SDK más reciente desde NuGet, en la dirección [http://nuget.org/packages/WindowsAzure.ServiceBus/](http://nuget.org/packages/WindowsAzure.ServiceBus/).

<h2>Codificación de aplicaciones .NET</h2>
...
Donde el [espacio de nombres], el [nombre de emisor] y la [clave de emisor] se obtienen desde el Portal de administración de Azure. Para obtener más información, consulte [Utilización de las colas del bus de servicio][].
...
<h2>Mensajería de diferentes plataformas entre JMS y .NET</h2>
...
Para obtener más información acerca de la mensajería entre diferentes plataformas utilizando el bus de servicio y AMQP 1.0, consulte la [Guía para desarrolladores sobre AMQP 1.0 del bus de servicio](http://msdn.microsoft.com/library/windowsazure/jj841071.aspx).
...
<h2>Características no admitidas y restricciones</h2>
...
Para obtener más información, consulte la [Guía para desarrolladores sobre AMQP 1.0 del bus de servicio](http://msdn.microsoft.com/library/windowsazure/jj841071.aspx). Aquí se incluye una lista detallada de las API incompatibles.
...
* [Guía para desarrolladores sobre AMQP 1.0 del bus de servicio](http://msdn.microsoft.com/library/windowsazure/jj841071.aspx)
