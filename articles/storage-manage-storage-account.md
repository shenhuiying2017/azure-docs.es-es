<properties 
	pageTitle="Cómo administrar cuentas de almacenamiento | Microsoft Azure" 
	description="Aprenda a administrar cuentas de almacenamiento en Azure usando el Portal de administración de Azure." 
	services="storage" 
	documentationCenter="" 
	authors="tamram" 
	manager="adinah" 
...
* [Uso de replicación de cuenta de almacenamiento](#georeplication)
...
<h2><a id="georeplication"></a>Procedimiento: de los datos de la cuenta de almacenamiento para obtener durabilidad y alta disponibilidad</h2>
...
<h2><a id="regeneratestoragekeys"></a>Procedimiento: copia y regeneración de claves de acceso de almacenamiento</h2>
...
<h2><a id="deletestorageaccount"></a>Procedimiento: de una cuenta de almacenamiento</h2>
...
> [AZURE.WARNING] No hay forma de restaurar el contenido de una cuenta de almacenamiento eliminada. Asegúrese de hacer una copia de seguridad de cualquier contenido que desee guardar antes de eliminar la cuenta.
> 
