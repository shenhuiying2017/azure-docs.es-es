<properties
	pageTitle="Azure AD B2C: Protección de una API web mediante Node.js | Microsoft Azure"
...
# Azure AD B2C: Protección de una API web mediante Node.js
...
> [AZURE.NOTE]	Este ejemplo se escribió de modo que fuera posible conectarse a él con nuestra [aplicación de ejemplo B2C para iOS](active-directory-b2c-devquickstarts-ios.md). Primero realice el tutorial actual y luego continúe con ese ejemplo.
...
La aplicación completada también estará [disponible en forma archivo .zip](https://github.com/AzureADQuickStarts/B2C-WebAPI-NodeJS/archive/complete.zip) o en la rama `complete` del mismo repositorio.
...
> [AZURE.NOTE] En este tutorial se asume que usa la instalación predeterminada y los puntos de conexión de servidor de MongoDB, que en el momento de escribir este artículo es: `mongodb://localhost`.
...
## Ejecute la aplicación de servidor para comprobar que le rechaza
