...
5. Desplácese a la sección **Políticas para restablecer la contraseña del usuario** y mueva la opción de alternancia **Usuarios habilitados para restablecer la contraseña** a **Sí**. Observe que la opción **Dirección de correo electrónico alternativa** está activada; déjela como está.
