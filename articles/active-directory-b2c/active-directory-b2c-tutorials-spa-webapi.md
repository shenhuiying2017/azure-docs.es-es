...
Para permitir que la aplicación de una sola página llame a la API web ASP.NET Core, debe habilitar [CORS](https://docs.microsoft.com/en-us/aspnet/core/security/cors).
...
2. Configure el ejemplo con la información de registro del inquilino de Azure AD B2C. Cambie los valores **b2cScopes** y **webApi** en las siguientes líneas de código:
