...
5. Haga clic en **Proveedores de identidades** y seleccione "Inicio de sesión de la cuenta local". También puede seleccionar proveedores de identidades sociales, si ya se han configurado. Haga clic en **OK**.
