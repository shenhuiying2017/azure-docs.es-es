<properties urlDisplayName="Authorize Users in Scripts (Xamarin.iOS)" pageTitle="Autorización a los usuarios en scripts (Xamarin.Android) - Servicios móviles de Azure" metaKeywords="autorización de usuarios de Azure, autorización de scripts de Xamarin.iOS, autorizar servicios móviles" description="Obtenga información acerca de cómo autorizar a los usuarios con scripts en su aplicación de Servicios móviles de Azure para Xamarin.iOS." metaCanonical="" disqusComments="1" umbracoNaviHide="1" title="Use scripts to authorize users in Mobile Services" documentationCenter="Mobile" authors="donnam" manager="dwrede" />
