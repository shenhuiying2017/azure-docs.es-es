...
1.  [Creación de la tabla Channel](#create-table)
...
1.  En la aplicación, escriba el texto "hello push again" en el cuadro de texto y, a continuación, haga clic en **Guardar**.
...
1.  (Opcional) Ejecute la aplicación en dos dispositivos a la vez y repita el paso anterior.
