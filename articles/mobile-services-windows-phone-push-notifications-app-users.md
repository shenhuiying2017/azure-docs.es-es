...
+ [Envío de notificaciones de inserción a usuarios autenticados](/es-es/documentation/articles/mobile-services-javascript-backend-windows-phone-push-notifications-app-users/)<br/>Amplía el tutorial anterior para permitir que solo los usuarios con sesión iniciada se registren para las notificaciones.
