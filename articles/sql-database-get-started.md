...
1.  Aparecerá la página Database Settings cuando haga clic en **Custom Create**. En esa página, proporcione información básica que crea una base de datos SQL vacía en el servidor. La adición de tablas y datos se tratará en un paso posterior.
...
2.  Haga clic en **Servers** en la parte superior de la página. A continuación, haga clic en el servidor que acaba de crear para abrir la página del servidor.
...
6.  Para guardar los cambios, haga clic en **SAVE** en la parte inferior de la página.
...
#### Datos del sistema de consultas
...
3.  Especifique el **master** al que conectará la base de datos y después inicie sesión con su nombre de usuario y contraseña. Este es el inicio de sesión de administrador que especificó cuando creó el servidor.
...
#### Crear un usuario de base de datos y asignar permisos
