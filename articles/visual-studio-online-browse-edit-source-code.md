...
6.  En la parte superior del cuadro aparecerá un mensaje intermitente que indica que la confirmación del repositorio se ha realizado correctamente.
  ...
  [\<br /\>\<img src=]: ./media/visual-studio-online-browse-edit-source-code/Repo-Blade.png
  ...
  [1]: ./media/visual-studio-online-browse-edit-source-code/Commit-Code.png
  [2]: ./media/visual-studio-online-browse-edit-source-code/Commit-Success.png
