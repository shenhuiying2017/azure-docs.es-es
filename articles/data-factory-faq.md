<properties title="Azure Data Factory - Frequently Asked Questions" pageTitle="Factoría de datos de Azure: preguntas más frecuentes" description="Preguntas más frecuentes sobre la Factoría de datos de Azure." metaKeywords=""  services="data-factory" solutions=""  documentationCenter="" authors="spelluru" manager="jhubbard" editor="monicar" />
...
Vea la [página de detalles de precios de la factoría de datos][adf-pricing-details] para obtener información al respecto.  
...
- **Orígenes de datos admitidos:** el almacenamiento de Azure (blobs y tablas), SQL Server, base de datos de SQL Azure.
- **Actividades compatibles:**: actividad de copia (de local a la nube y de la nube a local), actividad de HDInsight (transformaciones Pig y Hive) y actividades de C# personalizadas.
...
- Número de actividades dentro de una canalización: de
...
## Otras referencias
[Introducción a la Factoría de datos de Azure][adf-introduction]
[Introducción a la Factoría de datos de Azure][adfgetstarted]
[Guía de solución de problemas para la factoría de datos][adf-troubleshoot]
