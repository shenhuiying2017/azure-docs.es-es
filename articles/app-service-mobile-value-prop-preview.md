...
Servicios de aplicaciones de Azure es una plataforma totalmente administrada como una oferta de servicio (PaaS) para desarrolladores profesionales que ofrece un amplio conjunto de capacidades para escenarios de integración, móviles y web. *Mobile Apps* en *Azure App Service* ofrece una plataforma de desarrollo de aplicaciones móviles altamente escalable y disponible globalmente para desarrolladores empresariales e integradores de sistema que proporciona un amplio conjunto de capacidades para aplicaciones móviles.

![Mobile Apps](./media/app-service-mobile-value-prop-preview/overview.png)

#¿Por qué aplicaciones móviles?
Las *aplicaciones móviles* en *Azure App Service* ofrecen una plataforma de desarrollo de aplicaciones móviles altamente escalable y disponible globalmente para desarrolladores empresariales e integradores de sistema que proporciona un amplio conjunto de capacidades a las aplicaciones móviles. Con las aplicaciones móviles, puede:

- **Compilación nativa y cruzada aplicaciones de la plataforma** : si va a crear aplicaciones iOS, Android y Windows o aplicaciones multiplataforma Xamarin o Cordova (Phonegap) nativas, puede aprovechar Servicios de aplicaciones con SDK nativos.
- **Conexión a los sistemas empresariales**: con las aplicaciones móviles, puede agregar el inicio de sesión corporativo en cuestión de minutos y conectarse a sus recursos empresariales en la nube o locales.
- **Conexión sencilla a las API de Saas fácilmente**: con más de 40 conectores de API de SaaS, puede integrar fácilmente la aplicación con las API de SaaS que su empresa usa hoy en día. ¿Desea actualizar el estado de la cuenta en CRM y el sistema de facturación? Las aplicaciones móviles ofrecen API de Saas al alcance de su mano.
...
<!-- URLs. -->
[Migración del servicio móvil a Servicio de aplicaciones]: app-service-mobile-dotnet-backend-migrating-from-mobile-services-preview.md

[Servicio de aplicaciones de Azure]: app-service-value-prop-what-is.md
[Introducción]: app-service-mobile-ios-get-started-offline-data-preview.md
