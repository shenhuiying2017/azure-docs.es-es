...
<a href="/en-us/develop/mobile/tutorials/get-started-with-push-dotnet" title="C# para Tienda Windows">C# para Tienda Windows</a><a href="/en-us/develop/mobile/tutorials/get-started-with-push-js" title="JavaScript para Tienda Windows">JavaScript para Tienda Windows</a><a href="/en-us/develop/mobile/tutorials/get-started-with-push-wp8" title="Windows Phone">Windows Phone</a><a href="/en-us/develop/mobile/tutorials/get-started-with-push-ios" title="iOS">iOS</a><a href="/en-us/develop/mobile/tutorials/get-started-with-push-android" title="Android">Android</a><a href="/en-us/develop/mobile/tutorials/get-started-with-push-xamarin-ios" title="Xamarin.iOS">Xamarin.iOS</a><a href="/en-us/develop/mobile/tutorials/get-started-with-push-xamarin-android" title="Xamarin.Android" class="current">Xamarin.Android</a></div>

Hemos realizado algunos cambios en las notificaciones de inserción con Servicios móviles. Esté atento al tutorial actualizado para Xamarin Android.

  [C# para Tienda Windows]: /en-us/develop/mobile/tutorials/get-started-with-push-dotnet "C# para Tienda Windows"
  [JavaScript para Tienda Windows]: /en-us/develop/mobile/tutorials/get-started-with-push-js "JavaScript para Tienda Windows"
