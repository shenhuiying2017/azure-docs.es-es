...
4.  [Incorporación de un campo de marca de tiempo para CompleteDate][Incorporación de un campo de marca de tiempo para CompleteDate]
...
Este tutorial se basa en los pasos y en el código de ejemplo del tutorial anterior [Introducción][Introducción] o [Introducción a los datos][Introducción a los datos]. Antes de comenzar este tutorial, primero debe completar el tutorial [Introducción a los Servicios móviles][Introducción] o [Introducción a los datos][Introducción a los datos].
