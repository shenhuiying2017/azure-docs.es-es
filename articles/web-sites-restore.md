...
En este artículo se muestra cómo restaurar una aplicación web del que ha hecho previamente una copia de seguridad con la característica de copias de seguridad de [Aplicaciones web del Servicio de aplicaciones](http://go.microsoft.com/fwlink/?LinkId=529714). Para obtener más información, consulte [Copias de seguridad de Aplicaciones web del Servicio de aplicaciones](web-sites-backup.md). 
