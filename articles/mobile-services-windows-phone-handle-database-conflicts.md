...
<a href="/es-es/develop/mobile/tutorials/handle-database-write-conflicts-dotnet/" title="C# para Tienda Windows">C# para Tienda Windows</a>
<a href="/es-es/documentation/articles/mobile-services-windows-store-javascript-handle-database-conflicts/" title="JavaScript para Tienda Windows">JavaScript para Tienda Windows</a>
