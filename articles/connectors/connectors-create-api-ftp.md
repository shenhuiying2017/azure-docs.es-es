---
title: Aprenda a usar el conector de FTP en aplicaciones lógicas | Microsoft Docs
...
> [!INCLUDE [Pasos para crear una conexión a FTP](../../includes/connectors-create-api-ftp.md)]
> 
> 
...
3. Seleccione la opción **>** (flecha derecha) y busque la carpeta donde desea supervisar los archivos nuevos o modificados. Al seleccionar la carpeta, observará que esta aparece en el control **Carpeta**.  
