---
title: Aprenda a utilizar el conector del Bus de servicio de Azure en las aplicaciones lógicas | Microsoft Docs
...
> [!INCLUDE [Pasos para crear una conexión al Bus de servicio de Azure](../../includes/connectors-create-api-servicebus.md)]
> 
> 
...
> [!INCLUDE [Pasos para crear un desencadenador del Bus de servicio](../../includes/connectors-create-api-servicebus-trigger.md)]
> 
> 
...
[!INCLUDE [Pasos para crear una acción del Bus de servicio](../../includes/connectors-create-api-servicebus-action.md)]
