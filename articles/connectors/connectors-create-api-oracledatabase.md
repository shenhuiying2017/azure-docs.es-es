...
[Cree una aplicación lógica](../logic-apps/logic-apps-create-a-logic-app.md) y explore los conectores disponibles en Logic Apps en nuestra [lista de API](apis-list.md).
