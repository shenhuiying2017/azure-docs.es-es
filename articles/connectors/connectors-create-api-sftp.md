---
title: Aprenda a utilizar el conector de SFTP en las aplicaciones lógicas | Microsoft Docs
...
> [!INCLUDE [Pasos para crear una conexión a SFTP](../../includes/connectors-create-api-sftp.md)]
> 
> 
...
> [!INCLUDE [Pasos para crear un desencadenador de SFTP](../../includes/connectors-create-api-sftp-trigger.md)]
> 
> 

## Agregar una condición
> [!INCLUDE [Pasos para agregar una condición](../../includes/connectors-create-api-sftp-condition.md)]
> 
> 
...
> [!INCLUDE [Pasos para crear una acción de SFTP](../../includes/connectors-create-api-sftp-action.md)]
> 
> 
