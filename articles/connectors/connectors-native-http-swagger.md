...
1. [Crear una cuenta de Azure Storage con Azure Blob Storage](../storage/storage-create-storage-account.md). Para este paso, establezca los permisos en **Acceso público**.
