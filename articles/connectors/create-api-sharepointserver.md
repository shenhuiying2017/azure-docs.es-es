<properties
pageTitle="Uso de la API de SharePoint Server en las aplicaciones lógicas | Microsoft Azure"
description="Introducción al uso de la API de SharePoint Server del Servicio de aplicaciones de Azure en las aplicaciones lógicas y en PowerApps."
services=""	
documentationCenter="" 	
authors="msftman"	
manager="erikre"	
...
# Introducción a la API de SharePoint
...
## Pasos siguientes
[Creación de una nueva aplicación lógica mediante la conexión de servicios de SaaS](../app-service-logic/app-service-logic-create-a-logic-app.md) [Creación de una aplicación de PowerApp](../power-apps/powerapps-get-started-azure-portal.md)
