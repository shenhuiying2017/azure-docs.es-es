...
Para usar Cloud9, primero necesita visitar su página web y [registrarse para obtener una suscripción](http://cloud9ide.com/). Puede iniciar sesión con una cuenta de GitHub o BitBucket existente o crear una cuenta de Cloud9. Hay disponible una oferta de suscripción gratuita, además de otra de pago que proporciona más características. Para obtener más información, consulte [Cloud9 IDE](http://cloud9ide.com/).

Creación de un proyecto Node.js
-------------------------------

1.  Inicie sesión en Cloud9, haga clic en el símbolo **+** al lado de **My Projects** y, a continuación, seleccione **Create a new project**.

    ![Creación de un proyecto nuevo en Cloud9](./media/cloud-services-nodejs-develop-deploy-cloud9/cloud9_create_project.png)

2.  En el cuadro de diálogo **Create a new project**, introduzca un nombre de proyecto, acceso y tipo de proyecto. Haga clic en **Create** para crear el proyecto.
...
4.  Para crear una nueva aplicación Node, seleccione **File** y luego **New File**.
...
6.  Para guardar el código, seleccione **File** y, a continuación, **Save as**. En el cuadro de diálogo **Save As**, escriba **server.js** como el nombre del archivo y luego haga clic en **Save**.
...
3.  Si esta es la primera vez que ha creado una implementación de Cloud9 que usa Azure, debe configurar sus ajustes de publicación de Azure. Lleve a cabo los siguientes pasos para descargar e instalar esta configuración en Cloud9:
    ...
    3.  En el cuadro de diálogo **Add a deploy target**, seleccione **Choose File** y, a continuación, seleccione el archivo que descargó en el paso anterior.
