<properties urlDisplayName="Get Started with Media Services" pageTitle="Introducción a los Servicios multimedia en Azure" metaKeywords="Azure media services" description="An introduction to using Media Services with Azure." metaCanonical="" services="media-services" documentationCenter="" title="Get started with Media Services" authors="juliako" solutions="" manager="dwrede" editor="" />
