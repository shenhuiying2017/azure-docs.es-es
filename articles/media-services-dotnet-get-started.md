...
# Inicio rápido: Entrega de vídeo a petición con el SDK de Servicios multimedia para .NET 
...
La función **Main** llama a métodos que se definirán más adelante en esta sección.
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            try
            {
                // Crear y almacenar en caché las credenciales de Servicios multimedia en una variable de clase estática.
                _cachedCredentials = new MediaServicesCredentials(
                                _mediaServicesAccountName,
                                _mediaServicesAccountKey);
                // Se usan las credenciales almacenadas en caché para la creación. CloudMediaContext.
                _context = new CloudMediaContext(_cachedCredentials);

                // Agregar llamadas a métodos definidos en esta sección.
            ...
            {
                // Analizar el mensaje de error XML en la respuesta de Servicios multimedia y crear una nueva 
                // excepción con su contenido.
...
Agregue el método siguiente a la clase Program
	...
	{
		// Preparar un trabajo con una sola tarea para transcodificar el recurso especificado
	    ...
	    // Enviar el trabajo y esperar hasta que se complete.
	    job.Submit();
...
##Configuración de la directiva de entrega para el recurso codificado
...
##Publicación del recurso y obtención de direcciones URL de descarga progresiva y de streaming
...
Agregue el método siguiente a la clase Program
    ...
    static public void PublishAssetGetURLs(IAsset asset)
    {
        ...
        // Obtener direcciones URL de descarga progresiva para cada archivo MP4 que se generó como resultado
		// de la codificación.
		List<Uri> mp4ProgressiveDownloadUris = mp4AssetFiles.Select(af => af.GetSasUri()).ToList();


        // Mostrar direcciones URL de streaming.
		...
		// Mostrar las direcciones URL de descarga progresiva.
        Console.WriteLine("Use the following URLs for progressive download.");
        mp4ProgressiveDownloadUris.ForEach(uri => Console.WriteLine(uri + "\n"));
        Console.WriteLine();

        // Descargar el recurso de salida en una carpeta local.
