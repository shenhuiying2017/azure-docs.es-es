<properties
   ...
   description="Aprenda a utilizar Hive con HDInsight a través de SSH."
   services="hdinsight"
   documentationCenter=""
   authors="Blackmist"
   manager="paulettm"
...
3. Con la CLI, introduzca las siguientes instrucciones para crear una nueva tabla denominada **log4jLogs** con los datos de ejemplo:
    ...
    * **DROP TABLE**: elimina la tabla y el archivo de datos, en caso de que la tabla ya exista.
    ...
    * **ROW FORMAT**: indica a Hive cómo dar formato a los datos. En este caso, los campos de cada registro se separan mediante un espacio.
