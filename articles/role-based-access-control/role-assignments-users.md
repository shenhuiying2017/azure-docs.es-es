...
> * [Administración del acceso por usuario o grupo](role-assignments-users.md)
> * [Administración del acceso por recurso](role-assignments-portal.md)
...
Para administrar el acceso a los recursos, consulte [Uso de asignaciones de roles para administrar el acceso a los recursos de la suscripción de Azure](role-assignments-portal.md).
...
2. Seleccione **Usuarios y grupos** y luego **Todos los usuarios** o **Todos los grupos**. En este ejemplo, nos centramos en los usuarios individuales.
    ![Captura de pantalla de administración de usuarios y grupos en Azure Active Directory](./media/role-assignments-users/rbac_users_groups.png)
...
2. Seleccione **Quitar** y después **Sí** para confirmar.
    ![Captura de pantalla de eliminación de asignación de acceso](./media/role-assignments-users/delete_assignment.png)

## <a name="next-steps"></a>Pasos siguientes

* Vea una introducción al control de acceso basado en rol en [Uso de asignaciones de roles para administrar el acceso a los recursos de la suscripción de Azure](role-assignments-portal.md)
* Consulte los [Roles RBAC integrados](built-in-roles.md)
