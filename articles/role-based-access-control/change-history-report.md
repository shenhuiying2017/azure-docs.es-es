...
![PowerShell Get:AzureRMAuthorizationChangeLog (captura de pantalla)](./media/change-history-report/access-change-history.png)
...
![Changelog visto como una hoja de cálculo ( captura de pantalla)](./media/change-history-report/change-history-spreadsheet.png)

## <a name="next-steps"></a>Pasos siguientes
* Uso de [roles personalizados en RBAC de Azure](custom-roles.md)
* Información sobre cómo administrar [RBAC de Azure con PowerShell](role-assignments-powershell.md)
