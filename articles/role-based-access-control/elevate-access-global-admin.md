...
![Captura de pantalla del Centro de administración de Azure AD: Propiedades: Los administradores globales pueden administrar la suscripción de Azure](./media/elevate-access-global-admin/aad-azure-portal-global-admin-can-manage-azure-subscriptions.png)
...
- Obtener más información sobre la [administración del control de acceso basado en rol con REST](role-assignments-rest.md)

- [Administrar asignaciones de acceso](role-assignments-users.md) en Azure Portal
