...
- Aprenda a [crear un rol personalizado](custom-roles.md).
- Revise los [roles RBAC integrados](built-in-roles.md).
- Aprenda a administrar las asignaciones de acceso [por usuario](role-assignments-users.md) o [por recurso](role-assignments-portal.md) 
