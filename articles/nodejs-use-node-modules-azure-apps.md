...
* Servicios en la nube de Azure esperan que todos los módulos se instalen en el entorno de desarrollo y que el directorio **node_modules** se incluya como parte del paquete de implementación.
...
* Ejecute **npm install** en una máquina con Windows que tenga instalados todos los requisitos previos del módulo nativo. A continuación, implemente la carpeta **node_modules** creada como parte de la aplicación en Sitios web Azure.
...
[usar la interfaz de la línea de comandos de Azure para Mac y Linux]: xplat-cli.md
