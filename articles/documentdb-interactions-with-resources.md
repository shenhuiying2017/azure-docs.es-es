...
<tbody>
<tr class="odd">
<td align="left"><p><strong>Propiedad</strong></p></td>
<td align="left"><p><strong>¿Configurable por el usuario o generado por el sistema?</strong></p></td>
<td align="left"><p><strong>Propósito</strong></p></td>
</tr>
<tr class="even">
<td align="left"><p>_rid</p></td>
<td align="left"><p>Generado por el sistema</p></td>
<td align="left"><p>Identificador del recurso generado por el sistema único y jerárquico</p></td>
</tr>
<tr class="odd">
<td align="left"><p>_etag</p></td>
<td align="left"><p>Generado por el sistema</p></td>
<td align="left"><p>etag del recurso necesario para un control optimista de concurrencia</p></td>
</tr>
<tr class="even">
<td align="left"><p>_ts</p></td>
<td align="left"><p>Generado por el sistema</p></td>
<td align="left"><p>Última actualización de la marca de tiempo del recurso</p></td>
</tr>
<tr class="odd">
<td align="left"><p>_self</p></td>
<td align="left"><p>Generado por el sistema</p></td>
<td align="left"><p>URI del recurso única y direccionable</p></td>
</tr>
<tr class="even">
<td align="left"><p>id</p></td>
<td align="left"><p>Configurable por el usuario</p></td>
<td align="left"><p>Nombre del recurso único definido por el usuario</p></td>
</tr>
</tbody>
</table>
...
Por último, para ejecutar el procedimiento almacenado en el ejemplo anterior, se necesita emitir un POST contra la URI del recurso del procedimiento almacenado (/dbs/\_rid-db/colls/\_rid-coll/sprocs/sproc1). Esto se ilustra a continuación:
...
<tbody>
<tr class="odd">
<td align="left"><p><strong>Modo de conectividad</strong></p></td>
<td align="left"><p><strong>Protocol</strong></p></td>
<td align="left"><p><strong>Detalles</strong></p></td>
<td align="left"><p><strong>SDK de Base de datos de documentos</strong></p></td>
</tr>
<tr class="even">
<td align="left"><p>Puerta de enlace</p></td>
<td align="left"><p>HTTPS</p></td>
<td align="left"><p>Las aplicaciones se conectan directamente con los nodos perimetrales usando las URI lógicas. Esto significa un salto adicional de la red.</p></td>
<td align="left"><p>API de REST</p>
<p>.NET, JavaScript, Node.js, Python</p></td>
</tr>
<tr class="odd">
<td align="left"><p>Conectividad directa</p></td>
<td align="left"><p>HTTPS y</p>
<p>TCP</p></td>
<td align="left"><p>Las aplicaciones pueden tener acceso de manera directa a la tabla de enrutamiento y realizar el enrutamiento del cliente para que se conecte directamente con las réplicas.</p></td>
