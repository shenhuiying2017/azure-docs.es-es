...
- Una suscripción de Azure (vale con una [versión de evaluación gratuita](https://account.windowsazure.com/organization))
...
9. Para el URI del Id. de la aplicación, escriba `https://<your_directory_name>/ToGoAPI` y sustituya `<your_directory_name>` por el nombre de su directorio de Azure AD.  Guarde la configuración.
...
9. Para el URI del Id. de la aplicación, escriba `https://<your_directory_name>/ToDoSPA` y sustituya `<su_nombre_de_directorio>` por el nombre de su directorio de Azure AD.
...
4. Busque la clave de aplicación `ida:Audience` y sustituya el valor por el Id. de cliente del portal de Azure.
...
7. Sustituya el valor de `clientId` por el Id. de cliente del portal de Azure.
