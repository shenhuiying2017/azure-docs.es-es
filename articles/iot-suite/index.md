...
description: "La documentación de Azure IoT Suite incluye guías de introducción, artículos de procedimientos, tutoriales y referencia de API."
services: iot-suite
author: czeumault
manager: carolz
layout: LandingPage
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>Más información sobre el Conjunto de aplicaciones de IoT</h3>
                    </div>
                </div>
            </div>
        </div>
