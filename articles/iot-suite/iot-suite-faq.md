...
### ¿En qué se diferencian eliminar un grupo de recursos en el Portal de vista previa de Azure y hacer clic en Eliminar en una solución preconfigurada en azureiotsuite.com?
...
- Si elimina el grupo de recursos en el [Portal de vista previa de Azure][lnk-azure-portal], solo eliminará los recursos de dicho grupo de recursos; también tendrá que eliminar la aplicación de Azure Active Directory asociada a la solución preconfigurada en el [Portal de administración de Azure][lnk-classic-portal].
