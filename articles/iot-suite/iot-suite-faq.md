---
title: Preguntas más frecuentes sobre el conjunto de aplicaciones Azure IoT | Microsoft Docs
...
1. Obtenga la QueryKey de la API de Mapas de Bing para empresa en el [Portal de Azure][lnk-azure-portal]\:
   ...
   3. Verá dos claves: MasterKey y QueryKey. Copie el valor de QueryKey.
      ...
      > [!NOTE]
      > ¿No tiene una cuenta de la API de Mapas de Bing para empresa? Para crear una cuenta en el [Portal de Azure][lnk-azure-portal] haga clic en + Nuevo, busque la API de Mapas de Bing para empresa y siga las indicaciones para crearla.
      > 
      > 
