...
## [Introducción a los aceleradores de soluciones](iot-suite-what-are-solution-accelerators.md)

# Introducción
## Supervisión remota
### [Implementación del acelerador de solución](iot-suite-remote-monitoring-deploy.md)
### [Funcionamiento del acelerador de solución](iot-suite-remote-monitoring-explore.md)

## Supervisión remota (versión anterior)
### [¿Qué son los aceleradores de soluciones?](iot-suite-v1-what-are-preconfigured-solutions.md)
### [P+F](iot-suite-v1-faq.md)

### Introducción
#### [Introducción a los aceleradores de soluciones](iot-suite-v1-getstarted-preconfigured-solutions.md)
...
#### [Personalización de un acelerador de solución](iot-suite-v1-guidance-on-customizing-preconfigured-solutions.md)
...
### [Tutorial del acelerador de la solución de mantenimiento predictivo](iot-suite-predictive-walkthrough.md)

## Factoría conectada
### [¿Qué es la solución de factoría conectada?](iot-suite-connected-factory-features.md)
### [Introducción a la solución de factoría conectada](iot-suite-connected-factory-overview.md)
### [Tutorial sobre la solución de factoría conectada](iot-suite-connected-factory-sample-walkthrough.md)

## Simulación de dispositivo
### [Implementación de simulación de dispositivo](iot-suite-device-simulation-deploy.md)
### [Exploración de simulación de dispositivo](iot-suite-device-simulation-explore.md)
...
### [Integración de datos de SIM](iot-suite-remote-monitoring-telefonica-sim.md)
...
### [Visualización con Power BI](iot-suite-integrate-data-powerbi.md)
### [Personalización de la interfaz de usuario de la solución](iot-suite-remote-monitoring-customize.md)
### [Personalización y nueva implementación de un microservicio](iot-suite-microservices-example.md)
...
### [Visualización de datos con Time Series Insights](iot-suite-time-series-insights.md)
### [Integración con Data Lake](iot-suite-integrate-data-lake.md)
...
#### [Node.js en Raspberry Pi](iot-suite-connecting-pi-node.md)
#### [C en Raspberry Pi](iot-suite-connecting-pi-c.md)
#### [MX Chip AZ3166 DevKit](iot-suite-arduino-iot-devkit-az3166-devkit-remote-monitoringV2.md)

### Conceptos
#### [Detalles de la implementación de la supervisión remota](iot-suite-remote-monitoring-sample-walkthrough.md)
#### [Opciones de arquitectura de supervisión remota](iot-suite-remote-monitoring-architectural-choices.md)

## Factoría conectada
### [Implementación de una puerta de enlace para una solución de factoría conectada](iot-suite-connected-factory-gateway-deployment.md)
### [Personalización de factoría conectada](iot-suite-connected-factory-customize.md)
...
## [Preguntas frecuentes acerca de la supervisión remota](iot-suite-faq-rm-v2.md)
