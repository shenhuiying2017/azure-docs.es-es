...
description: Se describe cómo conectar un dispositivo a la solución de supervisión remota preconfigurada de Azure IoT Suite mediante una aplicación creada en Node.js.
services: ''
suite: iot-suite
