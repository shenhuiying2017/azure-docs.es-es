...
Asegúrese de que tiene instalada la versión 0.10.x o posterior de Node.js en la máquina de desarrollo. Para comprobar la versión, puede ejecutar `node --version` en la línea de comandos.
