...
Puede ver los recursos aprovisionados en [Portal de administración de Azure](https://portal.azure.com) y desplazándose al grupo de recursos con el nombre de la solución especificada.
