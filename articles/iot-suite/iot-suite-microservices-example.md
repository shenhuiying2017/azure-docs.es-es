...
>[!div class="checklist"]
> * [Implementación local de la solución preconfigurada de supervisión remota](../iot-accelerators/iot-accelerators-remote-monitoring-deploy-local.md)
...
![Mensaje de activo y correcto en Postman](media/iot-suite-microservices-example/postman-alive-well.png)
...
![Imagen de Docker correcta](media/iot-suite-microservices-example/successful-docker-image.png)
...
![Imagen de Docker en el centro de Docker](media/iot-suite-microservices-example/docker-image-in-docker-hub.png)
...
![Mensaje de Postman Las nuevas modificaciones se hacen aquí](media/iot-suite-microservices-example/new-postman-message.png)
...
Lo siguiente que hay que probar es [personalizar el microservicio del simulador de dispositivos en la solución de supervisión remota](iot-suite-remote-monitoring-test.md).
