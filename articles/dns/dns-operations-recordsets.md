...
[Delegar un dominio a DNS de Azure](dns-domain-delegation.md)<BR> [Administrar zonas DNS](dns-operations-dnszones.md)<BR> [Automatizar operaciones mediante el SDK de .NET](dns-sdk.md)
