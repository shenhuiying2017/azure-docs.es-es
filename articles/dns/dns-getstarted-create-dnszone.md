...
En estas instrucciones se usa PowerShell para Microsoft Azure. Asegúrese de actualizar a la versión más reciente de PowerShell para Azure para usar los cmdlets de DNS de Azure. Se pueden realizar los mismos pasos usando el Portal de Azure o CLI multiplataforma.

Para poder administrar DNS de Azure con PowerShell para Azure, es necesario seguir estos pasos.

DNS de Azure usa el Administrador de recursos de Azure (ARM). Siga estas instrucciones para Azure PowerShell 1.0.0 y posteriores. Puede encontrar más información en [Uso de Azure PowerShell con Azure Resource Manager](../powershell-azure-resource-manager.md).
