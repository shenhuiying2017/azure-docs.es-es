---
title: Administración de registros de DNS inversos para los servicios usando la CLI de Azure en Resource Manager | Microsoft Docs
...
[!INCLUDE [P+F](../../includes/dns-reverse-dns-record-operations-faq-arm-include.md)]
