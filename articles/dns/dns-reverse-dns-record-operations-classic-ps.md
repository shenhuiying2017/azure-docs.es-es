---
title: Administración de registros de DNS inversos para sus servicios usando PowerShell en el modelo de implementación clásico | Microsoft Docs
...
[!INCLUDE [P+F](../../includes/dns-reverse-dns-record-operations-faq-asm-include.md)]
