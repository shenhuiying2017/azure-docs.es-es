<properties
   pageTitle="Introducción a DNS de Azure | Microsoft Azure"
	description="Aprenda a crear zonas DNS en DNS de Azure paso a paso para empezar a hospedar el dominio DNS usando PowerShell o la CLI"
	services="dns"
...
Se crea una zona DNS con el comando "azure network dns-zone create". En el ejemplo siguiente, se crea una zona DNS denominada "contoso.com" en el grupo de recursos denominado "MyResourceGroup":
