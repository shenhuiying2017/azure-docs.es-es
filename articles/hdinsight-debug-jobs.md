<properties urlDisplayName="Debug HDInsight Hadoop Errors" pageTitle="Depuraci&oacute;n de Hadoop en HDInsight: Mensajes de error | Azure" metaKeywords="hdinsight, hdinsight service, hdinsight azure, debug, error messages, errors" description="Conozca los mensajes de error que puede recibir cuando administre HDInsight con PowerShell, as&iacute; como los pasos que debe seguir para la recuperaci&oacute;n." services="hdinsight" title="Depuraci&oacute;n de Hadoop en HDInsight: mensajes de error" umbracoNaviHide="0" disqusComments="1" editor="cgronlun" manager="paulettm" authors="bradsev" />
...
En la sección [Errores de HDInsight][Errores de HDInsight] se enumeran los errores que un usuario puede encontrarse en Azure PowerShell o en el portal de Azure, ordenados por orden alfabético según el nombre y vinculados a una entrada de la sección [Descripción y mitigación de los errores][Descripción y mitigación de los errores], donde se facilita la siguiente información sobre los mismos:
