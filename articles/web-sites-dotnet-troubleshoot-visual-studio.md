...
1.  [Requisitos previos](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md.html#prerequisites)
2.  [Configuración y administración de sitios](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md.html#sitemanagement)
3.  [Vista remota](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md.html#remoteview)
4.  [Depuración remota](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md.html#remotedebug)
5.  [Información general de registros de diagnóstico](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md.html#logsoverview)
6.  [Creación y visualización de registros de seguimiento de aplicación](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md.html#apptracelogs)
7.  [Visualización de registros de servidor web](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md.html#webserverlogs)
8.  [Visualización de registros de mensajes de error detallados](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md.html#detailederrorlogs)
9.  [Descarga de registros de sistema de archivos](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md.html#downloadlogs)
10. [Visualización de registros de almacenamiento](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md.html#storagelogs)
11. [Visualización de registros de solicitudes con error](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md.html#failedrequestlogs)
12. [Pasos siguientes](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md.html#nextsteps)
...
![Ver configuración en el Explorador de servidores](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image001.jpg)
...
![Ventana Azure Web Site](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image002.gif)
...
**Error del servidor en la aplicación '/':** ![Página de error poco práctica](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image003.jpg)

**Se produjo un error:** ![Página de error poco práctica](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image004.jpg)

**El sitio web no puede mostrar la página** ![Página de error poco práctica](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image005.jpg)
...
1.  En el **Explorador de servidores**, expanda **Azure**, **Sitios web** y expanda el nodo del sitio web en el que está realizando la implementación.
	...
	![Archivos y archivos de registro](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image006.jpg)

1.  Expanda el nodo **Files** y haga doble clic en el archivo *Web.config*.

	![Abrir Web.config](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image007.jpg)
...
1.  Agregue la siguiente línea al elemento system.web:
	...
	![Editar Web.config](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image008.jpg)
...
1.  Actualice el explorador que actualmente muestra el mensaje de error poco práctico y ahora podrá ver un mensaje detallado del error, tal como muestra el siguiente ejemplo:
	...
	![Mensaje de error detallado](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image009.jpg)
...
1.  [Defina un punto de interrupción](http://www.visualstudio.com/en-us/get-started/debug-your-app-vs.aspx) en la línea ViewBag.Message.
2.  En el **Explorador de soluciones**, haga clic con el botón secundario en el proyecto y, a continuación, en **Publicar**.
3.  En la lista desplegable **Perfil**, seleccione el mismo perfil que utilizó en [Introducción a Azure y ASP.NET](http://azure.microsoft.com/en-us/develop/net/tutorials/get-started/).
4.  Haga clic en la pestaña **Configuración**, cambie la **Configuración** a **Depurar** y, a continuación, haga clic en **Publicar**.

	![Publicar en modo de depuración](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image010.jpg)

1.  Una vez que ha finalizado la implementación y que el explorador abre la dirección URL de Azure de su sitio, cierre el explorador.
2.  Para Visual Studio 2013: En el **Explorador de servidores**, expanda **Azure**, **Sitios web**, haga clic con el botón secundario en el sitio web y, a continuación, haga clic en **Attach Debugger**.

	![Attach debugger](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image011.jpg)
	...
	Para Visual Studio 2012 con actualización 4:
	...
	![Definir la depuración remota en el portal de administración](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image012.jpg)

* En el menú **Depurar** de Visual Studio, haga clic en **Asociar al proceso**. \* En el cuadro **Calificador**, escriba la dirección URL de su sitio web, sin el prefijo http://. \* Seleccione **Mostrar los procesos de todos los usuarios**. \* Cuando se le soliciten credenciales, escriba el nombre de usuario y la contraseña con permisos para publicar el sitio web. Para obtener estas credenciales, vaya a la pestaña Panel del sitio web en el portal de administración y haga clic en **Download the publish profile**. Abra el archivo en un editor de texto y verá el nombre de usuario y la contraseña después de las primeras apariciones de **userName=** y **userPWD=**. \* Cuando los procesos aparezcan en la tabla **Available Processes**, seleccione **w3wp.exe** y haga clic en **Attach**. \* Abra la dirección URL de su sitio en el explorador.
...
1.  Mantenga el mouse sobre la variable currentTime para ver el valor de tiempo.
	...
	![Ver la variable en ejecución en modo de depuración en Azure](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image013.jpg)
...
![Página About con el valor nuevo](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image014.jpg)
...
1.  Presione F5 para ejecutar la aplicación en modo de depuración.
	...
	![Ventana de seguimiento en depuración](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image015.jpg)
...
![trace.axd](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image016.jpg)
...
![trace.axd](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image017.jpg)
...
1.  En el **Explorador de servidores**, haga clic con el botón secundario en su sitio web y seleccione **View Streaming Logs in Output Window**.
	...
	![Ver registros de streaming en el menú contextual](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image018.jpg)
	...
	![Ver registros de streaming en el menú contextual](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image019.jpg)
...
1.  En la ventana del explorador que muestra la página principal de su aplicación, haga clic en **Contact**.
	...
	![Seguimiento de errores en la ventana Output](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image020.gif)
	...
	![Registro de aplicación desactivado](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image021.gif)
...
2.  Cambie **Application Logging (File System)** a **Verbose** y, a continuación, haga clic en **Save**.
	...
	![Definir el nivel de seguimiento como Verbose](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image022.gif)
...
1.  En la ventana del explorador que ahora muestra su página **Contact**, haga clic en **Home**, en **About** y, a continuación, en **Contact**.
	...
	![Resultados detallados del seguimiento](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image023.gif)
...
![Botones de la pestaña de registros](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image024.gif)
...
1.  En la pestaña **Azure Web Site Configuration** que abrió desde el **Explorador de servidores**, cambie el registro de servidor web a **On** y haga clic en **Save**.
	...
	![Habilitar el registro de servidor web](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image025.gif)

1.  En la ventana **Resultados**, haga clic en el botón **Specify which Azure logs to monitor**.

	![Especificar los registros de Azure para supervisar](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image026.gif)

1.  En el cuadro de diálogo **Azure Logging Options**, seleccione **Web server logs** y haga clic en **OK**.

	![Supervisar los registros de servidor web](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image027.gif)
...
1.  En la ventana del explorador que muestra el sitio web, haga clic en **Home**, en **About** y, a continuación, en **Contact**.
	...
	![Registros de servidor web en la ventana Output](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image028.gif)
...
1.  En la pestaña **Azure Web Site Configuration** que abrió desde el **Explorador de servidores**, cambie **Detailed Error Messages** a **On** y haga clic en **Save**.
	...
	![Habilitar los mensajes de error detallados](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image029.gif)

1.  En la ventana **Resultados**, haga clic en el botón **Specify which Azure logs to monitor**.
2.  En el cuadro de diálogo **Azure Logging Options**, haga clic en **All logs** y haga clic en **OK**.

	![Supervisar todos los registros](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image030.gif)
...
1.  En la barra de direcciones de la ventana del explorador, agregue un carácter adicional a la dirección URL para generar un error 404 (por ejemplo, http://localhost:53370/Home/Contactx) y presione Entrar.
	...
	![Registro de error detallado en la ventana Resultados](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image031.jpg)

	Presione Ctrl y haga clic en el vínculo para ver el resultado del registro formateado en un explorador:

	![Registro de error detallado en la ventana del explorador](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image032.gif)

**Descarga de registros de sistema de archivos**
...
1.  En la ventana **Resultados**, haga clic en **Download Streaming Logs**.
	...
	![Botones de la pestaña de registros](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image033.gif)

	El Explorador de archivos abre la carpeta *Descargas* con el archivo descargado seleccionado.

	![Archivo descargado](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image034.gif)

1.  Extraiga el archivo *.zip* y verá la siguiente estructura de carpeta:

	![Archivo descargado](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image035.gif)
...
**Visualización de registros de almacenamiento**
...
2.  En el portal de administración, haga clic en la pestaña **Almacenamiento** y, a continuación, haga clic en **Create a Storage Account**.
	...
	![Crear una cuenta de almacenamiento](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image036.jpg)

1.  Escriba una dirección URL única para usarla en la cuenta de almacenamiento y haga clic en **Create Storage Account**.

	![Escribir una dirección URL](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image037.jpg)

1.  En la ventana **Azure Web Site** de Visual Studio, haga clic en la pestaña **Registros** y luego en **Configure Logging**.

	![Archivo descargado](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image038.gif)
...
3.  Haga clic en **Manage Table Storage**.
	...
	![Hacer clic en Manage Table Storage](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image039.gif)
	...
	![Administrar el almacenamiento de tablas](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image040.jpg)
...
1.  En la pestaña **Registros** de la ventana **Azure Web Site** en Visual Studio, haga clic en **Refresh** en **Diagnostic Summary**.
	...
	![Hacer clic en Actualizar](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image041.jpg)
	...
	![Registros de almacenamiento](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image042.jpg)
...
1.  Haga clic en **View all application logs**.
	...
	![Tabla de seguimiento en el Explorador de servidores](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image043.jpg)

	![Registros de almacenamiento en vista de tabla](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image044.jpg)
...
1.  Para ver los detalles de una sola fila, haga clic con el botón secundario en una de las filas y, a continuación, haga clic en **Editar**.
	...
	![Tabla de seguimiento en el Explorador de servidores](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image045.jpg)
...
1.  En la pestaña **Configuration** de la ventana **Azure Web Site** que abrió desde el **Explorador de servidores**, cambie **Failed Request Tracing** a **On** y haga clic en **Save**.
	...
	![Habilitar el seguimiento de solicitudes con error](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image046.gif)
...
2.  En el portal de administración, haga clic en **Panel** y luego en **Reset your deployment credentials** en la sección **Quick Glance**.
	...
	![Restablecer el vínculo a las credenciales de FTP en el panel](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image047.jpg)

1.  Escriba un nuevo nombre de usuario y contraseña.

	![Nuevo nombre de usuario y contraseña de FTP](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image048.jpg)
...
1.  Abra la carpeta *LogFiles*.
	...
	![Abrir la carpeta LogFiles](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image049.gif)

1.  Abra la carpeta llamada W3SVC más un valor numérico.

	![Abrir la carpeta W3SVC](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image050.gif)
	...
	![Carpeta W3SVC](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image051.gif)
...
1.  Haga clic en el archivo XML de la solicitud con error para la que desea ver información de seguimiento.
	...
	![Seguimiento de solicitudes con error en un explorador](Troubleshooting%20Azure%20Web%20Sites%20in%20Visual%20Studio.md_archivos/image052.gif)
