...
![GlobalWebCreate][Creación de presencia global]
...
La opción **De la galería** le permite configurar un sitio nuevo con varios marcos de trabajo, como Drupal o WordPress. Esto puede resultar útil para configurar con rapidez un sitio nuevo que posteriormente puede personalizar con el marco de trabajo seleccionado.
...
Para obtener pasos detallados para crear un sitio web nuevo, consulte [Introducción a Sitios web Azure y ASP.NET][howtocreatewebsites].

##<a name="deploywebsite"></a>Implementación del sitio web
...
![GlobalWebQuickGlance][Vista rápida de web global]
...
![GlobalWebFTPSettings][Configuración FTP para web global]
...
<div class="dev-callout">
<strong>Nota:</strong>
<p>Es importante mantener el archivo <i>publishsettings</i> seguro y fuera del control de código fuente, porque contiene los nombres de usuario y las contraseñas para la implementación y también cualquier cadena de conexión de base de datos vinculada.</p>
</div>
...
![GlobalWebVSPublish][Publicación en VS para web global]
...
![GlobalWebWebMatrix][WebMatrix para web global]
...
Tras obtener el certificado de la entidad de certificación, no basta con cargarlo en Azure con el mismo formato. Debe generar un archivo .pfx con el comando openssl. El comando openssl forma parte del proyecto OpenSSL. Los orígenes se distribuyen en el [sitio web de OpenSSL][openssl], pero normalmente puede encontrar también una versión precompilada de la herramienta en Internet. En el ejemplo siguiente, se usan un certificado, myserver.crt, y el archivo de clave privada, myserver.key, para crear un archivo .pfx.

	openssl pkcs12 -export -out myserver.pfx -inkey myserver.key -in myserver.crt

Para cargar el certificado en Azure, primero vaya a la pestaña **Escala** y compruebe que ejecuta el modo **estándar**. El uso de SSL para dominios personalizados no se admite con los modos **libre** o **compartido**. En la pestaña **Configurar**, haga clic en el botón **Cargar un certificado**.

![GlobalWebUplodateCert][Carga de certificado para web global]
...
![GlobalWebSSLBindings][Enlaces SSL para web global]
...
![GlobalWebMonitor1][Supervisión web global 1]

Puede personalizar las métricas en este gráfico con el botón Add Metrics.

![GlobalWebMonitor2][Supervisión web global 2]
...
![GlobalWebMonitor3][Supervisión web global 3]
...
<tr>
   ...
   <td valign="top">- <a href="http://www.windowsazure.com/es-es/manage/services/web-sites/choose-web-app-service">Sitios web Azure, Servicios en la nube y Máquinas virtuales: cuándo usar cada uno</a></td>.
</tr>
<tr>
   <td valign="middle"><strong>Creación</strong></td>
   <td valign="top">- <a href="http://azure.microsoft.com/es-es/documentation/articles/web-sites-dotnet-get-started/">Introducción a Sitios web Azure y ASP.NET</a></td>
</tr>
<tr>
   <td valign="middle"><strong>Implementación</strong></td>
   <td valign="top">- <a href="http://www.windowsazure.com/es-es/develop/net/common-tasks/publishing-with-git/">Publicación en Sitios web Azure desde el control de código fuente</a><br/>- <a href="http://www.windowsazure.com/es-es/develop/net/tutorials/get-started/">Implementación de una aplicación web ASP.NET en un sitio web de Azure</a><br/>- <a href="http://www.windowsazure.com/es-es/develop/net/tutorials/website-with-webmatrix/">Desarrollo e implementación de un sitio web con Microsoft WebMatrix</a></td>
</tr>
<tr>
   <td valign="middle"><strong>Dominios personalizados</strong></td>
   <td valign="top">- <a href="http://www.windowsazure.com/es-es/develop/net/common-tasks/custom-dns-web-site/">Configuración de un nombre de dominio personalizado para un sitio web de Azure</a></td>
</tr>
<tr>
   <td valign="middle"><strong>SSL</strong></td>
   <td valign="top">- <a href="http://www.windowsazure.com/es-es/develop/net/common-tasks/enable-ssl-web-site/">Configuración de un certificado SSL para un sitio web de Azure</a></td>
</tr>
<tr>
   <td valign="middle"><strong>Monitor</strong></td>
   <td valign="top">- <a href="http://www.windowsazure.com/es-es/manage/services/web-sites/how-to-monitor-websites/">Supervisión de sitios web</a></td>
</tr>
</table>

  [websitesoverview]:/es-es/documentation/services/web-sites/
  [csoverview]:/es-es/documentation/services/cloud-services/
  [vmoverview]:/es-es/documentation/services/virtual-machines/
  [chooseservice]:/es-es/manage/services/web-sites/choose-web-app-service
  
  
  [scenariodigitalmarketing]:/es-es/manage/services/web-sites/digital-marketing-campaign-solution-overview
  [howtocreatewebsites]:/es-es/documentation/articles/web-sites-dotnet-get-started
  [webmatrix]:http://www.microsoft.com/web/webmatrix/
  [publishingwithgit]:/es-es/develop/net/common-tasks/publishing-with-git/
  [aspnetgetstarted]:/es-es/develop/net/tutorials/get-started/
  [drupal]:https://drupal.org/
  [umbraco]:http://umbraco.com/
  [customdns]:/es-es/develop/net/common-tasks/custom-dns-web-site/
  [ssl]:/es-es/develop/net/common-tasks/enable-ssl-web-site/
  [openssl]:http://www.openssl.org/
  [sni]:http://es.wikipedia.org/wiki/Server_Name_Indication
  [sslpricing]:/es-es/pricing/details/web-sites/#service-ssl
  [howtomonitor]:/es-es/manage/services/web-sites/how-to-monitor-websites/
