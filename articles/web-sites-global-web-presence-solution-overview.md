...
Para obtener pasos detallados para crear un sitio web nuevo, consulte [Empezar a utilizar Sitios web Azure y ASP.NET][].
...
![Configuración FTP para web global][]
...
![Publicación en VS para web global][]
...
|-----------|-----------------|---------------------------|------|
| **CNAME** | www.contoso.com | contoso.azurewebsites.net | 8000 |
...
Para obtener más información, consulte [Configuración de un nombre de dominio personalizado para un Sitio web Azure][].
...
![Carga de certificado para web global][]
...
![Enlaces SSL para web global][]

La opción **SSL basada en IP** es la forma tradicional de asignar la dirección IP dedicada pública al nombre de dominio. Funciona con todos los exploradores. La opción **SSL SNI** permite que varios dominios compartan la misma dirección IP y, a pesar de ello, tengan diferentes certificados SSL asociados para cada dominio. SSL SNI no funciona con algunos exploradores anteriores (para obtener más información sobre la compatibilidad, consulte la [entrada de Wikipedia para SSL SNI][]). Hay un cargo mensual (prorrateado por horas) asociado a cada certificado SSL y el precio varía en función de si la opción de SSL se basa en IP o en SSL SNI. Para obtener información sobre el precio, consulte [Información sobre el precio de Sitios web][]. Para obtener más información acerca de este proceso, consulte [Configuración de un certificado SSL para un sitio web de Azure][].
...
| **Creación**                | - [Introducción a Sitios web Azure y ASP.NET][]                                          |
| **Implementación**          | - [Publicación en Sitios web Azure desde el control de código fuente][1]                 
                               - [Implementación de una aplicación web ASP.NET en un sitio web de Azure][]               
                               - [Desarrollo e implementación de un sitio web con Microsoft WebMatrix][2]                |
| **Dominios personalizados** | - [Configuración de un nombre de dominio personalizado para un sitio web de Azure.][]    |
| **SSL**                     | - [Configuración de un certificado SSL para un sitio web de Azure][3]                    |
| **Monitor**                 | - [Supervisión de sitios web][4]                                                         |
  ...
  [Introducción a Sitios web Azure y ASP.NET]: http://azure.microsoft.com/es-es/documentation/articles/web-sites-dotnet-get-started/
  ...
  [2]: http://www.windowsazure.com/es-es/develop/net/tutorials/website-with-webmatrix/
  [Configuración de un nombre de dominio personalizado para un sitio web de Azure.]: http://www.windowsazure.com/es-es/develop/net/common-tasks/custom-dns-web-site/
  [3]: http://www.windowsazure.com/es-es/develop/net/common-tasks/enable-ssl-web-site/
  [4]: http://www.windowsazure.com/es-es/manage/services/web-sites/how-to-monitor-websites/
