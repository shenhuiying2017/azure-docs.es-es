...
Servicios de BizTalk de Azure implementa limitaciones del servicio según dos condiciones: uso de memoria y el número de mensajes simultáneos que se procesan. En este tema se enumeran los umbrales de limitación y se describe el comportamiento del tiempo de ejecución cuando se produce una condición de limitación.
...
<tr bgcolor="FAF9F9">
        ...
        <td><strong>Umbral bajo</strong></td>
        <td><strong>Umbral alto</strong></td>
</tr>
    <tr>
        <td>Memoria</td>
        <td>% de memoria total del sistema disponible/PageFileBytes. 
<br/><br/>
La cantidad total disponible de PageFileBytes es de aproximadamente 2 veces la memoria RAM del sistema.</td>
        <td>60%</td>
        <td>70%</td>
    </tr>
    <tr>
        <td>Procesamiento de mensajes</td>
        <td>Número de mensajes que se procesan simultáneamente</td>
        <td>40 * número de núcleos</td>
        <td>100 * número de núcleos</td>
    </tr>
</table>
