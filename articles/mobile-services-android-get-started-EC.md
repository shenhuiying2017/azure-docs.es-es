...
5. Descargue ahora la aplicación:
	- La versión más reciente de la aplicación utiliza el SDK de Android para Servicios móviles 2.0. Puede descargar dicha versión de <a href="https://github.com/RickSaling/mobile-services-samples/tree/futures">aquí</a>. Haga clic en **Descargar ZIP**, descomprima el archivo, y el proyecto se encuentra en GettingStarted, bajo de la carpeta Android.
...
2. En Eclipse, haga clic en **File** (Archivo)y en **Import** (Importar), expanda **Android**, haga clic en **Existing Android Code into Workspace** (Código de Android existente en el área de trabajo) y luego en **Next** (Siguiente). 
...
4. Si ha descargado la versión 2.0 del SDK, deberá actualizar el código con la dirección URL y la clave del servicio móvil:
	...
	- 	Para obtener más detalles, consulte el tutorial <a href="http://azure.microsoft.com/ documentation/articles/mobile-services-android-get-started-data/">Agregar Servicios móviles a una aplicación existente</a>. 
