...
Permite crear campos de tiempo de ejecución en consultas. También puede utilizar el comando measure después de Extend si desea realizar tareas de agregación.
