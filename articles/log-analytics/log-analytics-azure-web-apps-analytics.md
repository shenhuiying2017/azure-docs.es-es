...
La solución Azure Web Apps Analytics (versión preliminar) proporciona información sobre [Azure Web Apps](../app-service-web/app-service-web-overview.md) mediante la recopilación de distintas métricas en todos los recursos de aplicaciones web de Azure. Con la solución, puede analizar y buscar datos de métricas de recursos de aplicaciones web.
