<properties
    pageTitle="Análisis de los registros de diagnóstico de Azure mediante Log Analytics | Microsoft Azure"
...
Log Analytics recopila registros para los siguientes servicios de Azure, que escriben [registros de diagnóstico de Azure](../azure-portal/monitoring-overview-of-diagnostic-logs.md) en formato JSON en Blob Storage:
...
Para algunos recursos, es posible llevar a cabo la configuración anterior de Azure Portal si se siguen los pasos que se describen en [Información general sobre los registros de diagnóstico de Azure](../azure-portal/monitoring-overview-of-diagnostic-logs.md#how-to-enable-collection-of-diagnostic-logs).
...
>[AZURE.NOTE] Si el área de trabajo y los recursos están en diferentes suscripciones de Azure, vaya de una a otra con `Select-AzureRmSubscription -SubscriptionId <Subscription the resource is in>`, según sea necesario
...
>[AZURE.NOTE] Esta configuración no se ve en Azure Portal. Puede comprobar la configuración mediante el cmdlet `Get-AzureRmOperationalInsightsStorageInsight` .  
