...
El umbral de una regla de alertas para un **número de resultados** es mayor o menor que un valor determinado. Se crea una alerta si el número de registros devueltos por la búsqueda de registros coincide con este criterio.
...
| Escriba |*Alerta* |
| SourceSystem |*OMS* |
| *Object*  | Las [alertas de unidades métricas](#metric-measurement-alert-rules) tienen una propiedad para el campo de grupo. Por ejemplo, si la búsqueda de registros se agrupa por Equipo, el registro de alertas tendrá un campo Equipo con el nombre del equipo como valor.
