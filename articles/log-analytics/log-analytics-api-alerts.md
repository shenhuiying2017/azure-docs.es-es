...
# API de REST de alertas de Log Analytics
...
## Programaciones
Una búsqueda guardada puede tener una o varias programaciones. La programación define la frecuencia con que se realiza la búsqueda y el intervalo de tiempo en el que se identifican los criterios. Las programaciones tienen las propiedades de la siguiente tabla.
...
Use el método Get para recuperar una programación concreta de una búsqueda guardada.
...
Para crear una programación, use el método Put con un identificador de programación que sea único de la búsqueda guardada. Si usa un identificador ya existente, lo que hará será modificar esa programación. Al crear una programación en la consola de OMS, se crea un GUID para el identificador de programación.
...
Para crear una actividad, use el método Put con un identificador de actividad que sea único de la programación. Si usa un identificador ya existente, lo que hará será modificar esa actividad. Al crear una actividad en la consola de OMS, se crea un GUID para el identificador de actividad.

El formato de solicitud para crear una actividad varía según el tipo de actividad. En las secciones siguientes se proporcionan ejemplos al respecto.
...
Use el método Put con el identificador de acción para crear una acción de umbral para una programación. Si usa un identificador nuevo para la acción, se creará una acción. Si usa un identificador ya existente para la programación, lo que hará será modificar esa acción.
...
Use el método Put con el identificador de acción para crear una acción de correo electrónico para una programación. Si usa un identificador nuevo para la acción, se creará una acción. Si usa un identificador ya existente para la programación, lo que hará será modificar esa acción.

En el siguiente ejemplo se crea una notificación de correo electrónico con un umbral para que el correo se envíe cuando los resultados de la búsqueda guardada superen el umbral.
...
Use el método Put con el identificador de acción para crear una acción de corrección para una programación. Si usa un identificador nuevo para la acción, se creará una acción. Si usa un identificador ya existente para la programación, lo que hará será modificar esa acción.

En el siguiente ejemplo se crea una corrección con un umbral para que el Runbook se inicie cuando los resultados de la búsqueda guardada superen el umbral.
...
#### Crear o editar una acción de webhook
Use el método Put con el identificador de acción para crear una acción de webhook para una programación. Si usa un identificador nuevo para la acción, se creará una acción. Si usa un identificador ya existente para la programación, lo que hará será modificar esa acción. En el siguiente ejemplo se crea una acción de webhook y una acción de alerta con un umbral para que el webhook se active cuando los resultados de la búsqueda guardada superen el umbral.
