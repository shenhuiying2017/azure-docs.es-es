...
4. En la página **Operations Management Suite Onboarding Wizard: Authentication** (Asistente para incorporación a Operations Management Suite: Autenticación), escriba la dirección de correo electrónico o el número de teléfono y la contraseña de la cuenta de administrador que está asociada a su suscripción de OMS y haga clic en **Iniciar sesión**.
...
6. En la página **Operations Manager Suite Onboarding Wizard: Summary** (Asistente para incorporación a Operations Manager Suite: Resumen), confirme la configuración y, si es correcta, haga clic en **Crear**.
...
3. Abra el perfil de **System Center Advisor Run As Profile Proxy** (Proxy del perfil Ejecutar como de System Center Advisor).
...
5. Para establecer la cuenta que se va a administrar, elija **Una clase, grupo u objeto seleccionado**, haga clic en **Seleccionar...** y después en **Grupo...** para abrir el cuadro **Búsqueda de grupos**.
...
## Cambio de un grupo de Operations Manager a una nueva área de trabajo de OMS
...
5. Siga la página **Operations Management Suite Onboarding Wizard** (Asistente para incorporación a Operations Management Suite) y escriba la dirección de correo electrónico o el número de teléfono y la contraseña de la cuenta de administrador que está asociada a su nueva área de trabajo de OMS.
    ...
    > [AZURE.NOTE] La página **Operations Management Suite Onboarding Wizard: Select Workspace** (Asistente para incorporación a Operations Management Suite: Seleccionar área de trabajo) presentará el área de trabajo existente que está en uso.
...
1.  En el portal de OMS, haga clic en el icono **Configuración**.
2.	Seleccione **Connected Sources** (Orígenes conectados).
3.	En la tabla de la sección de System Center Operations Manager, verá el nombre del grupo de administración que desea quitar del área de trabajo. En la columna **Last Data (Últimos datos)**, haga clic en **Quitar**.  
4.	Aparecerá una ventana que le pide que confirme que desea continuar con la eliminación. Haga clic en **Sí** para continuar.  
5.	Abra el shell de comandos de Operations Manager con una cuenta que sea miembro del rol Administradores de Operations Manager.

    >[AZURE.WARNING] Compruebe que no tiene ningún módulo de administración personalizado con la palabra Advisor o IntelligencePack en el nombre antes de continuar; de lo contrario, los siguientes pasos se eliminarán del grupo de administración.

6.	Desde el símbolo del shell de comandos, escriba `Get-SCOMManagementPack -name "*advisor*" | Remove-SCOMManagementPack`.

7.	Después, escriba `Get-SCOMManagementPack -name “*IntelligencePack*” | Remove-SCOMManagementPack`.

8.	Abra la consola de operaciones de Operations Manager con una cuenta que sea miembro del rol Administradores de Operations Manager.
9.	Bajo **Administración**, seleccione el nodo **Módulos de administración** y, en el cuadro **Buscar:**, escriba **Advisor** y compruebe que los siguientes módulos de administración todavía se importan en el grupo de administración:
...
>[AZURE.NOTE] El equipo desde el que se ejecute este script, si no es un servidor de administración, debe tener el shell de comandos de Operations Manager 2012 SP1 o R2 instalado según la versión del grupo de administración.
