<properties
    pageTitle="Optimización del entorno con la solución de Service Fabric en Log Analytics | Microsoft Azure"
...
- En Búsqueda de registros, utilice las siguientes consultas para profundizar en las métricas clave de los nodos:
    ...
    Obtenga más información sobre las métricas de rendimiento en Log Analytics [aquí]. (https://blogs.technet.microsoft.com/msoms/tag/metrics/)
...
>[AZURE.NOTE] Al seleccionar un grupo de recursos, si está trabajando con un área de trabajo de Log Analytics ya existente, seleccione Usar existente y busque el grupo de recursos que contiene el área de trabajo de OMS. En caso contrario, cree uno nuevo.
