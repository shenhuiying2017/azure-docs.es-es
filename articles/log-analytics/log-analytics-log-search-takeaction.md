...
# Realizar acciones con un runbook de Automation desde un resultado de búsqueda de registros de Log Analytics
...
## Componentes y características usados
...
## Para iniciar el runbook desde una búsqueda de registros
