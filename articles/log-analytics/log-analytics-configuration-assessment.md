---
title: Solución de evaluación de la configuración en Log Analytics | Microsoft Docs
...
---
# <a name="configuration-assessment-solution-in-log-analytics"></a>Solución de evaluación de la configuración de Log Analytics
...
> [!NOTE]
> A partir del 5 de julio de 2016, la solución de evaluación de la configuración ya no podrá agregarse a áreas de trabajo de Log Analytics y esta solución ya no estará disponible para los usuarios existentes después del 1 de agosto de 2016. Para los clientes que utilizan esta solución para SQL Server o Active Directory, se recomienda utilizar las soluciones [Evaluación de SQL Server](log-analytics-sql-assessment.md), [Evaluación de Active Directory](log-analytics-ad-assessment.md) y [Estado de replicación de Active Directory](log-analytics-ad-replication-status.md). Para los clientes que usan la evaluación de la configuración de Windows, Hyper-V y System Center Virtual Machine Manager, se recomienda usar las funcionalidades de recopilación de eventos y seguimiento de cambios para obtener una visión integral de los problemas en sus entornos.
> 
> 
...
### <a name="technologies-you-can-analyze-with-configuration-assessment"></a>Tecnologías que se pueden analizar con la evaluación de la configuración
...
## <a name="configuration-assessment-data-collection-details"></a>Detalles de la recopilación de datos para la evaluación de la configuración
La evaluación de la configuración recopila datos de configuración, metadatos y datos de estado con los agentes habilitados.
...
En la tabla siguiente se muestran ejemplos de tipos de datos recopilados por la evaluación de la configuración:
...
## <a name="configuration-assessment-alerts"></a>Alertas de evaluación de la configuración
...
> [!NOTE]
> Las alertas de evaluación de la configuración son diferentes de las otras alertas de Log Analytics. Para ver las alertas se requiere un complemento de Silverlight para su explorador.
> 
> 
...
> [!TIP]
> De forma predeterminada, el número máximo de alertas que se muestra es 2000. Para ver más alertas, haga clic en la barra de notificaciones encima de la lista de alertas.
> 
> 
...
## <a name="servers-and-workloads-analyzed"></a>Servidores y cargas de trabajo analizados
