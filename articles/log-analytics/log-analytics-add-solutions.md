...
| Estado de mantenimiento de los agentes                                                                              | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | Gratuito<br> Estándar<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(independiente)<br> Por&nbsp;nodo&nbsp;(OMS)   | Datos no sujetos al extremo de nivel Gratis<br> No disponible para agregar desde Azure Portal o Marketplace. |
...
| Backup                                                                                    | <ul><li>Insight and Analytics</li></ul>                                   | Gratuito<br> Estándar<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(independiente)<br> Por&nbsp;nodo&nbsp;(OMS)                                                                       | Requiere un almacén de Backup clásico.<br> No disponible para agregar desde Azure Portal o Marketplace. |
...
| [IT Service Management Connector](log-analytics-itsmc-overview.md)<br>(versión preliminar)                                               | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | Gratuito<br> Por&nbsp;nodo&nbsp;(OMS)     | |
...
| Logic Apps B2B                    | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | Gratuito<br> Estándar<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(independiente)<br> Por&nbsp;nodo&nbsp;(OMS)   | No disponible para agregar desde Azure Portal o Marketplace. |
...
| [Mapa de servicio](../operations-management-suite/operations-management-suite-service-map.md) <br>(versión preliminar)| <ul><li>Insight and Analytics</li></ul>                       | Gratuito<br> Por&nbsp;nodo&nbsp;(OMS)                                                                         | Disponible en Este y Centro de EE. UU. y Europa Occidental    |
| Site Recovery                                                                             | <ul><li>Insight and Analytics</li></ul>                                   | Gratuito<br> Estándar<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(independiente)<br> Por&nbsp;nodo&nbsp;(OMS)                                                                       | Requiere un almacén de Site Recovery clásico.<br> No disponible para agregar desde Azure Portal o Marketplace. |
...
| [Cumplimiento de actualizaciones](https://technet.microsoft.com/en-us/itpro/windows/manage/update-compliance-get-started) <br>(versión preliminar)                                                             | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | Gratuito<br> Estándar<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(independiente)<br> Por&nbsp;nodo&nbsp;(OMS)   | Sin cargos para datos ni nodos<br>Datos no sujetos al extremo de nivel Gratis.<br> No disponible para agregar desde Azure Portal o Marketplace. |
| [Preparación para la actualización](https://technet.microsoft.com/itpro/windows/deploy/manage-windows-upgrades-with-upgrade-readiness)                                                            | <ul><li>Insight&nbsp;and&nbsp;Analytics</li><li>Log Analytics</li></ul>   | Gratuito<br> Estándar<br> Premium&nbsp;(OMS)<br> Por&nbsp;GB&nbsp;(independiente)<br> Por&nbsp;nodo&nbsp;(OMS)   | Sin cargos para datos ni nodos<br>Datos no sujetos al extremo de nivel Gratis.<br> No disponible para agregar desde Azure Portal o Marketplace. |
...
| Wire Data 2.0<br>(versión preliminar)                                                                | <ul><li>Insight and Analytics</li></ul>                                   | Gratuito<br> Por&nbsp;nodo&nbsp;(OMS)                                                                         | Disponible en Este y Centro de EE. UU. y Europa Occidental |
...
| Administración de la capacidad |Windows |![Sí](./media/log-analytics-add-solutions/oms-bullet-green.png) |![Sí](./media/log-analytics-add-solutions/oms-bullet-green.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![Sí](./media/log-analytics-add-solutions/oms-bullet-green.png) |a la llegada |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Registros de actividad de Azure |Windows |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |según notificación |
| Registros de diagnóstico de Azure |Windows |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |según notificación |
| Métricas de diagnósticos de Azure |Windows |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |![No](./media/log-analytics-add-solutions/oms-bullet-red.png) |según notificación |
