...
3. Luego, configure la solución con la información necesaria y haga clic en **Guardar**. ![configurar solución](./media/log-analytics-add-solutions/configure.png)
...
## Características y soluciones de vista previa de Log Analytics
...
### ¿Qué hay que saber sobre las características y soluciones de vista previa?
...
#### Común a las vistas previas *públicas* y *privadas*
...
### ¿Cómo se puede obtener acceso a las características y soluciones de la vista previa privada?
...
- Puede registrarse basándose en detalles publicados en [msopsmgmt](https://twitter.com/msopsmgmt) en twitter. 
