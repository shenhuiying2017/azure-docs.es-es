<properties
    pageTitle="Uso de Blob Storage para IIS y Table Storage para eventos | Microsoft Azure"
...
>[AZURE.NOTE] El portal no valida la existencia del origen en la cuenta de almacenamiento o si se escriben nuevos datos.
