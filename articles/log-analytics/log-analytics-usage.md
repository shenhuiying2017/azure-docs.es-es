...
>[AZURE.NOTE] Si tiene una cuenta gratuita creada mediante el [sitio web de OMS](http://www.microsoft.com/oms), dispone de un límite diario de 500 MB de datos de envío al servicio de OMS. Si alcanza este límite diario, el análisis de los datos se detendrá y se reanudará al inicio del día siguiente. También deberá volver a enviar aquellos datos que OMS no haya aceptado o procesado.
