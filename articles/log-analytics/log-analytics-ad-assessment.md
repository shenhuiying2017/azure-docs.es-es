<properties
	pageTitle="Optimización del entorno con la solución de evaluación de Active Directory en Log Analytics | Microsoft Azure"
...
# Optimización del entorno con la solución de evaluación de Active Directory en Log Analytics
...
## Detalles de la recopilación de datos de la evaluación
...
**Seguridad y cumplimiento**. Esta área de enfoque muestra recomendaciones en caso de posibles amenazas e infracciones de seguridad, directivas corporativas y requisitos de cumplimiento técnico, legal y reglamentario.

**Disponibilidad y continuidad empresarial**. Esta área de enfoque muestra recomendaciones relacionadas con la disponibilidad de servicio, la resistencia de la infraestructura y la protección del negocio.

**Rendimiento y escalabilidad**. Esta área de enfoque muestra recomendaciones que ayudarán a crecer a la infraestructura de TI de su organización y garantizarán que el entorno de TI cumple con los actuales requisitos de rendimiento y que, además, puede responder a las cambiantes necesidades de infraestructura.

**Actualización, migración e implementación**. Esta área de enfoque muestra recomendaciones que le ayudarán a actualizar, migrar e implementar Active Directory en la infraestructura existente.
...
Antes de que pueda usar una solución de evaluación en OMS, debe tener instalada la solución. Para obtener más información sobre cómo instalar las soluciones, consulte [Add Log Analytics solutions from the Solutions Gallery](log-analytics-add-solutions.md) (Incorporación de soluciones de Log Analytics desde la galería de soluciones). Una vez instalada, puede ver el resumen de las recomendaciones mediante el icono Evaluación en el panel Información general de OMS.
...
3. En cualquiera de las páginas de área de enfoque, puede ver las recomendaciones priorizadas que se han efectuado para su entorno. Haga clic en una recomendación en **Objetos afectados** para ver los detalles sobre por qué se realiza la recomendación. ![imagen de las recomendaciones de evaluación](./media/log-analytics-ad-assessment/ad-focus.png)
4. Puede adoptar las medidas correctivas que se sugieren en **Acciones sugeridas**. Cuando se haya ocupado del asunto, las evaluaciones posteriores registrarán las acciones recomendadas que se han realizado y aumentará su calificación de cumplimiento normativo. Los asuntos que se hayan corregido aparecerán en **Objetos superados**.

## Omisión de las recomendaciones
...
### Para identificar las recomendaciones que omitirá
...
1.	Inicie sesión en su área de trabajo y abra Búsqueda de registros. Use la siguiente consulta para mostrar las recomendaciones para los equipos que presentan errores en el entorno.
    ...
    Esta es una captura de pantalla que muestra la consulta de Búsqueda de registros: ![recomendaciones con error](./media/log-analytics-ad-assessment/ad-failed-recommendations.png)
...
Después de que se ejecute la siguiente evaluación programada, de manera predeterminada cada 7 días, las recomendaciones especificadas se marcan como *Omitidas* y no aparecerán en el panel de evaluación.
...
## Preguntas más frecuentes sobre las soluciones de evaluación de AD
