...
**errores críticos de replicación** son aquellos que están en el 75 % de la [vigencia de objetos de desecho](https://technet.microsoft.com/library/cc784932%28v=ws.10%29.aspx) o por encima de esa cantidad para el bosque de Active Directory.
...
Además de identificar los errores de replicación que se han mantenido más allá de la duración de objetos de desecho, también deberá prestar atención a los errores de las categorías **50-75 % de la vigencia de objetos de desecho** o **75-100 % de la vigencia de objetos de desecho**.
