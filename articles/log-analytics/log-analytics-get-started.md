...
2. Expanda el nodo **Operational Insights** y seleccione **Conexión a Operational Insights**.
  ...
  >[AZURE.NOTE] En función del paquete acumulativo de actualizaciones de SCOM que se use, se puede ver un nodo para *System Center Advisor*, *Operational Insights* u *Operations Management Suite*.
