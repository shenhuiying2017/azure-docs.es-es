...
* Equipos Windows con Microsoft Monitoring Agent directamente conectado a un área de trabajo OMS
* Equipos Linux con el agente de OMS para Linux directamente conectado a un área de trabajo de OMS  
...
Para entender los requisitos y los pasos sobre cómo instalar el agente de OMS en equipos Windows conectados directamente a OMS, consulte [Conexión de equipos Windows a OMS](log-analytics-windows-agent.md) o para equipos Linux, consulte [Conexión de equipos Linux a OMS](log-analytics-linux-agents.md). 
...
* [Agregue orígenes de datos](log-analytics-data-sources.md) para recopilar datos de los orígenes conectados del área de trabajo de Log Analytics y almacenarlos en el repositorio de Log Analytics.
