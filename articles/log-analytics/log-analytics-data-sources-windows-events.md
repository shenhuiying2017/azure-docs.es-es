...
# Orígenes de datos de registros de eventos de Windows en Log Analytics
...
Configure los registros de eventos de Windows desde el [menú de datos en la configuración de Log Analytics](log-analytics-data-sources.md/configuring-data-sources).
...
| SourceSystem | El tipo de agente desde el que se recopiló el evento. <br> OpsManager. Agente de Windows, ya sea de conexión directa o SCOM <br> Linux. Todos los agentes de Linux <br> AzureStorage. Diagnósticos de Azure |
...
## Búsquedas de registros con eventos de Windows
