<properties
    pageTitle="Solución Monitor de rendimiento de red de OMS | Microsoft Azure"
...
>[AZURE.NOTE] Se trata de una [solución en versión preliminar](log-analytics-add-solutions.md#log-analytics-preview-solutions-and-features).
...
>[AZURE.NOTE] El script EnableRules.ps1 solo configura reglas del firewall de Windows en el equipo donde lo ejecute. Si tiene un firewall de red, debe asegurarse de que permite el tráfico destinado al puerto TCP que esté utilizando Monitor de rendimiento de red.
