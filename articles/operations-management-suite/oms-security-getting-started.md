<properties
   pageTitle="Introducción a la solución Seguridad y auditoría de Operations Management Suite | Microsoft Azure"
...
> [AZURE.NOTE] El agente recopilará la información en función de los eventos actuales que están habilitados; por ejemplo, el nombre del equipo, la dirección IP y el nombre de usuario. Sin embargo, no se recopila ningún documento, archivo, nombre de la base de datos ni datos privados.   
...
> [AZURE.NOTE] Para obtener más información sobre cómo OMS mantiene la seguridad de los datos, lea Cómo OMS protege los datos.
...
> [AZURE.NOTE] La conservación de los datos se realiza de acuerdo con el plan de precios de OMS. Para obtener más información, visite la página de precios de [Microsoft Operations Management Suite](https://www.microsoft.com/server-cloud/operations-management-suite/pricing.aspx) .
...
> [AZURE.NOTE] Para obtener más información sobre la consulta de búsqueda de OMS, consulte [Referencia de búsqueda de OMS](https://technet.microsoft.com/library/mt450427.aspx).
...
> [AZURE.NOTE] *rango* es una puntuación que se proporciona para reflejar el estado de la protección (activada, desactivada, actualizada, etc.) y las amenazas que se encuentran. Que este valor sea un número ayuda a realizar adiciones.
...
> [AZURE.NOTE] Para más información sobre la solución de actualizaciones, lea [Actualización de servidores con la solución de actualizaciones del sistema](https://technet.microsoft.com/library/mt484096.aspx).
...
> [AZURE.NOTE] Actualmente, los datos se basan solo en los datos de inicio de sesión de eventos de seguridad (id. de evento 4624) en los inicios de sesión futuros de Office365 y los datos de Azure AD también se incluirán.
...
Esta opción también puede utilizarse durante la investigación de una respuesta a incidentes para realizar la evaluación y obtener información sobre el ataque.

> [AZURE.NOTE] Para más información acerca de cómo usar OMS para una respuesta a incidentes, consulte [How to Leverage the Azure Security Center & Microsoft Operations Management Suite for an Incident Response](https://channel9.msdn.com/Blogs/Taste-of-Premier/ToP1703) (Cómo aprovechar Azure Security Center y Microsoft Operations Management Suite para una respuesta a incidentes).
