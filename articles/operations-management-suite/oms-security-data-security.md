<properties
   pageTitle="Seguridad de datos de la solución Seguridad y auditoría de Operations Management Suite | Microsoft Azure"
...
> [AZURE.NOTE] La ubicación de los datos se configura en el nivel del área de trabajo de OMS, durante la creación del área de trabajo, que forma parte del proceso de configuración inicial de Seguridad y auditoría de OMS.
