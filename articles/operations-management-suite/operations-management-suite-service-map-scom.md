...
Con esta versión preliminar de integración entre Service Map y System Center Operations Manager (SCOM), puede crear automáticamente diagramas de aplicaciones distribuidas en SCOM basados en mapas de dependencia dinámica de Service Map.
...
4.    Una entidad de servicio con acceso a la suscripción de Azure asociada al área de trabajo de OMS.  Consulte el anexo para más información sobre las entidades de servicio.
...
3. El primer paso en el asistente es la configuración de la conexión para configurar un nombre de entidad de servicio. Escriba el Id. de inquilino, el Id. de aplicación (o el nombre de usuario o ClientID) y la contraseña de la entidad de servicio.  Consulte el anexo sobre cómo crear a una entidad de servicio.
...
Se crea una regla **_Microsoft.SystemCenter.ServiceMap.Import.Rule**_ para capturar información de Service Map periódicamente.  Los usuarios pueden configurar invalidaciones de esta regla para cambiar los intervalos de sincronización.
