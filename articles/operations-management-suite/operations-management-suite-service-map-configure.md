...
|:--|:--|:--|
| 0 x 17 | El instalador de la biblioteca requiere una actualización de Windows que no se ha instalado. | Mire en el registro del instalador de la biblioteca más reciente (consulte más arriba).<br><br>Si una línea "Error 0x80240017: Failed to execute MSU package" (Error 0x80240017: No se pudo ejecutar el paquete MSU) sigue una referencia a "Windows8.1-KB2999226-x64.msu", consulte el artículo de Knowledge Base https://support.microsoft.com/kb/2919355.<br><br>Ejecute de nuevo el instalador de Agente de dependencia de Microsoft. |
