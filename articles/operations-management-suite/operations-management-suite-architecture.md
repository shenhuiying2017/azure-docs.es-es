<properties 
   pageTitle="Arquitectura de Operations Management Suite (OMS) | Microsoft Azure"
...
- Obtenga información sobre [Automatización de Azure](https://azure.microsoft.com/documentation/services/automation).
