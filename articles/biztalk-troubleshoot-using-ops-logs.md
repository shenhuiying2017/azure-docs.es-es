...
<p>Esta caracter&iacute;stica &uacute;nicamente captura registros para las operaciones de administraci&oacute;n en los Servicios BizTalk, por ejemplo, cu&aacute;ndo se inici&oacute; el servicio o cu&aacute;ndo se hizo la copia de seguridad, entre otros. Se realiza el seguimiento de dichas operaciones con independencia de si se llevan a cabo en el Portal de administraci&oacute;n de Azure o mediante las <a href="http://msdn.microsoft.com/es-es/library/windowsazure/dn232347.aspx">APIS de REST de los Servicios BizTalk</a>. Para obtener una lista completa de las operaciones que se siguen mediante los Servicios de administraci&oacute;n, consulte <a href="#bizops">Seguimiento de operaciones mediante los Servicios de administraci&oacute;n de Azure</a>.</p>
<p>No captura los registros de actividades relacionadas con el tiempo de ejecuci&oacute;n de los Servicios BizTalk (como mensajes procesados por puentes, etc.). Para consultar estos registros, debe utilizar la vista de seguimiento desde el portal de Servicios BizTalk. Para obtener m&aacute;s informaci&oacute;n, consulte <a HREF="http://msdn.microsoft.com/library/windowsazure/hh949805.aspx">Mensajes de seguimiento</a>.</p>
</div>
...
-   [Copia de seguridad del servicio de BizTalk][]
-   [Restauración del servicio de BizTalk a partir de una copia de seguridad][]
...
-   [¿Cómo puedo comenzar a utilizar el SDK de Servicios de BizTalk de Azure?][]
  ...
  [APIS de REST de los Servicios BizTalk]: http://msdn.microsoft.com/es-es/library/windowsazure/dn232347.aspx
  [Seguimiento de operaciones mediante los Servicios de administración de Azure]: #bizops
  [Mensajes de seguimiento]: http://msdn.microsoft.com/library/windowsazure/hh949805.aspx
  [Ver registros de operaciones]: ./media/biztalk-troubleshoot-using-ops-logs/Operation-Logs.png
