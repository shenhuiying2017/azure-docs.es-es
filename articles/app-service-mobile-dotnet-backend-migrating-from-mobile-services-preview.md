...
El primer paso en la migración es crear el Servicio de aplicaciones que hospedará la nueva versión de la aplicación. Puede crear una nueva Aplicación móvil en el [Portal de administración de Azure]. Puede consultar el tema [Creación de una aplicación móvil] para obtener más detalles.
...
[SDK del servidor de aplicaciones móviles]: http://www.nuget.org/packages/microsoft.azure.mobile.server
...
[Trabajo web]: websites-webjobs-resources.md
