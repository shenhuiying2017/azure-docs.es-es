...
<p>En este tutorial se muestra cómo agregar un servicio back-end basado en la nube a una aplicación Android mediante los Servicios móviles de Azure. En este tutorial creará tanto un servicio móvil nuevo como una aplicación sencilla de <em>To do list (Lista de pendientes)</em> que almacena datos de la aplicación en el nuevo servicio móvil.</p>
...
3. Haga clic en **Browse** (Examinar), vaya a la ubicación de los archivos de proyecto expandidos, haga clic en **OK** (Aceptar), asegúrese de que el proyecto TodoActivity esté marcado y luego haga clic en **Finish ** (Finalizar). 
...
5. En la aplicación, escriba texto significativo, como _Complete the tutorial_ y luego haga clic en **Agregar**.
