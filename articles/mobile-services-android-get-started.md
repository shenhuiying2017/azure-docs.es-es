...
Para completar este tutorial se requiere la [Herramientas para desarrolladores de Android][Android Studio], que incluye el entorno de desarrollo integrado de Android Studio y la última plataforma de Android. Se requiere Android 4.2 o versiones posteriores. 
...
> [AZURE.NOTE] Si desea ver el código fuente de la aplicación final, vaya <a href="https://github.com/RickSaling/mobile-services-samples/tree/androidStudio/GettingStarted/AndroidStudio" target="_blank">aquí</a>.
...
<!-- URLs. -->
[Introducción (Eclipse)]: /documentation/articles/mobile-services-android-get-started-EC/
