...
1. En el [portal de Azure](https://portal.azure.com/), inicie sesión con su cuenta de trabajo. Por ejemplo, inicie sesión con *suNombreDeUsuario*@**.com. Al hacerlo, automáticamente inicia sesión en la suscripción de su empresa. 
