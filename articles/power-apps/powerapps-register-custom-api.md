---
title: Cómo usar API personalizadas en flujos de lógica y PowerApps | Microsoft Docs
...
> [!IMPORTANT]
> Este tema se ha movido a powerapps.microsoft.com en [What are custom APIs](https://powerapps.microsoft.com/tutorials/register-custom-api/) (Qué son las API personalizadas). Vaya a PowerApps para ver la versión más reciente. Este vínculo de Azure está en proceso de archivo.
> 
> 
...
> [!NOTE]
> Próximamente se admitirá la autenticación de clave de API.
> 
> 
...
> [!TIP]
> En los archivos .json no puede agregar comentarios. Todo el texto se considera parte de los datos.
> 
> 
...
1. Vaya al [portal web][9] de PowerApps e inicie sesión con su cuenta profesional.
   ...
   > [!NOTE]
   > Actualmente, las API personalizadas solo se pueden usar en el portal web de PowerApps. No se pueden usar en el cliente de PowerApps.
   > 
   > 
...
> [!TIP]
> Si no se puede validar el archivo de Swagger, podrían sobrar caracteres. Por ejemplo, prácticamente todos los datos deben ir entre comillas, incluidos los sitios web. Si `https://mywebapi.mywebsite.com` no aparece entre comillas, el archivo no se puede validar.
> 
> 
...
> [!NOTE]
> Únicamente puede compartir API personalizadas con otros usuarios de su organización.
> 
> 
