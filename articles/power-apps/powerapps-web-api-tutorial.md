---
title: 'Tutorial: creación de una API web de AAD personalizada para PowerApps y flujos de lógica | Microsoft Docs'
...
> [!IMPORTANT]
> Este tema se ha movido a powerapps.microsoft.com en [Tutorial: Create a custom AAD protected Web API for PowerApps and Flows](https://powerapps.microsoft.com/tutorials/customapi-web-api-tutorial/) (Tutorial: Creación de una API web personalizada protegida de AAD para PowerApps y flujos). Vaya a PowerApps para ver la versión más reciente. Este vínculo de Azure está en proceso de archivo.
> 
> 
...
1. Abra Visual Studio y cree una nueva aplicación web ASP.NET en C#: ![](./media/powerapps-web-api-tutorial/newwebapp.png "Nueva aplicación web")
2. En la siguiente pantalla, seleccione la plantilla de API web y, después, **Sin autenticación**: ![](./media/powerapps-web-api-tutorial/noauth.png "Sin autorización")
   ...
   > [!IMPORTANT]
   > Recuerde establecer la autenticación en "Sin autenticación".
   > 
   > 
...
4. Ahora, genere un archivo de Swagger para la API web. Puede hacerlo fácilmente si abre la **Consola del Administrador de paquetes** e instala **Swashbuckle**: ![](./media/powerapps-web-api-tutorial/swashbuckle-console.png "Consola de Swashbuckle")
...
7. Extraiga el JSON de Swagger yendo a ***https://\<url-aplicación-web-azure>/swagger/docs/v1***.
   ...
   > [!IMPORTANT]
   > Los documentos de Swagger con valores operationId duplicados no son válidos. Si utiliza la plantilla de C# de ejemplo, el operationId "Values\_Get" se repite dos veces. Cambie una instancia a "Value\_Get".
   > 
   > 
...
En este tutorial se da por hecho que sabe cómo crear aplicaciones de AAD en Azure. Para más información sobre cómo crear una aplicación de AAD, consulte el [tutorial de Azure Resource Manager](powerapps-azure-resource-manager-tutorial.md). Se necesitan dos aplicaciones de AAD para este tutorial.
...
3. Para **webAPI**, use la siguiente configuración:
   ...
   3. URL de respuesta: ***https://\<su-url-raíz>/.auth/login/aad/callback***
      ...
      > [!IMPORTANT]
      > Necesitará el id. de cliente de esta aplicación más adelante, así que anótelo.
      > 
      > 
...
4. Configure la autenticación de AAD para su API personalizada:
   ...
   3. URL de inicio de sesión: ***https://login.windows.net***
   4. URI del recurso: ***el id. de cliente de webAPI*** del punto 3.4 del **paso 2** (de este tema)
5. Seleccione **Crear** e intente crear una conexión en la API personalizada. Si todo está configurado correctamente, debe poder iniciar sesión sin problemas.
...
Si tiene alguna pregunta o comentario, envíe un correo electrónico a [customapishelp@microsoft.com](mailto:customapishelp@microsoft.com).
