...
<h2 id="download">Descarga de la aplicación de ejemplo</h2>
...
<h3>Creación de una nueva aplicación de AD para este servicio</h3>
...
<h3>Configuración de la aplicación de AD</h3>
...
11. Desplácese hacia abajo hasta los permisos y seleccione la **API de administración de Microsoft Azure**. En este paso, especifique la API (en este caso, la API del Administrador de recursos de Azure) a la que la aplicación cliente necesita tener acceso, junto con el nivel de acceso que necesita.
...
<h3>Carga del programa de aplicación de ejemplo con valores de registro y suscripción</h3>
...
Si no ha [descargado la aplicación de ejemplo de Codeplex](linkTBD), la necesitará en este paso.

1. Abra **ManagementAPI.sln** en Visual Studio.

2. Abra Program.cs.

3. Proporcione el valor de 'ClientId'. Desde la página de configuración de la aplicación de AD que dejó abierta en el paso anterior, copie el identificador de cliente de la página de configuración de la aplicación de AD en el portal y péguelo en Program.cs.

4. Proporcione el valor de 'RedirectUrl'. Copie el URI de redirección de la misma página del portal y péguelo en Program.cs.

	![][9]

5. Proporcione el valor de 'TenantID'. 
...
6. Proporcione un valor de `SubscriptionID`.
...
<h3>Resolución de errores de compilación</h3>
...
<h2 id="explore">Exploración de la aplicación</h2>
...
[Exploración de la aplicación]: #explore
