<properties urlDisplayName="Visual Studio 14 CTP" pageTitle="Instalación de Azure SDK 2.4 para CTP2 de Visual Studio 14" metaKeywords="Visual Studio, Azure SDK" description="Install Azure SDK 2.4 and Visual Studio 14 CTP2" metaCanonical="" services="" documentationCenter="" title="Installing Azure SDK 2.4 for Visual Studio 14 CTP" authors="ghogen" solutions="" manager="douge" editor="" />
