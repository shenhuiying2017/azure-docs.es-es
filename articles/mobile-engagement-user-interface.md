...
Una vez que se ha integrado el [SDK] de Azure Mobile Engagement[Link 5] en la aplicación y comprende los [conceptos] básicos de Azure Mobile Engagement[Link 6], hay dos formas de interactuar con Azure Mobile Engagement para la aplicación: los usuarios estándar pueden usar la [interfaz de usuario][Link 1] y los usuarios programadores pueden utilizar [API] basadas en HTTP REST[Link 4]. Para obtener un tutorial de las actividades comunes, consulte las [Guías de procedimientos][Link 3]. Si tiene alguna dificultad, consulte las [Guías de solución de problemas] de Azure Mobile Engagement[Link 2].
