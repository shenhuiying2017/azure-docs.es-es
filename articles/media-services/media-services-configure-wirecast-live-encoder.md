---
title: Uso del codificador Telestream Wirecast para enviar una transmisión en vivo con velocidad de bits única
...
1. Haga clic en **Crear canal**. ![wirecast](./media/media-services-wirecast-live-encoder/media-services-wirecast2.png)
...
2. En la pantalla principal de **Wirecast**, confirme que los orígenes de audio y vídeo están listos y, luego, haga clic en **Stream** (Transmitir) en la esquina superior izquierda.
