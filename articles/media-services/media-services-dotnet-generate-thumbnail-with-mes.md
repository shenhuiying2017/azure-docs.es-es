<properties 
	pageTitle="Cómo generar vistas en miniatura mediante el Codificador multimedia estándar con .NET" 
...
#Cómo generar vistas en miniatura mediante el Codificador multimedia estándar con .NET
