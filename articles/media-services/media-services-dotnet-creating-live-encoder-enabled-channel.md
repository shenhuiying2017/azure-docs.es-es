...
El ejemplo que se describe en este tema se puede descargar [aquí](https://azure.microsoft.com/documentation/samples/media-services-dotnet-encode-live-stream-with-ams-clear/).
