...
<!-- __ -->
### <a name="a-idoutputfilesaoutput-files"></a><a id="output_files"></a>Archivos de salida
...
### <a name="a-idpreseta-task-preset-for-azure-media-indexer"></a><a id="preset"></a> Valores predefinidos de tarea para Azure Media Indexer
...
### <a name="a-iderrorcodesaerror-codes"></a><a id="error_codes"></a>Códigos de error
...
## <a name="a-idsupportedlanguagesasupported-languages"></a><a id="supported_languages"></a>Idiomas admitidos
