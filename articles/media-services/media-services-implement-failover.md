<properties 
	pageTitle="Implementación de un escenario de streaming de conmutación por error | Microsoft Azure" 
...
Este tutorial muestra cómo copiar contenido (blobs) de un recurso a otro con el fin de controlar la redundancia de streaming a petición. Este escenario es útil para aquellos clientes que desean configurar su red CDN para la conmutación por error entre dos centros de datos en caso de una interrupción en uno de nuestros centros de datos. Este tutorial usa el SDK de Servicios multimedia de Microsoft Azure, la API de REST de Servicios multimedia de Microsoft Azure y el SDK de Almacenamiento de Azure para demostrar las siguientes tareas.
...
>[AZURE.NOTE]Considere el uso de la [herramienta de duplicación](http://replicator.codeplex.com/) de Servicios multimedia como alternativa a la implementación manual de un escenario de streaming de conmutación por error. Esta herramienta permite replicar los recursos entre dos cuentas de Servicios multimedia.
...
##Adición de código que controle la redundancia del streaming a petición.
...
1. Reemplace la definición predeterminada del método Main por el código siguiente:
...
1. A continuación se llama a las definiciones de método desde Main.
		                                        ...
		                                        bool autoRedirect = true)
		{
		    ...
		    if (startTime != DateTime.MinValue)
		        sb.Append(", "StartTime" : "" + startTime.ToString("G", CultureInfo.CreateSpecificCulture("es-ES")) + """);
