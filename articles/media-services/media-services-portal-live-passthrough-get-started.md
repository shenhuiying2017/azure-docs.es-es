---
title: "Realización de streaming en vivo con codificadores locales mediante Azure Portal | Microsoft Docs"
...
---
# <a name="how-to-perform-live-streaming-with-onpremise-encoders-using-the-azure-portal"></a>Realización de streaming en vivo con codificadores locales mediante el Portal de Azure
...
> [!IMPORTANT]
> Revise [Streaming en directo con codificadores locales que crean secuencias de velocidad de bits múltiple](media-services-live-streaming-with-onprem-encoders.md) para obtener información acerca de los conceptos y las consideraciones relacionadas con el streaming en vivo con codificadores locales y canales de paso a través.
> 
> 
...
## <a name="create-and-start-passthrough-channels-and-events"></a>Creación e inicio de canales de paso a través y eventos
