---
title: Realización de streaming en vivo con codificadores locales mediante el Portal de Azure | Microsoft Docs
...
2. Haga clic en **Creación rápida** para crear un canal de paso a través con el protocolo de introducción RTMP.
   
    Aparece la ventana **CREAR UN NUEVO CANAL**.
3. Asigne un nombre al nuevo canal y haga clic en **Crear**.
