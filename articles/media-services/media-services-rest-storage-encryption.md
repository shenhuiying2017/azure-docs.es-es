...
3. Cifre la clave de contenido con la clave pública del certificado X.509. 
   ...
   El SDK de Media Services para .NET usa RSA con OAEP al realizar el cifrado.  Puede ver un ejemplo de .NET en la [función EncryptSymmetricKeyData](https://github.com/Azure/azure-sdk-for-media-services/blob/dev/src/net/Client/Common/Common.FileEncryption/EncryptionUtils.cs).
