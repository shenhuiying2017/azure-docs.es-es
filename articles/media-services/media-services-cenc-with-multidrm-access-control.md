...
1. Crear un reproductor mediante la [API del Reproductor multimedia de Azure](http://amp.azure.net/libs/amp/latest/docs/). [API ProtectionInfo del Reproductor multimedia de Azure](http://amp.azure.net/libs/amp/latest/docs/) le permite especificar la tecnología DRM que se usará en distintas plataformas DRM.
1. Matriz de pruebas:
