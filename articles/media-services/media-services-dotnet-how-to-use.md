...
2. Use **NuGet** para instalar y agregar **Extensiones del SDK de Azure Media Services para .NET**. Al instalar este paquete, también se instala el **SDK de Servicios multimedia para .NET** y agrega todas las demás dependencias necesarias.
...
3. Presione Aceptar.
4. Abra el archivo App.config (agregue el archivo al proyecto si no se ha agregado de forma predeterminada) y agregue una sección *appSettings* al archivo.     
