...
## <a name="loading-static-asset-library"></a>Carga de la biblioteca de activos estáticos
...
## <a name="loading-dynamic-asset-library"></a>Carga de la biblioteca de activos dinámicos
