...
---
#  <a name="use-azure-media-standard-to-auto-generate-a-bitrate-ladder"></a>Uso de Azure Media Standard para generar automáticamente una escalera de velocidad de bits
