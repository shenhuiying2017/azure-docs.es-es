...
Para ver las actualizaciones más recientes de Azure Media Hyperlapse, consulte los [blogs de Servicios multimedia](http://azure.microsoft.com/blog/topics/media-services/).
