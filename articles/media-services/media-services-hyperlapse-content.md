...
Para ver las actualizaciones más recientes de Azure Media Hyperlapse, consulte los [blogs de Media Services](https://azure.microsoft.com/blog/topics/media-services/).
