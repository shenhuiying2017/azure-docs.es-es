<properties 
	pageTitle="Uso del almacenamiento en cola de Azure para supervisar las notificaciones sobre trabajos de Servicios multimedia | Microsoft Azure" 
...
Servicios multimedia de Microsoft Azure tiene la capacidad de entregar mensajes de notificación al [almacenamiento en cola de Azure](../storage-dotnet-how-to-use-queues.md#what-is) cuando se procesar trabajos multimedia. En este tema se muestra cómo obtener estos mensajes de notificación del almacenamiento en cola.
