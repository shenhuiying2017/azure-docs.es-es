...
> [!NOTE]
> La configuración de **SceneChangeDetection** del siguiente valor preestablecido solo se puede establecer en true si va a codificar en vídeo con una única velocidad de bits. Si va a codificar un vídeo con velocidades de bits múltiple y establece **SceneChangeDetection** en true, el codificador devolverá un error.
> 
> 
