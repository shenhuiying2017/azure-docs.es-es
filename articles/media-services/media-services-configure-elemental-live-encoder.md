...
1. Especifique un nombre de canal (el campo de descripción es opcional). En Configuración de canal, seleccione **Estándar** para la opción de codificación en directo, con el protocolo de entrada establecido en **RTP (MPEG-TS)**. Puede dejar todas las demás opciones como están.

Asegúrese de que la opción **Iniciar el nuevo canal ahora** esté seleccionada.

1. Haga clic en **Crear canal**. ![Elemental](./media/media-services-elemental-live-encoder/media-services-elemental12.png)
...
3. Haga clic en **Crear** (si se creó un nuevo evento) o en **Actualizar** (si está modificando un evento ya existente) e inicie el codificador.

> [!IMPORTANT]
> Antes de hacer clic en **Iniciar** en la interfaz web de Elemental Live, **debe** asegurarse de que el canal está listo. Además, asegúrese de no dejar el canal en un estado Listo sin un evento durante más de 15 minutos.
> 
> 
