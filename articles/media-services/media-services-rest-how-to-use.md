---
title: Información general de la API de REST de Servicios multimedia | Microsoft Docs
...
## <a name="discovering-media-services-model"></a>Detección del modelo de Servicios multimedia
