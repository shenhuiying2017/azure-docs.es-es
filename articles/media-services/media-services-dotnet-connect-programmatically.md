---
title: Conexión con la cuenta de Servicios multimedia mediante .NET
...
---
# <a name="connecting-to-media-services-account-using-media-services-sdk-for-.net"></a>Conexión con la cuenta de Servicios multimedia con el SDK de Servicios multimedia para .NET.
...
## <a name="connecting-to-media-services"></a>Conexión con los Servicios multimedia
...
> [!NOTE]
> La clase **CloudMediaContext** no es segura para subprocesos. Debe crear un nuevo elemento CloudMediaContext por subproceso o por conjunto de operaciones.
> 
> 
...
## <a name="connecting-to-a-media-services-account-located-in-the-north-china-region"></a>Conexión con una cuenta de Servicios multimedia ubicada en la región Norte de China
