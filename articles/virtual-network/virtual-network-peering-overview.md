...
* Para establecer el emparejamiento entre redes virtuales en el modelo de implementación clásica y el modelo de Azure Resource Manager es necesario que las redes virtuales estén en la misma suscripción.
