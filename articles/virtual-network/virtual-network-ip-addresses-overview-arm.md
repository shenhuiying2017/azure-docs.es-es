---
title: Direcciones IP públicas y privadas en el Administrador de recursos de Azure | Microsoft Docs
...
[modelo de implementación clásica](virtual-network-ip-addresses-overview-classic.md).
