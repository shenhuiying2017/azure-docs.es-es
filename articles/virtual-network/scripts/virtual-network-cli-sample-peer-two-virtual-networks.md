...
Este script crea y conecta dos redes virtuales de la misma región a través de la red de Azure. Después de ejecutar el script, tendrá un emparejamiento entre dos redes virtuales.
