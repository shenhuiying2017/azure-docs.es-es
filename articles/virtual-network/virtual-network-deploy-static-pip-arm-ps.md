---
title: "Creación de una VM con una dirección IP pública estática mediante PowerShell | Microsoft Docs"
description: "Aprenda a crear una VM con una dirección IP pública estática con Azure Resource Manager mediante PowerShell."
...
---
# <a name="create-a-vm-with-a-static-public-ip-using-powershell"></a>Creación de una VM con una dirección IP pública estática mediante PowerShell
