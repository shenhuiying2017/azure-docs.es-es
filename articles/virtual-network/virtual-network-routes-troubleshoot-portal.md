<properties 
   pageTitle="Solución de problemas de rutas - Portal | Microsoft Azure"
...
# Solución de problemas de rutas mediante Azure Portal
...
## Uso de rutas eficaces para solucionar problemas de flujo de tráfico de máquinas virtuales
...
En este artículo se explica cómo determinar la causa del error de conexión, utilizando la funcionalidad de rutas eficaces en el modelo de implementación de Azure Resource Management. Aunque este ejemplo utiliza solo rutas de sistema, los pasos siguientes pueden utilizarse para determinar errores de conexión entrante y saliente a través de cualquier tipo de puerto.

>[AZURE.NOTE] Si la máquina virtual tiene más de una NIC conectada, compruebe las rutas eficaces para cada una de las NIC con el fin de diagnosticar problemas de conectividad de red, tanto de entrada como de salida, de una máquina virtual.

### Visualización de las rutas eficaces para una máquina virtual
...
6. Aparece la hoja **Effective routes** (Rutas eficaces), como se muestra en la siguiente imagen:
	...
	>[AZURE.NOTE] Si la máquina virtual asociada con la NIC no está en estado de ejecución, no se mostrará ninguna ruta eficaz. Solo las primeras 200 rutas eficaces se muestran en el portal. Para obtener la lista completa, haga clic en **Descargar**. Puede filtrar aún más los resultados en el archivo .csv descargado.
...
### Visualización de las rutas eficaces para una interfaz de red
...
1. Inicie sesión en Azure Portal en https://portal.azure.com.
2. Haga clic en **More services** (Más servicios), a continuación, haga clic en **Interfaces de red**
...
4. Seleccione **Effective routes** (rutas eficaces) en la hoja **Interfaz de red**, como se muestra en la siguiente imagen:
...
### Visualización de las rutas eficaces para una tabla de rutas
...
1. Inicie sesión en Azure Portal en https://portal.azure.com.
2. Haga clic en **More services** (Más servicios), a continuación, haga clic en **Tablas de rutas**
...
4. Seleccione **Effective Routes** (rutas eficaces) en la hoja **Tabla de rutas**. El **Ámbito** se establece en la tabla de rutas seleccionada.
...
6. Seleccione una **Interfaz de red**. Se muestran todas las NIC conectadas a la subred seleccionada. En este ejemplo está seleccionada **VM1-NIC1**.
	...
	>[AZURE.NOTE] Si la NIC no está asociada a una máquina virtual en ejecución, no se muestra ninguna ruta eficaz.
...
- Si está habilitada la tunelización forzada, todo el tráfico saliente de Internet se enrutará a la red local. Una conexión RDP o SSH desde Internet a su máquina virtual puede no funcionar con esta configuración, dependiendo de cómo la red local controle este tráfico. Puede habilitar la tunelización forzada:
