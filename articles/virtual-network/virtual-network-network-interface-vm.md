...
Si tiene que agregar, cambiar o quitar direcciones IP para una interfaz de red, lea el artículo [Add, change, or remove IP addresses (Adición, cambio o eliminación de direcciones IP)](virtual-network-network-interface-addresses.md). Si necesita crear, cambiar o eliminar interfaces de red, lea el artículo [Manage network interfaces (Administración de interfaces de red)](virtual-network-network-interface.md).
...
|Pasos detallados para [agregar un adaptador de red a una máquina virtual](../virtual-machines/windows/multiple-nics.md#add-a-nic-to-an-existing-vm)|
...
4. En la hoja sección **CONFIGURACIÓN** de la hoja de la máquina virtual seleccionada que aparece, haga clic en **Interfaces de red**. Para más información sobre la configuración de la interfaz de red y sobre cómo cambiarla, lea el artículo [Manage network interfaces (Administración de interfaces de red)](virtual-network-network-interface.md). Para más información sobre la incorporación, el cambio o la eliminación de direcciones IP asignadas a una interfaz de red, lea el artículo [Add, change, or remove IP addresses (Adición, cambio o eliminación de direcciones IP)](virtual-network-network-interface-addresses.md).
...
|Pasos detallados para [quitar un adaptador de red de una máquina virtual](../virtual-machines/windows/multiple-nics.md#remove-a-nic-from-an-existing-vm)|
