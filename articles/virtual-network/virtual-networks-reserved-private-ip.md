---
title: "Establecimiento de una dirección IP privada interna estática"
...
> [!NOTE]
> Si desea probar el comando anterior en un entorno seguro, siga las instrucciones de [Creación de una red virtual](virtual-networks-create-vnet-classic-portal.md) para crear una máquina virtual denominada *TestVnet* y asegurarse de que utiliza el espacio de direcciones *10.0.0.0/8*.
> 
> 
