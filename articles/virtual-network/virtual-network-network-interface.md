...
|**PowerShell**|[Get-AzureRmNetworkInterface](/powershell/module/azurerm.network/get-azurermnetworkinterface) para ver las NIC de la suscripción o la configuración de una NIC|
