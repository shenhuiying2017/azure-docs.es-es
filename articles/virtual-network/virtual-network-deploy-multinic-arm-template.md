---
title: Crear una VM con varias NIC mediante una plantilla | Microsoft Docs
description: "Crear una VM con varias NIC con una plantilla a través de Azure Resource Manager."
...
Para implementar la plantilla que ha descargado con PowerShell, instale y configure PowerShell completando los pasos del artículo [Install and configure PowerShell (Instalar y configurar PowerShell)](../powershell-install-configure.md) y, después, siga los siguientes pasos:
