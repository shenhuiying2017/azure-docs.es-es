---
title: Implementación de varias máquinas virtuales de NIC con una plantilla en el Administrador de recursos | Microsoft Docs
...
1. Ejecute el cmdlet **`New-AzureRmResourceGroup`** para crear un grupo de recursos con esta plantilla.
