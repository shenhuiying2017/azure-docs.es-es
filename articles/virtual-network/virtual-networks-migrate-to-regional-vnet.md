...
## <a name="creating-and-migrating-to-regional-vnets"></a>Creación y migración a redes virtuales regionales
...
### <a name="about-vnets-currently-associated-with-affinity-groups"></a>Información acerca de redes virtuales asociadas actualmente a grupos de afinidad
...
2. Edite el archivo de configuración de red y reemplace los valores anteriores por los nuevos valores. 
   
   > [!NOTE]
   > La **ubicación** es la región que especificó para el grupo de afinidad que está asociado a la red virtual. Por ejemplo, si la red virtual está asociada a un grupo de afinidad que se encuentra en Oeste de EE. UU., al migrar, la ubicación debe apuntar a Oeste de EE. UU. 
   > 
   > 
...
3. Guarde los cambios e [importe](virtual-networks-using-network-configuration-file.md) la configuración de red en Azure.
