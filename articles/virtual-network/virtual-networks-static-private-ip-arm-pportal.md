<properties 
   pageTitle="Establecimiento de una IP privada estática en el modo ARM con el Portal de vista previa | Microsoft Azure"
   description="Descripción de las IP privadas (DIP) y su administración en el modo ARM con el Portal de vista previa"
...
No se puede establecer una dirección IP privada estática durante la creación de una VM en el modo de implementación del Administrador de recursos mediante el Portal de vista previa. En primer lugar debe crear la VM, tehn establece la IP privada como estática.
...
2. Haga clic en **NUEVO** > **Proceso** > **Windows Server 2012 R2 Datacenter**. Tenga en cuenta que la lista **Seleccionar un modelo de implementación** ya muestra **Administrador de recursos** y, a continuación, haga clic en **Crear**, como se muestra en la figura siguiente.
	...
	![Creación de la VM en el Portal de vista previa](./media/virtual-networks-static-ip-arm-pportal/figure01.png)
...
7. En la hoja **Resumen**, haga clic en **Aceptar**. Observe el icono siguiente que aparece en el panel.
	...
	![Creación de la VM en el Portal de vista previa](./media/virtual-networks-static-ip-arm-pportal/figure06.png)
...
1. En el Portal de vista previa de Azure, haga clic en **EXAMINAR TODO** > **Máquinas virtuales** > **DNS01** > **Toda la configuración** > **Interfaces de red** y, a continuación, haga clic en la única interfaz de red que aparece.
...
2. Escriba *192.168.1.101* en **Dirección IP** y, a continuación, haga clic en **Guardar**.
	...
	![Creación de la VM en el Portal de vista previa](./media/virtual-networks-static-ip-arm-pportal/figure09.png)
