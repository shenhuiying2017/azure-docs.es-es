---
title: Establecimiento de una IP privada estática en el modo ARM con el Portal de Azure | Microsoft Docs
...
> [!NOTE]
> Si después de hacer clic en **Guardar** se da cuenta de que la asignación sigue establecida en **Dinámica**, significa que la dirección IP que escribió sigue estando en uso. Pruebe una dirección IP distinta.
> 
> 
