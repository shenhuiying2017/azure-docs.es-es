...
## <a name="about-peering"></a>Requisitos y restricciones 
...
6. Cambie los valores pertinentes. Obtenga información sobre las opciones de cada valor en el [paso 6](#add-peering) de la sección Crear un emparejamiento de este artículo. 
    ...
    >[!NOTE]
    >Es necesario tener en cuenta varios requisitos, restricciones y consideraciones para crear correctamente un emparejamiento. Antes de crear un emparejamiento, asegúrese de conocer la lista de consideraciones de la sección [Requisitos y restricciones](#about-peering) de este artículo.
    >
