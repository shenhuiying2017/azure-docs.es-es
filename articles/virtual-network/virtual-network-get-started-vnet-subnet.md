---
title: "Creación de su primera instancia de Azure Virtual Network | Microsoft Docs"
description: "Aprenda a crear una instancia de Azure Virtual Network, a conectar dos máquinas virtuales a la red virtual y a conectarse a las máquinas virtuales."
...
1. En [Azure Portal](https://portal.azure.com), haga clic en **Crear un recurso** > **Proceso** > **Windows Server 2016 Datacenter**.
...
1. En [Azure Portal](https://portal.azure.com), haga clic en **Todos los servicios**.
2. Escriba *Grupos de recursos* en el cuadro con la palabra *Filtro*. Haga clic en **Grupos de recursos** cuando lo vea en la lista filtrada.
