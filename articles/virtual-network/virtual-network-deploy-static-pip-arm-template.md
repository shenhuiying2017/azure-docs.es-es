---
title: "Creación de una VM con una dirección IP pública estática mediante una plantilla | Microsoft Docs"
description: "Aprenda a crear una VM con una dirección IP pública estática con Azure Resource Manager mediante una plantilla."
...
---
# <a name="create-a-vm-with-a-static-public-ip-using-a-template"></a>Creación de una VM con una dirección IP pública estática mediante una plantilla
...
1. Si no ha usado nunca la CLI de Azure, siga los pasos del artículo [Instalación de la CLI de Azure](../xplat-cli-install.md) para instalarla y configurarla.
