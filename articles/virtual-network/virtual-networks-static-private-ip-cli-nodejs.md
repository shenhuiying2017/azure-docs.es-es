---
title: "Configuración de direcciones IP privadas para máquinas virtuales en la CLI de Azure 1.0 | Microsoft Docs"
description: "Aprenda a configurar direcciones IP privadas para máquinas virtuales mediante la interfaz de línea de comandos (CLI) de Azure 1.0."
...
---
# <a name="configure-private-ip-addresses-for-a-virtual-machine-using-the-azure-cli-10"></a>Configuración de direcciones IP privadas para una máquina virtual mediante la CLI de Azure 1.0
...
- [CLI de Azure 1.0](#how-to-specify-a-static-private-ip-address-when-creating-a-vm): la CLI para los modelos de implementación clásico y de Resource Manager (este artículo)
- [CLI de Azure 2.0](virtual-networks-static-private-ip-arm-cli.md): la CLI de última generación para el modelo de implementación de administración de recursos. 
