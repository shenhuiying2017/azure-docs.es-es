---
title: Implementación de máquinas virtuales con varias NIC mediante la CLI de Azure en el modelo de implementación clásico | Microsoft Docs
...
Obtenga información acerca de cómo [realizar estos pasos con el modelo de Resource Manager](virtual-network-deploy-multinic-arm-cli.md).
