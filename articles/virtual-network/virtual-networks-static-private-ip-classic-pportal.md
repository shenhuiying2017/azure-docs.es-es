<properties 
   pageTitle="Establecimiento de una IP privada estática en el modo clásico con el Portal de vista previa | Microsoft Azure"
   description="Descripción de las IP privadas estáticas y su administración en el modo clásico con el portal"
...
# Configuración de una dirección IP privada estática (clásica) en el Portal de vista previa
...
2. Haga clic en **NUEVO** > **Proceso** > **Windows Server 2012 R2 Datacenter**. Tenga en cuenta que la lista **Seleccionar un modelo de implementación** ya muestra **Clásico** y, a continuación, haga clic en **Crear**.
	...
	![Creación de la VM en el Portal de vista previa](./media/virtual-networks-static-ip-classic-pportal/figure01.png)
...
3. En la hoja **Crear VM**, especifique el nombre de la VM que se va a crear (*DNS01* en nuestro escenario), la cuenta de administrador local y la contraseña.
	...
	![Creación de la VM en el Portal de vista previa](./media/virtual-networks-static-ip-classic-pportal/figure02.png)
...
4. Haga clic en **Configuración opcional** > **Red** > **Red virtual** y, a continuación, haga clic en **TestVNet**. Si **TestVNet** no está disponible, asegúrese de que usa la ubicación *Centro de EE. UU.* y que ha creado el entorno de prueba descrito al principio de este artículo.
	...
	![Creación de la VM en el Portal de vista previa](./media/virtual-networks-static-ip-classic-pportal/figure03.png)
...
5. En la hoja **Red**, asegúrese de que la subred seleccionada actualmente sea *front-End* y, a continuación, haga clic en **Direcciones IP**, en **Asignación de dirección IP**, en **Estático** y, a continuación, especifique *192.168.1.101* para **Dirección IP** como se muestra a continuación.
	...
	![Creación de la VM en el Portal de vista previa](./media/virtual-networks-static-ip-classic-pportal/figure04.png)
...
7. En la hoja **Crear VM**, haga clic en **Crear**. Observe el icono siguiente que aparece en el panel.
	...
	![Creación de la VM en el Portal de vista previa](./media/virtual-networks-static-ip-classic-pportal/figure05.png)
...
1. En el Portal de vista previa de Azure, haga clic en **EXAMINAR TODO** > **Máquinas virtuales (clásico)** > **DNS01** > **Toda la configuración** > **Direcciones IP** y observe la asignación de direcciones IP y la dirección IP que se muestran a continuación.

	![Creación de la VM en el Portal de vista previa](./media/virtual-networks-static-ip-classic-pportal/figure06.png)
...
1. En la hoja **Direcciones IP** que aparecen a continuación, haga clic en **Dinámico** a la derecha de **Asignación de la dirección IP** y, a continuación, haga clic en **Guardar** y después en **Sí**.
	...
	![Creación de la VM en el Portal de vista previa](./media/virtual-networks-static-ip-classic-pportal/figure07.png)
