---
title: Dirección IP pública de nivel de instancia (ILPIP) | Microsoft Docs
...
Obtenga información acerca de cómo [realizar estos pasos con el modelo de Resource Manager](virtual-network-ip-addresses-overview-arm.md).
