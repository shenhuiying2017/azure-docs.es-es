---
title: Implementación de máquinas virtuales con varias NIC mediante PowerShell en el modelo de implementación clásico | Microsoft Docs
...
Obtenga información acerca de cómo [realizar estos pasos con el modelo de Resource Manager](virtual-network-deploy-multinic-arm-ps.md).
