<properties 
   pageTitle="Solución de problemas de rutas - PowerShell | Microsoft Azure"
...
# Solución de problemas de rutas mediante Azure PowerShell
...
2.  El siguiente comando devuelve todas las rutas aplicadas a una interfaz de red denominada *VM1-NIC1* en el grupo de recursos *RG1*.
	...
	>[AZURE.TIP] Si no conoce el nombre de una interfaz de red, escriba el siguiente comando para recuperar los nombres de todas las interfaces de red en un grupo de recursos.*
