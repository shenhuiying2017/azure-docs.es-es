...
5. Agregue las reglas creadas anteriormente a un nuevo grupo de seguridad de red (NSG) denominado **NSG-FrontEnd**.
...
6. Asocie el grupo de seguridad de red creado anteriormente a la subred *FrontEnd*.
	...
	El resultado solo muestra la configuración de subred *FrontEnd*; tendrá que tener en cuenta el valor de la propiedad **NetworkSecurityGroup**:
