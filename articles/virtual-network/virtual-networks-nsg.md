...
### <a name="nsg-for-frontend-subnet"></a>Grupo de seguridad de red para la subred FrontEnd
**Reglas de entrada**
...
### <a name="nsg-for-backend-subnet"></a>Grupo de seguridad de red para la subred BackEnd
**Reglas de entrada**
...
### <a name="nsg-for-single-vm-nic-in-frontend-for-rdp-from-internet"></a>Grupo de seguridad de red para una única máquina virtual (NIC) en FrontEnd para RDP desde Internet
**Reglas de entrada**
...
### <a name="nsg-for-management-nics-in-backend"></a>Grupo de seguridad de red para las NIC de administración en BackEnd
**Reglas de entrada**
...
### <a name="nsg-for-database-access-nics-in-back-end"></a>Grupo de seguridad de red para las NIC de acceso a la base de datos en el back-end
**Reglas de entrada**
