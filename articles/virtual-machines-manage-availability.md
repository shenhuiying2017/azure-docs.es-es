<properties pageTitle="Administración de la disponibilidad de las máquinas virtuales - Azure" description="Aprenda cómo utilizar varias máquinas virtuales para garantizar una alta disponibilidad para su aplicación de Azure." services="virtual-machines" documentationCenter="" authors="kenazk" manager="timlt" editor="tysonn"/>
