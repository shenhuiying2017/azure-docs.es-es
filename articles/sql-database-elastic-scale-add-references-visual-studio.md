...
#Trabajo referencias de escalado elástico de Base de datos SQL de Azure a un proyecto de Visual Studio 
...
4. En el cuadro de diálogo **Buscar en línea**, escriba **Escalado elástico**, seleccione las **bibliotecas de cliente de escalado elástico** y haga clic en **Instalar**.
