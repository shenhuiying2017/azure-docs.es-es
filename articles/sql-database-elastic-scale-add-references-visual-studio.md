<properties title="Add Azure SQL DB Elastic Scale References to a Visual Studio Project" pageTitle="Incorporación de referencias de escalado elástico de Base de datos SQL de Azure a un proyecto de Visual Studio" description="Cómo agregar referencias de .NET para las API de escala elástica a proyectos de Visual Studio mediante Nuget." metaKeywords="Azure SQL Database, elastic scale, Nuget references" services="sql-database" documentationCenter="" manager="jhubbard" authors="sidneyh@microsoft.com"/>
