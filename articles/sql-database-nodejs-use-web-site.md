...
<b>Nota:</b>
<p>Actualmente, el controlador de Microsoft para Node.JS de SQL Server usado en este tutorial est&aacute; a disposici&oacute;n de los usuarios como versi&oacute;n preliminar y se basa en componentes en tiempo de ejecuci&oacute;n solamente disponibles en los sistemas operativos Microsoft Windows y Azure.</p>
</div>

<div class="dev-callout">
<strong>Nota:</strong>
<p>Este tutorial hace referencia a la carpeta <strong>tasklist</strong>. La ruta completa a esta carpeta se omite, debido a que la sem&aacute;ntica de la ruta es diferente entre los sistemas operativos. Debe crear esta carpeta en una ubicaci&oacute;n a la que le sea f&aacute;cil tener acceso en su sistema de archivos local, como <strong>~/node/tasklist</strong> o <strong>c:\node\tasklist</strong></p>
</div>

<div class="dev-callout">
<strong>Nota:</strong>
<p>Muchos de los pasos que se mencionan a continuaci&oacute;n usan la l&iacute;nea de comandos. Para realizar estos pasos, utilice la l&iacute;nea de comandos de su sistema operativo, como <strong>cmd.exe</strong> (Windows) o <strong>Bash</strong> (shell de Unix). En los sistemas OS X puede tener acceso a la l&iacute;nea de comandos mediante la aplicaci&oacute;n Terminal.</p>
</div>
...
[Aplicación web Node.js con almacenamiento de tablas]: /es-es/develop/nodejs/tutorials/web-site-with-storage/
  ...
  [diseño de tabla completado]: ./media/sql-database-nodejs-use-web-site/table-columns.png
