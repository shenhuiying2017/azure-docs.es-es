...
Cuando agrega una segunda región, se habilita la opción **Conmutación por error manual** en el hoja **Replicate data locally** (Replicar datos localmente) del portal. Puede usar esta opción para probar el proceso de conmutación por error o cambiar la región de escritura principal. Cuando agrega una tercera región, la opción **Prioridades de conmutación por error** se habilita en la misma hoja para que pueda cambiar el orden de la conmutación por error en las lecturas.  
