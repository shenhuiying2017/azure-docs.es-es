...
5.  Elija si desea dirigirse al emulador de almacenamiento (almacenamiento de Windows
    Azure simulado en su equipo local) o una cuenta de
    almacenamiento en la nube. El código de esta guía funciona con cualquiera
    de estas opciones. Escriba el valor **Clave de acceso primaria** copiado del
    paso anterior de este tutorial si desea dirigirse a la
    cuenta de almacenamiento que se creó anteriormente en Azure.
