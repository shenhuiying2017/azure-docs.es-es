...
3. Seleccione **Aplicaciones web**. Busque **WordPress** y haga clic en el icono **WordPress**.
...
7. Haga clic en **BASE DE DATOS** y proporcione los valores necesarios para configurar la base de datos de MySQL. 
