...
- [(C# universal para Windows| .NET)](mobile-services-dotnet-backend-windows-universal-dotnet-get-started-data.md)
- [(C# universal para Windows | Javascript)](mobile-services-javascript-backend-windows-universal-dotnet-get-started-data.md)
- [(JavaScript universal para Windows | .NET)](mobile-services-dotnet-backend-windows-universal-javascript-get-started-data.md)
- [(JavaScript universal para Windows | Javascript)](mobile-services-javascript-backend-windows-universal-javascript-get-started-data.md)
