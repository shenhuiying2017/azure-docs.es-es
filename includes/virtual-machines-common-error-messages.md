...
|  StorageAccountTypeNotSupported  |  La cuenta de almacenamiento {0} es de tipo {1}. Diagnósticos de arranque admite {2} tipos de cuenta de almacenamiento.  <ul><li>Este error se produce si usa la cuenta de almacenamiento premium para Diagnósticos de arranque. Para más información, consulte [Uso de Diagnósticos de arranque](../articles/virtual-machines/windows/boot-diagnostics.md). </li></ul> |
