...
2. Haga clic con el botón derecho del mouse en la tabla **TodoItem**, haga clic en **Editar permisos**, establezca todos los permisos en **Solo usuarios autenticados** y, a continuación, haga clic en **Aplicar**. Esto garantiza que todas las operaciones frente a la tabla *TodoItem* requieren un usuario autenticado.
