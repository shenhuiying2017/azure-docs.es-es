...
La directiva de IPsec o IKE personalizada se admite en las puertas de enlace de VPN de Azure **Standard** y **HighPerformance**. **Basic** NO se admite.
...
| Selector de tráfico | UsePolicyBasedTrafficSelectors** ($True/$False)                             |
|                  |                                                                             |
