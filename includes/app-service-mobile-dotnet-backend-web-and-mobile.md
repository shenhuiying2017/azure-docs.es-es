...
>[AZURE.NOTE] Si desea ver una introducción al Servicio de aplicaciones de Azure antes de registrar una cuenta de Azure, vaya a [Prueba del Servicio de aplicaciones](http://go.microsoft.com/fwlink/?LinkId=523751) (en inglés), donde puede crear inmediatamente una aplicación web básica de corta duración en el Servicio de aplicaciones. No es necesario proporcionar ninguna tarjeta de crédito ni asumir ningún compromiso.

## Creación de un nuevo back-end de aplicación móvil y un cliente

* Siga los pasos del tutorial [Crear una aplicación móvil] para crear tanto un back-end de aplicación móvil como un cliente. Puede usar cualquier plataforma cliente compatible con las aplicaciones móviles, entre las que se incluyen iOS, Windows, Xamarin iOS, y Xamarin Android.
...
1. En el [Portal de Azure](https://portal.azure.com/), cree una nueva aplicación web, para lo que debe usar el mismo grupo de recursos y plan de hospedaje que en la aplicación móvil.
...
4. A continuación, obtendrá la cadena de conexión de la aplicación móvil del Portal de Azure:
    ...
    - En la hoja que se abre, seleccione **Todas las configuraciones** y, a continuación, **Configuración de la aplicación**.
...
5. En Visual Studio, haga clic con el botón secundario en el proyecto de API web y seleccione **Publicación**. Seleccione **Aplicaciones web de Azure** como destino de publicación y seleccione la aplicación web creada arriba. Haga clic en **Siguiente** hasta que llegue a la sección **Configuración** del Asistente para publicación web.
...
2. Haga clic con el botón secundario en el proyecto **MultiChannelToDo.Web** y seleccione **Publicación**.

3. En el Asistente para **publicación web**, seleccione **Aplicación web de Azure** como publicación de destino y cree una nueva aplicación web sin base de datos. 
...
1. En la interfaz de usuario web, agregue o edite algunas tareas pendientes.
    ...
    ![Vista de aplicación web en el explorador](./media/app-service-mobile-dotnet-backend-web-and-mobile/web-app-in-browser.png)

2. Ejecute la aplicación móvil que creó en el tutorial [Crear una aplicación móvil]. Verá las mismas tareas pendientes que en la aplicación web. 

    ![Vista de aplicación móvil de Xamarin](./media/app-service-mobile-dotnet-backend-web-and-mobile/xamarin-ios-quickstart-device.png)
