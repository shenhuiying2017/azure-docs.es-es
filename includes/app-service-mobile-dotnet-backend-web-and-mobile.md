...
> [!NOTE]
> Antes de completar estos pasos, asegúrese de que ha inicializado la base de datos del back-end de aplicación móvil, para lo que debe conectar un cliente a ella. De lo contrario, la aplicación web no podrá conectarse a la misma base de datos.
> 
> 
