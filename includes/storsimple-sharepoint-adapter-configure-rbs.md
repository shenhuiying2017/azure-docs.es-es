...
6. (Opcional) Puede usar el cmdlet de PowerShell `Migrate()` de Microsoft RBS incluido con SharePoint para migrar el contenido de BLOB existente para el dispositivo StorSimple. Para más información, consulte [Migrar contenido a o desde EDR en SharePoint 2013][6] o [Migrate content into or out of RBS (SharePoint Foundation 2010)][7] [Migración de contenido a o desde el EDS (SharePoint Foundation 2010)].
