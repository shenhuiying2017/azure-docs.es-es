...
5. En el cuadro de diálogo anterior, **Crear servicio móvil**, seleccione su **Suscripción**, el back-end de **.NET Framework** en **Tiempo de ejecución** y una **Región** para su servicio móvil; luego escriba un **Nombre** para el servicio móvil.
