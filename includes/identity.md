...
Ejecutar Windows Server AD en las máquinas virtuales de Azure es muy parecido a hacerlo de manera local. [En la Ilustración 1](#fig1) se muestra un ejemplo típico de su apariencia.
...
Puesto que las aplicaciones SaaS son cada vez más frecuentes, plantean una pregunta obvia: ¿qué tipo de servicio de directorio deben usar estas aplicaciones basadas en la nube? La respuesta de Microsoft a esa pregunta es Azure Active Directory.
...
<a id="fig3"></a>Ilustración 3: Una organización puede federar Windows Server Active Directory con Azure Active Directory para ofrecer a los usuarios un inicio de sesión único a aplicaciones SaaS.
