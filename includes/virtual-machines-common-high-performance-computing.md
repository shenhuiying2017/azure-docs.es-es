...
Con Azure, puede ejecutar la informática de alto rendimiento (HPC) y las cargas de trabajo por lotes en clústeres de máquinas virtuales de Azure, mediante su elección de los servicios de infraestructura de Azure o de los servicios administrados. Azure le proporciona la flexibilidad para escalar los recursos de proceso a miles de máquinas virtuales o núcleos para, posteriormente, reducir verticalmente cuando necesite menos recursos. 

Las soluciones de informática de alto rendimiento de Azure ejecutan eficazmente cargas de trabajo de Linux y Windows de proceso intensivo que abarcan desde trabajos por lotes en paralelo hasta las simulaciones de informática de alto rendimiento habituales. Las principales aplicaciones de informática de alto rendimiento son compatibles para su ejecución en máquinas virtuales de Azure y puede sacar partido de los tamaños e imágenes especializados de máquinas virtuales diseñados para trabajos de proceso intensivo. 


## <a name="solution-architectures"></a>Arquitecturas de las soluciones

Entre los ejemplos de arquitecturas de las soluciones de proceso intensivo de Azure se incluyen:

* La ejecución de aplicaciones de informática de alto rendimiento en máquinas virtuales o en [conjuntos de escalado de máquinas virtuales](../articles/virtual-machine-scale-sets/virtual-machine-scale-sets-overview.md), mediante un clúster Linux o Windows o un administrador de soluciones en malla de su elección [Más información](https://azure.microsoft.com/en-us/solutions/architecture/hpc-cluster/)
* La creación de soluciones híbridas que amplíen un clúster de HPC local para las descargas de cargas de trabajo máximas en las máquinas virtuales de Azure [Más información](https://azure.microsoft.com/en-us/solutions/architecture/hpc-on-prem-burst/)
...
## <a name="hpc-cluster-and-grid-solutions"></a>Clúster de HPC y soluciones en malla
Implemente o amplíe las conocidas herramientas de administración de cargas de trabajo de HPC en las máquinas virtuales de Azure y ejecute cargas de trabajo de proceso intensivo. Entre las opciones se incluyen herramientas de código abierto como el [administrador de cargas de trabajo Slurm](https://slurm.schedmd.com/) y los administradores de clústeres o soluciones en malla de Microsoft y otros editores.

### <a name="linux-and-oss-cluster-solutions"></a>Soluciones de clúster de Linux y OSS
Use las plantillas de Azure Resource Manager para implementar soluciones de clúster de HPC de Linux en máquinas virtuales o en conjuntos de escalado de máquinas virtuales, incluidos:
...
Consulte también la colección de [plantillas de 5-click](https://github.com/tanewill/5clickTemplates).

### <a name="grid-managers"></a>Administradores de soluciones en malla
Los asociados de Microsoft con administradores de soluciones comerciales en malla para hacer que sus soluciones estén disponibles en las máquinas virtuales de Azure. Algunos ejemplos son:
...
[HPC Pack](https://technet.microsoft.com/library/cc514029(v=ws.11).aspx) es la solución HPC gratuita de Microsoft integrada en las tecnologías de Microsoft Azure y Windows Server. HPC Pack ofrece varias opciones de ejecución en máquinas virtuales [Windows](../articles/virtual-machines/windows/hpcpack-cluster-options.md?toc=%2fazure%2fvirtual-machines%2fwindows%2ftoc.json) y [Linux](../articles/virtual-machines/linux/hpcpack-cluster-options.md?toc=%2fazure%2fvirtual-machines%2flinux%2ftoc.json). 

Obtenga información sobre cómo:

* [Crear un clúster de HPC Pack 2016 en Azure](../articles/virtual-machines/windows/hpcpack-2016-cluster.md)
* [Dar el salto a Azure con HPC Pack](https://technet.microsoft.com/library/gg481749(v=ws.11).aspx)
...
Use los SDK y las herramientas de Batch para integrar las aplicaciones de HPC o las cargas de trabajo de los contenedores con Azure, almacenar provisionalmente datos en Azure y crear canalizaciones de ejecución de trabajos. También puede usar la capacidad sobrante de las máquinas virtuales de Azure (prioridad baja) a un [precio reducido](https://azure.microsoft.com/pricing/details/batch/), lo cual reduce considerablemente el costo de algunas cargas de trabajo en Batch.
...
## <a name="hpc-images"></a>Imágenes de HPC

Visite [Azure Marketplace](https://azuremarketplace.microsoft.com/marketplace/) para obtener las imágenes de máquinas virtuales Windows y Linux diseñadas para HPC. Algunos ejemplos son:

* [HPC basado en RogueWave CentOS](https://azuremarketplace.microsoft.com/en-us/marketplace/apps/RogueWave.CentOSbased73HPC?tab=Overview)
...
Ejecute aplicaciones HPC personalizadas o comerciales en Azure. Se realizan pruebas comparativas en varias para realizar un escalado eficaz con máquinas virtuales o nodos de proceso adicionales. Las secciones siguientes son ejemplos.
...
## <a name="solution-partners"></a>Asociados de soluciones

Entre los asociados que desarrollan o entregan aplicaciones de HPC y de Batch en Azure se incluyen:

* [Cycle Computing](https://cyclecomputing.com/) (ahora [unido a Microsoft](https://blogs.microsoft.com/blog/2017/08/15/microsoft-acquires-cycle-computing-accelerate-big-computing-cloud/))
* [Rescale](https://www.rescale.com/azure/)
* [UberCloud](https://www.theubercloud.com/)

## <a name="hpc-storage"></a>Almacenamiento de HPC

Las cargas de trabajo a gran escala de Batch y HPC presentan una demanda de almacenamiento y acceso de datos que superan las capacidades de los sistemas de archivos en la nube tradicionales. Puede implementar soluciones de sistema de archivos en paralelo en Azure como [Lustre](http://lustre.org/) y [BeeGFS](http://www.beegfs.com/content/).
...
* [Factoría de datos](../articles/data-factory/data-factory-introduction.md)
...
* Obtenga más información sobre las soluciones de Big Compute para [simulación de ingeniería](https://simulation.azure.com/), [representación](https://simulation.azure.com/) y [los mercados de capital y banca](https://finance.azure.com/).
