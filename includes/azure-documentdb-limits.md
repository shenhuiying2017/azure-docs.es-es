=======
Entidad| Restricción (oferta estándar)
---|---
...
Almacenamiento de datos adjuntos por cuenta de base de datos (característica de vista previa)|2 GB 
...
Elementos máximos por página|1.000 
Tamaño de solicitud máximo del documento y del adjunto|512 KB 
Tamaño de solicitud máximo del procedimiento almacenado, desencadenador y UDF|512 KB 
...
Número máximo de JOIN por consulta*|2 N
úmero máximo de cláusulas AND por consulta*|5 
