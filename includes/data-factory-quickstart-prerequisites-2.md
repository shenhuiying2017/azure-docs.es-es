...
1. En el explorador web, vaya a la página [Descargas de Azure](https://azure.microsoft.com/downloads/). 
...
2. Ejecute el siguiente comando para ver todas las suscripciones de esta cuenta:
    ...
    ```
3. Si ve varias suscripciones de Azure asociadas a su cuenta, ejecute el siguiente comando para seleccionar la suscripción con la que desea trabajar. Reemplace **SubscriptionId** con el identificador de la suscripción de Azure:
