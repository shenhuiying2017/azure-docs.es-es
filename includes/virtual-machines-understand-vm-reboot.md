...
- [Programación del mantenimiento planeado en máquinas virtuales de Azure](../articles/virtual-machines/windows/planned-maintenance-schedule.md)
...
### Azure Security Center y Windows Update
...
Con Azure Premium Storage se consiguen límites de IOPS mayores (hasta 80 000 IOPS). Para más información, consulte el artículo sobre [Premium Storage de alto rendimiento](../articles/storage/storage-premium-storage.md).
