...
2. En la hoja **Espacio de nombres del Bus de servicio**, haga clic en **Directivas de acceso compartido**.
...
4. En la hoja **Directiva: RootManageSharedAccessKey**, haga clic en el botón Copiar junto a **Cadena de conexión: clave principal**, para copiar la cadena de conexión en el portapapeles para su uso posterior.
