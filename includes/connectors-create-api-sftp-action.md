...
3. Seleccione **Source archive file path** (Ruta de acceso del archivo de origen).  
...
5. Seleccione **Destination folder path** (Ruta de acceso de la carpeta de destino).  
