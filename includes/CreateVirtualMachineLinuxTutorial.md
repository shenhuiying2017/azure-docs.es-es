...
1. Localice el **Nombre de host** y la **Información de puerto** en el Portal de administración. Puede encontrar la información que necesita en el panel de la máquina virtual. Haga clic en el nombre de la máquina virtual y busque **Detalles de SSH** en la sección **Vista rápida** del panel.

	![Find SSH details](./media/CreateVirtualMachineLinuxTutorial/SSHdetails.png)

2. Abra el programa PuTTY.

3. Escriba los valores en **Nombre de host** e **Información de puerto** que recopiló en el panel y, a continuación, haga clic en **Abrir**.
...
Los discos de datos residen en el almacenamiento de Azure y pueden utilizarse para el almacenamiento persistente de archivos y datos de la aplicación.
...
3. En la barra de comandos, haga clic en **Adjuntar** y, a continuación, en **Conectar disco vacío**.
...
4. Las opciones **Nombre de máquina virtual**, **Ubicación de almacenamiento** y **Nombre de archivo** ya están predefinidas. Solo tiene que especificar el tamaño que desea utilizar para el disco. Escriba **5** en el campo **Tamaño**.
...
11. Agregue la nueva unidad a /etc/fstab:
	...
	**Precaución:** la edición incorrecta del archivo /etc/fstab puede tener como resultado un sistema que no se pueda arrancar. Si no está seguro, consulte la documentación de distribución para obtener información sobre cómo editar correctamente ese archivo. También se recomienda realizar una copia de seguridad del archivo /etc/fstab antes de editarlo.
	...
	Ahora puede probar que el sistema de archivos está correctamente montado con solo desmontar y volver a montar el sistema de archivos, es decir, usando el punto de montaje de ejemplo "/datadrive": 
