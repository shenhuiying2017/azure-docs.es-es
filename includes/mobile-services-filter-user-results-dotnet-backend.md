...
> [WACOM.NOTE] Los métodos siguientes deben tener el atributo **RequiresAuthorizationAttribute** aplicado en el objeto **Authorizationlevel** del objeto **User**. De esta forma, se restringe el acceso a la tabla solo a usuarios autenticados.
...
4.  Busque el método **PostTodoItem** y agregue el siguiente código al principio del método:
