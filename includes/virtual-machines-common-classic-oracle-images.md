...
Para crear máquinas virtuales a partir de imágenes de Oracle, inicie sesión en [Azure Portal](https://portal.azure.com/), haga clic en **Marketplace**, luego en **Compute** y, finalmente, escriba **Oracle** en el cuadro de búsqueda. Seleccione una imagen y siga las instrucciones para configurarla en Microsoft Azure. Tenga en cuenta que las imágenes de Oracle efectuadas por Microsoft en el [Portal de Azure](https://portal.azure.com/) se ejecutan en Windows, mientras que las imágenes de Oracle efectuadas por Oracle se ejecutan en Oracle Linux.
