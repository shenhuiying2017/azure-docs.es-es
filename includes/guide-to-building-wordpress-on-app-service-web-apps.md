...
### WordPress y el Servicio de aplicaciones de Azure
...
* [Compile su propio clúster de MySQL de maestro/maestro mediante el clúster de Percona](https://azure.microsoft.com/documentation/templates/mysql-ha-pxc/) y [obtenga más información sobre cómo administrar el clúster](https://github.com/fanjeffrey/axiom.articles/tree/master/pxc)
...
* [How to build a WordPress Multisite web app](../articles/app-service-web/web-sites-php-convert-wordpress-multisite.md) (Cómo crear una aplicación web de multisitio de WordPress)

### Trasladar la aplicación al Servicio de aplicaciones
* [How to Plan your migration to Azure App Service](https://azure.microsoft.com/blog/how-to-plan-your-migration-to-azure-websites/) (Cómo planear la migración al Servicio de aplicaciones de Azure)
* [How to migrate your existing WordPress site to Azure web apps](https://sunithamk.wordpress.com/2013/11/06/migrate-your-existing-wordpress-site-to-windows-azure/) (Cómo migrar el sitio de WordPress existente a aplicaciones web de Azure)
* [How to migrate your Web App from Linux to Azure web apps](https://www.movemetothecloud.net/LinuxMigration) (Cómo migrar la aplicación web desde Linux a aplicaciones web de Azure)
* [Checklist for going live on Azure Web Apps](https://sunithamk.wordpress.com/2015/10/27/azure-web-apps-basic-operations-checklist/) (Lista de comprobación de puesta en marcha en aplicaciones web de Azure)
* [How to configure PHP](../articles/app-service-web/web-sites-php-configure.md) (Cómo configurar PHP)
* [Setup multiple development environments for your WordPress app](../articles/app-service-web/app-service-web-staged-publishing-realworld-scenarios.md) (Preparar varios entornos de desarrollo para la aplicación de WordPress)
