...
2. En la página **Agregar colección**, especifique la configuración de la nueva colección.
    ...
    Rendimiento|400 RU|Cambie el rendimiento a 400 unidades de solicitud por segundo (RU/s). La capacidad de almacenamiento debe estar establecida en **Fija (10 GB)** con el fin de establecer el rendimiento en 400 RU/s. Si quiere reducir la latencia, puede escalar verticalmente el rendimiento más adelante. 
    Clave de partición|/categoría|Escriba */categoría* como clave de partición. Una clave de partición distribuye los datos uniformemente a cada partición de la base de datos. Para más información acerca de la creación de particiones, consulte [Diseño de la creación de particiones](../articles/cosmos-db/partition-data.md#designing-for-partitioning).
