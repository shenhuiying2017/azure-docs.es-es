...
## Concesión de permisos de db\_owner de usuario de base de datos nueva

Siga estos pasos para conceder a usuario de una base de datos existente permisos de db\_owner
