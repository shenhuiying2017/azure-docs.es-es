...
1. De forma predeterminada, el portal de la solución muestra el *panel*. Desplácese a otras áreas del portal de solución mediante el menú del lado izquierdo de la página.
...
1. Elija **Permitirme definir mi propio id. de dispositivo**. Escriba un identificador de dispositivo como **dispositivo01**, haga clic en **Comprobar id.** para comprobar que no haya usado ya el nombre en la solución y haga clic en **Crear** para aprovisionar el dispositivo.
