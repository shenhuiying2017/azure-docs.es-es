...
2. En la hoja **Create virtual network gateway** (Crear puerta de enlace de red virtual), rellene los valores de la puerta de enlace de red virtual.
    ...
    ![Campos de la hoja Create virtual network gateway (Crear puerta de enlace de red virtual)](./media/vpn-gateway-add-gw-rm-portal-include/createvng.png "Campos de la hoja Create virtual network gateway (Crear puerta de enlace de red virtual)")
...
7. **Ubicación**: ajuste el campo **Ubicación** para que apunte a la ubicación en la que se encuentra la red virtual. Si la ubicación no apunta a la región en que reside la red virtual, esta no aparecerá en la lista desplegable 'Elegir una red virtual'.
