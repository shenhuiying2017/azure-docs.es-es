...
1. Con sus credenciales de cuenta de Microsoft, inicie sesión en el Portal de Azure clásico en esta dirección URL: [http://azure.microsoft.com/](http://azure.microsoft.com/).
