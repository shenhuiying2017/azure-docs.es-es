...
3.  Después de la función **refreshTodoItems**, agregue el siguiente código:
    ...
    Este método controla el evento **Click** del nuevo botón. El método **InvokeApiAsync** se llama en el cliente, el cual envía una solicitud POST a la nueva API personalizada. El resultado devuelto por la API personalizada se muestra en un cuadro de diálogo de mensaje, al igual que todos los errores.
