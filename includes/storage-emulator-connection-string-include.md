...
La manera más fácil de conectarse al emulador de almacenamiento desde la aplicación consiste en configurar una cadena de conexión desde dentro del archivo de configuración de la aplicación que hace referencia el acceso directo `UseDevelopmentStorage=true`. Este es un ejemplo de una cadena de conexión al emulador de almacenamiento en un archivo app.config:
