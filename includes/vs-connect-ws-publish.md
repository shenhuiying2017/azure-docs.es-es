* Haga clic en **Sign In** y, a continuación, escriba las credenciales de su cuenta de Azure.
...
* Haga clic en **Manage subscriptions** para instalar un certificado de administración que permita el acceso a su cuenta.
	...
	En el cuadro de diálogo **Manage Azure Subscriptions**, haga clic en la pestaña **Certificates** y, a continuación, en **Import**. Siga las indicaciones para descargar e importar un archivo de suscripción (también denominado archivo *.publishsettings*) para su cuenta de
Azure.
