...
3. Seleccione **Tienda**.  
   ![Tienda][button-store]
4. Seleccione MongoLab. Puede encontrarnos tanto en la categoría **App Services** como en **Todo**.  
...
10. Revise la información de la compra en la tienda y, a continuación, haga clic en **Comprar** para confirmar.  
    ![Siguiente][button-purchase]  
11. El botón de progreso de la barra de herramientas proporciona el estado de aprovisionamiento.  
