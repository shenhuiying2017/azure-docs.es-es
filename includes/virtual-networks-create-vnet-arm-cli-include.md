## <a name="how-to-create-a-vnet-using-the-azure-cli"></a>Cómo crear una red virtual mediante la CLI de Azure
...
3. En caso necesario, ejecute **azure group create** para crear un grupo de recursos, como se muestra a continuación. Observe la salida del comando. En la lista que se muestra en la salida se explican los parámetros utilizados. Para obtener más información sobre los grupos de recursos, visite [Información general del Administrador de recursos de Azure](../articles/azure-resource-manager/resource-group-overview.md#resource-groups).
...
7. Ejecute el comando **azure network vnet show** para ver las propiedades de la nueva red virtual, tal como se muestra a continuación.
