...
> [!NOTE]
> Los procedimientos de esta tarea se aplican a los Servicios en la nube de Azure. Para obtener información sobre las cuentas de almacenamiento, consulte [Configuración de un nombre de dominio personalizado para una cuenta de Almacenamiento de Azure](../articles/storage/storage-custom-domain-name.md). Para obtener información sobre sitios web, consulte [Configuración de un nombre de dominio personalizado para un sitio web de Azure](../articles/app-service-web/web-sites-custom-domain-name.md).
> 
> 
...
## Pasos siguientes
* [Administración de servicios en la nube](../articles/cloud-services/cloud-services-how-to-manage.md)
