...
Puede utilizar la [interfaz de línea de comandos de Azure][interfaz de línea de comandos de Azure] para crear los archivos. Use este comando desde la carpeta del proyecto:
