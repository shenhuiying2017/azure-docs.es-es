...
Los pasos siguientes le ayudarán a usar la CLI de Azure fácilmente con la versión más reciente y la suscripción adecuada. Si necesita instalar la CLI de Azure y conectarla primero a su cuenta, consulte la [interfaz de la línea de comandos de Azure (CLI de Azure)](../articles/cli-install-nodejs.md).
