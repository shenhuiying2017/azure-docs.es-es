| **Hardware** | |
| --- |---|
| Número de núcleos de la CPU| 8 núcleos |
| RAM| 12 GB|
| Número de discos | **3 discos** <br> - Disco del sistema operativo<br> - Disco de caché del servidor de procesos<br> - Unidad de retención (conmutación por recuperación)|
...
| Roles de Windows Server | No habilite los siguientes roles <br> **Active Directory Domain Services** <br>**Internet Information Service** <br> **Hyper-V** |
| **Red** | |
