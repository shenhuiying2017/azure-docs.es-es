...
1. Cree la red virtual en el [Portal de Azure](http://manage.windowsazure.com). Para obtener más información, consulte [Tareas de configuración de la red virtual](../documentation/services/virtual-machines.md).
...
[Tareas de configuración de red virtual](../documentation/services/virtual-machines.md)
