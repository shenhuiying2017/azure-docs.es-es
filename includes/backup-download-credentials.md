## <a name="using-vault-credentials-to-authenticate-with-the-azure-backup-service"></a>Uso de las credenciales de almacén para autenticarse con el servicio de Copia de seguridad de Azure
...
3. En la página de Inicio rápido, haga clic en **Descargar credenciales de almacén**. El portal genera el archivo de credenciales del almacén, que puede descargarse.
