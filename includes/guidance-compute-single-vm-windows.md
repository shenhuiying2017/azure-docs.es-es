...
- **Grupo de recursos.** Un [_grupo de recursos_][resource-manager-overview] es un contenedor que incluye los recursos relacionados de una aplicación. Cree un grupo de recursos para contener los recursos de esta máquina virtual.
