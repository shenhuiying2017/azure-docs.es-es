...
Con la disponibilidad reciente del compilador de [Microsoft Visual C++ para Python 2.7][Microsoft Visual C++ para Python 2.7], ahora es más fácil crear paquetes que tienen código nativo para Python 2.7.
...
En el caso de Python 2.7, puede instalar el [compilador de Microsoft Visual C++ para Python 2.7][compilador de Microsoft Visual C++ para Python 2.7].
