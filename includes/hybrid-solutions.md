...
- *Queues*, que permiten la comunicación unidireccional. Cada cola funciona como un intermediario (al que se le llama a veces  *broker*) que almacena los mensajes enviados hasta que se reciben.
- *Topics*, que proporcionan comunicación unidireccional mediante  *subscriptions*. Como en las colas, los temas funcionan como un agente, pero permiten a cada suscripción visualizar solo los mensajes que cumplen con criterios específicos.
- *Relays*, que permiten la comunicación bidireccional. A diferencia de las colas y los temas, los relés no almacenan mensajes que se encuentran en proceso; no son un agente. Simplemente los transmiten a la aplicación de destino.
...
El proceso es sencillo: un usuario envía un mensaje a la cola del bus de servicio y un receptor recoge ese mensaje más tarde. Una cola puede tener solo un único receptor, como muestra la [Ilustración 2],(#Fig2)  o varias aplicaciones pueden leer de la misma cola. En esa última situación, los mensajes los lee normalmente solo un receptor; las colas no proporcionan un servicio multidifusión.
...
- El suscriptor 3 ha establecido su filtro en  *True*,  lo que significa que recibe todos los mensajes. Esta aplicación puede ser la responsable del mantenimiento, por ejemplo, de una pista de auditoría, y por eso necesita verlo todo.
