...
Si aún no lo ha agregado al sitio web como extremo del Administrador de tráfico, debe hacerlo para que funcione la resolución de nombres, debido a que el nombre de dominio personalizado se enruta a Traffic Manager. Posteriormente, el Administrador de tráfico enruta al sitio web. Utilice la información de [Adición o eliminación de extremos](http://msdn.microsoft.com/es-es/library/windowsazure/hh744839.aspx) para agregar su sitio web como un extremo en su perfil del Administrador de tráfico.
