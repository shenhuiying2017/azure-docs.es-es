...
2. Expanda **Servicios móviles de Azure** y haga clic en **Controlador personalizado de Servicios móviles de Azure**; luego haga clic en **Agregar**, indique un **nombre de controlador** de  `CompleteAllController` y haga clic en **Agregar** de nuevo.
