...
4. Desmonte cada partición enumerada para el disco. En este ejemplo: `$ sudo umount /dev/sdc1`
5. Utilice el comando `blkid` para la detección del UUID de todas las particiones.
...
6. Quite las entradas del archivo **/etc/fstab** asociado a las rutas de acceso del dispositivo o los UUID de todas las particiones del disco que se va a desvincular. Las entradas de este ejemplo podrían ser:
