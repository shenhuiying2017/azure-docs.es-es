...
Para más información sobre la configuración de las máquinas virtuales de cara a conseguir una alta disponibilidad, consulte el artículo sobre cómo administrar la disponibilidad de máquinas virtuales en Windows (../articles/virtual-machines/windows/manage-availability.md) o [Linux](../articles/virtual-machines/linux/manage-availability.md).