...
3. En el panel **Nueva cuenta**, especifique la configuración que quiera para la cuenta de Azure Cosmos DB. 
    ...
    Rellene el panel **Nueva cuenta** con la información de la tabla como guía.
 
    ![Captura de pantalla del panel Nueva cuenta de Azure Cosmos DB](./media/cosmos-db-create-dbaccount-mongodb/create-nosql-db-databases-json-tutorial-2.png)
    ...
    La ubicación|*Región más cercana a los usuarios*|Ubicación geográfica en la que se va a hospedar la cuenta de Azure Cosmos DB. Elija la ubicación más cercana a los usuarios para proporcionarles el acceso más rápido a los datos.
