...
1. En el Explorador de soluciones de Visual Studio, expanda la carpeta **App_Start** en el proyecto de servicio todolist. Abra el archivo WebApiConfig.cs.
...
A continuación, actualice la aplicación cliente para mostrar los datos nuevos de **CompleteDate**.<!--HONumber=42-->
