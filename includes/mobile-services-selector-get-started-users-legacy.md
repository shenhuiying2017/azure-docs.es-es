...
- [(C# de Tienda Windows | .NET)](../articles/mobile-services-dotnet-backend-windows-store-dotnet-get-started-users.md)
- [(C# de Tienda Windows | Javascript)](../articles/mobile-services-windows-store-dotnet-get-started-users.md)
- [(JavaScript de Tienda Windows | Javascript)](../articles/mobile-services-windows-store-javascript-get-started-users.md)
