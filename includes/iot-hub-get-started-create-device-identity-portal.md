...
1. Cuando se abra el recurso de IoT Hub, haga clic en la herramienta **Explorador de dispositivos** y, a continuación, haga clic en **Agregar** en la parte superior. Proporcione el nombre del nuevo dispositivo, como **myDeviceId** y haga clic en **Guardar**.
