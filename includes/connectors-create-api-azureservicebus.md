...
4. Seleccione **SharePoint Online - Create file** (SharePoint Online: crear archivo). Esta es la acción que se realizará.   **Nota**: Si no lo ha hecho aún, se le pedirá que autorice el acceso de la aplicación lógica a la cuenta de SharePoint.    
...
8. Seleccione el control **File name** (Nombre de archivo) y escriba el nombre del archivo que quiere crear. Para el nombre de archivo, tenga en cuenta que puede usar cualquiera de las propiedades del desencadenador creado anteriormente simplemente seleccionándolo en la lista presentada.     
