...
2.	En la barra de salto, haga clic en **Nuevo**, a continuación, seleccione **Datos y almacenamiento**y, a continuación, haga clic en **DocumentDB**. 
	...
	O bien, en el panel de inicio, examine el catálogo de soluciones de Azure, seleccione **Datos y análisis**, elija **DocumentDB** y, a continuación, haga clic en **Crear**.  
...
3. En la hoja **Nueva DocumentDB (vista previa)**, especifique la configuración para la cuenta. 
	...
	- La lente **Nivel de precios** lente está bloqueada porque la vista previa de DocumentDB admite un nivel de precios estándar único. Para obtener más información, vea [Precios de DocumentDB](http://go.microsoft.com/fwlink/p/?LinkID=402317&clcid=0x409).

	- El modo **Configuración opcional** se usa para especificar la capacidad inicial asignada a su cuenta de DocumentDB.  DocumentDB aprovecha las unidades de capacidad para permitirle escalar su cuenta de DocumentDB, donde cada unidad de capacidad incluye almacenamiento y rendimiento de base de datos reservados.  De manera predeterminada, se aprovisiona una unidad de capacidad.  Puede ajustar el número de unidades de capacidad disponibles para su cuenta de DocumentDB en cualquier momento mediante el [portal de administración de vista previa](https://portal.azure.com/#gallery/Microsoft.DocumentDB). Para obtener más información acerca de la capacidad y el rendimiento de la cuenta de DocumentDB, vea el artículo [Administración de capacidad y rendimiento de DocumentDB][documentdb-manage].

	- En **Grupo de recursos**, seleccione o cree un grupo de recursos para su cuenta de DocumentDB.  De forma predeterminada, se creará un nuevo grupo de recursos.  Puede, sin embargo, optar por seleccionar un grupo de recursos existente al que agregar su cuenta de DocumentDB. Para obtener más información, consulte [Uso de grupos de recursos para administrar los recursos de Azure](azure-preview-portal-using-resource-groups.md).
	...
	- Use **Ubicación** para especificar la ubicación geográfica en la que se hospedará su cuenta de DocumentDB.   

3.	Una vez que las nuevas opciones de cuenta de DocumentDB estén configuradas, haga clic en **Crear**.  La creación de la cuenta puede tardar unos minutos.  Para comprobar el estado, puede supervisar el progreso en el panel de inicio.  
...
4.	Después de crear la cuenta de DocumentDB, ya se puede usar con la configuración predeterminada.

	*Tenga en cuenta que la coherencia predeterminada de la cuenta de DocumentDB se establecerá en Sesión.  Puede ajustar la configuración de coherencia predeterminada a través del [portal de administración de vista previa](https://portal.azure.com/#gallery/Microsoft.DocumentDB). *  
