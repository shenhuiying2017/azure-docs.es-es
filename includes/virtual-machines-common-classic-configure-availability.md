...
* [Opción 1: Creación de una máquina virtual y de un conjunto de disponibilidad simultáneamente][Opción 1: Creación de una máquina virtual y de un conjunto de disponibilidad simultáneamente]. A continuación, agregue nuevas máquinas virtuales al conjunto cuando cree en dichas máquinas virtuales.
...
2. En el menú del concentrador, haga clic en **+ Nuevo** y, luego, haga clic en **Máquina virtual**.
...
4. Para la máquina virtual seleccionada, compruebe que el modelo de implementación está establecido en **Clásica** y, luego, haga clic en **Crear**.
...
Para usar los comandos de Azure PowerShell con el fin de crear una máquina virtual de Azure y agregarla a un conjunto de disponibilidad nuevo o existente, consulte [Creación de una máquina virtual de Windows con PowerShell y el modelo de implementación clásica](../articles/virtual-machines/virtual-machines-windows-classic-create-powershell.md).
