...
4. Una vez que el portal haya creado el certificado, haga clic en el botón **Download** (Descargar) y en **Done** (Listo).
   ...
   > [!NOTE]
   > de manera predeterminada, el certificado de desarrollo del archivo descargado se llama **aps\_development.cer**.
   > 
   > 
5. Haga doble clic en el certificado de inserción **aps\_development.cer** descargado.
