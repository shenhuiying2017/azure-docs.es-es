...
A continuación definirá el conjunto de datos de SQL de Azure como sigue. 

> [!NOTE]
> No es necesario especificar la sección **structure** con información de tipo porque ya se especificó en el almacén de datos subyacente.
