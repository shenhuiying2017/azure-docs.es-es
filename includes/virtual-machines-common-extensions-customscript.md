...
- [Implementación de plantillas con la CLI de Azure](virtual-machines-linux-cli-manage.md)
- [Implementación de plantillas con Azure PowerShell](virtual-machines-windows-ps-manage.md)
