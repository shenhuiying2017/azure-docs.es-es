> [AZURE.SELECTOR-LIST (Plataformaa | Back-end)]
...
- [(C# universal para Windows| .NET)](../articles/mobile-services-dotnet-backend-windows-store-universal-get-started-data.md)
- [(C# universal para Windows | Javascript)](../articles/mobile-services-javascript-backend-windows-universal-dotnet-get-started-data.md)
- [(JavaScript de Tienda Windows | Javascript)](../articles/mobile-services-windows-store-javascript-get-started-data.md)
