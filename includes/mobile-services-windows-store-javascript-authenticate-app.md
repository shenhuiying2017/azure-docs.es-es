...
1.  Abra el archivo de proyecto default.js y, en la sobrecarga del método **app.OnActivated**, sustituya la última llamada al método **refreshTodoItems** por el siguiente código:
         ...
         // Solicitar autenticación a Servicios móviles utilizando un usuario y contraseña de Facebook.
         var login = function () {
    ...
    > [WACOM.NOTE]Si registró la información del paquete de la aplicación de la Tienda Windows en Servicios móviles, debe llamar al método [login](http://go.microsoft.com/fwlink/p/?LinkId=322050) proporcionando un valor **true** para el parámetro *useSingleSignOn*. Si no realiza este procedimiento, los usuarios seguirán visualizando una solicitud de inicio de sesión cada vez que se llame al método de inicio de sesión.
