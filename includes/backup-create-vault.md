...
### <a name="azure-backup---storage-redundancy-options"></a>Copia de seguridad de Microsoft Azure: Opciones de redundancia de almacenamiento
> [!IMPORTANT]
...
#### <a name="geo-redundant-storage-grs"></a>Almacenamiento con redundancia geográfica (GRS)
...
#### <a name="locally-redundant-storage-lrs"></a>Almacenamiento con redundancia local (LRS)
...
Si usa Azure como un punto de conexión de almacenamiento de copia de seguridad terciario (por ejemplo, usa SCDPM para tener una copia de seguridad local y usa Azure para sus necesidades de retención a largo plazo), debería considerar elegir el almacenamiento con redundancia local en la opción **Configurar** del almacén de copia de seguridad. Esto reduce el costo de almacenamiento de datos en Azure, a la vez que ofrece un menor nivel de durabilidad de los datos, el cual podría ser aceptable para copias terciarias.
