...
3. Haga clic con el botón secundario en el proyecto, haga clic en **Agregar** y, a continuación, haga clic en **Clase...**.
4. Asigne un nombre a la nueva clase `PushRegistrationHandler` vacía y haga clic en **Agregar**.
...
6. Reemplace la clase **PushRegistrationHandler** existente por el siguiente código:
