...
3.  Reemplace la función **InsertTodoItem** por el siguiente código:
...
4.  Reemplace la función **RefreshTodoItems** por el siguiente código:
...
5.  Reemplace la función **UpdateCheckedTodoItem** por el siguiente código:
