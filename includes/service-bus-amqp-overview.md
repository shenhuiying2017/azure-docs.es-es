...
Para obtener más información sobre cómo obtener y usar estas bibliotecas con el Bus de servicio, consulte la [Guía del desarrollador de AMQP del Bus de servicio][Guía del desarrollador de AMQP del Bus de servicio]. Consulte a continuación la sección "Referencias" para más información.
