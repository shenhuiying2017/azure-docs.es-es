...
2. Desplácese hasta el sitio web para <a href="http://go.microsoft.com/fwlink/p/?LinkId=268300" target="_blank">desarrolladores de Twitter</a> , inicie sesión con las credenciales de la cuenta de Twitter, diríjase a **My Applications** (Mis aplicaciones) y seleccione la aplicación de Twitter.

    ![](./media/mobile-services-register-twitter-access/mobile-twitter-my-apps.png)

3. En la pestaña **Details** (Detalles) para la aplicación, anote los siguientes valores:
...
2. Haga clic en la pestaña **Configurar**, desplácese hasta **Configuración de la aplicación** y escriba un par **Nombre** y **Valor** para cada uno de los siguientes que obtuvo desde la cuenta de almacenamiento y, a continuación, haga clic en **Guardar**.
