...
2. Escriba el nombre de la aplicación en **Nombre de aplicación**, haga clic en **Reservar nombre de aplicación** y, a continuación, haga clic en **Guardar**.
...
4. En el Explorador de soluciones, haga clic con el botón secundario en el proyecto, haga clic en **Tienda** y, a continuación, haga clic en **Asociar aplicación con la Tienda...**. 
...
6. Seleccione la aplicación que ha registrado en el paso 2, haga clic en **Siguiente** y, a continuación, haga clic en **Asociar**.
...
10. Haga clic en **Autenticación del servicio** y anote los valores de **Secreto de cliente** e **Identificador de seguridad de paquete (SID)**. 
	...
	<p>El secreto de cliente y el SID del paquete son credenciales de seguridad importantes. No comparta esta información con nadie ni la distribuya con su aplicación.</p>
    </div> 
