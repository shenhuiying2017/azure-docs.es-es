...
Este tutorial asume que ya tiene conocimientos básicos de cómo trabajar con ASP.NET [Web API 2](http://www.asp.net/web-api/overview/getting-started-with-aspnet-web-api/tutorial-your-first-web-api) y [MVC 5](http://www.asp.net/mvc/overview/getting-started/introduction/getting-started) en Visual Studio.
...
No necesita ningún conocimiento previo sobre cómo trabajar con Microsoft Azure, pero necesita una cuenta de Azure para completar el tutorial. Puede:
