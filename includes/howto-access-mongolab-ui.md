...
Desde ahí puede seleccionar una colección específica y explorar en profundidad los documentos individuales. Cierre la sesión cuando haya terminado.
  ...
  [página de soporte (en inglés)]: http://support.mongolab.com
  [blog (en inglés)]: http://blog.mongolab.com
  [botón de complementos]: ./media/howto-access-mongolab-ui/button-addons.png
  [MongolabEntry]: ./media/howto-access-mongolab-ui/entry-mongolabaddon.png
  [botón de administración]: ./media/howto-access-mongolab-ui/button-manage.png
