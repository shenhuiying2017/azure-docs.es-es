...
Para detalles sobre los agentes de máquina virtual y cómo funcionan para admitir las extensiones de máquina virtual, vea [Información general sobre el agente de máquina virtual y las extensiones de máquina virtual](../articles/virtual-machines/virtual-machines-windows-classic-manage-extensions.md).
...
| --- | --- | --- |
| VMAccessAgent (Windows) |Creación, actualización y restablecimiento de la información del usuario y las configuraciones de conexión RDP. |[Windows](../articles/virtual-machines/virtual-machines-windows-classic-extensions-customscript.md) |
...
| **CustomScriptExtension** (Windows)**CustomScriptForLinux** (Linux) |Invoca scripts personalizados en la máquina virtual en cualquier momento, ya sea en el inicio o durante su vigencia. |[Extensión Custom Script](../articles/virtual-machines/virtual-machines-windows-classic-extensions-customscript.md) |
