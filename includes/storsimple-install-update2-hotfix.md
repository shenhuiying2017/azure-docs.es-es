...
3. En el cuadro de búsqueda del Catálogo de Microsoft Update, escriba el número de Knowledge Base (KB) de la revisión que desee descargar (por ejemplo, **3121901**) y haga clic en **Buscar**.
...
8. Repita los pasos 3 a 5 para instalar las revisiones en modo normal restantes.
