...
1. En Acceso a llaves, haga clic con el botón secundario en el nuevo certificado de la aplicación de inicio rápido en **Claves** o **Mis certificados**, haga clic en **Exportar**, asigne un nombre al archivo QuickstartPusher, seleccione el formato **.p12** y, a continuación, haga clic en **Guardar**.
