Los datos de la cuenta de almacenamiento se replican para garantizar la durabilidad y una alta disponibilidad y deben cumplir los [contratos de nivel de servicio para almacenamiento de Azure][], incluso en caso de errores transitorios del hardware. Almacenamiento de Azure se ha implementado en 15 regiones de todo el mundo e incluye también soporte para la replicación de datos entre regiones. Tiene diversas opciones para replicar los datos en la cuenta de almacenamiento:
...
Para obtener más detalles acerca de las opciones de replicación, consulte el [Blog del equipo de Almacenamiento de Azure][] y [Opciones de redundancia del Almacenamiento de Azure][].

Las diferencias de precio entre las diversas opciones de replicación pueden encontrarse en la página de [Detalles de precios de Almacenamiento][].

  [contratos de nivel de servicio para almacenamiento de Azure]: /en-us/support/legal/sla/
  ...
  [Detalles de precios de Almacenamiento]: /en-us/pricing/details/storage/
