# <a name="using-cdn-for-azure"></a>Uso de la red CDN en Azure
...
<h2>Paso 1: Creación de una cuenta de almacenamiento</h2>
...
> [!NOTE]
> Para obtener información acerca de la realización de esta operación mediante la API de administración de servicios de Azure, consulte el tema de referencia [Creación de una cuenta de almacenamiento](http://msdn.microsoft.com/library/windowsazure/hh264518.aspx) .
> 
> 
...
2. En la esquina inferior izquierda, haga clic en **Nuevo**. En el cuadro de diálogo **Nuevo**, seleccione **Data Services**, haga clic en **Storage** y, después, en **Creación rápida**.
   
   Aparece el cuadro de diálogo **Crear cuenta de almacenamiento** .
   
   ![Creación de una cuenta de almacenamiento][create-new-storage-account]
3. En el campo **URL** , escriba un nombre de subdominio. Esta entrada puede contener de 3 a 24 letras minúsculas y números.
...
4. En la lista desplegable **Región/grupo de afinidad** , seleccione una región o grupo de afinidad para la cuenta de almacenamiento. Seleccione un grupo de afinidad en lugar de una región si quiere que sus servicios de almacenamiento estén en el mismo centro de datos que los otros servicios de Microsoft Azure que utiliza. Con esto se puede mejorar el rendimiento y no se generan cargos por concepto de salida.  
   ...
   **Nota**: Para crear un grupo de afinidad, abra el área **Configuración** del Portal de administración, haga clic en **Grupos de afinidad** y, después, en **Agregar un grupo de afinidad** o en **Agregar**. Además, puede crear y administrar grupos de afinidad usando la API de administración de servicios de Microsoft Azure. Para obtener más información, consulte [Operaciones en grupos de afinidad].
5. En la lista desplegable **Suscripción** , seleccione la suscripción que se usará con la cuenta de almacenamiento.
6. Haga clic en **Crear cuenta de almacenamiento**. El proceso de creación de la cuenta de almacenamiento podría tardar varios minutos en completarse.
7. Para comprobar que la cuenta de almacenamiento se ha creado correctamente, compruebe si aparece en la lista de elementos de **Storage** con el estado **En línea**.

<a id="Step2"> </a>

<h2>Paso 2: Creación de un nuevo extremo de la red CDN para una cuenta de almacenamiento</h2>
...
2. En la cinta, haga clic en **Nuevo**. En el cuadro de diálogo **Nuevo**, seleccione **App Services**, luego **CDN** y, finalmente, **Creación rápida**.
...
<h2>Paso 3: Obtención de acceso a su contenido de la red CDN</h2> 
...
<h2>Paso 4: Eliminación de su contenido de la red CDN</h2>
...
El Portal de administración de Azure no admite actualmente la posibilidad de purgar contenido. Si necesita purgar inmediatamente el contenido, póngase en contacto con el [soporte técnico de Azure](https://azure.microsoft.com/support/options/). 
