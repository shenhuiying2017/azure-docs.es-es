...
2. En el cuadro de diálogo Administrador de servicios, haga clic en **Crear servicio...** y, a continuación, seleccione **&lt;Administrar...&gt;** en **Suscripción** en el cuadro de diálogo Crear servicio móvil.  
...
5. De nuevo, en el cuadro de diálogo **Crear servicio móvil**, seleccione la **Subscripción**, el backend **JavaScript** en **Tiempo de ejecución** y una **Región** para el servicio móvil y, a continuación, escriba un **Nombre** para el servicio móvil.
