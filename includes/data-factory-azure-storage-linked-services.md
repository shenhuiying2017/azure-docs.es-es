...
Consulte el siguiente artículo para conocer los pasos para ver o copiar la clave de cuenta del Almacenamiento de Azure: [Visualización, copia y regeneración de las claves de acceso de almacenamiento](../articles/storage/storage-create-storage-account.md#view-copy-and-regenerate-storage-access-keys).
