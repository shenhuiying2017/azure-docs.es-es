...
- La Factoría de datos de Azure solo admite **SAS de servicio**, no SAS de cuenta. Consulte [Tipos de firmas de acceso compartido](../storage/storage-dotnet-shared-access-signature-part-1.md#types-of-shared-access-signatures) para obtener más información acerca de estos dos tipos.
