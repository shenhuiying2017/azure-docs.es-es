# Arquitectura de seguridad de Internet de las cosas
...
Todos los elementos del diagrama arquitectónico están sujetos a diversas amenazas; usaremos el mnemotécnico STRIDE. Para obtener más información sobre los elementos de STRIDE, consulte el artículo [Threat Modeling Again, STRIDE](https://blogs.msdn.microsoft.com/larryosterman/2007/09/04/threat-modeling-again-stride/) (Modelado de riesgos otra vez, STRIDE).
