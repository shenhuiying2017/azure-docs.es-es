## <a name="download-install-and-register-the-azure-backup-agent"></a>Descarga, instalación y registro del agente de Copia de seguridad de Azure
...
3. En la página Inicio rápido, haga clic en la opción **Para Windows Server, System Center Data Protection Manager o cliente de Windows** de **Descargar agente**. Haga clic en **Guardar** para copiarlo en la máquina local.
