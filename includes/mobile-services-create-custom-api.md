...
> [!NOTE]
> Los objetos [request](http://msdn.microsoft.com/library/windowsazure/jj554218.aspx) y [response](http://msdn.microsoft.com/library/windowsazure/dn303373.aspx) que se proporcionan para personalizar las funciones de la API se implementan mediante [Express.js library](http://go.microsoft.com/fwlink/p/?LinkId=309046).
> 
> 
