...
1.	Inicie sesión en el [Portal de administración]. En la parte inferior del panel de navegación, haga clic en **+NEW**. Expanda **Proceso** y **Mobile Service** y, a continuación, haga clic en **Create**.

	![](./media/mobile-services-create-new-service/mobile-create.png)

	Esto muestra el cuadro de diálogo **Crear un servicio móvil**.

2.	En el cuadro de diálogo **Crear un servicio móvil**, seleccione **Crear una base de datos de 20 MB SQL gratis**, seleccione el tiempo de ejecución **JavaScript**, escriba un nombre de subdominio para el nuevo servicio móvil en el cuadro de texto de **URL**. Haga clic en el botón de flecha derecha para ir a la página siguiente.
...
3.	En **Name**, escriba el nombre de la base de datos nueva, luego escriba el **Login name**, que es el nombre de inicio de sesión de administrador para el nuevo servidor de Base de datos SQL, escriba y confirme la contraseña y haga clic en el botón de comprobación para completar el proceso.
