...
* [Cómo configurar la aplicación web de WordPress de clase empresarial](web-sites-php-enterprise-wordpress.md)
...
* [Realización de una copia de seguridad de las aplicaciones web](web-sites-backup.md) y [Restauración de la aplicación web](web-sites-restore.md).
...
* [Cómo habilitar la caché en Redis](../redis-cache/cache-dotnet-how-to-use-azure-redis-cache.md) con el [complemento de caché en Redis](https://wordpress.org/plugins/wp-redis/)
* [Cómo habilitar la caché de objetos de memcached para WordPress](web-sites-connect-to-redis-using-memcache-protocol.md) con el [complemento de memcached](https://wordpress.org/plugins/memcached/)
