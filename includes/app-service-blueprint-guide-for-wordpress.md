...
* [Cómo hacer una copia de seguridad de la aplicación web](../articles/app-service/web-sites-backup.md) y [Cómo restaurar la aplicación web](../articles/app-service/web-sites-restore.md)
