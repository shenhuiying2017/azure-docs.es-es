...
4. En el cuadro de diálogo **Configurar sitio de Azure**, seleccione una suscripción, una región y una base de datos para usarlas con este proyecto. A continuación, haga clic en **Aceptar** para crear el proyecto.
