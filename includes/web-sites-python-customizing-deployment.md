...
Puede utilizar la [interfaz de la línea de comandos de Azure][Azure command-line interface] para crear los archivos.  Use este comando desde la carpeta del proyecto:
