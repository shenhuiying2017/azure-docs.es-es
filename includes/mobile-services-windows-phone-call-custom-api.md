...
4. Haga clic en el botón **Complete All**.
	...
	Se mostrará un cuadro de mensaje que indica el número de elementos marcados como completados y la consulta filtrada se vuelve a ejecutar, por lo que se borran todos los elementos de la lista.<!--HONumber=42-->
