...
8. Cambie el **Protocolo** a **TCP**.
9. Especifique un **Intervalo de puertos de destino** de 1433 (o el puerto en el que escucha su instancia de SQL Server).
10. Compruebe que la opción **Acción** está establecida en **Permitir**. El cuadro de diálogo de la regla de seguridad debe verse como la siguiente captura de pantalla.
