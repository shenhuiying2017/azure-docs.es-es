...
5. Vaya al [Centro de desarrollo de Windows](https://dev.windows.com/es-ES/overview), inicie sesión con su cuenta Microsoft, haga clic en el nuevo registro de aplicación en **Mis aplicaciones** y, por último, expanda **Servicios** > **Notificaciones push**.
6. En la página **Notificaciones push** haga clic en la opción **sitio de Live Services** de **Estado de los Servicios de notificaciones push de Windows (WNS) y Aplicaciones móviles de Microsoft Azure**. Después, anote los valores de **SID del paquete** y el valor *actual* de **Secretos de aplicación**.
