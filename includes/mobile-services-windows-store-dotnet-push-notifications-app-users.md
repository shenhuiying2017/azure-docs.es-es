...
3. Abra el archivo de proyecto MainPage.xaml.cs y reemplace el método **OnNavigatedTo** por lo siguiente:
	...
	En este código, debe reemplazar el nombre de la clase de inserción generada ("todolistPush") por el nombre de la clase que ha generado el asistente, normalmente en el formato <code><em>mobile_service</em>Insertar</code>.
...
2. Cambie la accesibilidad del método **InitNotificationsAsync** de "privado" a "público" y agregue el modificador "estático". 
