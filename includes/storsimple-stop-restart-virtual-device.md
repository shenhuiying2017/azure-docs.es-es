#### <a name="to-stop-and-start-a-virtual-device"></a>Para detener e iniciar un dispositivo virtual
...
#### <a name="to-restart-a-virtual-device"></a>Para reiniciar un dispositivo virtual
