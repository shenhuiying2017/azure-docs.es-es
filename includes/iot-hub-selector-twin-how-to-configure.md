...
> [!NOTE]
> Dado que las configuraciones pueden ser objetos complejos, se les asignan identificadores únicos (hashes o [GUID][lnk-guid]) para simplificar las comparaciones.
> 
> 
...
Posteriormente, la aplicación del dispositivo le indica el acierto o error de esta operación mediante la actualización de la propiedad anterior.
