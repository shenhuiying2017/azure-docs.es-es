...
* [Proteger el tráfico a la aplicación mediante la habilitación de Seguridad de la capa de transporte (TLS/SSL) - HTTPS](../articles/app-service-web/web-sites-configure-ssl-certificate.md)
...
* [Configurar la autenticación mutua de TLS para requerir certificados de cliente para conectarse a la aplicación web](../articles/app-service-web/app-service-web-configure-tls-mutual-auth.md)
