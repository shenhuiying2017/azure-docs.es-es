...
1.  Inicie Visual Studio con la opción **Ejecutar como administrador** y abra la solución que contiene el proyecto de servicio móvil con el que trabajó en el tutorial de [Introducción][] o de [Introducción a los datos][].
...
5.  Haga clic con el botón secundario en el proyecto de servicio y haga clic en **Publicar**. Publique el servicio móvil en su cuenta de Microsoft Azure usando la configuración de publicación que utilizó anteriormente en el tutorial [Introducción][] o [Introducción a los datos][].

    > [WACOM.NOTE] Puede probar alternativamente el servicio hospedado localmente en IIS Express. Para obtener más información, consulte el tutorial [Introducción a los datos][].
