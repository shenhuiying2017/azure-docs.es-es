...
4. Haga clic con el botón secundario en el proyecto de servicio y haga clic en **Compilar** para compilar el proyecto de servicio móvil. Compruebe que no haya errores.

   	![](./media/mobile-services-dotnet-backend-add-validation/mobile-services-build-dotnet-service.png)

5. Haga clic con el botón secundario en el proyecto de servicio y haga clic en **Publicar**. Publique el servicio móvil en su cuenta de Microsoft Azure usando la configuración de publicación que utilizó anteriormente en el tutorial [Introducción] o [Introducción a los datos](mobile-services-dotnet-backend-windows-store-dotnet-get-started-data.md).
 
     >[AZURE.NOTE] Puede probar alternativamente el servicio hospedado localmente en IIS Express. Para obtener más información, consulte el tutorial [Introducción a los datos](mobile-services-dotnet-backend-windows-store-dotnet-get-started-data.md).
