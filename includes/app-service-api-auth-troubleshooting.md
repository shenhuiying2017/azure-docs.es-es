...
* Para una aplicación de API de .NET, asegúrese de que obtiene tanta información como sea posible en los mensajes de error estableciendo el [modo customErrors como Off (desactivado)](../articles/app-service-web/web-sites-dotnet-troubleshoot-visual-studio.md#remoteview).
