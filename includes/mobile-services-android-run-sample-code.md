1. En el Explorador de proyectos, expanda **app** => **src** => **main** => **java** => **com.example.GetStartedWithData** y luego abra el archivo *ToDoActivity.java*.
...
1. En el menú **Ejecutar**, haga clic en **Ejecutar aplicación**.
2. Aparecerá el cuadro de diálogo **Elegir dispositivo**.
...
1. Elija un dispositivo conectado o *Iniciar emulador*.
2. Cuando aparezca la aplicación, escriba texto significativo, como *Completar el tutorial* y, a continuación, haga clic en **Agregar**.
