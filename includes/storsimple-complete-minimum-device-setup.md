...
1. En la página **Dispositivos**, selecciona el dispositivo y haz clic en la flecha situada junto al nombre del dispositivo para ir a la página específica del dispositivo. 
...
2. Haz clic en el icono de inicio rápido ![Icono de inicio rápido](./media/storsimple-complete-minimum-device-setup/HCS_QuickStartIcon-include.png) para tener acceso a la página de inicio rápido del dispositivo. Haz clic en **Completar la instalación del dispositivo** para iniciar el Asistente para **Configurar dispositivos**.

	![Página de inicio rápido del dispositivo](./media/storsimple-complete-minimum-device-setup/Device_Quick_Start_page_1M.png)

2. En la página de **Configuración básica** haz lo siguiente:
