...
* La solución de *supervisión remota* le permite supervisar el estado de dispositivos como las máquinas expendedoras.
* La solución de *mantenimiento predictivo* le ayuda a anticiparse a las necesidades de mantenimiento de dispositivos como las bombas de centros de bombeo remotos y a evitar el tiempo de inactividad no programado.
