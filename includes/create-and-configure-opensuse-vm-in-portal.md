...
**Importante**: si desea que su máquina virtual utilice una red
virtual, asegúrese de especificar la red virtual cuando cree la máquina
virtual. Puede configurarse una máquina virtual para que se una a una
red virtual solo cuando se cree la máquina virtual. Para obtener más
información acerca de redes virtuales, consulte [Información general
sobre redes virtuales de Azure][1].
...
3.  Seleccione una imagen de máquina virtual OpenSUSE en **Platform
...
Una vez creada la máquina virtual, debe configurar los extremos para
...
Si usa un equipo con Linux, conéctese a la máquina virtual mediante SSH.
...
1.  Una vez que se haya conectado a la máquina virtual, tiene la opción
    de instalar revisiones y actualizaciones del sistema. Ejecute:
    
    `$ sudo zypper update`

2.  Seleccione **Software** y, a continuación, **Online Update**.
    Aparecerá una lista de actualizaciones. Seleccione **Accept** para
    iniciar la instalación y aplicar todas las nuevas revisiones
    (excepto las opcionales) que estén disponibles actualmente para su
    sistema.
