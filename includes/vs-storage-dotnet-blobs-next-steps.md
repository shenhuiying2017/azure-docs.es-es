...
<ul> 
 <ul>
    <li>Utilice <a href="https://azure.microsoft.com/es-es/documentation/articles/vs-storage-aspnet5-getting-started-tables/">Almacenamiento de tablas</a> para almacenar datos estructurados.</li>
    <li>Utilice <a href="https://azure.microsoft.com/documentation/articles/storage-dotnet-how-to-use-queues/">Almacenamiento de cola</a> para almacenar datos no estructurados.</li>
    <li>Utilice <a href="https://azure.microsoft.com/documentation/articles/sql-database-dotnet-how-to-use/">Base de datos SQL</a> para almacenar datos relacionales.</li>
  </ul>
</ul>
