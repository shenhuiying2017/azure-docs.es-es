...
Vuelva a Visual Studio y seleccione el proyecto de aplicación cliente de código compartido (su nombre es `<nombre de su aplicación>.Shared`)
...
2. En la aplicación, escriba un texto significativo, como*Complete the tutorial*, en el cuadro de texto **Insertar un TodoItem**y, a continuación, haga clic en **Guardar**.

	![](./media/app-service-mobile-windows-universal-test-app-preview/mobile-quickstart-startup.png)

	Esta acción envía una solicitud POST al back-end de la nueva aplicación móvil hospedada en Azure.

3. Detenga la depuración y cambie el proyecto de de inicio predeterminada en la solución universal de Windows para la aplicación Tienda de Windows Phone (haga clic con el botón secundario en el proyecto `<nombre de su aplicación>.WindowsPhone` y haga clic en **Establecer como proyecto de inicio**) y presione F5 de nuevo.
