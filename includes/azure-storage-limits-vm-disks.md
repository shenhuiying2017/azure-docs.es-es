...
* **Para Azure Managed Disks:** el límite del número de instancias de Managed Disks depende de la región de la suscripción. El límite temporal predeterminado es 2000. Para aumentar el límite, póngase en contacto con el soporte técnico de Azure.
