...
- [(C# universal para Windows| .NET)](mobile-services-dotnet-backend-windows-store-dotnet-get-started.md)
- [(C# universal para Windows | Javascript)](mobile-services-javascript-backend-windows-store-dotnet-get-started.md)
- [(JavaScript universal para Windows | .NET)](mobile-services-dotnet-backend-windows-store-javascript-get-started.md)
- [(JavaScript universal para Windows | Javascript)](mobile-services-javascript-backend-windows-store-javascript-get-started.md)
