...
1.  Haga clic en **Connection Info**.
    ...
    ![bot&oacute;n-informaci&oacute;n-conexi&oacute;n-blitline](./media/blitline-signup/blitline_connection_info_button.png)

2.  Puede consultar su identificador de aplicación en el cuadro de
    diálogo *Información de la conexión*.
    
    ![informaci&oacute;n-conexi&oacute;n-blitline](./media/blitline-signup/blitline_connection_info_screen.jpeg)
