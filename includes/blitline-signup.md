...
### <a name="to-sign-up-for-a-blitline-account"></a>Para suscribirse a una cuenta Blitline
...
### <a name="to-find-your-blitline-application-id"></a>Para encontrar su identificador de aplicación de Blitline
