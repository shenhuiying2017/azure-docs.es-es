...
3. Comprueba que el **Nombre** y el **Puerto público** del extremo del agente de escucha que quieres utilizar no está ya en uso. En el ejemplo siguiente, el nombre es "MyEndpoint" y el puerto es "1433".
