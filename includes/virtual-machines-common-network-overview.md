...
| Método | DESCRIPCIÓN |
| ------ | ----------- |
| Azure Portal | Actualmente no se puede crear equilibrador de carga con acceso Internet mediante Azure Portal. |
...
| Método | DESCRIPCIÓN |
| ------ | ----------- |
| Azure Portal | Actualmente no se puede crear equilibrador de carga interno mediante Azure Portal. |
