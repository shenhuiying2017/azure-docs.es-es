...
3. Indique sus credenciales y seleccione el botón para iniciar sesión ![](./media/connectors-create-api-wunderlist/wunderlist-2.png)  
4. Tras esto, se le informará de que la aplicación lógica tendrá permisos en su cuenta de Wunderlist. Si está de acuerdo, seleccione el botón para indicarlo. ![](./media/connectors-create-api-wunderlist/wunderlist-4.png)  
5. Por último, seleccione el botón **Autorizar** ![](./media/connectors-create-api-wunderlist/wunderlist-5.png)  
