...
| [Copias de seguridad programadas](../articles/app-service/web-sites-backup.md) | | | |12 al día |Una vez cada 5 minutos<sup>8</sup> |
...
<sup>3</sup>Las instancias dedicadas pueden tener diferentes tamaños. Consulte [Precios de App Service](https://azure.microsoft.com/pricing/details/data-transfers/pricing/details/app-service/) para obtener más detalles.  
...
<sup>8</sup>El nivel Premium permite intervalos de copia de seguridad de hasta cada 5 minutos cuando se usa en entornos de App Service y 50 veces al día, de lo contrario.  
<sup>9</sup>Ejecuta scripts o ejecutables personalizados a petición, según una programación o de manera continua como tarea en segundo plano dentro de tu instancia de App Service. Siempre disponible se requiere para la ejecución continua de Trabajos web. Se requiere Azure Scheduler de nivel Gratis o Estándar para Trabajos web programados. No hay ningún límite predefinido en el número de WebJobs que puede ejecutar en una instancia de App Service, pero sí hay límites prácticos que dependen de lo que el código de la aplicación esté intentando hacer.   
