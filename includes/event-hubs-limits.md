...
| --- | --- | --- | --- | --- |
| Número de centros de eventos por espacio de nombres |Espacio de nombres |estática |Se rechazarán las solicitudes posteriores para la creación de un nuevo centro de eventos. |10 |
| Número de particiones por centro de eventos |Entidad |Estática |- |32 |
...
| Número de reglas de autorización por espacio de nombres |Espacio de nombres|estática |Se rechazarán las solicitudes posteriores de creación de reglas de autorización.|12 |
