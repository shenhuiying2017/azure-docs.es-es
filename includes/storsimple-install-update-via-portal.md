<properties 
   pageTitle="Instalación de la actualización 1 desde el Portal de administración de Azure"
   description="Explica cómo usar el Portal de administración para instalar StorSimple 8000 Series Update 1."
   services="storsimple"
