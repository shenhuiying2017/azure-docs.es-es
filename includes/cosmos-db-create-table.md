...
2. En la hoja Explorador de datos, haga clic en **Nueva tabla** y rellene la página con la información siguiente.
    ...
    RU/m|Off|Use el valor predeterminado. Si tiene que controlar grandes cargas de trabajo más adelante, puede activar la característica [RU/m](../articles/cosmos-db/request-units-per-minute.md).
