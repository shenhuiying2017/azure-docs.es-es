<properties
   pageTitle="Instalar las actualizaciones manualmente"
   description="Se explica cómo usar la función de actualización de StorSimple y el Portal de administración para instalar las actualizaciones manualmente."
   services="storsimple"
...
4. Verá un mensaje si hay actualizaciones de software disponibles. Haga clic en **Instalar actualizaciones** para iniciar la actualización del dispositivo.
    ...
    Recibirá una notificación cuando la actualización esté correctamente instalada. <!--HONumber=52-->
