...
11. Cuando MySQL esté instalado, deberá configurar un extremo para que pueda acceder a MySQL de manera remota. Inicie sesión en el [Portal de Azure][AzurePortal]. Haga clic en **Máquinas virtuales**, en el nombre de la nueva máquina virtual y luego en **Extremos**.

12. Haga clic en **Agregar** en la parte inferior de la página.

13. Agregue un extremo con el nombre "MySQL", con el protocolo **TCP** y los puertos **Público** y **Privado** establecidos en "3306".

14. Para conectarse de forma remota a la máquina virtual desde su equipo, escriba:
