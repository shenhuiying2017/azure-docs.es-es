...
| Almacenamiento máximo de datos por base de datos | 250 GB | 250 GB | 250 GB | 250 GB | 250 GB | 250 GB |
||||||||

<a id="standard-elastic-pool-limits-continued" class="xliff"></a>

### Límites de grupo elástico estándar (continuación) 
...
### Límites de grupo elástico premium (continuación) 
...
### Límites de grupo elástico RS Premium
...
| Almacenamiento máximo de datos por base de datos | 500 GB | 500 GB | 500 GB | 500 GB | 
||||||||
