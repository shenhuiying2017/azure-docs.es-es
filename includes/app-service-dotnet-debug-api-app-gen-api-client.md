## <a name="generate-an-api-app-client"></a>Generación de un cliente de aplicación de API
...
1. En Visual Studio, abra la solución que contiene la aplicación de API desde el tema [Creación de una aplicación de API](../articles/app-service-api/app-service-dotnet-create-api-app.md). 
...
4. Haga clic con el botón derecho en el proyecto de la aplicación de consola recién creado y seleccione **Add** > **Azure API App Client** (Agregar > Cliente de aplicación de API de Azure). 
...
## <a name="test-the-api-app-client"></a>Prueba del cliente de aplicación de API
...
3. En el menú contextual de la aplicación de consola, seleccione **Debug > Start new instance** (Depurar > Iniciar nueva instancia). 
