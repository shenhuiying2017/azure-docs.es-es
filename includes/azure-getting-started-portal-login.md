...
-->
## <a name="connect-to-the-azure-portal-with-a-subscription"></a>Conexión al portal de Azure con una suscripción
Para conectarse al portal de Azure, debe tener una suscripción.

### <a name="get-a-new-account"></a>Obtención de una cuenta nueva
Si no tiene una cuenta de Azure existente, elija una de las siguientes opciones para obtener una:
