...
2. Haga clic en **Parámetros**. En el panel **Parámetros**, escriba valores nuevos, selecciónelos de los valores permitidos o acepte los valores predeterminados y, luego, haga clic en **Aceptar**.
