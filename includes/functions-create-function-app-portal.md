...
1. Haga clic en **Proceso** > **Function App** y seleccione su **suscripción**. Después, use la configuración de Function App especificada en la tabla.
    ...
    | **[Cuenta de almacenamiento](../articles/storage/storage-create-storage-account.md#create-a-storage-account)** |  Nombre único globalmente |  Nombre de la nueva cuenta de almacenamiento usada por Function App. También puede usar una cuenta existente. |
