...
4. Reemplace el elemento **StackPanel** de **DataTemplate** por el siguiente código:
...
5. En el proyecto de aplicación de Windows Phone, abra el archivo MainPage.xaml y reemplace el elemento **ButtonSave** con el código siguiente:
...
6. Reemplace el elemento **StackPanel** de **DataTemplate** por el siguiente código:
...
7. En la carpeta DataModel compartida, abra el archivo de proyecto TodoItem.cs y agregue las siguientes propiedades a la clase TodoItem:
...
8. Abra el archivo de proyecto compartido MainPage.cs y agregue las siguientes instrucciones **using**:
...
9. Agregue el siguiente código a la clase MainPage:
...
10. Reemplace el método `InsertTodoItem` existente por el código siguiente:
...
7. Puntee en la vista previa para tomar una imagen y luego haga clic en **Upload** (Cargar) para insertar el nuevo elemento y cargar la imagen.
